...
public class q extends AbstractAction
{
    ...
    public q(final y a, final String s, final int b) {
        this.a = a;
        super(s);
        this.b = b;
    }
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        this.a.u = this.b;
        this.a.t = ((JMenuItem)actionEvent.getSource()).getText();
        if (this.a.u != this.a.au && this.a.bw.n()) {
            this.a.bw.c(false);
            this.a.bw.b(false);
            this.a.bw.b((FocusEvent)null);
        }
        this.a.repaint();
    }
}
