...
public class oneRowTicker extends Applet implements ActionListener, useHandleInterface
{
    ...
    public void init() {
        ...
        if (this.localTest) {
            this.baseUrl = "http://qa.quotemedia.com/";
        }
        else {
        ...
        if (this.getParameter("symbology") != null) {
            this.symbology = this.getParameter("symbology");
        }
        ...
        System.out.println("OneRowTicker Version 3.22.0");
    }
    ...
    public void openLookup() {
        ...
        if (this.excludeExchanges != null) {
            ...
            while (tok.hasMoreTokens()) {
                ...
                stbuffer.append("&excludeExchanges=").append(tsy);
            }
        }
        final String tmpurl = this.baseUrl + "quotetools/symbolLookup.jsp?symbology=" + this.symbology + "&webmasterId=" + this.wmid + stbuffer.toString();
        final String property = "width=600,height=300,left=" + tleft + ",top=" + mtop + ",resizable=1,menubar=no,toolbar=no,location=no,scrollbars=yes,statusbar=yes,status=yes";
    ...
    public void actionPerformed(final ActionEvent ev) {
        ...
        if (obj == this.edit) {
            ...
            this.hframe.setExistingListSymbols(this.hframe.getExistingSymbol());
            this.hframe.setExistingIndices(this.hframe.getExistingIndices());
            this.hframe.show();
        }
