...
public class SupersetENGParser extends ScriptParser
{
    ...
    private static String[] getTokens() {
        ...
        int n = 0;
        final StringTokenizer stringTokenizer = new StringTokenizer("R;U;F;L;D;B;R';U';F';L';D';B';R2;U2;F2;L2;D2;B2;R2';U2';F2';L2';D2';B2';TR;TU;TF;TL;TD;TB;TR';TU';TF';TL';TD';TB';TR2;TU2;TF2;TL2;TD2;TB2;TR2';TU2';TF2';TL2';TD2';TB2';MR ML';MU MD';MF MB';ML MR';MD MU';MB MF';MR2 ML2';MU2 MD2';MF2 MB2';ML2 MR2';MD2 MU2';MB2 MF2';SR SL';SU SD';SF SB';SL SR';SD SU';SB SF';SR2 SL2';SU2 SD2';SF2 SB2';SL2 SR2';SD2 SU2';SB2 SF2';CR CL';CU CD';CF CB';CL CR';CD CU';CB CF';CR2 CL2';CU2 CD2';CF2 CB2';CL2 CR2';CD2 CU2';CB2 CF2';.;r;u;f;l;d;b;+;-;++;;';;( [ {;) ] };,;(;);;;;;;;;;/*;*/;//;", ";", true);
