...
public class RubyNameError$i$0$2$initialize extends JavaMethodNBlock
{
    public RubyNameError$i$0$2$initialize(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return ((RubyNameError)rubyObject).initialize(array, block);
    }
}
