...
class cgMatrix
{
    ...
    public void unitInverse(final cgMatrix cgMatrix) {
        this.m_dXx = cgMatrix.m_dYy * cgMatrix.m_dZz - cgMatrix.m_dYz * cgMatrix.m_dZy;
        this.m_dXy = cgMatrix.m_dXz * cgMatrix.m_dZy - cgMatrix.m_dXy * cgMatrix.m_dZz;
        this.m_dXz = cgMatrix.m_dXy * cgMatrix.m_dYz - cgMatrix.m_dXz * cgMatrix.m_dYy;
        this.m_dYx = cgMatrix.m_dYz * cgMatrix.m_dZx - cgMatrix.m_dYx * cgMatrix.m_dZz;
        this.m_dYy = cgMatrix.m_dXx * cgMatrix.m_dZz - cgMatrix.m_dXz * cgMatrix.m_dZx;
        this.m_dYz = cgMatrix.m_dXz * cgMatrix.m_dYx - cgMatrix.m_dXx * cgMatrix.m_dYz;
        this.m_dZx = cgMatrix.m_dYx * cgMatrix.m_dZy - cgMatrix.m_dYy * cgMatrix.m_dZx;
        this.m_dZy = cgMatrix.m_dXy * cgMatrix.m_dZx - cgMatrix.m_dXx * cgMatrix.m_dZy;
        this.m_dZz = cgMatrix.m_dXx * cgMatrix.m_dYy - cgMatrix.m_dXy * cgMatrix.m_dYx;
    }
    ...
    public cgMatrix(final cgVector cgVector, final cgVector cgVector2, final cgVector cgVector3) {
        this.m_dXx = cgVector.m_dX;
        this.m_dXy = cgVector.m_dY;
        this.m_dXz = cgVector.m_dZ;
        this.m_dYx = cgVector2.m_dX;
        this.m_dYy = cgVector2.m_dY;
        this.m_dYz = cgVector2.m_dZ;
        this.m_dZx = cgVector3.m_dX;
        this.m_dZy = cgVector3.m_dY;
        this.m_dZz = cgVector3.m_dZ;
    }
