...
public final class bO extends Panel implements MouseListener
{
    ...
    public bO(final aa q, final bt q2, final j q3) {
        this.setLayout(null);
        this.q = q;
        this.q = q3;
        this.q = q2.q("mb", 0, 0);
        ...
        this.addFocusListener(new ax(this));
        if (q.q) {
            this.q = new Q(q.q, q2, true, null);
        }
    }
    ...
    static bt q(final bO bo) {
        return bo.q;
    }
    
    static void q(final bO bo) {
        bo.e();
    }
