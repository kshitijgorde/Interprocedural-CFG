...
public class IntegralCurves extends GenericGraphApplet
{
    ...
    protected void setUpCanvas() {
        ...
        final String upperCase = (String.valueOf(this.getParameter("VectorStyle", "")) + "A").toUpperCase();
        int n = 0;
    ...
    protected void setUpBottomPanel() {
        ...
        if ("yes".equalsIgnoreCase(this.getParameter("UseStartInputs", "yes"))) {
            ...
            container3.add(new Label(String.valueOf(super.xVar.getName()) + " ="));
            container3.add(this.xStart);
            container3.add(new Label(String.valueOf(this.yVar.getName()) + " ="));
        ...
        if (equalsIgnoreCase3 || equalsIgnoreCase4) {
            ...
            if (equalsIgnoreCase4) {
                ...
                panel.add(this.deltaT = new VariableInput(null, String.valueOf(this.dt)));
            }
