...
public class RubySignal$s$0$1$trap extends JavaMethodNBlock
{
    public RubySignal$s$0$1$trap(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubySignal.trap(context, recv, array, block);
    }
}
