...
public class RubyTime$s$0$9$new_utc extends JavaMethodN
{
    public RubyTime$s$0$9$new_utc(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyTime.new_utc(recv, array);
    }
}
