...
public class Keywords
{
    ...
    static {
        ...
        Keywords.m_nodetests = new Hashtable();
        ...
        Keywords.m_nodetests.put("comment", new Integer(1030));
        Keywords.m_nodetests.put("text", new Integer(1031));
        Keywords.m_nodetests.put("processing-instruction", new Integer(1032));
        Keywords.m_nodetests.put("node", new Integer(1033));
    }
}
