...
public class RubyFile$i$0$2$initialize extends JavaMethodNBlock
{
    public RubyFile$i$0$2$initialize(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return ((RubyFile)rubyObject).initialize(array, block);
    }
}
