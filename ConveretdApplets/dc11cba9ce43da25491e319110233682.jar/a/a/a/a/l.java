...
public class l extends Applet implements KeyListener, MouseMotionListener, MouseListener, Runnable
{
    ...
    protected long S;
    private boolean z;
    protected static final String u = "1.14.1.4";
    protected String O;
    ...
    public l() {
        ...
        this.S = 0L;
        this.z = false;
        this.O = "ImmerVision PURE Player PRO for Java 1.14.1.4";
        this.c = this;
        this.L = null;
        this.a = false;
        this.J = false;
    ...
    public void init() {
        ...
        try {
            ...
            if (this.new == 6) {
                ...
                if (n > 1 && Integer.parseInt(property.substring(n)) >= 3) {
                    this.m = 24;
                }
            }
    ...
    public void char() {
        if (this.i == null) {
            ...
            if (this.D != null) {
                this.i = new bg(this, frame, "1.14.1.4", this.G.e, this.G.new, this.G.s, this.D.e, this.D.new, this.D.s);
            }
            else {
                this.i = new bg(this, frame, "1.14.1.4", this.G.e, this.G.new, this.G.s, "", "", "");
            }
        }
        else {
            this.i.toFront();
    ...
    public void int(final String s) {
        if (this.t == null) {
            Container container;
            for (container = this.getParent(); !(container instanceof Frame); container = container.getParent()) {}
            this.t = new bq((Frame)container, "1.14.1.4", this, s);
        }
        else {
            this.t.toFront();
        }
