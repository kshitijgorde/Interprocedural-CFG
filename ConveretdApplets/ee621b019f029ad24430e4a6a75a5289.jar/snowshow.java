...
public class snowshow extends Applet implements Runnable
{
    Thread motor;
    int XSIZE;
    int YSIZE;
    ...
    public void init() {
        ...
        this.bufImg = new loadsnow(this, this.mainImg, this.XSIZE, this.YSIZE);
    ...
    public void run() {
        ...
        System.err.println("Snowing Slide Show Applet (C) 2001 I-Yuan Chen [6sense.com]");
        while (true) {
            final Graphics mainGrp = this.mainImg.getGraphics();
