...
public class RubyException$i$0$1$exception extends JavaMethodN
{
    public RubyException$i$0$1$exception(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyException)rubyObject).exception(array);
    }
}
