...
public class aU extends aY
{
    ...
    public aU(final int bevelType) {
        this.bevelType = bevelType;
    }
    
    public aU(final int n, final Color color, final Color color2) {
        this(n, color.brighter(), color, color2, color2.brighter());
    }
    
    public aU(final int n, final Color highlightOuter, final Color highlightInner, final Color shadowOuter, final Color shadowInner) {
        this(n);
