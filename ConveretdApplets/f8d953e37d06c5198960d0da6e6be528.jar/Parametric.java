...
public class Parametric extends GenericGraphApplet
{
    ...
    protected void setUpCanvas() {
        ...
        if ("no".equalsIgnoreCase(this.getParameter("UseParamInputs", "yes"))) {
            this.tMin = new VariableInput(super.xVar.getName() + "Start", this.getParameter("ParameterMin", "-2"));
            this.tMax = new VariableInput(super.xVar.getName() + "End", this.getParameter("ParameterMax", "2"));
