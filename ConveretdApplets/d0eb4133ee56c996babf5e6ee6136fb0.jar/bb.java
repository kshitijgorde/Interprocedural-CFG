...
class bb extends Panel implements MouseListener
{
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "Zi".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "Zh".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "Zn".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "Zf".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "Zk".toCharArray();
        ...
        final int n19 = 6;
        final char[] charArray7 = "Xh".toCharArray();
        ...
        final int n25 = 8;
        final char[] charArray9 = "Z1".toCharArray();
