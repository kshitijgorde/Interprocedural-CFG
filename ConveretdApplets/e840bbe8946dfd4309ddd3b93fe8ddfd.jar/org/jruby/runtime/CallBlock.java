...
public class CallBlock extends BlockBody
{
    ...
    public static Block newCallClosure(final IRubyObject self, final RubyModule imClass, final Arity arity, final BlockCallback callback, final ThreadContext context) {
        ...
        final BlockBody body = new CallBlock(imClass, arity, callback, context);
        return new Block(body, binding);
    }
    
    private CallBlock(final RubyModule imClass, final Arity arity, final BlockCallback callback, final ThreadContext context) {
        super(3);
        this.arity = arity;
    ...
    public IRubyObject yieldSpecific(final ThreadContext context, final IRubyObject arg0, final IRubyObject arg1, final Binding binding, final Block.Type type) {
        return this.callback.call(context, new IRubyObject[] { RubyArray.newArrayLight(context.getRuntime(), arg0, arg1) }, Block.NULL_BLOCK);
    }
    ...
    public IRubyObject yieldSpecific(final ThreadContext context, final IRubyObject arg0, final IRubyObject arg1, final IRubyObject arg2, final Binding binding, final Block.Type type) {
        return this.callback.call(context, new IRubyObject[] { RubyArray.newArrayLight(context.getRuntime(), arg0, arg1, arg2) }, Block.NULL_BLOCK);
    }
