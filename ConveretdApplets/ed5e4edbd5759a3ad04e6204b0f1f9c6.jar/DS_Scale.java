...
public class DS_Scale extends Applet implements Runnable
{
    Thread _fld0;
    int _fld1;
    Font _fld3;
    ...
    public final boolean mouseMove(final Event event, final int n, final int fld7d) {
    ...
    void _mth1b() {
        ...
        this._fld3e = ((this._fld3e >= 1) ? ((this._fld3e <= 8) ? this._fld3e : 8) : 1);
        ...
        if (parameter3 != null) {
            this._fld7e = parameter3;
            final String parameter4 = this.getParameter("reglink");
            if (parameter4 != null) {
                try {
                    this._fld8e = new URL("http://" + parameter4);
                }
                catch (MalformedURLException ex) {
                    this._fld8e = null;
                }
    ...
    void _mth2b() {
        ...
        double n = 0.015625;
        for (int i = 0; i < 128; ++i) {
            this._fld2e[i] = (int)(n * 256.0);
            this._fld2e[255 - i] = (int)(n * 256.0);
            n += 0.015625;
        }
    }
    ...
    void _mth3b() {
        if (this._fld9d) {
            ...
            else if (this._fld6e == 1) {
                this._fld5e = this._fld3e;
                this._fld6e = 2;
            }
        }
        if (this._fld1e + this._fld5e > 127) {
            this._fld5e = -this._fld3e;
        }
        else if (this._fld1e + this._fld5e < 0) {
            this._fld5e = this._fld3e;
        }
        this._mth4b(this._fld1e += this._fld5e);
        this._fld9 = this.createImage(this._fld8);
    }
    
    void _mth4b(final int n) {
        final int n2 = this._fld4 >> 1;
        final int n3 = this._fld5 >> 1;
        final int fld4e = this._fld4e;
        int n4 = 0;
        for (int i = -n3; i < this._fld5 - n3; ++i) {
            final int n5 = i * this._fld2e[n] >> 8;
            final int n6 = this._fld4 * (n5 + n3);
            for (int j = -n2; j < this._fld4 - n2; ++j) {
                final int n7 = j * this._fld2e[n] >> 8;
                if (n7 > -n2 && n7 < this._fld4 - n2 && n5 > -n3 && n5 < this._fld5 - n3) {
                    this._fld7[n4++] = this._fld6[n6 + (n7 + n2)];
                }
                else {
                    this._fld7[n4++] = fld4e;
                }
    ...
    void _mth6b() {
        ...
        if (--fld9c > 0) {
            this._fld9b = true;
            this._fld9c = fld9c;
            this._fld5f = new String[this._fld9c];
            this._fld6f = new Color[this._fld9c];
            this._fld7f = new Color[this._fld9c];
            this._fld8f = new Font[this._fld9c];
            this._fld9f = new FontMetrics[this._fld9c];
            this._fld0g = new String[this._fld9c];
            this._fld1g = new int[this._fld9c];
            this._fld2g = new int[this._fld9c];
            for (int i = 0; i < this._fld9c; ++i) {
                this._fld5f[i] = this.getParameter("overtext" + String.valueOf(i + 1));
                this._fld6f[i] = this._mth0b("overtextcol" + String.valueOf(i + 1), new Color(16777215));
                this._fld7f[i] = this._mth0b("overtextcols" + String.valueOf(i + 1), new Color(0));
                final String parameter = this.getParameter("overtexty" + String.valueOf(i + 1));
                if (parameter == null) {
                    this._fld2g[i] = 10;
                }
                else {
                    this._fld2g[i] = Integer.parseInt(parameter);
                }
                ...
                this._fld8f[i] = new Font(parameter2, n, int1);
                this._fld9f[i] = this._fld2c.getFontMetrics(this._fld8f[i]);
                this._fld0g[i] = this.getParameter("overTextType" + String.valueOf(i + 1));
                if (this._fld0g[i] == null) {
                    this._fld0g[i] = "scrollleft";
                }
                ...
                if (parameter5 == null) {
                    ...
                    this._fld1g[i] = Integer.valueOf(parameter5);
                    if (this._fld1g[i] < 1 || this._fld1g[i] > 4) {
                        this._fld1g[i] = 2;
                    }
                }
            }
    ...
    void _mth7b() {
        this._fld2d = this._fld9f[this._fld8c].stringWidth(this._fld5f[this._fld8c]);
        this._fld3d = this._fld9f[this._fld8c].getHeight();
        if (this._fld0g[this._fld8c].equalsIgnoreCase("scrolldown")) {
            this._fld0d = this._fld4 - this._fld2d >> 1;
            this._fld1d = 0;
            return;
        }
        if (this._fld0g[this._fld8c].equalsIgnoreCase("scrollup")) {
            this._fld0d = this._fld4 - this._fld2d >> 1;
            this._fld1d = this._fld5 + this._fld3d;
            return;
        }
        if (this._fld0g[this._fld8c].equalsIgnoreCase("scrollright")) {
            this._fld0d = -this._fld2d;
            this._fld1d = this._fld2g[this._fld8c] + (this._fld3d >> 1) + (this._fld3d >> 3);
            return;
        }
    ...
    void _mth8b(final Graphics graphics) {
        graphics.setFont(this._fld8f[this._fld8c]);
        graphics.setColor(this._fld7f[this._fld8c]);
        graphics.drawString(this._fld5f[this._fld8c], this._fld0d + 1, this._fld1d + 1);
        graphics.setColor(this._fld6f[this._fld8c]);
        graphics.drawString(this._fld5f[this._fld8c], this._fld0d, this._fld1d);
        if (this._fld0g[this._fld8c].equalsIgnoreCase("scrolldown")) {
            this._fld1d += this._fld1g[this._fld8c];
        }
        else if (this._fld0g[this._fld8c].equalsIgnoreCase("scrollup")) {
            this._fld1d -= this._fld1g[this._fld8c];
        }
        else if (this._fld0g[this._fld8c].equalsIgnoreCase("scrollright")) {
            this._fld0d += this._fld1g[this._fld8c];
        }
        else {
            this._fld0d -= this._fld1g[this._fld8c];
        }
