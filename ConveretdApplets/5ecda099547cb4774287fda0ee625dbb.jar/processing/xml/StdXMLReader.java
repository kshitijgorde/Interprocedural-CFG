...
public class StdXMLReader
{
    ...
    public static StdXMLReader fileReader(final String systemID) throws FileNotFoundException, IOException {
        final StdXMLReader stdXMLReader = new StdXMLReader(new FileInputStream(systemID));
        stdXMLReader.setSystemID(systemID);
        for (int i = 0; i < stdXMLReader.readers.size(); ++i) {
            ((StackedReader)stdXMLReader.readers.elementAt(i)).systemId = stdXMLReader.currentReader.systemId;
        }
        return stdXMLReader;
    }
    ...
    protected Reader stream2reader(final InputStream inputStream, final StringBuffer sb) throws IOException {
    ...
    public Reader openStream(final String publicId, final String s) throws MalformedURLException, FileNotFoundException, IOException {
        URL resource = new URL(this.currentReader.systemId, s);
    ...
    public void startNewStream(final Reader reader, final boolean b) {
        final StackedReader currentReader = this.currentReader;
    ...
    public int getLineNr() {
        ...
        final StackedReader stackedReader = this.readers.peek();
    ...
    public void setSystemID(final String s) throws MalformedURLException {
        this.currentReader.systemId = new URL(this.currentReader.systemId, s);
    }
