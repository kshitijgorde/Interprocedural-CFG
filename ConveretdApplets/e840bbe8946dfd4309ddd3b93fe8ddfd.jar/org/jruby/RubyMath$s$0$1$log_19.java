...
public class RubyMath$s$0$1$log_19 extends JavaMethodN
{
    public RubyMath$s$0$1$log_19(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyMath.log_19(recv, array);
    }
}
