...
public final class DES extends ci
{
    public int[] nh;
    public int ng;
    public int nf;
    ...
    public final synchronized void nb(final byte[] array, final int n, final byte[] array2, final int n2, final int n3) {
        ...
        for (int n4 = n + n3, i = n, n5 = n2; i < n4; i += 8, n5 += 8) {
            this.nb(ng ^ ((array[i] & 0xFF) | (array[i + 1] & 0xFF) << 8 | (array[i + 2] & 0xFF) << 16 | (array[i + 3] & 0xFF) << 24), nf ^ ((array[i + 4] & 0xFF) | (array[i + 5] & 0xFF) << 8 | (array[i + 6] & 0xFF) << 16 | (array[i + 7] & 0xFF) << 24), array3);
            ng = array3[0];
            nf = array3[1];
            array2[n5] = (byte)(ng & 0xFF);
            array2[n5 + 1] = (byte)(ng >>> 8 & 0xFF);
            array2[n5 + 2] = (byte)(ng >>> 16 & 0xFF);
            array2[n5 + 3] = (byte)(ng >>> 24 & 0xFF);
            array2[n5 + 4] = (byte)(nf & 0xFF);
            array2[n5 + 5] = (byte)(nf >>> 8 & 0xFF);
            array2[n5 + 6] = (byte)(nf >>> 16 & 0xFF);
            array2[n5 + 7] = (byte)(nf >>> 24 & 0xFF);
        }
        this.ng = ng;
        this.nf = nf;
    }
    ...
    public final synchronized void na(final byte[] array, final int n, final byte[] array2, final int n2, final int n3) {
        ...
        for (int n4 = n + n3, i = n, n5 = n2; i < n4; i += 8, n5 += 8) {
            ...
            this.na(n6, n7, array3);
            final int n8 = ng ^ array3[0];
            final int n9 = nf ^ array3[1];
    ...
    public final void m9(final byte[] array) {
        ...
        for (int i = 0; i < 16; ++i) {
            ...
            n20 = (n22 & 0xFFFFFFF);
            n19 = (n23 & 0xFFFFFFF);
            final int n24 = DES.nm[0][n20 & 0x3F] | DES.nm[1][(n20 >>> 6 & 0x3) | (n20 >>> 7 & 0x3C)] | DES.nm[2][(n20 >>> 13 & 0xF) | (n20 >>> 14 & 0x30)] | DES.nm[3][(n20 >>> 20 & 0x1) | (n20 >>> 21 & 0x6) | (n20 >>> 22 & 0x38)];
            final int n25 = DES.nm[4][n19 & 0x3F] | DES.nm[5][(n19 >>> 7 & 0x3) | (n19 >>> 8 & 0x3C)] | DES.nm[6][n19 >>> 15 & 0x3F] | DES.nm[7][(n19 >>> 21 & 0xF) | (n19 >>> 22 & 0x30)];
            this.nh[i * 2] = (n25 << 16 | (n24 & 0xFFFF));
            final int n26 = n24 >>> 16 | (n25 & 0xFFFF0000);
            this.nh[i * 2 + 1] = (n26 << 4 | n26 >>> 28);
        }
    }
    
    public final void nb(int n, int n2, final int[] array) {
        final int n3 = (n2 >>> 4 ^ n) & 0xF0F0F0F;
        n ^= n3;
        n2 ^= n3 << 4;
        ...
        for (int i = 0; i < 32; i += 4) {
            final int n9 = n2 ^ this.nh[i];
            final int n10 = n2 ^ this.nh[i + 1];
            final int n11 = (n10 >>> 4) + (n10 << 28);
            n ^= (DES.nl[1][n11 & 0x3F] | DES.nl[3][n11 >>> 8 & 0x3F] | DES.nl[5][n11 >>> 16 & 0x3F] | DES.nl[7][n11 >>> 24 & 0x3F] | DES.nl[0][n9 & 0x3F] | DES.nl[2][n9 >>> 8 & 0x3F] | DES.nl[4][n9 >>> 16 & 0x3F] | DES.nl[6][n9 >>> 24 & 0x3F]);
            final int n12 = n ^ this.nh[i + 2];
            final int n13 = n ^ this.nh[i + 3];
            final int n14 = (n13 >>> 4) + (n13 << 28);
            n2 ^= (DES.nl[1][n14 & 0x3F] | DES.nl[3][n14 >>> 8 & 0x3F] | DES.nl[5][n14 >>> 16 & 0x3F] | DES.nl[7][n14 >>> 24 & 0x3F] | DES.nl[0][n12 & 0x3F] | DES.nl[2][n12 >>> 8 & 0x3F] | DES.nl[4][n12 >>> 16 & 0x3F] | DES.nl[6][n12 >>> 24 & 0x3F]);
        }
        n = (n >>> 1 | n << 31);
        n2 = (n2 >>> 1 | n2 << 31);
    ...
    public final void na(int n, int n2, final int[] array) {
        final int n3 = (n2 >>> 4 ^ n) & 0xF0F0F0F;
        n ^= n3;
        n2 ^= n3 << 4;
        final int n4 = (n >>> 16 ^ n2) & 0xFFFF;
