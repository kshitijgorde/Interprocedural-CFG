...
final class aC extends Canvas
{
    ...
    public aC(final ax q) {
        this.q = 100;
        this.q = false;
        this.q = q;
    }
    
    public final void q(final aA q) {
        this.q = q;
    }
    ...
    public final synchronized void update(final Graphics graphics) {
        this.getSize();
        if (aC.q == null) {
            aC.q = dU.q(this, this.getSize().width, this.getSize().height, "vcr.u");
        }
        final Graphics graphics2 = aC.q.getGraphics();
        this.q = new Rectangle(8, 0, 8, 150);
        graphics2.setColor(Color.black);
        graphics2.drawImage(this.q.q(aC.q), 0, 0, this);
        ...
        graphics2.dispose();
        graphics.drawImage(aC.q, 0, 0, this);
    }
