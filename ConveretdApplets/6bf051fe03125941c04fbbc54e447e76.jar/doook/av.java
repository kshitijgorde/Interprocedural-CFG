...
public final class av extends at
{
    ...
    public final void c() {
        ...
        final String parameter2 = av.a.getParameter("serverID");
        final String parameter3 = av.a.getParameter("nickname");
        final String x = null;
        final String v = null;
        final Object o = null;
        final String w = null;
        ...
        final String u = null;
        final String parameter4 = av.a.getParameter("floodControl");
        final String parameter5 = av.a.getParameter("autoPopup");
        final String parameter6 = av.a.getParameter("KickUserHTML");
        final String parameter7 = av.a.getParameter("logoutHTML");
        final String parameter8 = av.a.getParameter("noLogoutButton");
        ...
        if (parameter4 != null) {
            try {
                super.j = Integer.parseInt(parameter4);
            }
        ...
        try {
            ...
            super.L = Integer.parseInt(parameter2);
        }
