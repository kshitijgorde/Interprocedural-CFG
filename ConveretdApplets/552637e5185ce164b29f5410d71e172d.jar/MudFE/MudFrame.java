...
public class MudFrame extends WPPanel implements DialogClient, TextDisplayer
{
    ...
    public static final boolean d8x6 = false;
    public static final boolean d7x5 = true;
    ...
    void prompted() {
        ...
        if (this.showshield && this.hp == null) {
            (this.hp = new HealthPanel(this, this.getImage("shield7x5.jpg"), (LayoutManager)new ShieldLayout7x5())).hide();
            this.add("SH", this.hp);
    ...
    public void jbInit() throws Exception {
        ...
        this.dim = this.getImage("disconnect7x5.jpg");
    ...
    public MudFrame(final MudApplet a, final String cb) {
        ...
        try {
            ...
            this.defaultDisplay.setFontSize(11);
            this.setLayout(new PrettyLayout7());
            this.mainImage = this.getImage("a7x5.jpg");
            this.jbInit();
            final Image sImage = this.getSImage("shield7x5.jpg");
            this.sim = sImage;
            this.hp = new HealthPanel(this, sImage, (LayoutManager)new ShieldLayout7x5());
            this.co = (Panel)new Compas7(this);
    ...
    void do_history() {
        if (MudFrame.connected) {
            if (this.history) {
                ...
                this.history = true;
                if (this.Lbl == null) {
                    this.slim = this.getImage("stoplog7x5.jpg");
