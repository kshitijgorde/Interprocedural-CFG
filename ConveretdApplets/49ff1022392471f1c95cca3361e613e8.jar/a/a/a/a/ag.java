...
public class ag
{
    ...
    void char(final a3 a3, final a3 a4, final a3 a5) throws ar {
    ...
    void a(final a3 a3, final a3 a4, final a3 a5) {
        this.a(a4, a5);
        a3.char = 1;
        switch (a4.char) {
            case 4: {
                if (g.a(a4.int, a5.int) == 0) {
                    a3.long = true;
                    break;
                }
                a3.long = false;
    ...
    void case(final a3 a3, final a3 a4, final a3 a5) throws ar {
        this.a(a4, a5);
        a3.char = 1;
        switch (a4.char) {
            case 4: {
