...
public class RubyFileTest$s$1$0$size extends JavaMethodOne
{
    public RubyFileTest$s$1$0$size(final RubyModule implementationClass, final Visibility visibility) {
