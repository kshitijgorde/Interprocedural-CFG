...
public class a
{
    ...
    private static final int if = 32635;
    private static final int[] case;
    private static short[] for;
    private static final byte a = 15;
    private static final byte char = 4;
    private static final short[] byte;
    private static short[] else;
    private static byte[] try;
    private static byte[] new;
    ...
    public static byte a(int n) {
        ...
        n += 132;
        final int n3 = d.a.b.a.a.case[n >> 7 & 0xFF];
    ...
    public static short for(final byte b) {
        return d.a.b.a.a.for[b & 0xFF];
    }
    
    public static void int(final byte[] array, final int n, int i, final boolean b) {
        int n3;
        int n2 = n3 = n;
        if (b) {
            while (i > 0) {
    ...
    public static void do(final byte[] array, final int n, int n2, final boolean b) {
        n2 += n;
        if (b) {
            for (int i = n; i < n2; ++i) {
                array[i] = a(array[i] << 8);
    ...
    public static void int(final byte[] array, final int n, final byte[] array2, final int n2, int i, final boolean b) {
        ...
        int n4 = n;
        while (i > 0) {
            do(d.a.b.a.a.for[array[n4++] & 0xFF], array2, n3++, b);
            ++n3;
            --i;
        }
    }
    
    public static void new(final byte[] array, final int n, int n2, final boolean b) {
        n2 += n;
        if (b) {
            for (int i = n; i < n2; ++i) {
                array[i] = (byte)(d.a.b.a.a.for[array[i] & 0xFF] >> 8 & 0xFF);
            }
        }
        else {
            for (int j = n; j < n2; ++j) {
                array[j] = (byte)((d.a.b.a.a.for[array[j] & 0xFF] >> 8) + 128);
            }
        }
    }
    ...
    public static void do(final byte[] array, final int n, final byte[] array2, final int n2, int i, final boolean b) {
        ...
        if (b) {
            while (i > 0) {
                array2[n4++] = (byte)(d.a.b.a.a.for[array[n3++] & 0xFF] >> 8 & 0xFF);
                --i;
            }
        }
        else {
            while (i > 0) {
                array2[n4++] = (byte)((d.a.b.a.a.for[array[n3++] & 0xFF] >> 8) + 128);
                --i;
            }
        }
    }
    ...
    public static void a(final byte[] array, final int n, int n2, final boolean b) {
        ...
        if (b) {
            for (int i = n; i < n2; ++i) {
                array[i] = (byte)(d.a.b.a.a.else[array[i] & 0xFF] >> 8 & 0xFF);
            }
        }
        else {
            for (int j = n; j < n2; ++j) {
                array[j] = (byte)((d.a.b.a.a.else[array[j] & 0xFF] >> 8) + 128);
            }
        }
    }
    ...
    public static void byte(final byte[] array, final int n, final byte[] array2, final int n2, int i, final boolean b) {
        ...
        if (b) {
            while (i > 0) {
                array2[n4++] = (byte)(d.a.b.a.a.else[array[n3++] & 0xFF] >> 8 & 0xFF);
                --i;
            }
        }
        else {
            while (i > 0) {
                array2[n4++] = (byte)((d.a.b.a.a.else[array[n3++] & 0xFF] >> 8) + 128);
                --i;
            }
        }
    }
    ...
    public static void for(final byte[] array, final int n, final byte[] array2, final int n2, int i, final boolean b) {
        ...
        int n4 = n;
        while (i > 0) {
            do(d.a.b.a.a.else[array[n4++] & 0xFF], array2, n3++, b);
            ++n3;
            --i;
        }
    }
    ...
    public static byte do(final byte b) {
        return d.a.b.a.a.try[b & 0xFF];
    }
    
    public static void a(final byte[] array, final int n, int n2) {
        n2 += n;
        for (int i = n; i < n2; ++i) {
            array[i] = d.a.b.a.a.try[array[i] & 0xFF];
        }
    }
    ...
    public static void if(final byte[] array, final int n, final byte[] array2, final int n2, int i) {
        ...
        int n4 = n;
        while (i > 0) {
            array2[n4++] = d.a.b.a.a.try[array[n3++] & 0xFF];
            --i;
        }
    }
    
    public static byte a(final byte b) {
        return d.a.b.a.a.new[b & 0xFF];
    }
    
    public static void int(final byte[] array, final int n, int n2) {
        n2 += n;
        for (int i = n; i < n2; ++i) {
            array[i] = d.a.b.a.a.new[array[i] & 0xFF];
        }
    }
    ...
    public static void do(final byte[] array, final int n, final byte[] array2, final int n2, int i) {
        ...
        int n4 = n;
        while (i > 0) {
            array2[n3++] = d.a.b.a.a.new[array[n4++] & 0xFF];
            --i;
        }
    }
