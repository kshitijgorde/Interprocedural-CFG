...
public class Pointer$i$0$1$to_s extends JavaMethodN
{
    public Pointer$i$0$1$to_s(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((Pointer)rubyObject).to_s(context, array);
    }
}
