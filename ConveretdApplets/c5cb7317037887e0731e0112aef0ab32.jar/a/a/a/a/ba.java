...
public class ba extends bm
{
    ...
    public void c() {
        if (super.for && super.aI != -1 && super.aK != -1) {
            if (super.bs.i.w == null) {
                return;
            }
            float az;
            if (super.bs.i.w != null) {
                az = super.aZ + super.bs.i.w.W.cE - super.bs.i.w.T;
            }
            else {
                az = super.aZ;
            }
            ...
            final int n = 2000;
            if (super.bs.i.w.W.eI == 0.0f) {
                super.do = true;
                return;
            }
            final float n2 = (float)Math.atan2(super.bs.i.w.W.eM >> 1, super.bs.i.w.W.eI);
            if (Math.cos(super.bs.i.w.W.cx) >= 0.0) {
    ...
    void a(final ab ab) {
        if (super.for) {
            ...
            if (super.a0 && ab.if == 1) {
                ...
                if (super.bs.i.w != null) {
                    super.bs.i.w.W.ek = false;
                    super.bs.i.w.W.cE = n + super.bs.i.w.T - super.aZ;
                    super.bs.i.w.long = true;
                }
            }
        }
    }
