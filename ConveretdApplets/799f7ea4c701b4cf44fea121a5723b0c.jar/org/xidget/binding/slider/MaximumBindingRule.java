...
public class MaximumBindingRule implements IBindingRule
{
    ...
    private static final class Listener extends ExpressionListener
    {
        ...
        public void notifyAdd(final IExpression expression, final IContext context, final List<IModelObject> list) {
            ...
            this.xidget.getFeature(ISliderWidgetFeature.class).setMaximum(Xlate.get(this.node, 0.0));
        }
        ...
        public void notifyChange(final IExpression expression, final IContext context, final String s, final String s2) {
            try {
                this.xidget.getFeature(ISliderWidgetFeature.class).setMaximum(Double.parseDouble(s));
            }
            catch (Exception ex) {}
        }
        
        @Override
        public void notifyChange(final IExpression expression, final IContext context, final double maximum, final double n) {
            this.xidget.getFeature(ISliderWidgetFeature.class).setMaximum(maximum);
        }
        ...
        public void notifyValue(final IExpression expression, final IContext[] array, final IModelObject modelObject, final Object o, final Object o2) {
            if (modelObject == this.node) {
                this.xidget.getFeature(ISliderWidgetFeature.class).setMaximum(Xlate.get(modelObject, 0.0));
            }
        }
