...
public final class aI extends Panel implements ab
{
    private boolean b;
    private boolean c;
    public boolean a;
    ...
    public aI(final int n, final int n2, final bh a, final TextArea a2) {
        this(25, 25);
        this.a = a;
        this.a = a2;
        this.f = true;
        (this.a = new o(a, a2)).a(a.a.j);
        this.a.a = this.a.a(4);
        this.a.a(1);
        this.a.b = true;
