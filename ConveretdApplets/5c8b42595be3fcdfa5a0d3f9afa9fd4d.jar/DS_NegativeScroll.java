...
public class DS_NegativeScroll extends Applet implements Runnable
{
    Thread _fld0;
    int _fld1;
    Font _fld3;
    ...
    void _mth1b() {
        ...
        if (parameter == null) {
            this._fld6d = "Applet by Dario Sciacca";
        }
        else {
            this._fld6d = parameter;
        }
    ...
    void _mth2b() {
        this._mth4b();
        this._mth6b(this._fld3e = new int[this._fld4 * this._fld5], this._fld6);
        this._fld9d = this._fld4;
    ...
    void _mth3b() {
        ...
        if (this._fld9d < -this._fld2e) {
            this._fld9d = this._fld4;
        }
        for (int n = this._fld4 * this._fld5, i = 0; i < n; ++i) {
            this._fld7[i] = this._fld6[i];
        }
        this._mth5b(this._fld7, this._fld9d, this._fld7d, this._fld4, this._fld5, this._fld8d, 0, 0, this.tW - 1, this.tH - 1, this.tW, this.tH, this._fld6, this._fld3e);
        this._fld9 = this.createImage(this._fld8);
    }
    
    void _mth4b() {
        final FontMetrics fontMetrics = this.getGraphics().getFontMetrics(this._fld5d);
        this.tW = fontMetrics.stringWidth(this._fld6d);
        this.tH = fontMetrics.getHeight();
        this._fld8d = new int[this.tW * this.tH];
        new MemoryImageSource(this.tW, this.tH, this._fld8d, 0, this.tW);
        final Image image = this.createImage(this.tW, this.tH);
        final Graphics graphics = image.getGraphics();
        graphics.setColor(Color.black);
        graphics.fillRect(0, 0, this.tW, this.tH);
        graphics.setFont(this._fld5d);
        final int n = (this.tH >> 1) + (this.tH >> 3);
        graphics.setColor(Color.white);
        graphics.drawString(this._fld6d, 0, n);
        final PixelGrabber pixelGrabber = new PixelGrabber(image, 0, 0, this.tW, this.tH, this._fld8d, 0, this.tW);
        try {
            pixelGrabber.grabPixels();
        }
        catch (InterruptedException ex) {}
        for (int i = 0; i < this.tW * this.tH; ++i) {
            if ((this._fld8d[i] & 0xFF) == 0xFF) {
                this._fld8d[i] = 255;
            }
            else {
                this._fld8d[i] = 0;
        ...
        if (this._fld7d == -10000) {
            this._fld7d = (this._fld5 >> 1) - (n >> 1);
        }
    }
    
    void _mth5b(final int[] array, int n, int n2, final int n3, final int n4, final int[] array2, int n5, int n6, int n7, int n8, final int n9, final int n10, final int[] array3, final int[] array4) {
        ...
        for (int i = 0; i < n11; ++i) {
            ...
            for (int j = 0; j < n12; ++j) {
                if (array2[n14 + j] == 255) {
                    array[n13 + j] = array4[n13 + j];
                }
                else {
                    array[n13 + j] = array3[n13 + j];
                }
            }
        }
    }
    ...
    void _mth7b() {
        ...
        if (host.length() > 0 && this._fld4e.length() > 9) {
            ...
            this._fld4e.getBytes(1, n + 1, this._fld0f, 0);
            this._fld1f = new byte[n2];
            this._fld4e.getBytes(0, n2, this._fld1f, 0);
            int n3 = n % 7;
            final int n4 = n % 3;
            for (int i = 0; i < n; ++i) {
        ...
        try {
            this._fld8e = new URL("http://" + this._fld6b);
        }
        catch (MalformedURLException ex) {
            this._fld8e = null;
        }
    ...
    public final boolean mouseDown(final Event event, final int n, final int n2) {
        ...
        else if (this._fld5e != null) {
            if (this._fld6e != null) {
                this.getAppletContext().showDocument(this._fld5e, this._fld6e);
            }
            else {
                this.getAppletContext().showDocument(this._fld5e);
            }
        }
        return true;
    }
    ...
    void _mth8b() {
        this._fld2f = this.getParameter("overtext");
        if (this._fld2f != null) {
            this._fld9b = true;
            this._fld3f = this._mth0b("overtextcol", new Color(16777215));
            this._fld4f = this._mth0b("overtextcols", new Color(0));
            ...
            this._fld5f = new Font(parameter, n, int1);
            this._fld6f = this._fld2c.getFontMetrics(this._fld5f);
            final int stringWidth = this._fld6f.stringWidth(this._fld2f);
            final int height = this._fld6f.getHeight();
            final int n2 = (height >> 1) + (height >> 3);
            final String parameter4 = this.getParameter("overtextx");
            if (parameter4 == null) {
                this._fld7f = (this._fld4 >> 1) - (stringWidth >> 1);
            }
            else {
                this._fld8f = Integer.parseInt(parameter4);
            }
            final String parameter5 = this.getParameter("overtexty");
            if (parameter5 == null) {
                this._fld8f = (this._fld5 >> 1) - (n2 >> 1);
                return;
            }
            this._fld8f = Integer.parseInt(parameter5) + n2;
        }
    }
    ...
    void _mth9b(final Graphics graphics) {
        ...
        graphics.drawString(this._fld2f, this._fld7f + 1, this._fld8f + 1);
        graphics.setColor(this._fld3f);
        graphics.drawString(this._fld2f, this._fld7f, this._fld8f);
    }
    ...
    public DS_NegativeScroll() {
        ...
        this._fld9b = false;
        this._fld0c = false;
        this._fld2d = "NegativeScroll started";
        this._fld4d = false;
        this._fld4e = "";
        this._fld6e = "_blank";
        this._fld7e = "Applet by Dario Sciacca";
        this._fld9e = false;
    }
}
