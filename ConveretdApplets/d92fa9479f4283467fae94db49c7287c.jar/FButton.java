...
public class FButton
{
    ...
    public FButton(final Image img, final int indexNumber, final int indexNumberDown, final int xPos, final int yPos) {
    ...
    public FButton(final int image, final int indexNumber, final int indexNumberDown, final int indexNumberUnabled, final int xPos, final int yPos) {
        this.scrX = new int[] { 0, 80, 160, 240, 320, 380 };
        this.scrY = new int[] { 0, 0, 0, 0, 0, 0 };
        this.widthX = new int[] { 80, 80, 80, 80, 60, 60 };
        this.heightX = new int[] { 15, 15, 15, 15, 15, 15 };
