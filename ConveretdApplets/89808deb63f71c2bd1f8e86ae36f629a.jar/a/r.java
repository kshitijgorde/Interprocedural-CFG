...
public final class r
{
    ...
    public final int q(final String s) {
        if (this.q != null) {
            ...
            for (int i = 0; i < w.q; ++i) {
                final aO ao;
                if ((ao = (aO)w.q(i)).e().trim().equals(s)) {
                    return ao.w();
                }
            }
        }
    ...
    public final synchronized void w() {
        ...
        for (int i = 0; i < w.q; ++i) {
            final String trim = ((aO)w.q(i)).e().trim();
            boolean b;
            do {
                final int index;
                boolean b4 = false;
                ...
                if (b3) {
                    ...
                    if ((cu.q() && this.u >= ((cq)this.q).Y) || (cu.w() && this.u >= ((cq)this.q).P)) {
    ...
    private String q(String s, final Hashtable hashtable) {
        this.u = 0;
        final String[] q = cg.q(s, "<RPL_DELIM>");
        int index;
    ...
    public r(final String s, final l q, final boolean b, final boolean b2, final av av, final br q2) {
        this(s, q.o, b, b2, av, q.s, q.q(62) || q.q(61), q.q(59), q.t, q.w());
        this.u = q.q(23);
        (this.q = q).q(61);
        this.g = q.s;
        this.q = q2;
    ...
    public r(final String s, final String w, final boolean e, final boolean r, final av av, final int t, final boolean w2, final boolean y, final int p10, final int i) {
        this.i = false;
        this.a = 1;
        this.s = 0;
        this.p = false;
