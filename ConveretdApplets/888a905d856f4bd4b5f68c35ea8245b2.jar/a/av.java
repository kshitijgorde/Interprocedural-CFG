...
public final class av extends Panel implements ef
{
    public transient dG q;
    private transient dG w;
    private Color q;
    private boolean q;
    private TextField q;
    private TextField w;
    ...
    public av(final cM q) {
        ...
        final dT dt = new dT();
        final dT dt2;
        (dt2 = new dT()).setLayout(gridBagLayout);
        dt2.setBackground(bC.w.q);
        dt2.setForeground(bC.w.q);
        dt.setLayout(gridBagLayout);
        dt.setBackground(bC.w.i);
        dt.setForeground(bC.w.u);
        (this.q = new Panel()).setLayout(this.q);
        (this.q = new X(this)).setCursor(Cursor.getPredefinedCursor(1));
        (this.q = new ec(this)).setSize(new Dimension(150, 165));
        ...
        if (this.q == null) {
            ...
            switch (this.q) {
                case 0: {
                    this.q = new dG(0, 150, 150, q2[0], 1.0f, 1.0f);
                    this.w = new dG(3, 16, 150, 0.0f, 1.0f, 1.0f);
                    break;
                }
                case 1: {
                    this.q = new dG(1, 150, 150, 1.0f, q2[1], 1.0f);
                    this.w = new dG(4, 16, 150, 1.0f, 0.0f, 1.0f);
                    break;
                }
                case 2: {
                    this.q = new dG(2, 150, 150, 1.0f, 1.0f, q2[2]);
                    this.w = new dG(5, 16, 150, 1.0f, 1.0f, 0.0f);
                    break;
                }
            }
            this.q.q = this.q;
        ...
        panel3.setBackground(bC.w.i);
        panel3.setForeground(bC.w.u);
        panel3.add(panel5, "Center");
        final Panel panel6;
        (panel6 = new Panel()).setBackground(bC.w.i);
        panel6.setForeground(bC.w.u);
        panel6.add(this.q);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        gridBagLayout.setConstraints(dt2, gridBagConstraints);
        this.add(dt2);
        this.q(0);
