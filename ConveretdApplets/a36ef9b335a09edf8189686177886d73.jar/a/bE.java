...
final class bE extends A
{
    ...
    public final boolean handleEvent(final Event event) {
        switch (event.id) {
            ...
            case 506: {
                ((p)(this.q.q = null)).setValue(this.q.w - (event.y - this.q));
                final int n;
            ...
            case 1001: {
                final bF bf;
                if (event.arg instanceof bF && (bf = (bF)event.arg).y != -1) {
                    this.q.q.p(bf.y);
                    break;
                }
                break;
    ...
    public final int q(final Graphics graphics, int n, final int n2) {
        ...
        if (this.q == null || (this.getSize().height != 0 && this.getSize().height != this.w) || (this.getSize().width != 0 && this.getSize().width != this.e)) {
            ...
            this.q = co.q(this, this.e, this.w, "mpe.a");
        }
