...
public abstract class aO implements aQ, as
{
    private av q;
    private aH q;
    private Window q;
    ...
    public aO(final Component component, final bI bi) {
        this(component, 12632319, bi);
    }
    
    private aO(final Component q, final int n, final bI bi) {
        this.q = 15;
    ...
    protected final void y() {
        ...
        this.q = new av(this.q, this, true, null);
    }
    ...
    protected final void q(final int n, final int n2) {
        this.q(this);
        this.q.requestFocus();
        (this.q = cp.q(this.q, this.q)).setLocation(n, n2);
        this.q.setSize(0, 0);
        this.q((Component)this.q);
        final int n3 = this.q.q() * this.q + this.q.w() * 3 + 4 + (bI.a() ? 0 : this.q);
    ...
    private synchronized void q(final aO ao) {
        if (aO.q == null) {
            aO.q = ao;
            return;
        }
    ...
    private synchronized void w(final aO ao) {
        if (aO.q == ao) {
            aO.q = null;
        }
    }
    ...
    private aH q(final String s, final boolean b) {
        ...
        while (this.q(s + n)) {
            ...
            final String s3 = (q3 != null) ? (cl.q("=5>E") + "_" + cl.q(q3.toLowerCase(), ' ', '_') + ".gif") : null;
            if (q4 == null) {
                q4 = s3;
            }
            Image image;
