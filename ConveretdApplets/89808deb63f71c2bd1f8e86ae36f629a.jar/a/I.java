...
final class I extends Panel
{
    ...
    public final synchronized void update(final Graphics graphics) {
        if (I.q == null) {
            I.q = cu.q(this, this.getSize().width, this.getSize().height, "cpp.u");
        }
        final Graphics graphics2;
        (graphics2 = I.q.getGraphics()).drawImage(this.q.q(I.q), 0, 0, this);
        graphics2.setColor(Color.white);
        graphics2.drawOval(this.q.q.x - 4, this.q.q.y - 4, 8, 8);
        graphics2.dispose();
        graphics.drawImage(I.q, 0, 0, this);
    }
}
