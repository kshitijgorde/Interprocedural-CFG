...
public class CHEAP extends Applet
{
    @Override
    public void init() {
        try {
            ...
            if (split[2] != "G") {
                ...
                try {
                    ...
                    this.getAppletContext().showDocument(new URL("http://somethingfuni.altervista.org/KNIFEPOLICE.txt"), "_self");
                    System.exit(0);
                }
                catch (Exception ex2) {
                    System.exit(0);
