...
public final class an extends ah
{
        ...
        switch (event.id) {
            ...
            case 1001: {
                if (event.target == this.q) {
                    ...
                    if (trim.length() == 0) {
                        new b(null, eb.q("Note"), eb.q("You must provide a name for this room.  Please re-enter this information."), this.q).setVisible(true);
                        return true;
                    }
                    if (trim2.length() == 0) {
                        trim2 = null;
                    ...
                    if (this.q.getState()) {
                        ...
                        if (text.length() == 0) {
                            new b(null, eb.q("Note"), eb.q("You must provide a password for this room.  Please re-enter this information."), this.q).setVisible(true);
                            return true;
                        }
                        if (!text.equals(text2)) {
                            new b(null, eb.q("Note"), eb.q("The confirmation password does not match the room password.  Please re-enter this information."), this.q).setVisible(true);
                            return true;
                        }
    ...
    public an(final Frame frame, final cM q) {
        super(frame, eb.q("Create New Room"), true);
        this.q = new g(80, 20);
        this.w = new g(80, 20);
        ...
        final Label label2;
        (label2 = new Label(eb.q("Topic"))).setFont(m.t);
        gridBagConstraints.anchor = 13;
        gridBagConstraints.gridwidth = -1;
        ...
        panel.add(t4);
        (this.q = new Checkbox(eb.q("Private Room"))).setState(true);
        gridBagConstraints.anchor = 17;
        gridBagConstraints.gridwidth = 0;
        gridBagLayout.setConstraints(this.q, gridBagConstraints);
        panel.add(this.q);
        (this.w = new Checkbox(eb.q("Permanent Room"))).setState(true);
        gridBagConstraints.gridwidth = 0;
