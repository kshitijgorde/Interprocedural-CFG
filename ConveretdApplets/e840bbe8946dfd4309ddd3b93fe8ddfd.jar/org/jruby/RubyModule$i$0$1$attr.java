...
public class RubyModule$i$0$1$attr extends JavaMethodN
{
    public RubyModule$i$0$1$attr(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyModule)rubyObject).attr(context, array);
    }
}
