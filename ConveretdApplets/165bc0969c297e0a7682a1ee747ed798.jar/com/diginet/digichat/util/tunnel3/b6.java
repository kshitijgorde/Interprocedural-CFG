...
public class b6 implements b7, Runnable
{
    private String a;
    private boolean b;
    private Vector c;
    ...
    public dg a() throws IOException {
        synchronized (this) {
            if (!this.b) {
                this.c();
            }
        ...
        while (this.b) {
            synchronized (this.c) {
                if (this.c.size() > 0) {
                    if (this.e != -1L) {
                        System.out.println(String.valueOf(this.e).concat(String.valueOf(" got message")));
                    }
                    final dg dg = this.c.elementAt(0);
    ...
    public void a(final dg dg) throws IOException {
        if (dg == null) {
            throw new NullPointerException("HttpTunnelingClientModule: send called with null Message.");
        }
        if (this.e != -1L) {
            System.out.println(String.valueOf(this.e).concat(String.valueOf(" sent message")));
        }
        synchronized (this) {
            if (!this.b) {
                this.c();
    ...
    public void run() {
        while (this.b) {
            try {
                ...
                final URLConnection openConnection = new URL(String.valueOf(String.valueOf(this.a).concat(String.valueOf("?clientID="))).concat(String.valueOf(this.d))).openConnection();
                ...
                for (int int1 = dataInputStream.readInt(), i = 0; i < int1; ++i) {
                    if (this.e != -1L) {
                        System.out.println(String.valueOf(this.e).concat(String.valueOf(" queued message")));
                    }
                    final byte[] array = new byte[dataInputStream.readInt()];
                    dataInputStream.readFully(array);
                    this.c.addElement(new dg(array));
                    synchronized (this.c) {
                        this.c.notify();
                    }
                    // monitorexit(this.c)
    ...
    public b6(final String a, final long d) throws MalformedURLException {
        this.a = null;
        this.b = false;
        this.c = null;
        this.d = -1L;
