...
public class nsIDataType extends nsISupports
{
    ...
    public static final String NS_IDATATYPE_IID_STR = "4d12e540-83d7-11d5-90ed-0010a4e73d9a";
    ...
    static {
        LAST_METHOD_ID = nsISupports.LAST_METHOD_ID + 0;
        NS_IDATATYPE_IID = new nsID("4d12e540-83d7-11d5-90ed-0010a4e73d9a");
    }
    
    public nsIDataType(final int n) {
        super(n);
    }
}
