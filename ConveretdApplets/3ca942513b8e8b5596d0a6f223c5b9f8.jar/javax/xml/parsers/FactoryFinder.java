...
class FactoryFinder
{
    ...
    static Object find(final String s, final String s2) throws ConfigurationError {
        ...
        if (classLoader == null) {
            classLoader = ((FactoryFinder.class$javax$xml$parsers$FactoryFinder == null) ? (FactoryFinder.class$javax$xml$parsers$FactoryFinder = class$("javax.xml.parsers.FactoryFinder")) : FactoryFinder.class$javax$xml$parsers$FactoryFinder).getClassLoader();
        }
        ...
        final Class clazz = (FactoryFinder.class$javax$xml$parsers$FactoryFinder == null) ? (FactoryFinder.class$javax$xml$parsers$FactoryFinder = class$("javax.xml.parsers.FactoryFinder")) : FactoryFinder.class$javax$xml$parsers$FactoryFinder;
        synchronized (clazz) {
            int n = 0;
