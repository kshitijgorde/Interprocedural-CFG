...
public class squarehelper2 extends Canvas
{
    ...
    public squarehelper2(final squarelink2 mApplet) {
        this.mnShape = 0;
        this.mnStyle = 0;
        ...
        this.msClickText = "";
        this.mnFontStyle = 0;
        this.mnMouseFontStyle = 0;
        this.mnClickFontStyle = 0;
        this.mbUnderline = false;
        this.mbMouseUnderline = false;
        this.mbClickUnderline = false;
        this.mnTextVAlign = 0;
        this.mnMouseTextVAlign = 0;
        this.mnClickTextVAlign = 0;
