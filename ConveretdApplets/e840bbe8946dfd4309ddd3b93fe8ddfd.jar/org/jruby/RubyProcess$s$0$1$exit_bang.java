...
public class RubyProcess$s$0$1$exit_bang extends JavaMethodN
{
    public RubyProcess$s$0$1$exit_bang(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyProcess.exit_bang(recv, array);
    }
}
