...
public final class au implements ImageObserver
{
    ...
    public final void q(final Graphics graphics, int n, int n2, final int n3, final boolean b) {
        if (this.q instanceof Image) {
            ...
            be.q(graphics, this.q.toString(), n + 7, 0, n2 - 12, n3, 0, false);
        }
    }
    
    final boolean q(Graphics graphics, final bO bo, final Object o, int int1, int n, int n2, int n3, final boolean b) {
        if (o == null && bo.q instanceof l) {
            return false;
        }
        if (o instanceof Boolean) {
            ...
            if (height == 0 || height == 0) {
                ...
                if (this.q.q != null && cs.q()) {
                    int1 = 0;
                    if (this.q.q.q().containsKey("" + ((l)bo.q).s)) {
                        int1 = Integer.parseInt(this.q.q.q().get("" + ((l)bo.q).s));
                    }
                    if (int1 > 0) {
            ...
            n = n19 + (n - 15) / 2;
            n3 = int1 + (n2 - 15) / 2 - 1;
            cv.q(graphics, 15, 15, color2, n, n3);
        }
        else if (o != null) {
            ...
            graphics8.setFont(new Font(graphics8.getFont().getFamily(), ((aJ)bo.q).e(), graphics8.getFont().getSize()));
            Color color3 = null;
            Label_0822: {
                Color q;
                if (b) {
                    if ((aS.w.Q.getRGB() & 0xFF) == 0x0) {
                        color3 = (bo.q ? bo.w : Color.lightGray);
                        break Label_0822;
                    }
                    q = aS.w.Q;
                }
                else {
                    q = ((bo.q instanceof aJ && (((aJ)bo.q).w() & 0xFF) != 0x0) ? new Color(((aJ)bo.q).w()) : (bo.q ? bo.q : Color.gray));
                }
                color3 = q;
            }
            graphics8.setColor(color3);
            be.q(graphics8, s, n + 5, n2, n3 - 8, n23, 0, bo.w, bo);
        }
        return true;
    }
