...
final class ObjectFactory
{
    ...
    static /* synthetic */ Class class$org$apache$xml$serialize$ObjectFactory;
    ...
    static Object createObject(final String s, String string, final String s2) throws ConfigurationError {
        ...
        if (string == null) {
            ...
            final Class clazz = (ObjectFactory.class$org$apache$xml$serialize$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xml$serialize$ObjectFactory = class$("org.apache.xml.serialize.ObjectFactory")) : ObjectFactory.class$org$apache$xml$serialize$ObjectFactory;
            synchronized (clazz) {
                boolean b = false;
    ...
    static ClassLoader findClassLoader() throws ConfigurationError {
        ...
        for (ClassLoader classLoader3 = ((ObjectFactory.class$org$apache$xml$serialize$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xml$serialize$ObjectFactory = class$("org.apache.xml.serialize.ObjectFactory")) : ObjectFactory.class$org$apache$xml$serialize$ObjectFactory).getClassLoader(), parentClassLoader = classLoader; classLoader3 != parentClassLoader; parentClassLoader = instance.getParentClassLoader(parentClassLoader)) {
    ...
    static Class findProviderClass(final String s, ClassLoader classLoader, final boolean b) throws ClassNotFoundException, ConfigurationError {
        ...
        if (classLoader == null) {
            ...
            try {
                ...
                final ClassLoader classLoader2 = ((ObjectFactory.class$org$apache$xml$serialize$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xml$serialize$ObjectFactory = class$("org.apache.xml.serialize.ObjectFactory")) : ObjectFactory.class$org$apache$xml$serialize$ObjectFactory).getClassLoader();
                if (classLoader2 == null) {
                    clazz = Class.forName(s);
                }
                else {
