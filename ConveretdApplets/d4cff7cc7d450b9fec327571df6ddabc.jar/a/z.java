...
public final class z extends Panel
{
    ...
    public final Dimension preferredSize() {
        ...
        final FontMetrics fontMetrics = this.getFontMetrics(z.q);
        ...
        final Dimension dimension = new Dimension(Math.max(preferredSize.width, be.w.p), preferredSize.height);
        return new Dimension(Math.max(dimension.width, n2 + 10 + this.q.u / 2), Math.max(dimension.height, 42));
    }
            ...
            for (int n6 = 0; (n == -1 || n6 <= n || n6 <= n2) && n6 < size; ++n6) {
                ...
                if (n == -1 || n6 == n || n6 == n2) {
                    ...
                    if (n6 == this.w) {
                        ...
                        graphics.setColor((this.q.u == 0) ? Color.white : darker);
                        graphics.drawLine(n3, n7 + 22, n9, n7 + 22);
                        graphics.setColor((this.q.u == 0) ? Color.black : darker2);
    ...
    public final void paint(final Graphics graphics) {
        ...
        if (this.q.u != 0) {
            ...
            graphics.fillRoundRect(0, 22, n2, n - 22, u, u);
            graphics.drawArc(n2 - u, n - u - 1, u, u, 0, -90);
            graphics.fillRect(0, 22, u << 1, u << 1);
            graphics.setColor(background.darker());
            if (this.q) {
                graphics.drawLine(0, 22, n2 - u / 2, 22);
            }
            graphics.drawLine(n2, 22 + u / 2 - 2, n2, n - u / 2);
            graphics.drawArc(n2 - u, 22, u, u - 1, 0, 90);
            graphics.drawArc(n2 - u, n - u, u, u, 0, -90);
            graphics.drawLine(u / 2 - 1, n, n2 - u / 2, n);
            graphics.drawLine(0, 22, 0, n - u / 2);
            graphics.drawArc(0, n - u, u, u, 180, 90);
        }
        else {
            graphics.setColor(background2);
    ...
    private z(final int t, int n, final int i, final int u, final int e, final bz q, final boolean q2) {
        this.q = 12;
    ...
    public z(final int n, final int n2, final int n3, final int n4, final int n5, final bz bz) {
        this(2, 10, 2, 10, n5, bz, false);
    }
    
    public z(final bz bz, final boolean b) {
        this(4, 4, 4, 4, 1, bz, b);
    }
