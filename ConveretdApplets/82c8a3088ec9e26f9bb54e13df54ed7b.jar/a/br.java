...
public abstract class br implements bs, cC
{
    protected W q;
    private P q;
    private aV q;
    ...
    public br(final Component component, final W w) {
        this(component, 12632319, w);
    }
    
    private br(final Component q, final int n, final W q2) {
        this.q = 15;
    ...
    private synchronized void q(final br br) {
        if (br.q == null) {
            br.q = br;
            return;
        }
    ...
    private synchronized void w(final br br) {
        if (br.q == br) {
            br.q = null;
        }
    }
