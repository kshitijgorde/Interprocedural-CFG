...
public class ba extends bm
{
    ...
    public void c() {
        if (super.for && super.aI != -1 && super.aK != -1) {
            if (super.bs.i.B == null) {
                return;
            }
            float az;
            if (super.bs.i.B != null) {
                az = super.aZ + super.bs.i.B.W.cE - super.bs.i.B.T;
            }
            else {
                az = super.aZ;
            }
            ...
            final int n = 2000;
            if (super.bs.i.B.W.eI == 0.0f) {
                super.do = true;
                return;
            }
            final float n2 = (float)Math.atan2(super.bs.i.B.W.eM >> 1, super.bs.i.B.W.eI);
            if (Math.cos(super.bs.i.B.W.cx) >= 0.0) {
    ...
    void a(final ab ab) {
        if (super.for) {
            ...
            if (super.a0 && ab.if == 1) {
                ...
                if (super.bs.i.B != null) {
                    super.bs.i.B.W.ek = false;
                    super.bs.i.B.W.cE = n + super.bs.i.B.T - super.aZ;
                    super.bs.i.B.long = true;
                }
            }
        }
    }
