...
public abstract class aJ implements aW, bV, Cloneable
{
    public int s;
    public int d;
    public int f;
    ...
    public int q(final aW aw, final String s) {
        if ("name".equals(s) && aw instanceof aJ) {
            return this.o.toLowerCase().compareTo(((aJ)aw).o.toLowerCase());
        }
        if ("ID".equals(s) && aw instanceof aJ) {
            return this.s - ((aJ)aw).s;
        }
        return 0;
    }
