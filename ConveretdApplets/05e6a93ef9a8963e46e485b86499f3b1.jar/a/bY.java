...
public final class bY extends aG implements aB
{
    ...
    private void q(final aK ak) {
        if (ak != null) {
            int i = ak.w();
            final int d = ak.d;
            if (ak instanceof bw && i == 0) {
                i = 128;
            }
            if (ak instanceof l && ((l)ak).w) {
                i = Color.red.getRGB();
            }
            this.w.o = d;
            this.w.i = i;
    ...
    private as q(final int n) {
        return (as)super.q.t().w(n);
    }
    
    protected final synchronized void q(final s w, int n, final Graphics graphics) {
        try {
            this.p = 0;
            this.w = w;
            if (w.q != null) {
            ...
            final int n4 = n + 3 + 1;
            final Font w2 = aT.w.w();
            final Font q = aT.w.q();
            if (w.p) {
                graphics.setColor(aT.w.g);
            }
            else if (w.e) {
                graphics.setColor(aT.w.d);
            }
            else if (w.r) {
                graphics.setColor(aT.w.f);
            }
            else if (w.q && super.q.y()) {
                graphics.setColor(aT.w.p);
            }
            else if (w.s != 0) {
                graphics.setColor(new Color(w.s));
            }
            else {
                graphics.setColor(aT.w.a);
            }
            if (this.q(w.t) != null && this.q(w.t).i != 0 && !w.e) {
                graphics.setColor(new Color(this.q(w.t).i));
            }
            if (graphics.getColor() != aT.w.a && super.w && super.q != null) {
            ...
            if (n >= n3 && n - this.i <= n2) {
                ...
                if (w.p > 999) {
                    final bu bu = (bu)super.q.q().w(w.p);
                    Image q2 = null;
                    if (bu != null) {
                        q2 = bu.q;
                    }
                    if (q2 != null) {
                        graphics.drawImage(q2, aG.q - 1, n - 11, null);
                    }
                }
                if (w.i) {
                    this.q((aK)super.q.i().w(w.t));
                }
                ...
                final int n5 = (w.p == 0) ? aG.q : (aG.q + 14);
                if (w.q instanceof as && ((as)w.q).q != null) {
                    graphics.drawImage(((as)w.q).q, n5, n - 12, null);
                    final int height;
                    if ((height = ((as)w.q).q.getHeight(null)) > 10) {
                        this.y += height - 10;
                    }
                }
                else {
                ...
                if (w.e && super.w) {
                    as as;
                    if ((as = (as)super.q.t().w(w.t)) != null && as.q(59) && ((bx)super.q.r().w(as.r)).q(61)) {
                        final String q3 = al.q("(Private message from Guest Speaker)");
                        graphics.setColor(aT.w.o);
                        graphics.drawString(q3, aG.q + this.q.stringWidth(w.w + "######"), n);
                    }
                    else if (w.y == -1 && !w.p) {
                        if (as == null) {
                            as = (as)w.q;
                        }
                        if (super.q.y().w(as.a) == null) {
                            final String q4 = al.q("(Single click on this message to reply)");
                            graphics.setColor(aT.w.o);
                            graphics.drawString(q4, aG.q + this.q.stringWidth(w.w + "######"), n);
                        }
                    }
                }
                final aP ap;
                if (w.r && super.w && w.y == -1 && !w.p && (ap = (aP)super.q.u().w(w.d)) == null) {
                    final String q5 = al.q(ce.q("S#9>7<5K3<93;K?>KD89CK=5CC175KD?K:?9>K3?>65B5>35T"));
                    graphics.setColor(aT.w.o);
                    graphics.drawString(q5, aG.q + this.q.stringWidth(w.w + "######"), n);
                }
            }
            if (super.q.t()) {
                graphics.setFont(aT.w.e());
                graphics.setColor(new Color(16125039));
                graphics.drawString(w.e, aG.q, this.y);
    ...
    private void q(final boolean b, final Graphics graphics, String trim, final int n, final boolean b2, final boolean b3) {
        if (b && !"".equals(trim)) {
            ...
            for (int n5 = 0; n5 < this.u && (q = this.q.q.q(trim, ++q)) != -1 && q < length; ++n5) {
                ...
                final R q2;
                if (((q2 = this.q.q.q(trim.substring(q, index))) != null && q2.q != null && this.w.q != null && ((cs.q() && this.p < ((co)this.w.q).R) || (cs.w() && this.p < ((co)this.w.q).P))) || this.w.i) {
    ...
    public final synchronized void q(final s s, final int n, final FontMetrics fontMetrics) {
        try {
            final int index;
            if (s.p && (index = s.q.indexOf(" > ")) >= 0) {
                s.q = s.q.substring(0, index) + "\n" + s.q.substring(index + " > ".length());
                s.q();
                s.w();
            }
            final int stringWidth = fontMetrics.stringWidth(s.q);
            final int n2 = this.getSize().width - 65;
            if (s.q != null && s.q != null && n2 > 0 && stringWidth > n2 * s.a && !s.p) {
                String string = "";
                for (int i = 0; i < s.q.length(); ++i) {
                    string += s.q.charAt(i);
                    if (fontMetrics.stringWidth(string) > n2 * s.a) {
                        s.q = string.substring(0, string.length() - 1);
                        s.q();
                        s.w();
                        break;
                    }
            ...
            final String s2 = new String(s.q);
            int n3 = 0;
            s.q[0] = 0;
            s.w = 0;
            ...
            while (stringTokenizer.hasMoreTokens()) {
                ...
                if (s.q == null || (s.q != null && n4++ < s.a) || s.p) {
            ...
            for (int j = 0; j < array.length; ++j) {
                ...
                array2[n5] = length;
                for (int n12 = 1; n12 <= n5 && s.w < 30; ++n12) {
                    s.q[++s.w] = array2[n12] + n3;
                }
                n3 += array2[n5];
            }
            s.q = "";
            ...
            if (16 > fontMetrics.getHeight()) {
                for (int n14 = 0; n14 < s.w; ++n14) {
                    if (this.q.q.q(s.q.substring(s.q[n14], s.q[n14 + 1])) > 0) {
                        n13 += 16 - fontMetrics.getHeight();
                    }
                }
            }
            this.getFontMetrics(aT.w.e());
            final int height;
            if (s.q != null && s.q instanceof as && ((as)s.q).q != null && (height = ((as)s.q).q.getHeight(null)) > 12) {
                n13 += height - 12;
            }
            s.q = 6 + fontMetrics.getHeight() * (s.w + 1) + n13;
        }
        catch (Exception ex) {}
    }
    ...
    private String q(String substring, final Graphics graphics, final int n, final int n2) {
        ...
        if (this.q != null && this.w.q != null) {
            for (int i = 0; i < this.q.q; ++i) {
                final as as;
                if ((as = (as)this.q.q(i)) != null && as.o != null && substring.length() > as.o.length() && substring.substring(0, as.o.length()).equals(as.o) && as.a == this.w.q.q()) {
                    this.r = q(graphics, as.o, font2, fontMetrics, n, n2);
                    substring = substring.substring(as.o.length());
                    break;
                }
            }
        }
    ...
    private void q(String s, final Graphics graphics, int n, final int n2) {
        final aL al = new aL(graphics.getFont());
        final FontMetrics fontMetrics = this.getFontMetrics(al.r());
        final FontMetrics fontMetrics2 = this.getFontMetrics(al.q());
        final FontMetrics fontMetrics3 = this.getFontMetrics(al.w());
        final FontMetrics fontMetrics4 = this.getFontMetrics(al.e());
        s = s;
        int n3 = 0;
        int n4 = 0;
        ...
        if (s.indexOf("i]") >= 0 || s.indexOf("b]") >= 0) {
            for (int j = 0; j < s.length(); ++j) {
                if (s.charAt(j) == '[' && j + 2 < s.length()) {
                    if (s.charAt(j + 1) == 'i' && s.charAt(j + 2) == ']') {
                        if (n12 == 0) {
                            n += q(graphics, s.substring(q(n9, n10), j), al.r(), fontMetrics, n, n2);
                        }
                        else if (n11 != 0 && j + 3 < s.length()) {
                            s = s.substring(0, j) + s.substring(j + 3);
                        }
                        else {
                            n += q(graphics, s.substring(n8 + 3, j), al.w(), fontMetrics3, n, n2);
                        }
                        n7 = j;
                        n11 = 1;
                        j += 2;
                        ...
                        if (n11 != 0 && n12 == 0) {
                            n += q(graphics, s.substring(q(n7 + 3, n10), j), al.q(), fontMetrics2, n, n2);
                            n11 = 0;
                        }
                        else if (n11 != 0 && n12 != 0) {
                            n += q(graphics, s.substring(q(n7, n8) + 3, j), al.e(), fontMetrics4, n, n2);
                            n11 = 0;
                        }
                        ...
                        if (n11 == 0) {
                            ...
                            n += q(graphics, s.substring(n7 + 3, j), al.q(), fontMetrics2, n, n2);
                        }
                        n8 = j;
                        n12 = 1;
                        j += 2;
                        ...
                        if (n12 != 0 && n11 == 0) {
                            n += q(graphics, s.substring(q(n8 + 3, n9), j), al.w(), fontMetrics3, n, n2);
                            n12 = 0;
                        }
                        else if (n11 != 0 && n12 != 0) {
                            n += q(graphics, s.substring(q(n7, n8) + 3, j), al.e(), fontMetrics4, n, n2);
            ...
            if (substring.length() > 0) {
                q(graphics, substring, al.r(), fontMetrics, n, n2);
            }
        }
        else {
            q(graphics, s, al.r(), fontMetrics, n, n2);
        }
        graphics.setFont(al.r());
    }
    ...
    public final String q(final Object o) {
        ...
        return al.q("Private messages are displayed here.");
    }
