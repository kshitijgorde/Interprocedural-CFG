...
public final class ca extends aG implements aA, Runnable
{
    private Thread q;
    ...
    public final String q(final Object o) {
        final int e = this.e;
        final t t;
        if ((t = ((e >= 0 && e < this.q.q) ? ((t)this.q.q(e)) : null)) != null) {
            return s.q(ak.q("Click here to visit %1 (%2)."), new String[] { t.o, t.w });
        }
        return null;
    }
        ...
        while (!this.q) {
            ...
            try {
                if (this.r > 24) {
                    ...
                    if (this.r == 0) {
                        this.q.waitForID(((t)this.q.q(this.e)).s);
                    }
                    Thread.sleep(20L);
    ...
    public final synchronized void q(final t t) {
        if (t.q == null) {
            return;
        }
        if (this.q.q == 0) {
        ...
        this.q.q(t);
        this.q.addImage(t.q, t.s);
        this.q(t.q.getWidth(this), t.q.getHeight(this));
    }
