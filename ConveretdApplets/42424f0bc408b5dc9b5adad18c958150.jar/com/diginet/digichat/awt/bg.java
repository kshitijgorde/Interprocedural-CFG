...
public class bg extends Panel
{
    ...
    public Dimension preferredSize() {
        ...
        final FontMetrics fontMetrics = this.getFontMetrics(com.diginet.digichat.awt.p.b);
    ...
    private final void b(final Graphics graphics, final int n, final int n2) {
        if (graphics != null) {
            graphics.setFont(com.diginet.digichat.awt.p.b);
    ...
    public bg(final int m, final int n, final int p7, final int o, final int k, final i r, final boolean f) {
        this.a = 12;
        ...
        this.p = p7;
        this.b(k);
        this.q = ((this.r != null) ? this.r.ca : a2.a);
        if (this.f) {
            this.a = 0;
        }
    ...
    public bg(final int n, final int n2, final int n3, final int n4, final int n5, final i i) {
        this(n, n2, n3, n4, n5, i, false);
    }
    
    public bg(final i i, final boolean b) {
        this(4, 4, 4, 4, 1, i, b);
    }
}
