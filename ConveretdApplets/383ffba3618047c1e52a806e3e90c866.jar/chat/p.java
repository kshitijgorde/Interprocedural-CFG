...
final class p extends q implements ab
{
    private boolean a;
    private Event a;
    private String a;
    ...
    public final boolean handleEvent(final Event a) {
        ...
        final int b2;
        final w w = ((b2 = this.a.b(a.x)) >= 0) ? this.a.a(b2) : null;
        s arg;
        if (a2 >= 0 && a2 < a3) {
            arg = chat.y.a(this.a).elementAt(a2);
        }
        else {
            arg = null;
        }
