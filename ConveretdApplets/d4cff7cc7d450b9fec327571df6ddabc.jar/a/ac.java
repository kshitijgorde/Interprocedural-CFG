...
public final class ac extends aa
{
    ...
    private ac(final int q) {
        this.q = q;
    }
    
    public ac(final int n, final Color color, final Color color2) {
        this(1, color.brighter(), color, color2, color2.brighter());
    }
    
    private ac(final int n, final Color q, final Color w, final Color r, final Color e) {
        this(n);
        this.q = q;
        this.w = w;
        this.r = r;
