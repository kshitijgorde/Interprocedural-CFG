...
public class Iterate1 extends Applet implements MouseMotionListener, KeyListener
{
    Image buffImage;
    ...
    public void draw() {
        ...
        for (int j = 0; j <= this.maxIt; ++j) {
            this.buffGraphics.fillRect(this.xIt[j] - 1, this.yIt[j] - 1, 3, 3);
        }
    }
