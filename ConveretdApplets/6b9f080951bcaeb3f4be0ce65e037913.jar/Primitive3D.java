...
class Primitive3D
{
    ...
    public static String text_composite;
    ...
    public Primitive3D(final Primitive3D other) {
        ...
        this.text_root = other.text_root;
        ...
        this.is_inactive_flags = other.is_inactive_flags;
    ...
    static {
        ...
        Primitive3D.text_composite = "composite text";
    }
}
