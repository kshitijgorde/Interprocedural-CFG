    ...
    public final int q() {
        try {
            ...
            if (!C.q.equals(this.q.getSelectedItem()) && (((int1 = Integer.parseInt(this.q.getText().trim())) < 10 && C.w.equals(this.q.getSelectedItem())) || int1 <= 0)) {
                new bR(null, ak.q("Error"), new String[] { ak.q("OK") }, new String[] { "Entered time must be at least ten seconds long.  Please specify a larger value." }, null, null).setVisible(true);
                this.q.selectAll();
                this.q.requestFocus();
                return -1;
            }
            ...
            new bR(null, ak.q("Error"), new String[] { ak.q("OK") }, new String[] { "Entered time is invalid." }, null, null).setVisible(true);
            this.q.selectAll();
            this.q.requestFocus();
            return -1;
        }
