...
public class ptmedia extends Applet implements Runnable
{
    ...
    public void init() {
        ...
        if ((parameter5 = this.getParameter("loop")) != null) {
    ...
    void InitJMFMedia(final String s) {
        if (this.pv != null) {
            ...
            try {
                ...
                if ((instance = forName.getConstructor((ptmedia.class$java$lang$String == null) ? (ptmedia.class$java$lang$String = class$("java.lang.String")) : ptmedia.class$java$lang$String).newInstance(externalForm)) == null) {
                    return;
                }
            }
            catch (Exception ex2) {
        ...
        if (this.JMFplayer != null) {
            ...
            if (this.JMFGetPlayerState() >= intValue) {
                try {
                    ...
                    if ((component = (Component)Class.forName("javax.media.Player").getMethod("getVisualComponent", (Class<?>[])null).invoke(this.JMFplayer, (Object[])null)) != null) {
                ...
                try {
                    final Class<?> forName;
                    final Object invoke = (forName = Class.forName("javax.media.Duration")).getMethod("getDuration", (Class<?>[])null).invoke(this.JMFplayer, (Object[])null);
