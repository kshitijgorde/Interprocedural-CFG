...
public class Record
{
                ...
                for (int n9 = 0; n9 < contO.npl; ++n9) {
                    ...
                    for (int n10 = 0; n10 < contO.p[n9].n; ++n10) {
                        if (contO.p[n9].wz == 0) {
                            ...
                            if ((Math.abs(contO.p[n9].oy[n10] - madness.flipy[madness.cn] - this.squash[0][madness.im]) < madness.msquash[madness.cn] * 3 || contO.p[n9].oy[n10] < madness.flipy[madness.cn] + this.squash[0][madness.im]) && this.squash[0][madness.im] < madness.msquash[madness.cn]) {
        ...
        do {
            ...
            do {
                if (this.hry[n][n2][n4] == lastfr && this.lastfr != lastfr) {
                    this.regy(n2, this.hmagy[n][n2][n4], this.hmtouch[n][n4], contO, madness);
                }
                if (this.hrx[n][n2][n4] == lastfr) {
                    if (this.lastfr != lastfr) {
                        this.regx(n2, this.hmagx[n][n2][n4], contO, madness);
                    }
                    else {
                        this.chipx(n2, this.hmagx[n][n2][n4], contO, madness);
                    }
                }
                if (this.hrz[n][n2][n4] == lastfr) {
                    if (this.lastfr != lastfr) {
                        this.regz(n2, this.hmagz[n][n2][n4], contO, madness);
                    }
                    else {
                        this.chipz(n2, this.hmagz[n][n2][n4], contO, madness);
                    }
                }
            } while (++n4 < 7);
        } while (++n2 < 4);
    ...
    public void chipz(final int n, float n2, final ContO contO, final Madness madness) {
    ...
    public void regz(final int n, float n2, final ContO contO, final Madness madness) {
        if (Math.abs(n2) > 100.0f) {
            if (n2 > 100.0f) {
                n2 -= 100.0f;
            }
        ...
        do {
            ...
            do {
                if (this.ry[n][n3][n5] == n2) {
                    this.regy(n3, this.magy[n][n3][n5], this.mtouch[n][n5], contO, madness);
                }
                if (this.rx[n][n3][n5] == n2) {
                    this.regx(n3, this.magx[n][n3][n5], contO, madness);
                }
                if (this.rz[n][n3][n5] == n2) {
                    this.regz(n3, this.magz[n][n3][n5], contO, madness);
                }
            } while (++n5 < 7);
        } while (++n3 < 4);
    }
    ...
    public void chipx(final int n, float n2, final ContO contO, final Madness madness) {
        if (Math.abs(n2) > 100.0f) {
            if (n2 > 100.0f) {
                n2 -= 100.0f;
            }
    ...
    public void regx(final int n, float n2, final ContO contO, final Madness madness) {
        if (Math.abs(n2) > 100.0f) {
            if (n2 > 100.0f) {
                n2 -= 100.0f;
            }
