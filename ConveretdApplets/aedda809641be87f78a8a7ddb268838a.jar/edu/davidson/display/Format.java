...
public class Format
{
    ...
    public Format(final String s) {
        ...
        while (i == 0) {
            if (n >= length) {
                ...
                this.pre = String.valueOf(String.valueOf(this.pre)).concat(String.valueOf(String.valueOf(s.charAt(n))));
            }
            ++n;
        }
        while (i == 1) {
    ...
    public String form(final long n) {
        ...
        if (this.fmt == 'd' || this.fmt == 'i') {
            if (n < 0) {
                s = "".concat(String.valueOf(String.valueOf(n))).substring(1);
                n2 = -1;
            }
            else {
    ...
    public String form(final char c) {
        ...
        return this.pad("".concat(String.valueOf(String.valueOf(c))));
    }
    ...
    private static String convert(long n, final int n2, final int n3, final String s) {
        ...
        String concat = "";
        while (n != 0) {
            concat = String.valueOf(String.valueOf(s.charAt((int)(n & n3)))).concat(String.valueOf(String.valueOf(concat)));
            n >>>= n2;
        }
        return concat;
    }
    ...
    private String pad(final String s) {
        ...
        if (this.left_align) {
            return String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(this.pre))).append(s).append(repeat).append(this.post)));
        }
        return String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(this.pre))).append(repeat).append(s).append(this.post)));
    }
    ...
    private String sign(final int n, final String s) {
        ...
        return String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(s2))).append(repeat('0', n2 - s2.length() - s.length())).append(s)));
    }
    ...
    private String fixed_format(final double n) {
        ...
        if (this.precision == 0) {
            return String.valueOf(String.valueOf((long)(n + 0.5))).concat(String.valueOf(String.valueOf(b ? "" : ".")));
        }
        long n2 = (long)n;
        ...
        double n4 = 1.0;
        String concat = "";
        for (int n5 = 1; n5 <= this.precision && n4 <= Long.MAX_VALUE; n4 *= 10, concat = String.valueOf(String.valueOf(concat)).concat("0"), ++n5) {}
        long n6 = (long)(n4 * n3 + 0.5);
        if (n6 >= n4) {
            n6 = 0L;
            ++n2;
        }
        final String concat2 = String.valueOf(String.valueOf(concat)).concat(String.valueOf(String.valueOf(n6)));
        String s = ".".concat(String.valueOf(String.valueOf(concat2.substring(concat2.length() - this.precision, concat2.length()))));
        if (b) {
            int n7;
        ...
        return String.valueOf(String.valueOf(n2)).concat(String.valueOf(String.valueOf(s)));
    }
    ...
    private String exp_format(double n) {
        ...
        n *= n4;
        final String concat = String.valueOf(String.valueOf(s)).concat(String.valueOf(String.valueOf(this.fixed_format(n))));
        String s2;
        if (this.fmt == 'e' || this.fmt == 'g') {
            s2 = String.valueOf(String.valueOf(concat)).concat("e");
        }
        else {
            s2 = String.valueOf(String.valueOf(concat)).concat("E");
        }
        ...
        String s5;
        if (n2 >= 0) {
            s4 = String.valueOf(String.valueOf(s2)).concat("+");
            s5 = String.valueOf(String.valueOf(s3)).concat(String.valueOf(String.valueOf(n2)));
        }
        else {
            s4 = String.valueOf(String.valueOf(s2)).concat("-");
            s5 = String.valueOf(String.valueOf(s3)).concat(String.valueOf(String.valueOf(-n2)));
        }
        return String.valueOf(String.valueOf(s4)).concat(String.valueOf(String.valueOf(s5.substring(s5.length() - 3, s5.length()))));
    }
}
