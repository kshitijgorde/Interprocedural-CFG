...
public class RubyFile$s$0$0$utime extends JavaMethodN
{
    public RubyFile$s$0$0$utime(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyFile.utime(context, recv, array);
    }
}
