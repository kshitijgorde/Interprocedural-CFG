        ...
        if (dataSeries.hasMoreElements()) {
            ...
            for (int j = n7; j >= 1; --j) {
                ...
                for (int k = values.length - 1; k >= 0; --k) {
                    graphics.setColor(colorList[k].darker());
                    final float n10 = Math.round(360.0f * (values[k] / n5));
                    n9 += (int)n10;
                    graphics.fillArc(n, j + n2, n3, (int)(n3 / n6), n8, (k == 0) ? (360 - n9 + (int)n10) : ((int)n10));
                    n8 += (int)n10;
                }
            }
            int n11 = 90;
            ...
            for (int l = values.length - 1; l >= 0; --l) {
                graphics.setColor(colorList[l]);
                final float n13 = Math.round(360.0f * (values[l] / n5));
                n12 += (int)n13;
                graphics.fillArc(n, n2, n3, (int)(n3 / n6), n11, (l == 0) ? (360 - n12 + (int)n13) : ((int)n13));
                n11 += (int)n13;
            }
        }
    }
