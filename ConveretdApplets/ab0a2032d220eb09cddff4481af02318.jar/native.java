...
public class native extends o
{
    public native(final int[] array, final a a) {
        super("PVI - Positive Volume Index", 3, array, null, a);
        this.C();
    }
    ...
    protected void C() {
        ...
        super.qIb[2] = super.DDb[0] + super.DDb[1] - 1;
    }
