...
{
    public a6(final be be, final DataSource dataSource) {
        super("BarOHLC", be, dataSource);
    }
    ...
    protected void c(final Graphics graphics) {
        ...
        for (int i = 0; i < super.fs; ++i) {
            ...
            if (super.f0 < 2) {
                ...
                if (n2 != Integer.MIN_VALUE) {
                    graphics.drawLine(n - 2 * super.f0, n2, n - super.f0, n2);
                }
                if (n3 != Integer.MIN_VALUE) {
