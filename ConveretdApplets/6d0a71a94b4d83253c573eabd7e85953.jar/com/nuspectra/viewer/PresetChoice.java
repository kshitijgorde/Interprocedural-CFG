...
public class PresetChoice extends Choice implements ItemListener, SessionListener
{
    NuApplet applet;
    int xpos;
    int ypos;
    ...
    public PresetChoice(final NuApplet a) {
        this.applet = a;
    ...
    public void setDebug() {
        this.add("Preset");
        for (int count = 5, x = 0; x < count; ++x) {
            final Preset p = new Preset(x, "Preset " + (x + 1));
            this.add(p.name);
        }
    }
