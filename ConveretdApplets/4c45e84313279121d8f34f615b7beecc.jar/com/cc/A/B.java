...
public class B
{
    ...
    private void A(final A a, final com.cc.B.A a2, final A.A.B b) {
        a.\u00c3 = this.A(b, "width", 0);
        a.R = this.A(b, "height", 0);
        a.Y = this.A(b, "scroll-height", 0);
        a.m = this.A(b, "scroll-width", 0);
        if (b.A("solve-state")) {
            a.\u00c8 = b.H("solve-state");
        }
        a.n = this.A(b, "is-solving", false);
        a.\u00c2 = this.A(b, "background-color", a.\u00c2);
        ...
        this.B(a, b);
        if (b.D("title")) {
            a.P = a.A(com.cc.D.A.A(b.B("title")));
        }
        if (b.D("copyright")) {
            a.x = a.A(com.cc.D.A.A(b.B("copyright")));
        }
    }
    ...
    private void A(final com.cc.B.E e, final A.A.B b, final Vector vector) {
        ...
        if (b.A("solve-state")) {
            e.A(b.H("solve-state"), "pencil".equals(this.A(b, "solve-status", "")));
        }
        if (b.A("number")) {
            e.B = b.H("number");
        }
    ...
    private void A(final com.cc.B.A a, final A.A.B b) {
        ...
        a.v = this.A(b, "block-color", a.v);
        a.e = this.A(b, "font-color", a.e);
        a.x = this.A(b, "number-color", a.x);
        a.u = this.A(b, "pencil-color", a.u);
    }
    ...
    private void C(final A a, final A.A.B b) {
        ...
        a.S = this.A(b2, "wide-buttons", a.S);
        a.s = this.A(b2, "graphical-buttons", a.s);
        ...
        if (b7 != null) {
            a.H.A(b7.H("label"));
            a.c = this.A(b7, "target-frame", (String)null);
            a.\u00c6 = this.A(b7, "target-url", (String)null);
            a.o = this.A(b7, "target-type", a.o);
        }
        ...
        if (b9 != null) {
            a.f = this.A(b9, "target-url", (String)null);
            a.H.B(b9.H("label"));
        }
    ...
    private void B(final A a, final A.A.B b) {
        ...
        if (b2 != null) {
            a.K = this.A(b2.I("layout"), new String[] { "right", "left", "below" }, new int[] { 0, 1, 2 });
            a.L = new Font(b2.H("font-family"), 0, b2.I("font-size").C());
            a.\u00c9 = this.A(b2, "color", a.\u00c9);
            a.J = b2.I("gutter").C();
            a.\u00c5 = b2.I("width").C();
            a.u = this.A(b2, "selection-color", a.u);
            a.Q = this.A(b2, "right-align-numbers", a.Q);
            a.¤ = (a.Q || this.A(b2, "clue-indent-align", a.¤));
            a.g = this.A(b2, "hint-url-text", a.g);
            a.\u00ca = this.A(b2, "target-frame", (String)null);
            a.\u00cf = this.A(b2, "url-color", a.\u00cf);
            a.N = this.A(b2, "bold-numbers", a.N);
            a.V = this.A(b2, "heading-centered", a.V);
            a.w = this.A(b2, "period-with-numbers", a.w);
            a.W = this.A(b2, "scroll-color", a.W);
            a.z = this.A(b2, "completed-color", a.z);
        }
    }
    ...
    private void A(final A a, final A.A.B b) {
        ...
        a.\u00c1 = this.A(b2, "allow-pause", a.\u00c1);
        a.U = this.A(b2, "start-on-load", a.U);
    ...
    private void D(final A a, final A.A.B b) {
        ...
        a._ = this.A(b2, "only-if-correct", a._);
        a.r = this.A(b2, "friendly-submit", a.r);
        a.\u00d0 = this.A(b2, "cheating", a.\u00d0);
        a.\u00c7 = this.A(b2, "show-solution", a.\u00c7);
        a.v = this.A(b2, "target-url", (String)null);
        a.I = this.A(b2, "target-frame", (String)null);
        a.q = b2.A();
    }
