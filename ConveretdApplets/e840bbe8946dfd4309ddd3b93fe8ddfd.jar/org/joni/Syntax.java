...
public final class Syntax implements SyntaxProperties
{
    ...
    static {
        RUBY = new Syntax(2146948438, 736218, -2086665253, 0, new MetaCharTable(92, 0, 0, 0, 0, 0));
        DEFAULT = Syntax.RUBY;
    ...
    public static class MetaCharTable
    {
        ...
        public MetaCharTable(final int esc, final int anyChar, final int anyTime, final int zeroOrOneTime, final int oneOrMoreTime, final int anyCharAnyTime) {
            this.esc = esc;
