...
public class MD5Digest extends GeneralDigest
{
    ...
    protected void processWord(final byte[] array, final int n) {
        this.X[this.xOff++] = ((array[n] & 0xFF) | (array[n + 1] & 0xFF) << 8 | (array[n + 2] & 0xFF) << 16 | (array[n + 3] & 0xFF) << 24);
        if (this.xOff == 16) {
            this.processBlock();
        }
    }
    ...
    protected void processBlock() {
        ...
        final int n64 = this.rotateLeft(n60 + this.K(n63, n62, n61) + this.X[9] - 343485551, 21) + n63;
        this.H1 += n61;
        this.H2 += n64;
        this.H3 += n63;
        this.H4 += n62;
