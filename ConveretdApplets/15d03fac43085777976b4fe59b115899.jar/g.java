...
class g extends Dialog implements ActionListener
{
    ...
    g(final esChat a, final String s) {
        ...
        panel2.add(c);
        panel2.add(c2);
        this.add(new Label(), g.z[2]);
        this.add(panel, g.z[1]);
        this.add(panel2, g.z[0]);
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "oM\u0016\r1".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "\u007fG\r\r<N".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "rM\u0011\r1".toCharArray();
