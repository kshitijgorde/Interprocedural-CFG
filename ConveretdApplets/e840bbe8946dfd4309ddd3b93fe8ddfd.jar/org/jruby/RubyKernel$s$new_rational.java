...
public class RubyKernel$s$new_rational extends JavaMethodZeroOrOneOrTwo
{
    public RubyKernel$s$new_rational(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject arg0, final IRubyObject arg2) {
        return RubyKernel.new_rational(context, recv, arg0, arg2);
    }
