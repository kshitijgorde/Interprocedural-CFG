        ...
        if (!this.addr_str.equals("")) {
            ...
            if (this.button_show && this.image.getWidth(null) > 0) {
                if (z1.z138) {
                    ...
                    final String z21 = z1.z21;
                    graphics.drawString(z21, this.x_offset + 4, this.y_offset + 16);
                    graphics.drawString(z21, this.x_offset + 6, this.y_offset + 16);
                    graphics.drawString(z21, this.x_offset + 5, this.y_offset + 15);
                    graphics.drawString(z21, this.x_offset + 5, this.y_offset + 17);
                    graphics.setColor(Color.white);
                    graphics.drawString(z21, this.x_offset + 5, 16 + this.y_offset);
                    z1.z138 = false;
                }
