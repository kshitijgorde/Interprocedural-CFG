            ...
            if (n != 0) {
                if (this.Sudoku) {
                    ...
                    for (int i = 0; i < this.ab; ++i) {
                        ...
                        if (n2 == 0 && (this.jn[i][this.ga.y].JA & 0x2) != 0x0) {
                            n2 = i;
                        }
                    }
                    for (int j = 0; j < this.ac; ++j) {
                        ...
                        if (n3 == 0 && (this.jn[this.ga.x][j].JA & 0x4) != 0x0) {
                            n3 = j;
                        }
                    }
                    for (int k = this.ga.x / n2 * n2; k < this.ga.x / n2 * n2 + n2; ++k) {
                        for (int l = this.ga.y / n3 * n3; l < this.ga.y / n3 * n3 + n3; ++l) {
