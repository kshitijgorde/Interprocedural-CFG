...
class w extends Panel implements ComponentListener
{
    ...
    w(final esChat a, final String s) {
        ...
        this.w.add(this.h, w.z[4]);
        this.add(this.w, w.z[4]);
        a.getClass();
                    ...
                    Label_0602: {
                        if (!r) {
                            if (!a.V.equalsIgnoreCase(w.z[6])) {
                                equalsIgnoreCase = a.V.equalsIgnoreCase(w.z[8]);
                                if (r) {
                                    break Label_0619;
                                }
                                if (!equalsIgnoreCase) {
    ...
    public void c() {
        (this.j = new t(this, w.z[0])).setSize(600, 450);
        this.j.pack();
    ...
    public void a(String substring) {
        ...
        Label_0140: {
            if (!r) {
                if (s2.indexOf(w.z[9]) <= -1) {
                    break Label_0140;
                }
                substring.substring(0, substring.indexOf(w.z[9]));
            }
            this.h.a(s2);
            substring = substring.substring(substring.indexOf(w.z[9]) + 3);
        }
        this.h.a(substring);
    }
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "@o\u0014kyk}\u000e".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "RO(\u001f\u0015".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "Qa\u000f?]".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "Nk\u001c?".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "Ak\u0014?Pp".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "Go\t?".toCharArray();
        ...
        final int n19 = 6;
        final char[] charArray7 = "M`".toCharArray();
        ...
        final int n22 = 7;
        final char[] charArray8 = "Uk\t?".toCharArray();
        ...
        final int n25 = 8;
        final char[] charArray9 = "Pg\u001d#A".toCharArray();
