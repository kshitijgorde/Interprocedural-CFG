...
public final class PostOfficeSignup_Stub extends RemoteStub implements SignupInt, Remote
{
    private static Operation[] operations;
    private static final long interfaceHash = -3919808369620208655L;
    
    public PostOfficeSignup_Stub() {
    }
    
    public PostOfficeSignup_Stub(final RemoteRef remoteRef) {
        super(remoteRef);
    }
    ...
    public String createAccount(final String s, final String s2, final String s3, final String s4) throws RemoteException {
        ...
        final RemoteCall call = ref.newCall(this, PostOfficeSignup_Stub.operations, n, -3919808369620208655L);
        try {
    ...
    static {
        PostOfficeSignup_Stub.operations = new Operation[] { new Operation("java.lang.String createAccount(java.lang.String, java.lang.String, java.lang.String, java.lang.String)"), new Operation("java.util.Hashtable getAccountData(java.lang.String, java.lang.String)"), new Operation("java.lang.String saveAccountData(java.lang.String, java.lang.String, java.util.Hashtable)") };
    }
}
