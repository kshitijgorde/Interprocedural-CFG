...
public final class bG extends Canvas implements aB
{
    private Image a;
    private Image b;
    private Image c;
    ...
    public static bG a(final Image image, final Image image2, final Image image3) {
        return new bG(image, image2, image3);
    }
    ...
    private bG(final Image a, final Image b, final Image c) {
        this.a = false;
        this.b = true;
        this.c = true;
        this.d = false;
