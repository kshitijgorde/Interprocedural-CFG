...
public class RubyArgsFile$s$0$1$each19 extends JavaMethodNBlock
{
    public RubyArgsFile$s$0$1$each19(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyArgsFile.each19(context, recv, array, block);
    }
}
