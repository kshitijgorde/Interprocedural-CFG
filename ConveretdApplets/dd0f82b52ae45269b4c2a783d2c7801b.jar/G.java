...
public class G extends JPanel
{
    ...
    public G(final V a, final int f, final int g) {
        super(false);
        this.d = false;
        this.k = false;
    ...
    public final void b(int n) {
        if (j != this.j) {
            ...
            if (b || b2) {
                ...
                if (!c(((G)n).j)) {
                    ((G)n).b = new BufferedImage(((G)n).f * d, ((G)n).g * d, 1);
                }
                else {
                    ((G)n).b = new BufferedImage(((G)n).f, ((G)n).g, 1);
                    (((G)n).e = ((G)n).b.createGraphics()).setFont(((G)n).o);
                    final Graphics2D graphics2D;
                    (graphics2D = (Graphics2D)((G)n).e).setRenderingHint(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_SPEED);
                    graphics2D.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_OFF);
                    try {
                        ((G)n).c = ((Component)n).createVolatileImage(((G)n).f, ((G)n).g, new ImageCapabilities(true));
                    }
                    catch (Exception ex) {
                        ((G)n).j = 3;
                        ((G)n).b = new BufferedImage(((G)n).f * d, ((G)n).g * d, 1);
                ...
                (graphics2D2 = (Graphics2D)((G)n).e).setRenderingHint(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_SPEED);
                graphics2D2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_OFF);
                final int[] data = ((DataBufferInt)((G)n).b.getRaster().getDataBuffer()).getData();
                if (((G)n).j == 0 || ((G)n).j == 1 || ((G)n).j == 2) {
                    ((G)n).h = data;
                    ((G)n).a.c.d = data;
                }
                else {
                ...
                ((Component)n).setSize(((G)n).f * d, ((G)n).g * d);
                ((Component)n).setBounds(((JComponent)n).getX(), ((JComponent)n).getY(), ((G)n).f * d, ((G)n).g * d);
