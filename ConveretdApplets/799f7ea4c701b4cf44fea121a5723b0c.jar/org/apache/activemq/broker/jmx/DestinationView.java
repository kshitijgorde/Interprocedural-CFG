...
public class DestinationView implements DestinationViewMBean
{
    ...
    @Override
    public String sendTextMessage(final Map headers, final String body, final String userName, final String password) throws Exception {
        ...
        try {
            ...
            final long ttl = msg.getExpiration() - System.currentTimeMillis();
    ...
    public ObjectName[] getSubscriptions() throws IOException, MalformedObjectNameException {
        ...
        final ObjectName objectName = this.broker.getBrokerService().getBrokerObjectName();
        int index = 0;
        for (final Subscription subscription : subscriptions) {
            final String connectionClientId = subscription.getContext().getClientId();
            final String objectNameStr = ManagedRegionBroker.getSubscriptionObjectName(subscription, connectionClientId, objectName);
