...
public class TeletextKeyAssociation
{
    ...
    Method method;
    private static /* synthetic */ Class class$Lteletext$TeletextPageCanvas;
    ...
    public TeletextKeyAssociation(final int keyCode, final char charCode, final int modifiers, final Object targetObject, final String methodName, final Class[] methodParameterTypes, final Object[] methodParameters) {
        ...
        final Class clazz = (TeletextKeyAssociation.class$Lteletext$TeletextPageCanvas != null) ? TeletextKeyAssociation.class$Lteletext$TeletextPageCanvas : (TeletextKeyAssociation.class$Lteletext$TeletextPageCanvas = class$("teletext.TeletextPageCanvas"));
        try {
