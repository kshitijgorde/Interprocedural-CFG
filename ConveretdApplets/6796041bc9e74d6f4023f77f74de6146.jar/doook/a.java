...
public class a
{
    ...
    public void a(String a) {
        a = a(a);
        final byte[] a2 = new byte[a.length() / 2];
        for (int i = 0, n = 0; i < a2.length; a2[i++] = (byte)(Object)new Integer(Integer.parseInt(a.substring(n++, ++n), 16))) {}
        this.a = a2;
    }
    
    public a(final DataInput dataInput) {
