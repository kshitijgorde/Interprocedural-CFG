...
public final class Session
{
    ...
    private Session(final Properties props, final Authenticator authenticator) {
        ...
        if (this.debug) {
            this.pr("DEBUG: JavaMail version 1.4.4");
        }
        Class cl;
    ...
    public synchronized void setDebug(final boolean debug) {
        this.debug = debug;
        if (debug) {
            this.pr("DEBUG: setDebug: JavaMail version 1.4.4");
        }
    }
    ...
    private void loadProviders(final Class cl) {
        ...
        if (this.providers.size() == 0) {
            ...
            this.addProvider(new Provider(Provider.Type.STORE, "imap", "com.sun.mail.imap.IMAPStore", "Sun Microsystems, Inc.", "1.4.4"));
            this.addProvider(new Provider(Provider.Type.STORE, "imaps", "com.sun.mail.imap.IMAPSSLStore", "Sun Microsystems, Inc.", "1.4.4"));
            this.addProvider(new Provider(Provider.Type.STORE, "pop3", "com.sun.mail.pop3.POP3Store", "Sun Microsystems, Inc.", "1.4.4"));
            this.addProvider(new Provider(Provider.Type.STORE, "pop3s", "com.sun.mail.pop3.POP3SSLStore", "Sun Microsystems, Inc.", "1.4.4"));
            this.addProvider(new Provider(Provider.Type.TRANSPORT, "smtp", "com.sun.mail.smtp.SMTPTransport", "Sun Microsystems, Inc.", "1.4.4"));
            this.addProvider(new Provider(Provider.Type.TRANSPORT, "smtps", "com.sun.mail.smtp.SMTPSSLTransport", "Sun Microsystems, Inc.", "1.4.4"));
        }
        if (this.debug) {
