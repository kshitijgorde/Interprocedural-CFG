...
public class RubyIO$i$0$1$initialize extends JavaMethodNBlock
{
    public RubyIO$i$0$1$initialize(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block unusedBlock) {
        ...
        return ((RubyIO)rubyObject).initialize(array, unusedBlock);
    }
}
