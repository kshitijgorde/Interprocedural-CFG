...
public class RubyIO$s$0$3$select extends JavaMethodN
{
    public RubyIO$s$0$3$select(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyIO.select(context, recv, array);
    }
}
