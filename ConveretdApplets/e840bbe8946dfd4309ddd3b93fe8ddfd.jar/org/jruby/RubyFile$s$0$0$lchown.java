...
public class RubyFile$s$0$0$lchown extends JavaMethodN
{
    public RubyFile$s$0$0$lchown(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyFile.lchown(context, recv, array);
    }
}
