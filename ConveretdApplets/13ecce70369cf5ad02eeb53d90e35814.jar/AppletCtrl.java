...
class AppletCtrl implements ItemListener, MouseListener, ActionListener, MouseMotionListener
{
    ...
    public AppletCtrl(final AppletComponents appComp, final ImageCanvas imgCanvas, final ChordAnalyser chordAnalyser, final GuitarCodex guitCodex, final MidiGuitar midiGuitar) {
        this.strBaseNote = "";
        this.strSymbNote = "";
        this.nScopePos = 1;
    ...
    public void mouseClicked(final MouseEvent mouseEvent) {
        if (mouseEvent.getSource() == this.appComp.getHomeUrl()) {
            final String s = "http://www.microtools.de";
            try {
        ...
        if (this.checkArea(this.point.x, this.point.y)) {
            ...
            this.imgCanvas.repaint();
            if (this.midiGuitar.getSoundStrCbx().getState()) {
                this.midiGuitar.playSingleNote(this.imgCanvas.getLastMidiNote());
            }
        }
    }
