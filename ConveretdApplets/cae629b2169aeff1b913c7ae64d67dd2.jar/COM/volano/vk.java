...
public abstract class vk extends Panel
{
    ...
    public static vk a(final String s, final boolean b) {
        vk vk = null;
        final boolean b2 = b || s.equals("1.5.0") || s.equals("1.5.0_01") || s.startsWith("1.5.0-beta");
        try {
            vk = (vk)((COM.volano.vk.b && b2) ? Class.forName("COM/volano/vj".replace('/', '.')).newInstance() : ((vk)Class.forName("COM/volano/vl".replace('/', '.')).newInstance()));
        }
        catch (Exception ex) {
