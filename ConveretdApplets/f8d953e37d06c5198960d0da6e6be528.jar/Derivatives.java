...
public class Derivatives extends GenericGraphApplet
{
    ...
    protected void setUpCanvas() {
        final boolean b = !"no".equalsIgnoreCase(this.getParameter("SecondDerivative", "no"));
        ...
        if ("yes".equalsIgnoreCase(this.getParameter("ShowGraphLabels", "yes"))) {
            final DrawString drawString = new DrawString(parameter + " = " + this.functionName + "(" + super.xVar.getName() + ")");
            ...
            final DrawString drawString2 = new DrawString(parameter + " = " + this.functionName + " ' (" + super.xVar.getName() + ")");
            ...
            if (b) {
                final DrawString drawString3 = new DrawString(parameter + " = " + this.functionName + " ' ' (" + super.xVar.getName() + ")");
        ...
        if ("yes".equalsIgnoreCase(this.getParameter("ShowValues", "yes"))) {
            final DrawString drawString4 = new DrawString(this.functionName + "(#) = #", 8, new Value[] { this.xInput, new ValueMath(this.func, this.xInput) });
            ...
            final DrawString drawString5 = new DrawString(this.functionName + " ' (#) = #", 8, new Value[] { this.xInput, new ValueMath(this.deriv, this.xInput) });
            ...
            if (b) {
                final DrawString drawString6 = new DrawString(this.functionName + " ' ' (#) = #", 8, new Value[] { this.xInput, new ValueMath(this.deriv2, this.xInput) });
