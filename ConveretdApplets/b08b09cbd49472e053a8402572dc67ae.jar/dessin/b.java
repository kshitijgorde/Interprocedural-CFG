...
public class b extends q
{
    ...
    public b(final int n, final int n2, final int n3, final int n4, final Color p7, final float r, final boolean q) {
        this.P = Color.black;
        this.R = 1.0f;
        this.Q = false;
    ...
    public b(final Point k, final Point l, final Color p5, final float r, final boolean q) {
        this.P = Color.black;
        this.R = 1.0f;
        this.Q = false;
        this.P = p5;
    ...
    public b(final int x, final int y, final int x2, final int y2) {
        this.P = Color.black;
        this.R = 1.0f;
        this.Q = false;
        super.K = new Point(0, 0);
    ...
    public b(final int x, final int y, final Color p5, final float r, final boolean q) {
        this.P = Color.black;
        this.R = 1.0f;
        this.Q = false;
        this.P = p5;
    ...
    public void a(final Graphics graphics, final boolean b) {
        ...
        if (!this.Q) {
            graphics.drawRect(super.if.if, super.if.a, super.if.a(), super.if.if());
        }
        if (this.Q) {
            graphics.fillRect(super.if.if, super.if.a, super.if.a(), super.if.if());
        }
    }
    ...
    public String if() {
        final String string = "" + "rectangle;" + super.if.if + ";" + super.if.a + ";" + super.if.a() + ";" + super.if.if() + ";" + this.P.getRGB() + ";" + (int)this.R + ";";
        String s;
        if (this.Q) {
            s = string + "0;";
        }
