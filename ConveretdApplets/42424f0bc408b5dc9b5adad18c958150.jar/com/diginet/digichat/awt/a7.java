...
public class a7 extends Panel
{
    ...
    public a7(final int n, final int n2, final int n3, final int n4, final int b) {
        this(n, n2, n3, n4);
        this.b = b;
    }
    
    public a7(final int n, final int n2, final int n3, final int n4) {
        this.b = 0;
