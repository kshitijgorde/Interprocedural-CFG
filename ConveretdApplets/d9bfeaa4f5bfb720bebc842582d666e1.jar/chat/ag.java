...
public final class ag extends l implements ab, Runnable
{
    private Thread a;
    ...
    public final synchronized String a(final Object o) {
        ...
        if ((c2 = ((c > -1 && c < this.a.a()) ? ((c)this.a.a(c)) : null)) != null) {
            return ak.a(ak.a(473), new String[] { c2.c, c2.b });
        }
        return null;
    }
        ...
        while (!this.a) {
            ...
            try {
                if (this.d > 24) {
                    ...
                    if (this.d == 0) {
                        this.a.waitForID(((c)this.a.a(this.c)).g);
                    }
                    Thread.sleep(20L);
