...
public class SegmentedTimeline implements Timeline, Cloneable, Serializable
{
    ...
    public long toTimelineValue(final long millisecond) {
        ...
        if (groupMilliseconds >= this.segmentsIncludedSize) {
            ...
            if (segment.inExceptionSegments()) {
                result = this.toTimelineValue(segment.getSegmentEnd() + 1L);
            }
            else {
    ...
    public class Segment implements Comparable, Cloneable, Serializable
    {
        ...
        public long calculateSegmentNumber(final long millisecond) {
            if (millisecond >= SegmentedTimeline.this.startTime) {
                return (millisecond - SegmentedTimeline.this.startTime) / SegmentedTimeline.this.segmentSize;
            }
            return (millisecond - SegmentedTimeline.this.startTime) / SegmentedTimeline.this.segmentSize - 1L;
        }
        ...
        public boolean contains(final long millisecond) {
