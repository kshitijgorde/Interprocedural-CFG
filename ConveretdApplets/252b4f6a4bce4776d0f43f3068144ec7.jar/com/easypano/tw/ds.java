...
public final class ds
{
    ...
    public static boolean g(final String s) {
        ...
        try {
            equalsIgnoreCase = s.equalsIgnoreCase(m("D?\u001eM"));
        }
        catch (Exception ex) {}
        ...
        if (substring != null) {
            try {
                ...
                if (index2 > 0) {
                    ...
                    if (trim.equalsIgnoreCase(m("y\u0019*d\bs"))) {
                        n = 2;
                    }
                    else if (trim.equalsIgnoreCase(m("r\u0002'l"))) {
                        n = 1;
                    }
                    else if (trim.equalsIgnoreCase(m("r\u0002'l\bd\f'a\u0002"))) {
                        n = 3;
                    }
                    else {
                        n = 0;
    ...
    public static dz k(String substring) {
        int intValue = 0;
        int intValue2 = 0;
        int intValue3 = 0;
        if (substring != null) {
        ...
        return new dz(intValue, intValue2, intValue3);
    }
