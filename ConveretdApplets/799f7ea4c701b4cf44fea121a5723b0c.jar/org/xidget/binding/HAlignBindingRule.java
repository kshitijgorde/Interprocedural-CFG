...
public class HAlignBindingRule implements IBindingRule
{
    @Override
    ...
    private static final class Listener extends ExpressionListener
    {
        ...
        private void update(final String s) {
            ...
            if (textWidgetFeature != null) {
                if (s.equals("left")) {
                    textWidgetFeature.setHAlign(ITextWidgetFeature.HAlign.left);
                }
                if (s.equals("center")) {
                    textWidgetFeature.setHAlign(ITextWidgetFeature.HAlign.center);
                }
                if (s.equals("right")) {
                    textWidgetFeature.setHAlign(ITextWidgetFeature.HAlign.right);
                }
            }
        }
    }
