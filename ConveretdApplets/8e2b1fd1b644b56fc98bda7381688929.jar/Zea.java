...
public class Zea extends p
{
    ...
    public Zea(final int n) {
        super(n, 4);
        this.R = new double[4];
        this.P = 6;
        this.Q = 1;
        this.Y = Color.green.darker();
        this.Z = Color.red;
    }
    ...
    public void b(final Graphics graphics, final o o, final o o2) {
        ...
        final boolean equals = this.Z.equals(this.Y);
        for (int i = max; i <= n; ++i) {
            final double value = super.X.getValue(i, 0);
            final double value2 = super.X.getValue(i, 3);
            if (value2 > value) {
