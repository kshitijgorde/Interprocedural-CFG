...
public class RubyDir$s$0$1$glob extends JavaMethodNBlock
{
    public RubyDir$s$0$1$glob(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyDir.glob(context, recv, array, block);
    }
}
