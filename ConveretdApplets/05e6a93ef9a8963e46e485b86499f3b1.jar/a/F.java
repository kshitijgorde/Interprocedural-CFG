...
public final class F extends Panel
{
    ...
    public F(final int n, final int n2, final TextArea q, final Color background) {
        this(null, 25, 25);
        this.q = q;
        this.t = true;
        if ((cs.q == 0 && cs.t) || (cs.q == 1 && cs.y)) {
            ...
            this.q = new bF(q, canvas, new Color(238, 238, 238));
    ...
    private F(final String s, final int n, int e) {
        this.q = null;
        this.q = false;
        this.w = false;
        this.q = null;
    ...
    public final void paint(final Graphics graphics) {
        if (this.isShowing()) {
            ...
            if (!(this.getParent() instanceof ab)) {
