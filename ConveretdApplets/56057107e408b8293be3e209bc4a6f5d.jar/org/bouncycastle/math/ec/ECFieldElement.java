...
public abstract class ECFieldElement implements ECConstants
{
    ...
    public static class Fp extends ECFieldElement
    {
        ...
        public Fp(final BigInteger q, final BigInteger x) {
            this.x = x;
            if (x.compareTo(q) >= 0) {
        ...
        public ECFieldElement sqrt() {
            ...
            while (true) {
                ...
                if (bigInteger.compareTo(this.q) < 0 && bigInteger.multiply(bigInteger).subtract(mod).modPow(shiftRight, this.q).equals(subtract)) {
                    final BigInteger[] lucasSequence = lucasSequence(this.q, bigInteger, x, add);
        ...
        private static BigInteger[] lucasSequence(final BigInteger bigInteger, final BigInteger bigInteger2, final BigInteger bigInteger3, final BigInteger bigInteger4) {
            ...
            final BigInteger mod = bigInteger8.multiply(bigInteger9).mod(bigInteger);
            final BigInteger mod2 = mod.multiply(bigInteger3).mod(bigInteger);
            BigInteger bigInteger10 = bigInteger5.multiply(bigInteger6).subtract(mod).mod(bigInteger);
            BigInteger bigInteger11 = bigInteger7.multiply(bigInteger6).subtract(bigInteger2.multiply(mod)).mod(bigInteger);
            BigInteger bigInteger12 = mod.multiply(mod2).mod(bigInteger);
            for (int j = 1; j <= lowestSetBit; ++j) {
                bigInteger10 = bigInteger10.multiply(bigInteger11).mod(bigInteger);
                bigInteger11 = bigInteger11.multiply(bigInteger11).subtract(bigInteger12.shiftLeft(1)).mod(bigInteger);
                bigInteger12 = bigInteger12.multiply(bigInteger12).mod(bigInteger);
            }
