...
public class XPATHErrorResources_hu extends ListResourceBundle
{
    ...
    public static final String ER_NULL_NAMESPACE_CONTEXT = "ER_NULL_NAMESPACE_CONTEXT";
    public static final String ER_NULL_XPATH_EXPRESSION = "ER_NULL_XPATH_EXPRESSION";
    public static final String ER_NULL_XPATH_RETURN_TYPE = "ER_NULL_XPATH_RETURN_TYPE";
    public static final String ER_INVALID_XPATH_RETURN_TYPE = "ER_INVALID_XPATH_RETURN_TYPE";
    public static final String ER_NULL_INPUT_SOURCE = "ER_NULL_INPUT_SOURCE";
    public static final String ER_UNSUPPORTED_CONTEXT_ITEM = "ER_UNSUPPORTED_CONTEXT_ITEM";
    public static final String ER_UNDEFINED_FUNCTION_RESOLVER = "ER_UNDEFINED_FUNCTION_RESOLVER";
    public static final String ER_UNRESOLVED_EXTENSION_FUNCTION = "ER_UNRESOLVED_EXTENSION_FUNCTION";
    public static final String ER_EXTENSION_FUNCTION_NOT_ALLOWED_IN_SECURE_PROCESSING = "ER_EXTENSION_NOT_ALLOWED_IN_SECURE_PROCESSING";
    public static final String ER_UNDEFINED_VARIABLE_RESOLVER = "ER_UNDEFINED_VARIABLE_RESOLVER";
    public static final String ER_UNRESOLVED_VARIABLE = "ER_UNRESOLVED_VARIABLE";
