...
public class CMOS_nor2 extends Applet
{
    int clicks;
    ...
    public void init() {
        ...
        this.v_int = new Voltage(1);
        this.v_out = new Voltage(1);
        this.pmos1 = new MOS(230, 100, 2, "T1", this.v_vcc, this.v_in_a, this.v_int);
        this.pmos2 = new MOS(230, 160, 2, "T2", this.v_int, this.v_in_b, this.v_out);
        this.nmos1 = new MOS(150, 240, 1, "T3", this.v_gnd, this.v_in_b, this.v_out);
        this.nmos2 = new MOS(230, 240, 1, "T4", this.v_gnd, this.v_in_a, this.v_out);
        ...
        (this.w_VCC = new Wire(100, 100, 350, 100, this.v_vcc, "VCC")).addSolderDot(280, 100);
        (this.w_GND = new Wire(100, 300, 350, 300, this.v_gnd, "GND")).addSolderDot(200, 300);
        this.w_GND.addSolderDot(280, 300);
        (this.w_in_a = new Wire(100, 130, 230, 130, this.v_in_a, "A")).append(230, 130);
        this.w_in_a.append(230, 270);
        this.w_in_a.addSolderDot(230, 130);
        this.w_in_a.addSolderDot(100, 130);
        (this.w_in_b = new Wire(100, 190, 150, 190, this.v_in_b, "B")).append(150, 270);
        this.w_in_b.append(150, 190);
        this.w_in_b.append(230, 190);
        this.w_in_b.addSolderDot(150, 190);
        this.w_in_b.addSolderDot(100, 190);
        (this.w_out = new Wire(200, 240, 280, 240, this.v_out, "Y")).append(280, 220);
        this.w_out.append(280, 240);
        this.w_out.append(350, 240);
        this.w_out.addSolderDot(280, 240);
        this.w_out.addSolderDot(350, 240);
    }
    ...
    public void drawBorder(final Graphics graphics) {
        ...
        if (this.techlogo == null) {
            this.techlogo = this.getImage(this.getCodeBase(), "images/nor2.gif");
        }
        if (this.techlogo != null) {
            graphics.drawImage(this.techlogo, this.xsize - 126 - 6, 6, this);
        }
    }
    ...
    public void paint(final Graphics graphics) {
        ...
        graphics.setColor(Color.black);
        graphics.drawString("CMOS 2-input NOR gate demo:   Y = !(A v B)", 10, 20);
    ...
    public boolean mouseDown(final Event event, final int n, final int n2) {
        ...
        if (this.v_in_a.get() == 0) {
            this.v_int.set(1);
        }
        else if (this.v_in_b.get() == 0) {
            this.v_int.set(this.v_out.get());
        }
        else {
            this.v_int.set(3);
        }
        this.pmos1.setVoltages(this.v_vcc, this.v_in_a, this.v_int);
        this.pmos2.setVoltages(this.v_int, this.v_in_b, this.v_out);
        this.nmos1.setVoltages(this.v_gnd, this.v_in_b, this.v_out);
        this.nmos2.setVoltages(this.v_gnd, this.v_in_a, this.v_out);
        this.repaint();
        return false;
    }
