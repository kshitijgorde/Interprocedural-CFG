...
public class RubyFileTest$s$1$0$worldWritable extends JavaMethodOne
{
    public RubyFileTest$s$1$0$worldWritable(final RubyModule implementationClass, final Visibility visibility) {
