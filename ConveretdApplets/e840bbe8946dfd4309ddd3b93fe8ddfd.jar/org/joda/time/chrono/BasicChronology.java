...
abstract class BasicChronology extends AssembledChronology
{
    ...
    BasicChronology(final Chronology chronology, final Object o, final int iMinDaysInFirstWeek) {
        super(chronology, o);
        this.iYearInfoCache = new YearInfo[1024];
        if (iMinDaysInFirstWeek < 1 || iMinDaysInFirstWeek > 7) {
            throw new IllegalArgumentException("Invalid min days in first week: " + iMinDaysInFirstWeek);
        }
    ...
    public long getDateTimeMillis(final int n, final int n2, final int n3, final int n4) throws IllegalArgumentException {
        ...
        FieldUtils.verifyValueBounds(DateTimeFieldType.millisOfDay(), n4, 0, 86400000);
