...
final class HighScoreTool
{
    ...
    public void doHigh() {
        URL url = null;
        final String string = "http://www.mycgiserver.com/servlet/realapplets.ServletHS?Score=" + this.getScore() + "&Level=" + this.getLevel() + "&Code=" + this.getCode(this.getScore(), this.getLevel()) + "&Dir=" + this.getDir() + "&File=" + this.getFile() + "&Applet=" + this.getApplet();
        try {
            url = new URL(string);
            ...
            System.out.println("eg. <APPLET CODE=Invaders.class  archive=RealInvaders.jar WIDTH=550 HEIGHT=335 MAYSCRIPT>");
