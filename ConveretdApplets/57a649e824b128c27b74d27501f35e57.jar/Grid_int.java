...
public class Grid_int extends Applet implements ActionListener, KeyListener, MouseListener, MouseMotionListener
{
    ...
    ClueView_int[] OO;
    boolean DD;
    private static final String k = " Software © 2004 ";
    ...
    public void init() {
        ...
        try {
            ...
            try {
                ...
                this.copylen = fontMetrics.stringWidth(" Software © 2004 ");
            ...
            if (this.Err == "") {
                this.Err = "Error reading crossword file";
            }
        }
    }
    ...
    public void paint(final Graphics graphics) {
        if (this.Err != null) {
            ...
            graphics.drawString(" Software © 2004 ", this.a.getBounds().x + -this.copylen, this.p);
        }
    }
    ...
    void IF(final String s, final String s2, final boolean b) {
        if (s != null && s.length() != 0) {
            ...
            final int index4 = s3.indexOf("%TIME%");
            if (index4 != -1 && this.ka != null) {
                s3 = s3.substring(0, index4) + Integer.toString(this.ka.ke) + s3.substring(index4 + 6);
            }
            String s4 = s2;
            if (s4 == null) {
                s4 = (b ? "_self" : "_blank");
    ...
    public void keyPressed(final KeyEvent keyEvent) {
        ...
        if (keyEvent.getSource() == this.CCGrid) {
