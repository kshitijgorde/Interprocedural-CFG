...
class d extends m
{
    ...
    public d(final double n, final double n2, final double d, final double a, final int b) {
        this.d = d;
        this.a = a;
        this.b = b;
        this.c = new Rectangle2D.Double(n, n2, 7.0, 19.0);
    ...
    public void c() {
        ...
        this.c.setRect(this.c.getMinX() + this.d, this.c.getMinY() + this.a, 7.0, 19.0);
    ...
    public void a(final Graphics2D graphics2D, final ImageObserver imageObserver) {
        graphics2D.drawImage(y.O, (int)this.c.getMinX(), (int)this.c.getMinY(), imageObserver);
    }
