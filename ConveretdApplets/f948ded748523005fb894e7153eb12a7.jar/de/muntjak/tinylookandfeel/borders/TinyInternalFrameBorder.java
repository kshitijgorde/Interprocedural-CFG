...
public class TinyInternalFrameBorder extends AbstractBorder implements UIResource
{
    ...
    public void paintBorder(final Component component, final Graphics graphics, final int n, final int n2, final int n3, final int n4) {
        ...
        if (this.isPalette) {
            this.titleHeight = Theme.framePaletteTitleHeight[Theme.derivedStyle[Theme.style]];
        }
        else {
    ...
    private void drawXpCaption(final Graphics graphics, final int n, final int n2, final int n3, final int n4, final Color color) {
        if (this.isPalette) {
            this.drawXpPaletteCaption(graphics, n, n2, n3, n4, color);
            return;
        }
        ...
        final Object value = TinyInternalFrameBorder.cache.get(captionKey);
        if (value != null) {
            graphics.drawImage((Image)value, n + 6, n2, n + n3 - 6, n2 + 5, 0, 0, 1, 5, this.frame);
            graphics.drawImage((Image)value, n + 1, n2 + 5, n + n3 - 1, n2 + this.titleHeight, 0, 5, 1, this.titleHeight, this.frame);
            if (this.isActive) {
                TinyInternalFrameBorder.frameUpperColor = ColorRoutines.darken(color, 4 * n5);
                TinyInternalFrameBorder.frameLowerColor = ColorRoutines.lighten(color, 10 * n6);
            }
            else {
                TinyInternalFrameBorder.disabledUpperColor = ColorRoutines.darken(color, 4 * n5);
                TinyInternalFrameBorder.disabledLowerColor = ColorRoutines.lighten(color, 10 * n6);
            }
            return;
        }
        ...
        graphics2.dispose();
        graphics.drawImage(bufferedImage, n + 6, n2, n + n3 - 6, n2 + 5, 0, 0, 1, 5, this.frame);
        graphics.drawImage(bufferedImage, n + 1, n2 + 5, n + n3 - 1, n2 + this.titleHeight, 0, 5, 1, this.titleHeight, this.frame);
        TinyInternalFrameBorder.cache.put(captionKey, bufferedImage);
    }
    ...
    private void drawXpCaptionNoCache(final Graphics graphics, final int n, final int n2, final int n3, final int n4, final Color color) {
        if (this.isPalette) {
            this.drawXpPaletteCaptionNoCache(graphics, n, n2, n3, n4, color);
            return;
        }
        int n5 = n2;
        ...
        ++n5;
        if (this.isActive) {
            graphics.setColor(TinyInternalFrameBorder.frameUpperColor = ColorRoutines.darken(color, 4 * n6));
        }
        else {
            graphics.setColor(TinyInternalFrameBorder.disabledUpperColor = ColorRoutines.darken(color, 4 * n6));
        }
        ...
        ++n5;
        if (this.isActive) {
            graphics.setColor(TinyInternalFrameBorder.frameLowerColor = ColorRoutines.lighten(color, 10 * n7));
        }
        else {
            graphics.setColor(TinyInternalFrameBorder.disabledLowerColor = ColorRoutines.lighten(color, 10 * n7));
        }
        graphics.drawLine(n + 1, n5, n + n3 - 2, n5);
        ++n5;
        graphics.setColor(ColorRoutines.lighten(color, 4 * n7));
    ...
    private void drawXpPaletteCaption(final Graphics graphics, final int n, final int n2, final int n3, final int n4, final Color color) {
        int n5 = n2;
        int n6 = Theme.frameSpreadDarkDisabled[Theme.style];
        int n7 = Theme.frameSpreadLightDisabled[Theme.style];
        ColorUIResource color2;
        ...
        final Color darken = ColorRoutines.darken(color, 4 * n6);
        graphics.setColor(darken);
        graphics.drawLine(n + 3, n5, n + 5, n5);
        graphics.drawLine(n + n3 - 6, n5, n + n3 - 4, n5);
        graphics.setColor(ColorRoutines.getAlphaColor(darken, 139));
        graphics.drawLine(n + 2, n5, n + 2, n5);
        graphics.drawLine(n + n3 - 3, n5, n + n3 - 3, n5);
        graphics.setColor(ColorRoutines.getAlphaColor(darken, 23));
        ...
        ++n5;
        graphics.setColor(ColorRoutines.lighten(color, 10 * n7));
        graphics.drawLine(n + 4, n5, n + 5, n5);
        graphics.drawLine(n + n3 - 6, n5, n + n3 - 5, n5);
        graphics.setColor(color);
        graphics.drawLine(n + 3, n5, n + 3, n5);
        graphics.drawLine(n + n3 - 4, n5, n + n3 - 4, n5);
        final Color darken2 = ColorRoutines.darken(color, 6 * n6);
        ...
        ++n5;
        graphics.setColor(ColorRoutines.darken(color, 2 * n6));
        graphics.drawLine(n + 5, n5, n + 6, n5);
        graphics.drawLine(n + n + n3 - 7, n5, n + n3 - 6, n5);
        graphics.setColor(ColorRoutines.darken(color, 6 * n6));
        graphics.drawLine(n + 1, n5, n + 1, n5);
        graphics.drawLine(n + n3 - 2, n5, n + n3 - 2, n5);
        graphics.setColor(ColorRoutines.lighten(color, 10 * n7));
        ...
        if (value != null) {
            ...
            graphics.drawImage((Image)value, n + 1, n2 + 5, n + n3 - 1, n2 + this.titleHeight, 0, 5, 1, this.titleHeight, this.frame);
            if (this.isActive) {
                TinyInternalFrameBorder.frameUpperColor = ColorRoutines.darken(color, 4 * n6);
                TinyInternalFrameBorder.frameLowerColor = ColorRoutines.lighten(color, 10 * n7);
            }
            else {
                TinyInternalFrameBorder.disabledUpperColor = ColorRoutines.darken(color, 4 * n6);
                TinyInternalFrameBorder.disabledLowerColor = ColorRoutines.lighten(color, 10 * n7);
            }
            return;
        }
        final BufferedImage bufferedImage = new BufferedImage(1, this.titleHeight, 2);
        ...
        graphics2.setColor(color2);
        graphics2.drawLine(0, 0, 1, 0);
        graphics2.setColor(ColorRoutines.darken(color, 4 * n6));
        graphics2.drawLine(0, 1, 1, 1);
        graphics2.setColor(ColorRoutines.lighten(color, 10 * n7));
        graphics2.drawLine(0, 2, 1, 2);
        graphics2.setColor(color);
        graphics2.drawLine(0, 3, 1, 3);
        graphics2.setColor(ColorRoutines.darken(color, 2 * n6));
        graphics2.drawLine(0, 4, 1, 4);
        graphics2.setColor(ColorRoutines.darken(color, 4 * n6));
        graphics2.drawLine(0, 5, 1, 5);
        graphics2.drawLine(0, 6, 1, 6);
        graphics2.setColor(ColorRoutines.darken(color, 3 * n6));
        graphics2.drawLine(0, 7, 1, 7);
        graphics2.setColor(ColorRoutines.darken(color, 2 * n6));
        graphics2.drawLine(0, 8, 1, 8);
        graphics2.setColor(ColorRoutines.darken(color, n6));
        graphics2.drawLine(0, 9, 1, 9);
        graphics2.setColor(color);
        graphics2.drawLine(0, 10, 1, 10);
        graphics2.setColor(ColorRoutines.lighten(color, 2 * n7));
        graphics2.drawLine(0, 11, 1, 11);
        graphics2.setColor(ColorRoutines.lighten(color, 4 * n7));
        graphics2.drawLine(0, 12, 1, 12);
        graphics2.setColor(ColorRoutines.lighten(color, 5 * n7));
        graphics2.drawLine(0, 13, 1, 13);
        graphics2.setColor(ColorRoutines.lighten(color, 6 * n7));
        graphics2.drawLine(0, 14, 1, 14);
        graphics2.setColor(ColorRoutines.lighten(color, 8 * n7));
        graphics2.drawLine(0, 15, 1, 15);
        graphics2.setColor(ColorRoutines.lighten(color, 9 * n7));
        graphics2.drawLine(0, 16, 1, 16);
        graphics2.setColor(ColorRoutines.lighten(color, 10 * n7));
        graphics2.drawLine(0, 17, 1, 17);
        graphics2.setColor(ColorRoutines.lighten(color, 4 * n7));
    ...
    private void drawXpPaletteCaptionNoCache(final Graphics graphics, final int n, final int n2, final int n3, final int n4, final Color color) {
        int n5 = n2;
        int n6 = Theme.frameSpreadDarkDisabled[Theme.style];
        int n7 = Theme.frameSpreadLightDisabled[Theme.style];
        ColorUIResource color2;
    ...
    static {
        TinyInternalFrameBorder.cache = new HashMap();
    }
