...
final class h extends Class43 implements Interface9
{
    ...
    private final native void JA(final oa p0, final ya p1, final byte[][] p2, final int[] p3, final int[] p4, final int[] p5, final int[] p6);
    
    @Override
    public final native void w(final boolean p0);
    
    private final native void NA(final char p0, final int p1, final int p2, final int p3, final boolean p4, final aa p5, final int p6, final int p7);
    ...
    final void method409(final char c, final int n, final int n2, final int n3, final boolean b, final aa aa, final int n4, final int n5) {
        this.NA(c, n, n2, n3, b, aa, n4, n5);
    }
    
    h(final oa oa, final ya ya, final Class197 class197, final Class324[] array, final Class332[] array2) {
        super(oa, class197);
        ...
        this.JA(oa, ya, array3, array4, array5, array6, array7);
    }
