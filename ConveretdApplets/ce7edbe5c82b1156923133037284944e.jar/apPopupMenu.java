...
public class apPopupMenu extends Applet implements Runnable
{
    ...
    public void IIl1() {
        ...
        if (this.l1II != null && !this.l1II.equalsIgnoreCase("") && !this.lIlll(this.l1II, this.getParameter("key"))) {
            this.showStatus(this.l1I1 = "Free menu applets at www.apycom.com");
        }
        try {
        ...
        this.l1II = this.getParameter("encoding");
        if (this.l1II != null) {
        ...
        while (stringTokenizer3.hasMoreTokens()) {
            ...
            final int n3 = this.l1II.lastIndexOf(")") + 1;
            if (index != -1 && n3 > index) {
                substring = this.l1II.substring(index, n3);
                final int n4 = this.l1II.lastIndexOf(this.II1I) + 1;
                final int n5 = this.l1II.lastIndexOf(".") + 4;
                if (n5 > n4) {
                    substring2 = this.l1II.substring(n4, n5);
                }
            }
            String nextToken2 = stringTokenizer4.nextToken();
            if (this.lI1ll != "") {
                try {
                    nextToken2 = new String(nextToken2.getBytes(), this.lI1ll);
                }
                catch (Exception ex3) {}
            }
            if (!this.l1II.trim().startsWith("|")) {
                this.l1l[this.l1I][0] = nextToken2;
                final StringTokenizer stringTokenizer5 = new StringTokenizer(this.l1l[this.l1I][0], "\\");
                int n6 = 0;
                while (stringTokenizer5.hasMoreTokens()) {
                    this.l1l[this.l1I][n6] = stringTokenizer5.nextToken();
                    ++n6;
                }
                if ((this.llll1[this.l1I] = n6) > 1) {
                    n2 += n6 - 1;
                }
                ...
                if (this.l1l[this.l1I][0].trim().equals("-")) {
                    ...
                    if (stringTokenizer4.countTokens() == 1) {
                        ...
                        this.l1II = stringTokenizer4.nextToken().trim();
                        if (!this.l1II.startsWith("javascript:")) {
                            try {
                                this.l1Il[this.l1I] = new URL(this.getCodeBase(), this.l1II);
                            }
                            catch (Exception ex4) {}
                            this.llI[this.l1I] = stringTokenizer4.nextToken();
                        }
                        else {
                            if (substring != "") {
                                this.llI[this.l1I] = substring;
                                if (substring2 != "") {
                                    this.I11[this.l1I] = this.IlII(substring2);
                                }
                                ++this.l1I;
                                continue;
                            }
                ...
                if (stringTokenizer4.hasMoreTokens()) {
                    ...
                    if (!this.l1II.startsWith("javascript:")) {
                        ...
                        this.lll[this.lIl] = stringTokenizer4.nextToken();
                    }
                    else if (substring == "") {
                        this.lll[this.lIl] = this.l1II;
                    }
                    else {
                        this.lll[this.lIl] = substring;
                    }
                }
                this.lll[this.lIl] = String.valueOf(this.lll[this.lIl]) + this.llI[this.l1I - 1];
                ++this.lIl;
            }
        }
        ...
        if (this.llII) {
            for (int l = 0; l < this.lII; ++l) {
                if (!this.l1l[l][0].trim().equals("-")) {
                    ...
                    this.l1lI[l] = 0;
                    for (int n8 = 0; n8 < this.llll1[l]; ++n8) {
                        if (this.l1lI[l] < this.IlI.getFontMetrics().stringWidth(this.l1l[l][n8])) {
                            this.l1lI[l] = this.IlI.getFontMetrics().stringWidth(this.l1l[l][n8]);
                        }
                    }
                    ...
                    if (this.I11[l] != null) {
                        ...
                        final int n10 = l;
                        l1lI2[n10] += this.I11[l].getWidth(this) + 3;
                    }
                    this.lIl += this.l1lI[l];
                }
            }
            this.l111[0] = this.l11;
            for (int n11 = 0; n11 < this.lII; ++n11) {
                int ii11 = 0;
                if (this.llI[n11] != null && this.llI[n11].startsWith("__menu") && this.ll11) {
                    ii11 = this.II11;
                }
                this.lll11[n11] = this.lI1;
                final int n12 = (this.II1 - 7 * n - this.lIl) / (this.lII - n) / 2;
                if (this.l1l[n11][0].trim().equals("-")) {
                    this.l1lI[n11] = 7;
                }
                else {
                    this.l1lI[n11] += n12 * 2;
                ...
                if (n11 > 0) {
                    this.l111[n11] = this.l111[n11 - 1] + this.l1lI[n11 - 1];
                }
                this.l11l[n11] = this.l11;
                int n13 = 0;
                if (this.I11[n11] != null) {
                    n13 = this.I11[n11].getWidth(this) + 3;
                }
                for (int n14 = 0; n14 < this.llll1[n11]; ++n14) {
                    this.l1l1[n11][n14] = (this.l1lI[n11] - this.IlI.getFontMetrics().stringWidth(this.l1l[n11][n14]) + n13 - ii11) / 2;
                    if (this.III1.equalsIgnoreCase("right")) {
                        this.l1l1[n11][n14] = this.l1l1[n11][n14] * 2 - (n12 + n13);
                    }
                    if (this.III1.equalsIgnoreCase("left")) {
                        this.l1l1[n11][n14] = n12 + n13;
                    }
                }
                this.IllI(n11);
                this.IlI1();
            ...
            this.lIl = this.l11;
            for (int n15 = 0; n15 < this.lII; ++n15) {
                this.l111[n15] = this.l11;
                this.l1lI[n15] = this.II1 - this.l11 * 2;
                if (this.l1l[n15][0].trim().equals("-")) {
                    this.l11l[n15] = this.lIl;
                    this.lIl += 8;
                }
                else {
                    if (this.llI[n15].startsWith("__menu") && this.ll11) {
                        n7 = this.II11;
                    }
                    this.lll1I[n15] = this.lI1 / 2 + this.II11 / 2 - 1;
                    this.l11l[n15] = this.lIl;
                    this.lll11[n15] = this.lI1 + (this.llll1[n15] - 1) * (this.II11 + 1);
                    this.lIl += this.lll11[n15];
                    for (int n16 = 0; n16 < this.llll1[n15]; ++n16) {
                        this.l1l1[n15][n16] = this.II11 / 2 + this.IIlI + 3;
                        if (this.III1.equalsIgnoreCase("right")) {
                            this.l1l1[n15][n16] = this.II1 - this.IlI.getFontMetrics().stringWidth(this.l1l[n15][n16]) - this.II11 / 2 - n7;
                        }
                        if (this.III1.equalsIgnoreCase("center")) {
                            this.l1l1[n15][n16] = (this.II1 - this.IlI.getFontMetrics().stringWidth(this.l1l[n15][n16])) / 2;
                        }
                    }
                    this.IllI(n15);
                    this.IlI1();
    ...
    private void Illl(final Menu menu, final int n, final int n2) {
        final String string = "__menu" + n + "_";
        for (int i = 0; i < this.Il1; ++i) {
            if (this.lll[i].indexOf(string) != -1) {
                int n3 = 0;
                int n4 = 0;
                ...
                this.lll[i] = this.lll[i].substring(0, this.lll[i].indexOf(string));
                ...
                if (i + 1 < this.Il1 && this.lll[i + 1].indexOf("__menu" + n + "_") != -1) {
    ...
    public boolean handleEvent(final Event event) {
        ...
        try {
            if (event.id == 1001) {
                ...
                for (int i = 0; i < this.Il1; ++i) {
                    if (this.lI1l[i] != null && this.lI1l[i].equals(event.target) && !this.lll[i].equals("_")) {
                        this.lI1lI = this.l11I[i];
                        this.lI11l = this.lll[i];
                    }
                }
            }
            ...
            if (event.id == 501) {
                ...
                this.IlI1();
                this.lI1lI = this.l1Il[ill1];
                this.lI11l = this.llI[ill1];
                this.lI1l1 = ill1;
                if (this.l1I1 == null) {
                    this.showStatus(this.l1l[ill1][0].trim());
                }
    ...
    protected boolean lIlll(String s, final String s2) {
        try {
            s = s.toLowerCase();
            if (s.indexOf("://") != -1) {
                s = s.substring(s.lastIndexOf("://") + 3);
            }
            final int n = Integer.parseInt(s2.substring(2, 5), 16) - 546;
            final int n2 = Integer.parseInt(s2.substring(5, s2.lastIndexOf("O")), 16) - 546;
            final String substring = s2.substring(s2.lastIndexOf("O") + 1, s2.lastIndexOf("O") + 2);
            if (!substring.equals("b") && !substring.equals("f")) {
                return false;
            }
            ...
            try {
                if (!this.lI11l.equals("_")) {
                    ...
                    if (this.lI11l.startsWith("__menu")) {
                        this.lI11l = "_";
                        if (this.llII) {
                            this.lI11[this.lI1l1].show(this, this.l111[this.lI1l1], this.l11l[this.lI1l1] + this.lll11[this.lI1l1]);
                        }
                        else {
                            this.lI11[this.lI1l1].show(this, this.l111[this.lI1l1] + this.l1lI[this.lI1l1], this.l11l[this.lI1l1]);
                        }
                    }
                    else {
                        if (!this.lI11l.startsWith("javascript:")) {
                            if (this.lI1lI != null) {
                                this.getAppletContext().showDocument(this.lI1lI, this.lI11l);
                            }
                        }
                        else {
                            this.II(this.lI11l);
