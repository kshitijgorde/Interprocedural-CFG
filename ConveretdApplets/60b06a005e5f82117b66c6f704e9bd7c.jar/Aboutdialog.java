...
class Aboutdialog extends Dialog
{
    ...
    public Aboutdialog(final Applet app, final String version, final boolean isDemo) {
        super(new Frame(), "About Sidereal & Solar Clock", true);
        ...
        if (isDemo) {
            L1.setText("Version " + version + " DEMO");
        }
        else {
            L1.setText("Version " + version);
        }
        gbl.setConstraints(L1, gbc);
        this.add(L1);
        gbc.gridy = 1;
        final Label L2 = new Label("© 2005-2010 Juergen Giesen");
