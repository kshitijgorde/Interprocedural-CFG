...
public class v
{
    ...
    public final synchronized int p(final String s, final PixScreen p2) {
        ...
        try {
            ...
            System.out.println("Length of url connection = " + contentLength);
            if (contentLength == -1) {
                contentLength = 1027;
            }
        ...
        for (int k = 0; k < p5; ++k) {
            ...
            switch (p8) {
                ...
                case 1001: {
                    ...
                    n2 += 4;
                    System.out.println("iFieldType = " + p11);
                    if (p11 != 6) {
                        System.out.println("Incorrect field type.");
                        return 0;
                    }
                    final String p12 = this.p.p(p7, n2);
                    n2 += 4 + p12.length();
                    System.out.println("logo image = " + p12);
                    final int p13 = this.p.p(p7, n2);
                    n2 += 4;
                    System.out.println("iNumberOfImageBytes = " + p13);
                    final byte[] array3 = new byte[p13];
                    for (int l = 0; l < p13; ++l) {
                        array3[l] = p7[n2];
                        ++n2;
                    }
                ...
                case 1002: {
                    ...
                    n2 += 4;
                    final byte[] array4 = new byte[p15];
                    for (int n5 = 0; n5 < p15; ++n5) {
                        array4[n5] = p7[n2];
                        ++n2;
                    }
                ...
                case 1003: {
                    ...
                    n2 += 4 + this.p.p(p7, n2).length();
                    final int p17 = this.p.p(p7, n2);
                    n2 += 4;
                    final byte[] array5 = new byte[p17];
                    for (int n7 = 0; n7 < p17; ++n7) {
                        array5[n7] = p7[n2];
                        ++n2;
                    }
                    this.p = Toolkit.getDefaultToolkit().createImage(array5);
                    v.p.prepareImage(this.p, v.p);
                    break;
                }
            }
        }
