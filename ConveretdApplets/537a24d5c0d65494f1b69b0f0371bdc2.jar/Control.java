                    ...
                    if (this.attack == 0) {
                        ...
                        do {
                            if (acr != madness.im && checkPoints.clear[acr] != -1) {
                                ...
                                int j;
                                for (j = (int)(90 + n5 + Math.atan((checkPoints.opz[acr] - contO.z) / (checkPoints.opx[acr] - contO.x)) / 0.017453292519943295); j < 0; j += 360) {}
                                while (j > 180) {
                                    j -= 360;
                                }
                                int n6 = Math.abs(i - j);
                                ...
                                if (n6 < 85 + 15 * (Math.abs(checkPoints.clear[acr] - madness.clear) + 1) && this.py(contO.x / 100, checkPoints.opx[acr] / 100, contO.z / 100, checkPoints.opz[acr] / 100) < n7 && this.afta && madness.power > n4) {
                                    float n8 = 35 - Math.abs(checkPoints.clear[acr] - madness.clear) * 10;
                                    if (n8 < 1.0f) {
                                        n8 = 1.0f;
                                    }
            ...
            if (b3) {
                ...
                if (this.attack == 0) {
                    ...
                    if (this.turncnt > this.randtcnt) {
                        ...
                        this.pan = (int)(90 + n20 + Math.atan((checkPoints.z[point] - contO.z) / (checkPoints.x[point] - contO.x)) / 0.017453292519943295);
                        this.turncnt = 0;
                    ...
                    this.pan = (int)(90 + n21 + Math.atan((checkPoints.opz[this.acr] - contO.z) / (checkPoints.opx[this.acr] - contO.x)) / 0.017453292519943295);
                    --this.attack;
                    if (this.attack <= 0) {
                        this.attack = 0;
                    }
                ...
                if (this.trickfase == 2) {
                    ...
                    if (this.udbare) {
                        int n23;
                        for (n23 = madness.pzy + 90; n23 < 0; n23 += 360) {}
                        while (n23 > 180) {
                            n23 -= 360;
                        }
                        final int abs = Math.abs(n23);
