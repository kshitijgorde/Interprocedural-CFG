        ...
        try {
            ...
            try {
                ...
                if (error == null) {
                    ...
                    if (dl_mp4high != null) {
                        mainWindow.eval("kv_ds('dl_mp4high', 'MP4', '360p', '" + dl_mp4high + "', '" + title2 + "');");
                    }
                    if (dl_mp4hd != null) {
                    ...
                    if (dl_mp4hd3 != null) {
                        mainWindow.eval("kv_ds('dl_mp4hd3', 'MP4', '3072p (Original)', '" + dl_mp4hd3 + "', '" + title2 + "');");
                    }
                    if (dl_webmhd != null) {
                        mainWindow.eval("kv_ds('dl_webmhd', 'WebM', '480p', '" + dl_webmhd + "', '" + title2 + "');");
                    }
                    if (dl_webmhd2 != null) {
                        mainWindow.eval("kv_ds('dl_webmhd', 'WebM', '720p', '" + dl_webmhd2 + "', '" + title2 + "');");
                    }
                    try {
