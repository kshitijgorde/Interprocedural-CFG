...
{
    public BEQInstr(final Operand v1, final Operand v2, final Label jmpTarget) {
        super(Operation.BEQ, v1, v2, jmpTarget);
    }
    
    public Instr cloneForInlining(final InlinerInfo ii) {
        return new BEQInstr(this.operand1.cloneForInlining(ii), this.operand2.cloneForInlining(ii), ii.getRenamedLabel(this.target));
    }
