...
public class RubyArgsFile$s$0$1$to_a extends JavaMethodN
{
    public RubyArgsFile$s$0$1$to_a(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyArgsFile.to_a(context, recv, array);
    }
}
