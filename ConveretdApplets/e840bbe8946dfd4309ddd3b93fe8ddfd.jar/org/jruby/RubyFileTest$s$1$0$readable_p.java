...
public class RubyFileTest$s$1$0$readable_p extends JavaMethodOne
{
    public RubyFileTest$s$1$0$readable_p(final RubyModule implementationClass, final Visibility visibility) {
