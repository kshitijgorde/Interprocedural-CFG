...
final class aj extends Panel
{
    al q;
    private static Image q;
    private ai q;
    
    public aj(final ai q) {
        this.q = q;
    }
    ...
    public final synchronized void update(final Graphics graphics) {
        if (aj.q == null) {
            aj.q = co.q(this, this.getSize().width, this.getSize().height, "cpp.u");
        }
        final Graphics graphics2;
        (graphics2 = aj.q.getGraphics()).drawImage(this.q.q(aj.q), 0, 0, this);
        graphics2.setColor(Color.white);
        graphics2.drawOval(this.q.q.x - 4, this.q.q.y - 4, 8, 8);
        graphics2.dispose();
        graphics.drawImage(aj.q, 0, 0, this);
    }
}
