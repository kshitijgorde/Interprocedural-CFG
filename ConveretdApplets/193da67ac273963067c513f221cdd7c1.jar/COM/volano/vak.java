...
public class vak extends Menu
{
    ...
    public vak(final vd vd) {
        super(vd.es);
        (this.a = new Menu(vd.et)).add(new CheckboxMenuItem("Serif"));
        this.a.add(new CheckboxMenuItem("SansSerif"));
        this.a.add(new CheckboxMenuItem("Monospaced"));
        this.b = new Menu(vd.eu);
        this.c = new CheckboxMenuItem(vd.ev);
        this.d = new CheckboxMenuItem(vd.ew);
        this.e = new CheckboxMenuItem(vd.ex);
        this.f = new CheckboxMenuItem(vd.ey);
        this.b.add(this.c);
        this.b.add(this.d);
        this.b.add(this.e);
        this.b.add(this.f);
        this.g = new MenuItem(vd.ez);
        this.h = new MenuItem(vd.e0);
        this.i = new CheckboxMenuItem(vd.e1);
        this.j = new CheckboxMenuItem(vd.e2);
        this.k = new CheckboxMenuItem(vd.e3);
        this.l = new CheckboxMenuItem(vd.e4);
        this.m = new CheckboxMenuItem(vd.e5);
