...
public class StdMapO extends Applet implements MouseListener, KeyListener, ActionListener
{
    int w;
    int h;
    int w2;
    ...
    public void Orbits(final int n) {
        ...
        double po = this.Po;
        int n3;
        int n2 = n3 = this.w2 + (int)((xo - this.Xc) / this.Mx);
        int n4 = this.h2 - (int)((po - this.Yc) / this.My);
        for (int i = 0; i < n; ++i) {
            po += this.K * Math.sin(xo);
            xo += po;
            int n5 = this.w2 + (int)((xo - this.Xc) / this.Mx);
            final int n6 = this.h2 - (int)((po - this.Yc) / this.My);
            if (xo < 0.0) {
                this.buffGraphics.drawLine(n2, n4, n5, n6);
                n2 = this.w2 + (int)((this.Xo + this.Pi2 - this.Xc) / this.Mx);
                while (xo < 0.0) {
                    xo += this.Pi2;
                }
                n5 = this.w2 + (int)((xo - this.Xc) / this.Mx);
            }
            if (xo > this.Pi2) {
                this.buffGraphics.drawLine(n2, n4, n5, n6);
                n2 = this.w2 + (int)((this.Xo - this.Pi2 - this.Xc) / this.Mx);
            ...
            this.buffGraphics.drawLine(n2, n4, n5, n6);
            this.buffGraphics.fillRect(n3, n4, 3, 3);
            n3 = (n2 = n5);
            n4 = n6;
            this.Xo = xo;
        }
    ...
    public void drawLabel() {
        ...
        while (true) {
            ...
            this.Po = Double.valueOf(stringTokenizer.nextToken());
