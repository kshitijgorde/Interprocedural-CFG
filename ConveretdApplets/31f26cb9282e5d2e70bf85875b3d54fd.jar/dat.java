...
public class dat
{
    ...
    SimpleTimeZone Baghdad;
    SimpleTimeZone Colombo;
    SimpleTimeZone Dakar;
    SimpleTimeZone Kabul;
    SimpleTimeZone Katmandu;
    SimpleTimeZone Kuala_Lumpur;
    SimpleTimeZone Riyadh;
    SimpleTimeZone Vientiane;
    SimpleTimeZone Ankara;
    SimpleTimeZone Doha;
    SimpleTimeZone Leipzig;
    SimpleTimeZone Nicosia;
    SimpleTimeZone Beijing;
    SimpleTimeZone Hanoi;
    
    public dat() {
        (this.city = new Vector()).addElement("Abidjan");
        this.city.addElement("Amsterdam");
        this.city.addElement("Ankara");
        this.city.addElement("Athens");
        this.city.addElement("Baghdad");
        this.city.addElement("Bangkok");
        this.city.addElement("Beirut");
        this.city.addElement("Beijing(Peking)");
        ...
        this.city.addElement("Kabul");
        this.city.addElement("Katmandu");
        this.city.addElement("Khartoum");
        this.city.addElement("Kinshasa");
        this.city.addElement("Kuala Lumpur");
        this.city.addElement("Leipzig");
        ...
        this.city.addElement("Vientiane");
        ...
        this.Baghdad = new SimpleTimeZone(10800000, "Asia/Baghdad", 3, 1, 0, 10800000, 9, 1, 0, 14400000);
        this.Colombo = new SimpleTimeZone(21600000, "Asia/Colombo", 0, 0, 0, 0, 0, 0, 0, 0);
        this.Dakar = new SimpleTimeZone(0, "Africa/Dakar", 0, 0, 0, 0, 0, 0, 0, 0);
        this.Kabul = new SimpleTimeZone(16200000, "Asia/Kabul", 0, 0, 0, 0, 0, 0, 0, 0);
        this.Katmandu = new SimpleTimeZone(20700000, "Asia/Katmandu", 0, 0, 0, 0, 0, 0, 0, 0);
        this.Kuala_Lumpur = new SimpleTimeZone(28800000, "Asia/Kuala_Lumpur", 0, 0, 0, 0, 0, 0, 0, 0);
        this.Riyadh = new SimpleTimeZone(10800000, "Asia/Riyadh", 0, 0, 0, 0, 0, 0, 0, 0);
        this.Vientiane = new SimpleTimeZone(25200000, "Asia/Vientiane", 0, 0, 0, 0, 0, 0, 0, 0);
        this.Ankara = new SimpleTimeZone(7200000, "Europe/Ankara", 2, -1, 1, 10800000, 9, -1, 1, 10800000);
        this.Doha = new SimpleTimeZone(10800000, "Asia/Doha", 3, 1, 0, 10800000, 9, 1, 0, 14400000);
        this.Leipzig = new SimpleTimeZone(3600000, "Europe/Leipzig", 2, -1, 1, 7200000, 9, -1, 1, 7200000);
        this.Nicosia = new SimpleTimeZone(7200000, "Asia/Nicosia", 2, -1, 1, 0, 8, -1, 1, 0);
        this.Beijing = new SimpleTimeZone(28800000, "Asia/Beijing(Peking)", 0, 0, 0, 0, 0, 0, 0, 0);
        this.Hanoi = new SimpleTimeZone(25200000, "Asia/Hanoi", 0, 0, 0, 0, 0, 0, 0, 0);
    }
}
