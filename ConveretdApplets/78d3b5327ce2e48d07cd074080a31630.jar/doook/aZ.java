...
public class aZ extends D
{
    ...
    public Font a() {
        if (this.g == null) {
            this.g = new Font(this.h, this.ao | 0x1, this.an);
        }
        return this.g;
    }
    ...
    public Font b() {
        if (this.f == null) {
            this.f = new Font(this.h, this.ao, this.an);
        }
        return this.f;
    }
    ...
    public Font c() {
        if (this.h == null || this.h.getSize() + 4 != this.f.getSize()) {
            this.h = new Font(this.h, this.ao, this.an - 4);
        }
        return this.h;
    }
