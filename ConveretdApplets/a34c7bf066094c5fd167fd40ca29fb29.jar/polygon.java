...
class polygon
{
    ...
    public void translate(final int n, final int n2, final int n3) {
        this.p1.translate(n, n2, n3);
        this.p2.translate(n, n2, n3);
        this.p3.translate(n, n2, n3);
        this.p1.xform2d();
        this.p2.xform2d();
        this.p3.xform2d();
    }
    ...
    public void globalRotate(final int[] array) {
    }
    ...
    public void setShading(final int n) {
    }
    
    public void setFacing(final int n) {
    }
