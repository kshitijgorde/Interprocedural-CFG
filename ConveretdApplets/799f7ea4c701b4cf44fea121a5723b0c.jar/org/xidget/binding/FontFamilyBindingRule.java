...
public class FontFamilyBindingRule implements IBindingRule
{
    ...
    public FontFamilyBindingRule(final String fontTag) {
    ...
    private static final class Listener extends ExpressionListener
    {
        ...
        public void notifyAdd(final IExpression expression, final IContext context, final List<IModelObject> list) {
            ...
            this.xidget.getFeature(ITextWidgetFeature.class).setFontFamily(Xlate.get(this.node, ""));
        }
        ...
        @Override
        public void notifyChange(final IExpression expression, final IContext context, final String fontFamily, final String s) {
            this.xidget.getFeature(ITextWidgetFeature.class).setFontFamily(fontFamily);
        }
        ...
        public void notifyValue(final IExpression expression, final IContext[] array, final IModelObject modelObject, final Object o, final Object o2) {
            if (modelObject == this.node) {
                this.xidget.getFeature(ITextWidgetFeature.class).setFontFamily(Xlate.get(modelObject, ""));
            }
        }
