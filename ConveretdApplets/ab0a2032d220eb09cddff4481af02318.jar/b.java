...
class b extends Vo
{
    b(final FnChartsApplet fnChartsApplet, final volatile volatile1, final Color color, final Color color2) {
        super(3, new Insets(4, 4, 4, 4));
        this.setLayout(new FlowLayout(1));
        final Label label = new Label(volatile1._("msgFnChartsMaximized"));
