...
public abstract class cg implements cw
{
    protected ap q;
    private n q;
    private int q;
    ...
    public final void q(final Frame q) {
        ...
        this.q = "_blank";
        this.e = false;
        ((Frame)(this.q = this.q("mi_", true))).setBackground(bC.w.k);
        this.e = 21;
        (this.q = new n(this.q, this.e, this.q, this)).setBounds(0, 0, this.q, this.e);
    }
    ...
    protected final void e() {
        ...
        final Font y = cb.y;
        this.q.put("mb_bgcr", Integer.toString(bC.w.k.getRGB(), 16));
        this.q.put("mb_bgcrin", Integer.toString(bC.w.l.getRGB(), 16));
        this.q.put("mb_fgcrin", Integer.toString(bC.w.z.getRGB(), 16));
    ...
    private bI q(final String s, final boolean b) {
        int n = 1;
        final bI bi = new bI();
        while (this.q(s + n)) {
            ...
            final String s3 = (q3 != null && string.length() > 4) ? (ds.q("=5>E") + "_" + ds.q(q3.toLowerCase(), ' ', '_') + ".gif") : "";
            if (q4 == null) {
                q4 = s3;
            }
            Image image;
            if (q4 != null && q4.trim().length() > 0) {
                image = m.q().getImage(m.q().getCodeBase(), "Resources/" + ds.q("=5>E") + "/" + q4);
            }
            else {
                image = null;
            }
            ...
            if (q != null) {
                ...
                o = new at(q3, this.q(string), s2, b, image, booleanValue);
                if (dN.q() && (((at)o).q.equals(dX.j) || ((at)o).q.equals(dX.k))) {
                    cU.q = (at)o;
                }
            }
            if (this.q(s + n + "_1")) {
                ((at)o).q(this.q(s + n + "_", false));
            }
            ++n;
            bi.q(o);
        }
    ...
    protected final void w(final at at) {
        for (int i = 0; i < this.q.m.q; ++i) {
            final bN bn = (bN)this.q.m.q(i);
            if (at.q.equalsIgnoreCase(bn.a)) {
    ...
    protected final void w(final int n, int i) {
        ...
        if (this.q.m.q > 0) {
            this.q.put(s + "_txt", dX.b);
        }
        for (i = 0; i < this.q.m.q; ++i) {
            this.q.put(s + "_" + (i + 1) + "_txt", ((bN)this.q.m.q(i)).a);
        }
    }
}
