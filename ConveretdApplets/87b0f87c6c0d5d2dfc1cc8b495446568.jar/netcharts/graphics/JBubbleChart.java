...
public class JBubbleChart extends JDataChart
{
    ...
    public JBubbleChart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
    ...
    public JBubbleChart(final Applet applet) {
        this.FORMAT_TYPE_DEFAULT = -1;
        this.formatType = this.FORMAT_TYPE_DEFAULT;
        this.FORMAT_STR_DEFAULT = null;
        this.formatStr = this.FORMAT_STR_DEFAULT;
        ...
        if (super.param.changed("AddDataPoint")) {
            ...
            while (elements.hasMoreElements()) {
                ...
                try {
                    ...
                    NFDebug.print("JBubbleChart: AddDataPoint: first four attributes are needed");
                    continue;
                }
                if (n < 0 || n >= super.dataSeries.size()) {
                    NFDebug.print("JBubbleChart: AddDataPoint: Illegal data set ID");
                }
                else {
                    try {
                        ...
                        NFDebug.print("JBubbleChart: AddDataPoint: " + ex.getMessage());
                    }
                }
            }
        }
