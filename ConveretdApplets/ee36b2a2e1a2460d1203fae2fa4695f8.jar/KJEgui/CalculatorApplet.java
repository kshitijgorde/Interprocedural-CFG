...
public abstract class CalculatorApplet extends JApplet implements ActionListener
{
    ...
    public JButton JButton(final String s, final String toolTipText, final Color color, final Color background, final Font font) {
    ...
    public String getGraphApplet(final int n) {
        ...
        return "<div align=center id=\"GraphCalculator" + (n + 1) + "\"><!--[if IE]>" + "<object  name=\"graph\" classid=\"clsid:8AD9C840-044E-11D1-B3E9-00805F499D93\" height=" + string + " width=" + string2 + "  >" + "<param name=\"code\" value=\"KJEgraph.GraphApplet\" />" + "<param name=\"archive\" value=\"dinkytown.jar\" />" + "<param name=\"codebase\" value=\"" + this.gCB + "\" />" + "<![endif]-->" + "<![if !IE]>" + "<applet name=\"calculator\" code=\"KJEgraph.GraphApplet.class\" archive=\"dinkytown.jar\" codebase=\"" + this.gCB + "\" align=\"baseline\" height=" + string + " width=" + string2 + " > " + "<![endif]>" + "<param name=\"PAGEBACKGROUND_COLOR\" value=\"" + this.sPageBackground + "\" />" + "<param name=\"background_image\" value=\"" + this.getParameter("BACKGROUND", "background.jpg") + "\">" + "<param name=\"graph\" value=\"" + this.G[n].getProperty() + "\">" + "<param name=\"legend\" value=\"" + this.G[n]._legend.getProperty(this.G[n]) + "\">" + "<param name=\"titleXAxis\" value=\"" + this.G[n]._titleXAxis.getProperty() + "\">" + "<param name=\"titleYAxis\" value=\"" + this.G[n]._titleYAxis.getProperty() + "\">" + "<param name=\"titleGraph\" value=\"" + this.G[n]._titleGraph.getProperty() + "\">" + "<param name=\"axisX\" value=\"" + this.G[n]._axisX.getProperty() + "\">" + "<param name=\"axisY\" value=\"" + this.G[n]._axisY.getProperty() + "\">" + "<param name=\"grid\" value=\"" + this.G[n]._grid.getProperty() + "\">" + "<param name=\"dataProperties\" value=\"" + this.G[n].getDataProperties() + "\">" + "<param name=\"titleFont\" value=\"" + fontEncode(this.G[n].FONT_TITLE) + "\">" + "<param name=\"boldFont\" value=\"" + fontEncode(this.G[n].FONT_BOLD) + "\">" + "<param name=\"plainFont\" value=\"" + fontEncode(this.G[n].FONT_PLAIN) + "\">" + "<!--[if IE]></object><![endif]-->" + "<![if !IE]></applet><![endif]></div>";
    }
    ...
    public void init() {
        ...
        UIManager.put("ToolTip.border", new LineBorder(c(this.getParameter("HOVER_BORDER", parameter)), 3));
