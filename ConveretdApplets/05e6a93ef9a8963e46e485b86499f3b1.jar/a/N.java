...
public class N extends Canvas implements aB
{
    String q;
    private String w;
    private String e;
    ...
    public final void w() {
        ...
        if ((parent = this.getParent()) instanceof ab) {
            ((ab)parent).q(true, true);
        }
    }
    ...
    public boolean isShowing() {
        return (bE.w && bE.w == 1) || super.isShowing();
    }
    ...
    public N(final String s, final int n, int e) {
        this.r = false;
        this.r = aT.w.j();
        this.r = 20;
        this.q = null;
        ...
        this.e = this.getFontMetrics(be.w).getHeight() + 7;
        this.q(s);
        this.setFont(be.w);
    ...
    public N(final String s) {
        this(s, 22, 22);
        this.resize(this.getFontMetrics(be.w).stringWidth(s) + 20, this.e);
    }
