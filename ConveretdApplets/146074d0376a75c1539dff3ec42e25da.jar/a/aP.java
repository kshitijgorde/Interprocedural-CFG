...
public final class aP extends Panel implements MouseListener
{
    ...
    public aP(final aX q, final aH q2, final aM q3) {
        this.setLayout(null);
        this.q = q;
        this.q = q3;
        this.q = q2.q("mb", 0, 0);
        ...
        this.addFocusListener(new aQ(this));
        if (q.q) {
            this.q = new aK(q.q, q2, true, null);
        }
    }
    ...
    static aH q(final aP ap) {
        return ap.q;
    }
    
    static void q(final aP ap) {
        ap.e();
    }
