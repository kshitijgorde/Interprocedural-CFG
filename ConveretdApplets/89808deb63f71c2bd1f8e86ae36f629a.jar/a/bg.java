...
public final class bg extends Panel implements aA
{
    ...
    private int q(final aY ay, final aY ay2) {
        int q = 0;
        au au;
        for (int index = this.w.indexOf(this.e), size = this.w.size(), n = 0; n < size && (!(au = this.w.elementAt((n + index) % size)).q() || (q = ay.q(ay2, au.q())) == 0); ++n) {}
        if (this.t) {
            return q;
        }
        return -q;
    ...
    private synchronized void q(final Vector vector, final int n, final int n2, final au au) {
        if (n2 > n) {
            ...
            int n4 = n2;
            int i = n;
            final aY q = vector.elementAt(n3).q;
            while (i <= n4) {
                ...
                if (i < n4) {
                    final aM element = vector.elementAt(i);
                    final aM element2 = vector.elementAt(n4);
    ...
    protected final synchronized void q(final int n, final Graphics graphics) {
        if (graphics != null && this.isShowing()) {
            ...
            final aM am = this.q.elementAt(n);
            ...
            else if (this.u && this.q.q((Object)am.q)) {
                graphics.setColor(this.q);
            }
            else if (am.q instanceof aJ && ((aJ)am.q).g != 0) {
                graphics.setColor(new Color(((aJ)am.q).g));
            }
            else {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (!au.w()) {
                    if (au.q(graphics, am, am.q.q(au.q()), n3, e, q, this.q, n == this.e)) {
                        n3 += q;
                    }
                }
                else if (au.q(graphics, am, am.q.q(au.q()), width - q - n4, e, q, this.q, n == this.e)) {
                    n4 += q;
                }
    ...
    public final synchronized int q(final aY ay) {
        for (int i = 0; i < this.q.size(); ++i) {
            if (((aM)this.q.elementAt(i)).q.equals(ay)) {
                return i;
            }
        }
        return -1;
    ...
    public final synchronized aY q(final int n) {
    ...
    private synchronized void w(final aY ay, int n) {
        if (this.e != null) {
            int i = 0;
            ...
            Label_0161: {
                if (n2 == -1) {
                    ...
                    int n5;
                    if ((n5 = this.q(ay, this.q.elementAt(n2).q)) > 0) {
                        n4 = n2 + 1;
                    }
                    else {
                        while (true) {
                            while (i <= n2) {
                                n3 = i + (n2 - i) / 2;
                                if ((n5 = this.q(ay, this.q.elementAt(n3).q)) == 0) {
                                    n4 = n3;
                                    break Label_0161;
                                }
                                if (n5 < 0) {
        ...
        this.q.insertElementAt(new aM(this, this, ay), n);
        if (this.e >= n) {
            ++this.e;
        }
        final int e = this.e(n);
    ...
    public final void q(final aY ay) {
        this.w(ay, this.q.size());
    }
    
    public final synchronized void q(final aY ay, final int n) {
        this.q.setElementAt(new aM(this, this, ay), n);
        if (this.e != null) {
            this.q(200L);
            return;
        }
    ...
    public final boolean q(final aY ay) {
        final int q;
        if ((q = this.q(ay)) != -1) {
            this.e(q);
            return true;
    ...
    protected static void q(final Graphics graphics, String string, final int n, final int n2, final int n3, final int n4, final int n5, final boolean b, final aM am) {
        ...
        if (am != null && am.q() != null) {
            graphics.drawImage(am.q(), n9 - 2, n6 - 17, null);
        }
        else {
    ...
    public final synchronized void q(final aY ay, final boolean b) {
        final int q;
        if ((q = this.q(ay)) >= 0) {
            this.q(q, b);
        }
    ...
    private synchronized void q(final int n, final Color q, final Color w) {
        final aM am;
        (am = this.q.elementAt(n)).q = q;
        am.w = w;
        this.q(0L, n);
    }
    
    public final synchronized void q(final aY ay, final Color color, final Color color2) {
        final int q;
        if ((q = this.q(ay)) >= 0) {
    ...
    public bg(final boolean u) {
        this();
        this.u = u;
    }
    
    public bg(final cq q) {
        this();
        this.q = q;
    }
    ...
    static boolean q(final bg bg) {
        return bg.u;
    }
    
    static Vector w(final bg bg) {
        return bg.q;
    }
    
    static A q(final bg bg) {
        return bg.q;
    }
