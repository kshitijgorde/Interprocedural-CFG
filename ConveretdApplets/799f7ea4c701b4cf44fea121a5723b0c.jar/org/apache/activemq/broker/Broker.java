...
public interface Broker extends Region, Service
{
    ...
    void sendToDeadLetterQueue(final ConnectionContext p0, final MessageReference p1, final Subscription p2);
    ...
    void networkBridgeStarted(final BrokerInfo p0, final boolean p1);
