...
public abstract class a extends Applet implements c
{
    ...
    private void long() {
        ...
        if (this.goto().equals("d3") || this.goto().equals("pano")) {
            if ((float)this.z.byte("param/" + this.goto() + ".autospin") == 0.0) {
                booleanValue = false;
            }
        }
        else {
    ...
    protected abstract String goto();
    ...
    public void start() {
        ...
        if (case1 != null) {
            this.q = String.valueOf(case1) + "." + this.goto();
        }
        else {
            this.q = this.goto();
        }
