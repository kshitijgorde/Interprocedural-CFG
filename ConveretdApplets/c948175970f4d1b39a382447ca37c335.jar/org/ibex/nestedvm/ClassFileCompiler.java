...
public class ClassFileCompiler extends Compiler implements CGConst
{
    ...
    public ClassFileCompiler(final String s, final String s2, final OutputStream outputStream) throws IOException {
        this(new Seekable.File(s), s2, outputStream);
    }
    
    public ClassFileCompiler(final Seekable seekable, final String s, final OutputStream os) throws IOException {
        this(seekable, s);
        if (os == null) {
    ...
    public ClassFileCompiler(final Seekable seekable, final String s, final File outDir) throws IOException {
        this(seekable, s);
        if (outDir == null) {
            throw new NullPointerException();
        }
    ...
    private ClassFileCompiler(final Seekable seekable, final String s) throws IOException {
        super(seekable, s);
    ...
    protected void _go() throws Exn, IOException {
        try {
            ...
            throw new Exn("Class generation exception: " + exn.toString());
        }
    }
    
    private void __go() throws Exn, IOException {
        if (!this.pruneCases) {
            throw new Exn("-o prunecases MUST be enabled for ClassFileCompiler");
        }
        ...
        for (int k = 0; k < this.elf.sheaders.length; ++k) {
            final ELF.SHeader sHeader = this.elf.sheaders[k];
            final String name = sHeader.name;
            if (sHeader.addr != 0) {
                max = Math.max(max, sHeader.addr + sHeader.size);
                if (name.equals(".text")) {
                    ...
                    this.emitData(sHeader.addr, new DataInputStream(sHeader.getInputStream()), sHeader.size, name.equals(".rodata"));
                }
                else {
        ...
        if (this.supportCall) {
            ...
            for (int l = 0; l < symbols.length; ++l) {
                final ELF.Symbol symbol = symbols[l];
        ...
        final MethodGen.Switch.Table table = new MethodGen.Switch.Table(n, n2 - 1);
        addMethod.add((byte)(-86), (Object)table);
        for (int n3 = n; n3 < n2; ++n3) {
            table.setTargetForVal(n3, addMethod.size());
    ...
    private void emitData(int i, final DataInputStream dataInputStream, int n, final boolean b) throws Exn, IOException {
        if ((i & 0x3) != 0x0 || (n & 0x3) != 0x0) {
            throw new Exn("Data section on weird boundaries");
        }
        while (i < i + n) {
    ...
    private void emitBSS(final int n, int n2) throws Exn {
        if ((n & 0x3) != 0x0) {
            throw new Exn("BSS section on weird boundaries");
        }
        n2 = (n2 + 3 & 0xFFFFFFFC);
        final int n3 = n2 / 4;
        this.init.add((byte)42);
    ...
    private void emitText(int n, final DataInputStream dataInputStream, final int n2) throws Exn, IOException {
        if (this.textDone) {
            throw new Exn("Multiple text segments");
        }
        this.textDone = true;
        if ((n & 0x3) != 0x0 || (n2 & 0x3) != 0x0) {
            throw new Exn("Section on weird boundaries");
        }
        final int n3 = n2 / 4;
        int n4 = -1;
        boolean b = true;
    ...
    private void startMethod(final int n) {
        ...
        final MethodGen.Switch.Lookup lookup = new MethodGen.Switch.Lookup(n2);
        System.arraycopy(array, 0, lookup.vals, 0, n2);
        System.arraycopy(array2, 0, lookup.targets, 0, n2);
        lookup.setDefaultTarget((Object)(this.defaultTarget = new MethodGen.PhantomTarget()));
        this.fixupRegsStart();
        this.mg.add((byte)42);
    ...
    private int doIfInstruction(final byte b, final int n, final int n2, final int n3) throws Exn {
    ...
    private int emitInstruction(final int n, final int n2, final int n3) throws Exn {
        final MethodGen mg = this.mg;
        if (n2 == -1) {
            throw new Exn("insn is -1");
        }
        int n4 = 0;
            ...
            switch (n5) {
                case 0: {
                    switch (n13) {
                        ...
                        case 8: {
                            if (n == -1) {
                                throw new Exn("pc modifying insn in delay slot");
                            }
                            this.emitInstruction(-1, n3, -1);
                            this.preSetPC();
                            this.pushRegWZ(0 + n6);
                        ...
                        default: {
                            throw new Exn("Illegal instruction 0/" + n13);
                        }
                    }
                    break;
                }
                case 1: {
                    switch (n7) {
                        ...
                        default: {
                            throw new Exn("Illegal Instruction 1/" + n7);
                        }
                    }
                    break;
                }
                ...
                case 17: {
                    switch (n6) {
                        ...
                        case 2: {
                            if (n10 != 31) {
                                throw new Exn("FCR " + n10 + " unavailable");
                            }
                            this.preSetReg(0 + n7);
                            this.pushReg(66);
                            this.setReg();
                        ...
                        case 17: {
                            ...
                            switch (n13) {
                                ...
                                case 36: {
                                    final MethodGen.Switch.Table table = new MethodGen.Switch.Table(0, 3);
                                    this.preSetReg(32 + n12);
                                    this.pushDouble(32 + n10, b);
                                    this.pushReg(66);
                                    mg.add((byte)6);
                                    mg.add((byte)126);
                                    mg.add((byte)(-86), (Object)table);
                                    table.setTarget(2, mg.size());
                                    if (!b) {
                                        mg.add((byte)(-115));
                                    }
                                    ...
                                    table.setTarget(1, mg.size());
                                    table.setDefaultTarget(mg.size());
                                ...
                                default: {
                                    throw new Exn("Invalid Instruction 17/" + n6 + "/" + n13);
                                }
                            }
                            break;
                        }
                        ...
                        default: {
                            throw new Exn("Invalid Instruction 17/" + n6);
                        }
                    }
                    break;
                }
                ...
                default: {
                    throw new Exn("Invalid Instruction: " + n5 + " at " + Compiler.toHex(n));
                }
            }
        }
        return n4;
    ...
    private int pushFloat(final int n) throws Exn {
        return this.pushDouble(n, false);
    }
    
    private int pushDouble(final int n, final boolean b) throws Exn {
        if (n < 32 || n >= 64) {
        ...
        if (b) {
            if (this.singleFloat) {
                throw new Exn("Double operations not supported when singleFloat is enabled");
            }
            if (n == 63) {
                throw new Exn("Tried to use a double in f31");
            }
            this.pushReg(n + 1);
    ...
    private int setDouble(final boolean b) throws Exn {
