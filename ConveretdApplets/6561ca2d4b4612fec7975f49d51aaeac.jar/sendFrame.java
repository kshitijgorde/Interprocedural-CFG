...
public class sendFrame extends Frame
{
    ...
    void sendBtn_actionPerformed(final ActionEvent actionEvent) {
        ...
        if (itemCount > 0) {
            try {
                ...
                System.out.println("READ ERROR: " + ((Throwable)ex).toString());
                final ErrorDlg errorDlg2 = new ErrorDlg(this, "ERROR!", this.props.language.getProperty("error.trust", "The operation cannot be completed because you did not enable the disk access privilege."), true);
            ...
            for (int i = 0; i < itemCount; ++i) {
                ...
                try {
                    ...
                    final ErrorDlg errorDlg3 = new ErrorDlg(this, "Out of memory", this.props.language.getProperty("error.send_memory", "There is not enough memory available to send this message. Try removing one or more attachments and resending."), true);
        ...
        if (this.props.serverSend) {
            ...
            if (s == null) {
                final ErrorDlg errorDlg4 = new ErrorDlg(this, "Error!", this.props.language.getProperty("error.sending", "An error occured while trying to send the message. Check the destination address(es) for possible syntax errors."), true);
            ...
            if (s.toLowerCase().startsWith("error")) {
                final ErrorDlg errorDlg5 = new ErrorDlg(this, "Error!", s, true);
            ...
            try {
                ...
                try {
                    ...
                    if (s2.startsWith("4") || s2.startsWith("5")) {
                        final ErrorDlg errorDlg6 = new ErrorDlg(this, "Error!", "Error: " + s2, true);
                ...
                try {
                ...
                catch (JSServerCommandException ex3) {
                    System.out.println("JSX ERROR: " + ((Throwable)ex3).toString());
                    ...
                    System.out.println("IOX ERROR: " + ex4.toString());
                    final ErrorDlg errorDlg8 = new ErrorDlg(this, "Error!", this.props.language.getProperty("error.sending", "An error occured while trying to send the message. Check the destination address(es) for possible syntax errors."), true);
                    ...
                    final ErrorDlg errorDlg9 = new ErrorDlg(this, "Out of memory", this.props.language.getProperty("error.send_memory", "There is not enough memory available to send this message. Try removing one or more attachments and resending."), true);
                ...
                final ErrorDlg errorDlg10 = new ErrorDlg(this, "Error!", this.props.language.getProperty("error.no_connect", "Could not establish a connection with the mail server. This may be a temporary problem. Contact your service provider if the problem continues."), true);
                errorDlg10.setBackground(this.props.background);
                errorDlg10.setForeground(this.props.foreground);
                errorDlg10.setFont(this.props.font);
                errorDlg10.show();
                this.setCursor(Cursor.getPredefinedCursor(0));
            }
        }
    ...
    public void attachFile() {
        try {
            ...
            System.out.println("READ ERROR: " + ((Throwable)ex).toString());
            final ErrorDlg errorDlg = new ErrorDlg(this, "ERROR!", this.props.language.getProperty("error.trust", "The operation cannot be completed because you did not enable the disk access privilege."), true);
            errorDlg.setBackground(this.props.background);
            errorDlg.setForeground(this.props.foreground);
            errorDlg.setFont(this.props.font);
            errorDlg.show();
            ...
            System.out.println("READ ERROR: " + ex3.toString());
        }
    }
