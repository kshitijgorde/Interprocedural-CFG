...
public abstract class ay implements as
{
    protected bI q;
    private ax q;
    private int q;
    ...
    public static void q(final bI bi) {
        cu.q(new String[] { "window.focus(); setTimeout(\"window.external.AddFavorite('" + AppletAbstract.q().getCodeBase() + "', window.document.title);\", 100);" }, bi);
    }
    ...
    public final void q(final Frame q) {
        ...
        this.q = "_blank";
        this.e = false;
        ((Frame)(this.q = this.q("mi_", true))).setBackground(be.w.k);
        this.e = 21;
        (this.q = new ax(this.q, this.e, this.q, this)).setBounds(0, 0, this.q, this.e);
    }
    ...
    protected final void y() {
        ...
        final Font y = k.y;
        this.q.put("mb_bgcr", Integer.toString(be.w.k.getRGB(), 16));
        this.q.put("mb_bgcrin", Integer.toString(be.w.l.getRGB(), 16));
        this.q.put("mb_fgcrin", Integer.toString(be.w.z.getRGB(), 16));
    ...
    private aH q(final String s, final boolean b) {
        int n = 1;
        final aH ah = new aH();
        while (this.q(s + n)) {
            ...
            final String s3 = (q3 != null && string.length() > 4) ? (cl.q("=5>E") + "_" + cl.q(q3.toLowerCase(), ' ', '_') + ".gif") : "";
            if (q4 == null) {
                q4 = s3;
            }
            Image image;
            if (q4 != null && q4.trim().length() > 0) {
                image = AppletAbstract.q().getImage(AppletAbstract.q().getCodeBase(), "Resources/" + cl.q("=5>E") + "/" + q4);
            }
            else {
                image = null;
            }
            ...
            if (q != null) {
                ...
                o = new aI(q3, this.q(string), s2, b, image, booleanValue);
                if (a.q() && !((aI)o).q.equals(au.t)) {
                    final String q5 = ((aI)o).q;
                    final String y = au.y;
                }
            }
            if (this.q(s + n + "_1")) {
                ((aI)o).q(this.q(s + n + "_", false));
            }
            ++n;
            ah.q(o);
        }
    ...
    protected final void w(final aI ai) {
        for (int i = 0; i < this.q.k.q(); ++i) {
            final bh bh = (bh)this.q.k.q(i);
            if (ai.q.equalsIgnoreCase(bh.getName())) {
    ...
    protected final void w(final int n, int i) {
        ...
        if (this.q.k.q() > 0) {
            this.q.put(s + "_txt", au.o);
        }
        for (i = 0; i < this.q.k.q(); ++i) {
            this.q.put(s + "_" + (i + 1) + "_txt", ((bh)this.q.k.q(i)).getName());
        }
    }
}
