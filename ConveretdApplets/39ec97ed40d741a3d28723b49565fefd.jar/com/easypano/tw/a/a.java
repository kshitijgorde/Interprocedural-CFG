...
import com.easypano.tw.db;

public class a implements db, p
{
    ...
    static {
        ...
        h = com.easypano.tw.a.a.e;
        i = com.easypano.tw.a.a.e;
        j = com.easypano.tw.a.a.f;
    }
    ...
    protected void e(final Graphics graphics) {
        ...
        graphics.drawImage(this.H, (this.k.getBounds().width - h.getWidth(ds.d)) / 2, (this.k.getBounds().height - this.H.getHeight(ds.d)) / 2, this.k);
    }
    ...
    public void b(final int o) {
        final boolean o2 = com.easypano.tw.a.a.O;
        int n = o;
        int n2 = o;
        int n4;
        final int n3 = n4 = 13;
    ...
    public Dimension a() {
        ...
        if (!o) {
            if (image != null) {
                dimension.width = this.v.getWidth(ds.d);
                dimension.height = this.v.getHeight(ds.d);
            }
            final Image w;
            image2 = (w = this.w);
        }
        ...
        Label_0130: {
            if (!o) {
                if (image != null) {
                    ds.a(dimension, this.w.getWidth(ds.d), this.w.getHeight(ds.d));
                }
                a = this;
                if (o) {
                    break Label_0130;
            ...
            if (image2 != null) {
                ds.a(dimension, this.x.getWidth(ds.d), this.x.getHeight(ds.d));
            }
            a = this;
        }
        final g k = a.k;
        Label_0217: {
            ...
            if (graphics != null) {
                try {
                    this.l = graphics.getFontMetrics(this.k.getFont());
                    ds.a(dimension, this.l.stringWidth(this.k.e().a()), this.l.getHeight());
                }
                finally {
                    graphics.dispose();
                }
