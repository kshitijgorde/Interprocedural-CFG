...
public class a
{
    ...
    protected Object char(final String s) {
        final Applet applet = (Applet)this.byte("applet");
        if (applet == null) {
            return null;
        }
        String s2 = s;
    ...
    public Image int(final String s) {
        if (s == null) {
            return null;
        }
        try {
    ...
    public Object byte(final String s) {
        ...
        if (s.startsWith("resource/")) {
            if (s.startsWith("resource/image.toolbar")) {
                return this.int(this.for().getString(s.substring(9)));
            }
    ...
    protected c new(final String s) {
        c c = this.a.get(s);
        if (c == null) {
    ...
    protected Hashtable if() {
        if (this.do == null) {
            ...
            final Image image = (Image)this.byte("images/toolbar");
            if (image != null) {
                this.a(image);
    ...
    public Image do(final String s) {
        return (Image)this.byte(s);
    }
    
    public int case(final String s) {
    ...
    protected j try(final String s) {
        j j = this.a.get(s);
        if (j == null) {
    ...
    public String a(final String s) {
        final String s2 = (String)this.byte(s);
        if (s2 != null) {
            return s2.trim();
        }
        return null;
    ...
    protected void a(final Image image) {
        final ResourceBundle resourceBundle = (ResourceBundle)this.byte("resource.bundle");
    ...
    protected void new() {
        final StringTokenizer stringTokenizer = new StringTokenizer(((ResourceBundle)this.byte("resource.bundle")).getString("cursors"), ":");
        while (stringTokenizer.hasMoreTokens()) {
