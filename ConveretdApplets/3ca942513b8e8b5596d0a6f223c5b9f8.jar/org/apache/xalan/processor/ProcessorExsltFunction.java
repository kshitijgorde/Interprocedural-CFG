...
public class ProcessorExsltFunction extends ProcessorTemplateElem
{
    ...
    public void startElement(final StylesheetHandler handler, final String uri, final String localName, final String rawName, final Attributes attributes) throws SAXException {
        ...
        if (indexOfColon > 0) {
            final String prefix = val.substring(0, indexOfColon);
            final String localVal = val.substring(indexOfColon + 1);
            final String ns = handler.getNamespaceSupport().getURI(prefix);
        }
        else {
    ...
    public void endElement(final StylesheetHandler handler, final String uri, final String localName, final String rawName) throws SAXException {
        ...
        final SourceLocator locator = handler.getLocator();
        this.validate(function, handler);
        super.endElement(handler, uri, localName, rawName);
    }
    
    public void validate(ElemTemplateElement elem, final StylesheetHandler handler) throws SAXException {
        String msg = "";
        while (elem != null) {
