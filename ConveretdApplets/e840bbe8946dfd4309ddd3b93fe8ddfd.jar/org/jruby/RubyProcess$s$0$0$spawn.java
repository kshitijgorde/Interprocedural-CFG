...
public class RubyProcess$s$0$0$spawn extends JavaMethodN
{
    public RubyProcess$s$0$0$spawn(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyProcess.spawn(context, recv, array);
    }
}
