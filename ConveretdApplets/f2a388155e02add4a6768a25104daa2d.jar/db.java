...
class db extends Panel implements MouseListener, ActionListener
{
    ...
    public void a(final String s, final Component component, final boolean b) {
        ...
        boolean equals;
        final boolean b2 = equals = this.a.fb.equals(db.z[9]);
    ...
    public void b(final int b) {
            ...
            if (b2) {
                ...
                Label_0235: {
                    if (m == 0) {
                        ...
                        s2 = String.valueOf(s2) + db.z[6] + k + db.z[5];
                        if (m != 0) {
                            break Label_0235;
                        }
                    }
        ...
        ((cb)x).b.requestFocus();
        this.a.q(String.valueOf(((cb)component).e) + db.z[7] + this.a.n + db.z[8] + this.a.wb);
        this.a.e();
    }
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "x.Cp".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "f\"BlJ".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "`$U".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "`*GTQD>U".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "g?DpKG".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "ik\u001f".toCharArray();
        ...
        final int n31 = 10;
        final char[] charArray11 = "v$QpQY".toCharArray();
