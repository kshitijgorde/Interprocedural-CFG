...
public class bl
{
    ...
    protected void if(final a2 a2) {
        ...
        while (a4 != null) {
            if (a4.a.toLowerCase().compareTo("group") == 0) {
                ...
                int n3 = 0;
                while (a6 != null) {
                    if (a6.a.toLowerCase().compareTo("id") == 0) {
    ...
    public void a(final char[] array, final char[] array2, final a3 a3) {
        ...
        if (a.a.a.a.g.do(array, bl.char) == 0) {
            if (a.a.a.a.g.do(array2, bl.r) == 0) {
                ...
                float byte1 = al.do(a3) / 100.0f;
                if (byte1 < 0.01 || byte1 > 100.0f) {
                    byte1 = 1.0f;
                }
                this.i.byte = byte1;
            }
                ...
                if (a3.char == 4) {
                    this.i.F = new String(a3.int, 0, a.a.a.a.g.a(a3.int));
                }
            }
        ...
        else if (a.a.a.a.g.do(array, ac.q) == 0) {
            this.a(array2, a3);
        }
        else if (a.a.a.a.g.do(array, ac.U) == 0) {
            this.if(array2, a3);
        }
    ...
    public a3 if(final char[] array, final char[] array2) {
        ...
        if (a.a.a.a.g.do(array, bl.char) == 0) {
            ...
            if (a.a.a.a.g.do(array2, ac.aq) == 0) {
                a3.char = 2;
            ...
            if (a.a.a.a.g.do(array2, bl.A) == 0) {
                a3.char = 4;
                a3.int = (String.valueOf(this.i.F) + "\u0000").toCharArray();
                return a3;
            }
        }
        else {
            ...
            if (a.a.a.a.g.do(array, bl.o) == 0) {
                final a3 a5 = new a3();
                if (a.a.a.a.g.do(array2, ac.ab) == 0) {
                    a5.char = 2;
                    a5.case = this.i.O.goto;
                    return a5;
                }
                if (a.a.a.a.g.do(array2, ac.aa) == 0) {
                    a5.char = 2;
                    a5.case = this.i.O.else;
                    return a5;
                }
            }
            else {
