...
public class TypedListener implements Listener
{
    ...
    public TypedListener(final SWTEventListener eventListener) {
    ...
    public void handleEvent(final Event event) {
        switch (event.type) {
            ...
            case 21: {
                final ShellEvent shellEvent = new ShellEvent(event);
            ...
            case 48: {
                final GestureEvent gestureEvent = new GestureEvent(event);
            ...
            case 2: {
                final KeyEvent keyEvent2 = new KeyEvent(event);
            ...
            case 35: {
                final MenuDetectEvent menuDetectEvent = new MenuDetectEvent(event);
            ...
            case 31: {
                final TraverseEvent traverseEvent = new TraverseEvent(event);
