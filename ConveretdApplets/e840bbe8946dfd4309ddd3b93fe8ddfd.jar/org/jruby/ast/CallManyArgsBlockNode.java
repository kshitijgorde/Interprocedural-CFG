...
{
    public CallManyArgsBlockNode(final ISourcePosition position, final Node receiverNode, final String name, final Node args, final IterNode iter) {
    ...
    public IRubyObject interpret(final Ruby runtime, final ThreadContext context, final IRubyObject self, final Block aBlock) {
        ...
        try {
            return this.callAdapter.callIter(context, self, receiver, args, block);
        }
