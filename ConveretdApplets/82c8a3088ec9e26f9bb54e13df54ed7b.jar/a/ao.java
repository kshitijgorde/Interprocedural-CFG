...
public final class ao extends v
{
    ...
    public ao(final Frame frame, final W q) {
        ...
        panel.setBackground(aS.w.i);
        panel.setForeground(aS.w.u);
        ...
        final Label label = new Label(ak.q(ce.q("x5CC175e")));
        gridBagConstraints.gridwidth = 1;
        panel.add(label, gridBagConstraints);
        gridBagConstraints.gridwidth = 0;
        panel.add(this.q = new bx(this, this.q), gridBagConstraints);
        gridBagConstraints.gridwidth = 0;
        ...
        if ((e = this.q.e("postbox.gif", false)) != null) {
            final aG ag;
            (ag = new aG()).w(e);
            cw.add(ag, gridBagConstraints);
        }
        this.add(cw, gridBagConstraints);
        ...
        switch (event.id) {
            ...
            case 1001: {
                ...
                if (text == null || text.trim().length() == 0) {
                    new bR(this.q.q(), ak.q("Error"), ak.q("Master name should be set"), this.q).setVisible(true);
                    this.q.requestFocus();
                    return true;
                }
                if (q == null || q.trim().length() == 0) {
                    new bR(this.q.q(), ak.q("Error"), ak.q("Message should be entered"), this.q).setVisible(true);
