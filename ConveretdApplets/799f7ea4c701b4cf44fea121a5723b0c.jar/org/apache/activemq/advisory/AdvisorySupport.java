...
public final class AdvisorySupport
{
    ...
    public static ActiveMQTopic getConsumerAdvisoryTopic(final ActiveMQDestination destination) {
        if (destination.isQueue()) {
            return new ActiveMQTopic("ActiveMQ.Advisory.Consumer.Queue." + destination.getPhysicalName());
        }
        return new ActiveMQTopic("ActiveMQ.Advisory.Consumer.Topic." + destination.getPhysicalName());
    }
    ...
    public static ActiveMQTopic getProducerAdvisoryTopic(final ActiveMQDestination destination) {
        if (destination.isQueue()) {
            return new ActiveMQTopic("ActiveMQ.Advisory.Producer.Queue." + destination.getPhysicalName());
        }
        return new ActiveMQTopic("ActiveMQ.Advisory.Producer.Topic." + destination.getPhysicalName());
    }
    ...
    public static ActiveMQTopic getMasterBrokerAdvisoryTopic(final Destination destination) throws JMSException {
