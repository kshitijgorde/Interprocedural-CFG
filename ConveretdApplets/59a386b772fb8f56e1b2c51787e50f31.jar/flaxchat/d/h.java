...
public class h extends Panel implements MouseListener, FocusListener, KeyListener, ComponentListener
{
    ...
    private void a() throws Exception {
        ...
        this.add(this.v = new Button(flaxchat.d.h.z[0]));
        this.v.addKeyListener(this);
        this.v.addFocusListener(this);
        this.add(this.u = new Panel(this.w), flaxchat.d.h.z[1]);
        Font font = this.u.getFont();
        if (font == null) {
            font = new Font(flaxchat.d.h.z[2], 0, 12);
        }
        this.setFont(new Font(flaxchat.d.h.z[2], 0, 12));
        this.u.setFont(font);
        ...
        Label_0642: {
            ...
            while (true) {
                Label_0636: {
                    ...
                    Label_0446:
                        while (true) {
                            Label_0440: {
                                ...
                                final l j = this.t.elementAt(n5);
                                if (n5 > n6 && n3 + j.e.width > bounds.width) {
                                    break Label_0446;
                                }
                                n3 += j.e.width;
                                j.g = g2;
                    ...
                    final l k = this.t.elementAt(n6);
                    k.f.x = x2;
                    k.f.y = y2;
                    k.f.width = k.e.width;
                    if (this.l > 1 && g2 < this.l) {
                        final Rectangle f2 = k.f;
                        f2.width += (bounds.width - n3 - 1) / n;
                        final Rectangle f3 = k.f;
                        f3.width += ((n5 - n6 <= (bounds.width - n3 - 1) % n) ? 1 : 0);
                    }
                    k.f.height = this.j * g2;
                    if (k.g > 0) {
                        final Rectangle f4 = k.f;
                        f4.height -= 2;
                    }
                    x2 += k.f.width;
                    ++n6;
    ...
    static {
        flaxchat.d.h.z = new String[] { z(z("+@Yc1")), z(z(".JTb'\u001f")), z(z(")F[z-\n")) };
        a = Color.lightGray;
        b = Color.black;
        c = Color.white;
        d = Color.darkGray;
