...
public class JDialChart extends JGraph
{
    private Vector a;
    private Vector b;
    private Vector c;
    ...
    public JDialChart(final Applet applet) {
        this.a = new Vector();
        this.b = new Vector();
        this.c = new Vector();
    ...
    public JDialChart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
        this.a = new Vector();
        this.b = new Vector();
        this.c = new Vector();
        this.d = new Hashtable();
