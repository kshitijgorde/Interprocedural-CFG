...
class XMLUtil
{
    ...
    static void errorExpectedInput(final String s, final int n, final String s2) throws XMLParseException {
        throw new XMLParseException(s, n, "Expected: " + s2);
    }
    
    static void errorInvalidEntity(final String s, final int n, final String s2) throws XMLParseException {
        throw new XMLParseException(s, n, "Invalid entity: `&" + s2 + ";'");
    }
    
    static void errorUnexpectedEntity(final String s, final int n, final String s2) throws XMLParseException {
        throw new XMLParseException(s, n, "No entity reference is expected here (" + s2 + ")");
    }
    ...
    static void errorInvalidInput(final String s, final int n, final String s2) throws XMLParseException {
        throw new XMLParseException(s, n, "Invalid input: " + s2);
    }
    
    static void errorWrongClosingTag(final String s, final int n, final String s2, final String s3) throws XMLParseException {
        throw new XMLParseException(s, n, "Closing tag does not match opening tag: `" + s3 + "' != `" + s2 + "'");
    }
    ...
    static void errorMissingElement(final String s, final int n, final String s2, final String s3) throws XMLValidationException {
        throw new XMLValidationException(1, s, n, s3, null, null, "Element " + s2 + " expects to have a " + s3);
    }
    
    static void errorUnexpectedElement(final String s, final int n, final String s2, final String s3) throws XMLValidationException {
        throw new XMLValidationException(2, s, n, s3, null, null, "Unexpected " + s3 + " in a " + s2);
    }
    
    static void errorMissingAttribute(final String s, final int n, final String s2, final String s3) throws XMLValidationException {
        throw new XMLValidationException(3, s, n, s2, s3, null, "Element " + s2 + " expects an attribute named " + s3);
    }
    
    static void errorUnexpectedAttribute(final String s, final int n, final String s2, final String s3) throws XMLValidationException {
        throw new XMLValidationException(4, s, n, s2, s3, null, "Element " + s2 + " did not expect an attribute " + "named " + s3);
    }
    
    static void errorInvalidAttributeValue(final String s, final int n, final String s2, final String s3, final String s4) throws XMLValidationException {
        throw new XMLValidationException(5, s, n, s2, s3, s4, "Invalid value for attribute " + s3);
    }
    
    static void errorMissingPCData(final String s, final int n, final String s2) throws XMLValidationException {
        throw new XMLValidationException(6, s, n, null, null, null, "Missing #PCDATA in element " + s2);
    }
    
    static void errorUnexpectedPCData(final String s, final int n, final String s2) throws XMLValidationException {
        throw new XMLValidationException(7, s, n, null, null, null, "Unexpected #PCDATA in element " + s2);
    }
