...
class Graphics3D
{
    ...
    public void paint(final Graphics left_graphics, final Graphics right_graphics, final Image right_image) {
        if (!this.is_stereo) {
    ...
    public void paintPrimitives(final Graphics g, final int[] pixel_xs) {
        int edge_index = 0;
