...
public final class cD extends cE
{
    protected final void e() {
        ...
        this.add(super.w);
        (super.q = new cB()).setForeground(new Color(0, 0, 128));
        ...
        try {
            ...
            while (n < long1 && super.q != 2) {
                ...
                if (System.currentTimeMillis() > currentTimeMillis + 1000L) {
                    ...
                    super.r.setText("Transferring file " + cE.q(currentTimeMillis2, currentTimeMillis, n));
                }
            }
    ...
    public cD(final bH bh, final cz cz) {
        super(bh, cz.q, cz.q, cz.w, false);
        super.w = cz.q;
        super.e = cz.q;
    }
    
    public cD(final bH bh, final bp bp) {
        super(bh, bp, null, null, true);
    }
}
