...
public class g implements ListSelectionListener
{
    ...
    public void valueChanged(final ListSelectionEvent listSelectionEvent) {
        ar ar = null;
        final EventSelectionModel eventSelectionModel = this.a.B ? this.a.ce : this.a.cg;
        if (eventSelectionModel.a().size() > 0) {
            final Object value = eventSelectionModel.a().get(0);
        ...
        this.a.cl = ar;
        this.a.repaint(this.a.M.a.x, this.a.M.a.y, this.a.M.a.width, this.a.M.a.height);
    }
}
