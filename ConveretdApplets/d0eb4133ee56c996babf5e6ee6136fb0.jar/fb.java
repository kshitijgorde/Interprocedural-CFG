...
public class fb extends Panel implements ActionListener, MouseMotionListener, MouseListener
{
    ...
    public void a() {
        this.i = this.a.c(String.valueOf(this.a.J) + "/" + this.a.x + "/" + fb.z[1], fb.z[0]);
        this.j = this.a.c(String.valueOf(this.a.J) + "/" + this.a.x + "/" + fb.z[1], fb.z[0]);
        this.k = this.a.c(String.valueOf(this.a.J) + "/" + this.a.x + "/" + fb.z[1], fb.z[4]);
        this.l = this.a.c(String.valueOf(this.a.J) + "/" + this.a.x + "/" + fb.z[1], fb.z[3]);
    ...
    public void b() {
        ...
        this.a.a(this.a.Ab, fb.z[8], this);
        this.a.a(this.a.Bb, fb.z[6], this);
        this.a.a(this.a.Cb, fb.z[7], this);
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "M.)\u0018dm".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "m1!\u0002?j\"<".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "pg-\u001fRv;<V>\u007f8'\u0019e".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "N(!\u001apj?".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "]2)\u0002\u007f{6".toCharArray();
        ...
        final int n19 = 6;
        final char[] charArray7 = "o*'\u001cdn".toCharArray();
        ...
        final int n22 = 7;
        final char[] charArray8 = "r*'\u001cdn".toCharArray();
        ...
        final int n25 = 8;
        final char[] charArray9 = "s*'\u001cdn".toCharArray();
        ...
        final int n28 = 9;
        final char[] charArray10 = "|*'\u001cdn".toCharArray();
