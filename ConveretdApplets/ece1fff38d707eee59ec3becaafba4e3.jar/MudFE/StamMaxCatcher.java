...
class StamMaxCatcher implements DisplayInterface
{
    ...
    public StamMaxCatcher(final DisplayInterface d1, final MudFrame tf) {
    ...
    public void update() {
        ...
        if (this.hp != null) {
            try {
                this.hp.setmaxstam(Integer.parseInt(this.sb.toString()));
            }
            catch (Exception e) {
                e.printStackTrace();
            }
