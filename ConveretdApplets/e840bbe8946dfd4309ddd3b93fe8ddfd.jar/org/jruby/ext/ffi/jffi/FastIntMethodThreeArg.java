...
final class FastIntMethodThreeArg extends FastIntMethod
{
    ...
    public FastIntMethodThreeArg(final RubyModule implementationClass, final Function function, final IntResultConverter resultConverter, final IntParameterConverter[] parameterConverters) {
    ...
    private final IRubyObject invoke(final ThreadContext context, final IRubyObject arg1, final IRubyObject arg2, final IRubyObject arg3) {
        final int retval = FastIntMethodThreeArg.invoker.invokeIIIrI(this.function, this.c1.intValue(context, arg1), this.c2.intValue(context, arg2), this.c3.intValue(context, arg3));
