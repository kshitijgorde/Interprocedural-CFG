...
public class vai extends Menu
{
    public CheckboxMenuItem a;
    private CheckboxMenuItem b;
    
    public vai(final vd vd) {
        super(vd.fx);
        final StringTokenizer stringTokenizer = new StringTokenizer(vd.fy, "|");
        ...
        this.add(this.a = new CheckboxMenuItem(vd.fz));
        this.a(this.a);
    }
