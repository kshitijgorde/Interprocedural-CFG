...
public class InstructionHandle implements Serializable
{
    ...
    public void setInstruction(final Instruction i) {
        ...
        final Class<? extends InstructionHandle> class1 = this.getClass();
        Class class$0;
        if ((class$0 = InstructionHandle.class$0) == null) {
            try {
                class$0 = (InstructionHandle.class$0 = Class.forName("com.ibm.xslt4j.bcel.generic.BranchHandle"));
            }
            catch (ClassNotFoundException ex) {
                throw new NoClassDefFoundError(ex.getMessage());
            }
        }
        if (class1 != class$0 && i instanceof BranchInstruction) {
