...
public class ManagedTempQueueRegion extends TempQueueRegion
{
    ...
    public ManagedTempQueueRegion(final ManagedRegionBroker broker, final BrokerService brokerService, final DestinationStatistics destinationStatistics, final SystemUsage memoryManager, final TaskRunnerFactory taskRunnerFactory, final DestinationFactory destinationFactory) {
