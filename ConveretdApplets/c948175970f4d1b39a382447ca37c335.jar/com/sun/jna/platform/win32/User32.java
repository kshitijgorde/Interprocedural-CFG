...
public interface User32 extends StdCallLibrary
{
    ...
    boolean GetGUIThreadInfo(final int p0, final WinUser.GUITHREADINFO p1);
    
    boolean GetWindowInfo(final WinDef.HWND p0, final WinUser.WINDOWINFO p1);
    ...
    boolean EnumWindows(final WinUser.WNDENUMPROC p0, final Pointer p1);
    
    boolean EnumChildWindows(final WinDef.HWND p0, final WinUser.WNDENUMPROC p1, final Pointer p2);
    
    boolean EnumThreadWindows(final int p0, final WinUser.WNDENUMPROC p1, final Pointer p2);
    
    boolean FlashWindowEx(final WinUser.FLASHWINFO p0);
    ...
    boolean UpdateLayeredWindow(final WinDef.HWND p0, final WinDef.HDC p1, final WinUser.POINT p2, final WinUser.SIZE p3, final WinDef.HDC p4, final WinUser.POINT p5, final int p6, final WinUser.BLENDFUNCTION p7, final int p8);
    ...
    WinUser.HHOOK SetWindowsHookEx(final int p0, final WinUser.HOOKPROC p1, final WinDef.HINSTANCE p2, final int p3);
    
    WinDef.LRESULT CallNextHookEx(final WinUser.HHOOK p0, final int p1, final WinDef.WPARAM p2, final WinDef.LPARAM p3);
    
    WinDef.LRESULT CallNextHookEx(final WinUser.HHOOK p0, final int p1, final WinDef.WPARAM p2, final Pointer p3);
    
    boolean UnhookWindowsHookEx(final WinUser.HHOOK p0);
    
    int GetMessage(final WinUser.MSG p0, final WinDef.HWND p1, final int p2, final int p3);
    
    boolean PeekMessage(final WinUser.MSG p0, final WinDef.HWND p1, final int p2, final int p3, final int p4);
    
    boolean TranslateMessage(final WinUser.MSG p0);
    
    WinDef.LRESULT DispatchMessage(final WinUser.MSG p0);
