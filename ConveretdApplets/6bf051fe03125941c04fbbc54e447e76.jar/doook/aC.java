...
public class aC extends Panel
{
    ...
    public void paint(final Graphics graphics) {
        ...
        if (this.t != 0) {
            ...
            graphics.fillRoundRect(0, 0, n, n2, this.t, this.t);
            graphics.drawArc(n - this.t, n2 - this.t - 1, this.t, this.t, 0, -90);
            graphics.setColor(background.darker());
            graphics.drawRoundRect(0, 0, n, n2, this.t, this.t);
        }
        else {
    ...
    public aC(final int n, final int n2, final int n3, final int n4, final int t) {
        this(n, n2, n3, n4);
        this.t = t;
    }
    
    public aC(final int n, final int n2, final int n3, final int n4) {
        this.t = 0;
