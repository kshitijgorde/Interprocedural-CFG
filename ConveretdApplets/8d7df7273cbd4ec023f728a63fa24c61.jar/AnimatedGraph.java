...
public class AnimatedGraph extends GenericGraphApplet
{
    ...
    protected void setUpParser() {
        ...
        super.setUpParser();
        (super.parameterDefaults = new Hashtable()).put("Function", String.valueOf(super.xVar.getName()) + " / (" + this.kVar.getName() + " - " + super.xVar.getName() + "^2)");
    ...
    protected void setUpCanvas() {
        ...
        if (!"no".equalsIgnoreCase(this.getParameter("UseAnimatorInputs"))) {
            this.kMin = new VariableInput(String.valueOf(this.kVar.getName()) + "Start", this.getParameter("ParameterMin", "-2"));
            this.kMax = new VariableInput(String.valueOf(this.kVar.getName()) + "End", this.getParameter("ParameterMax", "2"));
        ...
        if (!"no".equalsIgnoreCase(this.getParameter("ShowParameter", "yes"))) {
            final DrawString drawString = new DrawString(String.valueOf(this.kVar.getName()) + " = #", 8, new Value[] { this.kVar });
