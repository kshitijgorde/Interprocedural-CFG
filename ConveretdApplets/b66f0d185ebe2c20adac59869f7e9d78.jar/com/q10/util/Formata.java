...
public class Formata
{
    ...
    public static DateFormat formataData(final char c, final String s) {
        ...
        final String s9 = "MMM/yy";
        final String s10 = "dd/MMM";
        ...
        switch (c) {
            ...
            case 'X': {
                dateFormat = new SimpleDateFormat(s9, new DateFormatSymbols(locale));
                break;
            }
            case 'x': {
                dateFormat = new SimpleDateFormat(s10, new DateFormatSymbols(locale));
                break;
            }
        }
        return dateFormat;
