...
final class X extends Panel
{
    ...
    public final synchronized void update(final Graphics graphics) {
        if (X.q == null) {
            X.q = dN.q(this, this.getSize().width, this.getSize().height, "cpp.u");
        }
        final Graphics graphics2;
        (graphics2 = X.q.getGraphics()).drawImage(this.q.q(X.q), 0, 0, this);
        graphics2.setColor(Color.white);
        graphics2.drawOval(this.q.q.x - 4, this.q.q.y - 4, 8, 8);
        graphics2.dispose();
        graphics.drawImage(X.q, 0, 0, this);
    }
}
