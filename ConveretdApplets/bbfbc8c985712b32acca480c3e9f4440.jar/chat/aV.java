...
public final class aV
{
    ...
    public final void a(final String s) {
        final byte[] a = new byte[s.length() / 2];
        for (int i = 0, n = 0; i < a.length; a[i++] = (byte)(Object)new Integer(Integer.parseInt(s.substring(n++, ++n), 16))) {}
        this.a = a;
    }
    
    public aV(final DataInput dataInput) {
        final int int1;
