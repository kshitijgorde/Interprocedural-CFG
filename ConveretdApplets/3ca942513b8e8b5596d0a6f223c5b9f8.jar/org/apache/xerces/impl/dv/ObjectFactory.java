...
final class ObjectFactory
{
    ...
    static Object createObject(final String s, String string, final String s2) throws ConfigurationError {
        ...
        if (string == null) {
            ...
            final Class clazz = (ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory = class$("org.apache.xerces.impl.dv.ObjectFactory")) : ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory;
            synchronized (clazz) {
                boolean b = false;
    ...
    static ClassLoader findClassLoader() throws ConfigurationError {
        ...
        for (ClassLoader classLoader3 = ((ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory = class$("org.apache.xerces.impl.dv.ObjectFactory")) : ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory).getClassLoader(), parentClassLoader = classLoader; classLoader3 != parentClassLoader; parentClassLoader = instance.getParentClassLoader(parentClassLoader)) {
    ...
    static Class findProviderClass(final String s, ClassLoader classLoader, final boolean b) throws ClassNotFoundException, ConfigurationError {
        ...
        if (classLoader == null) {
            ...
            try {
                ...
                final ClassLoader classLoader2 = ((ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory = class$("org.apache.xerces.impl.dv.ObjectFactory")) : ObjectFactory.class$org$apache$xerces$impl$dv$ObjectFactory).getClassLoader();
                if (classLoader2 == null) {
                    clazz = Class.forName(s);
                }
                else {
