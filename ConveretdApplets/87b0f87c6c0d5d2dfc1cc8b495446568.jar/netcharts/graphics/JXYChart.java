...
public class JXYChart extends JDataChart
{
    ...
    public JXYChart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
        this.b = 0;
        this.c = 0;
        this.d = 0;
        this.e = true;
    ...
    public JXYChart(final Applet applet) {
        this.b = 0;
        this.c = 0;
        this.d = 0;
        this.e = true;
        ...
        if (super.param.changed("AddDataPoint")) {
            ...
            while (elements.hasMoreElements()) {
                ...
                try {
                    ...
                    NFDebug.print("JXYChart: AddDataPoint: first three attributes are needed");
                    continue;
                }
                if (n < 0 || n >= super.dataSeries.size()) {
                    NFDebug.print("JXYChart: AddDataPoint: Illegal data set ID");
                }
                else {
                    try {
                        ...
                        NFDebug.print("JXYChart: AddDataPoint: " + ex.getMessage());
                    }
                }
            }
        }
