...
public class Process
{
    ...
    public static void main(final String[] argv) {
        ...
        if (argv.length < 1) {
            ...
            try {
                ...
                diagnosticsWriter.println(XSLMessages.createMessage("ER_NOT_SUCCESSFUL", null));
                tfactory = null;
                doExit(-1);
            }
            ...
            try {
                ...
                if (doDiag) {
                    ...
                    final String msg = XSLMessages.createMessage("diagTiming", msgArgs);
    ...
    static void doExit(final int i) {
        System.exit(i);
    }
