        ...
        try {
            ...
            do {
                ...
                switch (char1) {
                    ...
                    default: {
                        System.out.println(String.valueOf("I don't know what to do with ").concat(String.valueOf(s)));
                        return null;
                    }
                }
                n = n2 + 1;
            ...
            System.err.println(String.valueOf("format = ").concat(String.valueOf(s)));
            ex.printStackTrace();
            return null;
        }
    }
