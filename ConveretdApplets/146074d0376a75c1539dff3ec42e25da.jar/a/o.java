        ...
        if (this.isShowing()) {
            ...
            for (int i = this.q.w; i < n; ++i) {
                ...
                if ((graphics2 = this.getGraphics()) != null) {
                    ...
                    final boolean b;
                    if (!(b = (n3 < 0 || n3 >= a.n.q(this.q).q()))) {
                        Image image = null;
                        if (a.n.q(this.q).q(n3) instanceof cm) {
                            image = ((cm)a.n.q(this.q).q(n3)).q;
                        }
                        if (a.n.q(this.q).q(n3) instanceof cj) {
                            image = ((cj)a.n.q(this.q).q(n3)).q;
                        }
                        if (a.n.q(this.q).q(n3) instanceof cx) {
                            image = ((cx)a.n.q(this.q).q(n3)).q;
                        }
