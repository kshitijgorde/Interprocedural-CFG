...
public final class cc extends Panel
{
    private bt q;
    private String q;
    private Color q;
    ...
    public cc(final aa q, final bt q2, final Q w) {
        this.e = true;
        this.q = 20;
        this.w = w;
        this.q = q;
        ...
        if (q.q) {
            this.r = true;
            this.q = new Q(q.q, this.q, false, this);
        }
    }
            ...
            case 502: {
                ...
                if ((w = this.w).q != null) {
                    ...
                    for (int i = 0; i < q2.q.size(); ++i) {
                        final Panel panel;
                        if ((panel = q2.q.elementAt(i)) instanceof cc) {
                            ((cc)panel).q = false;
                        }
                    }
                }
