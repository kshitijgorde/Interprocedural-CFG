...
public class Grid
{
    ...
    public String getProperty() {
        return String.valueOf(this._showYGridLines) + "|" + this._showXGridLines;
    }
    ...
    public void paint(final Graphics graphics, final int n, final int n2) {
        if (this._gGraph.getImageBackground() != null) {
            ...
            graphics.setColor(this._gGraph._cGridBackground);
        ...
        if (this._bHorizontalValues) {
            ...
            graphics.setColor(this._gGraph._cAxisLine);
            graphics.drawLine(n - 1, n2 + this._iHeight, n + this._iWidth - 1, n2 + this._iHeight);
        }
        else {
        ...
        if (this._showYGridLines) {
            if (this._bHorizontalValues) {
                ...
                for (int j = 0; j < this._iAxisIncrementCount; ++j) {
                    if (this._AxisY._iZeroIntersects + n2 == n5) {
                        graphics.setColor(this._gGraph._cAxisLine);
                    }
    ...
    public void setProperty(final String s) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            switch (n) {
                case 0: {
                    this._showYGridLines = Graph.sgv(nextToken, this._showYGridLines);
                    break;
                }
                case 1: {
                    this._showXGridLines = Graph.sgv(nextToken, this._showXGridLines);
                    break;
                }
            }
            ++n;
