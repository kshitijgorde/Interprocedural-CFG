...
public class bI extends aU implements cj, Runnable
{
    protected boolean q;
    protected int q;
    ...
    protected void q() {
        ...
        this.add(this.w);
        (this.q = new bR()).setForeground(new Color(0, 0, 128));
    ...
    protected bI(final co q, final l q2, final String q3, final String w, final boolean q4) {
        super(false);
        this.q = 6;
        this.w = -1;
        this.q = q2;
