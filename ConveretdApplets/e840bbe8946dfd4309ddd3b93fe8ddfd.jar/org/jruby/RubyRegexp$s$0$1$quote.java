...
public class RubyRegexp$s$0$1$quote extends JavaMethodN
{
    public RubyRegexp$s$0$1$quote(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyRegexp.quote(context, recv, array);
    }
}
