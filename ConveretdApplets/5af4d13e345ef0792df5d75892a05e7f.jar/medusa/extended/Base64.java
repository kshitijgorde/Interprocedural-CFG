...
public class Base64
{
    ...
    public static boolean encodeFileToFile(final String s, final String s2) {
        boolean b = false;
        java.io.InputStream inputStream = null;
        java.io.OutputStream outputStream = null;
        try {
            inputStream = new InputStream(new BufferedInputStream(new FileInputStream(s)), 1);
    ...
    public static boolean decodeFileToFile(final String s, final String s2) {
        boolean b = false;
        java.io.InputStream inputStream = null;
        java.io.OutputStream outputStream = null;
        try {
            inputStream = new InputStream(new BufferedInputStream(new FileInputStream(s)), 0);
            outputStream = new BufferedOutputStream(new FileOutputStream(s2));
            final byte[] array = new byte[65536];
            int read;
            while ((read = inputStream.read(array)) >= 0) {
