...
public class TransformerFactoryImpl extends SAXTransformerFactory implements SourceLoader, ErrorListener
{
    ...
    public TransformerFactoryImpl() {
        ...
        this._transletName = TransformerFactoryImpl.DEFAULT_TRANSLET_NAME;
    ...
    private String getTransletBaseName(final Source source) {
        ...
        if (!this._transletName.equals(TransformerFactoryImpl.DEFAULT_TRANSLET_NAME)) {
            return this._transletName;
        }
        ...
        return (transletBaseName != null) ? transletBaseName : TransformerFactoryImpl.DEFAULT_TRANSLET_NAME;
    }
    ...
    static {
        TransformerFactoryImpl.DEFAULT_TRANSLET_NAME = "GregorSamsa";
        TransformerFactoryImpl._xmlReader = new ThreadLocal();
    }
