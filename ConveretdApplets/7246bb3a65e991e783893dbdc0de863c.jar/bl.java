...
abstract class bl extends Thread
{
    ...
    protected void a() throws IOException, RuntimeException, InterruptedException, Exception {
        this.h.a("invp", new float[] { 0.0f, 0.0f, 0.0f, 0.1f });
        this.a(this.h, 0);
    }
    ...
    protected void a(final q q, final int n) throws IOException, InterruptedException, Exception {
        ...
        while (!this.k) {
            ...
            try {
                ...
                if (a2[b + 1] != -38) {
                    this.a(q, new bq(this.i).a(a2, 0, b + 1));
                    this.f.a(2, 1.0f);
                    return;
                }
                a2[b + 1] = -39;
    ...
    protected abstract void a(final q p0, final Image p1) throws InterruptedException;
}
