...
class LayerIDecoder implements FrameDecoder
{
    ...
    static class SubbandLayer1Stereo extends SubbandLayer1
    {
        ...
        public void read_scalefactor(final Bitstream bitstream, final Header header) {
            if (this.allocation != 0) {
                this.scalefactor = SubbandLayer1Stereo.scalefactors[bitstream.get_bits(6)];
            }
            if (this.channel2_allocation != 0) {
                this.channel2_scalefactor = SubbandLayer1Stereo.scalefactors[bitstream.get_bits(6)];
            }
        }
        ...
        public boolean put_next_sample(final int n, final SynthesisFilter synthesisFilter, final SynthesisFilter synthesisFilter2) {
            ...
            if (this.channel2_allocation != 0 && n != 1) {
                ...
                if (n == 0) {
                    synthesisFilter2.input_sample(n2, this.subbandnumber);
                }
                else {
                    synthesisFilter.input_sample(n2, this.subbandnumber);
                }
            }
            return true;
        }
    ...
    static class SubbandLayer1 extends Subband
    {
        ...
        public void read_scalefactor(final Bitstream bitstream, final Header header) {
            if (this.allocation != 0) {
                this.scalefactor = SubbandLayer1.scalefactors[bitstream.get_bits(6)];
            }
        }
    ...
    static class SubbandLayer1IntensityStereo extends SubbandLayer1
    {
        ...
        public void read_scalefactor(final Bitstream bitstream, final Header header) {
            if (this.allocation != 0) {
                this.scalefactor = SubbandLayer1IntensityStereo.scalefactors[bitstream.get_bits(6)];
                this.channel2_scalefactor = SubbandLayer1IntensityStereo.scalefactors[bitstream.get_bits(6)];
            }
        }
        ...
        public boolean put_next_sample(final int n, final SynthesisFilter synthesisFilter, final SynthesisFilter synthesisFilter2) {
            if (this.allocation != 0) {
                ...
                if (n == 0) {
                    final float n2 = this.sample * this.scalefactor;
                    final float n3 = this.sample * this.channel2_scalefactor;
                    synthesisFilter.input_sample(n2, this.subbandnumber);
