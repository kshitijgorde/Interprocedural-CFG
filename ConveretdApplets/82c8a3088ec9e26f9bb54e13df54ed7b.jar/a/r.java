...
public final class r
{
    ...
    public final int q(final String s) {
        if (this.q != null) {
            ...
            for (int i = 0; i < w.q; ++i) {
                final aM am;
                if ((am = (aM)w.q(i)).e().trim().equals(s)) {
                    return am.w();
                }
            }
        }
    ...
    public final synchronized void w() {
        ...
        for (int i = 0; i < w.q; ++i) {
            final String trim = ((aM)w.q(i)).e().trim();
            boolean b;
            do {
                final int index;
                boolean b4 = false;
                ...
                if (b3) {
                    ...
                    if ((cs.q() && this.u >= ((co)this.q).Y) || (cs.w() && this.u >= ((co)this.q).P)) {
    ...
    public r(final String s, final l q, final boolean b, final boolean b2, final av av, final bp q2) {
