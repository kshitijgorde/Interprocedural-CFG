...
public interface DestinationViewMBean
{
    ...
    @MBeanInfo("Sends a TextMessage to a password-protected destination.")
    String sendTextMessage(@MBeanInfo("headers") final Map<?, ?> p0, @MBeanInfo("body") final String p1, @MBeanInfo("user") final String p2, @MBeanInfo("password") final String p3) throws Exception;
