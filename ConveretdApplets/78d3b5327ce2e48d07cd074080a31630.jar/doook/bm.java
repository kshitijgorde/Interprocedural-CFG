...
class bm
{
    ...
    private void a(final String s) {
        ...
        if (b && sval3 != null) {
            final bl bl = new bl(this.c, sval3, aH.a(this.c), this.av);
            if (sval != null) {
                bl.a(sval, sval2);
            }
    ...
    private void e(final String s) {
        if (s != null) {
            final bl bl = new bl(this.c, s, aH.a(this.c), this.av);
            aH.a(this.c).addElement(bl);
            aH.a(this.c, aH.a(this.c) + doook.bl.a(bl));
        }
    }
    
    bm(final aH c, final int n, final int av, String substring) {
        this.c = c;
        this.av = av;
        aH.a(c, n);
