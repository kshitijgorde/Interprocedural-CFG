...
public class easy extends Applet implements Runnable
{
    TextField Xsize;
    TextField Ysize;
    TextField Mines;
    ...
    public easy() {
        ...
        this.tfPlayerName = new TextField(7);
        this.bd = 4;
    ...
    public void init() {
        ...
        this.add(this.Time);
        this.buildConstraints(gridBagConstraints, 0, 2, 1, 1, 35, 87);
        final Canvas canvas3 = new Canvas();
        layout.setConstraints(canvas3, gridBagConstraints);
        this.add(canvas3);
        this.buildConstraints(gridBagConstraints, 1, 2, 1, 1, 30, 87);
        final Canvas canvas4 = new Canvas();
        layout.setConstraints(canvas4, gridBagConstraints);
        this.add(canvas4);
        this.buildConstraints(gridBagConstraints, 2, 2, 1, 1, 35, 87);
        final Canvas canvas5 = new Canvas();
        layout.setConstraints(canvas5, gridBagConstraints);
        this.add(canvas5);
        this.buildConstraints(gridBagConstraints, 0, 3, 1, 1, 25, 13);
        final Canvas canvas6 = new Canvas();
        layout.setConstraints(canvas6, gridBagConstraints);
        this.add(canvas6);
        this.buildConstraints(gridBagConstraints, 1, 3, 1, 1, 30, 13);
        layout.setConstraints(this.myPlayerNameLabel = new Label("Name", 1), gridBagConstraints);
        this.add(this.myPlayerNameLabel);
        this.buildConstraints(gridBagConstraints, 2, 3, 1, 1, 45, 13);
