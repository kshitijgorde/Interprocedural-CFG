...
class Evaluator
{
    ...
    public void setExpressionIfCondition(final int index, final Graphics3D new_graphics, final int flag, final int if_min_index, final int if_max_index, final int else_min_index, final int else_max_index, final int default_min_index, final int default_max_index) {
