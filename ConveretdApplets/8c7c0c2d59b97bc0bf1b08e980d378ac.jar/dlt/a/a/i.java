...
public class i extends f
{
    ...
    public i(final a a, final l l) {
        super(a, l);
    }
    
    private void new() {
        if (this.b == null) {
            this.b = new g(this.null, this.else);
        }
        else {
            this.b.a(this.null, this.else);
        }
    }
    ...
    public void for(final dlt.a.c.a a) {
        ...
        if (n >= 3.0) {
            for (int n2 = 0; n2 < n - 2.0; ++n2) {
                final h a2 = a.a();
                this.a(new1[0].if(), new1[n2 + 1].if(), new1[n2 + 2].if(), (float)new1[0].a(a2), (float)new1[n2 + 1].a(a2), (float)new1[n2 + 2].a(a2), a.if());
            }
        }
    }
    
    private void if(final dlt.a.b.c c, final dlt.a.b.c c2, final dlt.a.b.c c3, float n, float n2, float n3, final Color color) {
        try {
            double for1 = c.for();
            final double a = c.a();
            double int1 = c.int();
            ...
            for (int n27 = (int)a; n27 <= a3; ++n27) {
                ...
                if (n33 > 0 && n33 < this.else) {
                    for (int i = (int)(n18 + n25); i <= (int)(n19 + n25); ++i) {
                        if (i >= 0 && i <= this.null && this.b.a(i, n33, n28)) {
    ...
    private void a(dlt.a.b.c c, dlt.a.b.c c2, dlt.a.b.c c3, float n, float n2, float n3, final Color color) {
        if (c2.a() < c.a()) {
        ...
        if (c.a() == c2.a() || c.a() == c3.a() || c2.a() == c3.a()) {
            ...
            this.if(c, c7, c2, n, n10, n2, color);
            this.if(c2, c7, c3, n2, n10, n3, color);
        }
    }
