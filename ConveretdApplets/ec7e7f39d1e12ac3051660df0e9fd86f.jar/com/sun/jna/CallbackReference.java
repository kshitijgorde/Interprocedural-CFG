...
class CallbackReference extends WeakReference
{
    ...
    private CallbackReference(final Callback callback, final int callingConvention, boolean direct) {
        ...
        if (direct) {
            ...
            this.cbstruct = createNativeCallback(callback, this.method, nativeParamTypes, returnType, callingConvention, true);
        }
        else {
            ...
            this.cbstruct = createNativeCallback(this.proxy, CallbackReference.PROXY_CALLBACK_METHOD, nativeParamTypes, returnType, callingConvention, false);
        }
    }
    ...
    private static synchronized native Pointer createNativeCallback(final Callback p0, final Method p1, final Class[] p2, final Class p3, final int p4, final boolean p5);
    
    private static synchronized native void freeNativeCallback(final long p0);
