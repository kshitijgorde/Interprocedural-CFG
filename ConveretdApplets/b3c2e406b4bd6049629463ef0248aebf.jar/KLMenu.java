...
public class KLMenu extends Applet implements Runnable
{
    ...
    public void init(final String info) {
        ...
        this.a98("menuMain");
        this.a30 = this.a71("steps", 25);
        this.a31 = this.a71("switchSteps", 10);
        this.a29 = this.a71("delay", 50);
        this.a36 = this.a71("rounding", 0);
        this.a48 = this.a73("highlightFade", "");
        this.a49 = this.a73("inFade", "");
        this.a50 = this.a73("outFade", this.a49);
        ...
        this.a43 = this.a75("bgcolor", Color.white);
        final Color a75 = this.a75("fgcolor", Color.black);
        final Color a76 = this.a75("mouse", Color.blue);
        this.a44 = this.a75("highlight", this.a43);
        this.setBackground(this.a43);
        this.setForeground(a75);
        this.a41 = this.a68(a75, a76);
        this.a42 = this.a68(this.a43, this.a44);
        final String s = (this.getParameter("font") != null) ? this.getParameter("font") : "Times";
        final String lowerCase = this.a73("fontstyle", "").toLowerCase();
        this.a39.setFont(new Font(s, ((lowerCase.indexOf(105) != -1) ? 2 : 0) | ((lowerCase.indexOf(98) != -1) ? 1 : 0), this.a71("fontsize", 16)));
        ...
        if (this.getParameter("key") != null) {
            if (this.getParameter("key").equals(this.a78(host))) {
                this.a28 = false;
            }
            else if (this.getParameter("host") != null && host.indexOf(this.getParameter("host")) > -1) {
                if (this.getParameter("key").equals(this.a78(this.getParameter("host")))) {
                    this.a28 = false;
                }
            }
            else {
                this.showStatus("Incorrect key");
            }
        }
        if (this.a28) {
            ...
            array[this.a55.length] = "This,http://www.javabase.fsnet.co.uk/,_blank";
    ...
    protected Color[] a68(final Color color, final Color color2) {
        final Color[] array = new Color[this.a30];
        for (int i = 0; i < this.a30; ++i) {
            array[i] = new Color(color.getRed() + i * (color2.getRed() - color.getRed()) / this.a30, color.getGreen() + i * (color2.getGreen() - color.getGreen()) / this.a30, color.getBlue() + i * (color2.getBlue() - color.getBlue()) / this.a30);
        }
        return array;
    }
    
    protected int a71(final String s, final int n) {
    ...
    protected String a73(final String s, final String s2) {
        if (this.getParameter(s) != null && !this.getParameter(s).equals("")) {
    ...
    protected Color a75(final String s, final Color color) {
    ...
    protected String a78(final String s) {
    ...
    public void a80(final String a56) {
        this.a56 = a56;
        this.a35 = this.a31 - 1;
        this.a45 = true;
        this.a34 = 1;
    ...
    protected void a82(final int n) {
        ...
        if (this.a34 == 0) {
            if (this.a53 == null) {
                create.clearRect(this.a47[n].x, this.a47[n].y, this.a47[n].width, this.a47[n].height);
            }
            else {
        ...
        if (this.a34 != 0 && !this.a47[n].intersects(rectangle)) {
    ...
    protected void a98(final String s) {
        if (!this.a54.containsKey(s)) {
            ...
            for (int k = 0; k < n; ++k) {
                if (this.a104(array[k], 1, ',').indexOf("menu") == 0) {
                    this.a98(this.a104(array[k], 1, ','));
                }
            }
        }
    }
    ...
    protected void a106(final String s) {
        ...
        this.a39.clearRect(0, 0, this.width, this.height);
        this.a33 = -1;
    ...
    public KLMenu() {
        this.INFO = "KLMenu http://javabase.go.to/";
        this.a28 = true;
        this.a29 = 50;
        this.a31 = 2;
        this.a33 = -1;
