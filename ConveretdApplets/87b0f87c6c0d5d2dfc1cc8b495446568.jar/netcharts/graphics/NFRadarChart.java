...
public class NFRadarChart extends NFGraph
{
    ...
    public NFRadarChart(final Applet applet) {
        this.radialAxes = new Vector();
        this.dataSeries = new Vector();
        this.radiusGrids = new Vector();
        this.MaxDataSets = 50;
        this.centerPercentage = NFRadarChart.CENTER_PERCENTAGE_DEFAULT;
        this.alwaysCircle = NFRadarChart.ALWAYS_CIRCLE_DEFAULT;
        this.labelRatio = NFRadarChart.LABEL_RATIO_DEFAULT;
        this.lineValueLabel = null;
        this.initGraph(applet);
    }
    
    public NFRadarChart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
        this.radialAxes = new Vector();
        this.dataSeries = new Vector();
        this.radiusGrids = new Vector();
        this.MaxDataSets = 50;
                ...
                for (int n6 = 0; n6 < polygon2.npoints - 1; ++n6) {
                    ...
                    if (polygon2.xpoints[n6] == Integer.MIN_VALUE || polygon2.ypoints[n6] == Integer.MIN_VALUE) {
                        ...
                        if (nfDataSeries2.valueLabelStyle != 0) {
                            NFValueLabel.drawPointValueLabel((this.lineValueLabel == null) ? super.dwell.getLabel() : this.lineValueLabel, graphics, nfDataSeries2, n7, n8, string);
                        }
                    }
                }
            }
    ...
    protected void defineParams() {
        ...
        NFValueLabel.definePointValueLabel(super.param, "Line", 0);
    }
    ...
    protected synchronized void loadParams() throws Exception {
        ...
        if (super.param.changed("CenterRadius")) {
            double number = NFUtil.getNumber(super.param.get("CenterRadius"), NFRadarChart.CENTER_PERCENTAGE_DEFAULT);
            if (number < 0.0) {
                number = 0.0;
            }
            if (number > 100.0) {
        ...
        if (super.param.changed("RadarSquare")) {
            final String string = NFUtil.getString(super.param.get("RadarSquare"), NFRadarChart.ALWAYS_CIRCLE_DEFAULT ? "ON" : "OFF");
        ...
        this.lineValueLabel = NFValueLabel.loadValueLabel(this, "Line", 0, this.dataSeries, this.lineValueLabel, 0);
    }
    ...
    static {
        NFRadarChart.CENTER_PERCENTAGE_DEFAULT = 0.5;
        NFRadarChart.ALWAYS_CIRCLE_DEFAULT = true;
        NFRadarChart.LABEL_RATIO_DEFAULT = 1.0;
    }
}
