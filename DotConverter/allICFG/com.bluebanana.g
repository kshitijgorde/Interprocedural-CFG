digraph "" {
    ...
    "z1 = 0"
    "virtualinvoke $r3.<java.io.PrintStream: void println(java.lang.String)>($r4)"->"z1 = 0";
    "$r5 = staticinvoke <javax.swing.UIManager: javax.swing.UIManager$LookAndFeelInfo[] getInstalledLookAndFeels()>()"
    "z1 = 0"->"$r5 = staticinvoke <javax.swing.UIManager: javax.swing.UIManager$LookAndFeelInfo[] getInstalledLookAndFeels()>()";
    "r2 = $r5"
    "$r5 = staticinvoke <javax.swing.UIManager: javax.swing.UIManager$LookAndFeelInfo[] getInstalledLookAndFeels()>()"->"r2 = $r5";
    "i0 = lengthof $r5"
    "r2 = $r5"->"i0 = lengthof $r5";
    "$i1 = 0"
    "i0 = lengthof $r5"->"$i1 = 0";
    "i2 = 0"
    "$i1 = 0"->"i2 = 0";
    "goto [?= (branch)]"
    "i2 = 0"->"goto [?= (branch)]";
    "if $i1 < i0 goto r1 = r2[i2]"
    "goto [?= (branch)]"->"if $i1 < i0 goto r1 = r2[i2]";
    "$z3 = z1"
    "if $i1 < i0 goto r1 = r2[i2]"->"$z3 = z1";
    "if $z3 != 0 goto $r15 = staticinvoke <com.bluebanana.b.g: java.lang.String b(java.lang.String)>(\"1\r\u0014\u0011\u0004\u0017\u0002\u00013\r\u0015\u000b^\u0008\u001c\u0019\t4\u0019\u000b\u0004\")"
    "$z3 = z1"->"if $z3 != 0 goto $r15 = staticinvoke <com.bluebanana.b.g: java.lang.String b(java.lang.String)>(\"1\r\u0014\u0011\u0004\u0017\u0002\u00013\r\u0015\u000b^\u0008\u001c\u0019\t4\u0019\u000b\u0004\")";
    ...
    "r24 = $r19"
    "specialinvoke $r19.<com.bluebanana.gui.kb: void <init>()>()"->"r24 = $r19";
    "virtualinvoke r24.<com.bluebanana.gui.kb: void setSize(int,int)>(1000, 600)"
    "r24 = $r19"->"virtualinvoke r24.<com.bluebanana.gui.kb: void setSize(int,int)>(1000, 600)";
    "staticinvoke <com.bluebanana.a.g: void ALLATORI_DEMO(java.awt.Window)>(r24)"
    "virtualinvoke r24.<com.bluebanana.gui.kb: void setSize(int,int)>(1000, 600)"->"staticinvoke <com.bluebanana.a.g: void ALLATORI_DEMO(java.awt.Window)>(r24)";
    "virtualinvoke r24.<com.bluebanana.gui.kb: void setVisible(boolean)>(1)"
    "staticinvoke <com.bluebanana.a.g: void ALLATORI_DEMO(java.awt.Window)>(r24)"->"virtualinvoke r24.<com.bluebanana.gui.kb: void setVisible(boolean)>(1)";
    "return"
    "virtualinvoke r24.<com.bluebanana.gui.kb: void setVisible(boolean)>(1)"->"return";
    "$r21 := @caughtexception"
    ...
    "r23 = $r21"->"$r19 = new com.bluebanana.gui.kb";
    "$r17 = staticinvoke <javax.swing.UIManager: java.lang.Object get(java.lang.Object)>($r16)"->"$r21 := @caughtexception";
    "$r16 = staticinvoke <com.bluebanana.a.d: java.lang.String ALLATORI_DEMO(java.lang.String)>(\"B\u0015g\tw\u000fq\u0019@\u0015f\u0013-\u0001o\fB\u0015g\tw\u000fq\u0019@\u0015f\u0013\")"->"$r21 := @caughtexception";
    "$r15 = staticinvoke <com.bluebanana.b.g: java.lang.String b(java.lang.String)>(\"1\r\u0014\u0011\u0004\u0017\u0002\u00013\r\u0015\u000b^\u0008\u001c\u0019\t4\u0019\u000b\u0004\")"->"$r21 := @caughtexception";
    "staticinvoke <javax.swing.UIManager: void setLookAndFeel(java.lang.String)>($r20)"->"$r21 := @caughtexception";
    "$r20 = staticinvoke <javax.swing.UIManager: java.lang.String getSystemLookAndFeelClassName()>()"->"$r21 := @caughtexception";
    "if $z3 != 0 goto $r15 = staticinvoke <com.bluebanana.b.g: java.lang.String b(java.lang.String)>(\"1\r\u0014\u0011\u0004\u0017\u0002\u00013\r\u0015\u000b^\u0008\u001c\u0019\t4\u0019\u000b\u0004\")"->"$r15 = staticinvoke <com.bluebanana.b.g: java.lang.String b(java.lang.String)>(\"1\r\u0014\u0011\u0004\u0017\u0002\u00013\r\u0015\u000b^\u0008\u001c\u0019\t4\u0019\u000b\u0004\")";
    "if $z3 != 0 goto $r15 = staticinvoke <com.bluebanana.b.g: java.lang.String b(java.lang.String)>(\"1\r\u0014\u0011\u0004\u0017\u0002\u00013\r\u0015\u000b^\u0008\u001c\u0019\t4\u0019\u000b\u0004\")"->"$r21 := @caughtexception";
    "r1 = r2[i2]"
    "if $i1 < i0 goto r1 = r2[i2]"->"r1 = r2[i2]";
    "$r6 = staticinvoke <com.bluebanana.a.d: java.lang.String ALLATORI_DEMO(java.lang.String)>(\"M\tn\u0002v\u0013\")"
    "r1 = r2[i2]"->"$r6 = staticinvoke <com.bluebanana.a.d: java.lang.String ALLATORI_DEMO(java.lang.String)>(\"M\tn\u0002v\u0013\")";
    ...
    "z2 = 1"
    "staticinvoke <javax.swing.UIManager: java.lang.Object put(java.lang.Object,java.lang.Object)>($r12, $r13)"->"z2 = 1";
    "$z3 = z2"
    "z2 = 1"->"$z3 = z2";
    "$z3 = z2"->"goto [?= (branch)]";
    "goto [?= (branch)]"->"if $z3 != 0 goto $r15 = staticinvoke <com.bluebanana.b.g: java.lang.String b(java.lang.String)>(\"1\r\u0014\u0011\u0004\u0017\u0002\u00013\r\u0015\u000b^\u0008\u001c\u0019\t4\u0019\u000b\u0004\")";
    "staticinvoke <javax.swing.UIManager: java.lang.Object put(java.lang.Object,java.lang.Object)>($r12, $r13)"->"$r21 := @caughtexception";
    "$r13 = <java.awt.Color: java.awt.Color white>"->"$r21 := @caughtexception";
    "$r12 = staticinvoke <com.bluebanana.a.d: java.lang.String ALLATORI_DEMO(java.lang.String)>(\"m\tn\u0002v\u0013G\tp\u0001a\ff\u0004W\u0005{\u0014\")"->"$r21 := @caughtexception";
    "staticinvoke <javax.swing.UIManager: java.lang.Object put(java.lang.Object,java.lang.Object)>($r9, $r10)"->"$r21 := @caughtexception";
    "$r10 = <java.awt.Color: java.awt.Color darkGray>"->"$r21 := @caughtexception";
    "$r9 = staticinvoke <com.bluebanana.b.g: java.lang.String b(java.lang.String)>(\"\u0016\u0019\u0015\u0012\r\u0003:\u0011\u000b\u0015\")"->"$r21 := @caughtexception";
    "staticinvoke <javax.swing.UIManager: void setLookAndFeel(java.lang.String)>($r8)"->"$r21 := @caughtexception";
    "$r8 = virtualinvoke r1.<javax.swing.UIManager$LookAndFeelInfo: java.lang.String getClassName()>()"->"$r21 := @caughtexception";
    "i2 = i2 + 1"
    "if $z0 == 0 goto i2 = i2 + 1"->"i2 = i2 + 1";
    "$i1 = i2"
    "i2 = i2 + 1"->"$i1 = i2";
    "$i1 = i2"->"if $i1 < i0 goto r1 = r2[i2]";
    "if $z0 == 0 goto i2 = i2 + 1"->"$r21 := @caughtexception";
    "$z0 = virtualinvoke $r6.<java.lang.String: boolean equals(java.lang.Object)>($r7)"->"$r21 := @caughtexception";
    "$r7 = virtualinvoke r1.<javax.swing.UIManager$LookAndFeelInfo: java.lang.String getName()>()"->"$r21 := @caughtexception";
    "$r6 = staticinvoke <com.bluebanana.a.d: java.lang.String ALLATORI_DEMO(java.lang.String)>(\"M\tn\u0002v\u0013\")"->"$r21 := @caughtexception";
    "r1 = r2[i2]"->"$r21 := @caughtexception";
    "if $i1 < i0 goto r1 = r2[i2]"->"$r21 := @caughtexception";
    "r2 = $r5"->"$r21 := @caughtexception";
    "$r5 = staticinvoke <javax.swing.UIManager: javax.swing.UIManager$LookAndFeelInfo[] getInstalledLookAndFeels()>()"->"$r21 := @caughtexception";
