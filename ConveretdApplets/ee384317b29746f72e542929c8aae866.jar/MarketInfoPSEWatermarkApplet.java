...
public class MarketInfoPSEWatermarkApplet extends Applet implements Runnable, ImageObserver, MouseListener
{
    ...
    MarketInfo2 info;
    private Image psewatermark;
    private String psewatermarkImgName;
    
    public MarketInfoPSEWatermarkApplet() {
        this.upArrow = null;
        this.downArrow = null;
        this.info = null;
        this.psewatermark = null;
    }
    ...
    public void start() {
        if (this.thread == null) {
            this.psewatermark = this.loadImage(this.psewatermarkImgName);
    ...
    private void drawErrorMessage() {
        final String s = new String("Loading Data ...");
        this.offImg = this.createImage(this.width, this.height);
        this.offScr = this.offImg.getGraphics();
        this.repaint();
        this.offScr.setColor(this.foreColor);
    ...
    private void drawHeader() {
        ...
        final int n2 = 299;
        final int n3 = 12;
        final String s = new String("PSEi & SECTORAL INDICES");
    ...
    private void drawWatermark() {
        this.offScr.drawImage(this.psewatermark, 40, 60, null);
    }
    ...
    private void basicMarketInfoParameters() {
        ...
        this.psewatermarkImgName = this.getParameter("psewatermark");
    }
