...
class NumberAxisPropertyEditPanel extends AxisPropertyEditPanel implements FocusListener
{
    ...
    public NumberAxisPropertyEditPanel(final NumberAxis axis) {
        super(axis);
        ...
        (this.autoRangeCheckBox = new JCheckBox(NumberAxisPropertyEditPanel.localizationResources.getString("Auto-adjust_range"), this.autoRange)).setActionCommand("AutoRangeOnOff");
        this.autoRangeCheckBox.addActionListener(this);
        range.add(this.autoRangeCheckBox);
        range.add(new JPanel());
        range.add(new JLabel(NumberAxisPropertyEditPanel.localizationResources.getString("Minimum_range_value")));
        ...
        range.add(new JPanel());
        range.add(new JLabel(NumberAxisPropertyEditPanel.localizationResources.getString("Maximum_range_value")));
        ...
        range.add(new JPanel());
        other.add(NumberAxisPropertyEditPanel.localizationResources.getString("Range"), range);
    }
    ...
    private void attemptGridStrokeSelection() {
        ...
        final int result = JOptionPane.showConfirmDialog(this, panel, NumberAxisPropertyEditPanel.localizationResources.getString("Stroke_Selection"), 2, -1);
        if (result == 0) {
    ...
    private void attemptGridPaintSelection() {
        final Color c = JColorChooser.showDialog(this, NumberAxisPropertyEditPanel.localizationResources.getString("Grid_Color"), Color.blue);
        if (c != null) {
    ...
    static {
        NumberAxisPropertyEditPanel.localizationResources = ResourceBundle.getBundle("org.jfree.chart.ui.LocalizationBundle");
    }
}
