...
public class XplView extends Canvas implements Runnable
{
    ...
    public void start() {
        if (this.BallsThread == null) {
            (this.BallsThread = new Thread(this)).setPriority(10);
            this.BallsThread.start();
        }
    }
    
    public void stop() {
        if (this.BallsThread != null) {
            this.BallsThread.stop();
            this.BallsThread = null;
        }
    }
    ...
    public void pp(final int n, final int n2, final int n3) {
        if (n2 < this.h && n2 >= 0 && n < this.w && n >= 0) {
