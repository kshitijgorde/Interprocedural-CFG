...
public class gb extends Panel implements ActionListener, MouseMotionListener, MouseListener
{
    ...
    public void a() {
        this.i = this.a.c(String.valueOf(this.a.N) + "/" + this.a.y + gb.z[9], gb.z[6]);
        this.j = this.a.c(String.valueOf(this.a.N) + "/" + this.a.y + gb.z[9], gb.z[6]);
        this.k = this.a.c(String.valueOf(this.a.N) + "/" + this.a.y + gb.z[9], gb.z[5]);
        this.l = this.a.c(String.valueOf(this.a.N) + "/" + this.a.y + gb.z[9], gb.z[8]);
        this.i[this.a.a(this.i)] = gb.z[7];
        this.j[this.a.a(this.j)] = gb.z[7];
        this.k[this.a.a(this.k)] = gb.z[7];
        this.l[this.a.a(this.l)] = gb.z[7];
    }
    ...
    public void b() {
        ...
        this.a.Ib.removeAll();
        this.a.Jb.removeAll();
        this.a.a(this.a.Fb, gb.z[4], this);
        this.a.a(this.a.Gb, gb.z[3], this);
        this.a.a(this.a.Hb, gb.z[0], this);
        this.a.a(this.a.Ib, gb.z[1], this);
        this.a.a(this.a.Jb, gb.z[2], this);
    }
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "y,\u0003\u000bgx".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "d,\u0003\u000bgx".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "k,\u0003\u000bgx".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "e,\u0003\u000bgx".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "j,\u0003\u000bgx".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "K4\r\u0015|m0".toCharArray();
        ...
        final int n19 = 6;
        final char[] charArray7 = "[(\r\u000fg{".toCharArray();
        ...
        final int n22 = 7;
        final char[] charArray8 = "fa\t\bQ`=\u0018A=i>\u0003\u000ef".toCharArray();
        ...
        final int n25 = 8;
        final char[] charArray9 = "X.\u0005\rs|9".toCharArray();
