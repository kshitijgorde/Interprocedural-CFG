...
public class DS_Rain extends Applet implements Runnable
{
    Thread _fld0;
    int _fld1;
    Font _fld3;
    ...
    void _mth2b() {
        ...
        for (int i = 0; i < this._fld2e; ++i) {
            this._fld8e[i] = 2 + this._fld3e * 2 + (int)(Math.random() * 8.0);
            this._fld6e[i] = (int)(Math.random() * this._fld4);
            this._fld7e[i] = (int)(Math.random() * this._fld5);
            this._fld9e[i] = (0xFF000000 | (48 + (int)(Math.random() * 70.0)) * 65793);
            this._fld0f[i] = false;
        }
    }
    ...
    void _mth4b() {
        ...
        for (int j = 0; j < this._fld2e; j += 2) {
            this._fld7e[j] += this._fld8e[j];
            if (this._fld7e[j] >= this._fld5 - 3) {
                if (j < this._fld5e) {
                    this._fld0f[j] = true;
                }
                else {
            ...
            if (this._fld0f[j]) {
                ...
                this._fld7[(this._fld7e[j] + 1) * this._fld4 + this._fld6e[j]] = this._fld9e[j] + 526344;
                this._fld7[(this._fld7e[j] + 2) * this._fld4 + this._fld6e[j]] = this._fld9e[j] + 1052688;
                this._fld7[(this._fld7e[j] + 3) * this._fld4 + this._fld6e[j]] = this._fld9e[j] + 1579032;
            }
        }
        for (int k = 1; k < this._fld2e; k += 2) {
            this._fld7e[k] += this._fld8e[k];
            if (this._fld7e[k] >= this._fld5 - 5) {
                if (k < this._fld5e) {
                    this._fld0f[k] = true;
                }
                else {
            ...
            if (this._fld0f[k]) {
                ...
                this._fld7[(this._fld7e[k] + 1) * this._fld4 + this._fld6e[k]] = this._fld9e[k] + 526344;
                this._fld7[(this._fld7e[k] + 2) * this._fld4 + this._fld6e[k]] = this._fld9e[k] + 1052688;
                this._fld7[(this._fld7e[k] + 3) * this._fld4 + this._fld6e[k]] = this._fld9e[k] + 1579032;
                this._fld7[(this._fld7e[k] + 4) * this._fld4 + this._fld6e[k]] = this._fld9e[k] + 2105376;
                this._fld7[(this._fld7e[k] + 5) * this._fld4 + this._fld6e[k]] = this._fld9e[k] + 2631720;
            }
        }
    }
