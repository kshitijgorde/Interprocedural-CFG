...
public class LogConfiguration
{
    ...
    public static void setLogTarget(final String s) {
        BaseBoot.getInstance().getGlobalConfig().setConfigProperty("org.jfree.base.LogTarget", s);
    }
    ...
    public static void setLogLevel(final String s) {
        BaseBoot.getInstance().getGlobalConfig().setConfigProperty("org.jfree.base.LogLevel", s);
    }
    ...
    public static void setDisableLogging(final boolean b) {
        BaseBoot.getInstance().getGlobalConfig().setConfigProperty("org.jfree.base.NoDefaultDebug", String.valueOf(b));
    }
