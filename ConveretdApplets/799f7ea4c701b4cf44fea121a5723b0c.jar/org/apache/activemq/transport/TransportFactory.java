...
public abstract class TransportFactory
{
    ...
    public static TransportServer bind(final String brokerId, final URI location) throws IOException {
    ...
    private static TransportFactory findTransportFactory(final URI location) throws IOException {
