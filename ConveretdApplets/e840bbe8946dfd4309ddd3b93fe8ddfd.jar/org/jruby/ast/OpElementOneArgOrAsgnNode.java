...
public class OpElementOneArgOrAsgnNode extends OpElementAsgnNode
{
    ...
    public OpElementOneArgOrAsgnNode(final ISourcePosition position, final Node receiverNode, final String operatorName, final ArrayNode args, final Node valueNode) {
