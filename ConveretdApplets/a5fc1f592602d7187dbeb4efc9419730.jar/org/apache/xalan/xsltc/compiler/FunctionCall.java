    ...
    public void translate(final ClassGenerator classGen, final MethodGenerator methodGen) {
        ...
        if (this.isStandard() || this.isExtension()) {
            ...
            for (int j = 0; j < n; ++j) {
                ...
                exp2.getType().translateTo(classGen, methodGen, paramTypes[j]);
            }
            ...
            final LocalVariableGen _local = methodGen.addLocalVariable2("objects", org.apache.bcel.generic.Type.OBJECT, il.getEnd());
            il.append(new PUSH(cpg, n + 1));
            il.append(new ANEWARRAY(cpg.addClass("java.lang.Object")));
            il.append(InstructionConstants.DUP);
            ...
            il.append(new PUSH(cpg, this._className));
            il.append(new PUSH(cpg, methodName));
            il.append(new ALOAD(_local.getIndex()));
            final int index = cpg.addMethodref("org.apache.xalan.xsltc.runtime.CallFunction", "invokeMethod", "(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;");
            il.append(new INVOKESTATIC(index));
        }
        else {
            ...
            if (this._thisArgument != null && this._clazz.isInterface()) {
                final int index = cpg.addInterfaceMethodref(clazz, this._fname.getLocalPart(), buffer.toString());
                il.append(new INVOKEINTERFACE(index, n + 1));
            }
            else {
                final int index = cpg.addMethodref(clazz, this._fname.getLocalPart(), buffer.toString());
