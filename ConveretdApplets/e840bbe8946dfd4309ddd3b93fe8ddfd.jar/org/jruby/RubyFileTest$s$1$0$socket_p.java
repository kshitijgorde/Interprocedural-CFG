...
public class RubyFileTest$s$1$0$socket_p extends JavaMethodOne
{
    public RubyFileTest$s$1$0$socket_p(final RubyModule implementationClass, final Visibility visibility) {
