...
public final class ae extends Canvas implements aA, Runnable
{
    public Thread q;
    private int e;
    private int r;
    ...
    public void q() {
        ...
        this.q = (Frame)aK.q(this, !W.e());
        this.r = true;
    }
    
    public final void q(final String s, final as as) {
        if (as.q(1) || as.q(2)) {
            if (this.q.a == 2 && as.q(1)) {
                return;
            }
            if (this.q.q(61) && as.q(2)) {
                return;
            }
        }
        final H q = this.q(s);
        ...
        if (q.w == null || w.trim().equals("")) {
            ...
            this.r.addElement(s.q(ak.q("Follow link %1"), w));
        }
        this.e.addElement(w);
        final Font font = new Font(as.q, as.e(), as.w);
        this.i.addElement(font);
        this.o.addElement(this.getFontMetrics(font));
        this.t.addElement(new Color(as.w()));
        this.y.addElement(q.q);
        this.u.addElement(new Color(as.g));
    ...
    private H q(final String q) {
        final H h = new H(this, (byte)0);
        int n = 0;
        String sval = null;
        String sval2 = null;
