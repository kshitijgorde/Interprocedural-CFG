...
public class PLine implements PConstants
{
    ...
    public void draw() {
        ...
        if (this.parent.hints[6]) {
            final float n = -this.SCREEN_WIDTH;
            final float n2 = -this.SCREEN_HEIGHT;
            final float n3 = this.SCREEN_WIDTH * 2;
            final float n4 = this.SCREEN_HEIGHT * 2;
            if (this.x_array[1] < n || this.x_array[1] > n3 || this.x_array[0] < n || this.x_array[0] > n3 || this.y_array[1] < n2 || this.y_array[1] > n4 || this.y_array[0] < n2 || this.y_array[0] > n4) {
                return;
            }
        }
        ...
        if (this.x_array[1] < this.x_array[0]) {
            final float n5 = this.x_array[1];
            this.x_array[1] = this.x_array[0];
            this.x_array[0] = n5;
            final float n6 = this.y_array[1];
            this.y_array[1] = this.y_array[0];
            this.y_array[0] = n6;
            final float n7 = this.z_array[1];
            this.z_array[1] = this.z_array[0];
            this.z_array[0] = n7;
            final float n8 = this.r_array[1];
            this.r_array[1] = this.r_array[0];
            this.r_array[0] = n8;
            final float n9 = this.g_array[1];
            this.g_array[1] = this.g_array[0];
            this.g_array[0] = n9;
            final float n10 = this.b_array[1];
            this.b_array[1] = this.b_array[0];
            this.b_array[0] = n10;
            final float n11 = this.a_array[1];
            this.a_array[1] = this.a_array[0];
            this.a_array[0] = n11;
        }
        int n12 = (int)this.x_array[1] - (int)this.x_array[0];
        int n13 = (int)this.y_array[1] - (int)this.y_array[0];
        if (Math.abs(n13) > Math.abs(n12)) {
            final int n14 = n13;
            n13 = n12;
            n12 = n14;
            b = true;
        ...
        if (n12 < 0) {
            this.o0 = 1;
            this.o1 = 0;
            n15 = (int)this.x_array[1];
            n16 = (int)this.y_array[1];
            n17 = -n12;
        }
        else {
            this.o0 = 0;
            this.o1 = 1;
            n15 = (int)this.x_array[0];
            n16 = (int)this.y_array[0];
            n17 = n12;
        }
        int n18;
        if (n17 == 0) {
        ...
        if (this.INTERPOLATE_RGB) {
            this.dr = (this.r_array[this.o1] - this.r_array[this.o0]) / n17;
            this.dg = (this.g_array[this.o1] - this.g_array[this.o0]) / n17;
            this.db = (this.b_array[this.o1] - this.b_array[this.o0]) / n17;
        }
        else {
            this.dr = 0.0f;
            this.dg = 0.0f;
        ...
        if (this.INTERPOLATE_ALPHA) {
            this.da = (this.a_array[this.o1] - this.a_array[this.o0]) / n17;
        }
        else {
            this.da = 0.0f;
        }
        ...
        if (this.INTERPOLATE_Z) {
            this.dz = (this.z_array[this.o1] - this.z_array[this.o0]) / n17;
        }
        else {
            this.dz = 0.0f;
        }
        if (n17 == 0) {
            if (this.INTERPOLATE_ALPHA) {
                this.drawPoint_alpha(n15, n16);
            }
            else {
                this.drawPoint(n15, n16);
            }
            return;
        }
        if (this.SMOOTH) {
            this.drawLine_smooth(n15, n16, n18, n17, b);
        }
        else if (this.m_drawFlags == 0) {
            this.drawLine_plain(n15, n16, n18, n17, b);
        }
        else if (this.m_drawFlags == 2) {
            this.drawLine_plain_alpha(n15, n16, n18, n17, b);
        }
        else if (this.m_drawFlags == 1) {
            this.drawLine_color(n15, n16, n18, n17, b);
        }
        else if (this.m_drawFlags == 3) {
            this.drawLine_color_alpha(n15, n16, n18, n17, b);
        }
        else if (this.m_drawFlags == 8) {
            this.drawLine_plain_spatial(n15, n16, n18, n17, b);
        }
        else if (this.m_drawFlags == 10) {
            this.drawLine_plain_alpha_spatial(n15, n16, n18, n17, b);
        }
        else if (this.m_drawFlags == 9) {
            this.drawLine_color_spatial(n15, n16, n18, n17, b);
        }
        else if (this.m_drawFlags == 11) {
            this.drawLine_color_alpha_spatial(n15, n16, n18, n17, b);
        }
    }
    ...
    public PLine(final PGraphics3 parent) {
        this.INTERPOLATE_Z = false;
