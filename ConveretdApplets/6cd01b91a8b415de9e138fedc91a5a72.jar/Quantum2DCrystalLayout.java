...
class Quantum2DCrystalLayout implements LayoutManager
{
    ...
    public void layoutContainer(final Container container) {
        ...
        for (int j = 1; j < container.getComponentCount(); ++j) {
            ...
            if (component2.isVisible()) {
                ...
                if (component2 instanceof Scrollbar || component2 instanceof DecentScrollbar) {
                    preferredSize2.width = width;
                }
                if (component2 instanceof Choice && preferredSize2.width > width) {
                    preferredSize2.width = width;
                }
