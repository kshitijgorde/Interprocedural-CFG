...
public class TGCanvas extends Canvas implements KeyListener, MouseListener
{
    ...
    class Fill
    {
        ...
        void doIt(final Graphics graphics, final TGCanvas tgCanvas) {
            ...
            final int n = (int)Math.rint(this.point.x + TGCanvas.this.xCenter);
            final int n2 = (int)Math.rint(TGCanvas.this.yCenter - this.point.y);
            final int n3 = TGCanvas.this.graphicsPixels[n2 * TGCanvas.this.canvasWidth + n] & 0xFFFFFF;
            if (TGCanvas.this.currentAWTColor.getRGB() != this.color.getRGB()) {
                graphics.setColor(this.color);
                TGCanvas.this.currentAWTColor = this.color;
            }
            final int n4 = TGCanvas.this.currentAWTColor.getRGB() & 0xFFFFFF;
            if (n3 != n4) {
                this.floodFill(TGCanvas.this.graphicsPixels, n, n2, n3, n4);
            }
