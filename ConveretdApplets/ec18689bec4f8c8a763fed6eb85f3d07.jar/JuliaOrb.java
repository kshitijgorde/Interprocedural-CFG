...
public class JuliaOrb extends Applet implements MouseListener, ItemListener, KeyListener, Runnable
{
    Thread JuliaTrace;
    Image imgMan;
    Image imgJulia;
    ...
    public void Orbits() {
        ...
        for (int i = 0; i < 3 * this.MaxIt; ++i) {
            final double n3 = n * n;
            n = (n2 + n2) * n + this.trCi;
            n2 = n2 * n2 - n3 + this.trCr;
            final int n4 = (int)(n2 / this.stJulia) + this.wJulia / 2;
            final int n5 = -(int)(n / this.stJulia) + this.wJulia / 2;
            try {
                this.pArr[n4 + this.wJulia * (n5 + 1)] = this.ColorWhite;
            }
