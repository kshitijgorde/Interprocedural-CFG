...
public class Live extends Applet implements Runnable
{
    ...
    public void initialize() {
        if (!this.initialized) {
            System.out.println("LiveGraphics3D 1.90 by Martin_Kraus_Germany@yahoo.com");
            this.text_y = 0;
            this.ps3D = null;
            ...
            if (null == logo_image) {
                ...
                this.print_message(this.front_graphics_buffer, "LiveGraphics3D 1.90", false);
            ...
            if (null != this.evaluator && null == this.evaluator.variable_names) {
                this.evaluator = null;
            }
    ...
    public boolean setGraphics3D(final String input_text, final String independent_variables, final String dependent_variables) {
        ...
        if (null != dependent_variables) {
            ...
            Parser parser = new Parser(dependent_variables, this.evaluator);
            if (!parser.scan_dependent_variables()) {
                this.print_message(this.front_graphics_buffer, "LiveGraphics3D error in DEPENDENT_VARIABLES.");
                this.print_syntax_error(this.front_graphics_buffer, parser);
                this.repaint();
                this.evaluator = null;
        ...
        while (!this.is_stopped) {
            try {
                if (null == this.ps3D) {
                    ...
                    double animation_display_time = 0.0;
    ...
    public boolean keyDown(final Event evt, final int key) {
        ...
        if (100 == key) {
            ...
            System.out.println("current_frame_index: " + this.current_frame_index);
        }
        if (102 == key) {
    ...
    static {
        Live.empty_string = "";
        Live.enter_plain_string = "LiveGraphics3D 1.90";
        Live.enter_drag_string = "LiveGraphics3D 1.90: Please drag to rotate.";
        Live.enter_drag_animated_string = "LiveGraphics3D 1.90: Drag to rotate; double click to stop/restart.";
        Live.enter_animated_string = "LiveGraphics3D 1.90: Please double click to stop/restart.";
        Live.enter_init_string = "Initializing LiveGraphics3D 1.90. Please wait.";
