...
public class PImage implements PConstants, Cloneable
{
    ...
    public Image getImage() {
        this.loadPixels();
        final BufferedImage bufferedImage = new BufferedImage(this.width, this.height, (this.format == 1) ? 2 : 1);
    ...
    public PImage get() {
        try {
            final PImage pImage = (PImage)this.clone();
    ...
    private void blit_resize(final PImage pImage, int n, int n2, int n3, int n4, final int[] array, final int n5, final int n6, int n7, int n8, final int n9, final int n10, final int n11) {
        if (n < 0) {
            n = 0;
        }
        if (n2 < 0) {
        ...
        if (b) {
            ...
            switch (n11) {
                case 1: {
                    for (int i = 0; i < low2; ++i) {
                        ...
                        for (int j = 0; j < low; ++j) {
                            array[n18 + j] = blend_blend(array[n18 + j], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 32: {
                    for (int n27 = 0; n27 < low2; ++n27) {
                        ...
                        for (int n28 = 0; n28 < low; ++n28) {
                            array[n18 + n28] = blend_difference(array[n18 + n28], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 64: {
                    for (int n29 = 0; n29 < low2; ++n29) {
                        ...
                        for (int n30 = 0; n30 < low; ++n30) {
                            array[n18 + n30] = blend_exclusion(array[n18 + n30], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 128: {
                    for (int n31 = 0; n31 < low2; ++n31) {
                        ...
                        for (int n32 = 0; n32 < low; ++n32) {
                            array[n18 + n32] = blend_multiply(array[n18 + n32], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 256: {
                    for (int n33 = 0; n33 < low2; ++n33) {
                        ...
                        for (int n34 = 0; n34 < low; ++n34) {
                            array[n18 + n34] = blend_screen(array[n18 + n34], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 512: {
                    for (int n35 = 0; n35 < low2; ++n35) {
                        ...
                        for (int n36 = 0; n36 < low; ++n36) {
                            array[n18 + n36] = blend_overlay(array[n18 + n36], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 1024: {
                    for (int n37 = 0; n37 < low2; ++n37) {
                        ...
                        for (int n38 = 0; n38 < low; ++n38) {
                            array[n18 + n38] = blend_hard_light(array[n18 + n38], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 2048: {
                    for (int n39 = 0; n39 < low2; ++n39) {
                        ...
                        for (int n40 = 0; n40 < low; ++n40) {
                            array[n18 + n40] = blend_soft_light(array[n18 + n40], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 4096: {
                    for (int n41 = 0; n41 < low2; ++n41) {
                        ...
                        for (int n42 = 0; n42 < low; ++n42) {
                            array[n18 + n42] = blend_dodge(array[n18 + n42], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 8192: {
                    for (int n43 = 0; n43 < low2; ++n43) {
                        ...
                        for (int n44 = 0; n44 < low; ++n44) {
                            array[n18 + n44] = blend_burn(array[n18 + n44], this.filter_bilinear());
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
            ...
            switch (n11) {
                case 1: {
                    for (int n45 = 0; n45 < low2; ++n45) {
                        ...
                        for (int n46 = 0; n46 < low; ++n46) {
                            array[n18 + n46] = blend_blend(array[n18 + n46], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 2: {
                    for (int n47 = 0; n47 < low2; ++n47) {
                        ...
                        for (int n48 = 0; n48 < low; ++n48) {
                            array[n18 + n48] = blend_add_pin(array[n18 + n48], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 4: {
                    for (int n49 = 0; n49 < low2; ++n49) {
                        ...
                        for (int n50 = 0; n50 < low; ++n50) {
                            array[n18 + n50] = blend_sub_pin(array[n18 + n50], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 8: {
                    for (int n51 = 0; n51 < low2; ++n51) {
                        ...
                        for (int n52 = 0; n52 < low; ++n52) {
                            array[n18 + n52] = blend_lightest(array[n18 + n52], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 16: {
                    for (int n53 = 0; n53 < low2; ++n53) {
                        ...
                        for (int n54 = 0; n54 < low; ++n54) {
                            array[n18 + n54] = blend_darkest(array[n18 + n54], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 0: {
                    for (int n55 = 0; n55 < low2; ++n55) {
                        ...
                        for (int n56 = 0; n56 < low; ++n56) {
                            array[n18 + n56] = this.srcBuffer[this.sY + (this.sX >> 15)];
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 32: {
                    for (int n57 = 0; n57 < low2; ++n57) {
                        ...
                        for (int n58 = 0; n58 < low; ++n58) {
                            array[n18 + n58] = blend_difference(array[n18 + n58], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 64: {
                    for (int n59 = 0; n59 < low2; ++n59) {
                        ...
                        for (int n60 = 0; n60 < low; ++n60) {
                            array[n18 + n60] = blend_exclusion(array[n18 + n60], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 128: {
                    for (int n61 = 0; n61 < low2; ++n61) {
                        ...
                        for (int n62 = 0; n62 < low; ++n62) {
                            array[n18 + n62] = blend_multiply(array[n18 + n62], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 256: {
                    for (int n63 = 0; n63 < low2; ++n63) {
                        ...
                        for (int n64 = 0; n64 < low; ++n64) {
                            array[n18 + n64] = blend_screen(array[n18 + n64], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 512: {
                    for (int n65 = 0; n65 < low2; ++n65) {
                        ...
                        for (int n66 = 0; n66 < low; ++n66) {
                            array[n18 + n66] = blend_overlay(array[n18 + n66], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 1024: {
                    for (int n67 = 0; n67 < low2; ++n67) {
                        ...
                        for (int n68 = 0; n68 < low; ++n68) {
                            array[n18 + n68] = blend_hard_light(array[n18 + n68], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 2048: {
                    for (int n69 = 0; n69 < low2; ++n69) {
                        ...
                        for (int n70 = 0; n70 < low; ++n70) {
                            array[n18 + n70] = blend_soft_light(array[n18 + n70], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 4096: {
                    for (int n71 = 0; n71 < low2; ++n71) {
                        ...
                        for (int n72 = 0; n72 < low; ++n72) {
                            array[n18 + n72] = blend_dodge(array[n18 + n72], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
                ...
                case 8192: {
                    for (int n73 = 0; n73 < low2; ++n73) {
                        this.sX = this.srcXOffset;
                        this.sY = (this.srcYOffset >> 15) * pImage.width;
                        for (int n74 = 0; n74 < low; ++n74) {
                            array[n18 + n74] = blend_burn(array[n18 + n74], this.srcBuffer[this.sY + (this.sX >> 15)]);
                            this.sX += n16;
                        }
                        n18 += n5;
                        this.srcYOffset += n17;
    ...
    protected static PImage loadTIFF(final byte[] array) {
        ...
        final int n = (array[30] & 0xFF) << 8 | (array[31] & 0xFF);
        final int n2 = (array[42] & 0xFF) << 8 | (array[43] & 0xFF);
        final int n3 = (array[114] & 0xFF) << 24 | (array[115] & 0xFF) << 16 | (array[116] & 0xFF) << 8 | (array[117] & 0xFF);
        if (n3 != n * n2 * 3) {
            System.err.println("Error: Processing can only read its own TIFF files. (" + n + ", " + n2 + ")");
            return null;
        }
        for (int i = 0; i < PImage.TIFF_HEADER.length; ++i) {
            if (i != 30 && i != 31 && i != 42 && i != 43 && i != 102 && i != 103 && i != 114 && i != 115 && i != 116) {
                if (i != 117) {
                    if (array[i] != PImage.TIFF_HEADER[i]) {
        ...
        final PImage pImage = new PImage(n, n2, 1);
        int n4 = 768;
        for (int n5 = n3 / 3, j = 0; j < n5; ++j) {
            pImage.pixels[j] = (0xFF000000 | (array[n4++] & 0xFF) << 16 | (array[n4++] & 0xFF) << 8 | (array[n4++] & 0xFF));
        }
        return pImage;
    }
    ...
    protected boolean saveTIFF(final OutputStream outputStream) {
        try {
            ...
            array[30] = (byte)(this.width >> 8 & 0xFF);
            array[31] = (byte)(this.width & 0xFF);
            array[42] = (array[102] = (byte)(this.height >> 8 & 0xFF));
            array[43] = (array[103] = (byte)(this.height & 0xFF));
            final int n = this.width * this.height * 3;
            array[114] = (byte)(n >> 24 & 0xFF);
            array[115] = (byte)(n >> 16 & 0xFF);
            array[116] = (byte)(n >> 8 & 0xFF);
            array[117] = (byte)(n & 0xFF);
    ...
    protected boolean saveTGA(final OutputStream outputStream) {
        ...
        array[12] = (byte)(this.width & 0xFF);
        array[13] = (byte)(this.width >> 8);
        array[14] = (byte)(this.height & 0xFF);
        array[15] = (byte)(this.height >> 8);
        try {
            outputStream.write(array);
            ...
            if (this.format == 4) {
                while (i < n) {
                    int n2 = 0;
                    int n3 = 1;
                    int n4 = array2[0] = (this.pixels[i] & 0xFF);
                    while (i + n3 < n) {
    ...
    protected void saveImageIO(final String s) throws IOException {
        try {
            final BufferedImage bufferedImage = new BufferedImage(this.width, this.height, (this.format == 2) ? 2 : 1);
            bufferedImage.setRGB(0, 0, this.width, this.height, this.pixels, 0, this.width);
            ImageIO.write(bufferedImage, s.substring(s.lastIndexOf(46) + 1), new File(s));
        }
        catch (Exception ex) {
            ex.printStackTrace();
        ...
        try {
            ...
            if (this.saveImageFormats != null) {
                for (int i = 0; i < this.saveImageFormats.length; ++i) {
                    if (s.endsWith("." + this.saveImageFormats[i])) {
                        this.saveImageIO(s);
                        return;
                    }
                }
            ...
            if (s.toLowerCase().endsWith(".tga")) {
                bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(s), 32768);
                b = this.saveTGA(bufferedOutputStream);
            }
            else {
                if (!s.toLowerCase().endsWith(".tif") && !s.toLowerCase().endsWith(".tiff")) {
                    s += ".tif";
                }
                bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(s), 32768);
