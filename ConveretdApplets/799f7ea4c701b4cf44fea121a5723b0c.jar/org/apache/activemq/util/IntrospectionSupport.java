...
public final class IntrospectionSupport
{
    ...
    public static String convertToString(final Object value, final Class type) {
        final PropertyEditor editor = PropertyEditorManager.findEditor(type);
        if (editor != null) {
    ...
    static {
        final String[] additionalPath = { "org.springframework.beans.propertyeditors", "org.apache.activemq.util" };
        synchronized (PropertyEditorManager.class) {
            final String[] existingSearchPath = PropertyEditorManager.getEditorSearchPath();
            final String[] newSearchPath = (String[])Array.newInstance(String.class, existingSearchPath.length + additionalPath.length);
            System.arraycopy(existingSearchPath, 0, newSearchPath, 0, existingSearchPath.length);
            System.arraycopy(additionalPath, 0, newSearchPath, existingSearchPath.length, additionalPath.length);
            try {
