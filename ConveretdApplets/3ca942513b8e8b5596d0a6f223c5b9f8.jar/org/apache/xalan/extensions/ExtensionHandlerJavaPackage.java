    ...
    public Object callFunction(final String funcName, final Vector args, final Object methodKey, final ExpressionContext exprContext) throws TransformerException {
        ...
        try {
            ...
            if (funcName.endsWith(".new")) {
                ...
                Constructor c = (methodKey != null) ? ((Constructor)this.getFromCache(methodKey, null, methodArgs)) : null;
                if (c != null) {
                    try {
                ...
                Method m = (methodKey != null) ? ((Method)this.getFromCache(methodKey, null, methodArgs)) : null;
                ...
                Method m = (methodKey != null) ? ((Method)this.getFromCache(methodKey, targetObject, methodArgs)) : null;
                if (m != null) {
                    try {
                        final Class[] paramTypes = m.getParameterTypes();
                        MethodResolver.convertParams(methodArgs, convertedArgs, paramTypes, exprContext);
