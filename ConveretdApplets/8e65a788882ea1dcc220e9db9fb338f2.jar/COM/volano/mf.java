...
public class mf extends Canvas
{
    ...
    public mf(final AppletContext d, final URL url, final URL url2, final boolean e, final String f, final int g, final int h) {
        this.n = true;
        this.d = d;
        this.e = e;
        this.f = f;
    ...
    public void paint(final Graphics graphics) {
        ...
        if (this.e) {
            graphics.setColor(mf.a);
            graphics.draw3DRect(0, 0, this.i, this.j, this.n);
            graphics.setColor(mf.b);
