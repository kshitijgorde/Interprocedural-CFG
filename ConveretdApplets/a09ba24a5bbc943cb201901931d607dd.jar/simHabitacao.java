...
public class simHabitacao extends Applet implements ItemListener, MouseListener, MouseMotionListener
{
    ...
    private double getMaxPercentFinanciamento() {
        ...
        if (this.simulador == 10 || this.simulador == 11) {
            ...
            final double value = this.sliderPrazo.getValue();
            try {
            ...
            if (this.finalidade == 5) {
                ...
                switch (this.finalidade) {
                    ...
                    case 2: {
                        ...
                        n = 0.8;
                        if (this.prazoCarencia <= 0 && (this.modalidade == 1 || this.modalidade == 6) && value <= 40.0) {
                            n = 0.9;
                            break;
                        }
                        break;
    ...
    public void init() {
        ...
        if (this.getIParameter("limite") != null) {
            this.EMPRESTIMO_MAX = new Double(this.getIParameter("limite"));
        }
        else {
            this.EMPRESTIMO_MAX = this.EMPRESTIMO_FINANCIAMENTO;
        }
    ...
    private void processSliderEmprestimo() {
        ...
        if (n % this.EMPRESTIMO_JUMP != 0.0) {
            ...
            n = this.sliderEmprestimo.getValue();
        }
        else {
    ...
    private void processSliderEmprestimoLCP() {
        ...
        double value = this.sliderEmprestimoLCP.getValue();
    ...
    private void processSliderPrazo() {
        ...
        int n = (int)Math.round(this.sliderPrazo.getValue());
        if (n > this.PRAZO_MAX) {
        ...
        if (n < this.PRAZO_MIN_TAXAS) {
            ...
            n = (int)Math.round(this.sliderPrazo.getValue());
        }
        ...
        if (this.EMPRESTIMO_FINANCIAMENTO_LCP <= 0.0) {
            this.sliderPrestacao.setMaximum(this.calcPrestacao(this.EMPRESTIMO_MAX, n, this.currentTaxa, this.TRCB, this.IMPOSTO_SELO) + 200.0);
        }
        this.updateDisplay();
    }
