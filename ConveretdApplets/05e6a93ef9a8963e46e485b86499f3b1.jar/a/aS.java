...
public final class aS extends Panel
{
    ...
    public final Dimension preferredSize() {
        ...
        final FontMetrics fontMetrics = this.getFontMetrics(aS.q);
        ...
        final Dimension dimension = new Dimension(Math.max(preferredSize.width, aT.w.y), preferredSize.height);
    ...
    private aS(final int t, int n, final int i, final int u, final int e, final bq q, final boolean q2) {
        this.q = 12;
    ...
    public aS(final int n, final int n2, final int n3, final int n4, final int n5, final bq bq) {
        this(2, 10, 2, 10, n5, bq, false);
    }
    
    public aS(final bq bq, final boolean b) {
        this(4, 4, 4, 4, 1, bq, b);
    }
