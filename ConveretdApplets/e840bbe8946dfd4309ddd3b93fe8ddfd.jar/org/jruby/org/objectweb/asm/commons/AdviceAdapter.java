...
public abstract class AdviceAdapter extends GeneratorAdapter implements Opcodes
{
    ...
    protected AdviceAdapter(final MethodVisitor methodVisitor, final int methodAccess, final String s, final String methodDesc) {
        super(methodVisitor, methodAccess, s, methodDesc);
