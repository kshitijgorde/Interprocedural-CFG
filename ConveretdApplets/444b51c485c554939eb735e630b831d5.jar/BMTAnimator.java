...
public class BMTAnimator implements Runnable
{
    private Image src;
    private int fw;
    private int fh;
    ...
    BMTAnimator(final Image src, final int fw, final int fh, final int oy, final long interval) {
        this.frame = 0;
        this.animation = null;
        this.dest = null;
        this.x = 0;
    ...
    void drawFrame(final Graphics graphics, final int x, final int y, final Component dest) {
        synchronized (this) {
            this.x = x;
            this.y = y;
            this.dest = dest;
