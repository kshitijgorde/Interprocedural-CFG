...
public class RubyFile$s$0$0$chown extends JavaMethodN
{
    public RubyFile$s$0$0$chown(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyFile.chown(context, recv, array);
    }
}
