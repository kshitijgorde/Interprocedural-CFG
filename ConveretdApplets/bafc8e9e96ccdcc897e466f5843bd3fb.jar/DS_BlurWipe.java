...
public class DS_BlurWipe extends Applet implements Runnable
{
    Thread _fld0;
    int _fld1;
    Font _fld2;
    ...
    public final boolean mouseEnter(final Event event, final int n, final int n2) {
        this.showStatus(this._fld7f[this._fld4e]);
    ...
    boolean _mth6() {
        ...
        if (this._fld3e >= 2) {
            ...
            for (int j = 0; j < this._fld3e; ++j) {
                ...
                this._fld5f = new URL[this._fld3e];
                this._fld6f = new String[this._fld3e];
                this._fld7f = new String[this._fld3e];
                array2[j].flush();
                array2[j] = null;
                System.gc();
                n += n2;
    ...
    void _mth0b() {
        ...
        this._fld9e = ((this._fld9e >= 0) ? ((this._fld9e <= 60) ? this._fld9e : 60) : 0);
    ...
    void _mth1b() {
        ...
        for (int i = 0; i < this._fld3 * this._fld4; ++i) {
            ...
            this._fld7[i] = this._fld5[i + this._fld3 * this._fld4];
        }
        this._fld5e = 0;
    ...
    void _mth3b() {
        if (this._fld1f) {
            ...
            for (int i = 0; i < this._fld3 * this._fld4; ++i) {
                this._fld8[i] = this._fld6[i];
            }
            return;
        }
        this._fld7e += this._fld8e;
        if (this._fld2f == 0) {
            this._mth4b();
            return;
        }
    ...
    void _mth4b() {
        for (int i = 0; i < this._fld4 - 2; ++i) {
            for (int j = 0; j < this._fld3; ++j) {
                final int n = i * this._fld3 + j;
                final int n2 = this._fld6[n + this._fld3];
                final int n3 = this._fld6[n + this._fld3 - 1];
                final int n4 = this._fld6[n + this._fld3 + this._fld3];
                final int n5 = this._fld6[n + this._fld3 + 1];
                int n6 = (n2 >> 16 & 0xFF) + (n3 >> 16 & 0xFF) + (n4 >> 16 & 0xFF) + (n5 >> 16 & 0xFF) >> 2;
                if (n6 > this._fld8e) {
                    n6 -= this._fld8e;
                }
                int n7 = (n2 >> 8 & 0xFF) + (n3 >> 8 & 0xFF) + (n4 >> 8 & 0xFF) + (n5 >> 8 & 0xFF) >> 2;
                if (n7 > this._fld8e) {
                    n7 -= this._fld8e;
                }
                int n8 = (n2 & 0xFF) + (n3 & 0xFF) + (n4 & 0xFF) + (n5 & 0xFF) >> 2;
                if (n8 > this._fld8e) {
                    n8 -= this._fld8e;
                }
                this._fld8[n] = (this._fld6[n] = (0xFF000000 | n6 << 16 | n7 << 8 | n8));
            }
        }
        for (int k = this._fld3 * (this._fld4 - 2); k < this._fld3 * this._fld4; ++k) {
            this._fld8[k] = (this._fld6[k] = -16777216);
        }
    }
    
    void _mth5b() {
        for (int i = this._fld4 - 1; i > 1; --i) {
            for (int j = 0; j < this._fld3; ++j) {
                final int n = i * this._fld3 + j;
                final int n2 = this._fld6[n - this._fld3];
                final int n3 = this._fld6[n - this._fld3 - 1];
    ...
    void _mth6b() {
        ...
        try {
            this._fld8f = new URL("http://" + this._fld7b);
        }
        catch (MalformedURLException ex) {
            this._fld8f = null;
        }
    ...
    public final boolean mouseDown(final Event event, final int n, final int n2) {
        ...
        else if (this._fld5f[this._fld4e] != null) {
            if (this._fld6f[this._fld4e] != null) {
                this.getAppletContext().showDocument(this._fld5f[this._fld4e], this._fld6f[this._fld4e]);
            }
            else {
                this.getAppletContext().showDocument(this._fld5f[this._fld4e]);
            }
        }
        return true;
    }
    ...
    void _mth7b() {
        ...
        if (--fld0d > 0) {
            this._fld0c = true;
            this._fld0d = fld0d;
            this._fld2g = new String[this._fld0d];
            this._fld3g = new Color[this._fld0d];
            this._fld4g = new Color[this._fld0d];
            this._fld5g = new Font[this._fld0d];
            this._fld6g = new FontMetrics[this._fld0d];
            this._fld7g = new String[this._fld0d];
            this._fld8g = new int[this._fld0d];
            this._fld9g = new int[this._fld0d];
            for (int i = 0; i < this._fld0d; ++i) {
                this._fld2g[i] = this.getParameter("overtext" + String.valueOf(i + 1));
                this._fld3g[i] = this._mth9("overtextcol" + String.valueOf(i + 1), new Color(16777215));
                this._fld4g[i] = this._mth9("overtextcols" + String.valueOf(i + 1), new Color(0));
                ...
                this._fld6g[i] = this._fld3c.getFontMetrics(this._fld5g[i]);
    ...
    void _mth8b() {
        this._fld3d = this._fld6g[this._fld9c].stringWidth(this._fld2g[this._fld9c]);
        this._fld4d = this._fld6g[this._fld9c].getHeight();
        if (this._fld7g[this._fld9c].equalsIgnoreCase("scrolldown")) {
            this._fld1d = this._fld3 - this._fld3d >> 1;
            this._fld2d = 0;
            return;
        }
        if (this._fld7g[this._fld9c].equalsIgnoreCase("scrollup")) {
            this._fld1d = this._fld3 - this._fld3d >> 1;
            this._fld2d = this._fld4 + this._fld4d;
            return;
        }
        if (this._fld7g[this._fld9c].equalsIgnoreCase("scrollright")) {
            this._fld1d = -this._fld3d;
            this._fld2d = this._fld9g[this._fld9c] + (this._fld4d >> 1) + (this._fld4d >> 3);
            return;
        }
    ...
    void _mth9b(final Graphics graphics) {
        graphics.setFont(this._fld5g[this._fld9c]);
        graphics.setColor(this._fld4g[this._fld9c]);
        graphics.drawString(this._fld2g[this._fld9c], this._fld1d + 1, this._fld2d + 1);
        graphics.setColor(this._fld3g[this._fld9c]);
        graphics.drawString(this._fld2g[this._fld9c], this._fld1d, this._fld2d);
        if (this._fld7g[this._fld9c].equalsIgnoreCase("scrolldown")) {
            this._fld2d += this._fld8g[this._fld9c];
        }
        else if (this._fld7g[this._fld9c].equalsIgnoreCase("scrollup")) {
            this._fld2d -= this._fld8g[this._fld9c];
        }
        else if (this._fld7g[this._fld9c].equalsIgnoreCase("scrollright")) {
            this._fld1d += this._fld8g[this._fld9c];
        }
        else {
            this._fld1d -= this._fld8g[this._fld9c];
        }
