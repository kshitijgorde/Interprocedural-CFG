...
import org.jruby.javasupport.Java$OldStyleExtensionInherited$s$1$0$inherited;
...
public class org$jruby$javasupport$Java$OldStyleExtensionInherited$Populator extends TypePopulator
{
    public void populate(final RubyModule cls, final Class clazz) {
        ...
        final JavaMethod javaMethod = new Java$OldStyleExtensionInherited$s$1$0$inherited(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 1, "inherited", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(Java.OldStyleExtensionInherited.class, "inherited", IRubyObject.class, new Class[] { IRubyObject.class, IRubyObject.class }, true);
