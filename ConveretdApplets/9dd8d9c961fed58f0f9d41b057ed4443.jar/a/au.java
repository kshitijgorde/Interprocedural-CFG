...
public final class au implements ImageObserver
{
    private boolean q;
    private boolean w;
    private boolean e;
    ...
    public final void q(final Graphics graphics, int n, int n2, final int n3, final boolean b) {
        if (this.q instanceof Image) {
            ...
            bg.q(graphics, this.q.toString(), n + 7, 0, n2 - 12, n3, 0, false);
        }
    }
    
    final boolean q(Graphics graphics, final aM am, final Object o, int int1, int n, int n2, int n3, final boolean b) {
        if (o == null && am.q instanceof l) {
            return false;
        }
        if (o instanceof Boolean) {
            ...
            if (height == 0 || height == 0) {
                ...
                if (this.q.q != null && cu.q()) {
                    int1 = 0;
                    if (this.q.q.q().containsKey("" + ((l)am.q).s)) {
                        int1 = Integer.parseInt(this.q.q.q().get("" + ((l)am.q).s));
                    }
                    if (int1 > 0) {
            ...
            n = n19 + (n - 15) / 2;
            n3 = int1 + (n2 - 15) / 2 - 1;
            cx.q(graphics, 15, 15, color2, n, n3);
        }
        else if (o != null) {
            ...
            graphics8.setFont(new Font(graphics8.getFont().getFamily(), ((aJ)am.q).e(), graphics8.getFont().getSize()));
            Color color3 = null;
            Label_0822: {
                Color q;
                if (b) {
                    if ((aU.w.Q.getRGB() & 0xFF) == 0x0) {
                        color3 = (am.q ? am.w : Color.lightGray);
                        break Label_0822;
                    }
                    q = aU.w.Q;
                }
                else {
                    q = ((am.q instanceof aJ && (((aJ)am.q).w() & 0xFF) != 0x0) ? new Color(((aJ)am.q).w()) : (am.q ? am.q : Color.gray));
                }
                color3 = q;
            }
            graphics8.setColor(color3);
            bg.q(graphics8, s, n + 5, n2, n3 - 8, n23, 0, am.w, am);
        }
        return true;
    }
    
    public au(final Object q, final String q2) {
        this.q = Color.red;
        this.q = false;
        this.w = false;
        this.q = 50;
