...
public class OpenMBeanParameterInfoSupport extends MBeanParameterInfo implements OpenMBeanParameterInfo, Serializable
{
    ...
    public OpenMBeanParameterInfoSupport(final String name, final String description, final OpenType openType) {
        super(name, (openType == null) ? null : openType.getClassName(), description);
        try {
            this.init(name, description, openType, null, null, null, null);
        }
        catch (OpenDataException ex) {}
    }
    
    public OpenMBeanParameterInfoSupport(final String name, final String description, final OpenType openType, final Object defaultValue) throws OpenDataException {
        super(name, (openType == null) ? null : openType.getClassName(), description);
        this.init(name, description, openType, defaultValue, null, null, null);
    }
    
    public OpenMBeanParameterInfoSupport(final String name, final String description, final OpenType openType, final Object defaultValue, final Object[] legalValues) throws OpenDataException {
        super(name, (openType == null) ? null : openType.getClassName(), description);
        this.init(name, description, openType, defaultValue, legalValues, null, null);
    }
    
    public OpenMBeanParameterInfoSupport(final String name, final String description, final OpenType openType, final Object defaultValue, final Comparable minValue, final Comparable maxValue) throws OpenDataException {
        super(name, (openType == null) ? null : openType.getClassName(), description);
        this.init(name, description, openType, defaultValue, null, minValue, maxValue);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final OpenMBeanParameterInfo other = (OpenMBeanParameterInfo)obj;
    ...
    private void init(final String name, final String Description, final OpenType openType, final Object defaultValue, final Object[] legalValues, final Comparable minValue, final Comparable maxValue) throws OpenDataException {
