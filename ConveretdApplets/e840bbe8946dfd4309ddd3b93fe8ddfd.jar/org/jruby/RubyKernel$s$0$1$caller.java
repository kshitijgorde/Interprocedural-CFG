...
public class RubyKernel$s$0$1$caller extends JavaMethodNBlock
{
    public RubyKernel$s$0$1$caller(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyKernel.caller(context, recv, array, block);
    }
}
