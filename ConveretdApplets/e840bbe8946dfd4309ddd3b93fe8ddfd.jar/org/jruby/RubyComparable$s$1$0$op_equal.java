...
public class RubyComparable$s$1$0$op_equal extends JavaMethodOne
{
    public RubyComparable$s$1$0$op_equal(final RubyModule implementationClass, final Visibility visibility) {
