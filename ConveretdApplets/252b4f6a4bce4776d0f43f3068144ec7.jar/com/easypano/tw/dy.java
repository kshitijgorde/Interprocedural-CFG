...
class dy implements cf
{
    n a;
    final /* synthetic */ TWViewer b;
    
    public dy(final TWViewer b, final n a) {
        this.b = b;
        this.a = null;
        this.a = a;
    }
    ...
    public void a(final int n, final String s) {
        ...
        if (q == 0) {
            if (n == n3) {
                final Image image = (Image)TWViewer.a(this.b).d.a(this.b.a(a("v}\u0013\u0003prw\u0013\u00197kq\u0013\u00009"), ""), 1);
