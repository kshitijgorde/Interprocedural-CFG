...
public class q extends W
{
    ...
    public void f() {
        this.b.O = (short)this.a.getSelectedIndex();
        this.b.P = (short)this.b.getSelectedIndex();
        this.b.Q = (short)this.c.getSelectedIndex();
        this.b.R = (short)this.d.getSelectedIndex();
        this.b.S = (short)this.e.getSelectedIndex();
    }
    
    public void c() {
        this.a.select(this.b.O);
        this.b.select(this.b.P);
        this.c.select(this.b.Q);
        this.d.select(this.b.R);
        this.e.select(this.b.S);
    }
