...
public class C extends Canvas
{
    ...
    void a(final Graphics graphics, final int n) {
        final Image b = ((bh)U.a(this.a).a(n)).b;
        final Rectangle a = this.a(n - this.a.f);
        graphics.drawImage(b, 1 + a.x + (a.width - 24) / 2, 1 + a.y + (a.height - 24) / 2, this);
    }
    
    public void paint(final Graphics graphics) {
        if (this.isShowing()) {
            final int a = U.a(this.a).a();
            int c = this.a.c();
            if (a <= c) {
                this.a.f = 0;
                c = a;
            ...
            if (this.a.e >= this.a.f && this.a.e < n) {
                this.f(this.a.e - this.a.f);
            }
            for (int i = this.a.f; i < n; ++i) {
                this.b(i);
            }
        }
    }
    ...
    public boolean handleEvent(final Event event) {
        switch (event.id) {
            ...
            case 506: {
                ...
                final int n4 = n2 * width + n3 + this.a.f;
                if (n4 < a2 && n4 != this.a.e) {
                    this.a.c(n4);
                }
                return true;
            }
