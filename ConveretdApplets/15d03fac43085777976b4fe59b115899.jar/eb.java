...
class eb extends Panel implements MouseListener, MouseMotionListener, ActionListener
{
    ...
    public void a(final String s, final Component component, final boolean b) {
        ...
        boolean equals;
        final boolean b2 = equals = this.a.jb.equals(eb.z[5]);
    ...
    protected void a(final Graphics graphics) {
        ...
        final int n4 = equalsIgnoreCase = (n5 = (this.a.W.equalsIgnoreCase(eb.z[2]) ? 1 : 0));
        int width = 0;
        Label_0238: {
            if (!r) {
                if (n4 != 0) {
                ...
                final int n6;
                equalsIgnoreCase = (n6 = (n5 = (this.a.W.equalsIgnoreCase(eb.z[0]) ? 1 : 0)));
            }
            if (!r) {
                if (n4 != 0) {
                    n = 0;
        ...
        final int n9 = equalsIgnoreCase2 = (this.a.W.equalsIgnoreCase(eb.z[2]) ? 1 : 0);
        ...
        Label_0445:
                ...
                Label_0439: {
                    if (!r) {
                        if (n9 == 0) {
                            ...
                            final int n10 = (equalsIgnoreCase3 = this.a.W.equalsIgnoreCase(eb.z[0])) ? 1 : 0;
                            if (r || n10 == 0) {
                                final int n11;
                                if (!r) {
            ...
            int n12 = 17;
            equalsIgnoreCase4 = (this.a.W.equalsIgnoreCase(eb.z[2]) ? 1 : 0);
            if (r) {
                continue;
            }
            break;
            ...
            Label_0605: {
                if (!r) {
                    if (equalsIgnoreCase4 == 0) {
                        final boolean equalsIgnoreCase5 = this.a.W.equalsIgnoreCase(eb.z[0]);
                        if (r) {
                            break Label_0719;
                        }
    ...
    public Insets getInsets() {
        ...
        if (!r) {
            ...
            b2 = (equalsIgnoreCase = this.a.W.equalsIgnoreCase(eb.z[2]));
        }
        if (!r) {
            if (b) {
                return new Insets(1, 72, 1, 1);
            }
            b2 = this.a.W.equalsIgnoreCase(eb.z[0]);
        }
        if (b2) {
    ...
    public void c(final int b) {
            ...
            if (b2) {
                ...
                Label_0236: {
                    if (!r) {
                        ...
                        s2 = String.valueOf(s2) + eb.z[10] + k + eb.z[8];
                        if (r) {
                            break Label_0236;
                        }
                    }
        ...
        ((db)y).b.requestFocus();
        this.a.q(String.valueOf(((db)component).e) + eb.z[7] + this.a.n + eb.z[9] + this.a.Bb);
        this.a.e();
    }
    ...
    static {
        ...
        final int n10 = 3;
        final char[] charArray4 = " \u0012z\u0018\u0012\u0000".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "1\to\u0018\b\u001e".toCharArray();
        ...
        final int n19 = 6;
        final char[] charArray7 = "'\u0007y<\b\u0003\u0013k".toCharArray();
        ...
        final int n28 = 9;
        final char[] charArray10 = "S;;LG".toCharArray();
