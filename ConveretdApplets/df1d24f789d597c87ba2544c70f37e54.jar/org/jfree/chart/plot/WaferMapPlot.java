...
public class WaferMapPlot extends Plot implements RendererChangeListener, Cloneable, Serializable
{
    ...
    public void draw(final Graphics2D g2, final Rectangle2D plotArea, final PlotState state, final PlotRenderingInfo info) {
    ...
    private void drawChipGrid(final Graphics2D g2, final Rectangle2D plotArea) {
    ...
    private Ellipse2D getWaferEdge(final Rectangle2D plotArea) {
    ...
    private void drawWaferEdge(final Graphics2D g2, final Rectangle2D plotArea) {
