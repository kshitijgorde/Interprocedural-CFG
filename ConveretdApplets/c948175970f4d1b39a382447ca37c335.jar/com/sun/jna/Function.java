...
public class Function extends Pointer
{
    ...
    Object invoke(final Object[] args, final Class returnType, final boolean allowObjects) {
        ...
        if (returnType == null || returnType == Void.TYPE || returnType == ((Function.class$java$lang$Void == null) ? (Function.class$java$lang$Void = class$("java.lang.Void")) : Function.class$java$lang$Void)) {
            ...
            if (((Function.class$com$sun$jna$Pointer == null) ? (Function.class$com$sun$jna$Pointer = class$("com.sun.jna.Pointer")) : Function.class$com$sun$jna$Pointer).isAssignableFrom(returnType)) {
                return this.invokePointer(this.callFlags, args);
            }
            if (((Function.class$com$sun$jna$Structure == null) ? (Function.class$com$sun$jna$Structure = class$("com.sun.jna.Structure")) : Function.class$com$sun$jna$Structure).isAssignableFrom(returnType)) {
