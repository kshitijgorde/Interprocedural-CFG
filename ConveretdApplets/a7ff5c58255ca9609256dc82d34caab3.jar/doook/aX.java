    ...
    public void init() {
        ...
        if (parameter6 != null && parameter7 != null) {
            try {
                ...
                mediaTracker.addImage(this.n = this.getImage(url), 0);
        ...
        try {
            if (parameter3 != null) {
                bi.au = Integer.parseInt(parameter3);
            }
        }
        catch (NumberFormatException ex7) {}
        try {
            if (parameter4 != null) {
                bi.av = Integer.parseInt(parameter4);
            }
        }
        ...
        try {
            ...
            if (parameter13 != null) {
                bi.as = Integer.parseInt(parameter13);
            }
            final String parameter14 = this.getParameter(bi.ae ? "width" : "WindowWidth");
            if (parameter14 != null) {
                bi.at = Integer.parseInt(parameter14);
            }
        }
