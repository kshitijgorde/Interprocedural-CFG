...
public abstract class b extends Container implements ActionListener, ItemListener, c
{
    ...
    public b(final a w, final String ae) {
        ...
        this.W = w;
        this.aE = ae;
        (this.aw = (a.a.a.a.c.a.a)this.W.try("statemachine")).a(this);
        this.appContext = ((Applet)this.W.try("applet")).getAppletContext();
    ...
    public void q() {
        ...
        this.ar = (b ? 1 : 0);
        this.as = (b ? 1 : 0);
        this.al = (Color)this.W.try("param/backgroundColor");
        this.an = (boolean)this.W.try("param/enableZoomPastMax");
        this.Y = (boolean)this.W.try("param/showHotspots");
        this.ae = (Color)this.W.try("param/hotspotColor");
        ...
        this.aA = this.W.byte("resource/button.height");
        this.V = this.W.byte("resource/button.width");
        ...
        this.aw = (a.a.a.a.c.a.a)this.W.try("statemachine");
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (!trim.equals("separator")) {
                ...
                if (trim3.equals("state")) {
                    ...
                    vector6.addElement(this.W.try("command/state/" + trim2));
                    ...
                    vector6.addElement(this.W.try("command/action/" + trim2));
        ...
        final Point point = (Point)this.W.try("param/logopos");
        if (point == null) {
            this.au = 0;
            this.am = this.V + 10;
            this.N = this.au;
            ...
            switch (keyEvent.getID()) {
                case 401: {
                    switch (keyEvent.getKeyCode()) {
                        case 33:
                        case 65: {
                            ((a.a.a.a.b.a)this.W.try("command/action/zoomin")).a();
                            break Label_0284;
                        }
                        case 34:
                        case 90: {
                            ((a.a.a.a.b.a)this.W.try("command/action/zoomout")).a();
                            break Label_0284;
                        }
                        case 86: {
                            ((a.a.a.a.b.a)this.W.try("command/action/reset")).a();
                            break Label_0284;
                        }
                        case 73:
                        case 112: {
                            ((a.a.a.a.b.a)this.W.try("command/action/info")).a();
                            break Label_0284;
                        }
                        case 77: {
                            ((a.a.a.a.b.a)this.W.try("command/state/magnifier")).a();
                            break Label_0284;
                        }
                        case 84: {
                            ((a.a.a.a.b.a)this.W.try("command/state/toolbar")).a();
                            break Label_0284;
                        }
                        case 72: {
                            ((a.a.a.a.b.a)this.W.try("command/state/hotspots")).a();
                            break Label_0284;
                        }
                    }
                    break;
    ...
    public void processMouseEvent(final MouseEvent mouseEvent) {
        if (mouseEvent.isPopupTrigger() && !this.H) {
            ...
            this.setCursor((Cursor)this.W.try("cursor/default"));
        }
        else {
    ...
    public void t() {
        final a.a.a.a.d.a a = (a.a.a.a.d.a)this.W.try("applet");
        a.if("player start()");
        if (this.ah == null) {
            this.d();
            a.for("player start2()");
