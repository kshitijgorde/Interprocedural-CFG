...
public final class bN extends Panel implements MouseListener
{
    ...
    public bN(final aa q, final bs q2, final j q3) {
        this.setLayout(null);
        this.q = q;
        this.q = q3;
        this.q = q2.q("mb", 0, 0);
    ...
    static bs q(final bN bn) {
        return bn.q;
    }
    
    static void q(final bN bn) {
        bn.e();
    }
