...
public class h
{
    ...
    public void if(final ae byte1) throws Exception {
        this.K = 0;
        this.J = false;
    ...
    public aj a(final int do1, final int if1, final int a, final int new1) throws Exception {
        final aj aj = new aj();
        aj.do = do1;
        aj.if = if1;
        aj.a = a;
        aj.new = new1;
        aj.int = a * new1 * 2;
        aj.for = this.int(aj.int * do1 * if1);
        return aj;
    }
    
    public int a(final aj aj, final int n, final int n2) throws Exception {
        if (n >= aj.do) {
            this.do(-229);
        }
        if (n2 >= aj.if) {
        ...
        return n * aj.int + n2 * (aj.int * aj.do);
    }
    ...
    int if(final int n, final int n2) {
        return (n < br.E[n2]) ? (n + br.byte[n2]) : n;
    }
                ...
                for (k = 1; k < 64; ++k) {
                    ...
                    if (n7 != 0) {
                        if (n6 != 0) {
                            ...
                            if (k < n5) {
                                for (int l = (n6 < n5 - k) ? n6 : (n5 - k), n8 = k; l != 0; --l, ab[br.o[n8++] + n3] = 0) {}
                            }
                            k += n6;
                        }
                        ab[br.o[k] + n3] = (short)(this.if(this.if(n7), n7) * array[k]);
                    }
                    else {
                        if (n6 != 15) {
                            break;
                        ...
                        if (k < n5) {
                            for (int n9 = (16 < n5 - k) ? 16 : (n5 - k), n10 = k; n9 != 0; --n9, ab[br.o[n10++] + n3] = 0) {}
                        }
                        k += 15;
                    }
                }
                if (k < n5) {
                    for (int n11 = k; n11 < n5; ab[br.o[n11++] + n3] = 0) {}
                }
                this.n[n] = k;
                ++n;
            }
    ...
    public void a(final ae ae) throws Exception {
        this.if(ae);
        this.z();
    }
    ...
    public int a(final a a) throws Exception {
        int i = a.if[(int)(this.new >> 8 & 0xFFL)];
        if (i < 0) {
            this.if(8);
            do {
                i = a.a[~i + (1 - this.if(1))];
