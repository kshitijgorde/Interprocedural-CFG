...
public class TraceManager
{
    ...
    public void fireTraceEvent(final ElemTemplateElement styleNode) {
        if (this.hasTraceListeners()) {
            ...
            final Node source = this.getDOMNodeFromDTM(sourceNode);
    ...
    private Node getDOMNodeFromDTM(final int sourceNode) {
        final DTM dtm = this.m_transformer.getXPathContext().getDTM(sourceNode);
