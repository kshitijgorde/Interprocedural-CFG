...
public class vl extends vm
{
    ...
    public vl(final String d, final String e, final String f, final String g, final String h, final String i, final String j, final String k, final String l, final String m, final String n) {
        this.d = "";
        this.e = "";
        this.f = "";
        this.g = "";
