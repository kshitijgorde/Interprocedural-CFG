...
public class DataPanel extends JPanel
{
    ...
    public JLabel JOutputLabel(final String s, final String s2, final int n) {
        JLabel label;
        if (s2 == null) {
            label = new JLabel(String.valueOf(s) + " ", n);
        }
        else {
            label = new ClickLabel(String.valueOf(s) + " ", n);
    ...
    public void addRow(final Nbr nbr, final Slider slider, final Font font, final int n) {
        final JLabel jOutputLabel = this.JOutputLabel(nbr.getName(), nbr.getHover(), this.iAlign);
        this.c.gridx = 0;
        this.c.gridy = n;
        this.c.weightx = 1.0;
        this.c.gridwidth = 3;
    ...
    public void addRow(final String s, final Font font, final JComponent component, final JComponent component2, final Font font2, final int n) {
        this.addRow(this.JOutputLabel(s, this.iAlign), font, component, component2, font2, n);
    }
    ...
    public void addRow(final String s, final JComponent component, final String s2, final JComponent component2, final Font font, final int n) {
        this.addRow(this.JOutputLabel(s, this.iAlign), component, this.JOutputLabel(s2, this.iAlign), component2, font, n);
    }
