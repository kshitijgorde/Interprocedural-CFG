...
public class ValueAxis extends Axis
{
    ...
    public String getProperty() {
        return String.valueOf(super._bUseTextImages) + "|" + super._bShow + "|" + this._iFormat + "|" + this._bDescending + "|" + this._bAutoMaximum + "|" + this._bAutoMinimum + "|" + Fmt.number(this._axisMinimum, 2) + "|" + Fmt.number(this._axisMaximum, 2);
    }
