...
final class b extends ay implements aA
{
        ...
        switch (q.id) {
            ...
            case 501: {
                if (q.metaDown()) {
                    ...
                    if (bg.q(this.w) && q2 < bg.w(this.w).size() && arg != null && arg.q instanceof bX) {
                        if (bg.q(this.w).q((Object)arg.q)) {
                            bg.q(this.w).w(arg.q);
                        }
                        else {
                            bg.q(this.w).q((bX)arg.q);
                        }
                    }
                    this.repaint();
                    if (q.clickCount < 2) {
    ...
    public b(final bg w, final bg q) {
        this.w = w;
        this.q = false;
        this.q = -1;
        this.q = q;
