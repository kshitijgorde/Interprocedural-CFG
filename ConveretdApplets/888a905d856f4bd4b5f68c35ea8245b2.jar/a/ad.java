...
public class ad extends Canvas implements bf
{
    public String q;
    private String w;
    private String e;
    ...
    public final void w() {
        ...
        if ((parent = this.getParent()) instanceof as) {
            ((as)parent).q(true, true);
        }
    }
    ...
    public boolean isShowing() {
        return (cK.w && cK.w == 1) || super.isShowing();
    }
    ...
    public ad(final int n, final int n2) {
        this(null, n, n2);
    }
    
    public ad(final String s, final int n, int e) {
        this.r = false;
        this.r = bC.w.c();
        this.r = 20;
        this.q = null;
        ...
        this.e = this.getFontMetrics(cb.w).getHeight() + 7;
        this.q(s);
        this.setFont(cb.w);
    ...
    public ad(final String s) {
        this(s, 22, 22);
        this.resize(this.getFontMetrics(cb.w).stringWidth(s) + 20, this.e);
    }
