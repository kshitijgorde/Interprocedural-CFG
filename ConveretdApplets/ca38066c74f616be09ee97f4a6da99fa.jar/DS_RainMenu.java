...
public class DS_RainMenu extends Applet implements Runnable
{
    Thread _fld0;
    int _fld1;
    Font _fld3;
    ...
    void _mth4() {
        String parameter = this.getParameter("numraindrop");
        if (parameter == null) {
            parameter = "1000";
        }
    ...
    void _mth7() {
        ...
        for (int i = 0; i < this._fld6d; ++i) {
            this._fld1e[i] = 2 + this._fld7d * 2 + (int)(Math.random() * 8.0);
            this._fld9d[i] = (int)(Math.random() * this._fld4);
            this._fld0e[i] = (int)(Math.random() * this._fld5);
            this._fld2e[i] = (0xFF000000 | (48 + (int)(Math.random() * 70.0)) * 65793);
            this._fld3e[i] = false;
        }
    }
    ...
    void _mth7b() {
        ...
        for (int j = 0; j < this._fld6d; j += 2) {
            this._fld0e[j] += this._fld1e[j];
            if (this._fld0e[j] >= this._fld5 - 3) {
                if (j < this._fld8d) {
                    this._fld3e[j] = true;
                }
                else {
            ...
            if (this._fld3e[j]) {
                ...
                this._fld7[(this._fld0e[j] + 1) * this._fld4 + this._fld9d[j]] = this._fld2e[j] + 526344;
                this._fld7[(this._fld0e[j] + 2) * this._fld4 + this._fld9d[j]] = this._fld2e[j] + 1052688;
                this._fld7[(this._fld0e[j] + 3) * this._fld4 + this._fld9d[j]] = this._fld2e[j] + 1579032;
            }
        }
        for (int k = 1; k < this._fld6d; k += 2) {
            this._fld0e[k] += this._fld1e[k];
            if (this._fld0e[k] >= this._fld5 - 5) {
                if (k < this._fld8d) {
                    this._fld3e[k] = true;
                }
                else {
            ...
            if (this._fld3e[k]) {
                ...
                this._fld7[(this._fld0e[k] + 1) * this._fld4 + this._fld9d[k]] = this._fld2e[k] + 526344;
                this._fld7[(this._fld0e[k] + 2) * this._fld4 + this._fld9d[k]] = this._fld2e[k] + 1052688;
                this._fld7[(this._fld0e[k] + 3) * this._fld4 + this._fld9d[k]] = this._fld2e[k] + 1579032;
                this._fld7[(this._fld0e[k] + 4) * this._fld4 + this._fld9d[k]] = this._fld2e[k] + 2105376;
                this._fld7[(this._fld0e[k] + 5) * this._fld4 + this._fld9d[k]] = this._fld2e[k] + 2631720;
            }
        }
    }
