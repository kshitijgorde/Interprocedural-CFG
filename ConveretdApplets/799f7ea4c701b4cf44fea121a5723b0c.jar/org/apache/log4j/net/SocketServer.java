...
public class SocketServer
{
    ...
    LoggerRepository configureHierarchy(final InetAddress inetAddress) {
        ...
        if (configFile.exists()) {
            final Hierarchy h = new Hierarchy(new RootLogger((Level)Priority.DEBUG));
    ...
    static {
        ...
        SocketServer.cat = Logger.getLogger((SocketServer.class$org$apache$log4j$net$SocketServer == null) ? (SocketServer.class$org$apache$log4j$net$SocketServer = class$("org.apache.log4j.net.SocketServer")) : SocketServer.class$org$apache$log4j$net$SocketServer);
    }
}
