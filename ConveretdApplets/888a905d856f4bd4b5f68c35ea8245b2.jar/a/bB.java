...
public final class bB extends Panel
{
    ...
    public final Dimension preferredSize() {
        ...
        final FontMetrics fontMetrics = this.getFontMetrics(bB.q);
        ...
        final Dimension dimension = new Dimension(Math.max(preferredSize.width, bC.w.y), preferredSize.height);
    ...
    public bB(final int t, final int y, final int i, final int u, final int e, final cs q, final boolean q2) {
        this.q = 12;
    ...
    public bB(final int n, final int n2, final int n3, final int n4, final int n5, final cs cs) {
        this(2, 10, 2, 10, n5, cs, false);
    }
    
    public bB(final cs cs, final boolean b) {
        this(4, 4, 4, 4, 1, cs, b);
    }
