...
public class ptviewer extends Applet implements Runnable
{
    ...
    protected void CheckHorizonPosition() {
        ...
        if (this.pheight != this.pwidth >> 1) {
            final double n = this.pheight / this.pwidth * 180.0;
            final double n2 = this.deltaYHorizonPosition / this.pwidth * 180.0;
            this.pitch_min = this.pitch_min_org;
            this.pitch_max = this.pitch_max_org;
            if (this.pitch_max > n - n2) {
                this.pitch_max = n - n2;
            }
            if (this.pitch_min < -n - n2) {
                this.pitch_min = -n - n2;
            }
        }
    }
    ...
    public synchronized void paint(final Graphics graphics) {
        ...
        if (this.inited) {
            ...
            if (this.panning) {
                ...
                final double n7 = (this.newx - this.oldx) * this.mouseSensitivity;
                final double oldspeedx = (0.3 * n7 * n7 * ((this.newx <= this.oldx) ? -1.0 : 1.0) + this.MASS * this.oldspeedx) / (1.0 + this.MASS);
                this.oldspeedx = oldspeedx;
                final double n8 = (this.oldy - this.newy) * this.mouseSensitivity;
                final double oldspeedy = (0.3 * n8 * n8 * ((this.oldy <= this.newy) ? -1.0 : 1.0) + this.MASS * this.oldspeedy) / (1.0 + this.MASS);
                this.oldspeedy = oldspeedy;
                double n9 = n6 * oldspeedx;
                double n10 = n6 * oldspeedy;
                if (this.mousePanTime > 0.0 && this.lastPanningPaintTime > 0L) {
                    final double n11 = 360.0 / Math.sqrt(n9 * n9 + n10 * n10) * this.lastPanningPaintTime / 1000.0;
                    if (n11 < this.mousePanTime) {
                        n9 = n9 * n11 / this.mousePanTime;
                        n10 = n10 * n11 / this.mousePanTime;
                    }
                }
                this.gotoView(this.yaw + n9, this.pitch + n10, this.hfov * this.zoom);
            }
            if (this.lastframe > this.frames) {
            ...
            if (this.dirty) {
                ...
                if (this.app_properties.size() == 6 && this.filename != null && this.filename.toLowerCase().endsWith(".mov")) {
                    ...
                    for (int n12 = 0; n12 < this.app_properties.size(); ++n12) {
                        final Applet applet2;
                        if ((applet2 = this.applets.get(this.app_properties.elementAt(n12))) != null && this.sender != null && this.sender.get(applet2) != null) {
                ...
                if (this.dirty && this.show_pdata) {
                    ...
                    if (this.antialias && this.scaledPanos != null) {
                        final double n13 = this.hfov / (this.vwidth * 360.0 * this.max_oversampling);
                        int n14 = 0;
                        for (int length = this.pdata[0].length; length * n13 > 1.0; length >>= 1) {
                            ++n14;
                        }
                        if (this.scaledPanos.elementAt(n14) != null) {
                            pdata = (int[][])this.scaledPanos.elementAt(n14);
                    ...
                    switch (this.quality) {
                        ...
                        case 6: {
                            if (this.panning || this.lastframe > this.frames || this.keyPanning) {
                                ...
                                boolean b2 = false;
                                if (this.panning) {
                                    final int n16 = this.newx - this.oldx;
                                    final int n17 = this.newy - this.oldy;
                                    final int n18 = (int)(n16 * (this.mouseSensitivity / this.mouseQ6Threshold));
                                    final int n19 = (int)(n17 * (this.mouseSensitivity / this.mouseQ6Threshold));
                                    if (Math.abs(n18) * this.vwidth / 1024 > n15) {
                                        b2 = true;
                                    }
                                    if (Math.abs(n19) * this.vheight / 768 > n15) {
                                        b2 = true;
                                    }
                                }
    ...
    String DisplayHSCoordinates(final int n, final int n2) {
        ...
        final double[] array = math_view2pano = this.math_view2pano(n, n2, this.vwidth, this.vheight, this.pwidth, this.pheight - this.deltaYHorizonPosition, this.yaw, this.pitch, this.hfov);
    ...
    void ReadParameters(final String s) {
        ...
        if (this.showToolbar) {
            ...
            if ((myGetParameter34 = this.myGetParameter(s, "toolbarBoldText")) != null && myGetParameter34.equalsIgnoreCase("true")) {
                ((toolbar)this.tlbObj).setMsgBold(true);
            }
        }
        final String myGetParameter35;
        if ((myGetParameter35 = this.myGetParameter(s, "mouseSensitivity")) != null) {
            this.mouseSensitivity = Double.valueOf(myGetParameter35);
        }
        final String myGetParameter36;
        if ((myGetParameter36 = this.myGetParameter(s, "mouseQ6Threshold")) != null) {
            this.mouseQ6Threshold = Double.valueOf(myGetParameter36);
        }
        final String myGetParameter37;
        if ((myGetParameter37 = this.myGetParameter(s, "mousePanTime")) != null) {
            this.mousePanTime = Double.valueOf(myGetParameter37);
        }
        final String myGetParameter38;
        if ((myGetParameter38 = this.myGetParameter(s, "wait")) != null) {
            this.dwait = null;
            this.dwait = this.loadImage(myGetParameter38);
            this.update(this.getGraphics());
        }
        final String myGetParameter39;
        if ((myGetParameter39 = this.myGetParameter(s, "auto")) != null) {
            this.autopan = Double.valueOf(myGetParameter39);
        }
        if (this.autopan != 0.0) {
            final String myGetParameter40;
            if ((myGetParameter40 = this.myGetParameter(s, "autoTime")) != null) {
                this.autopanFrameTime = this.ComputeAutoTimeFrame(this.autopan, Double.valueOf(myGetParameter40));
            }
            final String myGetParameter41;
            if ((myGetParameter41 = this.myGetParameter(s, "autoNumTurns")) != null) {
                this.autoNumTurns = Double.valueOf(myGetParameter41);
            }
        }
        final String myGetParameter42;
        if ((myGetParameter42 = this.myGetParameter(s, "mousehs")) != null) {
            this.MouseOverHS = myGetParameter42;
        }
        final String myGetParameter43;
        if ((myGetParameter43 = this.myGetParameter(s, "getview")) != null) {
            this.GetView = myGetParameter43;
        }
        final String myGetParameter44;
        if ((myGetParameter44 = this.myGetParameter(s, "frame")) != null) {
            this.frame = null;
            this.frame = this.loadImage(myGetParameter44);
        }
        final String myGetParameter45;
        if ((myGetParameter45 = this.myGetParameter(s, "waittime")) != null) {
            this.waittime = Integer.parseInt(myGetParameter45);
        }
        final String myGetParameter46;
        if ((myGetParameter46 = this.myGetParameter(s, "hsimage")) != null) {
            this.hs_image = myGetParameter46;
        }
        final String myGetParameter47;
        if ((myGetParameter47 = this.myGetParameter(s, "pwidth")) != null) {
            this.pwidth = Integer.parseInt(myGetParameter47);
        }
        final String myGetParameter48;
        if ((myGetParameter48 = this.myGetParameter(s, "pheight")) != null) {
            this.pheight = Integer.parseInt(myGetParameter48);
        }
        final String myGetParameter49;
        if ((myGetParameter49 = this.myGetParameter(s, "loadAllRoi")) != null && myGetParameter49.equalsIgnoreCase("false")) {
            this.loadAllRoi = false;
        }
        final String myGetParameter50;
        if ((myGetParameter50 = this.myGetParameter(s, "file")) != null) {
            this.filename = myGetParameter50;
        }
        final String myGetParameter51;
        if ((myGetParameter51 = this.myGetParameter(s, "order")) != null) {
            this.order = myGetParameter51;
        }
        final String myGetParameter52;
        if ((myGetParameter52 = this.myGetParameter(s, "oversampling")) != null) {
            this.max_oversampling = Double.valueOf(myGetParameter52);
        }
        for (int i = 0; i <= this.hotspots.size(); ++i) {
            final String myGetParameter53;
            if ((myGetParameter53 = this.myGetParameter(s, "hotspot" + i)) != null) {
                if (i < this.hotspots.size()) {
                    this.hotspots.setSize(i);
                }
                this.hotspots.addElement(myGetParameter53);
            }
        }
        this.numroi = 0;
        int n;
        ...
        if (n > 0) {
            ...
            for (int j = 0; j < this.numroi; ++j) {
                ...
                if ((myGetParameter54 = this.myGetParameter(s, "roi" + j)) != null) {
                    this.ParseROILine(myGetParameter54, j);
                }
            }
        }
        for (int k = 0; k <= this.shotspots.size(); ++k) {
            final String myGetParameter55;
            if ((myGetParameter55 = this.myGetParameter(s, "shotspot" + k)) != null) {
                if (k < this.shotspots.size()) {
                    this.shotspots.setSize(k);
                }
                this.shotspots.addElement(myGetParameter55);
            }
        }
        for (int l = 0; l <= this.sounds.size(); ++l) {
            final String myGetParameter56;
            if ((myGetParameter56 = this.myGetParameter(s, "sound" + l)) != null) {
                if (l < this.sounds.size()) {
                    this.sounds.setSize(l);
                }
                this.sounds.addElement(myGetParameter56);
            }
        }
        for (int size = 0; size <= this.app_properties.size(); ++size) {
            final String myGetParameter57;
            if ((myGetParameter57 = this.myGetParameter(s, "applet" + size)) != null) {
                if (size < this.app_properties.size()) {
                    this.stopApplets(size);
                    this.app_properties.setSize(size);
                }
                this.app_properties.addElement(myGetParameter57);
            }
        }
        final String myGetParameter58;
        if ((myGetParameter58 = this.myGetParameter(s, "dynLoadROIs")) != null && myGetParameter58.equalsIgnoreCase("true")) {
            this.dynLoadROIs = true;
        }
        final String myGetParameter59;
        if ((myGetParameter59 = this.myGetParameter(s, "hsShowDescrInStatusBar")) != null && myGetParameter59.equalsIgnoreCase("false")) {
            this.hsShowDescrInStatusBar = false;
        }
        final String myGetParameter60;
        if ((myGetParameter60 = this.myGetParameter(s, "hsEnableVisibleOnly")) != null && myGetParameter60.equalsIgnoreCase("true")) {
            this.hsEnableVisibleOnly = true;
        }
        final String myGetParameter61;
        if ((myGetParameter61 = this.myGetParameter(s, "shsEnableVisibleOnly")) != null && myGetParameter61.equalsIgnoreCase("true")) {
            this.shsEnableVisibleOnly = true;
        }
        final String myGetParameter62;
        if ((myGetParameter62 = this.myGetParameter(s, "shsStopAutoPanOnClick")) != null && myGetParameter62.equalsIgnoreCase("false")) {
            this.shsStopAutoPanOnClick = false;
        }
        final String myGetParameter63;
        if ((myGetParameter63 = this.myGetParameter(s, "popup_panning")) != null && myGetParameter63.equalsIgnoreCase("true")) {
            this.popupPanning = true;
        }
        final String myGetParameter64;
        if ((myGetParameter64 = this.myGetParameter(s, "imgLoadFeedback")) != null && myGetParameter64.equalsIgnoreCase("false")) {
            this.imgLoadFeedback = false;
        }
        final String myGetParameter65;
        if ((myGetParameter65 = this.myGetParameter(s, "outOfMemoryURL")) != null) {
            this.outOfMemoryURL = myGetParameter65;
        }
        final String myGetParameter66;
        if ((myGetParameter66 = this.myGetParameter(s, "authoringMode")) != null && myGetParameter66.equalsIgnoreCase("true")) {
            this.authoringMode = true;
        }
        final String myGetParameter67;
        if ((myGetParameter67 = this.myGetParameter(s, "horizonposition")) != null) {
            this.horizonPosition = Integer.parseInt(myGetParameter67);
        }
        final String myGetParameter68;
        if ((myGetParameter68 = this.myGetParameter(s, "statusMessage")) != null) {
            this.statusMessage = myGetParameter68;
        }
    }
    ...
    String extractParameter(final String s, final String s2) {
        ...
        while ((index2 = s.indexOf(123, index)) >= 0 && (index = s.indexOf(125, index2)) >= 0) {
            ...
            if (stripWhiteSpace.toUpperCase().startsWith(String.valueOf(upperCase) + "=")) {
            ...
            switch (s.charAt(i++)) {
                ...
                case 'x': {
                    ...
                    if (this.shs_x1[n] < 0) {
                        ...
                        shs_x1[n] += ((this.vwidth == 0) ? this.getSize().width : this.vwidth);
                        continue;
                    }
                    continue;
                }
                case 'y': {
                    ...
                    if (this.shs_y1[n] < 0) {
                        ...
                        shs_y1[n] += ((this.vheight == 0) ? this.getSize().height : this.vheight);
                        continue;
                    }
                    continue;
                }
                case 'a': {
                    ...
                    if (this.shs_x2[n] < 0) {
                        ...
                        shs_x2[n] += ((this.vwidth == 0) ? this.getSize().width : this.vwidth);
                        continue;
                    }
                    continue;
                }
                case 'b': {
                    ...
                    if (this.shs_y2[n] < 0) {
                        ...
                        shs_y2[n] += ((this.vheight == 0) ? this.getSize().height : this.vheight);
                        continue;
                    }
                    continue;
                }
    ...
    final void math_extractview(final int[][] array, final int[] array2, final byte[] array3, final int n, final double n2, final double n3, final double n4, final boolean b, final boolean b2) {
        ...
        this.math_transform(array, array[0].length, array.length + this.deltaYHorizonPosition, array2, array3, n, array2.length / n, b, b2);
    }
    ...
    final void math_transform(final int[][] array, final int n, final int n2, final int[] array2, final byte[] array3, final int n3, final int n4, final boolean b, final boolean b2) {
        ...
        final int n5 = n - 1;
        final int n6 = n2 - this.deltaYHorizonPosition - 1;
        final int n7 = n3 - 1 >> 1;
        final int n8 = n4 >> 1;
        final int n9 = n >> 1;
        final int n10 = n2 >> 1;
                ...
                for (int n46 = 0; n46 < n36; ++n46) {
                    ...
                    while (n50 <= n12) {
                        ...
                        for (int n57 = 0; n57 < n40 && n50 <= n12; ++n50, n55 += n53, ++n57) {
                            ...
                            final int n62 = (n56 >> 8) + n10 - this.deltaYHorizonPosition;
                            int[] array14 = null;
                            if (b3) {
                                int n63;
                                if (n59 < 128) {
                            ...
                            if (n61 == 0) {
                                ...
                                if (n61 == 0) {
                                    if (b3) {
                                        ...
                                        if (b2) {
                                            array2[n38] = this.lanczos2_interp_pixel(array, n, n2 - this.deltaYHorizonPosition, n64, n62, n58, n59);
                                        }
                                        else {
    ...
    final void hs_setCoordinates(final int n, final int n2, final int n3, final int n4, final double n5, final double n6, final double n7) {
        ...
        for (int i = 0; i < this.numhs; ++i) {
            ...
            final double n13 = this.pheight + 2 * n8 - (this.hs_yp[i] + n8 + this.deltaYHorizonPosition / 2 - n10);
