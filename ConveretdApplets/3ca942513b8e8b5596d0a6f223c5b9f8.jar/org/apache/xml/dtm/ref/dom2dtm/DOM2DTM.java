...
public class DOM2DTM extends DTMDefaultBaseIterators
{
    ...
    protected int addNode(final Node node, final int parentIndex, final int previousSibling, final int forceNodeType) {
        ...
        final ExpandedNameTable exnt = super.m_expandedNameTable;
            ...
            if (pos.hasChildNodes()) {
                ...
                if (5 != pos.getNodeType()) {
                    ...
                    if (null != super.m_wsfilter) {
                        final short wsv = super.m_wsfilter.getShouldStripSpace(this.makeNodeHandle(this.m_last_parent), this);
                ...
                while (this.m_last_parent != -1) {
                    ...
                    final SuballocatedIntVector parent = super.m_parent;
