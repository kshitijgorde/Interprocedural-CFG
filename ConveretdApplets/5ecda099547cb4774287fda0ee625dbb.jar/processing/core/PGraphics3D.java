...
public class PGraphics3D extends PGraphics
{
    ...
    public void endShape(final int n) {
        ...
        if (!this.hints[5]) {
            if (this.fill && this.triangleCount > 0) {
    ...
    protected void addPoint(final int n) {
        if (this.pointCount == this.points.length) {
            ...
            System.arraycopy(this.points, 0, points, 0, this.lineCount);
            this.points = points;
        }
        ...
        for (int i = n; i < n2; ++i) {
            ...
            if (PGraphics3D.s_enableAccurateTextures && this.frustumMode) {
                ...
                if (n3 > -1 && this.textures[n3] != null) {
                    ...
                    final float n4 = this.textures[n3].width;
                    final float n5 = this.textures[n3].height;
    ...
    private int sortTrianglesPartition(int n, int n2) {
        while (true) {
            if (this.sortTrianglesCompare(++n, n2) < 0.0f) {
                continue;
            }
            while (n2 != 0 && this.sortTrianglesCompare(--n2, n2) > 0.0f) {}
