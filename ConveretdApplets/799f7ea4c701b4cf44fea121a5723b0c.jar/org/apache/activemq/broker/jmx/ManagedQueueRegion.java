...
public class ManagedQueueRegion extends QueueRegion
{
    ...
    public ManagedQueueRegion(final ManagedRegionBroker broker, final DestinationStatistics destinationStatistics, final SystemUsage memoryManager, final TaskRunnerFactory taskRunnerFactory, final DestinationFactory destinationFactory) {
