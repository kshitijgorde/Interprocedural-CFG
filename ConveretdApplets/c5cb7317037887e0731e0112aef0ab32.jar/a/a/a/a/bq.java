...
public class bq extends Dialog
{
    ...
    private final String a = "ImmerVision PURE Player PRO for Java";
    private final String try = "http://www.immervision.com";
    Font for;
    Font if;
    Font do;
    Color byte;
    ...
    public bq(final Frame frame, final String s, final l int1, final String s2) {
        super(frame, false);
        ...
        final Label label = new Label("ImmerVision PURE Player PRO for Java " + s, 1);
