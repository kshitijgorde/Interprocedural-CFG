...
public abstract class MeterNeedle implements Serializable
{
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof MeterNeedle) {
            final MeterNeedle n = (MeterNeedle)object;
            final boolean b0 = ObjectUtils.equal(this.outlinePaint, n.outlinePaint);
            final boolean b2 = ObjectUtils.equal(this.outlineStroke, n.outlineStroke);
            final boolean b3 = ObjectUtils.equal(this.fillPaint, n.fillPaint);
            final boolean b4 = ObjectUtils.equal(this.highlightPaint, n.highlightPaint);
            final boolean b5 = this.size == n.size;
            final boolean b6 = this.rotateX == n.rotateX;
            final boolean b7 = this.rotateY == n.rotateY;
