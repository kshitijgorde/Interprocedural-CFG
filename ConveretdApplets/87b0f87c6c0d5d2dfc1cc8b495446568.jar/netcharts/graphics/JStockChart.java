...
public class JStockChart extends JComboChart
{
    ...
    public JStockChart(final Applet applet) {
        super(applet);
        this.f = new StringBuffer();
        this.initStockChart();
    }
    
    public JStockChart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
    ...
    protected void drawStock(final Graphics graphics, final NFDataSeries nfDataSeries) {
        ...
        if (nfStockInfo.a > 0) {
            ...
            a = (int)NFUtil.rint(JStockChart.c * n);
        }
        if (a < 1) {
            a = 1;
        }
        ...
        if (nfStockInfo.b > 0) {
            ...
            b = (int)NFUtil.rint(JStockChart.e * n);
        }
        for (int i = 0; i < size; ++i) {
            final NFStockData nfStockData = nfStockInfo.c.elementAt(i);
    ...
    protected synchronized void loadParams() throws Exception {
        ...
        if (super.param.changed("StockWidth")) {
            ...
            JStockChart.c = NFUtil.getNumber(vector, 0, JStockChart.b);
            if (JStockChart.c < 0.0) {
                JStockChart.c = 0.0;
            }
            else if (JStockChart.c > 1.0) {
                JStockChart.c /= 100.0;
                if (JStockChart.c > 1.0) {
                    JStockChart.c = 1.0;
                }
            }
            JStockChart.e = NFUtil.getNumber(vector, 1, JStockChart.d);
            if (JStockChart.e < 0.0) {
                JStockChart.e = 0.0;
            }
            else if (JStockChart.e > 1.0) {
                JStockChart.e /= 100.0;
                if (JStockChart.e > 1.0) {
                    JStockChart.e = 1.0;
                }
            }
        }
    ...
    static {
        JStockChart.b = 0.33;
        JStockChart.c = JStockChart.b;
        JStockChart.d = 0.0;
        JStockChart.e = JStockChart.d;
    }
}
