...
public class ClientApplet extends h
{
    ...
    public void init() {
        ...
        try {
            if (parameter != null) {
                background = cg.q(parameter);
            }
        }
        catch (NumberFormatException ex3) {}
        try {
            if (parameter3 != null) {
                foreground = cg.q(parameter3);
            }
        }
        ...
        bf.q(this.getParameter("font1"));
        bf.w(this.getParameter("font1b"));
        bf.e(this.getParameter("font2"));
        bf.r(this.getParameter("font2b"));
        this.add("Center", super.q = new cn(this, super.q, super.q.o == null, false, false, false, parameter7, parameter8, parameter2));
        super.q.validate();
        ...
        try {
            for (int i = 0; i < this.q.length; ++i) {
                this.q[i] = this.getImage(new URL(this.getCodeBase() + cg.q("\"5C?EB35CZCD1BCZCD1B/") + i + ".gif"));
                this.w[i] = this.getImage(new URL(this.getCodeBase() + cg.q("\"5C?EB35CZCD1DEC5CZCD1DEC/") + i + ".gif"));
            }
        }
        catch (Exception ex8) {}
    }
