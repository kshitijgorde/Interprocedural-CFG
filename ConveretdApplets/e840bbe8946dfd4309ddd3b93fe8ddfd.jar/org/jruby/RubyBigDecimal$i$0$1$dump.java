...
public class RubyBigDecimal$i$0$1$dump extends JavaMethodNBlock
{
    public RubyBigDecimal$i$0$1$dump(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block unusedBlock) {
        ...
        return ((RubyBigDecimal)rubyObject).dump(array, unusedBlock);
    }
}
