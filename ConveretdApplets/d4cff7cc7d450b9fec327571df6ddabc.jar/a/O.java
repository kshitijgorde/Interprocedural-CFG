...
public final class O extends Panel
{
    ...
    public O(final int n, final int n2, final TextArea q, final Color background) {
        this(null, 25, 25);
        this.q = q;
        this.t = true;
        if (AppletAbstract.q().q.q(69)) {
            ...
            this.q = new ah(q, canvas, new Color(238, 238, 238));
    ...
    private O(final String s, final int n, int e) {
        this.q = null;
        this.q = false;
        this.w = false;
        this.q = null;
    ...
    public final void paint(final Graphics graphics) {
        if (this.isShowing()) {
            ...
            if (!(this.getParent() instanceof d)) {
