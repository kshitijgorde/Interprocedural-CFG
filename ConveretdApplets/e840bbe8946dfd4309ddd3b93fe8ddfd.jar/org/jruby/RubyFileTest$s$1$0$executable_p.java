...
public class RubyFileTest$s$1$0$executable_p extends JavaMethodOne
{
    public RubyFileTest$s$1$0$executable_p(final RubyModule implementationClass, final Visibility visibility) {
