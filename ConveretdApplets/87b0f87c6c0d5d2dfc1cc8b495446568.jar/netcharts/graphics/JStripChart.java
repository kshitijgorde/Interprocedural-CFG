...
public class JStripChart extends JDataChart
{
    ...
    public JStripChart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
        this.labelBackgroundColor = null;
        this.undefString = JStripChart.UNDEF_STRING_DEFAULT;
        this.initialFill = JStripChart.INITIAL_FILL_DEFAULT;
        this.nslots = 11;
        this.displayslots = JStripChart.DISPLAY_SLOTS_DEFAULT;
        this.scrollSlots = -1;
        this.maxLookAhead = JStripChart.MAX_LOOK_AHEAD_DEFAULT;
    ...
    public JStripChart(final Applet applet) {
        this.labelBackgroundColor = null;
        this.undefString = JStripChart.UNDEF_STRING_DEFAULT;
        this.initialFill = JStripChart.INITIAL_FILL_DEFAULT;
        this.nslots = 11;
    ...
    private void a(final String s) {
        NFDebug.print(512L, "JStripChart: " + s);
    }
    ...
    protected void loadDataSetParams(final NFDataSeries nfDataSeries, final int n, final Object o) {
        ...
        final NFLine loadParams2 = NFLine.loadParams(super.param, vector, n2 + JStripChart.r);
        final Color fillColor = (Color)vector.elementAt(n2 + JStripChart.r + JStripChart.s);
    ...
    protected void appendNewData(final int n, final double n2) throws Exception {
        try {
            ...
            throw new Exception("JStripChart: appendNewData failed - DataSet probably not created " + ex);
        }
    }
    ...
    protected void defineParams() {
        ...
        JStripChart.r = super.param.defineGraphSymbol("DataSet", vector2);
        JStripChart.s = super.param.defineLine("DataSet", vector2);
    ...
    protected synchronized void loadParams() throws Exception {
        ...
        if (super.param.changed("StripLayout")) {
            ...
            displayslots = NFUtil.getNumber(vector, 0, JStripChart.DISPLAY_SLOTS_DEFAULT);
            this.initialFill = NFUtil.getNumber(vector, 1, JStripChart.INITIAL_FILL_DEFAULT);
            this.maxLookAhead = NFUtil.getNumber(vector, 2, JStripChart.MAX_LOOK_AHEAD_DEFAULT);
            this.undefString = NFUtil.getString(vector, 3, JStripChart.UNDEF_STRING_DEFAULT);
        }
    ...
    static {
        JStripChart.UNDEF_STRING_DEFAULT = "-";
        JStripChart.INITIAL_FILL_DEFAULT = 0;
        JStripChart.DISPLAY_SLOTS_DEFAULT = 11;
        JStripChart.MAX_LOOK_AHEAD_DEFAULT = 100;
    }
}
