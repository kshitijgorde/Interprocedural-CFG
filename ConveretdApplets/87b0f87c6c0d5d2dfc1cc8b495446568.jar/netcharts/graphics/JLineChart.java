...
public class JLineChart extends JDataChart
{
    ...
    public JLineChart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
        this.b = 1;
        this.c = this.b;
        this.d = 1;
        this.e = this.d;
    ...
    public JLineChart(final Applet applet) {
        this.b = 1;
        this.c = this.b;
        this.d = 1;
        this.e = this.d;
    ...
    protected synchronized void loadParams() throws Exception {
        ...
        for (int i = 0; i < super.axes.size(); ++i) {
            ...
            if (JDataChart.isXAxis(nfAxis) && !nfAxis.isScaleSpecified() && (nfAxis.autoscale || (ticLabels != null && ticLabels.size() > 0)) && a != 0) {
