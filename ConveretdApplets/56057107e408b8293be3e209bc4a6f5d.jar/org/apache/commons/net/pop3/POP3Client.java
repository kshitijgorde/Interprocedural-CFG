...
public class POP3Client extends POP3
{
    ...
    public boolean login(final String username, String timestamp, final String secret) throws IOException, NoSuchAlgorithmException {
        ...
        timestamp += secret;
        final byte[] digest = md5.digest(timestamp.getBytes());
        final StringBuffer digestBuffer = new StringBuffer(128);
    ...
    public boolean noop() throws IOException {
        return this.getState() == 1 && this.sendCommand(7) == POP3Reply.OK;
    }
    
    public boolean deleteMessage(final int messageId) throws IOException {
        return this.getState() == 1 && this.sendCommand(6, Integer.toString(messageId)) == POP3Reply.OK;
    }
    
    public boolean reset() throws IOException {
        return this.getState() == 1 && this.sendCommand(8) == POP3Reply.OK;
    }
