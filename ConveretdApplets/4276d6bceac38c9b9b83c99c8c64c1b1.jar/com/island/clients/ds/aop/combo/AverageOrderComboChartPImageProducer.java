...
import com.island.clients.ds.aop.AverageOrderChartPImage;
import com.island.servers.ds.chart.stockorder.OrderChartProducer;

public abstract class AverageOrderComboChartPImageProducer extends OrderChartProducer
{
    ...
    protected AverageOrderChartPImage orderChartProducer;
    ...
    public AverageOrderComboChartPImageProducer(final String symbol) {
        super(symbol);
        this.chartWidth = 500;
        ...
        this.maxStep = 10;
        (this.orderChartProducer = new AverageOrderChartPImage(symbol)).setIslandChartMessageOn(false);
    }
    ...
    public Image createChart() {
        ...
        if (this.orderChartData != null) {
            this.orderChartProducer.drawChart(g2D);
    ...
    public void setDeltaPrice(final float deltaPrice) {
        ...
        this.orderChartProducer.setDeltaPrice(deltaPrice);
        this.orderChartProducer.resetPriceRange();
    }
    ...
    public void setMaxStep(final int maxStep) {
        ...
        this.orderChartProducer.setMaxStep(maxStep);
    }
}
