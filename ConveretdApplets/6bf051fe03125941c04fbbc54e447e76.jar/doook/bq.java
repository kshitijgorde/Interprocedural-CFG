...
public class bq extends Panel
{
    ...
    private void u() {
        ...
        this.x = Toolkit.getDefaultToolkit().createImage(this.a);
        this.y = Toolkit.getDefaultToolkit().createImage(this.b);
        this.a.v = this.x;
        this.a.g = this.y;
    }
    ...
    private void setMode(final int az) {
        if (this.az == az && this.ai) {
            this.ai = true;
            return;
        }
        this.aj = true;
