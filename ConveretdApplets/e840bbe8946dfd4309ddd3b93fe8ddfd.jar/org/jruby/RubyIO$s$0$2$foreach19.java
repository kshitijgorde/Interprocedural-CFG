...
public class RubyIO$s$0$2$foreach19 extends JavaMethodNBlock
{
    public RubyIO$s$0$2$foreach19(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyIO.foreach19(context, recv, array, block);
    }
}
