...
public class a8 extends Canvas implements s
{
    private Image a;
    private Image b;
    private Image c;
    ...
    public static a8 a(final Image image, final Image image2, final Image image3) {
        return new a8(image, image2, image3, true);
    }
    ...
    private a8(final Image a, final Image b, final Image c, final boolean e) {
        this.d = false;
        this.e = true;
        this.f = true;
        this.g = false;
