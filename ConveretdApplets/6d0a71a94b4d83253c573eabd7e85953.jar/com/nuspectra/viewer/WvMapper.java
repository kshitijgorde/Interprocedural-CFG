...
public class WvMapper
{
    ...
    public String toString() {
        return "x=" + this.degMinX + "," + this.degMaxX + "=" + this.degRangeX + ", y=" + this.degMinY + "," + this.degMaxY + "=" + this.degRangeY + " baseRect=" + this.rectDebug(this.baseRect) + " pos(0)" + this.getPosX(0);
    }
    ...
    protected void mapRect(final WvScope wvscope, Rectangle rectangle) {
        ...
        final float pr = panMin - this.degMinX;
        final float tr = this.degMaxY - tiltMax;
        rectangle.x = Math.round(this.baseRect.width * pr / this.degRangeX);
        rectangle.y = Math.round(this.baseRect.height * tr / this.degRangeY);
    ...
    public int getWidth(final int i) {
        final int f1 = Math.round(this.baseRect.width / this.degRangeX) * i;
