        ...
        if (s != null) {
            for (int len = s.length(), i = 0; i < len; ++i) {
                ...
                if (65 <= ch && ch <= 90) {
                    ...
                    sbuf.append(URLUTF8Encoder.hex[ch]);
                }
                else if (ch <= 2047) {
                    sbuf.append(URLUTF8Encoder.hex[0xC0 | ch >> 6]);
                    sbuf.append(URLUTF8Encoder.hex[0x80 | (ch & 0x3F)]);
                }
                else {
                    sbuf.append(URLUTF8Encoder.hex[0xE0 | ch >> 12]);
                    sbuf.append(URLUTF8Encoder.hex[0x80 | (ch >> 6 & 0x3F)]);
                    sbuf.append(URLUTF8Encoder.hex[0x80 | (ch & 0x3F)]);
                }
            }
