...
public class RubyZlib$s$0$2$crc32 extends JavaMethodN
{
    public RubyZlib$s$0$2$crc32(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyZlib.crc32(recv, array);
    }
}
