...
public class RubyDir$s$0$1$mkdir19 extends JavaMethodN
{
    public RubyDir$s$0$1$mkdir19(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyDir.mkdir19(context, recv, array);
    }
}
