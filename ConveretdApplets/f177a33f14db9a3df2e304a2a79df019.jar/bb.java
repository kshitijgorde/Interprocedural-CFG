...
class bb extends y
{
    ...
    boolean a(final float[] array) {
        ...
        switch (this.D) {
            ...
            case 1004: {
                final int n2 = 1;
                array[n2] += this.c() * 4.0f;
                break;
            }
            case 54:
            case 1007: {
                final int n3 = 0;
                array[n3] += this.c() * 4.0f;
                break;
            }
            case 50:
            case 1005: {
                final int n4 = 1;
                array[n4] -= this.c() * 4.0f;
                break;
            }
            case 55: {
                final int n5 = 0;
                array[n5] -= this.c() * 4.0f;
                final int n6 = 1;
                array[n6] += this.c() * 4.0f;
                break;
            }
            case 49: {
                final int n7 = 0;
                array[n7] -= this.c() * 4.0f;
                final int n8 = 1;
                array[n8] -= this.c() * 4.0f;
                break;
            }
            case 57: {
                final int n9 = 0;
                array[n9] += this.c() * 4.0f;
                final int n10 = 1;
                array[n10] += this.c() * 4.0f;
                break;
            }
            case 51: {
                final int n11 = 0;
                array[n11] += this.c() * 4.0f;
                final int n12 = 1;
                array[n12] -= this.c() * 4.0f;
                break;
            }
            case 43:
            case 61:
