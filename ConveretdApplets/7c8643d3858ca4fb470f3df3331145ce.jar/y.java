...
class y extends Panel implements ActionListener, ComponentListener
{
                ...
                if (!r) {
                    if (index > 0) {
                        ...
                        Label_0210: {
                            if (!r) {
                                if (equalsIgnoreCase) {
                                    this.a.a(String.valueOf(this.a.ob) + " " + this.c + y.z[1] + this.a.L + " ", 1);
                                }
                                y = this;
                                if (r) {
                                    break Label_0210;
                            ...
                            if (equalsIgnoreCase) {
                                ...
                                if (this.a.zb.length() > 0) {
                                    this.a.a(String.valueOf(this.a.ob) + " " + this.c + y.z[0] + this.a.zb + " ", 1);
                                }
                            }
                            y = this;
                        }
    ...
    static {
        ...
        final int n4 = 1;
        final char[] charArray2 = "L\u0004¡C\u0007+\u001e".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "0P".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "?Qt~\"".toCharArray();
