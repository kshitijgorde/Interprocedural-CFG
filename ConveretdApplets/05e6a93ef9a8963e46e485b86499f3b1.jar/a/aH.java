...
public class aH extends Canvas implements ImageObserver
{
    private static P q;
    protected Image q;
    private URL q;
    ...
    public final void q(final int n, final int n2) {
        ...
        if (((size = this.size()).height != n2 || size.width != n) && n > 0 && n2 > 0) {
            ...
            aH ah;
            for (parent = this, ah = this; parent != null && !(ah instanceof Window); ah = (aH)parent, parent = ((aH)parent).getParent()) {
                ((aH)parent).invalidate();
            }
            ah.validate();
        }
    }
    ...
    public void update(final Graphics graphics) {
        if (this.w == null) {
            ...
            this.w = cs.q(this, width, height + 4, "bp.u-d");
        }
