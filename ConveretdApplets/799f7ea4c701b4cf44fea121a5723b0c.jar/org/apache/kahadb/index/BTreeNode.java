...
public final class BTreeNode<Key, Value>
{
    ...
    public Value remove(final Transaction tx, final Key key) throws IOException {
        if (this.isBranch()) {
            ...
            final Value oldValue = (Value)this.values[idx];
    ...
    public Value put(final Transaction tx, final Key key, final Value value) throws IOException {
        ...
        Value oldValue = null;
        if (idx >= 0) {
            oldValue = (Value)this.values[idx];
    ...
    private void split(final Transaction tx) throws IOException {
        ...
        if (this.isBranch()) {
            ...
            if (prefixer != null) {
                ...
                separator = (Key)this.keys[leftKeys.length];
            }
        }
        else {
            leftKeys = this.createKeyArray(pivot);
    ...
    public void printStructure(final Transaction tx, final PrintWriter out, final String prefix) throws IOException {
    ...
    public void visit(final Transaction tx, final BTreeVisitor<Key, Value> visitor) throws IOException {
        ...
        if (this.isBranch()) {
            for (int i = 0; i < this.children.length; ++i) {
                Key key1 = null;
                if (i != 0) {
                    key1 = (Key)this.keys[i - 1];
                }
                Key key2 = null;
                if (i != this.children.length - 1) {
                    key2 = (Key)this.keys[i];
                }
            ...
            visitor.visit(Arrays.asList((Key[])this.keys), Arrays.asList((Value[])this.values));
        }
    }
    ...
    public Map.Entry<Key, Value> getFirst(final Transaction tx) throws IOException {
        ...
        if (node.values.length > 0) {
            return new KeyValueEntry((Key)node.keys[0], (Value)node.values[0]);
        }
        return null;
    }
    ...
    public Map.Entry<Key, Value> getLast(final Transaction tx) throws IOException {
        ...
        if (node.values.length > 0) {
            ...
            return new KeyValueEntry((Key)node.keys[idx], (Value)node.values[idx]);
        }
        return null;
    }
            ...
            try {
                while (this.current != null) {
                    if (this.nextIndex < this.current.keys.length) {
                        this.nextEntry = new KeyValueEntry((Key)this.current.keys[this.nextIndex], (Value)this.current.values[this.nextIndex]);
                        ++this.nextIndex;
                        break;
                    }
