...
public class LoggingBrokerPlugin extends BrokerPluginSupport
{
    ...
    public void acknowledge(final ConsumerBrokerExchange consumerExchange, final MessageAck ack) throws Exception {
        if (this.isLogAll() || this.isLogConsumerEvents()) {
            ...
            if (LoggingBrokerPlugin.LOG.isTraceEnabled() && ack.getMessageCount() > 1) {
                LoggingBrokerPlugin.LOG.trace("Message count: " + ack.getMessageCount() + ", First Message Id: " + ack.getFirstMessageId() + ", Last Message Id: " + ack.getLastMessageId());
            }
        }
    ...
    public Response messagePull(final ConnectionContext context, final MessagePull pull) throws Exception {
        if (this.isLogAll() || this.isLogConsumerEvents()) {
            LoggingBrokerPlugin.LOG.info("Message Pull from : " + context.getClientId() + " on " + pull.getDestination().getPhysicalName());
        }
    ...
    public void commitTransaction(final ConnectionContext context, final TransactionId xid, final boolean onePhase) throws Exception {
        if (this.isLogAll() || this.isLogTransactionEvents()) {
            LoggingBrokerPlugin.LOG.info("Commiting transaction : " + xid.getTransactionKey());
        }
    ...
    public TransactionId[] getPreparedTransactions(final ConnectionContext context) throws Exception {
        ...
        if ((this.isLogAll() || this.isLogTransactionEvents()) && result != null) {
            ...
            LoggingBrokerPlugin.LOG.info("Prepared transactions : " + (Object)tids);
        }
        return result;
    }
    ...
    public void send(final ProducerBrokerExchange producerExchange, final Message messageSend) throws Exception {
        if (this.isLogAll() || this.isLogProducerEvents()) {
            LoggingBrokerPlugin.LOG.info("Sending message : " + messageSend.copy());
        }
    ...
    public Connection[] getClients() throws Exception {
        ...
        if (this.isLogAll() || this.isLogInternalEvents()) {
            if (result == null) {
                ...
                LoggingBrokerPlugin.LOG.info("Connected clients : " + (Object)cids);
            }
        }
    ...
    public ActiveMQDestination[] getDestinations() throws Exception {
        ...
        if (this.isLogAll() || this.isLogInternalEvents()) {
            if (result == null) {
                ...
                LoggingBrokerPlugin.LOG.info("Get Destinations : " + (Object)destinations);
            }
        }
        return result;
    }
    ...
    public BrokerInfo[] getPeerBrokerInfos() {
        ...
        if (this.isLogAll() || this.isLogInternalEvents()) {
            if (result == null) {
                ...
                LoggingBrokerPlugin.LOG.info("Get Peer Broker Infos : " + (Object)peers);
            }
        }
        return result;
    }
    ...
    public Set<ActiveMQDestination> getDurableDestinations() {
        ...
        if (this.isLogAll() || this.isLogInternalEvents()) {
            if (result == null) {
                ...
                LoggingBrokerPlugin.LOG.info("Get Durable Destinations : " + (Object)destinations);
            }
        }
        return result;
    }
