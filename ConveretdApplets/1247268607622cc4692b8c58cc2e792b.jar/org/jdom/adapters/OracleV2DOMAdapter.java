...
public class OracleV2DOMAdapter extends AbstractDOMAdapter
{
    ...
    public Document getDocument(final InputStream in, final boolean validate) throws IOException, JDOMException {
        try {
            ...
            final Method parse = parserClass.getMethod("parse", (OracleV2DOMAdapter.class$org$xml$sax$InputSource == null) ? (OracleV2DOMAdapter.class$org$xml$sax$InputSource = class$("org.xml.sax.InputSource")) : OracleV2DOMAdapter.class$org$xml$sax$InputSource);
