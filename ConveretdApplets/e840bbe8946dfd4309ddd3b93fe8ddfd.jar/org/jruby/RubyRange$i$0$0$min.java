...
public class RubyRange$i$0$0$min extends JavaMethodZeroBlock
{
    public RubyRange$i$0$0$min(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject self, final RubyModule rubyModule, final String name, final Block block) {
        ...
        try {
            final IRubyObject min = ((RubyRange)self).min(threadContext, block);
