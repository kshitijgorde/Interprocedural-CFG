...
public class ptmviewer extends Applet
{
    ...
    public void init() {
        ...
        final String parameter3 = this.getParameter("oversampling");
        if (parameter3 != null) {
    ...
    void displayCylindricalQTVR(final byte[] array) {
        ...
        final int[] array3 = new int[get_jpeg_images[0].getHeight(null) * width];
        ...
        for (int j = 0; j < get_jpeg_images.length; ++j) {
            ...
            final PixelGrabber pixelGrabber = new PixelGrabber(image, 0, 0, image.getWidth(null), image.getHeight(null), array3, 0, image.getWidth(null));
            try {
            ...
            this.insert_cyltile(j, array3, width, array2, get_tiff_hsimages[j]);
        }
        this.y_LU = null;
        this.w0 = null;
        this.w1 = null;
        this.pv.pdata = new ImageData(array2, this.pv);
    }
