...
public class Metaphone implements StringEncoder
{
    ...
    public String metaphone(final String txt) {
        ...
        final char[] inwd = txt.toUpperCase().toCharArray();
        ...
        while (code.length() < this.getMaxCodeLen() && n < wdsz) {
            ...
            if (symb != 'C' && this.isPreviousChar(local, n, symb)) {
                ...
                switch (symb) {
                    ...
                    case 'C': {
                        if (this.isPreviousChar(local, n, 'S') && !this.isLastChar(wdsz, n) && this.frontv.indexOf(local.charAt(n + 1)) >= 0) {
                            break;
                        }
                        ...
                        if (!this.isLastChar(wdsz, n) && this.frontv.indexOf(local.charAt(n + 1)) >= 0) {
                            code.append('S');
                            break;
                        }
                    ...
                    case 'D': {
                        if (!this.isLastChar(wdsz, n + 1) && this.isNextChar(local, n, 'G') && this.frontv.indexOf(local.charAt(n + 2)) >= 0) {
                            code.append('J');
                            n += 2;
                            break;
                        }
                    ...
                    case 'G': {
                        ...
                        if (!this.isLastChar(wdsz, n) && this.frontv.indexOf(local.charAt(n + 1)) >= 0 && !hard) {
                            code.append('J');
                            break;
                        }
                        code.append('K');
