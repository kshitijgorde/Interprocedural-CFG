...
public class elevaz096 extends Applet
{
    String versStr;
    final char deg = '°';
    public compute comp;
    ...
    public void doData() {
        for (int i = 0; i <= 24; ++i) {
            ...
            final double appElev = elev + this.comp.refract(elev);
            String str4;
            if (elev > -0.83) {
            ...
            this.Data[i] = String.valueOf(str) + "  " + str2 + str4 + "  " + str3;
        }
        ...
        str = String.valueOf(str) + "Local      True     Appar.  Azimuth\n";
    ...
    public void paint(final Graphics g) {
        ...
        g.drawString("Loc. Hour Angle  " + Math.round(100.0 * H) / 100.0 + '°', 315, 145);
    ...
    public elevaz096() {
        this.versStr = "Elevation & Azimuth  v. 0.96 ";
        this.demo = true;
        this.online = false;
        this.usrLat = 0.0;
        this.usrLong = 0.0;
