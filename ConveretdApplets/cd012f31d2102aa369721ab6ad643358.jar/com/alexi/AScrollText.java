...
public class AScrollText extends Applet implements MouseMotionListener, MouseListener, Runnable
{
    ...
    protected void loadFromAppletParams() {
        ...
        final String parameter8 = this.getParameter("linkTarget");
        if (parameter8 != null) {
            this.m_strLinkTarget = parameter8;
        }
        else {
            this.m_strLinkTarget = "_parent";
        }
        final String parameter9 = this.getParameter("addLinesAfter");
        if (parameter9 != null && this.getIntFromString(parameter9) >= 0) {
            this.m_bAddLinesAfter = (this.getIntFromString(parameter9) == 1);
        }
        final String parameter10 = this.getParameter("specialCharsURL");
        if (parameter10 != null && parameter10.length() > 0) {
            this.m_strSpecialsURL = new String(parameter10);
        }
        final String parameter11 = this.getParameter("paragraphDelay");
        if (parameter11 != null && this.getIntFromString(parameter11) >= 0) {
            this.m_nParagraphSleep = this.getIntFromString(parameter11);
        }
    }
    ...
    public void start() {
        ...
        if (this.verifyLicense() == 0) {
            this.getDisplayer().goToNextLine();
            this.getDisplayer().addFormattedText("Visit AXScroll homepage", this.getFont(), new Color(255, 255, 255), "http://alexi.webmessenger.ro", null, 0);
        }
