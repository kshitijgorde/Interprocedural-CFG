...
public final class bl extends cN implements aA
{
    private Component q;
    private A q;
    private A w;
    ...
    private void q(final boolean b) {
        synchronized (this.e) {
            for (int i = 0; i < this.e.q; ++i) {
                ...
                if ((b || ar.r == this.q.r) && cg.q(lowerCase, lowerCase2, ar.y) && (b || b2) && b3) {
                    super.q(ar, true);
                }
                else {
                    this.q(ar);
    ...
    public bl(final W w, final boolean b, final A a, final A a2, final aP ap) {
        this(w, true, null, a2, null, true);
    }
    
    public bl(final W w, final boolean b, final A q, final A w2, final aP q2, final boolean b2) {
        super(w);
        this.e = new A();
        this.q = q2;
        this.q = q;
        ...
        if (b2) {
            ...
            final Label label = new Label(aU.w.j() ? ak.q("Show users in all rooms") : "");
            gridBagConstraints.weightx = 1.0;
