...
import org.jruby.RubyProcess$UserID$s$0$0$rid;
import org.jruby.runtime.Block;
import org.jruby.RubyProcess$UserID$s$0$0$switch_rb;
import org.jruby.RubyProcess$UserID$s$1$0$grant_privilege;
import org.jruby.RubyProcess$UserID$s$0$0$eid;
import org.jruby.RubyProcess$UserID$s$1$0$eid;
import org.jruby.RubyProcess$UserID$s$0$0$re_exchangeable_p;
import org.jruby.RubyProcess$UserID$s$0$0$sid_available_p;
import org.jruby.runtime.ThreadContext;
import org.jruby.RubyProcess$UserID$s$0$0$re_exchange;
import org.jruby.internal.runtime.methods.DynamicMethod;
import org.jruby.runtime.builtin.IRubyObject;
import org.jruby.RubyProcess;
import org.jruby.internal.runtime.methods.CallConfiguration;
import org.jruby.RubyProcess$UserID$s$1$0$change_privilege;
...
public class org$jruby$RubyProcess$UserID$Populator extends TypePopulator
{
    public void populate(final RubyModule cls, final Class clazz) {
        ...
        JavaMethod javaMethod = new RubyProcess$UserID$s$1$0$change_privilege(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 1, "change_privilege", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "change_privilege", IRubyObject.class, new Class[] { IRubyObject.class, IRubyObject.class }, true);
        ...
        javaMethod = new RubyProcess$UserID$s$0$0$re_exchange(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 0, "re_exchange", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "re_exchange", IRubyObject.class, new Class[] { ThreadContext.class, IRubyObject.class }, true);
        ...
        javaMethod = new RubyProcess$UserID$s$0$0$sid_available_p(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 0, "sid_available_p", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "sid_available_p", IRubyObject.class, new Class[] { IRubyObject.class }, true);
        cls.addMethodAtBootTimeOnly("sid_available?", javaMethod);
        moduleMethod = TypePopulator.populateModuleMethod(cls, javaMethod);
        singletonClass.addMethodAtBootTimeOnly("sid_available?", moduleMethod);
        javaMethod = new RubyProcess$UserID$s$0$0$re_exchangeable_p(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 0, "re_exchangeable_p", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "re_exchangeable_p", IRubyObject.class, new Class[] { IRubyObject.class }, true);
        ...
        javaMethod = new RubyProcess$UserID$s$1$0$eid(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 1, "eid", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "eid", IRubyObject.class, new Class[] { ThreadContext.class, IRubyObject.class, IRubyObject.class }, true);
        cls.addMethodAtBootTimeOnly("eid=", javaMethod);
        moduleMethod = TypePopulator.populateModuleMethod(cls, javaMethod);
        singletonClass.addMethodAtBootTimeOnly("eid=", moduleMethod);
        javaMethod = new RubyProcess$UserID$s$0$0$eid(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 0, "eid", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "eid", IRubyObject.class, new Class[] { ThreadContext.class, IRubyObject.class }, true);
        cls.addMethodAtBootTimeOnly("eid", javaMethod);
        moduleMethod = TypePopulator.populateModuleMethod(cls, javaMethod);
        singletonClass.addMethodAtBootTimeOnly("eid", moduleMethod);
        javaMethod = new RubyProcess$UserID$s$1$0$grant_privilege(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 1, "grant_privilege", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "grant_privilege", IRubyObject.class, new Class[] { IRubyObject.class, IRubyObject.class }, true);
        ...
        javaMethod = new RubyProcess$UserID$s$0$0$switch_rb(cls, Visibility.PRIVATE);
        TypePopulator.populateMethod(javaMethod, 0, "switch_rb", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "switch_rb", IRubyObject.class, new Class[] { ThreadContext.class, IRubyObject.class, Block.class }, true);
        cls.addMethodAtBootTimeOnly("switch", javaMethod);
        moduleMethod = TypePopulator.populateModuleMethod(cls, javaMethod);
        singletonClass.addMethodAtBootTimeOnly("switch", moduleMethod);
        javaMethod = new RubyProcess$UserID$s$0$0$rid(cls, Visibility.PUBLIC);
        TypePopulator.populateMethod(javaMethod, 0, "rid", true, CallConfiguration.FrameNoneScopeNone, false);
        javaMethod.setNativeCall(RubyProcess.UserID.class, "rid", IRubyObject.class, new Class[] { ThreadContext.class, IRubyObject.class }, true);
