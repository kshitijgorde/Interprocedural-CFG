...
public class RubyFileTest$s$1$0$setuid_p extends JavaMethodOne
{
    public RubyFileTest$s$1$0$setuid_p(final RubyModule implementationClass, final Visibility visibility) {
