...
public class l extends Applet implements KeyListener, MouseMotionListener, MouseListener, Runnable
{
    ...
    long L;
    public boolean t;
    public static final String q = "v1.11";
    String H;
    Component void;
    Component F;
    boolean a;
    ...
    public l() {
        ...
        this.L = 0L;
        this.t = false;
        this.H = "ImmerVision PURE Player PRO for Java v1.11";
        this.void = this;
        this.F = null;
        this.a = false;
        this.D = false;
    ...
    public void int() {
        if (this.g == null) {
            ...
            if (this.w != null) {
                this.g = new bg(this, frame, "v1.11", this.A.e, this.A.new, this.A.s, this.w.e, this.w.new, this.w.s);
            }
            else {
                this.g = new bg(this, frame, "v1.11", this.A.e, this.A.new, this.A.s, "", "", "");
            }
        }
        else {
            this.g.toFront();
    ...
    public void for(final String s) {
        if (this.p == null) {
            Container container;
            for (container = this.getParent(); !(container instanceof Frame); container = container.getParent()) {}
            this.p = new bq((Frame)container, "v1.11", this, s);
        }
        else {
            this.p.toFront();
        }
    ...
    public void start() {
        ...
        this.if.new();
        this.G = new o();
        this.char = new be(this.getDocumentBase(), this.G, this.n);
        this.n.B = this.char;
        this.G.b = this.n;
        this.A = new v(this.n, this.G, this);
        ...
        if (this.t) {
            this.A.a(this.char.a(this.getParameter(new String(ac.p)), null, false, false, false));
            this.try = false;
        }
        else {
            this.A.a(this.char.a(new String(ac.Y), null, false, false, false));
        }
        ...
        if (!this.t) {
            ...
            if (parameter7 == null) {
                ...
                (this.i = new v(this.n, this.G, this)).a(this.char.a(parameter7, null, false, false, false));
            }
        }
    ...
    private void a(final long n) {
        ...
        synchronized (this.case) {
            this.if();
            if (this.width != this.void.getSize().width || (this.height != this.void.getSize().height - (((this.a | this.D) & !a.a.a.a.l.v) ? 30 : 0) - (((this.a | this.D) & a.a.a.a.l.v) ? 22 : 0) | this.I)) {
                this.width = this.void.getSize().width;
                this.height = this.void.getSize().height - (((this.a | this.D) & !a.a.a.a.l.v) ? 30 : 0) - (((this.a | this.D) & a.a.a.a.l.v) ? 22 : 0);
                if (this.if != null) {
                    this.if.new();
                }
                if (this.A != null) {
            ...
            if (this.A != null) {
                ...
                if (this.A.h && !this.try) {
                    if (this.w == null && this.e == null) {
                        ...
                        if (parameter != null) {
                            this.e = new m(this.n, this, false);
                            this.e.M = parameter;
    ...
    public String execpano(final String s) {
        synchronized (this.case) {
            if (this.w != null && this.w.z) {
                // monitorexit(this.case)
                return al.for(this.w.if((String.valueOf(s) + "\u0000").toCharArray()));
            }
        }
        // monitorexit(this.case)
        return "";
    ...
    public String execgui(final String s) {
        synchronized (this.case) {
            if (this.A != null && this.A.new()) {
                // monitorexit(this.case)
                return al.for(this.A.a((String.valueOf(s) + "\u0000").toCharArray()));
            }
        }
        // monitorexit(this.case)
        return "";
    ...
    public void if(final String m, final ae ae) {
        ...
        this.k[this.long] = new m(this.n, this, false);
        this.k[this.long].M = m;
        this.k[this.long].if(this.char.a(m, ae, false, false, false));
        ++this.long;
    }
    ...
    private void if() {
        ...
        (this.e = new m(this.n, this, this.b)).if(this.char.a(this.h, this.else, false, false, false));
        this.h = null;
        this.else = null;
    }
    
    public void a(final String h, final ae else1, final boolean b) {
        this.h = h;
        this.else = else1;
        this.b = b;
    }
        ...
        try {
            if (this.a || this.D) {
                if (this.F == null || this.goto.z != this.a || this.goto.y != this.D) {
                    ...
                    if (this.new >= 4) {
                        this.F = new a4(frame, this);
                        ((a4)this.F).setUndecorated(true);
                    }
                    else {
                        this.F = new q(frame, this);
                    }
                    ...
                    if (a.a.a.a.l.u) {
                        this.F.reshape(0, 22, width, height + (a.a.a.a.l.v ? 0 : 30));
                    }
                    else {
                        this.F.reshape(0, 0, width, height + (a.a.a.a.l.v ? 0 : 30));
                    }
                    this.width = this.F.getSize().width;
                    this.height = this.F.getSize().height - (((this.a | this.D) & !a.a.a.a.l.v) ? 30 : 0) - (((this.a | this.D) & a.a.a.a.l.v) ? 22 : 0);
                    ...
                    if (this.goto == null || this.goto.z != this.a || this.goto.y != this.D) {
                        Label_0581: {
                            if (this.new >= 3) {
                                try {
                                    (this.goto = new bj()).a(this.F, true, this);
                                    break Label_0581;
                                }
                                catch (Exception ex2) {
                                    ac.ah = false;
    ...
    private void for() {
        ...
        Label_0116: {
            if (this.int == null) {
                if (this.new >= 3) {
                    try {
                        (this.int = new bj()).a(this.void, false, this);
                        break Label_0116;
                    }
                    catch (Exception ex) {
                        ac.ah = false;
