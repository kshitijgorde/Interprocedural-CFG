...
public final class ci
{
    ...
    public static String w(final String s) {
        for (int i = 0; i < ci.w.length; ++i) {
            if (s.equalsIgnoreCase(ci.w[i])) {
                return ci.q[i];
            }
        }
        return s;
