...
public class DS_RotHue extends Applet implements Runnable
{
    Thread _fld0;
    int _fld1;
    Font _fld3;
    ...
    void _mth3b() {
        ...
        this._mth4b(this._fld2e = (this._fld2e + this._fld4e + 360) % 360);
    ...
    void _mth4b(final int n) {
        ...
        int n4;
        int n3;
        int n2 = n3 = (n4 = (n5 = (n6 = (n7 = (n8 = (n9 = (n10 = 0)))))));
        switch (n / 60) {
            case 0: {
                final int n11 = n * 255 / 60;
                n6 = (n3 = (n10 = 510 - n11));
                n7 = (n2 = (n8 = n11));
                break;
            }
            case 1: {
                final int n12 = (n - 60) * 255 / 60;
                n6 = (n3 = (n10 = 255 - n12));
                n7 = (n2 = (n8 = 255 + n12));
                break;
            }
            case 2: {
                final int n13 = (n - 120) * 255 / 60;
                n7 = (n2 = (n8 = 510 - n13));
                n5 = (n4 = (n9 = n13));
                break;
            }
            case 3: {
                final int n14 = (n - 180) * 255 / 60;
                n7 = (n2 = (n8 = 255 - n14));
                n5 = (n4 = (n9 = 255 + n14));
                break;
            }
            case 4: {
                final int n15 = (n - 240) * 255 / 60;
                n6 = (n3 = (n10 = n15));
                n5 = (n4 = (n9 = 510 - n15));
                break;
            }
            case 5: {
                final int n16 = (n - 300) * 255 / 60;
                n6 = (n3 = (n10 = 255 + n16));
                n5 = (n4 = (n9 = 255 - n16));
                break;
            }
        ...
        final int n24 = n9 >> 1;
        final int n25 = n10 >> 1;
        for (int n26 = this._fld4 * this._fld5, i = 0; i < n26; ++i) {
            final int n27 = this._fld6[i] >> 16 & 0xFF;
            final int n28 = this._fld6[i] >> 8 & 0xFF;
            final int n29 = this._fld6[i] & 0xFF;
            this._fld7[i] = (0xFF000000 | n27 * n17 + n28 * n18 + n29 * n19 >> 8 << 16 | n27 * n20 + n28 * n21 + n29 * n22 >> 8 << 8 | n27 * n23 + n28 * n24 + n29 * n25 >> 8);
        }
    }
