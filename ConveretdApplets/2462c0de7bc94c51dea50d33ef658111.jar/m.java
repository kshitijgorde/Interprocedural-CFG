...
public class m
{
    ...
    public m(final int n, final int k, final int l, final double m, final int n2) {
        this.a = new int[32];
        this.h = 0.0;
    ...
    public void a(final int n, final byte[] c, final short[] array) {
        ...
        for (int n4 = 0; n4 < this.i / this.j; ++n4) {
            ...
            final double n7 = (this.z[n4] & 0x7) << 0 + m.g[(this.z[n4] & 0x38) >> 3];
        ...
        for (int n19 = 0; n19 < n; ++n19) {
            array[n19] = (short)((this.u[n19] > 32767.0) ? 32767.0 : ((this.u[n19] < -32768.0) ? -32768.0 : this.u[n19]));
        }
    }
