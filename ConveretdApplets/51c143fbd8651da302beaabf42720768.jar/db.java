...
class db extends Panel implements ActionListener, ComponentListener
{
    ...
    db(final esChat a, final String e) {
        ...
        a.getClass();
        this.b = new fb(a, db.z[2]);
        this.b.c.setFont(new Font(a.eb, a.d, a.hb));
        this.b.c.setBackground(a.h);
        a.getClass();
        this.add(this.d = new z(a, this.b, false), db.z[1]);
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "6J\u0016e\u000e".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "&@\re\u0003\u0017".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "6Q\u0002e\u0013\u0016".toCharArray();
