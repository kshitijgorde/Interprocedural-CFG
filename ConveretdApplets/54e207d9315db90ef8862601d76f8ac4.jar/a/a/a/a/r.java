...
public class r extends Applet implements KeyListener, MouseMotionListener, MouseListener, Runnable
{
    ...
    public void int() {
        if (this.g == null) {
            ...
            if (this.w != null) {
                this.g = new bx(this, frame, "v1.11", this.A.e, this.A.new, this.A.s, this.w.e, this.w.new, this.w.s);
            }
            else {
                this.g = new bx(this, frame, "v1.11", this.A.e, this.A.new, this.A.s, "", "", "");
            }
        }
        else {
            this.g.toFront();
    ...
    public void for(final String s) {
        if (this.p == null) {
            Container container;
            for (container = this.getParent(); !(container instanceof Frame); container = container.getParent()) {}
            this.p = new b9((Frame)container, "v1.11", this, s);
        }
        else {
            this.p.toFront();
        }
