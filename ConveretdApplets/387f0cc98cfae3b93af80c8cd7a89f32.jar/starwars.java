...
public class starwars extends Applet implements Runnable
{
    Thread motor;
    int XSIZE;
    int YSIZE;
    ...
    public void init() {
        ...
        this.bufImg = new textScroll(this, this.mainImg, this.XSIZE, this.YSIZE);
    ...
    public void run() {
        ...
        System.err.println("Starwars Text Applet (C) 2001 I-Yuan Chen [6sense.com]");
        while (true) {
            final Graphics graphics = this.mainImg.getGraphics();
