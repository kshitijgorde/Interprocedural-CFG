...
final class NestedDB extends DB implements Runtime.CallJavaCB
{
    ...
    protected synchronized void _open(String s) throws SQLException {
        if (this.handle != 0) {
    ...
    int shared_cache(final boolean b) throws SQLException {
        return -1;
    }
    ...
    synchronized void busy_timeout(final int n) throws SQLException {
    ...
    protected synchronized int finalize(final long n) throws SQLException {
        return this.call("sqlite3_finalize", (int)n);
    }
    
    protected synchronized int step(final long n) throws SQLException {
        return this.call("sqlite3_step", (int)n);
    }
    
    protected synchronized int reset(final long n) throws SQLException {
        return this.call("sqlite3_reset", (int)n);
    }
    
    synchronized int clear_bindings(final long n) throws SQLException {
        return this.call("sqlite3_clear_bindings", (int)n);
    }
    
    synchronized int bind_parameter_count(final long n) throws SQLException {
        return this.call("sqlite3_bind_parameter_count", (int)n);
    }
    
    synchronized int column_count(final long n) throws SQLException {
        return this.call("sqlite3_column_count", (int)n);
    }
    
    synchronized int column_type(final long n, final int n2) throws SQLException {
        return this.call("sqlite3_column_type", (int)n, n2);
    }
    
    synchronized String column_name(final long n, final int n2) throws SQLException {
        return this.utfstring(this.call("sqlite3_column_name", (int)n, n2));
    }
    
    synchronized String column_text(final long n, final int n2) throws SQLException {
        return this.utfstring(this.call("sqlite3_column_text", (int)n, n2));
    }
    
    synchronized byte[] column_blob(final long n, final int n2) throws SQLException {
    ...
    synchronized double column_double(final long n, final int n2) throws SQLException {
        try {
    ...
    synchronized long column_long(final long n, final int n2) throws SQLException {
        try {
    ...
    synchronized int column_int(final long n, final int n2) throws SQLException {
        return this.call("sqlite3_column_int", (int)n, n2);
    }
    
    synchronized String column_decltype(final long n, final int n2) throws SQLException {
        return this.utfstring(this.call("sqlite3_column_decltype", (int)n, n2));
    }
    
    synchronized String column_table_name(final long n, final int n2) throws SQLException {
        return this.utfstring(this.call("sqlite3_column_table_name", (int)n, n2));
    }
    
    synchronized int bind_null(final long n, final int n2) throws SQLException {
        return this.call("sqlite3_bind_null", (int)n, n2);
    }
    
    synchronized int bind_int(final long n, final int n2, final int n3) throws SQLException {
        return this.call("sqlite3_bind_int", (int)n, n2, n3);
    }
    
    synchronized int bind_long(final long n, final int n2, final long n3) throws SQLException {
        return this.bind_text(n, n2, Long.toString(n3));
    }
    
    synchronized int bind_double(final long n, final int n2, final double n3) throws SQLException {
        return this.bind_text(n, n2, Double.toString(n3));
    }
    
    synchronized int bind_text(final long n, final int n2, final String s) throws SQLException {
        if (s == null) {
    ...
    synchronized int bind_blob(final long n, final int n2, final byte[] array) throws SQLException {
    ...
    synchronized void result_null(final long n) throws SQLException {
        this.call("sqlite3_result_null", (int)n);
    }
    
    synchronized void result_text(final long n, final String s) throws SQLException {
        this.call("sqlite3_result_text", (int)n, this.rt.strdup(s), -1, this.rt.lookupSymbol("free"));
    }
    
    synchronized void result_blob(final long n, final byte[] array) throws SQLException {
    ...
    synchronized void result_double(final long n, final double n2) throws SQLException {
        this.result_text(n, Double.toString(n2));
    }
    
    synchronized void result_long(final long n, final long n2) throws SQLException {
        this.result_text(n, Long.toString(n2));
    }
    
    synchronized void result_int(final long n, final int n2) throws SQLException {
        this.call("sqlite3_result_int", (int)n, n2);
    }
    
    synchronized void result_error(final long n, final String s) throws SQLException {
        final int strdup = this.rt.strdup(s);
        this.call("sqlite3_result_error", (int)n, strdup, -1);
        this.rt.free(strdup);
    }
    
    synchronized int value_bytes(final Function function, final int n) throws SQLException {
        return this.call("sqlite3_value_bytes", this.value(function, n));
    }
    
    synchronized String value_text(final Function function, final int n) throws SQLException {
        return this.utfstring(this.call("sqlite3_value_text", this.value(function, n)));
    }
    
    synchronized byte[] value_blob(final Function function, final int n) throws SQLException {
    ...
    synchronized double value_double(final Function function, final int n) throws SQLException {
        return Double.parseDouble(this.value_text(function, n));
    }
    
    synchronized long value_long(final Function function, final int n) throws SQLException {
        return Long.parseLong(this.value_text(function, n));
    }
    
    synchronized int value_int(final Function function, final int n) throws SQLException {
        return this.call("sqlite3_value_int", this.value(function, n));
    }
    
    synchronized int value_type(final Function function, final int n) throws SQLException {
        return this.call("sqlite3_value_type", this.value(function, n));
    }
    
    private int value(final Function function, final int n) throws SQLException {
        return this.deref((int)function.value + n * 4);
    }
    
    synchronized int create_function(final String s, final Function function) throws SQLException {
    ...
    synchronized int destroy_function(final String s) throws SQLException {
        if (s == null) {
            return 0;
        }
        int n;
    ...
    synchronized boolean[][] column_metadata(final long n) throws SQLException {
    ...
    private int call(final String s, final int n) throws SQLException {
        this.p1[0] = n;
        return this.call(s, this.p1);
    }
    
    private int call(final String s, final int n, final int n2) throws SQLException {
        this.p2[0] = n;
        this.p2[1] = n2;
        return this.call(s, this.p2);
    }
    
    private int call(final String s, final int n, final int n2, final int n3) throws SQLException {
        this.p3[0] = n;
        this.p3[1] = n2;
        this.p3[2] = n3;
    ...
    private int call(final String s, final int n, final int n2, final int n3, final int n4) throws SQLException {
        this.p4[0] = n;
        this.p4[1] = n2;
        this.p4[2] = n3;
        this.p4[3] = n4;
    ...
    private int call(final String s, final int n, final int n2, final int n3, final int n4, final int n5) throws SQLException {
        this.p5[0] = n;
        this.p5[1] = n2;
        this.p5[2] = n3;
        this.p5[3] = n4;
    ...
    private int call(final String s, final int[] array) throws SQLException {
        try {
    ...
    private int deref(final int n) throws SQLException {
        try {
    ...
    private String utfstring(final int n) throws SQLException {
        try {
    ...
    private String cstring(final int n) throws SQLException {
        try {
    ...
    private void copyin(final int n, final byte[] array, final int n2) throws SQLException {
        try {
    ...
    private void copyout(final byte[] array, final int n, final int n2) throws SQLException {
        try {
    ...
    private static final class CausedSQLException extends SQLException
    {
        ...
        CausedSQLException(final Exception cause) {
            if (cause == null) {
