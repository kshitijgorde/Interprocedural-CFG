...
public class StylesheetRoot extends StylesheetComposed implements Serializable, Templates
{
    ...
    public String setExtensionHandlerClass(final String handlerClassName) {
        final String oldvalue = this.m_extensionHandlerClass;
    ...
    public void setOptimizer(final boolean b) {
        this.m_optimizer = b;
    }
    ...
    public void setSource_location(final boolean b) {
