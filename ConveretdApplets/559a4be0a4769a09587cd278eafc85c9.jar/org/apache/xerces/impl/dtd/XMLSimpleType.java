...
public class XMLSimpleType
{
    ...
    public void setValues(final short type, final String name, final String[] enumeration, final boolean list, final short defaultType, final String defaultValue, final String nonNormalizedDefaultValue, final DatatypeValidator datatypeValidator) {
        this.type = type;
        this.name = name;
