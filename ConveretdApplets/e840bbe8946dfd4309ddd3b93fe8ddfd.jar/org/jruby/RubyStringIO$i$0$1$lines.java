...
public class RubyStringIO$i$0$1$lines extends JavaMethodNBlock
{
    public RubyStringIO$i$0$1$lines(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return ((RubyStringIO)rubyObject).lines(context, array, block);
    }
}
