...
public final class el extends em
{
    ...
    private el(final int q) {
        this.q = q;
    }
    
    public el(final int n, final Color color, final Color color2) {
        this(1, color.brighter(), color, color2, color2.brighter());
    }
    
    private el(final int n, final Color q, final Color w, final Color r, final Color e) {
        this(n);
        this.q = q;
        this.w = w;
        this.r = r;
