...
import com.ibm.xslt4j.bcel.generic.FieldGen;
...
public final class Stylesheet extends SyntaxTreeNode
{
    ...
    private void compileStaticInitializer(final ClassGenerator classGen) {
        ...
        final MethodGenerator staticConst = new MethodGenerator(9, com.ibm.xslt4j.bcel.generic.Type.VOID, null, null, "<clinit>", this._className, il, cpg);
    ...
    private void compileConstructor(final ClassGenerator classGen, final Output output) {
        final ConstantPoolGen cpg = classGen.getConstantPool();
        final InstructionList il = new InstructionList();
        final MethodGenerator constructor = new MethodGenerator(1, com.ibm.xslt4j.bcel.generic.Type.VOID, null, null, "<init>", this._className, il, cpg);
    ...
    private String compileTopLevel(final ClassGenerator classGen, final Enumeration elements) {
        final ConstantPoolGen cpg = classGen.getConstantPool();
        final com.ibm.xslt4j.bcel.generic.Type[] argTypes = { Util.getJCRefType("Lorg/apache/xalan/xsltc/DOM;"), Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), Util.getJCRefType("Lorg/apache/xml/serializer/SerializationHandler;") };
        final String[] argNames = { "document", "iterator", "handler" };
        final InstructionList il = new InstructionList();
        final MethodGenerator toplevel = new MethodGenerator(1, com.ibm.xslt4j.bcel.generic.Type.VOID, argTypes, argNames, "topLevel", this._className, il, classGen.getConstantPool());
        toplevel.addException("org.apache.xalan.xsltc.TransletException");
        final LocalVariableGen current = toplevel.addLocalVariable("current", com.ibm.xslt4j.bcel.generic.Type.INT, il.getEnd(), null);
    ...
    private String compileBuildKeys(final ClassGenerator classGen) {
        final ConstantPoolGen cpg = classGen.getConstantPool();
        final com.ibm.xslt4j.bcel.generic.Type[] argTypes = { Util.getJCRefType("Lorg/apache/xalan/xsltc/DOM;"), Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), Util.getJCRefType("Lorg/apache/xml/serializer/SerializationHandler;"), com.ibm.xslt4j.bcel.generic.Type.INT };
        final String[] argNames = { "document", "iterator", "handler", "current" };
        final InstructionList il = new InstructionList();
        final MethodGenerator buildKeys = new MethodGenerator(1, com.ibm.xslt4j.bcel.generic.Type.VOID, argTypes, argNames, "buildKeys", this._className, il, classGen.getConstantPool());
    ...
    private void compileTransform(final ClassGenerator classGen) {
        ...
        final String[] argNames = { "document", "iterator", "handler" };
        final InstructionList il = new InstructionList();
        final MethodGenerator transf = new MethodGenerator(1, com.ibm.xslt4j.bcel.generic.Type.VOID, argTypes, argNames, "transform", this._className, il, classGen.getConstantPool());
        transf.addException("org.apache.xalan.xsltc.TransletException");
        final LocalVariableGen current = transf.addLocalVariable("current", com.ibm.xslt4j.bcel.generic.Type.INT, il.getEnd(), null);
