...
public class WebRectFurn extends Webfurn
{
    public WebRectFurn(final int n, final int n2, final int n3, final int n4, final char c, final char c2, final String s, final Color color, final String s2, final double n5, final String s3, final String s4, final String s5, final String s6, final String s7, final String s8, final String s9, final String s10) {
    ...
    public void paint(final Graphics graphics) {
        ...
        graphics.fillPolygon(super.actualFurn);
        if (!super.spinning) {
            if (super.n.length() > 0) {
