...
public class SessionEnclosure
{
    ...
    private void loginAuth(final ConnData connData, final GenericResponse genericResponse) {
        ...
        this.send(this.cmGenTransPack((short)10001, (short)11003, (short)20000, "9.13,applet-rel-9090," + s));
        this.send(this.cmGenTransPack((short)10001, (short)11005, (short)20000, WindowUtil.clientProps(this.paraConf.getApplet(), "9.13", "applet-rel-9090-" + s)));
