...
class JupiterCompute
{
    ...
    public JupiterCompute(final double JD) {
        ...
        this.L = (this.L0(this.T) + this.L1(this.T) * this.T + this.L2(this.T) * this.T * this.T + this.L3(this.T) * this.T * this.T * this.T) / 1.0E8;
        this.B = (this.B0(this.T) + this.B1(this.T) * this.T + this.B2(this.T) * this.T * this.T + this.B3(this.T) * this.T * this.T * this.T) / 1.0E8;
    ...
    double R3(final double t) {
        final double[][] L = { { 3519.0, 6.058, 529.691 }, { 1073.0, 1.6732, 536.8045 }, { 916.0, 1.413, 522.577 }, { 342.0, 0.523, 1059.382 }, { 255.0, 1.196, 7.114 }, { 222.0, 0.952, 515.464 } };
        double r3 = 0.0;
        for (int i = 0; i <= 5; ++i) {
