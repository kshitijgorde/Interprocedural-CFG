...
public class aG extends Canvas implements ImageObserver
{
    private static O q;
    protected Image q;
    private URL q;
    ...
    public final void q(final int n, final int n2) {
        ...
        if (((size = this.size()).height != n2 || size.width != n) && n > 0 && n2 > 0) {
            ...
            aG ag;
            for (parent = this, ag = this; parent != null && !(ag instanceof Window); ag = (aG)parent, parent = ((aG)parent).getParent()) {
                ((aG)parent).invalidate();
            }
            ag.validate();
        }
    }
