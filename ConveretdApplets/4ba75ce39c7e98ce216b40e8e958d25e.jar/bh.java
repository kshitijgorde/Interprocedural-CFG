...
abstract class bh extends ba implements i, bl
{
    ...
    bh(final bn d, final Rectangle x) {
        ...
        do {
            int n2 = 0;
            do {
                this.s[n2][n] = super.d.b().n.b(f + n * 3 + n2);
            } while (++n2 < 3);
        } while (++n < 8);
    ...
    public void a(final a a) {
        switch (a.id) {
            ...
            case 501: {
                ...
                if (super.d.c(this) || super.d.a((ba)this)) {
                    this.A = b;
                    return;
                }
                break;
            ...
            case 506: {
                if (this.B) {
                    if (super.d.c(this) && this.C == -1 && this.b(a.x, a.y) != this.A) {
                        super.d.b((ba)this);
                    }
                    this.a(a.x, a.y, 1);
                    a.consume();
