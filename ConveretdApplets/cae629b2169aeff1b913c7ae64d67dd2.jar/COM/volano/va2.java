...
public class va2 extends vap
{
    ...
    public va2(final vc vc, final Component component, final vd vd, final String[][] array, final String a, final int b, final int c, final String d, final String e, final Hashtable f) {
        ...
        if (this.i.size() > vd.fs) {
            this.i.setSize(vd.fs);
        }
        if (b == 1 || vd.z) {
            super.k.a(vd.en);
        }
        ...
        if (vd.fd.length() > 0 && (b == 1 || vd.z)) {
            menuBar.add(this.p);
        }
        if (vd.fi.length() > 0 && (vd.n || vd.x)) {
            menuBar.add(this.q);
        }
        if (vd.fp.length() > 0) {
            menuBar.add(this.r);
    ...
    public boolean action(final Event event, final Object o) {
        ...
        if (event.target == this.p.g) {
            super.k.a(vaq.a(super.c.gs, new Integer(this.c)));
            return true;
        }
        if (event.target == this.q.a) {
            this.a(super.c.ft, this.a(this.h), 1);
            return true;
        }
        if (event.target == this.q.b) {
            this.a(super.c.fu, this.a(this.i), 2);
            return true;
        }
        if (event.target == this.q.c) {
            this.a(super.c.fv, this.a(this.i), 3);
            return true;
        }
    ...
    public void c(String s) {
        if (this.k <= super.c.cr && super.e && s.trim().length() != 0) {
            if (this.b == 1 || super.c.z) {
                s = this.a(s, true);
            }
            else {
                s = this.a(s, false);
                super.k.a(super.c.ep);
            }
            synchronized (this.j) {
    ...
    private void g(final String s) {
        if (super.e && !super.c.ar && !s.equals(this.d)) {
            if (super.c.ao != -1 && this.f.size() >= super.c.ao && !super.c.x && !super.c.w) {
                super.k.a(vaq.a(super.c.gu, new Integer(super.c.ao)));
                return;
            }
            super.k.a(vaq.a(super.c.gl, s));
    ...
    private void a(final vc vc, final vu vu) {
        ...
        if (f.length() == 0) {
            ...
            vector.addElement(b);
            super.i.a(vaq.a(super.c.g0, vector));
            return;
        }
        if (!this.p.a(f)) {
            if (this.m != null && vu.c) {
    ...
    private void a(final vc vc, final vs vs) {
        ...
        if (this.o.k.getState() && !this.p.a(d)) {
            ...
            super.i.a(vaq.a(super.c.gz, vector));
            super.c.h.a();
        }
    }
    ...
    private void a(final String s, final String s2, final String s3, final String s4, final String s5) {
        ...
        synchronized (this.h) {
            ...
            if (this.i.size() > super.c.fs) {
                this.i.setSize(super.c.fs);
            }
        }
        // monitorexit(this.h)
