...
public class B implements Observer, MouseListener, MouseMotionListener
{
    ...
    private void A(final int n, final int n2) {
        if (this.O.E != null && this.O.E.A().length() > 0) {
            (this.R = new F(this.O.E, new Font(this.P.L.getName(), 0, this.P.L.getSize() + 2), n, true, this.I)).C(true);
            if (this.P.V) {
                this.R.A(0.5f);
            }
    ...
    private void A(final com.cc.C.A a) {
        ...
        for (int i = 0; i < this.N.length; ++i) {
            final com.cc.D.A._A a2 = new com.cc.D.A._A((this.N[i].E.length() > 0 && !this.O.B) ? (this.N[i].E + s) : "", a.N, false, com.cc.D.A._A.E);
            (this.C[i] = new F(this.N[i].F, a.L, n, true, this.I)).A(true);
            if ((!a.Q || a2.A().length() > s.length() + 1) && !this.O.B) {
                a2.A(a2.A() + " ");
            }
            this.C[i].A(a2, a.Q);
            this.C[i].A(a.\u00c9);
            (this.J[i] = new F(new com.cc.D.A(new com.cc.D.A._A[] { new com.cc.D.A._A(this.N[i].F() ? a.g : " ", true, false, com.cc.D.A._A.E) }), a.L, n, true, this.I)).A(true);
            this.J[i].A(a.\u00cf);
            this.J[i].B(true);
        ...
        if (!this.A(this.C[n], true)) {
            ...
            for (int i = 0; i < this.C.length; ++i) {
                if (this.C[i].B().y >= this.L.y) {
                    ...
                    final Rectangle j = this.L;
                    j.y += this.C[i].B().y - this.L.y;
                    break;
                }
            }
            this.A.H(this.L.y);
    ...
    public void mousePressed(final MouseEvent mouseEvent) {
        ...
        this.K = this.A.Q() + mouseEvent.getY();
        this.H = (this.A != null);
        ...
        for (int i = 0; i < this.J.length; ++i) {
            ...
            if (b.contains(a) || rectangle.contains(a)) {
                ...
                if (rectangle.contains(a) && this.N[i].F()) {
                    this.E.A(this.N[i].E(), this.P.\u00ca, false, false);
                }
                return;
            }
        }
    ...
    public void A(final Graphics graphics) {
        ...
        final D d = this.O.A() ? null : this.Q.C();
        for (int i = 0; i < this.N.length; ++i) {
            final F f = this.C[i];
            if (this.N[i] == d) {
                f.C(this.P.u);
            ...
            if (!this.B.d) {
                if (this.N[i].B(this.B.I()) && d != null) {
                    f.A(this.P.u);
                }
                else if (this.N[i].A() != null && this.B.D(this.N[i].A()).E() && d != null) {
                    f.A(this.P.z);
                }
                else {
            ...
            else if (this.N[i].A() != null && !this.B.D(this.N[i].A()).D()) {
                f.A(this.P.u);
            }
            else {
                f.A(this.I.getForeground());
    ...
    private void A(final Graphics graphics, final F f) {
        if (f != null && this.A(f, false)) {
            ...
            f.B(graphics.create(b.x, b.y - this.L.y + this.G, b.width, b.height));
        }
    }
