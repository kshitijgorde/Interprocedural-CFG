...
public class vaf extends Frame implements Observer
{
    ...
    public vaf(final vc b, final Component c, final vd d, final String s, final String s2, final String[] array) {
        ...
        if (d.a5.length() > 0) {
            this.q = new vah(d.a, "logo.param.", d.a5, d.a6, d.a7, d.a8);
        }
        else {
            this.q = new vai();
        }
        ...
        if (d.ay.length() > 0 || d.aw.length() > 0) {
            this.ah = new vag(d.b, d.bs);
            if (d.ay.length() > 0) {
                this.ah.a(d.ay, d.az, d.a0, d.aw, d.ax);
            }
            else {
                this.ah.a(d.aw, d.ax);
            }
    ...
    private void a(final vd d) {
        ...
        if (this.q instanceof vai) {
            ((vai)this.q).a(d.b2, d.b3, d.b4, d.b5);
        }
        if (this.r != null) {
            this.r.setText(d.ed);
        }
        ...
        this.v.setText(d.d4);
        this.ab.setText(d.d8);
        this.ad.setLabel(d.eh);
        this.ae.setLabel(d.ei);
        this.ag.a("Copyright (c) 1996-2009 Volano Software");
        ...
        this.n.put(this.w, d.fz);
        this.n.put(this.ac, d.f0);
        if (this.x != null) {
            this.n.put(this.x, d.f1);
        }
        this.n.put(this.y, d.f2);
        this.n.put(this.z, d.f3);
        this.n.put(this.ad, d.f4);
        this.n.put(this.ae, d.f5);
        this.n.put(this.ag, "Copyright (c) 1996-2009 Volano Software");
        this.a(d.a(0));
        this.ag.h = true;
    }
    ...
    private void e() {
        ...
        this.c(this.k);
        this.c(this.j);
        final URL url = this.d.o ? this.d.c3 : this.d.c2;
        this.b.d();
        this.dispose();
        this.d.h.a(1);
    ...
    public boolean action(final Event event, final Object o) {
        ...
        if (event.target == this.am.a) {
            this.d.b.showDocument(this.d.c0, "_blank");
            return true;
        }
    ...
    private boolean a(final String s, final String s2) {
        ...
        if (s.length() == 0) {
            ...
            this.ag.a(vaq.a(this.d.f9, this.f));
        }
        else {
            final va2 va2 = this.j.get(s);
            if (va2 != null) {
                this.ag.a(vaq.a(this.d.gm, s));
                va2.requestFocus();
            }
            else if (this.d.an != -1 && this.j.size() >= this.d.an) {
                this.ag.a(vaq.a(this.d.gr, new Integer(this.d.an)));
            }
            else {
                b = true;
            }
    ...
    private void h() {
        ...
        if (s.length() == 0 || this.d.at) {
            s = a(this.y.getText().replace(' ', ' ').trim(), this.d.cc);
        }
        if (this.a(f, s)) {
            this.ag.a(vaq.a(this.d.gi, f));
            String s2 = this.i;
            if (s2.length() == 0 || this.d.au) {
                s2 = a(this.z.getText().trim(), this.d.ca);
            }
            this.a();
    ...
    private void a(final vd vd, final String[] array) {
        if (vd.as.length() > 0 && Boolean.valueOf(array[3]) && Boolean.valueOf(array[4])) {
            ...
            this.ag.a(vap.a(vd, array), vd.b8, vaq.a(vd.as, vector), vd.bu, vd.bt);
            return;
        }
        this.ag.a(vap.a(vd, array), vd.bu, vd.bt);
    }
    ...
    private void a(final vp vp) {
        try {
            ...
            this.ag.a(vaq.a(this.d.g0, new Date()));
    ...
    private void a(final vc vc, final vad vad) {
        ...
        if (f.startsWith("http://") || this.g == 2) {
            this.ag.a(f, this.d.bw, this.d.bv);
            return;
        }
        this.i();
    }
    ...
    private void a(final vc vc, final vx vx) {
        ...
        if (i == 3) {
            ...
            vector.addElement(d);
            vector.addElement(e);
            this.ag.a(vaq.a(this.d.gn, vector));
            return;
        }
        if (i == 4) {
            this.ag.a(vaq.a(this.d.go, d));
            return;
        }
        if (i == 5) {
            this.ab.setText(this.d.d8);
    ...
    private void a(final String[] array) {
        ...
        switch (array.length) {
            case 0: {
                this.v.setText(this.d.d5);
                break;
            }
            case 1: {
                this.v.setText(this.d.d6);
                break;
            }
            default: {
                this.v.setText(vaq.a(this.d.d7, new Integer(array.length)));
                break;
            }
        }
        this.ab.setText(this.d.d8);
    ...
    private void a(final int n, final String[][] o) {
        ...
        switch (o.length) {
            case 0: {
                this.ab.setText(this.d.d9);
            }
            case 1: {
                this.ab.setText(this.d.ea);
            }
            default: {
                this.ab.setText(vaq.a(this.d.eb, new Integer(o.length)));
            }
        }
    }
    ...
    private void i() {
        ...
        this.ag.a(vaq.a(this.d.ge, this.f));
    }
