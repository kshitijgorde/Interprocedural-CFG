...
public final class S extends Panel
{
    private String q;
    private boolean q;
    private boolean w;
    ...
    public S(final int n, final int n2, final TextArea q, final Color background) {
        this(null, 25, 25);
        this.q = q;
        this.t = true;
        if ((dN.q == 0 && dN.t) || (dN.q == 1 && dN.y)) {
            ...
            this.q = new cM(q, canvas, new Color(238, 238, 238));
    ...
    private S(final String s, final int n, int e) {
        this.q = null;
        this.q = false;
        this.w = false;
        this.q = null;
    ...
    public final void paint(final Graphics graphics) {
        if (this.isShowing()) {
            ...
            if (!(this.getParent() instanceof as)) {
