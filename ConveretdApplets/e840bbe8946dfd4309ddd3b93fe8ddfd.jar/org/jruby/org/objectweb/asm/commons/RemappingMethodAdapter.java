...
public class RemappingMethodAdapter extends LocalVariablesSorter
{
    ...
    public AnnotationVisitor visitAnnotation(final String s, final boolean b) {
        final AnnotationVisitor visitAnnotation = this.mv.visitAnnotation(this.remapper.mapDesc(s), b);
    ...
    public AnnotationVisitor visitParameterAnnotation(final int n, final String s, final boolean b) {
        final AnnotationVisitor visitParameterAnnotation = this.mv.visitParameterAnnotation(n, this.remapper.mapDesc(s), b);
