...
public final class aT extends Panel
{
    ...
    public final Dimension preferredSize() {
        ...
        final FontMetrics fontMetrics = this.getFontMetrics(aT.q);
        ...
        final Dimension dimension = new Dimension(Math.max(preferredSize.width, aU.w.y), preferredSize.height);
    ...
    private aT(final int t, int n, final int i, final int u, final int e, final br q, final boolean q2) {
        this.q = 12;
    ...
    public aT(final int n, final int n2, final int n3, final int n4, final int n5, final br br) {
        this(2, 10, 2, 10, n5, br, false);
    }
    
    public aT(final br br, final boolean b) {
        this(4, 4, 4, 4, 1, br, b);
    }
