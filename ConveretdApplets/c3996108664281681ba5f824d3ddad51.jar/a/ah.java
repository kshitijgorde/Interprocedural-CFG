...
public final class ah extends Panel implements MouseListener, WindowListener
{
    private ai q;
    private Window q;
    ...
    public ah(final Component component, final Component w, final Color q) {
        this(component);
        this.w = w;
        this.q = q;
    }
    ...
    public final void q(final cq q) {
        this.q = q;
    }
    ...
    public final synchronized void w() {
        ...
        (this.q = cp.q(this.q, component)).add(this.q);
        Point point;
        if (this.q != null) {
            point = this.q;
        }
