...
public class x extends Panel
{
    ...
    public Dimension preferredSize() {
        ...
        return new Dimension(Math.max(preferredSize.width, n2 + 10 + this.a.aq / 2), Math.max(preferredSize.height, 42));
    }
            ...
            for (int n6 = 0; (n == -1 || n6 <= n || n6 <= n2) && n6 < size; ++n6) {
                ...
                if (n == -1 || n6 == n || n6 == n2) {
                    ...
                    if (n6 == this.q) {
                        ...
                        graphics.setColor((this.a.aq != 0) ? darker : Color.white);
                        graphics.drawLine(n3, n7 + 22, n9, n7 + 22);
                        graphics.setColor((this.a.aq != 0) ? darker2 : Color.black);
    ...
    public void paint(final Graphics graphics) {
        ...
        if (this.a.aq != 0) {
            ...
            final int aq = this.a.aq;
            final int n4 = 22;
            graphics.setColor(background);
            graphics.fillRoundRect(0, n4, n2, n - n4, aq, aq);
            graphics.drawArc(n2 - aq, n - aq - 1, aq, aq, 0, -90);
            graphics.fillRect(0, n4, aq * 2, aq * 2);
            graphics.setColor(background.darker());
            if (this.e) {
                graphics.drawLine(0, n4, n2 - aq / 2, n4);
            }
            graphics.drawLine(n2, n4 + aq / 2 - 2, n2, n - aq / 2);
            graphics.drawArc(n2 - aq, n4, aq, aq - 1, 0, 90);
            graphics.drawArc(n2 - aq, n - aq, aq, aq, 0, -90);
            graphics.drawLine(aq / 2 - 1, n, n2 - aq / 2, n);
            graphics.drawLine(0, n4, 0, n - aq / 2);
            graphics.drawArc(0, n - aq, aq, aq, 180, 90);
        }
        else {
            graphics.setColor(background2);
