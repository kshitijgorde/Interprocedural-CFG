...
public class s implements bc
{
    ...
    public void q(final cr cr) {
        if (cr.q() != 4202576) {
            return;
        }
        final String q = cr.q(0, 0);
        final int q2 = cr.q(0, 0);
        final int q3 = cr.q(0, 1);
        final int q4 = cr.q(0, 2);
        switch (q3) {
            case 1: {
                final bT bt;
                (bt = new bT(this.q.q, ak.q("Info"), new String[] { ak.q("Yes"), ak.q("No") }, new String[] { ak.q(q) }, null, this.q)).setVisible(true);
                this.q(q2, this.q.s, ak.q("Yes").equals(bt.q));
            }
            case 3: {
                ...
                bo.q("AV conference with " + l.o, q, h.q().getCodeBase() + "Resources/" + cq.p + "/" + ((av)this.q.w.w(l.e)).o);
            ...
            case 2: {
                ...
                (this.q = new bT(this.q.q, ak.q("Info"), new String[] { ak.q("Close") }, new String[] { ak.q(q) }, null, this.q)).setModal(false);
    ...
    public static cr q(final int n, final int n2, final int n3, final String s) {
        final cr cr;
        (cr = new cr(4202576, 1)).q(0, 0, n);
        cr.q(0, 1, n2);
        cr.q(0, 2, n3);
        cr.q(0, 0, s);
        return cr;
