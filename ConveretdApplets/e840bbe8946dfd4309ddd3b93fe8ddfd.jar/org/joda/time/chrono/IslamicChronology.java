...
public final class IslamicChronology extends BasicChronology
{
    ...
    public static IslamicChronology getInstance(DateTimeZone default1, final LeapYearPatternType leapYearPatternType) {
        ...
        IslamicChronology instance;
        synchronized (IslamicChronology.cCache) {
            IslamicChronology[] array = IslamicChronology.cCache.get(default1);
            if (array == null) {
                array = new IslamicChronology[4];
                IslamicChronology.cCache.put(default1, array);
            }
            instance = array[leapYearPatternType.index];
            if (instance == null) {
                ...
                array[leapYearPatternType.index] = instance;
            }
        }
        return instance;
    }
