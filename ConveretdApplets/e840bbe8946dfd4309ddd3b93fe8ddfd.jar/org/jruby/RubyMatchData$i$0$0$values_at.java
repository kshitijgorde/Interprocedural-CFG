...
public class RubyMatchData$i$0$0$values_at extends JavaMethodN
{
    public RubyMatchData$i$0$0$values_at(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyMatchData)rubyObject).values_at(array);
    }
}
