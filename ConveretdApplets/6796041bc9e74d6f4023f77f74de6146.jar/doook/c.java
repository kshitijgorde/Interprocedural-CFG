...
public class c extends Canvas
{
    ...
    public void resize(final int b, final int n) {
    ...
    private final int a(final Graphics graphics, final int n) {
        if (this.c) {
            try {
                ...
                graphics.drawString(cI.an, this.getSize().width - this.getFontMetrics(this.getFont()).stringWidth(cI.an) - 42, this.getSize().height - 5);
                graphics.drawImage(doook.y.c, this.getSize().width - 34, this.getSize().height / 2 - 16, null);
            }
            catch (Exception ex) {
    ...
    public c(final String a, final URL url) {
        this.c = false;
        this.b = true;
        this.a = a;
        this.a(url);
