...
public class M extends Canvas implements aA
{
    String q;
    private String w;
    private String e;
    ...
    public final void w() {
        ...
        if ((parent = this.getParent()) instanceof Z) {
            ((Z)parent).q(true, true);
        }
    }
    ...
    public boolean isShowing() {
        return (bF.w && bF.w == 1) || super.isShowing();
    }
    ...
    public M(final String s, final int n, int e) {
        this.r = false;
        this.r = aU.w.l();
        this.r = 20;
        this.q = null;
        ...
        this.e = this.getFontMetrics(bf.w).getHeight() + 7;
        this.q(s);
        this.setFont(bf.w);
    ...
    public M(final String s) {
        this(s, 22, 22);
        this.resize(this.getFontMetrics(bf.w).stringWidth(s) + 20, this.e);
    }
