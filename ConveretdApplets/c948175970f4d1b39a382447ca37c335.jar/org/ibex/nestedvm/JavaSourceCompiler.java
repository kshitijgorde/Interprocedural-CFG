...
public class JavaSourceCompiler extends Compiler
{
    ...
    public JavaSourceCompiler(final Seekable seekable, final String s, final Writer writer) throws IOException {
        super(seekable, s);
    ...
    protected void _go() throws Exn, IOException {
        if (this.singleFloat) {
            throw new Exn("JavaSourceCompiler doesn't support singleFloat");
        }
        String substring;
        String s;
        ...
        if (this.supportCall) {
            ...
            for (int n2 = 0; n2 < symbols.length; ++n2) {
                final ELF.Symbol symbol = symbols[n2];
                if (symbol.type == 2 && symbol.binding == 1 && (symbol.name.equals("_call_helper") || !symbol.name.startsWith("_"))) {
                    this.p("symbols.put(\"" + symbol.name + "\",new Integer(" + Compiler.toHex(symbol.addr) + "));");
                }
            }
            --this.indent;
            this.p("}");
    ...
    private void emitInstruction(final int n, final int n2, final int n3) throws IOException, Exn {
        if (n2 == -1) {
            ...
            switch (n4) {
                ...
                case 17: {
                    switch (n5) {
                        ...
                        case 2: {
                            if (n9 != 31) {
                                throw new Exn("FCR " + n9 + " unavailable");
                            }
                            this.p("r" + n6 + " = fcsr;");
                            break Label_7576;
                        }
                        ...
                        case 16: {
                            switch (n12) {
                                ...
                                default: {
                                    throw new Exn("Invalid Instruction 17/" + n5 + "/" + n12);
                                }
                            }
                            break;
                        }
                        ...
                        default: {
                            throw new Exn("Invalid Instruction 17/" + n5);
                        }
                    }
                    break;
                }
                ...
                default: {
                    throw new Exn("Invalid Instruction: " + n4 + " at " + Compiler.toHex(n));
                }
            }
        }
    }
