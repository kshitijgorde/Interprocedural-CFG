...
public final class cq implements Cloneable
{
    ...
    private synchronized int q(final Object o) {
        if (o instanceof cG) {
            return this.q(((cG)o).q());
        }
    ...
    public final int q(final cG cg) {
        return this.q(cg, cg.q());
    }
    
    public final synchronized int q(final Object o, int n) {
        if (o instanceof cG && ((cG)o).getName() == null) {
            return -1;
        }
        int q = this.q;
        if (n < 0 && n > -2147483638) {
    ...
    public final synchronized Object clone() {
        try {
            final cq cq;
            (cq = (cq)super.clone()).q = new Object[this.q];
            cq.q = new int[this.q];
            System.arraycopy(this.q, 0, cq.q, 0, this.q);
            System.arraycopy(this.q, 0, cq.q, 0, this.q);
            return cq;
        }
    ...
    public cq(final int n, final int n2) {
        this.q = 0;
        this.q = new Object[n];
        this.q = new int[n];
        this.w = 0;
