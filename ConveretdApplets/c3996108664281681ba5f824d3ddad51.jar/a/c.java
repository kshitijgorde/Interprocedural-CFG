...
public class c extends Canvas implements ImageObserver
{
    private static G q;
    protected Image q;
    private URL q;
    ...
    public final void q(final int n, final int n2) {
        ...
        if (((size = this.size()).height != n2 || size.width != n) && n > 0 && n2 > 0) {
            ...
            c c;
            for (parent = this, c = this; parent != null && !(c instanceof Window); c = (c)parent, parent = ((c)parent).getParent()) {
                ((c)parent).invalidate();
            }
            c.validate();
        }
    ...
    public void update(final Graphics graphics) {
        if (this.w == null) {
            ...
            this.w = co.q(this, width, height + 4, "bp.u-d");
        }
        ...
        if (this.e != null && this.q) {
            ...
            if ((parent = this.getParent()) != null && !this.q.equals(parent.size()) && !this.q.equals(parent.location())) {
                ...
                this.r = co.q(this, new FilteredImageSource(this.e.getSource(), new CropImageFilter(this.location().x + (0 + parent.location().x), this.location().y + (0 + parent.location().y), this.size().width - 1, parent.size().height)), "bp.u-g");
            }
        }
