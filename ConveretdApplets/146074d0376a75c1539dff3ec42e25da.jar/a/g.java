...
public class g extends Canvas implements dT
{
    private String q;
    private String w;
    private String e;
    ...
    public boolean isShowing() {
        return (ef.w && ef.w == 1) || super.isShowing();
    }
    ...
    public g(final String s, final int n, int e) {
        this.r = false;
        this.r = cf.w.z();
        this.r = 20;
        this.q = null;
        ...
        this.e = this.getFontMetrics(m.w).getHeight() + 7;
        this.q(s);
        this.setFont(m.w);
    ...
    public g(final String s) {
        this(s, 22, 22);
        this.resize(this.getFontMetrics(m.w).stringWidth(s) + 20, this.e);
    }
