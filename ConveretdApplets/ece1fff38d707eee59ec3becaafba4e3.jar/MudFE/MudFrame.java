...
public class MudFrame extends WPPanel implements DialogClient, TextDisplayer
{
    ...
    public static final boolean d6x4 = true;
    ...
    void prompted() {
        ...
        if (this.showshield && this.hp == null) {
            (this.hp = new HealthPanel(this, this.getImage("shield6x4.jpg"), (LayoutManager)new ShieldLayout6x4())).hide();
            this.add("SH", this.hp);
    ...
    public void jbInit() throws Exception {
        ...
        this.dim = this.getImage("c6x4.jpg");
    ...
    public MudFrame(final MudApplet a, final String cb) {
        ...
        try {
            ...
            this.defaultDisplay.setFontSize(10);
            this.setLayout(new PrettyLayout6());
            this.mainImage = this.getImage("a6x4.jpg");
            this.jbInit();
            final Image sImage = this.getSImage("shield6x4.jpg");
            this.sim = sImage;
            this.hp = new HealthPanel(this, sImage, (LayoutManager)new ShieldLayout6x4());
            this.co = (Panel)new Compas6(this);
    ...
    void do_history() {
        if (MudFrame.connected) {
            if (this.history) {
                ...
                this.history = true;
                if (this.Lbl == null) {
                    this.slim = this.getImage("stoplog6x4.jpg");
