...
public class b implements c
{
    ...
    public void a(final Image c) {
        ...
        if (c != null) {
            ...
            this.a(new Dimension(c.getWidth(ds.d), c.getHeight(ds.d)));
        }
        else {
            this.d = null;
        }
    ...
    public void a(final int n) {
        if (this.d != null && this.b != null && this.a != null) {
            this.d.drawImage(this.b, 0, 0, ds.d);
            final double n2 = this.g * n / 100.0;
            double n3 = 0.0;
            double n4 = (this.g - n2) / 2.0;
            for (int i = 0; i < 10; ++i) {
                this.d.drawImage(this.a, (int)n4, 0, (int)(n4 + n2), this.f, (int)n3, 0, (int)(n3 + this.g), this.f, ds.d);
                n3 += this.g;
                n4 += this.g;
            }
        }
