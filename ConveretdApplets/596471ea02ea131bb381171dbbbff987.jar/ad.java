...
public class ad
{
    ...
    public void a(final boolean i, final int j, final int k) {
        this.i = i;
        this.j = j;
        this.k = k;
    }
                    ...
                    switch (max - 16405) {
                        ...
                        case 2: {
                            if (this.i && this.a.c != null && this.a.c.d != null) {
                                max = Math.max(0, this.j - 4);
                                final int min = Math.min(256, this.j + 4);
                                final int max2 = Math.max(0, this.k - 4);
                                final int min2 = Math.min(240, this.k + 4);
                                int n2 = 0;
    ...
    protected void g(int n, int n2) {
        ...
        n2 = n4;
        final i i = b;
        if (n2 + 8192 <= i.a.length) {
            System.arraycopy(array2, n6, i.a, n2, 8192);
        }
    }
}
