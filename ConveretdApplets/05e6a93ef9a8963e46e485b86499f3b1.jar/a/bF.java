...
public final class bF extends Panel implements MouseListener, WindowListener
{
    private ad q;
    private Window q;
    ...
    public bF(final Component component, final Component w, final Color q) {
        this(component);
        this.w = w;
        this.q = q;
    }
    ...
    public final synchronized void w() {
        ...
        (this.q = aL.q(this.q, component)).add(this.q);
        Point point;
        if (this.q != null) {
            point = this.q;
        }
