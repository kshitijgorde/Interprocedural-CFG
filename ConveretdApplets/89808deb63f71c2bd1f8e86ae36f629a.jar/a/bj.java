...
public abstract class bj implements bu
{
    ...
    public static void q(final W w) {
        bo.q(new String[] { "window.focus(); setTimeout(\"window.external.AddFavorite('" + h.q().getCodeBase() + "', window.document.title);\", 100);" }, w);
    }
    ...
    public final void q(final Frame q) {
        ...
        this.q = "_blank";
        this.e = false;
        ((Frame)(this.q = this.q("mi_", true))).setBackground(aU.w.k);
        this.e = 21;
    ...
    protected final void e() {
        ...
        final Font y = bf.y;
        this.q.put("mb_bgcr", Integer.toString(aU.w.k.getRGB(), 16));
        this.q.put("mb_bgcrin", Integer.toString(aU.w.l.getRGB(), 16));
        this.q.put("mb_fgcrin", Integer.toString(aU.w.z.getRGB(), 16));
    ...
    private aX q(final String s, final boolean b) {
        int n = 1;
        final aX ax = new aX();
        while (this.q(s + n)) {
            ...
            final String s3 = (q3 != null && string.length() > 4) ? (cg.q("=5>E") + "_" + cg.q(q3.toLowerCase(), ' ', '_') + ".gif") : "";
            if (q4 == null) {
                q4 = s3;
            }
            Image image;
            if (q4 != null && q4.trim().length() > 0) {
                image = h.q().getImage(h.q().getCodeBase(), "Resources/" + cg.q("=5>E") + "/" + q4);
            }
            else {
                image = null;
            }
    ...
    protected final void w(final int n, int i) {
        ...
        if (this.q.k.q > 0) {
            this.q.put(s + "_txt", cB.o);
        }
        for (i = 0; i < this.q.k.q; ++i) {
            this.q.put(s + "_" + (i + 1) + "_txt", ((aZ)this.q.k.q(i)).o);
        }
    }
}
