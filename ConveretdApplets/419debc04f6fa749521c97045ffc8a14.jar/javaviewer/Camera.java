...
public class Camera extends Component
{
        ...
        if (n5 > 10) {
            ...
            if (index2 > 0) {
                ...
                if (this.relPanTilt.length() == 1) {
                    this.relPanTilt = "0".concat(String.valueOf(String.valueOf(this.relPanTilt)));
                }
            }
        }
        ...
        if (n6 > 7) {
            ...
            if (index3 > 0) {
                ...
                if (this.relZoom.length() == 1) {
                    this.relZoom = "0".concat(String.valueOf(String.valueOf(this.relZoom)));
                }
            }
        }
    ...
    private String _$167786(final String s) {
        if (s.length() < 2) {
    ...
    public int getControl() {
        ...
        if (this.waitTime == 0 && this.controlTime == -1) {
            return 0;
        }
        if (this.waitTime != -1) {
            return 1;
    ...
    public void setPresetPosition(final String s) {
        synchronized (this.parent.commandSend) {
            this.parent.commandSend.setCommand("/command/presetposition.cgi", "PresetCall=".concat(String.valueOf(String.valueOf(s))));
            this.parent.commandSend.notify();
        }
        // monitorexit(this.parent.commandSend)
    ...
    public void notifyCameraPos(final String s) {
        if (s.length() >= 15) {
            if (s.substring(0, 1).equals("1")) {
                ...
                if (this.panPos != int1) {
                    this.parent.logger.print(String.valueOf(String.valueOf(new StringBuffer("pan position : ").append(String.valueOf(this.panPos)).append("->").append(String.valueOf(int1)))));
                    this.panPos = int1;
            ...
            if (s.substring(1, 2).equals("1")) {
                ...
                if (this.tiltPos != int2) {
                    this.parent.logger.print(String.valueOf(String.valueOf(new StringBuffer("tilt position : ").append(String.valueOf(this.tiltPos)).append("->").append(String.valueOf(int2)))));
                    this.tiltPos = int2;
                    this.parent.imageThread.panoramaView.repaint();
                }
            }
            if (s.substring(2, 3).equals("1")) {
                ...
                if (this.zoomPos != int3) {
                    this.parent.logger.print(String.valueOf(String.valueOf(new StringBuffer("zoom position : ").append(String.valueOf(this.zoomPos)).append("->").append(String.valueOf(int3)))));
                    this.zoomPos = int3;
    ...
    public int getZoomPos() {
        this.parent.logger.print("current zoom position : ".concat(String.valueOf(String.valueOf(String.valueOf(this.zoomPos)))));
        return this.zoomPos;
    }
    ...
    public String toPTAddress(final int n) {
        ...
        String s;
        if (n >= 0) {
            s = "0000".concat(String.valueOf(String.valueOf(hexString)));
        }
        else {
            s = "ffff".concat(String.valueOf(String.valueOf(hexString)));
        }
