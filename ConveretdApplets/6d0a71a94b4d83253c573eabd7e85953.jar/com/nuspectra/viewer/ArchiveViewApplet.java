...
public class ArchiveViewApplet extends NuApplet implements Runnable
{
    Image[] images;
    String[] desc;
    ...
    public void start() {
        ...
        try {
            ...
            this.println("loading first " + waitUntil + " images of " + this.items);
    ...
    public void actionPerformed(final ImageButtonCanvas b) {
    ...
    protected boolean handleMessage(final int id, final Object arg) {
        ...
        switch (id) {
            ...
            case 1100: {
                if (arg instanceof ImageButtonCanvas) {
                    this.actionPerformed((ImageButtonCanvas)arg);
                    break;
                }
                break;
            }
