...
public final class ci extends Canvas
{
    private cm a;
    ...
    final Rectangle a(final int n) {
        ...
        return new Rectangle((size.width + 6 - width * 30) / 2 + n % width * 30, (size.height + 6 - a.height * 28) / 2 + n / width * 28, 25, 25);
    }
        ...
        if (this.isShowing()) {
            ...
            for (int i = this.a.b; i < n; ++i) {
                ...
                if ((graphics2 = this.getGraphics()) != null) {
                    ...
                    final Image a2 = ((Y)this.a.a.a(n3)).a;
                    final Rectangle a3 = this.a(n3 - this.a.b);
                    graphics4.drawImage(a2, 1 + a3.x + (a3.width - 16) / 2, 1 + a3.y + (a3.height - 16) / 2, this);
                    graphics2.dispose();
                }
            }
        }
    ...
    public final boolean handleEvent(final Event event) {
        switch (event.id) {
            ...
            case 506: {
                ...
                final int n = (size.width + 6 - width * 30) / 2;
                int n2 = (event.y - (size.height + 6 - height * 28) / 2) / 28;
                int n3;
                if ((n3 = (event.x - n) / 30) >= width) {
                    n3 = width - 1;
                }
                else if (n3 < 0) {
                    n3 = 0;
