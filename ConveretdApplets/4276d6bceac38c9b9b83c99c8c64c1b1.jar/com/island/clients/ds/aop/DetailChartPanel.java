...
class DetailChartPanel extends Panel implements Runnable
{
    public static final int SHARES = 100000;
    ...
    public DetailChartPanel(final int width, final int height) {
        ...
        if (this.started) {
            ...
            synchronized (this.socketLock) {
                if (this.dataController != null) {
                    d = (AverageOrderAppletData)this.dataController.getOrderChartData(this.symbol, 100000);
                }
            }
    ...
    protected void initOffScreenImage() {
        if (this.offScreenImage == null || this.offScreenImage.getHeight(null) != this.height || this.offScreenImage.getWidth(null) != this.width) {
            this.offScreenImage = this.getImageTemplate(this.width, this.height);
        }
        final Graphics offg = this.offScreenImage.getGraphics();
