...
public final class Parser
{
    ...
    public void parse() {
        ...
        while ((lastIndex = substring.lastIndexOf(";")) != -1) {
            this.function = String.valueOf(substring.substring(lastIndex + 1)).concat(String.valueOf(')'));
        ...
        if (this.error == 0) {
            this.function = String.valueOf(substring).concat(String.valueOf(')'));
            this.parseSubFunction();
        }
    ...
    public double evaluate() {
        ...
        final double evaluateSubFunction2 = this.evaluateSubFunction();
        this.refvalue = null;
    ...
    private void addCode(final char c) {
        this.postfix_code = String.valueOf(this.postfix_code).concat(String.valueOf(c));
    }
    ...
    private void scanNumber() throws ParserException {
        ...
        if (this.character != '.') {
            do {
                s = String.valueOf(s).concat(String.valueOf(this.character));
    ...
    private void scanNonNumeric() throws ParserException {
        ...
        do {
            concat = String.valueOf(concat).concat(String.valueOf(this.character));
            this.getNextCharacter();
        ...
        if (concat.equals("if")) {
            ...
            this.addCode('\u0001');
            final String concat2 = String.valueOf(String.valueOf(s).concat(String.valueOf((char)(this.postfix_code.length() + 2)))).concat(String.valueOf(this.postfix_code));
            this.postfix_code = "";
            this.scanAndParse();
            if (this.character != ')') {
                throw new ParserException(2);
            }
            this.postfix_code = new String(String.valueOf(String.valueOf(concat2).concat(String.valueOf((char)(this.postfix_code.length() + 1)))).concat(String.valueOf(this.postfix_code)));
            this.getNextCharacter();
        }
        else {
            int i = 0;
            ...
            while (j < 4) {
                if (concat.equals(this.extfunc[j])) {
                    ...
                    this.getNextCharacter();
                    this.postfix_code = new String(String.valueOf(s2).concat(String.valueOf(this.postfix_code)));
