...
public class RubyFile$s$0$1$realpath extends JavaMethodN
{
    public RubyFile$s$0$1$realpath(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyFile.realpath(context, recv, array);
    }
}
