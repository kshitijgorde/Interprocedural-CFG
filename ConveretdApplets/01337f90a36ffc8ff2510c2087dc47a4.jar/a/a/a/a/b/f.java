...
public class f extends Component implements c, h
{
    ...
    public f(final a c, final String else1, final int n, final int n2, final int new1, final int d, final a.a.a.a.b.a int1, final boolean void1) {
        ...
        ((a.a.a.a.c.a.a)this.c.case("statemachine")).if(this);
        this.new();
        if (this.new == 0) {
            this.d = this.int();
        }
        ...
        this.setCursor((Cursor)this.c.case("cursor/default"));
    ...
    protected int int() {
        switch (((a.a.a.a.c.a.a)this.c.case("statemachine")).a(this.else)) {
            case -1: {
                return -1;
            }
            case 1: {
    ...
    private void new() {
        ...
        this.long = (Image)this.c.case("images/button/" + this.else + ".up");
        if (this.long == null) {
            this.long = (Image)this.c.case("images/button/" + this.else);
        }
        this.byte.addImage(this.long, 0);
        this.null = (Image)this.c.case("images/button/" + this.else + ".down");
        if (this.null == null) {
            this.null = this.long;
        }
        else {
        ...
        this.h = (Image)this.c.case("images/button/" + this.else + ".gray");
        if (this.h == null) {
            this.h = this.long;
        }
        else {
    ...
    public void processMouseEvent(final MouseEvent mouseEvent) {
        switch (mouseEvent.getID()) {
            ...
            case 505: {
                ((Applet)this.c.case("applet")).getAppletContext().showStatus("                      ");
                if (this.new != 1) {
                    this.d = this.int();
                    this.repaint();
                    break;
    ...
    protected void try() {
        ...
        if (s != null) {
            ((Applet)this.c.case("applet")).getAppletContext().showStatus(s);
        }
    }
