...
public class Grid_int extends Applet implements ActionListener, KeyListener, MouseListener, MouseMotionListener
{
    ...
    ClueView_int[] OO;
    boolean DD;
    private static final String k = " Software © 2005 ";
    ...
    public void init() {
        ...
        try {
            ...
            try {
                ...
                this.copylen = fontMetrics.stringWidth(" Software © 2005 ");
    ...
    public void paint(final Graphics graphics) {
        if (this.Err != null) {
            ...
            graphics.drawString(" Software © 2005 ", this.a.getBounds().x + -this.copylen, this.p);
        }
    }
