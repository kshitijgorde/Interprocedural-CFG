...
public class RubyKernel$s$0$0$fork extends JavaMethodZeroBlock
{
    public RubyKernel$s$0$0$fork(final RubyModule implementationClass, final Visibility visibility) {
