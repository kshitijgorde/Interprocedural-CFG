...
public final class CallOneArgNode extends CallNode
{
    ...
    public CallOneArgNode(final ISourcePosition position, final Node receiverNode, final String name, final ArrayNode args) {
    ...
    public IRubyObject interpret(final Ruby runtime, final ThreadContext context, final IRubyObject self, final Block aBlock) {
        return this.callAdapter.call(context, self, this.getReceiverNode().interpret(runtime, context, self, aBlock), this.arg1.interpret(runtime, context, self, aBlock));
    }
