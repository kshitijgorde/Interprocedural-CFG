...
public class ActiveMQConfiguration extends JmsConfiguration
{
    ...
    public ActiveMQConfiguration() {
        this.brokerURL = "failover://tcp://localhost:61616";
    ...
    public PlatformTransactionManager getTransactionManager() {
        ...
        if (this.isTransacted() && answer == null) {
            answer = this.createTransactionManager();
            this.setTransactionManager(answer);
            answer = this.getTransactionManager();
        }
        return answer;
    }
