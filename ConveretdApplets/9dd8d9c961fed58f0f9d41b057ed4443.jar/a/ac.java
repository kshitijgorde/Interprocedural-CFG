...
public final class ac extends Panel implements cH
{
    public transient cp q;
    private transient cp w;
    private Color q;
    private boolean q;
    private TextField q;
    private TextField w;
    ...
    public ac(final bG q) {
        ...
        final cy cy = new cy();
        final cy cy2;
        (cy2 = new cy()).setLayout(gridBagLayout);
        cy2.setBackground(aU.w.q);
        cy2.setForeground(aU.w.q);
        ...
        (this.q = new cF(this)).setSize(new Dimension(150, 165));
        ...
        if (this.q == null) {
            ...
            switch (this.q) {
                case 0: {
                    this.q = new cp(0, 150, 150, q2[0], 1.0f, 1.0f);
                    this.w = new cp(3, 16, 150, 0.0f, 1.0f, 1.0f);
                    break;
                }
                case 1: {
                    this.q = new cp(1, 150, 150, 1.0f, q2[1], 1.0f);
                    this.w = new cp(4, 16, 150, 1.0f, 0.0f, 1.0f);
                    break;
                }
                case 2: {
                    this.q = new cp(2, 150, 150, 1.0f, 1.0f, q2[2]);
                    this.w = new cp(5, 16, 150, 1.0f, 1.0f, 0.0f);
                    break;
                }
            }
            this.q.q = this.q;
        ...
        panel3.setBackground(aU.w.i);
        panel3.setForeground(aU.w.u);
        panel3.add(panel5, "Center");
        final Panel panel6;
        (panel6 = new Panel()).setBackground(aU.w.i);
        panel6.setForeground(aU.w.u);
        panel6.add(this.q);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        gridBagLayout.setConstraints(cy2, gridBagConstraints);
        this.add(cy2);
        this.q(0);
