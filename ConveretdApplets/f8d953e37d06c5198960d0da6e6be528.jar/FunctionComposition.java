...
public class FunctionComposition extends GenericGraphApplet implements ActionListener, ItemListener
{
    ...
    public void setUpMainPanel() {
        ...
        final boolean b = !"no".equalsIgnoreCase(this.getParameter("UseFunctionInput", "yes"));
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ...
        if (source == this.zoomInButton) {
            ...
            if (this.fTableShown) {
                ...
                double ymin;
                if (0.0 < super.canvas.getCoordinateRect(0).getYmin() || 0.0 > super.canvas.getCoordinateRect(0).getYmax()) {
            ...
            if (this.gTableShown) {
                ...
                double ymin2;
                if (0.0 < super.canvas.getCoordinateRect(1).getYmin() || 0.0 > super.canvas.getCoordinateRect(1).getYmax()) {
