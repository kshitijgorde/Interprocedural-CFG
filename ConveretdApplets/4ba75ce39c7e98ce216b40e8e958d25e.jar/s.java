...
class s
{
    ...
    final void a(final float[] l) {
        ...
        this.h[0] = bm.a(this.j, array);
        this.h[1] = bm.a(this.k, array);
        this.h[2] = bm.a(this.i, array);
        this.f[0] = bm.a(this.j, array2);
        this.f[1] = bm.a(this.k, array2);
        this.f[2] = bm.a(this.i, array2);
        bm.a(this.h, this.f, this.g);
    }
