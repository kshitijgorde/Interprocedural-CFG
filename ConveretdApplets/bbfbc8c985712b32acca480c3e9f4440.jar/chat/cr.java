...
public class cr extends Canvas implements aB
{
    public String a;
    private String b;
    private String c;
    ...
    public cr(final String s, final int n, int c) {
        this.d = 16777215;
        this.e = 20;
        this.a = null;
        this.b = null;
        ...
        if (this.d) {
            this.d = o.e.getRGB();
            final int rgb = o.d.getRGB();
            this.a = new int[(this.e << 1) + 1];
            this.a = this.a(rgb);
        }
        this.c = this.getFontMetrics(bk.b).getHeight() + 7;
        this.a(s);
        this.setFont(bk.b);
    ...
    public cr(final String s) {
        this(s, 22, 22);
        this.resize(this.getFontMetrics(bk.b).stringWidth(s) + 20, this.c);
    }
