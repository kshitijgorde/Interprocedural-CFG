...
class s
{
    ...
    final boolean a(float n, final float[] array, final float[] array2) {
        ...
        final float n3 = this.l[3] * this.e;
        if (n2 < 1.0E-5f) {
    ...
    final void a(final float[] l) {
        ...
        this.h[0] = bn.a(this.j, array);
        this.h[1] = bn.a(this.k, array);
        this.h[2] = bn.a(this.i, array);
        this.f[0] = bn.a(this.j, array2);
        this.f[1] = bn.a(this.k, array2);
        this.f[2] = bn.a(this.i, array2);
        bn.a(this.h, this.f, this.g);
    }
