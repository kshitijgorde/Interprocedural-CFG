...
public class XIncludeMessageFormatter implements MessageFormatter
{
    ...
    public String formatMessage(final Locale fLocale, final String s, final Object[] array) throws MissingResourceException {
        if (this.fResourceBundle == null || fLocale != this.fLocale) {
            if (fLocale != null) {
                this.fResourceBundle = ResourceBundle.getBundle("org.apache.xerces.impl.msg.XIncludeMessages", fLocale);
        ...
        if (s2 == null) {
            throw new MissingResourceException(this.fResourceBundle.getString("BadMessageKey"), "org.apache.xerces.impl.msg.XIncludeMessages", s);
        }
        return s2;
    }
}
