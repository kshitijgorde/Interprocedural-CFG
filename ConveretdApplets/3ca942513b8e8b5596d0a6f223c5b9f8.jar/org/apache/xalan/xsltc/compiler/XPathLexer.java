...
class XPathLexer implements Scanner
{
    ...
    Symbol disambiguateAxisOrFunction(final int ss) throws Exception {
        int index;
    ...
    Symbol disambiguateOperator(final int ss) throws Exception {
        switch (this.last) {
            case -1:
            case 2:
            case 4:
    ...
    Symbol newSymbol(final int ss) {
        this.last = ss;
        return new Symbol(ss);
    }
    
    Symbol newSymbol(final int ss, final String value) {
        this.last = ss;
        return new Symbol(ss, value);
    }
    
    Symbol newSymbol(final int ss, final Long value) {
        this.last = ss;
        return new Symbol(ss, value);
    }
    
    Symbol newSymbol(final int ss, final Double value) {
        this.last = ss;
        return new Symbol(ss, value);
    }
