...
public class RubyArgsFile$s$0$1$bytes extends JavaMethodNBlock
{
    public RubyArgsFile$s$0$1$bytes(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyArgsFile.bytes(context, recv, array, block);
    }
}
