...
public class WvEvent
{
    ...
    public WvEvent(final int i) {
        this(i, null);
    }
    
    public WvEvent(final int i, final int j) {
        this.id = i;
        this.arg = new Integer(j);
    }
    
    public WvEvent(final int i, final Object obj) {
        this.id = i;
        this.arg = obj;
    }
    
    public WvEvent(final int i, final Object obj, final int j, final int k) {
        this.id = i;
        this.arg = obj;
        this.int1 = j;
        this.int2 = k;
