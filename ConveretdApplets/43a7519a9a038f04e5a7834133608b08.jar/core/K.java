...
public final class K
{
        ...
        while (i < s.length()) {
            ...
            while (true) {
                for (int j = 0; j < array.length; ++j) {
                    if (char1 == array[j]) {
                        s2 = String.valueOf(s2) + I.I(659) + Integer.toHexString(char1);
                        ++i;
                        continue Label_0211;
                    }
                }
    ...
    public static final String d(final String s) {
        if (!s.endsWith(I.I(61))) {
            return String.valueOf(s) + I.I(61);
        }
        return s;
    }
    ...
    public static final BufferedReader a(URLConnection urlConnection, final boolean b) {
        try {
            ...
            try {
                inputStreamReader = new InputStreamReader((InputStream)urlConnection, I.I(63));
            }
