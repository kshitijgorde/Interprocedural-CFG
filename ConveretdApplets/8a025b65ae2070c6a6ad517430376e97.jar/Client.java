...
public class Client extends Applet implements Runnable, AppletStub, MouseListener, MouseMotionListener
{
    ...
    public void init() {
        ...
        System.out.println("\nAddonChat v9.00.29.94 (en_uk" + ((this.c > 0) ? ",big" : "") + ")");
    ...
    public void run() {
        try {
            ...
            if (this.c == 1) {
                array[0] = new URL(this.getCodeBase(), "AddonChat_en_uk_lg.zip");
            }
            else if (this.c > 1) {
                array[0] = new URL(this.getCodeBase(), "AddonChat_en_uk_xl.zip");
            }
            else {
                array[0] = new URL(this.getCodeBase(), "AddonChat_en_uk.zip");
            }
