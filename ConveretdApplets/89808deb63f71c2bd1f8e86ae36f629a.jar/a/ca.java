...
public final class ca extends aF implements aA
{
    ...
    protected final synchronized void q(final r w, int n, final Graphics graphics) {
        try {
            ...
            final int n4 = n + 3 + 1;
            final Font w2 = aU.w.w();
            final Font q = aU.w.q();
            if (w.p) {
                graphics.setColor(aU.w.g);
            }
            else if (w.s != 0) {
                graphics.setColor(new Color(w.s));
            }
            else if (w.e) {
                graphics.setColor(aU.w.d);
            }
            else if (w.r) {
                graphics.setColor(aU.w.f);
            }
            else if (w.q && super.q.y()) {
                graphics.setColor(aU.w.p);
            }
            else {
                graphics.setColor(aU.w.a);
            }
            if (this.q(w.t) != null && this.q(w.t).i != 0 && !w.e) {
                graphics.setColor(new Color(this.q(w.t).i));
            }
            if (graphics.getColor() != aU.w.a && super.w && super.q != null) {
            ...
            if (n >= n3 && n - this.i <= n2) {
                ...
                if (w.p > 999) {
                    final bv bv = (bv)super.q.q().w(w.p);
                    Image q2 = null;
                    if (bv != null) {
                        q2 = bv.q;
                    }
                ...
                if (w.p) {
                    ...
                    if (w.a) {
                        s = s + " - " + ak.q("Warning");
                        graphics.setColor(ca.q);
                    }
                    else if (w.s) {
                        s = s + " - " + ak.q("Notice");
                        graphics.setColor(ca.w);
                    }
                    else if (w.d) {
                        s = s + " - " + ak.q("Info");
                        graphics.setColor(ca.e);
                    }
                }
                ...
                if (w.e && super.w) {
                    ar ar;
                    if ((ar = (ar)super.q.t().w(w.t)) != null && ar.q(59) && ((by)super.q.r().w(ar.r)).q(61)) {
                        final String q3 = ak.q("(Private message from Guest Speaker)");
                        graphics.setColor(aU.w.o);
                ...
                if (w.r && super.w && w.y == -1 && !w.p && (ap = (aP)super.q.u().w(w.d)) == null) {
                    final String q5 = ak.q(cg.q("S#9>7<5K3<93;K?>KD89CK=5CC175KD?K:?9>K3?>65B5>35T"));
                    graphics.setColor(aU.w.o);
                    graphics.drawString(q5, aF.q + this.q.stringWidth(w.w + "######"), n);
                }
            }
            if (super.q.t()) {
                graphics.setFont(aU.w.e());
    ...
    private void q(final boolean b, final Graphics graphics, String trim, final int n, final boolean b2, final boolean b3) {
        if (b && !"".equals(trim)) {
            ...
            for (int n5 = 0; n5 < this.u && (q = this.q.q.q(trim, ++q)) != -1 && q < length; ++n5) {
                ...
                final Q q2;
                if (((q2 = this.q.q.q(trim.substring(q, index))) != null && q2.q != null && this.w.q != null && ((cu.q() && this.p < ((cq)this.w.q).T) || (cu.w() && this.p < ((cq)this.w.q).A))) || this.w.i) {
    ...
    private void q(final String s, final Graphics graphics, final int n, final int n2, final int n3, final boolean b, final boolean b2) {
        if (b || (cu.t && ((this.w.q != null && !this.w.q.q(61)) || this.w.q == null)) || (cu.y && ((this.w.q != null && this.w.q.q(61)) || this.w.q == null))) {
            graphics.setColor(new Color((n3 != 0) ? n3 : this.w.o));
        }
        if ((cu.q && this.w.q != null && !this.w.q.q(61)) || (cu.w && this.w.q != null && this.w.q.q(61)) || b2) {
            if (cu.q == 1) {
    ...
    public ca(final cq cq, final boolean b) {
        super(cq, b);
        this.r = 0;
        this.w = null;
        this.q = null;
    ...
    static {
        ca.q = new Color(130, 15, 15);
        ca.w = new Color(240, 130, 40);
        ca.e = new Color(0, 140, 0);
    }
}
