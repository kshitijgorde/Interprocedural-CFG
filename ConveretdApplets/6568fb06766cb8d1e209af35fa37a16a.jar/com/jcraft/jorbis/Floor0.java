...
class Floor0 extends FuncFloor
{
    ...
    int inverse(final Block block, final Object o, final float[] array) {
        ...
        if (read > 0) {
            final float n = read / ((1 << vi.ampbits) - 1) * vi.ampdB;
            ...
            if (read2 != -1 && read2 < vi.numbooks) {
                synchronized (this) {
                    ...
                    Lsp.lsp_to_curve(array, lookFloor0.linearmap, lookFloor0.n, lookFloor0.ln, this.lsp, lookFloor0.m, n, vi.ampdB);
                    return 1;
                }
            }
        }
    ...
    int inverse2(final Block block, final Object o, final Object o2, final float[] array) {
        ...
        if (o2 != null) {
            ...
            Lsp.lsp_to_curve(array, lookFloor0.linearmap, lookFloor0.n, lookFloor0.ln, array2, lookFloor0.m, array2[lookFloor0.m], vi.ampdB);
            return 1;
        }
        for (int i = 0; i < lookFloor0.n; ++i) {
            array[i] = 0.0f;
