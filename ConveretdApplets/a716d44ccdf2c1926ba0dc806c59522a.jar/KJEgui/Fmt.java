...
public class Fmt
{
    ...
    public static String dollarsPad(final double n, final int n2) {
        return number(n, 0, true, false, Fmt.sCP, Fmt.sCS, Fmt.sCC, Fmt.sCD, n2, false, true, ' ');
    }
    
    public static String dollarsPad(final double n, final int n2, final int n3) {
        return number(n, n2, true, true, Fmt.sCP, Fmt.sCS, Fmt.sCC, Fmt.sCD, n3, false, true, ' ');
    }
    ...
    public static String numberPad(final double n, final int n2) {
        return number(n, 0, true, false, Fmt.sNP, Fmt.sNS, Fmt.sPC, Fmt.sPD, n2, false, true, ' ');
    }
    
    public static String numberPad(final double n, final int n2, final int n3) {
        return number(n, n2, true, false, Fmt.sNP, Fmt.sNS, Fmt.sPC, Fmt.sPD, n3, false, true, ' ');
    }
    ...
    public static String percentPad(final double n, final int n2) {
        return number(n * 100.0, 0, true, false, Fmt.sPP, Fmt.sPS, Fmt.sPC, Fmt.sPD, n2, false, true, ' ');
    }
    
    public static String percentPad(final double n, final int n2, final int n3) {
        return number(n * 100.0, n2, true, true, Fmt.sPP, Fmt.sPS, Fmt.sPC, Fmt.sPD, n3, false, true, ' ');
    }
