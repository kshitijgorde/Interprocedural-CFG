    ...
    public String createMessage(final Locale locale, int n, final int n2, final Object[] array) {
        ...
        if (array != null) {
            try {
                ...
                s2 = String.valueOf(this.fResourceBundle.getString(XMLMessages.fgMessageKeys[1])) + " " + this.fResourceBundle.getString(s);
            }
        }
        if (b) {
