...
public class Eda extends public
{
    public Eda(final int[] array, final b b) {
        super("NVI - Negative Volume Index", 3, array, null, b);
        this.G();
    }
    ...
    protected void G() {
        ...
        super.Uoa[2] = Math.max(super.Oa[0], super.Oa[1]) - 1;
    }
