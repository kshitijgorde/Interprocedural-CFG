...
public class StylesheetHandler extends DefaultHandler implements TemplatesHandler, PrefixResolver, NodeConsumer
{
    ...
    private Stack m_importSourceStack;
    ...
    static /* synthetic */ Class class$org$apache$xalan$templates$FuncDocument;
    static /* synthetic */ Class class$org$apache$xalan$templates$FuncFormatNumb;
    ...
    public StylesheetHandler(final TransformerFactoryImpl processor) throws TransformerConfigurationException {
        ...
        this.m_importSourceStack = new Stack();
        this.warnedAboutOldXSLTNamespace = false;
        this.m_nsSupportStack = new Stack();
        this.m_spacePreserveStack = new BoolStack();
        Class func = (StylesheetHandler.class$org$apache$xalan$templates$FuncDocument == null) ? (StylesheetHandler.class$org$apache$xalan$templates$FuncDocument = class$("org.apache.xalan.templates.FuncDocument")) : StylesheetHandler.class$org$apache$xalan$templates$FuncDocument;
        this.m_funcTable.installFunction("document", func);
        func = ((StylesheetHandler.class$org$apache$xalan$templates$FuncFormatNumb == null) ? (StylesheetHandler.class$org$apache$xalan$templates$FuncFormatNumb = class$("org.apache.xalan.templates.FuncFormatNumb")) : StylesheetHandler.class$org$apache$xalan$templates$FuncFormatNumb);
    ...
    public XPath createXPath(final String str, final ElemTemplateElement owningTemplate) throws TransformerException {
        ...
        final XPath xpath = new XPath(str, owningTemplate, this, 0, handler, this.m_funcTable);
    ...
    XPath createMatchPatternXPath(final String str, final ElemTemplateElement owningTemplate) throws TransformerException {
        final ErrorListener handler = this.m_stylesheetProcessor.getErrorListener();
        final XPath xpath = new XPath(str, owningTemplate, this, 1, handler, this.m_funcTable);
        xpath.callVisitors(xpath, new ExpressionVisitor(this.getStylesheetRoot()));
        return xpath;
    }
    ...
    void pushImportSource(final Source sourceFromURIResolver) {
    ...
    String peekImportURL() {
        return this.m_importStack.peek();
    }
    
    Source peekSourceFromURIResolver() {
        return this.m_importSourceStack.peek();
    }
    
    Source popImportSource() {
        return this.m_importSourceStack.pop();
    }
