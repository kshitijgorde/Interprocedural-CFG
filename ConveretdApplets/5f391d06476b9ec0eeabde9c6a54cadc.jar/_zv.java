...
public class _zv
{
    ...
    public final synchronized double a(final double n) {
        return this.p(Math.atan2(this.d / 2, this.p / 2 / Math.tan(this.v(n / 2.0)))) * 2.0;
    }
    ...
    public final synchronized void p(final double n, final double n2, final double n3, final long n4, final long n5) {
        ...
        this.b = this.p(n18);
        this.c = this.p(n19);
        this.e = this.p(((n10 > n16) ? n10 : n16) * 2.0);
    }
    ...
    public synchronized double p(final int n, final int n2) {
        ...
        while (l > this.i) {
            final double n5 = this.p(Math.atan2(n2 / 2, n4 / Math.tan(this.v(l / 2.0)))) * 2.0;
            if (this.d() || this.a()) {
    ...
    public synchronized double n(final double n) {
        double n3;
        if (this.a() || this.d()) {
            this.d = this.a(n);
            double n2;
    ...
    public synchronized double p(final double n, final double n2) {
        double n3;
        if (this.d()) {
            n3 = this.p(Math.atan2(Math.tan(this.v(n2 / 2.0)), Math.cos(this.v(n)) - Math.tan(this.v(this.a(n2) / 2.0)) * Math.sin(this.v(Math.abs(n))))) + 0.5;
        }
        else {
            n3 = 0.0;
        }
