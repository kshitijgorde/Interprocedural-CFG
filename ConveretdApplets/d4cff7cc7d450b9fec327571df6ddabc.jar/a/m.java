...
public final class m extends Canvas
{
    ...
    final void q(int width) {
        final Graphics graphics;
        if ((graphics = this.getGraphics()) != null) {
            final Rectangle q;
            int x = (q = this.q(width)).x;
            int y = q.y;
            int height = q.height;
            width = q.width;
        ...
        if (this.isShowing()) {
            ...
            for (int i = this.q.w; i < n; ++i) {
                ...
                if ((graphics2 = this.getGraphics()) != null) {
                    ...
                    final boolean b;
                    if (!(b = (n3 < 0 || n3 >= l.q(this.q).q()))) {
                        Image image = null;
                        if (l.q(this.q).q(n3) instanceof bj) {
                            image = ((bj)l.q(this.q).q(n3)).q;
                        }
                        if (l.q(this.q).q(n3) instanceof bg) {
                            image = ((bg)l.q(this.q).q(n3)).q;
                        }
                        if (l.q(this.q).q(n3) instanceof bn) {
                            image = ((bn)l.q(this.q).q(n3)).q;
                        }
                        final Rectangle q3 = this.q(n3 - this.q.w);
                        final int n4 = 1 + q3.x + (q3.width - 24) / 2;
                        final int n5 = 1 + q3.y + (q3.height - 24) / 2;
                        if (image != null) {
