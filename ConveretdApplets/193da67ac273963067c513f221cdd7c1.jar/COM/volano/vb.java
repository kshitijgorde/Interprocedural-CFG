...
public abstract class vb extends Applet implements Runnable, Observer
{
    ...
    public String getAppletInfo() {
        return String.valueOf(this.getClass().getName()) + " " + "2.8.3" + " " + "(www.volano.com)" + "\n" + "Copyright (c) 1996-2009 Volano Software";
    }
    ...
    public void init() {
        ...
        if (this.a.bm != null) {
            this.setFont(this.a.bm);
        }
        this.setLayout(new BorderLayout());
        this.c = new vf(this.a.b, this.a.by, this.a.bz, this.a.bx, this.a.du, this.a.b0, this.a.b1);
        this.d = new Label(this.a.dv, 1);
    }
    ...
    public void a(final URL url) {
        ...
        this.d.setText(vaq.a(this.a.dz, vector));
        this.f = 0;
    }
    ...
    private void e() throws IOException {
        ...
        vector.addElement((String)new Integer(this.a.am));
        this.d.setText(vaq.a(this.a.dw, vector));
