...
public final class dS extends Panel
{
    private int q;
    private int w;
    public TextField q;
    ...
    public final boolean handleEvent(final Event event) {
        switch (event.id) {
            case 502: {
                if (event.target == this && this.q && !cM.q) {
                    final cM cm;
                    (cm = new cM(this)).q = this.q;
                    cm.q(this.getBackground());
                    cm.w();
                    break;
                }
                break;
            ...
            case 1004: {
                if (event.target == this && this.q != null) {
                    this.q.setText(ds.q(this.getBackground()));
                    break;
                }
                break;
            }
