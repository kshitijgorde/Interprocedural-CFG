...
public class ValueAxis extends Axis
{
    ...
    public String getLabel(final float n) {
        return (super._gGraph._sValueLabels == null) ? ((this._iFormat == 4) ? Fmt.percent(n, 1) : ((this._iFormat == 3) ? ((this._fAbsoluteMaxValue - this._fAbsoluteMinValue <= 5.0f && n != 0.0f) ? Fmt.dollars(n, 2) : Fmt.dollars(n, 0)) : ((this._fIncrement >= 1.0f) ? Fmt.number(n) : new Float(n).toString()))) : super._gGraph._sValueLabels[(int)n];
    }
    ...
    public String getProperty() {
        return String.valueOf(super._bUseTextImages) + "|" + super._bShow + "|" + this._iFormat + "|" + this._bDescending + "|" + this._bAutoMaximum + "|" + this._bAutoMinimum + "|" + Graph.number(this._axisMinimum, 2) + "|" + Graph.number(this._axisMaximum, 2);
    }
    ...
    public void setINF(final Graphics graphics, final Graph gGraph) {
        ...
        else if (this._fAbsoluteMaxValue < 1.0f && this._fAbsoluteMaxValue > -1.0f && this._fAbsoluteMinValue < 1.0f && this._fAbsoluteMinValue > -1.0f && this._iFormat == 3) {
            this._fAbsoluteMaxValue = 1.0f;
        }
        this.setIncrement(this._fAbsoluteMaxValue - this._fAbsoluteMinValue);
    ...
    public void setProperty(final String s) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            switch (n) {
                ...
                case 2: {
                    this._iFormat = Graph.sgv(nextToken, this._iFormat);
                    break;
                }
                case 3: {
                    this._bDescending = Graph.sgv(nextToken, this._bDescending);
                    break;
                }
                case 4: {
                    this._bAutoMaximum = Graph.sgv(nextToken, this._bAutoMaximum);
                    break;
                }
                case 5: {
                    this._bAutoMinimum = Graph.sgv(nextToken, this._bAutoMinimum);
                    break;
                }
                case 6: {
                    this._axisMinimum = Graph.sgv(nextToken, this._axisMinimum);
                    break;
                }
                case 7: {
                    this._axisMaximum = Graph.sgv(nextToken, this._axisMaximum);
                    break;
                }
            }
            ++n;
