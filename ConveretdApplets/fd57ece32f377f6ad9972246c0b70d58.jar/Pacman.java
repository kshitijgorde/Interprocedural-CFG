...
public class Pacman extends Applet
{
    ...
    public void init() {
        ...
        this.instructions.addItem("Send shareware fee to David Kaplan");
        this.instructions.addItem("75 Fleur Place");
        this.instructions.addItem("Atherton, CA, 94027 (USA)");
    ...
    public void paint(final Graphics graphics) {
        ...
        if (!Pacman.soundsLoaded) {
            ...
            graphics.setColor(Color.red);
            graphics.drawString("This game is shareware.  If you play it and enjoy it, send $2 to", 30, 50);
            graphics.drawString("the address below.  If you wish to use the applet on your website,", 30, 65);
            graphics.drawString("please acknowledge the author (David Kaplan) and send $10 to the address below.", 30, 80);
            graphics.drawString("I will e-mail you the source code, too, once I receive the money.  Thank you.", 30, 95);
            graphics.drawString("David Kaplan", 30, 110);
            graphics.drawString("75 Fleur Place", 30, 125);
            graphics.drawString("Atherton, CA (USA), 94027", 30, 140);
        }
