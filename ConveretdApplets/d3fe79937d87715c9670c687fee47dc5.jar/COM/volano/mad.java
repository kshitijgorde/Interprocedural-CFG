...
public class mad extends TextArea
{
    private int a;
    private int b;
    private int c;
    ...
    public synchronized void a(final String s, final int n) {
        ...
        if (this.d.stringWidth(s) <= n2) {
            ...
            while (a.hasMoreTokens()) {
                ...
                if (this.d.stringWidth(String.valueOf(sb2) + nextToken + " ") <= n2) {
    ...
    private StringTokenizer a(final StringTokenizer stringTokenizer, final String s, final int n) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            String s2;
            String substring;
            for (s2 = stringTokenizer.nextToken(); this.d.stringWidth(String.valueOf(s2) + string) > n; s2 = s2.substring(substring.length(), s2.length())) {
                int n2;
                for (n2 = 1; n2 <= s2.length() && this.d.stringWidth(String.valueOf(s2.substring(0, n2)) + string) <= n; ++n2) {}
