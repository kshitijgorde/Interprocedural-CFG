...
public class HTMLSerializer extends BaseMarkupSerializer
{
    ...
    public void startElement(final String s, final String s2, String string, final Attributes attributes) {
        ...
        else if (s.equals(HTMLSerializer.XHTMLNamespace)) {
            s3 = s2;
        }
        else {
            s3 = null;
        ...
        super._printer.printText('<');
        if (HTMLSerializer._xhtml) {
            super._printer.printText(string.toLowerCase());
        }
        else {
        ...
        if (attributes != null) {
            for (int i = 0; i < attributes.getLength(); ++i) {
                ...
                final String lowerCase = attributes.getQName(i).toLowerCase();
                final String value = attributes.getValue(i);
                if (HTMLSerializer._xhtml || s != null) {
                    if (value == null) {
    ...
    public void endElement(final String s, final String s2, final String s3) {
        ...
        final ElementState elementState = this.getElementState();
        String s4;
        if (elementState.namespaceURI == null) {
            s4 = elementState.rawName;
        }
        else if (elementState.namespaceURI.equals(HTMLSerializer.XHTMLNamespace)) {
        ...
        if (HTMLSerializer._xhtml) {
            if (elementState.empty) {
                ...
                super._printer.printText("</");
                super._printer.printText(elementState.rawName.toLowerCase());
                super._printer.printText('>');
            }
        }
        else {
    ...
    public void startElement(final String s, final AttributeList list) {
        ...
        super._printer.printText('<');
        if (HTMLSerializer._xhtml) {
            super._printer.printText(s.toLowerCase());
        }
        else {
        ...
        if (list != null) {
            for (int i = 0; i < list.getLength(); ++i) {
                super._printer.printSpace();
                final String lowerCase = list.getName(i).toLowerCase();
    ...
    protected void startDocument(final String s) {
        ...
        if (!super._started) {
            ...
            if (!super._format.getOmitDocumentType()) {
                if (super._docTypePublicId != null && (!HTMLSerializer._xhtml || super._docTypeSystemId != null)) {
    ...
    protected void serializeElement(final Element element) {
        ...
        super._printer.printText('<');
        if (HTMLSerializer._xhtml) {
            super._printer.printText(tagName.toLowerCase());
        }
        else {
        ...
        if (attributes != null) {
            for (int i = 0; i < attributes.getLength(); ++i) {
                ...
                final String lowerCase = attr.getName().toLowerCase();
    ...
    protected void characters(final String s) {
        this.content().doCData = false;
        super.characters(s);
    }
