...
class t extends Frame implements ActionListener
{
            ...
            Label_0118: {
                ...
                Label_0115: {
                    if (!r) {
                        ...
                        w.a(this.a).a(t.z[1] + this.a.r + t.z[5] + this.a.c.getItem(n3), 1);
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "xw>".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "\u000b3)\ri".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "\r2\u001e\u0018o".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "\u001b92\rd*".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "xq>Y".toCharArray();
