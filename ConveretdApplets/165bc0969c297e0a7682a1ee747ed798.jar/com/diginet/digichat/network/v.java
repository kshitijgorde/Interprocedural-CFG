...
public class v
{
    ...
    protected void a() {
        ...
        if (n > 100) {
            System.out.println(String.valueOf("Message: intCount ").concat(String.valueOf(n)));
        }
        if (n2 > 100) {
            System.out.println(String.valueOf("Message: stringCount ").concat(String.valueOf(n2)));
        }
        if (n3 > 100) {
            System.out.println(String.valueOf("Message: passwordCount ").concat(String.valueOf(n3)));
        }
        if (this.b > 0) {
            if (n > 0) {
    ...
    public int a(final int n, final int n2) throws ArrayIndexOutOfBoundsException {
        if (n < 0 || n >= this.b) {
            throw new ArrayIndexOutOfBoundsException(String.valueOf("itemNumber is out-of-bounds: ").concat(String.valueOf(n)));
        }
        if (n2 < 0 || n2 >= this.e()) {
            throw new ArrayIndexOutOfBoundsException(String.valueOf("index is out-of-bounds: ").concat(String.valueOf(n2)));
        }
    ...
    public e d(final int n, final int n2) throws ArrayIndexOutOfBoundsException {
        if (n < 0 || n >= this.b) {
            throw new ArrayIndexOutOfBoundsException(String.valueOf("itemNumber is out-of-bounds: ").concat(String.valueOf(n)));
        }
        if (n2 < 0 || n2 >= this.g()) {
    ...
    public void a(final int n, final int n2, final e e) throws ArrayIndexOutOfBoundsException {
        if (n < 0 || n >= this.b) {
            throw new ArrayIndexOutOfBoundsException(String.valueOf("itemNumber is out-of-bounds: ").concat(String.valueOf(n)));
        }
        if (n2 < 0 || n2 >= this.g()) {
        ...
        this.g[n * this.g() + n2] = e;
    }
    
    public static final boolean a(final long n, final int n2) {
        if (n2 < 0 || n2 > 63) {
            throw new ArrayIndexOutOfBoundsException(String.valueOf("flag index must be between 0 and 63, inclusive: ").concat(String.valueOf(n2)));
        }
        return (n & 1L << n2) != 0x0L;
    }
    ...
    public void a(final int n, final long n2) throws ArrayIndexOutOfBoundsException {
        if (n < -1 || n >= this.b) {
            throw new ArrayIndexOutOfBoundsException(String.valueOf("itemNumber is out-of-bounds: ").concat(String.valueOf(n)));
        }
        this.h[n + 1] = n2;
    ...
    public v(final DataInput dataInput) throws IOException {
        ...
        synchronized (dataInput) {
            ...
            int c = w.a(this.a);
            if (c == -1) {
                System.out.println(String.valueOf(String.valueOf("Message of type ").concat(String.valueOf(Integer.toString(this.a, 16)))).concat(String.valueOf(" unknown.")));
                c = this.c;
            }
            ...
            final int n6 = c & 0xFF;
            if (c != this.c) {
                System.out.println(String.valueOf(String.valueOf("Message of type ").concat(String.valueOf(Integer.toString(this.a, 16)))).concat(String.valueOf(" upgraded.")));
                this.i = true;
                this.c = c;
            }
            final int int1 = dataInput.readInt();
            if (this.a != 67371268 && this.a != 67371269 && int1 > 1000) {
                System.err.println(String.valueOf("Message: byteCount ").concat(String.valueOf(int1)));
            ...
            this.a();
            if (this.b > 1000) {
                System.err.println(String.valueOf("Message: itemCount ").concat(String.valueOf(this.b)));
            }
            this.h = new long[this.b + 1];
            for (int i = 0; i < this.h.length; ++i) {
                this.h[i] = dataInput.readLong();
            }
            if ((this.a == 67371268 || this.a == 67371269) && int1 != (int)this.h[0]) {
                System.err.println(String.valueOf("Message: byteCount ").concat(String.valueOf(int1)));
                throw new IllegalArgumentException("Message corrupted.");
            }
            if (this.b > 0) {
                ...
                if (this.g != null) {
                    for (int n8 = 0; n8 < this.b; ++n8) {
                        for (int n9 = 0; n9 < n3; ++n9) {
                            if (n9 < n6) {
                                this.g[n8 * n6 + n9] = new e(dataInput);
    ...
    public v(final int a, final int c, final int b) {
        ...
        this.c = c;
        if (b > 1000) {
            System.err.println(String.valueOf("Message: itemCount2 ").concat(String.valueOf(b)));
        }
        this.a();
    }
}
