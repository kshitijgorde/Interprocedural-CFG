...
{
    private final RevolverEngine g;
    public final int a;
    public final int b;
    ...
    public H(final RevolverEngine g) {
        this.j = -10000.0;
        this.k = -110.0;
    ...
    public final U a(Z a) {
        ...
        return new U((int)((-z2.a / z2.c + 0.011) * this.h), (int)((-z2.b / z2.c + 0.011) * this.i));
    }
