...
public class squarelink2 extends Applet implements ImageObserver
{
    public static final String mszAppletInfo = "MightyLink/squarelink for Java 1.1.x\nVersion 1.0.1\nCopyright 1998-1999 by Maier Media\nhttp://www.maiermedia.com\n";
    public static final int FIRE_LINK = 0;
    public static final int CAPTION_CHANGE = 1;
    public squarehelper2 mLinkButton;
    ...
    public String getAppletInfo() {
        return "MightyLink/squarelink for Java 1.1.x\nVersion 1.0.1\nCopyright 1998-1999 by Maier Media\nhttp://www.maiermedia.com\n";
    }
    ...
    public void init() {
        ...
        this.loadImages();
        this.addMouseListener((MouseListener)new squarelisten2(this));
    }
    
    public void paint(final Graphics graphics) {
        final Rectangle bounds = this.getBounds();
        this.mLinkButton.getBounds();
        ...
        if (this.mbMouseDragOut) {
            this.mLinkButton.setBounds(this.mnButtonX, this.mnButtonY, this.mnButtonWidth, this.mnButtonHeight);
            this.mbMouseDragOut = false;
        }
        if (this.mbMouseOver && this.mbMouseDown) {
            this.mLinkButton.setBounds(this.mnButtonX + 1, this.mnButtonY + 1, this.mnButtonWidth, this.mnButtonHeight);
            return;
        }
        this.mLinkButton.setBounds(this.mnButtonX, this.mnButtonY, this.mnButtonWidth, this.mnButtonHeight);
    }
    ...
    public void fireLink() {
        try {
            this.getAppletContext().showDocument(new URL(this.msLink), this.msTargetFrame);
        }
        catch (Exception ex) {
    ...
    public void getParameters() {
        ...
        final String safeParm47 = this.getSafeParm("TARGET");
        if (safeParm47.length() > 0) {
            this.msTargetFrame = safeParm47;
        }
    }
    ...
    public Color getHTMLColor(String trim) {
        ...
        if (trim.charAt(0) == '#') {
            return new Color(this.hexToInt(String.valueOf(trim.substring(trim.indexOf("#") + 1))));
        }
        return Color.white;
    }
    ...
    public squarelink2() {
        this.mLinkButton = new squarehelper2(this);
        this.mbImageReady = true;
        this.mBackgroundColor = Color.white;
        this.mBorderColor = Color.white;
        this.msTargetFrame = "_self";
