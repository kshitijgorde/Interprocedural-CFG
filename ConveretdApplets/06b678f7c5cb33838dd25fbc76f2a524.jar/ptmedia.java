...
public class ptmedia extends Applet implements Runnable
{
    ...
    void InitJMFMedia(final String s) {
        ...
        try {
            ...
            instance = forName.getConstructor((ptmedia.class$java$lang$String == null) ? (ptmedia.class$java$lang$String = class$("java.lang.String")) : ptmedia.class$java$lang$String).newInstance(externalForm);
            if (instance == null) {
                return;
            }
        }
