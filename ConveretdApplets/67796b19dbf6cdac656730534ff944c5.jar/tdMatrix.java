...
class tdMatrix
{
    ...
    public tdMatrix(final double dXx, final double dXy, final double dXz, final double dYx, final double dYy, final double dYz, final double dZx, final double dZy, final double dZz) {
        this.m_dXx = dXx;
        this.m_dXy = dXy;
        this.m_dXz = dXz;
        this.m_dYx = dYx;
