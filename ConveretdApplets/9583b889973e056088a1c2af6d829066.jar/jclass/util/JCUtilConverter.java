...
public class JCUtilConverter
{
    ...
    public static void setParamSource(final Component component, String s) {
        if (s != null) {
            ...
            while ((index3 = s.indexOf(60)) != -1) {
                ...
                if (trim.charAt(0) == '!' || trim.length() < 20 || Character.isSpace(trim.charAt(11))) {
                    continue;
                }
                if (!trim.regionMatches(true, 0, "param name=", 0, 11)) {
                    continue;
                }
                String substring;
                int n;
                ...
                if (!substring.regionMatches(true, n2, "value=", 0, 6)) {
                    continue;
                }
    ...
    public static String getParam(final Applet applet, final Component component, final String s, final String s2) {
        ...
        String s3 = null;
        if (s != null) {
            s3 = getParam(applet, component, String.valueOf(s) + "." + s2);
        }
        if (s3 == null) {
        ...
        if (s3 != null) {
            ...
            while ((index = s3.indexOf(10)) != -1) {
                s3 = String.valueOf(s3.substring(0, index)) + s3.substring(index + 1);
            }
        }
        return s3;
    }
    ...
    public static void parseError(final String s) {
        if (JCUtilConverter.reportErrors) {
    ...
    public static String[] toStringList(final String s, final char c) {
        return toStringList(s, c, true);
    }
    
    public static String[] toStringList(final String s, final char c, final boolean b) {
        if (s == null) {
            return null;
        }
        final JCStringTokenizer jcStringTokenizer = new JCStringTokenizer(s);
    ...
    public static Integer[] toIntegerList(final String s, final char c) {
        if (s == null) {
            return null;
        }
        final JCStringTokenizer jcStringTokenizer = new JCStringTokenizer(s);
        final Integer[] array = new Integer[jcStringTokenizer.countTokens(c)];
        int n = 0;
        while (jcStringTokenizer.hasMoreTokens()) {
            array[n] = new Integer(JCUtilConverter.conv.toInt(jcStringTokenizer.nextToken(c).trim(), 0));
            ++n;
        }
        return array;
    }
    
    public static Double[] toDoubleList(final String s, final char c) {
        if (s == null) {
            return null;
        }
        final JCStringTokenizer jcStringTokenizer = new JCStringTokenizer(s);
        final Double[] array = new Double[jcStringTokenizer.countTokens(c)];
        int n = 0;
        while (jcStringTokenizer.hasMoreTokens()) {
            array[n] = new Double(JCUtilConverter.conv.toDouble(jcStringTokenizer.nextToken(c).trim(), 0.0));
            ++n;
        }
        return array;
    }
    ...
    public static Integer[] toIntegerList(final String s, final char c, final Integer[] array) {
        final Integer[] integerList = toIntegerList(s, c);
        if (integerList != null) {
            return integerList;
        }
        return array;
    ...
    public static Double[] toDoubleList(final String s, final char c, final Double[] array) {
        final Double[] doubleList = toDoubleList(s, c);
        if (doubleList != null) {
            return doubleList;
        }
        return array;
    ...
    public static String fromColorList(final Color[] array) {
        if (array == null) {
            return "";
        }
        ...
        for (int i = 0; i < array.length; ++i) {
            ...
            sb.append(fromColor(array[i]));
        }
        return new String(sb);
    }
    
    public static String fromColor(final Color color) {
        if (color == null) {
            return null;
        }
    ...
    public static String fromFont(final Font font) {
        if (font == null) {
            return null;
        }
        final StringBuffer sb = new StringBuffer();
    ...
    public static int toEnum(String trim, final String s, String s2, final String[][] array, final int[][] array2, final int n) {
        ...
        if (n2 == array.length) {
            error("Error converting '" + trim + "' to " + s2);
            return n;
        }
        trim = trim.trim();
    ...
    public static int toEnum(String trim, final String s, final String[] array, final int[] array2, final int n) {
        ...
        try {
            ...
            error("Error converting '" + trim + "' to " + s);
            return n;
        }
    }
    ...
    public static String fromEnum(final long n, final String[] array, final long[] array2) {
        if (array2 == null || array == null) {
            return null;
        }
        for (int i = 0; i < array2.length; ++i) {
    ...
    public static void checkEnum(final int n, final String s, final int[] array) {
        ...
        throw new IllegalArgumentException("invalid " + s + ": " + n);
    }
    ...
    public static String fromInsets(final Insets insets) {
    ...
    static {
        ...
        JCUtilConverter.reportErrors = true;
    }
}
