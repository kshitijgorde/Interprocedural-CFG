...
public class RubyMarshal$s$0$1$load extends JavaMethodNBlock
{
    public RubyMarshal$s$0$1$load(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block unusedBlock) {
        ...
        return RubyMarshal.load(context, recv, array, unusedBlock);
    }
}
