...
public class IntegerCellEditor extends AbstractCellEditor implements TableCellEditor
{
    ...
    public IntegerCellEditor(final IntegerField integerField) {
        this.clickCountToStart = 1;
        this.integerfield = new IntegerField(10);
    ...
    public IntegerCellEditor() {
        ...
        this.delegate = new EditorDelegate() {
            @Override
            public void setValue(final Object value) {
                IntegerCellEditor.this.integerfield.setValue(value);
            }
            ...
            public Object getCellEditorValue() {
                Integer f;
                try {
                    f = IntegerCellEditor.this.integerfield.getValue();
                }
                catch (Exception ex) {
                    f = new Integer(0);
                }
    ...
    protected class EditorDelegate implements ActionListener, ItemListener, Serializable
    {
        ...
        public boolean isCellEditable(final EventObject anEvent) {
            return !(anEvent instanceof MouseEvent) || ((MouseEvent)anEvent).getClickCount() >= IntegerCellEditor.this.clickCountToStart;
        }
        ...
        public boolean stopCellEditing() {
            IntegerCellEditor.this.fireEditingStopped();
            return true;
        }
        
        public void cancelCellEditing() {
            IntegerCellEditor.this.fireEditingCanceled();
        }
