...
public class RubyKernel$s$srand extends JavaMethodZeroOrOne
{
    public RubyKernel$s$srand(final RubyModule implementationClass, final Visibility visibility) {
