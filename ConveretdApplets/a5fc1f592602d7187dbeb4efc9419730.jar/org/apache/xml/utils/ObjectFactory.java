...
class ObjectFactory
{
    ...
    static /* synthetic */ Class class$org$apache$xml$utils$ObjectFactory;
    ...
    static String lookUpFactoryClassName(final String factoryId, String propertiesFilename, final String fallbackClassName) {
        ...
        if (propertiesFilename == null) {
            ...
            final Class clazz = (ObjectFactory.class$org$apache$xml$utils$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xml$utils$ObjectFactory = class$("org.apache.xml.utils.ObjectFactory")) : ObjectFactory.class$org$apache$xml$utils$ObjectFactory;
            synchronized (clazz) {
    ...
    static ClassLoader findClassLoader() throws ConfigurationError {
        ...
        ClassLoader current;
        for (current = ((ObjectFactory.class$org$apache$xml$utils$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xml$utils$ObjectFactory = class$("org.apache.xml.utils.ObjectFactory")) : ObjectFactory.class$org$apache$xml$utils$ObjectFactory).getClassLoader(), chain = system; current != chain; chain = ss.getParentClassLoader(chain)) {
            if (chain == null) {
                return current;
            }
        }
    ...
    static Class findProviderClass(final String className, ClassLoader cl, final boolean doFallback) throws ClassNotFoundException, ConfigurationError {
        ...
        if (cl == null) {
            ...
            try {
                ...
                final ClassLoader current = ((ObjectFactory.class$org$apache$xml$utils$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xml$utils$ObjectFactory = class$("org.apache.xml.utils.ObjectFactory")) : ObjectFactory.class$org$apache$xml$utils$ObjectFactory).getClassLoader();
                if (current == null) {
                    providerClass = Class.forName(className);
                }
                else {
