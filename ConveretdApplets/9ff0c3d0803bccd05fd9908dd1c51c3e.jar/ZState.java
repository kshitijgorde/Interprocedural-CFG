...
class ZState
{
    ...
    String get_save_file_name(final Frame frame) {
        ...
        try {
            ...
            string = String.valueOf(fileDialog.getDirectory()) + fileDialog.getFile();
        }
    ...
    String get_restore_file_name(final Frame frame) {
        String string;
        try {
    ...
    boolean restore_from_disk(final Frame frame) {
    ...
    void write_cmem_chunk(final IFFOutputFile iffOutputFile) throws IOException {
    ...
    boolean disk_save(final Frame frame, final int n) {
