...
public class RubyKernel$s$0$3$eval extends JavaMethodNBlock
{
    public RubyKernel$s$0$3$eval(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyKernel.eval(context, recv, array, block);
    }
}
