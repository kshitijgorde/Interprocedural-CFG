...
{
    public static final String aktVersion = "00.12.005";
    public static final boolean m_bUnstableVersion = false;
    private static final String CVS_GENERATED_RELEASE_DATE = "$Date: 2009-08-25 11:42:01 +0200 (Tue, 25 Aug 2009) $";
    public static final boolean m_bReleasedVersion = true;
    private static final String RELEASE_DATE = "2009/08/25 12:05:00";
    public static final String CURRENT_CONFIG_VERSION = "00.12.005";
    public static final String strReleaseDate;
    ...
    static final String[] DEFAULT_ANON_MIX_IDs;
    static final String[] DEFAULT_ANON_HOSTS;
    ...
    public static final String[] PI_CERTS;
    ...
    public static final String[] PAYMENT_ROOT_CERTS;
    ...
    public static final String[] MIX_ROOT_CERTS;
    public static final String[] INFOSERVICE_ROOT_CERTS;
    public static final String TERMS_CERTSPATH = "acceptedTaCTemplates/";
    public static final String[] TERMS_CERTS;
    ...
    public static String[] getSupportedLanguages() {
        final String[] array = new String[JAPConstants.SUPPORTED_LANGUAGES.length];
        for (int i = 0; i < array.length; ++i) {
            array[i] = JAPConstants.SUPPORTED_LANGUAGES[i];
        }
        return array;
    }
    
    static {
        strReleaseDate = "2009/08/25 12:05:00";
        DEFAULT_ANON_MIX_IDs = new String[] { "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" };
        DEFAULT_ANON_HOSTS = new String[] { "0.0.0.0" };
        DEFAULT_ANON_PORT_NUMBERS = new int[] { 6544 };
        DEFAULT_INFOSERVICE_NAMES = new String[] { "880D9306B90EC8309178376B43AC26652CE52B74", "8FF9236BD03A12391D939219310597C830F3943A", "1E47E65976C6F7868047B6E9A06654B8AFF36A38", "AE116ECB775FF127C02DF96F5466AECAF86B93A9" };
        DEFAULT_INFOSERVICE_HOSTNAMES = new String[] { "infoservice.inf.tu-dresden.de", "87.230.56.74", "78.129.146.44", "72.55.137.241" };
        DEFAULT_INFOSERVICE_PORT_NUMBERS = new int[][] { { 80, 6543 }, { 80, 443 }, { 80, 443 }, { 80, 443 } };
        ACCOUNTICONFNARRAY = new String[] { "accountDisabled.gif", "accountOk.gif", "accountBroken.gif" };
        BROWSERLIST = new String[] { "firefox", "iexplore", "explorer", "mozilla", "konqueror", "mozilla-firefox", "firebird", "opera" };
        PI_CERTS = new String[] { "bi.cer.dev", "Payment_Instance.cer" };
        PAYMENT_ROOT_CERTS = new String[0];
        MIX_ROOT_CERTS = new String[] { "japmixroot.cer", "Operator_CA.cer", "Test_CA.cer.dev", "gpf_jondonym_ca.cer" };
        INFOSERVICE_ROOT_CERTS = new String[] { "japinfoserviceroot.cer", "InfoService_CA.cer" };
        TERMS_CERTS = new String[] { "Terms_and_Conditions.b64.cer" };
        SUPPORTED_LANGUAGES = new String[] { "en", "de", "cs", "nl", "fr", "ru" };
    }
}
