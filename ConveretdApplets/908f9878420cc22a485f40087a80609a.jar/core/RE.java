...
public final class RE extends Applet implements Runnable
{
    ...
    public final void init() {
        this.h = (this.getDocumentBase().getHost().endsWith(I.I.I(247)) && this.getParameter(I.I.I(264)) != null && this.getParameter(I.I.I(264)).equals(I.I.I(267)));
        final D.I a = D.I.a(this);
        final int n = this.getDocumentBase().getHost().endsWith(I.I.I(247)) ? 700 : 350;
        int n2 = 300;
        try {
            final int int1;
            if ((int1 = Integer.parseInt(this.getParameter(I.I.I(53)))) >= 180 && int1 <= n) {
                n2 = int1;
            }
        }
        catch (Exception ex) {}
        ...
        this.i = this.getParameter(I.I.I(269));
        if (this.i == null) {
            this.i = I.I.I(271);
        }
        this.p = new K(new Z.Z(this, K.a(this.a(), I.I.I(273) + ((this.a > 500) ? I.I.I(278) : I.I.I(283)) + I.I.I(67) + this.i + I.I.I(288))));
        this.setBackground(new Color(16777215));
        this.e = new P(this);
        this.f = new Y(this);
        int int2 = 16747008;
        try {
            int2 = Integer.parseInt(this.getParameter(I.I.I(293)), 16);
        }
        catch (Exception ex2) {}
        this.c = new S(this);
        this.setLayout(null);
        this.k = new Z(new FI(this));
        final V v;
        (v = new V(5, this.b - 40, 16, this.getImage(this.getClass().getResource(I.I.I(295))))).addMouseListener(this.k.b());
        v.setCursor(new Cursor(12));
        this.add(v);
        final V v2;
        (v2 = new V(5, this.b - 21, 16, this.getImage(this.getClass().getResource(I.I.I(317))))).addMouseListener(this.k.c());
        v2.setCursor(new Cursor(12));
        this.add(v2);
        try {
            this.getClass().getMethod(I.I.I(374), Class.forName(I.I.I(340))).invoke(this, new G(this));
        }
        catch (Exception ex3) {}
        this.l = new Z(new DI(this));
        final V v3;
        (v3 = new V(43, this.b - 40, 16, this.getImage(this.getClass().getResource(I.I.I(396))))).addMouseListener(this.l.b());
        v3.setCursor(new Cursor(12));
        this.add(v3);
        final V v4;
        (v4 = new V(43, this.b - 21, 16, this.getImage(this.getClass().getResource(I.I.I(417))))).addMouseListener(this.l.c());
        v4.setCursor(new Cursor(12));
        this.add(v4);
        this.m = new Z(new BI(this));
        final V v5;
        (v5 = new V(24, this.b - 40, 16, this.getImage(this.getClass().getResource(I.I.I(440))))).addMouseListener(this.m.b());
        v5.setCursor(new Cursor(12));
        this.add(v5);
        final V v6;
        (v6 = new V(24, this.b - 21, 16, this.getImage(this.getClass().getResource(I.I.I(463))))).addMouseListener(this.m.c());
        v6.setCursor(new Cursor(12));
        this.add(v6);
        final V v7;
        (v7 = new V(this.a - 85 - 5, this.b - 16 - 5, 85, this.getImage(this.getClass().getResource(I.I.I(487))))).setCursor(new Cursor(12));
        v7.addMouseListener(new CI(this));
        this.add(v7);
        if (!this.h) {
            final V v8;
            (v8 = new V(62, this.b - 21, 16, this.getImage(this.getClass().getResource(I.I.I(508))))).setCursor(new Cursor(12));
            v8.addMouseListener(new D(this));
            this.add(v8);
        }
        this.q = a.a(this, new C.I(K.a(this.a(), I.I.I(546) + ((this.getParameter(I.I.I(529)) != null) ? this.getParameter(I.I.I(529)) : I.I.I(538)) + I.I.I(62)), int2, this.p));
        this.validate();
    }
    ...
    public final void run() {
        final double n = (this.p.a - 1) / 6.283185307179586;
        final double n2 = (this.p.b - 1) / 3.141592653589793;
        ...
        this.n = new T(this, this.a, this.b);
        System.gc();
            ...
            for (int i = 0; i < this.c.b; ++i) {
                ...
                for (int j = 0; j < this.c.a; ++j) {
                    ...
                    if ((n19 = n17 * n17 + n16) < n11) {
                        ...
                        final int n41;
                        T.a(this.n)[n12 + j] = this.a(this.c.c[n8], (n41 = this.p.a * (int)(acos * n2)) + (int)(n38 * n));
                        ...
                        T.a(this.n)[n12 + n30] = this.a(this.c.d[n8], n41 + (int)(n45 * n));
                        ...
                        final int n58;
                        T.a(this.n)[n13 + j] = this.a(this.c.c[n8], (n58 = this.p.a * (int)(acos2 * n2)) + (int)(n55 * n));
                        ...
                        T.a(this.n)[n13 + n30] = this.a(this.c.d[n8], n58 + (int)(n62 * n));
                    }
                    else {
                        final int n65 = this.c.c[n8] & 0xFF;
                        final int n66 = 255 - n65;
                        T.a(this.n)[n12 + j] = (n65 + (n5 * n66 >> 8) << 16 | n65 + (n6 * n66 >> 8) << 8 | n65 + (n7 * n66 >> 8));
                        final int n67 = this.c.d[n8] & 0xFF;
                        final int n68 = 255 - n67;
                        final int n69 = n67 + (n5 * n68 >> 8) << 16 | n67 + (n6 * n68 >> 8) << 8;
                        final int n70 = n4 - j;
                        T.a(this.n)[n12 + n70] = (n69 | n67 + (n7 * n68 >> 8));
                        final int n71 = this.c.e[n8] & 0xFF;
                        final int n72 = 255 - n71;
                        T.a(this.n)[n13 + j] = (n71 + (n5 * n72 >> 8) << 16 | n71 + (n6 * n72 >> 8) << 8 | n71 + (n7 * n72 >> 8));
                        final int n73 = this.c.f[n8] & 0xFF;
                        final int n74 = 255 - n73;
                        T.a(this.n)[n13 + n70] = (n73 + (n5 * n74 >> 8) << 16 | n73 + (n6 * n74 >> 8) << 8 | n73 + (n7 * n74 >> 8));
                    }
                    ++n8;
                }
            }
            this.q.a(this.n);
            T.b(this.n).newPixels();
    ...
    private final int a(int n, final int n2) {
        n &= 0xFF;
        int n3;
        if ((n3 = (K.a(this.p)[n2] & 0xFF) + n) > 255) {
            n3 = 255;
        }
        final int n4 = n3 << 16;
        int n5;
        if ((n5 = (K.b(this.p)[n2] & 0xFF) + n) > 255) {
            n5 = 255;
        }
        final int n6 = n4 | n5 << 8;
        int n7;
        if ((n7 = (K.c(this.p)[n2] & 0xFF) + n) > 255) {
            n7 = 255;
        }
        return n6 | n7;
    }
    ...
    public final boolean a(String parameter, final boolean b) {
        if ((parameter = this.getParameter(parameter)) != null) {
            return parameter.equals(I.I.I(563));
        }
        return b;
    }
    ...
    static final void a(final RE re, final Image j) {
        re.j = j;
    }
    
    static final String a(final RE re) {
        return re.i;
    }
}
