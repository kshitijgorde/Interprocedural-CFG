...
class FactoryFinder
{
    ...
    static Object find(final String s, final String s2) throws ConfigurationError {
        ...
        if (classLoader == null) {
            classLoader = ((FactoryFinder.class$javax$xml$transform$FactoryFinder == null) ? (FactoryFinder.class$javax$xml$transform$FactoryFinder = class$("javax.xml.transform.FactoryFinder")) : FactoryFinder.class$javax$xml$transform$FactoryFinder).getClassLoader();
        }
        ...
        final Class clazz = (FactoryFinder.class$javax$xml$transform$FactoryFinder == null) ? (FactoryFinder.class$javax$xml$transform$FactoryFinder = class$("javax.xml.transform.FactoryFinder")) : FactoryFinder.class$javax$xml$transform$FactoryFinder;
        synchronized (clazz) {
            int n = 0;
