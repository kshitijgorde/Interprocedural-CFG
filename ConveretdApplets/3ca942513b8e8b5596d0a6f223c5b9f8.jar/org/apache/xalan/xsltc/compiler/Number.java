...
final class Number extends Instruction implements Closure
{
    ...
    private void compilePatterns(final ClassGenerator classGen, final MethodGenerator methodGen) {
        ...
        if (this._from != null) {
            ...
            final MatchGenerator matchGen = new MatchGenerator(17, com.ibm.xslt4j.bcel.generic.Type.BOOLEAN, new com.ibm.xslt4j.bcel.generic.Type[] { com.ibm.xslt4j.bcel.generic.Type.INT }, new String[] { "node" }, "matchesFrom", this._className, il, cpg);
        ...
        if (this._count != null) {
            il = new InstructionList();
            final MatchGenerator matchGen = new MatchGenerator(17, com.ibm.xslt4j.bcel.generic.Type.BOOLEAN, new com.ibm.xslt4j.bcel.generic.Type[] { com.ibm.xslt4j.bcel.generic.Type.INT }, new String[] { "node" }, "matchesCount", this._className, il, cpg);
            this.compileLocals(nodeCounterGen, matchGen, il);
            il.append(matchGen.loadContextNode());
