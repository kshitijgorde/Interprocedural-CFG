...
public class RubyFile$s$0$1$basename extends JavaMethodN
{
    public RubyFile$s$0$1$basename(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyFile.basename(context, recv, array);
    }
}
