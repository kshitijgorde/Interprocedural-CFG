...
public class PrivManager implements PrivInter, Runnable
{
    ...
    public void receivedAvReject(final String s, final String s2) {
        this.getNewPrivate(s2, s).displayText(this.paraApplet.paraConf.get("Msg.Av.Rjt", "Your party has declined your video chat."), null);
    }
    ...
    public void receivedAvWeb(final String s, final String s2, final String s3) {
        ...
        newPrivate.displayText(this.paraApplet.paraConf.get("Msg.Av.Bker", "If you have popup blocker, copy the URL below and open it in a web browser."), null);
        newPrivate.displayText(s3, null);
