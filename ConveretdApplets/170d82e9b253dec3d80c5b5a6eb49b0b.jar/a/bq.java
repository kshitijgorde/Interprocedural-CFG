...
public final class bq extends Canvas implements dT, Runnable
{
    private Thread q;
    private int q;
    private int w;
    ...
    public bq(final cV q) {
        this.x = 0;
        this.r = false;
        this.q = q;
        final int e = cf.w.e;
        final Color q2 = cf.w.q;
        this.q = cf.w.n;
        this.r();
    }
    ...
    private void r() {
        ...
        this.q = (Frame)eb.q(this, !cV.s());
        this.e = true;
    }
    
    public final void q(final cs cs) {
        this.q(cs.getName(), cs);
    }
    
    public final void q(final String s, final cs cs) {
        if (!cs.e()) {
            if (this.q.b_() && cs.q()) {
                return;
            }
        ...
        if (q.w == null || w.trim().equals("")) {
            ...
            this.r.addElement(ec.q(eb.q("Follow link %1"), w));
        }
        this.e.addElement(w);
        final Font font = new Font(cs.q, cs.u(), cs.w);
        this.i.addElement(font);
        this.o.addElement(this.getFontMetrics(font));
        this.t.addElement(new Color(cs.y()));
        this.y.addElement(q.q);
        this.u.addElement(new Color(cs.t()));
    ...
    private void y() {
        ...
        this.q = dU.q(this, this.q, this.w, "sl.r-q");
    ...
    private void u() {
        ...
        this.w = dU.q(this, this.q, this.w, "sl.r-p");
    ...
    private br q(final String q) {
        final br br = new br(this);
        int n = 0;
        String sval = null;
        String sval2 = null;
