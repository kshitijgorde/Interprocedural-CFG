...
public class aj
{
    ...
    public static void a(final bw bw, final byte[] array, final int n) throws Exception {
        int n2 = 0;
        for (int i = 0; i < n; ++i) {
            if (array[i] == 62) {
                n2 = i;
        ...
        for (int length = array3.length, j = 0; j < length; ++j) {
            try {
                ...
                if (a(string.getBytes(), string.length(), array, n2)) {
                    a(bw, new String(array, 0, n, array3[j]).toCharArray(), n);
                    return;
                }
            }
            catch (Exception ex) {}
        }
        a(bw, new String(array, 0, n).toCharArray(), n);
    }
    ...
    public static void a(final bw bw, final char[] array, final int n) throws Exception {
