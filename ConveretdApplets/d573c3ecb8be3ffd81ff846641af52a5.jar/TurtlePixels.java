...
public abstract class TurtlePixels
{
    ...
    public TurtlePixels(final int n, final int n2, final float currentHeading) {
        if (n >= n2) {
            this.turtleSideSize = n + n / 4;
        }
        else {
            this.turtleSideSize = n2 + n2 / 4;
        }
        ...
        this.initTurtlePixels(this.baseTurtlePixels, this.turtleSideSize);
        ...
        this.updateTurtlePixels(this.currentHeading = currentHeading);
    }
    ...
    private void updateTurtlePixels(final float n) {
        ...
        if (n == 0.0f) {
            ...
            for (int l = 0; l < this.turtleSideSize; ++l) {
                final int n4 = l * this.turtleSideSize;
                ...
                for (int n6 = 0; n6 < this.turtleSideSize; ++n6) {
                    ...
                    if (n8 >= 0) {
                        if (n8 < this.turtleSideSize) {
                            if (n9 >= 0) {
                                if (n9 < this.turtleSideSize) {
                                    this.turtlePixels[n4 + n6] = this.baseTurtlePixels[n9 * this.turtleSideSize + n8];
                                }
                            }
                        }
                    }
    ...
    public void fillCirclePixels(int n, int i, final int n2, final int n3) {
        n = 0;
        i = n2;
        float n4 = 1.25f - n2;
        while (i > n) {
    ...
    public void fillPixel(final int n, final int n2, final int n3) {
        ...
        if (n < 0 || n > this.turtleSideSize) {
            System.err.println(s + "x=" + n + s2);
        }
        else if (n2 < 0 || n2 > this.turtleSideSize) {
            System.err.println(s + "y=" + n2 + s2);
        }
        else {
            this.baseTurtlePixels[n + n2 * this.turtleSideSize] = n3;
        }
    }
    
    public int[] getPixels() {
        return this.turtlePixels;
    }
    ...
    public void setTurtleColor(final Color color) {
        ...
        this.updateTurtlePixels(this.currentHeading);
    }
    
    public void setTurtleHeading(final float currentHeading) {
