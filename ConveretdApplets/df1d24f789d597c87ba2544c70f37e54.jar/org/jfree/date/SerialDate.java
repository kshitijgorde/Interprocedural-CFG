...
public abstract class SerialDate implements Comparable, Serializable, MonthConstants
{
    ...
    public static SerialDate addYears(final int n, final SerialDate serialDate) {
        ...
        return createInstance(Math.min(serialDate.getDayOfMonth(), lastDayOfMonth(month, yyyy)), month, yyyy + n);
    }
    
    public static SerialDate getPreviousDayOfWeek(final int n, final SerialDate serialDate) {
        if (!isValidWeekdayCode(n)) {
            throw new IllegalArgumentException("SerialDate.getPreviousDayOfWeek(...): invalid day-of-the-week code.");
        }
    ...
    public static SerialDate getFollowingDayOfWeek(final int n, final SerialDate serialDate) {
        if (!isValidWeekdayCode(n)) {
            throw new IllegalArgumentException("SerialDate.getFollowingDayOfWeek(...): invalid day-of-the-week code.");
        }
        final int dayOfWeek = serialDate.getDayOfWeek();
        int max;
        if (dayOfWeek > n) {
    ...
    public static SerialDate getNearestDayOfWeek(final int n, final SerialDate serialDate) {
        if (!isValidWeekdayCode(n)) {
            throw new IllegalArgumentException("SerialDate.getNearestDayOfWeek(...): invalid day-of-the-week code.");
        }
