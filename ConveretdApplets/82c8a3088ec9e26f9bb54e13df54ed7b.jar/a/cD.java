...
final class cD extends Canvas
{
    ...
    public final synchronized void update(final Graphics graphics) {
        this.getSize();
        if (cD.q == null) {
            cD.q = cs.q(this, this.getSize().width, this.getSize().height, "vcr.u");
        }
        final Graphics graphics2 = cD.q.getGraphics();
        this.q = new Rectangle(8, 0, 8, 150);
        graphics2.setColor(Color.black);
        graphics2.drawImage(this.q.q(cD.q), 0, 0, this);
        ...
        graphics2.dispose();
        graphics.drawImage(cD.q, 0, 0, this);
    }
