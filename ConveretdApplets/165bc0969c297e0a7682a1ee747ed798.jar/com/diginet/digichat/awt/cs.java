...
public class cs extends r
{
    ...
    public void a(final Graphics graphics) {
        ...
        final Color clrCtrlBack = CommonStyle.clrCtrlBack;
        final Color darker = clrCtrlBack.darker();
        darker.darker();
        ...
        if (super.f) {
            ...
            graphics.setColor(clrCtrlBack);
            graphics.fillPolygon(g2);
            graphics.setColor((!super.e || !super.d) ? Color.white : darker);
            if (b) {
    ...
    public cs(final int n, final int n2, final int a) {
        super(n, n2);
        this.a = a;
    }
}
