...
public class PropertyPrinter implements PropertyGetter.PropertyCallback
{
    ...
    protected void printOptions(final PrintWriter out, final Logger cat) {
        ...
        final String catKey = (cat == Logger.getRootLogger()) ? "log4j.rootLogger" : ("log4j.logger." + cat.getName());
        if (appenderString != "") {
