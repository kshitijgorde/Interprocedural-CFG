...
public class msgFrame extends Frame
{
    ...
    void saveMen_Action(final ActionEvent actionEvent) {
        try {
            ...
            System.out.println("WRITE ERROR: " + ((Throwable)ex).toString());
            ...
            System.out.println("WRITE ERROR: " + ex2.toString());
            try {
            ...
            final ErrorDlg errorDlg2 = new ErrorDlg(this, "ERROR!", String.valueOf(this.props.language.getProperty("error.save", "An error occured when saving this file")) + ": " + ex3.toString(), true);
            errorDlg2.setBackground(this.props.background);
            errorDlg2.setForeground(this.props.foreground);
            errorDlg2.setFont(this.props.font);
            errorDlg2.show();
