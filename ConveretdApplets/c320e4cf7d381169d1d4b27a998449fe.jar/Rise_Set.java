...
class Rise_Set
{
    ...
    public Rise_Set(final Date myDat, final double myLat, final double myLong, final int locOffset, final double myElevation) {
        this.dat = myDat;
        ...
        this.currentTime = this.hours + this.minutes / 60.0;
        this.latitude = myLat;
    ...
    public void riseset(final int date, final int month, final int year, final double HOUR) {
        ...
        final double sh = Math.sin(0.017453292519943295 * this.elevation);
