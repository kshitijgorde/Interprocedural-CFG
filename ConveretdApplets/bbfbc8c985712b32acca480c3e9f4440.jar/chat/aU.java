...
public final class aU
{
    ...
    public aU(final String s, final ai ai, final b b) {
        final String d = ai.d;
        final int i = ai.i;
        if (!ai.a(62)) {
            ai.a(61);
    ...
    public aU(final String s, final String s2, final b b, final int n) {
        this(s, s2, false, b, n, 0, 0);
    }
    
    private aU(final String a, final String b, final boolean b2, final b b3, final int e, final int i, final int l) {
        this.h = 0;
        this.i = 0;
        this.j = 0;
        this.a = null;
    ...
    public aU(final String s, final ai ai, final boolean b, final b b2, final int n, final int n2) {
        final String d = ai.d;
        final int i = ai.i;
        if (!ai.a(62)) {
            ai.a(61);
