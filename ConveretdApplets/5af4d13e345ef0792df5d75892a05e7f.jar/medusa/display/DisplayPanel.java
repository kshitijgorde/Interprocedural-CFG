...
public class DisplayPanel extends BasicGraphPanel
{
    ...
    public DisplayPanel(final MedusaSettings stringSettings) {
    ...
    private void initPopup() {
        ...
        this.editColorItem.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                final Color newColor = JColorChooser.showDialog(DisplayPanel.this.getRootPane(), "Choose node color", DisplayPanel.this.temp1.getColor());
                if (newColor != null) {
