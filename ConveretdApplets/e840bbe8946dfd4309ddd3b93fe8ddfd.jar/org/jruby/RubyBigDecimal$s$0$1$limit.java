...
public class RubyBigDecimal$s$0$1$limit extends JavaMethodN
{
    public RubyBigDecimal$s$0$1$limit(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyBigDecimal.limit(recv, array);
    }
}
