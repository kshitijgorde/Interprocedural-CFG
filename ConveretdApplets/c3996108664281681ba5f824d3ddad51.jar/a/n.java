...
public final class n extends Canvas implements cn
{
    private Image q;
    private Image w;
    private Image e;
    ...
    public static n q(final Image image, final Image image2, final Image image3) {
        return new n(image, image2, image3, true);
    }
    ...
    private n(final Image q, final Image w, final Image e, final boolean b) {
        this.q = false;
        this.w = true;
        this.e = true;
        this.r = false;
