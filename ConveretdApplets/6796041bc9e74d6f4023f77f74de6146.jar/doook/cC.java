...
public final class cC extends FilterInputStream implements DataInput
{
    private byte[] b;
    private int aM;
    private byte[] d;
    ...
    public cC(final InputStream inputStream) {
        super(inputStream);
        this.aM = 0;
        this.d = new byte[8];
    }
    ...
    private int f() {
        return this.aM = (this.aM + 1) % this.b.length;
    }
    ...
    public final int read(final byte[] array, final int n, final int n2) {
        ...
        if (this.b != null && this.b.length > 0) {
            for (int i = 0; i < array.length; ++i) {
                final int n3 = i;
                array[n3] ^= (byte)(this.b[this.f()] ^ 0x7F);
            }
        }
        return read;
    }
