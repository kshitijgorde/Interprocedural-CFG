...
public abstract class cv implements cw, eb
{
    protected ap q;
    private ai q;
    private bI q;
    ...
    public cv(final Component component, final ap ap) {
        this(component, 12632319, ap);
    }
    
    private cv(final Component q, final int n, final ap q2) {
        this.q = 15;
    ...
    protected final void e() {
        ...
        this.q = new ai(this.q, this, true, null);
    }
    ...
    protected final void q(final int n, final int n2) {
        this.q(this);
        this.q.requestFocus();
        (this.q = bq.q(this.q, this.q)).setLocation(n, n2);
        this.q.setSize(0, 0);
        this.q((Component)this.q);
        final int n3 = this.q.q * this.q + this.q.w * 3 + 4 + (ap.t() ? 0 : this.q);
    ...
    private synchronized void q(final cv cv) {
        if (cv.q == null) {
            cv.q = cv;
            return;
        }
    ...
    private synchronized void w(final cv cv) {
        if (cv.q == cv) {
            cv.q = null;
        }
    }
    ...
    private bI q(final String s, final boolean b) {
        ...
        while (this.q(s + n)) {
            ...
            final String s3 = (q3 != null) ? (ds.q("=5>E") + "_" + ds.q(q3.toLowerCase(), ' ', '_') + ".gif") : null;
            if (q4 == null) {
                q4 = s3;
            }
            Image image;
