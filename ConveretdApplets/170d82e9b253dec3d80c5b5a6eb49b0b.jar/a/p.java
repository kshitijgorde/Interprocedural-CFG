...
public final class p extends Canvas implements dT
{
    private Image q;
    private Image w;
    private Image e;
    ...
    public static p q(final Image image, final Image image2, final Image image3) {
        return new p(image, image2, image3, true);
    }
    ...
    private p(final Image q, final Image w, final Image e, final boolean b) {
        this.q = false;
        this.w = true;
        this.e = true;
        this.r = false;
