...
public class Pscreen extends Canvas implements MouseListener
{
    ...
    public void paint(final Graphics graphics) {
        ...
        if (!this.fi2f.gamePaused) {
            ...
            if (this.ID == 1) {
                this.psBuffG.drawString("Current Image: " + this.lvl.rightPic + " (" + this.lvl.randLevel + ")", 50, 140);
            }
            if (this.ID == 2) {
                this.psBuffG.drawString("Current Image: " + this.lvl.wrongPic + " (" + this.lvl.randLevel + ")", 50, 140);
            }
            this.psBuffG.drawString("Current score: " + this.fi2f.getScore(), 50, 160);
            this.psBuffG.drawString("Number of Images: " + this.fi2f.numberOfPictures, 50, 180);
