...
class mapFrame extends Frame
{
    ...
    public mapFrame(final String vStr, final Image MAP, final double DEC, final double GHA, final double PHASE, final double LAT, final double LONG, final boolean online) {
        this.setTitle(vStr);
    ...
    public void paint(final Graphics g) {
        ...
        g.drawImage(this.map, xL, oben, this);
        ...
        final int c = (int)Math.round(255.0 * this.phase);
        ...
        g.drawString("Map (c) Apple Computers Inc.", 200, this.size().height - 5);
        if (this.isOnline) {
