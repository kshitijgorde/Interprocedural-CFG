...
public final class j extends Panel
{
    ...
    public j(int q, final int w, final aV av, final bs q2) {
        this.setLayout(null);
        this.q = q2;
        this.q = q;
        this.w = w;
    ...
    private void q(final aV av) {
        this.q = new bN[this.e];
        while (av.q < av.q.size()) {
            final Object q;
            if ((q = av.q()) instanceof aa) {
                this.q[av.q - 1] = new bN((aa)q, this.q, this);
            }
        }
    }
