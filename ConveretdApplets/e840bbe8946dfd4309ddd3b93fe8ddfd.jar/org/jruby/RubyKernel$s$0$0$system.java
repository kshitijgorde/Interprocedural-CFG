...
public class RubyKernel$s$0$0$system extends JavaMethodN
{
    public RubyKernel$s$0$0$system(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyKernel.system(context, recv, array);
    }
}
