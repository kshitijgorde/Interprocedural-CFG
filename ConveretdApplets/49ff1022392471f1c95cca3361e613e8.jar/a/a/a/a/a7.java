...
public class a7
{
    ...
    public boolean a() {
        ...
        while (b && n > 0) {
            b = false;
            try {
                this.do.char.new = new int[do1 * case1];
            }
            catch (OutOfMemoryError outOfMemoryError) {
                if (!this.do.g) {
                    System.out.println("Not enough memory to open " + this.do.m);
        ...
        if (o != do1) {
            ...
            if (this.int.byte.v != null) {
                this.int.byte.v.a(charArray);
            }
            if (this.int.byte.r != null) {
                this.int.byte.r.if(charArray);
            }
        }
        this.do.char.do = do1;
        this.do.char.case = case1;
        if (this.do.goto != null && this.do.goto.char.int) {
            ...
            for (int i = 0; i < case1; ++i) {
                ...
                for (int j = 0; j < do1; ++j) {
                    ...
                    this.do.char.new[n2++] = ((b2 == b3) ? -3355444 : -1);
                    ++n4;
                }
                ++n3;
            }
        ...
        if (do1 == o && case1 == a) {
            ...
            for (int k = 0; k < case1; ++k) {
                ...
                if (this.for.w() == 3) {
                    for (int l = 0; l < do1; ++l, n8 += s) {
                        this.do.char.new[l + n7] = (0xFF000000 | (array3[n8] & 0xFF) << 16 | (array3[1 + n8] & 0xFF) << 8 | (array3[2 + n8] & 0xFF));
                    }
                }
                else if (this.for.w() == 1) {
                    for (int do2 = this.do.char.do; do2 > 0; --do2, n8 += s) {
                        this.do.char.new[this.do.char.do - do2 + n7] = (0xFF000000 | (array3[n8] & 0xFF) << 16 | (array3[n8] & 0xFF) << 8 | (array3[n8] & 0xFF));
                    }
                }
                ++n6;
                n7 += do1;
            ...
            for (int n11 = 0; n11 < 6; ++n11) {
                this.a(o, o, n9, do1, do1, n10);
                n9 += o;
                n10 += do1;
            }
        }
        else {
            this.a(o, a, 0, do1, case1, 0);
        }
        this.for = null;
