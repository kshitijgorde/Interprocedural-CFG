...
public class cE extends s implements cy, Runnable
{
    protected boolean q;
    protected int q;
    ...
    protected void e() {
        ...
        this.add(this.w);
        (this.q = new cB()).setForeground(new Color(0, 0, 128));
    ...
    protected boolean w() {
        ...
        try {
            ...
            final Socket socket = new Socket(this.q.u, 9000);
    ...
    public cE(final bH bh, final cz cz) {
        this(bh, cz.q, cz.q, cz.w, false);
        this.w = cz.q;
        this.e = cz.q;
    }
    
    public cE(final bH bh, final bp bp) {
        this(bh, bp, null, null, true);
    }
    
    protected cE(final bH q, final bp q2, final String q3, final String w, final boolean q4) {
        super(false);
        this.q = 6;
        this.w = -1;
        this.q = q2;
