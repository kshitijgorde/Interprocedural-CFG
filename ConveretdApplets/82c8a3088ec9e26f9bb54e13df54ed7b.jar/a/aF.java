...
public abstract class aF extends Panel
{
    ...
    public final synchronized void q(final r r) {
        try {
            ...
            this.q(this.q[(this.t - 1 + this.y) % this.q.length] = r, this.q.size().width - 12 - aF.q, this.getFontMetrics(aS.w.w()));
            ...
            if (event.x >= aF.q) {
                ...
                for (int i = 0; i < this.t; ++i) {
                    ...
                    if (n < q.q) {
                        ...
                        final int n4;
                        final int n3 = (n4 = n - (3 + fontMetrics.getAscent())) / (fontMetrics = this.getFontMetrics(aS.w.w())).getHeight();
                        if (n4 > 0 && n3 < q.w) {
                            int n5;
    ...
    public final synchronized void q() {
        ...
        final FontMetrics fontMetrics = this.getFontMetrics(aS.w.w());
        for (int i = 0; i < this.t; ++i) {
            final r q = this.q(i);
    ...
    public aF(final bp bp, final boolean w) {
        this.q = 0L;
        this.q = null;
        this.w = 0;
        this.e = 0;
        ...
        (this.q = new bG(1)).setLineIncrement(10);
        layout.setConstraints(this.q, gridBagConstraints);
        this.add(this.q);
    }
}
