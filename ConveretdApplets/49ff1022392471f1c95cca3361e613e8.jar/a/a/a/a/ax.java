...
public class ax
{
    ...
    a3 a(final char[] array) throws ar {
        ...
        if (int1.for == 1) {
            int if1;
            if ((if1 = this.goto.if(int1.do)) == -1) {
                if ((a4 = this.int.a(int1.do)) == -1) {
                    return null;
                }
                if1 = -2;
            }
            final z int2 = ah.int();
            if (int2.for == 0 && int2.do[0] == '(') {
                z z = ah.int();
                int n2 = 0;
                if (z.do[0] == '-') {
                    n2 = 1;
    ...
    int a(final boolean b, final char[] array) {
        if (b && this.b > 0) {
            for (int i = this.e[this.try]; i < this.b; ++i) {
                if (g.a(this.char[i].do, array, 31) == 0) {
                    return i;
                }
            }
        }
    ...
    void byte() {
        for (int i = this.e[this.try]; i < this.b; ++i) {
            this.char[this.b - 1] = null;
            --this.b;
        }
        this.b = this.e[this.try];
    }
        ...
        while (this.new.for == 2 && this.new.if == 7L) {
            ...
            while (this.new.for == 1) {
                for (int i = 0; i < int1; ++i) {
                    if (g.a(b.a[i].do, this.new.do, 31) == 0) {
    ...
    int if() throws ar {
        if (this.new.for == 1) {
            ...
            if (this.new.for == 4) {
                ...
                this.try(a3);
                if (b) {
                    this.long.if(this.char[n], a3, false);
                }
                else {
                    this.goto.a(n, a3);
                }
    ...
    void a(final char[] array, final a3 a3) throws ar {
        ...
        if (a4 != -1) {
            ...
            this.for.a(a5.new);
            this.if(true);
            this.long.if(a3, this.char[this.b - 1], false);
            this.byte();
            --this.try;
            this.for.a(char1);
        }
            ...
            case 1: {
                ...
                if (this.new.for == 0 && this.new.do[0] == '(') {
                    ...
                    if (if1.char == 5) {
                        ...
                        this.long.if(a3, if1.a[n2], false);
                    }
                    else {
                        if (if1.char != 4) {
                    ...
                    if (b2) {
                        this.long.if(a3, this.char[n3], false);
                    }
                    else {
                        this.goto.a(a3, n3);
                    }
