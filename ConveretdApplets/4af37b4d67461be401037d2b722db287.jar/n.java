...
public class n extends Thread
{
    ...
    private final String p(final String s) {
        ...
        for (int i = 0; i < s.length(); ++i) {
            if (s.charAt(i) == ' ' && !this.p.getCodeBase().getProtocol().equals("file")) {
    ...
    public static final String d(final n n, final String p2) {
        return n.p = p2;
    }
    ...
    public static final int d(final n n, final int v) {
        return n.v = v;
    }
    
    public static final int a(final n n, final int n2) {
        return n.v -= n2;
    }
    ...
    public static final int l(final n n, final int a) {
        return n.a = a;
    }
    ...
    public static final int n(final n n, final int p2) {
        return n.p = p2;
    }
