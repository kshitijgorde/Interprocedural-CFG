...
public class bJ extends aV implements cl, Runnable
{
    protected boolean q;
    protected int q;
    ...
    protected void q() {
        ...
        this.add(this.w);
        (this.q = new bS()).setForeground(new Color(0, 0, 128));
    ...
    public bJ(final cq cq, final bY by) {
        this(cq, by.q, by.q, by.w, false);
        this.w = by.q;
        this.e = by.q;
    }
    
    public bJ(final cq cq, final l l) {
        this(cq, l, null, null, true);
    }
    
    protected bJ(final cq q, final l q2, final String q3, final String w, final boolean q4) {
        super(false);
        this.q = 6;
        this.w = -1;
        this.q = q2;
