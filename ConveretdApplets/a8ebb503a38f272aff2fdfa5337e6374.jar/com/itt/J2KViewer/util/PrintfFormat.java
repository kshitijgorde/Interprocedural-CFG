...
public class PrintfFormat
{
    ...
    private String nonControl(final String s, final int n) {
    ...
    private class ConversionSpecification
    {
        ...
        private char[] fFormatDigits(final double n) {
            int int1 = 0;
            boolean b = false;
            String s;
            if (n > 0.0) {
        ...
        private String fFormatString(final double n) {
            char[] array;
        ...
        private char[] eFormatDigits(final double n, final char c) {
            int int1 = 0;
            boolean b = false;
            String s;
            if (n > 0.0) {
            ...
            char[] array3;
            if (this.alternateForm || !this.precisionSet || this.precision != 0) {
                array3 = new char[2 + precision + n5];
            }
            else {
                array3 = new char[1 + n5];
            }
            int n6;
            if (array[0] != '0') {
                array3[0] = array[0];
                ...
                for (n6 = 1; n6 < ((n2 == -1) ? array.length : n2) && array[n6] == '0'; ++n6) {}
                if ((n2 != -1 && n6 < n2) || (n2 == -1 && n6 < array.length)) {
                    array3[0] = array[n6];
                    int1 -= n6;
                    ++n6;
                }
            ...
            for (int n7 = 0; n7 < precision && n6 < array.length; ++n6, ++l, ++n7) {
                array3[l] = array[n6];
            }
            while (l < array3.length - n5) {
                array3[l] = '0';
                ++l;
            }
            array3[l++] = c;
            ...
            if (!this.leftJustify && this.leadingZeros) {
                ...
                if (this.thousands) {
                    ...
                    int n11;
                    for (n11 = n10; n11 < array3.length && array3[n11] != '.'; ++n11) {}
                    n9 = (n11 - n10) / 3;
                }
                if (this.fieldWidthSet) {
                    n8 = this.fieldWidth - array3.length;
                }
                if ((!b && (this.leadingSign || this.leadingSpace)) || b) {
                    --n8;
                }
            ...
            char[] array4;
            if ((!b && (this.leadingSign || this.leadingSpace)) || b) {
                array4 = new char[array3.length + n8 + 1];
                ++n12;
            }
            else {
                array4 = new char[array3.length + n8];
            }
            if (!b) {
                if (this.leadingSign) {
                    array4[0] = '+';
            ...
            for (int n14 = 0; n14 < array3.length && n12 < array4.length; ++n14, ++n12) {
                array4[n12] = array3[n14];
            }
            int n15 = 0;
            if (array4[0] == '+' || array4[0] == '-' || array4[0] == ' ') {
                n15 = 1;
            ...
            int n16;
            for (n16 = n15; n16 < array4.length && array4[n16] != '.'; ++n16) {}
            final int n17 = n16 / 3;
            if (n16 < array4.length) {
                array4[n16] = PrintfFormat.this.dfs.getDecimalSeparator();
            }
            char[] array5 = array4;
            if (this.thousands && n17 > 0) {
                array5 = new char[array4.length + n17 + n15];
                array5[0] = array4[0];
                int n18 = n15;
                int n19 = n15;
                while (n18 < n16) {
                    if (n18 > 0 && (n16 - n18) % 3 == 0) {
                        array5[n19] = PrintfFormat.this.dfs.getGroupingSeparator();
                        array5[n19 + 1] = array4[n18];
                        n19 += 2;
                    }
                    else {
                        array5[n19] = array4[n18];
                        ++n19;
                    }
                    ++n18;
                }
                while (n18 < array4.length) {
                    array5[n19] = array4[n18];
                    ++n18;
                    ++n19;
                }
        ...
        private boolean checkForCarry(final char[] array, final int n) {
            boolean b = false;
            if (n < array.length) {
                if (array[n] == '6' || array[n] == '7' || array[n] == '8' || array[n] == '9') {
                    ...
                    b = (n2 < array.length);
                    if (!b && n > 0) {
                        b = (array[n - 1] == '1' || array[n - 1] == '3' || array[n - 1] == '5' || array[n - 1] == '7' || array[n - 1] == '9');
                    }
                }
            }
            return b;
        ...
        private boolean startSymbolicCarry(final char[] array, final int n, final int n2) {
            boolean b = true;
        ...
        private String eFormatString(final double n, final char c) {
            char[] array;
            if (Double.isInfinite(n)) {
                if (n == Double.POSITIVE_INFINITY) {
                    if (this.leadingSign) {
        ...
        private char[] applyFloatPadding(final char[] array, final boolean b) {
            char[] array2 = array;
            if (this.fieldWidthSet) {
                if (this.leftJustify) {
        ...
        private String printFFormat(final double n) {
            return this.fFormatString(n);
        }
        
        private String printEFormat(final double n) {
        ...
        private String printGFormat(final double n) {
        ...
        private String printDFormat(final short n) {
            return this.printDFormat(Short.toString(n));
        }
        
        private String printDFormat(final long n) {
            return this.printDFormat(Long.toString(n));
        }
        
        private String printDFormat(final int n) {
            return this.printDFormat(Integer.toString(n));
        }
        
        private String printDFormat(String s) {
            int n = 0;
            int n2 = 0;
            int n3 = 0;
            int i = 0;
            final int n4 = (s.charAt(0) == '-') ? 1 : 0;
            ...
            if (this.fieldWidthSet) {
                ...
                if (n4 == 0 && (this.leadingSign || this.leadingSpace)) {
                    --n2;
                }
            }
            if (n2 < 0) {
            ...
            if (this.leftJustify) {
                ...
                for (int k = n5; k < charArray.length; ++k, ++i) {
                    array[i] = charArray[k];
                }
                for (int l = 0; l < n2; ++l) {
                    array[i] = ' ';
                ...
                if (!this.leadingZeros) {
                    ...
                    for (int n6 = 0; n6 < n2; ++n6, ++i) {
                        array[i] = '0';
                    }
                }
                for (int n7 = 0; n7 < n; ++n7, ++i) {
                    array[i] = '0';
                }
                final char[] charArray2 = s.toCharArray();
                for (int n8 = n4; n8 < charArray2.length; ++n8, ++i) {
                    array[i] = charArray2[n8];
                }
            }
            return new String(array);
        }
        
        private String printXFormat(final short n) {
            String s = null;
            if (n == -32768) {
                s = "8000";
            }
        ...
        private String printXFormat(final long n) {
            String s = null;
            if (n == Long.MIN_VALUE) {
                s = "8000000000000000";
            }
            else if (n < 0L) {
                final String string = Long.toString(~(-n - 1L) ^ Long.MIN_VALUE, 16);
                Label_0739: {
        ...
        private String printXFormat(final int n) {
            String s = null;
        ...
        private String printXFormat(String s) {
            int n = 0;
            int n2 = 0;
            if (s.equals("0") && this.precisionSet && this.precision == 0) {
                s = "";
        ...
        private String printOFormat(final short n) {
            String s = null;
            if (n == -32768) {
                s = "100000";
            }
        ...
        private String printOFormat(final long n) {
            String s = null;
            if (n == Long.MIN_VALUE) {
                s = "1000000000000000000000";
            }
            else if (n < 0L) {
                final String string = Long.toString(~(-n - 1L) ^ Long.MIN_VALUE, 8);
                switch (string.length()) {
                    case 1: {
        ...
        private String printOFormat(final int n) {
            String s = null;
            if (n == Integer.MIN_VALUE) {
                s = "20000000000";
            }
        ...
        private String printOFormat(String s) {
            int n = 0;
            int n2 = 0;
            if (s.equals("0") && this.precisionSet && this.precision == 0) {
                s = "";
        ...
        private String printCFormat(final char c) {
            final int n = 1;
        ...
        private String printSFormat(final String s) {
            int n = s.length();
            int fieldWidth = this.fieldWidth;
        ...
        private boolean setConversionCharacter() {
            ...
            if (this.pos < this.fmt.length()) {
                ...
                if (char1 == 'i' || char1 == 'd' || char1 == 'f' || char1 == 'g' || char1 == 'G' || char1 == 'o' || char1 == 'x' || char1 == 'X' || char1 == 'e' || char1 == 'E' || char1 == 'c' || char1 == 's' || char1 == '%') {
