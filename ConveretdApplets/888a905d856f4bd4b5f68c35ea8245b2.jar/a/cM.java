...
public final class cM extends Panel implements MouseListener, WindowListener
{
    private av q;
    private Window q;
    ...
    public cM(final Component component, final Component w, final Color q) {
        this(component);
        this.w = w;
        this.q = q;
    }
    ...
    public final synchronized void w() {
        ...
        (this.q = bq.q(this.q, component)).add(this.q);
        Point point;
        if (this.q != null) {
            point = this.q;
        }
