...
public class S extends aA
{
    ...
    public S(final Frame frame, final String s, final String[] array, final String[] array2, final P a, final as as) {
        ...
        for (int i = 0; i < array2.length; ++i) {
            if (array2[i].toLowerCase().startsWith("imgcast/") && (array2[i].toLowerCase().endsWith(".gif") || array2[i].toLowerCase().endsWith(".jpg") || array2[i].toLowerCase().endsWith(".jpeg"))) {
                this.g = as.a(array2[i], false);
                final M m = new M();
                m.b(this.g);
                this.g.getWidth(m);
