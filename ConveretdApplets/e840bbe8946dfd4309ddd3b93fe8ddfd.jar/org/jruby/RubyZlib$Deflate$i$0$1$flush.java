...
public class RubyZlib$Deflate$i$0$1$flush extends JavaMethodN
{
    public RubyZlib$Deflate$i$0$1$flush(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyZlib.Deflate)rubyObject).flush(array);
    }
}
