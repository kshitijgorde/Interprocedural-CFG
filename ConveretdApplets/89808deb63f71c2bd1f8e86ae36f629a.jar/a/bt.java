...
public abstract class bt implements bu, cE
{
    protected W q;
    private P q;
    private aX q;
    ...
    public bt(final Component component, final W w) {
        this(component, 12632319, w);
    }
    
    private bt(final Component q, final int n, final W q2) {
        this.q = 15;
    ...
    protected final void w() {
        ...
        this.q = new P(this.q, this, true, null);
    }
    ...
    protected final void q(final int n, final int n2) {
        this.q(this);
        this.q.requestFocus();
        (this.q = aK.q(this.q, this.q)).setLocation(n, n2);
        this.q.setSize(0, 0);
    ...
    private synchronized void q(final bt bt) {
        if (bt.q == null) {
            bt.q = bt;
            return;
        }
    ...
    private synchronized void w(final bt bt) {
        if (bt.q == bt) {
            bt.q = null;
        }
    }
    ...
    private aX q(final String s, final boolean b) {
        ...
        while (this.q(s + n)) {
            ...
            final String s3 = (q3 != null) ? (cg.q("=5>E") + "_" + cg.q(q3.toLowerCase(), ' ', '_') + ".gif") : null;
            if (q4 == null) {
                q4 = s3;
            }
            Image image;
