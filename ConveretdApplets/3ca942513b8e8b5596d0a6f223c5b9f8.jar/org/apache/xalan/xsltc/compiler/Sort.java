...
final class Sort extends Instruction implements Closure
{
    ...
    public static void translateSortIterator(final ClassGenerator classGen, final MethodGenerator methodGen, final Expression nodeSet, final Vector sortObjects) {
        ...
        final LocalVariableGen nodesTemp = methodGen.addLocalVariable("sort_tmp1", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), il.getEnd(), null);
        final LocalVariableGen sortRecordFactoryTemp = methodGen.addLocalVariable("sort_tmp2", Util.getJCRefType("Lorg/apache/xalan/xsltc/dom/NodeSortRecordFactory;"), il.getEnd(), null);
        if (nodeSet == null) {
    ...
    public static void compileSortRecordFactory(final Vector sortObjects, final ClassGenerator classGen, final MethodGenerator methodGen) {
        ...
        final ConstantPoolGen cpg = classGen.getConstantPool();
        final InstructionList il = methodGen.getInstructionList();
        final LocalVariableGen sortOrderTemp = methodGen.addLocalVariable("sort_order_tmp", Util.getJCRefType("[Ljava/lang/String;"), il.getEnd(), null);
        ...
        final LocalVariableGen sortTypeTemp = methodGen.addLocalVariable("sort_type_tmp", Util.getJCRefType("[Ljava/lang/String;"), il.getEnd(), null);
        il.append(new PUSH(cpg, nsorts));
        il.append(new ANEWARRAY(cpg.addClass("java.lang.String")));
        ...
        final LocalVariableGen sortLangTemp = methodGen.addLocalVariable("sort_lang_tmp", Util.getJCRefType("[Ljava/lang/String;"), il.getEnd(), null);
        il.append(new PUSH(cpg, nsorts));
        il.append(new ANEWARRAY(cpg.addClass("java.lang.String")));
        ...
        final LocalVariableGen sortCaseOrderTemp = methodGen.addLocalVariable("sort_case_order_tmp", Util.getJCRefType("[Ljava/lang/String;"), il.getEnd(), null);
        il.append(new PUSH(cpg, nsorts));
        il.append(new ANEWARRAY(cpg.addClass("java.lang.String")));
    ...
    public static String compileSortRecordFactory(final Vector sortObjects, final ClassGenerator classGen, final MethodGenerator methodGen, final String sortRecordClass) {
        ...
        final MethodGenerator makeNodeSortRecord = new MethodGenerator(1, Util.getJCRefType("Lorg/apache/xalan/xsltc/dom/NodeSortRecord;"), new com.ibm.xslt4j.bcel.generic.Type[] { com.ibm.xslt4j.bcel.generic.Type.INT, com.ibm.xslt4j.bcel.generic.Type.INT }, new String[] { "node", "last" }, "makeNodeSortRecord", className, il, cpg);
        il.append(InstructionConstants.ALOAD_0);
    ...
    private static Method compileInit(final Vector sortObjects, final NodeSortRecordGenerator sortRecord, final ConstantPoolGen cpg, final String className) {
        ...
        final MethodGenerator init = new MethodGenerator(1, com.ibm.xslt4j.bcel.generic.Type.VOID, null, null, "<init>", className, il, cpg);
        il.append(InstructionConstants.ALOAD_0);
    ...
    private static Method compileExtract(final Vector sortObjects, final NodeSortRecordGenerator sortRecord, final ConstantPoolGen cpg, final String className) {
        final InstructionList il = new InstructionList();
        final CompareGenerator extractMethod = new CompareGenerator(17, com.ibm.xslt4j.bcel.generic.Type.STRING, new com.ibm.xslt4j.bcel.generic.Type[] { Util.getJCRefType("Lorg/apache/xalan/xsltc/DOM;"), com.ibm.xslt4j.bcel.generic.Type.INT, com.ibm.xslt4j.bcel.generic.Type.INT, Util.getJCRefType("Lorg/apache/xalan/xsltc/runtime/AbstractTranslet;"), com.ibm.xslt4j.bcel.generic.Type.INT }, new String[] { "dom", "current", "level", "translet", "last" }, "extractValueFromDOM", className, il, cpg);
