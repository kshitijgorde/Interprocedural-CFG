...
public interface JDBCAdapter
{
    ...
    void doAddMessage(final TransactionContext p0, final long p1, final MessageId p2, final ActiveMQDestination p3, final byte[] p4, final long p5, final byte p6) throws SQLException, IOException;
    ...
    void doRemoveMessage(final TransactionContext p0, final long p1) throws SQLException, IOException;
    ...
    void doSetLastAck(final TransactionContext p0, final ActiveMQDestination p1, final String p2, final String p3, final long p4, final long p5) throws SQLException, IOException;
    ...
    void doDeleteOldMessages(final TransactionContext p0, final boolean p1) throws SQLException, IOException;
    ...
    void doSetLastAckWithPriority(final TransactionContext p0, final ActiveMQDestination p1, final String p2, final String p3, final long p4, final long p5) throws SQLException, IOException;
