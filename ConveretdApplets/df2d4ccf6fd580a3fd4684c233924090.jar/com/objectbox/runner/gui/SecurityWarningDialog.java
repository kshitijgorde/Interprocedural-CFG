...
public class SecurityWarningDialog extends Frame implements ActionListener
{
    private Panel ivjContentsPane;
    private FlatButton ivjFlatButtonOK;
    private Panel ivjPanelButtons;
    protected transient SecurityChangedListener aSecurityChangedListener;
    ...
    public SecurityWarningDialog() {
        ...
        this.aSecurityChangedListener = null;
        this.ivjLabelMessage = null;
        this.ivjTextAreaMessage = null;
        this.initialize();
    }
    
    public SecurityWarningDialog(final String text) {
        this.ivjContentsPane = null;
        this.ivjFlatButtonOK = null;
        this.ivjPanelButtons = null;
        this.aSecurityChangedListener = null;
    ...
    public static void main(final String[] array) {
        try {
            ...
            try {
                ...
                if ((class$java$awt$Window = SecurityWarningDialog.class$java$awt$Window) == null) {
                    try {
                        class$java$awt$Window = (SecurityWarningDialog.class$java$awt$Window = Class.forName("java.awt.Window"));
                    }
