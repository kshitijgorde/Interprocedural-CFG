...
public class OpCodes
{
    ...
    public static final int OP_EXTFUNCTION_SHORT = 25;
    public static final int OP_FUNCTION = 26;
    static final int LAST_NODESET_OP = 26;
    public static final int OP_ARGUMENT = 27;
    public static final int OP_NUMBERLIT = 28;
    public static final int OP_LOCATIONPATH = 29;
    public static final int OP_PREDICATE = 30;
    public static final int OP_MATCHPATTERN = 31;
    public static final int OP_LOCATIONPATHPATTERN = 32;
