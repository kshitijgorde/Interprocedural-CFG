...
public class em extends u implements eg, Runnable
{
    protected boolean q;
    protected int q;
    ...
    protected void e() {
        ...
        this.add(this.w);
        (this.q = new ej()).setForeground(new Color(0, 0, 128));
    ...
    protected boolean w() {
        ...
        try {
            ...
            final Socket socket = new Socket(this.q.i, 9000);
    ...
    public em(final cU cu, final eh eh) {
        this(cu, eh.q, eh.q, eh.w, false);
        this.w = eh.q;
        this.e = eh.q;
    }
    
    public em(final cU cu, final cz cz) {
        this(cu, cz, null, null, true);
    }
    
    protected em(final cU q, final cz q2, final String q3, final String w, final boolean q4) {
        super(false);
        this.q = 6;
        this.w = -1;
        this.q = q2;
