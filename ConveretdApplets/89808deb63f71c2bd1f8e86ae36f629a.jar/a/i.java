...
public final class i extends v
{
    ...
    public i(final Frame frame, final cq q, final l q2, final cr cr, final int n) {
        super(frame, false);
        this.q = new M(70, 20);
        this.w = new M(115, 20);
        ...
        this.q = q2;
        this.q = q;
        (this.q = new cy()).setBackground(aU.w.i);
        this.q.setForeground(aU.w.u);
        this.q = new m();
        this.q = new GridBagConstraints();
        ((br)(this.q = new GridBagLayout())).q(q2.o);
        this.w = this.q.q(cr.q(n, 1));
        this.q.q(cr.q(n, 3));
        this.r = null;
        this.t = null;
        this.y = null;
    ...
    public final void setVisible(final boolean visible) {
        if (!this.q()) {
            final Label label;
            (label = new Label(ak.q("No profile is available."))).setFont(bf.t);
            this.q.gridwidth = 0;
    ...
    private boolean q() {
        ...
        this.q.gridwidth = 0;
        final Label label;
        (label = new Label(this.q)).setFont(bf.q);
        this.q.setConstraints(label, this.q);
        this.q.add(label);
        this.q.weightx = 1.0;
        this.q.fill = 2;
        ...
        if (this.q.q) {
            final Label label2;
            (label2 = new Label(ak.q("This user blocks its profile."))).setFont(bf.q);
            this.q.add(label2);
            b = true;
        }
        else {
            if (this.q != null && this.q.trim().length() > 0) {
                ...
                final Label label4;
                (label4 = new Label(ak.q("Real Name"))).setFont(bf.t);
                this.q.gridwidth = -1;
            ...
            if (this.t != null && this.t.trim().length() > 0) {
                ...
                final Label label6;
                (label6 = new Label(ak.q("Age"))).setFont(bf.t);
                this.q.gridwidth = -1;
            ...
            if (this.y != null && this.y.trim().length() > 0) {
                ...
                final Label label8;
                (label8 = new Label(ak.q("Gender"))).setFont(bf.t);
                this.q.gridwidth = -1;
            ...
            if (this.r != null && this.r.trim().length() > 0) {
                ...
                final Label label9;
                (label9 = new Label(ak.q("E-mail"))).setFont(bf.t);
                this.q.gridwidth = -1;
            ...
            if (this.e != null && this.e.trim().length() > 0) {
                ...
                final Label label10;
                (label10 = new Label(ak.q("URL"))).setFont(bf.t);
                this.q.gridwidth = -1;
            ...
            if (this.w != null && this.w.trim().length() > 0) {
                ...
                final Label label11;
                (label11 = new Label(ak.q("Comments"))).setFont(bf.t);
                this.q.gridwidth = -1;
