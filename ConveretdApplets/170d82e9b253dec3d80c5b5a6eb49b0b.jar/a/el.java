...
public final class el extends em
{
    protected final void e() {
        ...
        this.add(super.w);
        (super.q = new ej()).setForeground(new Color(0, 0, 128));
    ...
    protected final boolean w() {
        ...
        try {
            ...
            final Socket socket = new Socket(super.q.i, 9000);
            ...
            while (n < long1 && super.q != 2) {
                ...
                if (System.currentTimeMillis() > currentTimeMillis + 1000L) {
                    ...
                    super.r.setText("Transferring file " + em.q(currentTimeMillis2, currentTimeMillis, n));
                }
            }
    ...
    public el(final cU cu, final eh eh) {
        super(cu, eh.q, eh.q, eh.w, false);
        super.w = eh.q;
        super.e = eh.q;
    }
    
    public el(final cU cu, final cz cz) {
        super(cu, cz, null, null, true);
    }
}
