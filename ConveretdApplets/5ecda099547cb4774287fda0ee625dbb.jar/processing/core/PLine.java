...
public class PLine implements PConstants
{
    ...
    public void draw() {
        ...
        int n8 = (int)this.x_array[1] - (int)this.x_array[0];
        int n9 = (int)this.y_array[1] - (int)this.y_array[0];
        ...
        if (n8 < 0) {
            this.o0 = 1;
            this.o1 = 0;
            n11 = (int)this.x_array[1];
            n12 = (int)this.y_array[1];
            n13 = -n8;
        }
        else {
            this.o0 = 0;
            this.o1 = 1;
            n11 = (int)this.x_array[0];
            n12 = (int)this.y_array[0];
            n13 = n8;
        }
        int n14;
        if (n13 == 0) {
        ...
        if (this.INTERPOLATE_RGB) {
            this.dr = (this.r_array[this.o1] - this.r_array[this.o0]) / n13;
            this.dg = (this.g_array[this.o1] - this.g_array[this.o0]) / n13;
            this.db = (this.b_array[this.o1] - this.b_array[this.o0]) / n13;
        }
        else {
            this.dr = 0.0f;
            this.dg = 0.0f;
        ...
        if (this.INTERPOLATE_ALPHA) {
            this.da = (this.a_array[this.o1] - this.a_array[this.o0]) / n13;
        }
        else {
            this.da = 0.0f;
        }
        ...
        if (this.INTERPOLATE_Z) {
            this.dz = (this.z_array[this.o1] - this.z_array[this.o0]) / n13;
        }
        else {
            this.dz = 0.0f;
        }
        if (n13 == 0) {
            if (this.INTERPOLATE_ALPHA) {
                this.drawPoint_alpha(n11, n12);
            }
            else {
                this.drawPoint(n11, n12);
            }
            return;
        }
        if (this.SMOOTH) {
            this.drawLine_smooth(n11, n12, n14, n13, b);
        }
        else if (this.m_drawFlags == 0) {
            this.drawLine_plain(n11, n12, n14, n13, b);
        }
        else if (this.m_drawFlags == 2) {
            this.drawLine_plain_alpha(n11, n12, n14, n13, b);
        }
        else if (this.m_drawFlags == 1) {
            this.drawLine_color(n11, n12, n14, n13, b);
        }
        else if (this.m_drawFlags == 3) {
            this.drawLine_color_alpha(n11, n12, n14, n13, b);
        }
        else if (this.m_drawFlags == 8) {
            this.drawLine_plain_spatial(n11, n12, n14, n13, b);
        }
        else if (this.m_drawFlags == 10) {
            this.drawLine_plain_alpha_spatial(n11, n12, n14, n13, b);
        }
        else if (this.m_drawFlags == 9) {
            this.drawLine_color_spatial(n11, n12, n14, n13, b);
        }
        else if (this.m_drawFlags == 11) {
            this.drawLine_color_alpha_spatial(n11, n12, n14, n13, b);
        }
    }
