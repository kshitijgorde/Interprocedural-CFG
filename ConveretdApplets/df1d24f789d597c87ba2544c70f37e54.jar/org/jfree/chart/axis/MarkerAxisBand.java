...
public class MarkerAxisBand implements Serializable
{
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof MarkerAxisBand) {
            final MarkerAxisBand mab = (MarkerAxisBand)obj;
            final boolean b0 = this.topOuterGap == mab.topOuterGap;
            final boolean b2 = this.topInnerGap == mab.topInnerGap;
            final boolean b3 = this.bottomInnerGap == mab.bottomInnerGap;
            final boolean b4 = this.bottomOuterGap == mab.bottomOuterGap;
            final boolean b5 = ObjectUtils.equal(this.font, mab.font);
            final boolean b6 = ObjectUtils.equal(this.markers, mab.markers);
