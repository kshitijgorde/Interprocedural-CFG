...
public class ChatClient extends Applet implements MainClient
{
    ...
    public static void main(final String[] array) {
        System.out.println("Client version \"9.13\"");
        System.out.println("Client release applet-rel-9090");
    }
    ...
    public void init() {
        ...
        System.out.println("Applet 9.13");
        System.out.println("Release applet-rel-9090");
        System.out.println("doc=" + this.getDocumentBase().toString());
        this.paraConf = new Config(this, this);
        String s;
        if (this.isBasic()) {
        ...
        this.chatApplet.setParent(this, this, this.paraConf);
    ...
    public void popSuggest() {
        ...
        new FrameOld(this.paraConf.title(), this.paraConf.get("Msg.OldJava", "You are using an older version of Java. Although you can still access this ParaChat room, we recommend that you upgrade to the latest Java version for the best chat experience.  You may upgrade now for free by visiting: http://java.com"), this.paraConf.get("Bt.GetJava", "Get Java"), this, this.paraConf.get("URL.Java", "http://java.com")).show();
    }
}
