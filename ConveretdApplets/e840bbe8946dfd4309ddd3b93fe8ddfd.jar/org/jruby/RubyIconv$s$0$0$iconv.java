...
public class RubyIconv$s$0$0$iconv extends JavaMethodNBlock
{
    public RubyIconv$s$0$0$iconv(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block unusedBlock) {
        ...
        return RubyIconv.iconv(context, recv, array, unusedBlock);
    }
}
