...
class nb extends Thread
{
        ...
        try {
            ...
            if (!r) {
                if (a.Mb != null) {
                    ...
                    if (!r) {
                        if (a4.r != null) {
                            this.a.a(String.valueOf(this.a.a(11, "", "", "")) + nb.z[12]);
                        }
                ...
                this.a.Zb.b.a();
                this.a.G = this.a.c(nb.z[10], nb.z[7]);
                final esChat a6 = this.a;
            }
            final String s = a.G[0];
            if (!r) {
                if (s == null) {
                    this.a.G = this.a.c(nb.z[10], nb.z[6]);
                    this.a.H = true;
                }
            ...
            new rb(this.a).start();
            this.a.oc = 0;
            this.a.a(nb.z[9] + this.a.db, 1);
            try {
                Thread.sleep(20L);
            }
            catch (Exception ex3) {}
            this.a.a(String.valueOf(this.a.nb) + " " + this.a.q + nb.z[0] + this.a.p, 1);
            try {
                Thread.sleep(20L);
            }
            catch (Exception ex4) {}
            ...
            if (!r) {
                if (a7.mb.equals(nb.z[4])) {
                    this.a.a(nb.z[5] + this.a.n, 1);
                    if (!r) {
                        return;
                    }
                }
            ...
            a7.a(nb.z[8] + this.a.n + " " + this.a.o, 1);
        }
        catch (Exception ex5) {
            this.a.a(String.valueOf(this.a.a(11, "", "", "")) + nb.z[1]);
            this.a.a(String.valueOf(this.a.a(10, "", "", "")) + nb.z[2] + this.a.qc + ")");
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "\u001bqu&MWuu6X\u001bjs+\u001f\t= ".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "\u0013.3".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "\u001b5".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "1=V,_ZsiedZi{6E".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "t{|".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "uTY\u000e\f".toCharArray();
        ...
        final int n19 = 6;
        final char[] charArray7 = "yqu&G^y:\u0001CV|s+_".toCharArray();
        ...
        final int n22 = 7;
        final char[] charArray8 = "zqv*[^y:\u0001CV|s+_".toCharArray();
        ...
        final int n25 = 8;
        final char[] charArray9 = "Uty.\f".toCharArray();
        ...
        final int n28 = 9;
        final char[] charArray10 = "k\\I\u0016\f".toCharArray();
        ...
        final int n31 = 10;
        final char[] charArray11 = "Hxn1EUzikXCi".toCharArray();
        ...
        final int n34 = 11;
        final char[] charArray12 = "jHS\u0011\f\u0001".toCharArray();
        ...
        final int n37 = 12;
        final char[] charArray13 = "\u0013/3".toCharArray();
