    ...
    public final void run() {
        ...
        try {
            ...
            if (!this.q.a_()) {
                ...
                String s;
                if (cp == null) {
                    s = t.q(al.q("The connection to the %1 server was unexpectedly broken."), new String[] { cs.e });
                }
                else {
                    s = t.q(al.q("The connection to the %1 server was unexpectedly broken while receiving message type %2."), new String[] { cs.e, Integer.toHexString(cp.q()) });
                }
                cp2.q(0, 0, s);
