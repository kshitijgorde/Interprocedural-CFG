...
public abstract class GenericPatternCache implements PatternCache
{
    ...
    public final synchronized Pattern getPattern(final String s, final int n) throws MalformedCachePatternException {
        Pattern addPattern;
        try {
            addPattern = this.addPattern(s, n);
        }
        catch (MalformedPatternException ex) {
            throw new MalformedCachePatternException("Invalid expression: " + s + "\n" + ex.getMessage());
        }
        return addPattern;
    }
