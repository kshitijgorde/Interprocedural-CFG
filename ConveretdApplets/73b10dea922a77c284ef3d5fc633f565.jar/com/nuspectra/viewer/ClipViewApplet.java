...
public class ClipViewApplet extends NuApplet implements Runnable
{
    Toolkit tk;
    ImageSlider slider;
        ...
        try {
            if (index != this.curIndex) {
                ...
                if (image != null) {
                    ...
                    this.curIndex = index;
                    this.frameDate.setTime(this.stream.getTimestamp(index));
    ...
    protected boolean handleMessage(final int id, final Object arg) {
        ...
        switch (id) {
            ...
            case 1100: {
                ...
                final ImageButtonCanvas b = (ImageButtonCanvas)arg;
                if ("start".equals(b.getCommand())) {
                    this.startPlay();
                    break;
                }
                if ("pause".equals(b.getCommand())) {
                    this.stopPlay();
                    break;
                }
                break;
