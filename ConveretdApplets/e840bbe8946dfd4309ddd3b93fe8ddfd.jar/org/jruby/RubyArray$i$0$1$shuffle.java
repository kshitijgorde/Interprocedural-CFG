...
public class RubyArray$i$0$1$shuffle extends JavaMethodN
{
    public RubyArray$i$0$1$shuffle(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyArray)rubyObject).shuffle(context, array);
    }
}
