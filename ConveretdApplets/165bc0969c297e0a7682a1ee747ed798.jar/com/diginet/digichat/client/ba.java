...
public final class ba extends ag
{
        ...
        switch (event.id) {
            ...
            case 1001: {
                if (event.target == this.a) {
                    if (new e(this.c.getText()).equals(this.d.h)) {
                        this.g = true;
                        this.dispose();
                        this.d.b = false;
                    }
                    else {
                        new a6(this.f, com.esial.util.c.a("Note"), com.esial.util.c.a("You have not entered the correct password for this room.  Please try again."), this.e).setVisible(true);
                    }
                }
                else if (event.target == this.b) {
                    this.g = true;
                    this.dispose();
                    if (this.e.b == -999 || !this.e.f) {
                        this.e.u();
                    }
                }
                return true;
    ...
    public ba(final Frame f, final i e, final bo d) {
        super(f, com.esial.util.c.a("Enter Password"), true);
        this.a = new r(80, 20);
        this.b = new r(80, 20);
        this.c = new TextField(15);
        this.g = false;
        this.setBackground(e.cc.j);
        this.setForeground(e.cc.i);
        ...
        final aw aw = new aw(a5.a(com.esial.util.c.a("You must enter the correct password to enter %1."), new String[] { d.x() }));
        this.d = d;
