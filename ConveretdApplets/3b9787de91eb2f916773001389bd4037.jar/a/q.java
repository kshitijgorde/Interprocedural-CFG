...
public class q extends Panel
{
    ...
    public q(final int n, final int n2, final int n3, final int n4, final int q) {
        this(n, n2, n3, n4);
        this.q = q;
    }
    
    public q(final int n, final int n2, final int n3, final int n4) {
        this.q = 0;
