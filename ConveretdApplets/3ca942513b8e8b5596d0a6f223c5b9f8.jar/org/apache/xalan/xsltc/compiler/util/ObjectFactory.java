...
class ObjectFactory
{
    ...
    static /* synthetic */ Class class$org$apache$xalan$xsltc$compiler$util$ObjectFactory;
    ...
    static String lookUpFactoryClassName(final String factoryId, String propertiesFilename, final String fallbackClassName) {
        ...
        if (propertiesFilename == null) {
            ...
            final Class clazz = (ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory = class$("org.apache.xalan.xsltc.compiler.util.ObjectFactory")) : ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory;
            synchronized (clazz) {
    ...
    static ClassLoader findClassLoader() throws ConfigurationError {
        ...
        ClassLoader current;
        for (current = ((ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory = class$("org.apache.xalan.xsltc.compiler.util.ObjectFactory")) : ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory).getClassLoader(), chain = system; current != chain; chain = ss.getParentClassLoader(chain)) {
            if (chain == null) {
                return current;
            }
        }
    ...
    static Class findProviderClass(final String className, ClassLoader cl, final boolean doFallback) throws ClassNotFoundException, ConfigurationError {
        ...
        if (cl == null) {
            ...
            try {
                ...
                final ClassLoader current = ((ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory == null) ? (ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory = class$("org.apache.xalan.xsltc.compiler.util.ObjectFactory")) : ObjectFactory.class$org$apache$xalan$xsltc$compiler$util$ObjectFactory).getClassLoader();
                if (current == null) {
                    providerClass = Class.forName(className);
                }
                else {
