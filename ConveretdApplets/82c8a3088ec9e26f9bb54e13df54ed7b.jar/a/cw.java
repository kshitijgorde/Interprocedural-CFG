...
public class cw extends Panel
{
    ...
    public cw(final int n, final int n2, final int n3, final int n4, final int q) {
        this(n, n2, n3, n4);
        this.q = q;
    }
    
    public cw(final int n, final int n2, final int n3, final int n4) {
        this.q = 0;
