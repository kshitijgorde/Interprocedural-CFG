...
public class o extends e
{
    ...
    public o() {
        ...
        this.a(new com.easypano.tw.c.o(this));
        this.r.a(false);
        ...
        this.add(this.l, b("J|7\b\u000e{"));
        this.add(this.q, b("Zv,\b\u0003"));
        this.o.b(42);
        this.p.b(41);
    ...
    public void a(final n o, final n p2) {
        ...
        this.o = o;
        this.p = p2;
        this.q.add(this.o, b("J|7\b\u000e{"));
        this.q.add(this.r, b("Lx*\b"));
        this.add(this.p, b("Lx*\b"));
