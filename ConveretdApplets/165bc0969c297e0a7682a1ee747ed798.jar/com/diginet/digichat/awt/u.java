...
public class u extends Panel
{
    public boolean a;
    public boolean b;
    private Color clrCtrlBack;
    
    public void paint(final Graphics graphics) {
        final Dimension size = this.size();
        final int n = size.height - 1;
        final int n2 = size.width - 1;
        final Color darker = this.clrCtrlBack.darker();
        final Color brighter = this.clrCtrlBack.brighter();
        if (this.b) {
            graphics.setColor(this.clrCtrlBack);
    ...
    public void a(final boolean b, final boolean a) {
    ...
    public u(final Component component) {
        this.a = true;
        this.b = true;
        this.clrCtrlBack = CommonStyle.clrCtrlBack;
