...
public abstract class ca extends Panel
{
    public Image a;
    private aU[] a;
    protected int a;
    ...
    public final synchronized void a(final aU au) {
        try {
            int a = 0;
            int d = -1;
            ...
            this.a(this.a[(this.c - 1 + this.e) % this.a.length] = au, this.a.size().width - 12 - 36, this.getFontMetrics(this.a.a.b()));
            final int height = this.a.size().height;
            this.d += au.a;
            if (this.isShowing() && this.a == this.a.getMaximum() - a) {
                final int n2;
                final Graphics graphics;
                if ((n2 = this.d - this.a - height - 1) < au.a && (graphics = this.a.getGraphics()) != null) {
                    this.a(au, this.d - au.a - this.a + 1, graphics);
                }
                if (n2 > 0) {
                    if (this.a.u == 4) {
                        this.b(-n2);
                        ...
                        final int n3 = (int)Math.ceil(n2 / Math.pow(3.0, 4 - this.a.u));
    ...
    public abstract void a(final aU p0, final int p1, final FontMetrics p2);
    
    public abstract void a(final aU p0, final int p1, final Graphics p2);
    
    public final synchronized aU a(final int n) {
    ...
    public final aU a(final Event event) {
        try {
            if (event.x >= 36) {
    ...
    public final synchronized void b() {
        ...
        this.d = -1;
        if (this.c == 0) {
            ((cn)(this.a = 0)).setValues(0, height, 0, 0);
            return;
        }
    ...
    public final void a(int i) {
        while (i < this.c - 1) {
            this.a[(i + this.e) % this.a.length] = this.a[(i + 1 + this.e) % this.a.length];
            ++i;
        }
        this.a[(this.c - 1 + this.e) % this.a.length] = null;
        --this.c;
        this.a.a();
        this.b();
        this.a.repaint();
    ...
    public ca(final cs a, final boolean b) {
        this.a = Color.black;
        this.a = null;
        this.a = 0;
        this.b = 0;
        ...
        (this.a = new cn()).setLineIncrement(10);
        layout.setConstraints(this.a, gridBagConstraints);
        this.add(this.a);
    }
}
