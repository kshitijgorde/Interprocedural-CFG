...
public final class al extends au
{
    ...
    private al(final int a) {
        this.a = a;
    }
    
    public al(final int n, final Color color, final Color color2) {
        this(n, color.brighter(), color, color2, color2.brighter());
    }
    
    private al(final int n, final Color a, final Color b, final Color d, final Color c) {
        this(n);
        this.a = a;
        this.b = b;
        this.d = d;
