...
class b extends Canvas implements MouseListener, MouseMotionListener
{
    ...
    public void paint(final Graphics graphics) {
            ...
            Label_0086: {
                Label_0079: {
                    if (!r) {
                        ...
                        this.b = this.a.Ob.createImage(16, this.getSize().height);
        ...
        final int n3 = n2;
        this.c.drawImage(this.a.z, 0, 0, 16, n3, 75, 57, 92, 64, null);
        this.j.setSize(16, n3 - 32);
        final boolean m = this.m;
        Label_0213: {
            if (!r) {
                if (m) {
                    this.c.drawImage(this.a.z, 0, 0, 16, 16, 109, 39, 125, 55, null);
                    if (!r) {
                        break Label_0213;
                    }
                }
                this.c.drawImage(this.a.z, 0, 0, 16, 16, 93, 39, 109, 55, null);
            }
        }
        final int q = this.q;
        if (!r) {
            Label_0356: {
                if (q > 0) {
                    ...
                    if (!r) {
                        if (o) {
                            this.c.drawImage(this.a.z, 0, n4, 16, n4 + 16, 109, 55, 125, 71, this);
                            if (!r) {
                                break Label_0356;
                            }
                        }
                        this.c.drawImage(this.a.z, 0, n4, 16, n4 + 16, 93, 55, 109, 71, this);
                    }
                }
            }
        ...
        Label_0437: {
            if (!r) {
                if (q != 0) {
                    this.c.drawImage(this.a.z, 0, n3 - 16, 16, n3, 109, 71, 125, 87, this);
                    if (!r) {
                        break Label_0437;
                    }
                }
                this.c.drawImage(this.a.z, 0, n3 - 16, 16, n3, 93, 71, 109, 87, this);
            }
        }
    ...
    public void a(final int p4, final int n, final int n2, final int q) {
        ...
        this.q = q;
        this.repaint();
        final int d = ((z)this.getParent()).b.d ? 1 : 0;
        b b = null;
        Label_0060: {
            if (!r) {
                if (d == 0) {
