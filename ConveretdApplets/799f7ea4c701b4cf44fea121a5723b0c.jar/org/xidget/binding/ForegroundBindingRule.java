...
public class ForegroundBindingRule implements IBindingRule
{
    ...
    private static final class Listener extends ExpressionListener
    {
        ...
        public void notifyAdd(final IExpression expression, final IContext context, final List<IModelObject> list) {
            ...
            this.xidget.getFeature(IWidgetFeature.class).setForeground(getColor(Xlate.get(this.node, "ffffff")));
        }
        ...
        public void notifyChange(final IExpression expression, final IContext context, final double n, final double n2) {
            this.xidget.getFeature(IWidgetFeature.class).setForeground((int)n);
        }
        
        @Override
        public void notifyChange(final IExpression expression, final IContext context, final String s, final String s2) {
            this.xidget.getFeature(IWidgetFeature.class).setForeground(getColor(s));
        }
