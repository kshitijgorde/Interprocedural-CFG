...
public class TeletextSelectionTool extends TeletextTool implements TeletextToolInterface, ClipboardOwner
{
    ...
    public void deleteSelection() {
        switch (this.getPageCanvas().getEditingMode()) {
            ...
            case 1: {
                this.getPage().fillRectangle(this.selectionData.getX1(), this.selectionData.getY1(), this.selectionData.getX2(), this.selectionData.getY2(), false);
                break;
            }
        }
    }
    ...
    public boolean invokeMethod(final String s) {
        if (s.equals("pasteFromClipboard")) {
            this.pasteFromClipboard();
            return true;
        }
