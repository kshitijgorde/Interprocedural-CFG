...
class cb extends Panel implements ActionListener, ComponentListener
{
    ...
    cb(final esChat a, final String e) {
        ...
        a.getClass();
        this.b = new eb(a, cb.z[0]);
        this.b.c.setFont(new Font(a.bb, a.d, a.eb));
        this.b.c.setBackground(a.h);
        a.getClass();
        this.add(this.d = new y(a, this.b, false), cb.z[2]);
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "(X`XU\b".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "(CtXH".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "8IoXE\t".toCharArray();
