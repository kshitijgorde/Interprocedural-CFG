...
public class AnnotatedMBean extends StandardMBean
{
    ...
    public AnnotatedMBean(final T impl, final Class<T> mbeanInterface) throws NotCompliantMBeanException {
    ...
    static {
        ...
        final Class[] arr$;
        final Class<?>[] p = (Class<?>[])(arr$ = new Class[] { Byte.TYPE, Short.TYPE, Integer.TYPE, Long.TYPE, Float.TYPE, Double.TYPE, Character.TYPE, Boolean.TYPE });
