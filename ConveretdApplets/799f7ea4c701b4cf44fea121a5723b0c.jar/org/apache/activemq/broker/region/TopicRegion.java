...
public class TopicRegion extends AbstractRegion
{
    ...
    public Subscription addConsumer(final ConnectionContext context, final ConsumerInfo info) throws Exception {
        if (info.isDurable()) {
            ...
            sub.activate(this.usageManager, context, info);
            return sub;
        }
    ...
    public void removeSubscription(final ConnectionContext context, final RemoveSubscriptionInfo info) throws Exception {
        ...
        final DurableTopicSubscription sub = this.durableSubscriptions.remove(key);
        if (sub == null) {
        ...
        if (this.subscriptions.get(sub.getConsumerInfo()) != null) {
            super.removeConsumer(context, sub.getConsumerInfo());
        }
        else {
    ...
    private ConsumerInfo createInactiveConsumerInfo(final SubscriptionInfo info) {
