...
class Seloc
{
    ...
    public void locMenu(final Choice locChoice) {
        ...
        locChoice.addItem("Recklinghausen");
        ...
        locChoice.addItem("NEAR EAST ------");
        locChoice.addItem("Cairo");
        locChoice.addItem("Riyadh");
        locChoice.addItem("AFRICA ---------");
        locChoice.addItem("Addis Abeba");
        locChoice.addItem("Algier");
        locChoice.addItem("Cairo");
        locChoice.addItem("Cape Town");
        locChoice.addItem("Dakar");
        locChoice.addItem("Johannesburg");
        locChoice.addItem("Khartoum");
        locChoice.addItem("Lagos");
        locChoice.addItem("Nairobi");
        locChoice.addItem("Windhoek");
    ...
    public double getLatLong(final String locString, final int n) {
        if (locString.equals("User Input")) {
            ...
            this.latitude = 51.613;
            this.longitude = 7.958;
        }
        else if (locString.equals("50N10E")) {
            this.latitude = 50.0;
            this.longitude = 10.0;
        }
        else if (locString.equals("Recklinghausen")) {
            this.latitude = 51.625;
            this.longitude = 7.182;
        }
        ...
        else if (locString.equals("Riyadh")) {
            this.latitude = 24.67;
            this.longitude = 46.71;
        }
        else if (locString.equals("Addis Abeba")) {
            this.latitude = 9.03;
            this.longitude = 38.7;
        }
        else if (locString.equals("Algier")) {
            this.latitude = 36.76;
            this.longitude = 3.05;
        }
        else if (locString.equals("Cairo")) {
            ...
            this.latitude = -33.92;
            this.longitude = 18.42;
        }
        else if (locString.equals("Dakar")) {
            this.latitude = 14.67;
            this.longitude = -17.43;
        }
        else if (locString.equals("Johannesburg")) {
            this.latitude = -26.2;
            this.longitude = 28.083;
        }
        else if (locString.equals("Khartoum")) {
            this.latitude = 15.59;
            this.longitude = 32.53;
        }
        else if (locString.equals("Lagos")) {
            this.latitude = 6.45;
            this.longitude = 3.4;
        }
        else if (locString.equals("Nairobi")) {
            this.latitude = -1.28;
            this.longitude = 36.82;
        }
        else if (locString.equals("Windhoek")) {
            this.latitude = -22.57;
            this.longitude = 17.08;
        }
