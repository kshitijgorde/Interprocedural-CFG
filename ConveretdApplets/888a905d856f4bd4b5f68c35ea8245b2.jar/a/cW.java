...
public final class cW extends Panel implements MouseListener
{
    ...
    public cW(final at q, final cw q2, final n q3) {
        this.setLayout(null);
        this.q = q;
        this.q = q3;
        this.q = q2.q("mb", 0, 0);
        ...
        this.addFocusListener(new bc(this));
        if (q.q) {
            this.q = new ai(q.q, q2, true, null);
        }
    }
    ...
    private Image q() {
        final boolean b = this.q.q.equalsIgnoreCase(dX.n) && cW.w != null;
        final boolean b2 = this.q.q.equalsIgnoreCase(dX.m) && cW.r != null;
    ...
    static cw q(final cW cw) {
        return cw.q;
    }
    
    static void q(final cW cw) {
        cw.e();
    }
