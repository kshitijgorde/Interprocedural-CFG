...
public class medium extends Applet implements Runnable
{
    TextField Xsize;
    TextField Ysize;
    TextField Mines;
    ...
    public void SubmitScore() {
        final long n = 0L;
        try {
            this.getAppletContext().showDocument(new URL("http://porter.desy.de/ms/cgi-bin/uncgi.cgi/Mina.cgi/query?level=" + this.level + "&popeyes=" + 0L + "&kfc=" + n + "&churchs=" + this.ntries + "&hardys=" + this.nclicks + "&playerName=" + this.makeGoodString()));
        }
        catch (Exception ex) {
    ...
    public void YouLose() {
        this.myMessage.setText("The princess");
        this.mySecondMessage.setText("is displeased.");
        this.stop();
        this.inPlay = false;
    }
    ...
    public boolean doMouseDown(final Event event, final int n, final int n2) {
        ...
        if (n > this.xmin && n < this.xmin + (50 + this.bd * 2) && n2 > this.ymin + this.nyButtons * this.sz && n2 < this.ymin + this.nyButtons * this.sz + (25 + this.bd * 2)) {
    ...
    public void dosetup() {
        ...
        this.ibutton = 0;
        this.nl = this.nMines;
        this.nuntouched = this.nxButtons * this.nyButtons;
        this.it = new ImgButton[this.nxButtons][this.nyButtons];
        this.restartButton = new ImgButton(this.Buttons[14], this.xmin + this.nxButtons * this.sz / 2 - (50 + this.bd * 2) / 2, this.ymin - (62 + this.bd * 2), true, this);
        this.firstflagButton = new ImgButton(this.Buttons[15], this.xmin, this.ymin + this.nyButtons * this.sz, true, this);
