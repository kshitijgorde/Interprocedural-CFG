...
public class EnvironmentCheck
{
    ...
    public EnvironmentCheck() {
        this.jarNames = new String[] { "xalan.jar", "xalansamples.jar", "xalanj1compat.jar", "xalanservlet.jar", "serializer.jar", "xerces.jar", "xercesImpl.jar", "b2bxml.jar", "testxsl.jar", "crimson.jar", "lotusxsl.jar", "jaxp.jar", "parser.jar", "dom.jar", "sax.jar", "xml.jar", "xml-apis.jar", "xsltc.jar" };
    ...
    protected boolean writeEnvironmentReport(final Hashtable h) {
        ...
        this.logMsg("#---- BEGIN writeEnvironmentReport(Revision: 1.42): Useful stuff found: ----");
    ...
    public void appendEnvironmentReport(final Node container, final Document factory, final Hashtable h) {
        ...
        try {
            ...
            envCheckNode.setAttribute("version", "Revision: 1.42");
    ...
    protected void checkParserVersion(Hashtable h) {
        ...
        try {
            final String B2BXML_VERSION_CLASS = "com.ibm.xml.b2b.Version";
            final String B2BXML_VERSION_METHOD = "getVersion";
            final Class clazz2 = ObjectFactory.findProviderClass("com.ibm.xml.b2b.Version", ObjectFactory.findClassLoader(), true);
            final Class[] noArgs = new Class[0];
            final Method method = clazz2.getMethod("getVersion", (Class[])noArgs);
            final Object b2bxmlVersion = method.invoke(null, new Object[0]);
            h.put("version.b2bxml", (String)b2bxmlVersion);
        }
        catch (Exception e) {
            h.put("version.b2bxml", "not-present");
        }
    }
    ...
    static {
        ...
        EnvironmentCheck.jarVersions.put(new Long(857171L), "xalan.jar from lotusxsl-j_1_0_1");
        EnvironmentCheck.jarVersions.put(new Long(802165L), "xalan.jar from lotusxsl-j_2_0_0");
        EnvironmentCheck.jarVersions.put(new Long(857692L), "xalan.jar from lotusxsl-j_2_2");
        EnvironmentCheck.jarVersions.put(new Long(906359L), "xalan.jar from lotusxsl-j_2_3_1");
        EnvironmentCheck.jarVersions.put(new Long(857692L), "xalan.jar from lotusxsl-j_2_3_2");
        EnvironmentCheck.jarVersions.put(new Long(1201514L), "xalan.jar from lotusxsl-j_2_3_3");
        EnvironmentCheck.jarVersions.put(new Long(1201599L), "xalan.jar from lotusxsl-j_2_3_4");
        EnvironmentCheck.jarVersions.put(new Long(1201641L), "xalan.jar from lotusxsl-j_2_3_5");
        EnvironmentCheck.jarVersions.put(new Long(1201693L), "xalan.jar from lotusxsl-j_2_3_6");
        EnvironmentCheck.jarVersions.put(new Long(1343764L), "xalan.jar from lotusxsl-j_2_4_0");
        EnvironmentCheck.jarVersions.put(new Long(1345301L), "xalan.jar from lotusxsl-j_2_4_1");
        EnvironmentCheck.jarVersions.put(new Long(1345793L), "xalan.jar from lotusxsl-j_2_4_2");
        EnvironmentCheck.jarVersions.put(new Long(1352562L), "xalan.jar from lotusxsl-j_2_4_3");
        EnvironmentCheck.jarVersions.put(new Long(226589L), "serializer.jar from XSLT4J-2_7_0");
        ...
        EnvironmentCheck.jarVersions.put(new Long(108484L), "xml-apis.jar from xalan-j_2_3_0, or xalan-j_2_3_1 or xalan-j_2_4_D1 from xml-commons-1.0.b2");
        EnvironmentCheck.jarVersions.put(new Long(108017L), "xml-apis.jar from lotusxsl-j_2_3_1");
        EnvironmentCheck.jarVersions.put(new Long(109049L), "xml-apis.jar from xalan-j_2_4_0, lotusxsl-j_2_3_2 or lotusxsl-j_2_3_3 from xml-commons RIVERCOURT1");
        EnvironmentCheck.jarVersions.put(new Long(113749L), "xml-apis.jar from xalan-j_2_4_1, lotusxsl-j_2_3_4 or lotusxsl-j_2_3_5 from factoryfinder-build of xml-commons RIVERCOURT1");
        EnvironmentCheck.jarVersions.put(new Long(113981L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons");
        EnvironmentCheck.jarVersions.put(new Long(124704L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons");
        EnvironmentCheck.jarVersions.put(new Long(124720L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons");
        EnvironmentCheck.jarVersions.put(new Long(124575L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons");
        EnvironmentCheck.jarVersions.put(new Long(124805L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons");
        EnvironmentCheck.jarVersions.put(new Long(124724L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons, tag = xml-commons-external-1_2_01");
        EnvironmentCheck.jarVersions.put(new Long(129319L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons, tag = xml-commons-external-1_2_02");
        EnvironmentCheck.jarVersions.put(new Long(129680L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons, tag = xml-commons-external-1_2_03");
        EnvironmentCheck.jarVersions.put(new Long(129749L), "xml-apis.jar from tck-jaxp-1_2_0 branch of xml-commons, tag = xml-commons-external-1_2_04");
        EnvironmentCheck.jarVersions.put(new Long(192444L), "xml-apis.jar from jaxp1.3 release, level jaxp1.3");
        EnvironmentCheck.jarVersions.put(new Long(192907L), "xml-apis.jar from jaxp1.3 release, level jaxp1.3.2");
        EnvironmentCheck.jarVersions.put(new Long(193605L), "xml-apis.jar from jaxp1.3 release, level jaxp1.3.3");
        EnvironmentCheck.jarVersions.put(new Long(193592L), "xml-apis.jar from jaxp1.3 release, level jaxp1.3.4");
        EnvironmentCheck.jarVersions.put(new Long(193648L), "xml-apis.jar from jaxp1.3 release, level jaxp1.3.5");
        ...
        EnvironmentCheck.jarVersions.put(new Long(1729063L), "xercesImpl.jar from lotusxsl-j_2_3_1 from XML4J-4_0_0");
        EnvironmentCheck.jarVersions.put(new Long(1738551L), "xercesImpl.jar from lotusxsl-j_2_3_2 from XML4J-4_0_2");
        EnvironmentCheck.jarVersions.put(new Long(3243826L), "xercesImpl.jar from lotusxsl-j_2_3_3 from XML4J-4_0_5");
        EnvironmentCheck.jarVersions.put(new Long(1171789L), "xercesImpl.jar from lotusxsl-j_2_3_4 from XML4J-4_0_6");
        EnvironmentCheck.jarVersions.put(new Long(1174955L), "xercesImpl.jar from lotusxsl-j_2_3_5 from XML4J-4_0_8");
        EnvironmentCheck.jarVersions.put(new Long(1173922L), "xercesImpl.jar from lotusxsl-j_2_3_6 from XML4J-4_0_9");
        EnvironmentCheck.jarVersions.put(new Long(831828L), "xercesImpl.jar from lotusxsl-j_2_4_0 from XML4J-4_1_1");
        EnvironmentCheck.jarVersions.put(new Long(1114292L), "xercesImpl.jar from lotusxsl-j_2_4_1, lotusxsl-j_2_4_2 or lotusxsl-j_2_4_3 from XML4J-4_1_3");
        EnvironmentCheck.jarVersions.put(new Long(885434L), "xercesImpl.jar from XSLT4J-2_5_0beta from XML4J-4_2_0beta");
        EnvironmentCheck.jarVersions.put(new Long(895925L), "xercesImpl.jar from XSLT4J-2_5_0 from XML4J-4_2_0");
        EnvironmentCheck.jarVersions.put(new Long(1209585L), "xercesImpl.jar from XML4J-4_2_2");
        EnvironmentCheck.jarVersions.put(new Long(1209556L), "xercesImpl.jar from XML4J-4_2_3");
        EnvironmentCheck.jarVersions.put(new Long(950131L), "xercesImpl.jar from XML4J-4_3_0beta");
        EnvironmentCheck.jarVersions.put(new Long(1010806L), "xercesImpl.jar from XML4J-4_3_0");
        EnvironmentCheck.jarVersions.put(new Long(1422751L), "xercesImpl.jar from XML4J-4_3_1");
        EnvironmentCheck.jarVersions.put(new Long(1423434L), "xercesImpl.jar from XML4J-4_3_2");
        EnvironmentCheck.jarVersions.put(new Long(1423982L), "xercesImpl.jar from XML4J-4_3_3");
        EnvironmentCheck.jarVersions.put(new Long(1255171L), "xercesImpl.jar from XML4J-4_4_0");
        EnvironmentCheck.jarVersions.put(new Long(1825859L), "xercesImpl.jar from XML4J-4_4_3");
        EnvironmentCheck.jarVersions.put(new Long(1827995L), "xercesImpl.jar from XML4J-4_4_4");
        EnvironmentCheck.jarVersions.put(new Long(1829599L), "xercesImpl.jar from XML4J-4_4_5");
        EnvironmentCheck.jarVersions.put(new Long(343458L), "b2bxml.jar from B2BXML4J 1.2.0");
        EnvironmentCheck.jarVersions.put(new Long(615993L), "b2bxml.jar from B2BXML4J 1.2.1");
    }
}
