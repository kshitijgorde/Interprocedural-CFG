...
public class DS_CrossFade extends Applet implements Runnable
{
    Thread _fld1;
    int _fld3;
    Font _fld4;
        ...
        if (this._fld2b != null) {
            if (this._fld7b == 0) {
                if (!this._fld9f) {
                    ...
                    graphics.drawImage(this._fld2b, 0, 0, this);
                }
            }
            else if (this._fld7b == 1) {
                this._fld5c.drawImage(this._fld2b, 0, 0, this);
                this._mth0c(this._fld5c);
            }
    ...
    void _mth2b() {
        ...
        this._fld3f = ((this._fld3f >= 0) ? ((this._fld3f <= 60) ? this._fld3f : 60) : 0);
    ...
    void _mth5b() {
        ...
        this._mth6b(this._fld9e[this._fld0f], this._fld0b, this._fld8, this._fld9);
