...
final class br extends az
{
    ...
    public final boolean handleEvent(final Event event) {
        switch (event.id) {
            ...
            case 506: {
                ((bH)(this.q.q = null)).setValue(this.q.w - (event.y - this.q));
                final int n;
            ...
            case 1001: {
                final s s2;
                if (event.arg instanceof s && (s2 = (s)event.arg).y != -1) {
                    this.q.q.e(s2.y);
                    break;
                }
                break;
