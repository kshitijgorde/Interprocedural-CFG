...
public final class bf extends Canvas
{
    private final be a;
        ...
        if (this.isShowing()) {
            ...
            for (int i = this.a.b; i < n; ++i) {
                ...
                if ((graphics2 = this.getGraphics()) != null) {
                    ...
                    final Image a3 = ((K)this.a.a.a(n3)).a;
                    final Rectangle a4 = this.a(n3 - this.a.b);
                    graphics4.drawImage(a3, 1 + a4.x + (a4.width - 20) / 2, 1 + a4.y + (a4.height - 20) / 2, this);
                    graphics2.dispose();
                }
            }
        }
