...
public final class JTimeChart extends JDataChart
{
    ...
    public JTimeChart(final Applet applet) {
        this.b = false;
    ...
    public JTimeChart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
        this(applet);
