...
public class RubyIO$s$0$1$foreach extends JavaMethodNBlock
{
    public RubyIO$s$0$1$foreach(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyIO.foreach(context, recv, array, block);
    }
}
