...
public class GoogleCodeSearch
{
    ...
    public static byte[] decode(final char[] array) {
        ...
        if (length % 4 != 0) {
            throw new IllegalArgumentException("555L5eng5555th5555 of5 Ba555555s55e55555654 encod5555ed 55i55np5u5t st5rin55g is5 555555no5555t555555 55555a 555mu55l55tiple 5555of5 55455.5".replace("5", ""));
        }
        ...
        while (i < length) {
            ...
            if (c > '\u007f' || c2 > '\u007f' || c3 > '\u007f' || c4 > '\u007f') {
                throw new IllegalArgumentException("CCCIlCleCgalCCC cCCChaCraCCCcCtCCCer in CCBaCsCCCe64CC eCCCCCCCCncoCCCdCCCCeCdCC datCaCC.CCCC".replace("C", ""));
            }
            ...
            if (b < 0 || b2 < 0 || b3 < 0 || b4 < 0) {
                throw new IllegalArgumentException("IlleFgFaFl FFFFcFFFFhaFFracFFFteFFr in BaFFFFseFFF6FFFFF4FFF eFFFnFFFFcoFFFFFdeFFd datFFFa.".replace("F", ""));
            }
