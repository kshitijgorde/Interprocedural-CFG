...
class b extends Canvas implements MouseListener, MouseMotionListener
{
    ...
    public void paint(final Graphics graphics) {
            ...
            Label_0086: {
                Label_0079: {
                    if (m == 0) {
                        ...
                        this.b = this.a.Ib.createImage(16, this.getSize().height);
        ...
        final int n3 = n2;
        this.c.drawImage(this.a.y, 0, 0, 16, n3, 75, 57, 92, 64, null);
        this.j.setSize(16, n3 - 32);
        final boolean i = this.m;
        Label_0213: {
            if (m == 0) {
                if (i) {
                    this.c.drawImage(this.a.y, 0, 0, 16, 16, 109, 39, 125, 55, null);
                    if (m == 0) {
                        break Label_0213;
                    }
                }
                this.c.drawImage(this.a.y, 0, 0, 16, 16, 93, 39, 109, 55, null);
            }
        }
        final int q = this.q;
        if (m == 0) {
            Label_0356: {
                if (q > 0) {
                    ...
                    if (m == 0) {
                        if (o) {
                            this.c.drawImage(this.a.y, 0, n4, 16, n4 + 16, 109, 55, 125, 71, this);
                            if (m == 0) {
                                break Label_0356;
                            }
                        }
                        this.c.drawImage(this.a.y, 0, n4, 16, n4 + 16, 93, 55, 109, 71, this);
                    }
                }
            }
        ...
        Label_0437: {
            if (m == 0) {
                if (q != 0) {
                    this.c.drawImage(this.a.y, 0, n3 - 16, 16, n3, 109, 71, 125, 87, this);
                    if (m == 0) {
                        break Label_0437;
                    }
                }
                this.c.drawImage(this.a.y, 0, n3 - 16, 16, n3, 93, 71, 109, 87, this);
            }
        }
