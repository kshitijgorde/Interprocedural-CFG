...
public class GenericGraphApplet extends Applet implements ActionListener, ItemListener
{
    ...
    protected void setUpMainPanel() {
        ...
        if ("yes".equalsIgnoreCase(this.getParameter("UseLimitsPanel", "yes"))) {
            ...
            this.limitsPanel = new LimitControlPanel(String.valueOf(s) + "min", String.valueOf(s) + "max", String.valueOf(parameter) + "min", String.valueOf(parameter) + "max", 0, false);
        }
        ...
        try {
            ...
            if (equalsIgnoreCase) {
                ...
                for (int j = 3; j < array.length; ++j) {
                    ...
                    if (j - 3 < n) {
                        tableFunction.setY(j - 3, array[j]);
                    }
                }
            }
            else {
                ...
                for (int k = 0; k < array.length / 2; ++k) {
                    tableFunction.addPoint(array[2 * k], array[2 * k + 1]);
                }
            }
