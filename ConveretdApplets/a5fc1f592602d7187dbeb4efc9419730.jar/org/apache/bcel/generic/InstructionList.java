...
public class InstructionList implements Serializable
{
    ...
    public void setPositions(final boolean check) {
        ...
        for (InstructionHandle ih2 = this.start; ih2 != null; ih2 = ih2.next) {
            additional_bytes += ih2.updatePosition(additional_bytes, max_additional_bytes);
        }
        count = (index = 0);
        for (InstructionHandle ih3 = this.start; ih3 != null; ih3 = ih3.next) {
            final Instruction k = ih3.instruction;
    ...
    public InstructionList copy() {
        ...
        for (InstructionHandle ih2 = this.start, ch = il.start; ih2 != null; ih2 = ih2.next, ch = ch.next) {
            final Instruction j = ih2.instruction;
