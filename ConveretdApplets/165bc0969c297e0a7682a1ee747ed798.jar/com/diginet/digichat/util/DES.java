...
public class DES
{
    ...
    public void encrypt(final byte[] array, final int n, final byte[] array2, final int n2, final int n3) {
        ...
        for (int n4 = n + n3, i = n, n5 = n2; i < n4; i += 8, n5 += 8) {
            this.encrypt(iv0 ^ ((array[i] & 0xFF) | (array[i + 1] & 0xFF) << 8 | (array[i + 2] & 0xFF) << 16 | (array[i + 3] & 0xFF) << 24), iv2 ^ ((array[i + 4] & 0xFF) | (array[i + 5] & 0xFF) << 8 | (array[i + 6] & 0xFF) << 16 | (array[i + 7] & 0xFF) << 24), array3);
            iv0 = array3[0];
            iv2 = array3[1];
            array2[n5] = (byte)(iv0 & 0xFF);
            array2[n5 + 1] = (byte)(iv0 >>> 8 & 0xFF);
            array2[n5 + 2] = (byte)(iv0 >>> 16 & 0xFF);
            array2[n5 + 3] = (byte)(iv0 >>> 24 & 0xFF);
            array2[n5 + 4] = (byte)(iv2 & 0xFF);
            array2[n5 + 5] = (byte)(iv2 >>> 8 & 0xFF);
            array2[n5 + 6] = (byte)(iv2 >>> 16 & 0xFF);
            array2[n5 + 7] = (byte)(iv2 >>> 24 & 0xFF);
        }
        this.IV0 = iv0;
        this.IV1 = iv2;
    }
    ...
    public void decrypt(final byte[] array, final int n, final byte[] array2, final int n2, final int n3) {
        ...
        int iv2 = this.IV1;
        for (int n4 = n + n3, i = n, n5 = n2; i < n4; i += 8, n5 += 8) {
            final int n6 = (array[i] & 0xFF) | (array[i + 1] & 0xFF) << 8 | (array[i + 2] & 0xFF) << 16 | (array[i + 3] & 0xFF) << 24;
            final int n7 = (array[i + 4] & 0xFF) | (array[i + 5] & 0xFF) << 8 | (array[i + 6] & 0xFF) << 16 | (array[i + 7] & 0xFF) << 24;
            this.decrypt(n6, n7, array3);
            final int n8 = iv0 ^ array3[0];
            final int n9 = iv2 ^ array3[1];
            array2[n5] = (byte)(n8 & 0xFF);
            array2[n5 + 1] = (byte)(n8 >>> 8 & 0xFF);
            array2[n5 + 2] = (byte)(n8 >>> 16 & 0xFF);
            array2[n5 + 3] = (byte)(n8 >>> 24 & 0xFF);
            array2[n5 + 4] = (byte)(n9 & 0xFF);
            array2[n5 + 5] = (byte)(n9 >>> 8 & 0xFF);
            array2[n5 + 6] = (byte)(n9 >>> 16 & 0xFF);
            array2[n5 + 7] = (byte)(n9 >>> 24 & 0xFF);
            iv0 = n6;
            iv2 = n7;
        }
        this.IV0 = iv0;
    ...
    public void setKey(final byte[] array) {
        ...
        final int n2 = (array[4] & 0xFF) | (array[5] & 0xFF) << 8 | (array[6] & 0xFF) << 16 | (array[7] & 0xFF) << 24;
        ...
        int n19 = (n18 & 0xFF) << 16 | (n18 & 0xFF00) | (n18 >>> 16 & 0xFF) | (n17 >>> 4 & 0xF000000);
        ...
        for (int i = 0; i < 16; ++i) {
            ...
            n20 = (n22 & 0xFFFFFFF);
            n19 = (n23 & 0xFFFFFFF);
            final int n24 = DES.des_skb[0][n20 & 0x3F] | DES.des_skb[1][(n20 >>> 6 & 0x3) | (n20 >>> 7 & 0x3C)] | DES.des_skb[2][(n20 >>> 13 & 0xF) | (n20 >>> 14 & 0x30)] | DES.des_skb[3][(n20 >>> 20 & 0x1) | (n20 >>> 21 & 0x6) | (n20 >>> 22 & 0x38)];
            final int n25 = DES.des_skb[4][n19 & 0x3F] | DES.des_skb[5][(n19 >>> 7 & 0x3) | (n19 >>> 8 & 0x3C)] | DES.des_skb[6][n19 >>> 15 & 0x3F] | DES.des_skb[7][(n19 >>> 21 & 0xF) | (n19 >>> 22 & 0x30)];
            this.key_schedule[i * 2] = (n25 << 16 | (n24 & 0xFFFF));
            final int n26 = n24 >>> 16 | (n25 & 0xFFFF0000);
            this.key_schedule[i * 2 + 1] = (n26 << 4 | n26 >>> 28);
        }
    }
    
    public void encrypt(int n, int n2, final int[] array) {
        final int n3 = (n2 >>> 4 ^ n) & 0xF0F0F0F;
        n ^= n3;
        n2 ^= n3 << 4;
        final int n4 = (n >>> 16 ^ n2) & 0xFFFF;
        n2 ^= n4;
        n ^= n4 << 16;
        final int n5 = (n2 >>> 2 ^ n) & 0x33333333;
        n ^= n5;
        n2 ^= n5 << 2;
        final int n6 = (n >>> 8 ^ n2) & 0xFF00FF;
        n2 ^= n6;
        n ^= n6 << 8;
        final int n7 = (n2 >>> 1 ^ n) & 0x55555555;
        n ^= n7;
        n2 ^= n7 << 1;
        final int n8 = n2 << 1 | n2 >>> 31;
        n2 = (n << 1 | n >>> 31);
        n = n8;
        for (int i = 0; i < 32; i += 4) {
            final int n9 = n2 ^ this.key_schedule[i];
            final int n10 = n2 ^ this.key_schedule[i + 1];
            final int n11 = (n10 >>> 4) + (n10 << 28);
            n ^= (DES.des_SPtrans[1][n11 & 0x3F] | DES.des_SPtrans[3][n11 >>> 8 & 0x3F] | DES.des_SPtrans[5][n11 >>> 16 & 0x3F] | DES.des_SPtrans[7][n11 >>> 24 & 0x3F] | DES.des_SPtrans[0][n9 & 0x3F] | DES.des_SPtrans[2][n9 >>> 8 & 0x3F] | DES.des_SPtrans[4][n9 >>> 16 & 0x3F] | DES.des_SPtrans[6][n9 >>> 24 & 0x3F]);
            final int n12 = n ^ this.key_schedule[i + 2];
            final int n13 = n ^ this.key_schedule[i + 3];
            final int n14 = (n13 >>> 4) + (n13 << 28);
            n2 ^= (DES.des_SPtrans[1][n14 & 0x3F] | DES.des_SPtrans[3][n14 >>> 8 & 0x3F] | DES.des_SPtrans[5][n14 >>> 16 & 0x3F] | DES.des_SPtrans[7][n14 >>> 24 & 0x3F] | DES.des_SPtrans[0][n12 & 0x3F] | DES.des_SPtrans[2][n12 >>> 8 & 0x3F] | DES.des_SPtrans[4][n12 >>> 16 & 0x3F] | DES.des_SPtrans[6][n12 >>> 24 & 0x3F]);
        }
        n = (n >>> 1 | n << 31);
        n2 = (n2 >>> 1 | n2 << 31);
        final int n15 = (n2 >>> 1 ^ n) & 0x55555555;
        n ^= n15;
        n2 ^= n15 << 1;
        final int n16 = (n >>> 8 ^ n2) & 0xFF00FF;
        n2 ^= n16;
        n ^= n16 << 8;
        final int n17 = (n2 >>> 2 ^ n) & 0x33333333;
        n ^= n17;
        n2 ^= n17 << 2;
        final int n18 = (n >>> 16 ^ n2) & 0xFFFF;
        n2 ^= n18;
        n ^= n18 << 16;
        final int n19 = (n2 >>> 4 ^ n) & 0xF0F0F0F;
        n ^= n19;
        n2 ^= n19 << 4;
        array[0] = n;
        array[1] = n2;
    ...
    public void decrypt(int n, int n2, final int[] array) {
        final int n3 = (n2 >>> 4 ^ n) & 0xF0F0F0F;
        n ^= n3;
        n2 ^= n3 << 4;
        final int n4 = (n >>> 16 ^ n2) & 0xFFFF;
        ...
        for (int i = 30; i > 0; i -= 4) {
            ...
            n ^= (DES.des_SPtrans[1][n11 & 0x3F] | DES.des_SPtrans[3][n11 >>> 8 & 0x3F] | DES.des_SPtrans[5][n11 >>> 16 & 0x3F] | DES.des_SPtrans[7][n11 >>> 24 & 0x3F] | DES.des_SPtrans[0][n9 & 0x3F] | DES.des_SPtrans[2][n9 >>> 8 & 0x3F] | DES.des_SPtrans[4][n9 >>> 16 & 0x3F] | DES.des_SPtrans[6][n9 >>> 24 & 0x3F]);
            final int n12 = n ^ this.key_schedule[i - 2];
            final int n13 = n ^ this.key_schedule[i - 1];
            final int n14 = (n13 >>> 4) + (n13 << 28);
            n2 ^= (DES.des_SPtrans[1][n14 & 0x3F] | DES.des_SPtrans[3][n14 >>> 8 & 0x3F] | DES.des_SPtrans[5][n14 >>> 16 & 0x3F] | DES.des_SPtrans[7][n14 >>> 24 & 0x3F] | DES.des_SPtrans[0][n12 & 0x3F] | DES.des_SPtrans[2][n12 >>> 8 & 0x3F] | DES.des_SPtrans[4][n12 >>> 16 & 0x3F] | DES.des_SPtrans[6][n12 >>> 24 & 0x3F]);
        }
        n = (n >>> 1 | n << 31);
