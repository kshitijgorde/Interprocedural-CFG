...
public class RubyIO$i$0$1$readlines extends JavaMethodN
{
    public RubyIO$i$0$1$readlines(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyIO)rubyObject).readlines(context, array);
    }
}
