...
public class RubyArgsFile$s$0$1$gets extends JavaMethodN
{
    public RubyArgsFile$s$0$1$gets(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyArgsFile.gets(context, recv, array);
    }
}
