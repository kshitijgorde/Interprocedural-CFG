    ...
    public Destination intercept(final Destination destination) {
        if (destination.getActiveMQDestination().isQueue()) {
            ...
            try {
                ...
                MirroredQueue.LOG.error("Failed to lookup the mirror destination for: " + destination + ". Reason: " + e, e);
            }
        }
        return destination;
    }
    ...
    public void remove(final Destination destination) {
        ...
        if (topic != null) {
            try {
                ...
                MirroredQueue.LOG.error("Failed to remove mirror destination for " + destination + ". Reason: " + e, e);
            }
        }
    }
