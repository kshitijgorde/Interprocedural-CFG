...
public class X509Extensions extends ASN1Encodable
{
    ...
    public X509Extensions(final Vector vector, final Hashtable hashtable) {
        ...
        if (vector == null) {
            enumeration = (Enumeration<Object>)hashtable.keys();
        }
        else {
    ...
    public X509Extension getExtension(final DERObjectIdentifier derObjectIdentifier) {
        return this.extensions.get(derObjectIdentifier);
    }
    ...
    public DERObject toASN1Object() {
        ...
        while (elements.hasMoreElements()) {
            final DERObjectIdentifier derObjectIdentifier = elements.nextElement();
            final X509Extension x509Extension = this.extensions.get(derObjectIdentifier);
