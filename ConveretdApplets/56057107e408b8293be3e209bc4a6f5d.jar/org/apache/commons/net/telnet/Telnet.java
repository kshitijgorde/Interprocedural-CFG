...
class Telnet extends SocketClient
{
    ...
    void _setWill(final int option) {
    ...
    final synchronized void _sendSubnegotiation(final int[] subn) throws IOException {
        if (subn != null) {
            final byte[] byteresp = new byte[subn.length];
    ...
    void addOptionHandler(final TelnetOptionHandler opthand) throws InvalidTelnetOptionException {
    ...
    void deleteOptionHandler(final int optcode) throws InvalidTelnetOptionException {
        if (!TelnetOption.isValidOption(optcode)) {
            throw new InvalidTelnetOptionException("Invalid Option Code", optcode);
        }
        if (this.optionHandlers[optcode] == null) {
