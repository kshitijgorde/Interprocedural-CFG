...
final class ec extends Canvas
{
    ...
    public final synchronized void update(final Graphics graphics) {
        this.getSize();
        if (ec.q == null) {
            ec.q = dN.q(this, this.getSize().width, this.getSize().height, "vcr.u");
        }
        final Graphics graphics2 = ec.q.getGraphics();
        this.q = new Rectangle(8, 0, 8, 150);
        graphics2.setColor(Color.black);
        graphics2.drawImage(this.q.q(ec.q), 0, 0, this);
        ...
        graphics2.dispose();
        graphics.drawImage(ec.q, 0, 0, this);
    }
