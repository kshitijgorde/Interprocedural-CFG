...
public final class ToHTMLStream extends ToStream
{
        ...
        for (int i = 0; i < end; ++i) {
            ...
            if (this.escapingNotNeeded(ch) && !super.m_charInfo.isSpecialAttrChar(ch)) {
                ...
                if (i != pos) {
                    ...
                    final String outputStringForChar = super.m_charInfo.getOutputStringForChar(ch);
    ...
    static {
        m_htmlcharInfo = CharInfo.getCharInfo("org.apache.xml.serializer.HTMLEntities", "html");
