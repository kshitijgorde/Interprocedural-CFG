...
public class JBarchart extends JDataChart
{
    ...
    public JBarchart(final Applet applet) {
    ...
    public JBarchart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
        this.BAR_FORMAT_DEFAULT = 1;
        this.barFormat = this.BAR_FORMAT_DEFAULT;
        this.BAR_LAYOUT_DEFAULT = 1;
        this.barLayout = this.BAR_LAYOUT_DEFAULT;
    ...
    private void a(final Graphics graphics, final NFDataSeries nfDataSeries, final int n, final double n2, final double n3, final Color color, int n4, int n5, int n6, int n7, final int n8, final int n9, final int n10, final int n11, final int n12) {
        ...
        if (nfDataSeries.valueLabelStyle != 0) {
            JValueLabel.drawRectValueLabel((this.a == null) ? super.dwell.getLabel() : this.a, graphics, nfDataSeries, n4, n5, n6, n7, label, n8, n3, this.barLayout == 1);
        }
    }
    ...
    protected void defineParams() {
        ...
        JValueLabel.defineRectValueLabel(super.param, "Bar", this.BAR_VALUE_LABEL_STYLE_DEFAULT);
    ...
    protected synchronized void loadParams() throws Exception {
        ...
        this.a = JValueLabel.loadValueLabel(this, "Bar", 1, super.dataSeries, this.a, this.BAR_VALUE_LABEL_STYLE_DEFAULT);
