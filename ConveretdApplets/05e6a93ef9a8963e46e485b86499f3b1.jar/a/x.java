...
public final class x extends Canvas implements aB
{
    private Image q;
    private Image w;
    private Image e;
    ...
    public static x q(final Image image, final Image image2, final Image image3) {
        return new x(image, image2, image3, true);
    }
    ...
    private x(final Image q, final Image w, final Image e, final boolean b) {
        this.q = false;
        this.w = true;
        this.e = true;
        this.r = false;
