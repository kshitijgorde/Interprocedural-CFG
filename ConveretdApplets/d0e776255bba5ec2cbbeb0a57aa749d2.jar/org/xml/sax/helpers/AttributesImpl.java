...
public class AttributesImpl implements Attributes
{
    ...
    public void removeAttribute(final int n) {
        if (n >= 0 && n < this.length) {
            this.data[n * 5] = null;
            this.data[n * 5 + 1] = null;
            this.data[n * 5 + 2] = null;
            this.data[n * 5 + 3] = null;
            this.data[n * 5 + 4] = null;
            if (n < this.length - 1) {
                System.arraycopy(this.data, (n + 1) * 5, this.data, n * 5, (this.length - n) * 5);
            }
            --this.length;
        }
        else {
