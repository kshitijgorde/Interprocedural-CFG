...
public class RubyJRuby$s$0$3$compile extends JavaMethodNBlock
{
    public RubyJRuby$s$0$3$compile(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyJRuby.compile(recv, array, block);
    }
}
