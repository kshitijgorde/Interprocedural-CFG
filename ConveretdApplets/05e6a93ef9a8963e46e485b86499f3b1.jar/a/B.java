...
public final class B implements Cloneable
{
    ...
    public final int q(final bV bv) {
        return this.q(bv, bv.q());
    }
    ...
    public final synchronized Object clone() {
        try {
            final B b;
            (b = (B)super.clone()).q = new Object[this.q];
            b.q = new int[this.q];
            System.arraycopy(this.q, 0, b.q, 0, this.q);
            System.arraycopy(this.q, 0, b.q, 0, this.q);
            return b;
        }
