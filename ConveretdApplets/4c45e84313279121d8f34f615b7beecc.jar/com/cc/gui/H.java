...
public class H implements MouseListener, MouseMotionListener, Observer
{
    ...
    private void K() {
        final D k = this.A.K();
        this.F = new G[1][k.J().A()];
        final B j = k.J();
        final Rectangle rectangle = new Rectangle(1, 1, this.E, this.E);
        for (int i = 0; i < j.A(); ++i) {
            final G g = new G(this, (E)j.A(i), this.R, this.A, this.S, true, this.E);
        ...
        for (int k = 0; k < this.A.A; ++k) {
            for (int l = 0; l < this.A.D; ++l) {
                ...
                if (a != null) {
                    ...
                    final Insets m = g.l;
                    b.setSize(b.width - m.left - m.right, b.height - m.top - m.bottom);
                    b.setLocation(b.x + m.left, b.y + m.top);
                    g.A(b);
                }
            }
        }
            ...
            for (int j = 0; j < this.A.D; ++j) {
                ...
                if (a != null) {
                    if (!a.R()) {
                        ...
                        final Point b = this.B(a);
                        final G g2 = this.C.get(a);
                        final Insets l = g2.l;
                        l.left += b.x;
                        if (g == null) {
                            this.D.left = Math.max(this.D.left, b.y);
                            this.H.A(new Rectangle(-b.y, g2.B().y, b.y, g2.B().height));
                        }
                        else {
                            final Insets k = this.C.get(g).l;
                            k.right += b.y;
                        }
                    }
                }
                ...
                if (a != null) {
                    if (!a.R()) {
                        ...
                        if (h == null) {
                            ...
                            if (h.a > 1) {
                                g2.l.bottom = Math.max(g2.l.bottom, n2);
                            }
                            else {
                                final Insets k = g2.l;
                                k.bottom += n2;
                        ...
                        final int y = this.B(a).y;
                        if (y > 0) {
                            this.H.A(new Rectangle(g.B().x - y, g.B().y - n2, y, n2));
                        }
                        final int y2 = this.E(a).y;
                        if (y2 > 0) {
            ...
            for (int j = 0; j < this.A.D; ++j) {
                ...
                if (a != null) {
                    if (!a.R()) {
                        ...
                        final Point e = this.E(a);
                        final G g = this.C.get(a);
                        final Insets l = g.l;
                        l.right += e.x;
                        if (c == null) {
                            this.D.right = Math.max(this.D.right, e.y);
                            this.H.A(new Rectangle(g.B().x + g.B().width, g.B().y, e.y, g.B().height));
                        }
                        else {
                            final G g2 = this.C.get(c);
                            if (c.Z > 1) {
                                g2.l.left = Math.max(g2.l.left, e.y);
                            }
                            else {
                                final Insets k = g2.l;
                                k.left += e.y;
        ...
        for (int i = 0; i < this.A.A; ++i) {
            for (int j = 0; j < this.A.D; ++j) {
                ...
                if (a != null) {
                    ...
                    final Rectangle b = g.B();
                    final Insets l = g.l;
                    final int n = b.x - l.left - (this.A.r ? 0 : 0);
                    final int n2 = b.width + l.left + l.right + (this.A.r ? 0 : 0);
                    if (l.top > 0) {
                        graphics.fillRect(n, b.y - l.top, n2, l.top);
                    }
                    if (l.bottom > 0) {
                        graphics.fillRect(n, b.y + b.height, n2, l.bottom);
                    }
                    final int n3 = b.y - l.top - (this.A.r ? 0 : 0);
                    final int n4 = b.height + l.top + l.bottom + (this.A.r ? 0 : 0);
                    if (l.left > 0) {
                        graphics.fillRect(b.x - l.left, n3, l.left, n4);
                    }
                    if (l.right > 0) {
                        graphics.fillRect(b.x + b.width, n3, l.right, n4);
                    }
                }
            }
        }
    ...
    private void A(final Graphics graphics, final D d) {
        ...
        this.A(graphics, this.C(this.C.get(g)), this.C((G)this.C.get(c)));
    }
    ...
    private Point C(final G g) {
        final Rectangle b = g.B();
        final Insets l = g.l;
        return new Point((b.width + l.left + l.right) / 2 + (b.x - l.left), (b.height + l.top + l.bottom) / 2 + (b.y - l.top));
    }
    ...
    public boolean A(final KeyEvent keyEvent) {
        switch (keyEvent.getKeyCode()) {
            ...
            case 39: {
                this.B(false);
                this.A(this.B.E(this.A.I()));
                break;
            }
            case 38: {
                this.B(false);
                this.A(this.B.F(this.A.I()));
                break;
            }
            case 40: {
                this.B(false);
                this.A(this.B.D(this.A.I()));
                break;
            }
            case 8: {
                if (this.L()) {
    ...
    private void A(final E e) {
        int n = 0;
        if (e != null) {
            n = ((this.S.C() == null || this.A.M().A(e)) ? 1 : 0);
            if (n == 0) {
                n = 1;
    ...
    public void B(final G g) {
        if (this.A.I() == g.o || g.J() || this.A.d) {
            return;
        }
        final Point c = this.A.C(g.o);
        final Point c2 = this.A.C(this.A.I());
        if (Math.abs(c.x - c2.x) > Math.abs(c.y - c2.y)) {
            if (this.D(this.B.G(this.A.I()))) {
                return;
            }
            this.D(this.B.C(this.A.I()));
        }
        else {
            if (this.D(this.B.B(this.A.I()))) {
                return;
            }
    ...
    public void D(final G g) {
        ...
        this.O = g;
        this.A.A(this.A.C(this.K.o), this.A.C(this.O.o));
    }
