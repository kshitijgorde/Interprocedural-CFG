...
public final class aR extends Panel
{
    ...
    private aR(final int e, final int f, final int h, final int g, final bh a, final boolean a2) {
        this.a = 12;
        ...
        this.a = ((this.a == null) ? bm.a : this.a.a);
        if (this.a) {
            this.a = 0;
        }
    ...
    public aR(final bh bh) {
        this(2, 10, 2, 10, bh, false);
    }
    
    public aR(final bh bh, final boolean b) {
        this(4, 4, 4, 4, bh, b);
    }
}
