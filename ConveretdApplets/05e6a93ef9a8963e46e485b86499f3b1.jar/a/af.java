...
public final class af extends Canvas implements aB, Runnable
{
    public Thread q;
    private int e;
    private int r;
    ...
    public void q() {
        ...
        this.q = q("16", 10, 16);
        this.w = this.q;
        this.e = new Color(q("990000", 16, 0));
        this.t = 0;
        this.w = new Vector();
        this.e = new Vector();
        this.r = new Vector();
        ...
        this.q = (Frame)aL.q(this, !W.e());
        this.r = true;
    }
    
    public final void q(final String s, final at at) {
        if (at.q(1) || at.q(2)) {
            if (this.q.p == 2 && at.q(1)) {
                return;
            }
            if (this.q.q(61) && at.q(2)) {
                return;
            }
        }
        final I q = this.q(s);
        ...
        if (q.w == null || w.trim().equals("")) {
            ...
            this.r.addElement(a.t.q(al.q("Follow link %1"), w));
        }
        this.e.addElement(w);
        final Font font = new Font(at.q, at.e(), at.w);
        this.i.addElement(font);
        this.o.addElement(this.getFontMetrics(font));
        this.t.addElement(new Color(at.w()));
        this.y.addElement(q.q);
        this.u.addElement(new Color(at.f));
        if (this.c < font.getSize()) {
            this.c = font.getSize();
            this.q(this.c + 4);
        }
    }
    ...
    private void r() {
        ...
        this.q = cs.q(this, this.e, this.r, "sl.r-q");
    ...
    private void t() {
        ...
        this.w = cs.q(this, this.e, this.r, "sl.r-p");
    ...
    private synchronized void q(final boolean b) {
        ...
        if (this.x == 0) {
            ...
            this.w.fillRect(0, 0, 30, this.r);
            this.w.fillRect(this.e - 30, 0, this.e, this.r);
            this.w.setColor(this.q);
            this.w.fillRoundRect(0, 0, this.e, this.r, this.x, this.x);
            this.w.setColor(this.q.darker());
            this.w.drawRoundRect(0, 0, this.e - 1, this.r - 1, this.x, this.x);
        }
        this.o = this.u;
        this.w(this.i, true);
        this.w = false;
        ...
        do {
            ...
            if (this.w.elementAt(this.p).startsWith("img:")) {
                ...
                this.w.drawString(this.w.elementAt(this.p), this.o, this.c);
                if (b3) {
                ...
                if (this.k == 1 || Math.abs(n - this.d) < 20) {
                    ...
                    try {
                        if (this.e.elementAt(this.h).startsWith("http://") || this.e.elementAt(this.h).startsWith("mailto:")) {
                            ...
                            this.q = new URL(a.h.q().getCodeBase(), this.e.elementAt(this.h));
                        }
                    }
                    catch (Exception ex) {
                        return true;
                    }
                    a.h.q().getAppletContext().showDocument(this.q, this.e);
                }
                this.k = 0;
            }
        }
    ...
    private I q(final String q) {
        final I i = new I(this, (byte)0);
        int n = 0;
        String sval = null;
        String sval2 = null;
