...
public class CombinedRangeCategoryPlot extends CategoryPlot implements Cloneable, PublicCloneable, Serializable, PlotChangeListener
{
    ...
    public void draw(final Graphics2D g2, final Rectangle2D plotArea, PlotState parentState, final PlotRenderingInfo info) {
        ...
        final AxisState state = axis.draw(g2, cursor, plotArea, dataArea, rangeEdge, info);
        if (parentState == null) {
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof CombinedRangeCategoryPlot) {
            final CombinedRangeCategoryPlot plot = (CombinedRangeCategoryPlot)object;
