...
public class l extends Canvas implements ImageObserver
{
    private static aL a;
    protected Image a;
    private URL a;
    ...
    public final void a(final int n, final int n2) {
        ...
        if (((size = this.size()).height != n2 || size.width != n) && n > 0 && n2 > 0) {
            this.resize(n, n2);
            l l = null;
            for (ImageObserver parent = this; parent != null && !(l instanceof Window); l = (l)parent, parent = ((l)parent).getParent()) {
                ((l)parent).invalidate();
            }
            l.validate();
        }
