...
public class DS_DissolveText extends Applet implements Runnable
{
    Thread _fld0;
    int _fld1;
    Font _fld3;
    ...
    public final boolean mouseEnter(final Event event, final int n, final int n2) {
        this.showStatus(this._fld0g[this._fld0f]);
    ...
    void _mth2b() {
        ...
        for (int i = 0; i < this._fld4 * this._fld5; ++i) {
            if (this._fld6e[i] == 255) {
                this._fld8e[i] = (int)(Math.random() * 255.0);
            }
            else {
                this._fld8e[i] = 256;
            }
        ...
        if (!this._fld0e) {
            ...
            for (int j = 0; j < n; ++j) {
                this._fld6[j] = this._fld7e;
            }
        }
        this._fld6f *= this._fld5f;
        this._fld3f = (this._fld6f + 256 << 1) + this._fld6f;
        this._fld4f = this._fld3f >> 1;
        this._fld1f = new int[this._fld3f];
        for (int k = 0; k < this._fld6f; ++k) {
            this._fld1f[k] = 0;
        }
        for (int l = this._fld6f; l < 256 + this._fld6f; ++l) {
            this._fld1f[l] = l - this._fld6f;
        }
        for (int n2 = 0; n2 < this._fld6f; ++n2) {
            this._fld1f[this._fld6f + 256 + n2] = 255;
        }
        for (int n3 = 0; n3 < 256; ++n3) {
            this._fld1f[this._fld6f + this._fld6f + 256 + n3] = 256 - n3;
        }
        for (int n4 = 0; n4 < this._fld6f; ++n4) {
            this._fld1f[this._fld6f + this._fld6f + 256 + 256 + n4] = 0;
        }
    }
    
    void _mth3b() {
        if (this._fld2f > this._fld4f) {
            this._fld2f -= this._fld5f;
            if (this._fld2f < this._fld4f) {
                this._fld2f = this._fld4f;
            }
        }
        else {
            this._fld2f += this._fld5f;
    ...
    void _mth4b() {
        ...
        if (this._fld2f >= this._fld3f) {
            this._fld2f = 0;
            this._fld0f = (this._fld0f + 1) % this._fld9e;
            this._mth5b();
            for (int i = 0; i < this._fld4 * this._fld5; ++i) {
                if (this._fld6e[i] == 255) {
                    this._fld8e[i] = (int)(Math.random() * 255.0);
        ...
        this._mth6b(this._fld1f[this._fld2f]);
    ...
    void _mth5b() {
        ...
        graphics.setFont(this._fld1e[this._fld0f]);
        final FontMetrics fontMetrics = graphics.getFontMetrics(this._fld1e[this._fld0f]);
        final int stringWidth = fontMetrics.stringWidth(this._fld2e[this._fld0f]);
        final int height = fontMetrics.getHeight();
        final int n = (height >> 1) + (height >> 3);
        if (this._fld3e[this._fld0f] == -10000) {
            this._fld3e[this._fld0f] = (this._fld4 >> 1) - (stringWidth >> 1);
        }
        if (this._fld4e[this._fld0f] == -10000) {
            this._fld4e[this._fld0f] = (this._fld5 >> 1) - (n >> 1);
        }
        graphics.drawString(this._fld2e[this._fld0f], this._fld3e[this._fld0f], this._fld4e[this._fld0f] + n);
    ...
    void _mth6b(final int n) {
        for (int n2 = this._fld4 * this._fld5, i = 0; i < n2; ++i) {
            if (this._fld8e[i] < n) {
                this._fld7[i] = this._fld5e[this._fld0f];
            }
            else {
    ...
    public final boolean mouseDown(final Event event, final int n, final int n2) {
        ...
        else if (this._fld8f[this._fld0f] != null) {
            if (this._fld9f[this._fld0f] != null) {
                this.getAppletContext().showDocument(this._fld8f[this._fld0f], this._fld9f[this._fld0f]);
            }
            else {
                this.getAppletContext().showDocument(this._fld8f[this._fld0f]);
            }
        }
        return true;
    }
    ...
    public DS_DissolveText() {
        ...
        this._fld9b = false;
        this._fld0c = false;
        this._fld7d = "DissolveText started";
        this._fld9d = false;
        this._fld0e = true;
        this._fld7f = "";
        this._fld2g = false;
