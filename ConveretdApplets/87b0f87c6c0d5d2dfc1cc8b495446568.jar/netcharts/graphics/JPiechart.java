...
public class JPiechart extends JGraph implements NFCompare
{
    ...
    public JPiechart(final Applet applet) {
        this.b = 1.1;
        this.c = this.b;
        this.d = -1;
        this.e = this.d;
    ...
    public JPiechart(final Applet applet, final int n, final int n2, final int n3, final int n4) {
        this(applet);
