...
public final class ad extends Panel implements cE
{
    ...
    public ad(final bF q) {
        ...
        final cv cv = new cv();
        final cv cv2;
        (cv2 = new cv()).setLayout(gridBagLayout);
        cv2.setBackground(aT.w.q);
        cv2.setForeground(aT.w.q);
        cv.setLayout(gridBagLayout);
        cv.setBackground(aT.w.i);
        cv.setForeground(aT.w.u);
        (this.q = new Panel()).setLayout(this.q);
        (this.q = new J(this)).setCursor(Cursor.getPredefinedCursor(1));
        (this.q = new cC(this)).setSize(new Dimension(150, 165));
        ...
        panel3.setBackground(aT.w.i);
        panel3.setForeground(aT.w.u);
        panel3.add(panel5, "Center");
        final Panel panel6;
        (panel6 = new Panel()).setBackground(aT.w.i);
        panel6.setForeground(aT.w.u);
        panel6.add(this.q);
