...
public class PGraphics2D extends PGraphics
{
        ...
        if (this.smooth || this.strokeAlpha || this.ctm.isWarped()) {
            ...
            if (this.stroke) {
                if (this.strokeWeight == 1.0f) {
                    ...
                    this.thick_flat_line(n5, n6, this.strokeR, this.strokeG, this.strokeB, this.strokeA, n7, n6, this.strokeR, this.strokeG, this.strokeB, this.strokeA);
                    this.thick_flat_line(n7, n6, this.strokeR, this.strokeG, this.strokeB, this.strokeA, n7, n8, this.strokeR, this.strokeG, this.strokeB, this.strokeA);
                    this.thick_flat_line(n7, n8, this.strokeR, this.strokeG, this.strokeB, this.strokeA, n5, n8, this.strokeR, this.strokeG, this.strokeB, this.strokeA);
                    this.thick_flat_line(n5, n8, this.strokeR, this.strokeG, this.strokeB, this.strokeA, n5, n6, this.strokeR, this.strokeG, this.strokeB, this.strokeA);
                }
            }
        }
    }
    ...
    private void flat_circle_stroke(final int n, final int n2, final int n3) {
        ...
        int n7 = 0;
        while (i < n4) {
            this.thin_point(n + i, n2 + n4, this.strokeColor);
            this.thin_point(n + n4, n2 - i, this.strokeColor);
            this.thin_point(n - i, n2 - n4, this.strokeColor);
            this.thin_point(n - n4, n2 + i, this.strokeColor);
            ++i;
            n7 += n5;
    ...
    private void flat_circle_fill(final int n, final int n2, final int n3) {
        ...
        while (i < n4) {
            for (int j = n; j < n + i; ++j) {
                this.thin_point(j, n2 + n4, this.fillColor);
            }
            for (int k = n; k < n + n4; ++k) {
                this.thin_point(k, n2 - i, this.fillColor);
            }
            for (int l = n - i; l < n; ++l) {
                this.thin_point(l, n2 - n4, this.fillColor);
            }
            for (int n8 = n - n4; n8 < n; ++n8) {
                this.thin_point(n8, n2 + i, this.fillColor);
            }
            ++i;
            n7 += n5;
            n5 += 2;
            ...
            for (int n9 = n; n9 < n + n4; ++n9) {
                this.thin_point(n9, n2 + i, this.fillColor);
            }
            for (int n10 = n; n10 < n + i; ++n10) {
                this.thin_point(n10, n2 - n4, this.fillColor);
            }
            for (int n11 = n - n4; n11 < n; ++n11) {
                this.thin_point(n11, n2 - i, this.fillColor);
            }
            for (int n12 = n - i; n12 < n; ++n12) {
                this.thin_point(n12, n2 + n4, this.fillColor);
            }
        }
    }
    ...
    private void thin_flat_line(final int n, final int n2, final int n3, final int n4) {
        final int thin_flat_line_clip_code = this.thin_flat_line_clip_code(n, n2);
        final int thin_flat_line_clip_code2 = this.thin_flat_line_clip_code(n3, n4);
        ...
        if (n5 != 0) {
            ...
            for (int i = 0; i < 4; ++i) {
                if ((n5 >> i) % 2 == 1) {
                    final float thin_flat_line_slope = this.thin_flat_line_slope(n, n2, n3, n4, i + 1);
        ...
        if (k == n7) {
            ...
            for (int n16 = j; n16 <= n6; ++n16) {
                this.thin_point_at_index(n15++, 0.0f, this.strokeColor);
            }
            return;
        }
        if (b) {
            ...
            int n20 = 32768 + (j << 16);
            while (k >= n19) {
                this.thin_point_at(n20 >> 16, k, 0.0f, this.strokeColor);
                n20 -= n11;
                --k;
            }
        }
            ...
            int n24 = 32768 + (k << 16);
            while (j >= n23) {
                this.thin_point_at(j, n24 >> 16, 0.0f, this.strokeColor);
                n24 -= n11;
                --j;
            }
        }
    ...
    private void thick_flat_line(final float n, final float n2, final float n3, final float n4, final float n5, final float n6, final float n7, final float n8, final float n9, final float n10, final float n11, final float n12) {
        ...
        final float n15 = this.strokeWeight / (float)Math.sqrt(n13 * n13 + n14 * n14);
