...
public final class CharDataChunk implements StringPool.StringProducer
{
    ...
    public static CharDataChunk createChunk(final StringPool fStringPool, final CharDataChunk fPreviousChunk) {
        ...
        final Class clazz = (CharDataChunk.class$org$apache$xerces$utils$CharDataChunk == null) ? (CharDataChunk.class$org$apache$xerces$utils$CharDataChunk = class$("org.apache.xerces.utils.CharDataChunk")) : CharDataChunk.class$org$apache$xerces$utils$CharDataChunk;
        synchronized (clazz) {
            fgFreeChunks = CharDataChunk.fgFreeChunks;
    ...
    public int addSymbol(final int n, final int n2, int hashChars) {
        ...
        if (n3 != this.fChunk) {
            ...
            if (n3 == n4) {
                ...
                int n6 = this.fStringPool.lookupSymbol(this, n & 0x3FFF, n2, hashChars);
                if (n6 == -1) {
