...
public class JavaSoundAudioDevice extends AudioDeviceBase
{
    ...
    protected DataLine.Info getSourceLineInfo() {
        return new DataLine.Info((JavaSoundAudioDevice.class$javax$sound$sampled$SourceDataLine == null) ? (JavaSoundAudioDevice.class$javax$sound$sampled$SourceDataLine = class$("javax.sound.sampled.SourceDataLine")) : JavaSoundAudioDevice.class$javax$sound$sampled$SourceDataLine, this.getAudioFormat());
    }
