...
public class xtGraphics extends Panel
{
    ...
    public void framer(final int n, final Graphics graphics) {
        int n2 = (int)(230.0f - 230.0f * (this.m.snap[0] / (100 * this.hipno[n - 1])));
        if (n2 > 255) {
            n2 = 255;
        }
        if (n2 < 0) {
        ...
        int n3 = (int)(230.0f - 230.0f * (this.m.snap[1] / (100 * this.hipno[n - 1])));
        if (n3 > 255) {
            n3 = 255;
        }
        if (n3 < 0) {
        ...
        int n4 = (int)(230.0f - 230.0f * (this.m.snap[2] / (100 * this.hipno[n - 1])));
        if (n4 > 255) {
            n4 = 255;
        }
        if (n4 < 0) {
        ...
        graphics.setColor(new Color(n2, n3, n4));
    ...
    public void loadingstage(final int n, final Graphics graphics) {
        this.cars.stop();
        this.stages.stop();
        graphics.drawImage(this.trackbg, 0, 0, null);
        graphics.setFont(new Font("SansSerif", 1, 13));
        this.ftm = graphics.getFontMetrics();
        this.drawcs(graphics, 180, "Loading Stage " + n + ", please wait...", 0, 0, 0, 3);
        graphics.drawImage(this.select, 201, 45, null);
        graphics.drawImage(this.bl, 0, 0, null);
        graphics.drawImage(this.bt, 0, 0, null);
        graphics.drawImage(this.br, 509, 0, null);
    ...
    public void fleximage(final Image image, final Graphics graphics, final int n) {
        if (n == 0) {
            final PixelGrabber pixelGrabber = new PixelGrabber(image, 0, 0, 550, 400, this.flexpix, 0, 550);
            try {
            ...
            do {
                ...
                this.flexpix[n2] = Color.getHSBColor(0.7f, array[1], array[2]).getRGB();
            } while (++n2 < 220000);
        }
        int n3 = 0;
        do {
            if (this.m.random() > 0.2) {
                ...
                int n4 = (int)(color2.getRed() - color2.getRed() * 0.4);
                if (n4 > 225) {
                    n4 = 225;
                }
                if (n4 < 0) {
                ...
                int n5 = (int)(color2.getGreen() - color2.getGreen() * 0.35);
                if (n5 > 225) {
                    n5 = 225;
                }
                if (n5 < 0) {
                ...
                int n6 = (int)(color2.getBlue() - color2.getBlue() * (0.25 + n / 30.0f));
                if (n6 > 225) {
                    n6 = 225;
                }
                if (n6 < 0) {
                ...
                this.flexpix[n3] = new Color(n4, n5, n6).getRGB();
            }
        } while (++n3 < 220000);
    ...
    public void arrow(final Graphics graphics, final int n, final int n2, final CheckPoints checkPoints, final boolean b) {
        ...
        if (!b) {
            ...
            n8 = (int)(90 + n7 + Math.atan((checkPoints.z[n] - checkPoints.opz[0]) / (checkPoints.x[n] - checkPoints.opx[0])) / 0.017453292519943295);
        }
        else {
            int n9 = 0;
            int py = -1;
            ...
            n8 = (int)(90 + n12 + Math.atan((checkPoints.opz[n9] - checkPoints.opz[0]) / (checkPoints.opx[n9] - checkPoints.opx[0])) / 0.017453292519943295);
        ...
        if (!b) {
            if (abs > 7 || n2 > 0 || n2 == -2 || this.cntan != 0) {
                ...
                int n14 = (int)(190.0f + 190.0f * (this.m.snap[0] / 100.0f));
                if (n14 > 255) {
                    n14 = 255;
                }
                if (n14 < 0) {
                ...
                int n15 = (int)(255.0f + 255.0f * (this.m.snap[1] / 100.0f));
                if (n15 > 255) {
                    n15 = 255;
                }
                if (n15 < 0) {
                ...
                if (n2 <= 0) {
                    ...
                    if (abs >= 90) {
                        int n17 = (int)(255.0f + 255.0f * (this.m.snap[0] / 100.0f));
                        if (n17 > 255) {
                            n17 = 255;
                        }
                        if (n17 < 0) {
                    ...
                    n15 = (int)(220.0f + 220.0f * (this.m.snap[1] / 100.0f));
                    if (n15 > 255) {
                        n15 = 255;
                    }
                    if (n15 < 0) {
                ...
                graphics.setColor(new Color(n14, n15, n16));
                graphics.fillPolygon(array, array2, 7);
                int n18 = (int)(115.0f + 115.0f * (this.m.snap[0] / 100.0f));
                if (n18 > 255) {
                    n18 = 255;
                }
                if (n18 < 0) {
                ...
                int n19 = (int)(170.0f + 170.0f * (this.m.snap[1] / 100.0f));
                if (n19 > 255) {
                    n19 = 255;
                }
                if (n19 < 0) {
                ...
                if (n2 <= 0) {
                    if (abs <= 45 && n2 != -2 && this.cntan == 0) {
                        n18 = (n18 * abs + this.m.csky[0] * (45 - abs)) / 45;
                        n19 = (n19 * abs + this.m.csky[1] * (45 - abs)) / 45;
                        n20 = (n20 * abs + this.m.csky[2] * (45 - abs)) / 45;
                    }
                }
                else if (this.flk) {
                    n18 = (int)(255.0f + 255.0f * (this.m.snap[0] / 100.0f));
                    if (n18 > 255) {
                        n18 = 255;
                    }
                    if (n18 < 0) {
                ...
                graphics.setColor(new Color(n18, n19, n20));
            ...
            int n21 = 0;
            do {
                array[n21] = this.xs(array[n21], array3[n21]);
                array2[n21] = this.ys(array2[n21], array3[n21]);
            } while (++n21 < 7);
            int n22 = (int)(159.0f + 159.0f * (this.m.snap[0] / 100.0f));
            if (n22 > 255) {
                n22 = 255;
            }
            if (n22 < 0) {
            ...
            int n23 = (int)(207.0f + 207.0f * (this.m.snap[1] / 100.0f));
            if (n23 > 255) {
                n23 = 255;
            }
            if (n23 < 0) {
            ...
            graphics.setColor(new Color(n22, n23, n24));
            graphics.fillPolygon(array, array2, 7);
            int n25 = (int)(120.0f + 120.0f * (this.m.snap[0] / 100.0f));
            if (n25 > 255) {
                n25 = 255;
            }
            if (n25 < 0) {
            ...
            int n26 = (int)(114.0f + 114.0f * (this.m.snap[1] / 100.0f));
            if (n26 > 255) {
                n26 = 255;
            }
            if (n26 < 0) {
            ...
            int n27 = (int)(255.0f + 255.0f * (this.m.snap[2] / 100.0f));
            if (n27 > 255) {
                n27 = 255;
            }
            if (n27 < 0) {
    ...
    public void loadpak1(final MediaTracker mediaTracker, final Toolkit toolkit) {
        try {
            final DataInputStream dataInputStream = new DataInputStream(new URL(this.app.getCodeBase(), "graphics/images1.zipo").openStream());
            ...
            for (ZipEntry zipEntry = zipInputStream.getNextEntry(); zipEntry != null; zipEntry = zipInputStream.getNextEntry()) {
                ...
                if (name.equals("cars.gif")) {
                    this.carsbg = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("1.gif")) {
                    this.orank[0] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("gameh.gif")) {
                    this.ogameh = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("gameov.gif")) {
                    this.gameov = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("lap.gif")) {
                    this.olap = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("paused.gif")) {
                    this.paused = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("select.gif")) {
                    this.select = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("yourwasted.gif")) {
                    this.oyourwasted = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("youwastedem.gif")) {
                    this.oyouwastedem = this.loadimage(array, mediaTracker, toolkit);
                }
            }
            ...
            System.out.println("Error Loading Images Pak 1: " + ex);
        }
        System.gc();
    }
    ...
    public void pauseimage(final Image image, final Graphics graphics) {
        final PixelGrabber pixelGrabber = new PixelGrabber(image, 0, 0, 550, 400, this.flexpix, 0, 550);
        try {
            pixelGrabber.grabPixels();
        }
        ...
        do {
            ...
            if (n5 > 550 * (106 + n2) + 156 && n2 < 188) {
                final int n7 = (n6 + 60) / 3;
                final int n8 = (n6 + 135) / 3;
                final int n9 = (n6 + 220) / 3;
                if (++n == 237) {
                    ++n2;
                    n = 0;
                }
                this.flexpix[n5] = new Color(n7, n8, n9).getRGB();
            }
            else {
    ...
    public void loadmusic(final int n, final int n2, final Graphics graphics) {
        int n3 = (int)(230.0f - 230.0f * (this.m.snap[0] / (100 * this.hipno[n - 1])));
        if (n3 > 255) {
            n3 = 255;
        }
        if (n3 < 0) {
        ...
        int n4 = (int)(230.0f - 230.0f * (this.m.snap[1] / (100 * this.hipno[n - 1])));
        if (n4 > 255) {
            n4 = 255;
        }
        if (n4 < 0) {
        ...
        int n5 = (int)(230.0f - 230.0f * (this.m.snap[2] / (100 * this.hipno[n - 1])));
        if (n5 > 255) {
            n5 = 255;
        }
        if (n5 < 0) {
        ...
        if (this.winner) {
            if (checkPoints.stage == this.unlocked) {
                ...
                if (checkPoints.stage != 11) {
                    ...
                    if (this.aflk) {
                        this.drawcs(graphics, 200, "You're truly a RADICAL GAMER!", 144, 167, 255, 3);
                    }
                    else {
                        this.drawcs(graphics, 200, "You're truly a RADICAL GAMER!", 228, 240, 255, 3);
                    }
    ...
    public void drawcs(final Graphics graphics, final int n, final String s, int n2, int n3, int n4, final int n5) {
        if (n5 != 3 && n5 != 4) {
        ...
        if (n5 == 1) {
            graphics.setColor(new Color(0, 0, 0));
            graphics.drawString(s, 275 - this.ftm.stringWidth(s) / 2 + 1, n + 1);
        }
        if (n5 == 2) {
            graphics.setColor(new Color((n2 + this.m.csky[0] * 2) / 3, (n3 + this.m.csky[1] * 2) / 3, (n4 + this.m.csky[2] * 2) / 3));
            graphics.drawString(s, 275 - this.ftm.stringWidth(s) / 2 + 1, n + 1);
        }
        graphics.setColor(new Color(n2, n3, n4));
        graphics.drawString(s, 275 - this.ftm.stringWidth(s) / 2, n);
    }
    ...
    private Image loadsnap(final Image image) {
        ...
        for (int i = 0; i < width * height; ++i) {
            if (array[i] != -4144960 && array[i] != array[width * height - 1]) {
                ...
                int n = (int)(color.getRed() + color.getRed() * (this.m.snap[0] / 100.0f));
                if (n > 225) {
                    n = 225;
                }
                if (n < 0) {
                ...
                int n2 = (int)(color.getGreen() + color.getGreen() * (this.m.snap[1] / 100.0f));
                if (n2 > 225) {
                    n2 = 225;
                }
                if (n2 < 0) {
                ...
                int n3 = (int)(color.getBlue() + color.getBlue() * (this.m.snap[2] / 100.0f));
                if (n3 > 225) {
                    n3 = 225;
                }
                if (n3 < 0) {
    ...
    public void loadpak2(final MediaTracker mediaTracker, final Toolkit toolkit) {
        try {
            final DataInputStream dataInputStream = new DataInputStream(new URL(this.app.getCodeBase(), "graphics/images2.zipo").openStream());
            final ZipInputStream zipInputStream = new ZipInputStream(dataInputStream);
            for (ZipEntry zipEntry = zipInputStream.getNextEntry(); zipEntry != null; zipEntry = zipInputStream.getNextEntry()) {
                int i = (int)zipEntry.getSize();
                final String name = zipEntry.getName();
                ...
                if (name.equals("1c.gif")) {
                    this.ocntdn[1] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("2c.gif")) {
                    this.ocntdn[2] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("3c.gif")) {
                    this.ocntdn[3] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("2.gif")) {
                    this.orank[1] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("3.gif")) {
                    this.orank[2] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("4.gif")) {
                    this.orank[3] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("5.gif")) {
                    this.orank[4] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("bgmain.jpg")) {
                    this.bgmain = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("br.gif")) {
                    this.br = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("loadingmusic.gif")) {
                    this.oloadingmusic = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("main.gif")) {
                    this.maini = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("radicalplay.gif")) {
                    this.radicalplay = this.loadimage(array, mediaTracker, toolkit);
                }
            }
            dataInputStream.close();
            zipInputStream.close();
            ...
            System.out.println("Error Reading Images Pak 2: " + ex);
        }
        System.gc();
    }
    ...
    public void loading(final Graphics graphics, final Applet applet) {
        ...
        this.drawcs(graphics, 385, "" + (int)((26.0f + this.dnload / this.kbload * 200.0f) / 226.0f * 100.0f) + " % loaded    |    " + (this.kbload - this.dnload) + " KB remaining", 32, 64, 128, 3);
        graphics.setColor(new Color(32, 64, 128));
        graphics.fillRect(162, 346, 26 + (int)(this.dnload / this.kbload * 200.0f), 10);
        applet.repaint();
    }
    ...
    public xtGraphics(final Medium m, final Graphics graphics, final Applet app, final int n) {
        ...
        int n3 = 0;
        do {
            this.engs[0][n3] = this.getSound("sounds/" + s + "a" + n3 + ".au");
            this.dnload += 2;
            this.loading(graphics, this.app);
            this.engs[1][n3] = this.getSound("sounds/" + s + "b" + n3 + ".au");
            this.dnload += 3;
            this.loading(graphics, this.app);
            this.pengs[n3] = false;
        } while (++n3 < 5);
        int n4 = 0;
        do {
            this.air[n4] = this.getSound("sounds/" + s + "air" + n4 + ".au");
            this.dnload += 2;
            this.loading(graphics, this.app);
        } while (++n4 < 6);
        int n5 = 0;
        do {
            this.crash[n5] = this.getSound("sounds/" + s + "crash" + (n5 + 1) + ".au");
            if (n == 2) {
                this.dnload += 12;
                this.loading(graphics, this.app);
            }
        ...
        int n6 = 0;
        do {
            this.lowcrash[n6] = this.getSound("sounds/" + s + "lowcrash" + (n6 + 1) + ".au");
            if (n == 2) {
                this.dnload += 8;
                this.loading(graphics, this.app);
            }
        ...
        int n7 = 0;
        do {
            this.skid[n7] = this.getSound("sounds/" + s + "skid" + (n7 + 1) + ".au");
            if (n == 2) {
                this.dnload += 9;
                this.loading(graphics, this.app);
            }
        ...
        int n8 = 0;
        do {
            this.dustskid[n8] = this.getSound("sounds/" + s + "dustskid" + (n8 + 1) + ".au");
            if (n == 2) {
                this.dnload += 11;
                this.loading(graphics, this.app);
            }
    ...
    public void loadpak3(final MediaTracker mediaTracker, final Toolkit toolkit) {
        try {
            final DataInputStream dataInputStream = new DataInputStream(new URL(this.app.getCodeBase(), "graphics/images3.zipo").openStream());
            final ZipInputStream zipInputStream = new ZipInputStream(dataInputStream);
            for (ZipEntry zipEntry = zipInputStream.getNextEntry(); zipEntry != null; zipEntry = zipInputStream.getNextEntry()) {
                int i = (int)zipEntry.getSize();
                final String name = zipEntry.getName();
                ...
                if (name.equals("back.gif")) {
                    this.back[0] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("continue1.gif")) {
                    this.contin1[0] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("continue2.gif")) {
                    this.contin2[0] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("inst3.gif")) {
                    this.inst3 = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("next.gif")) {
                    this.next[0] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("pgate.gif")) {
                    this.pgate = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("rpro.gif")) {
                    this.rpro = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("selectcar.gif")) {
                    this.selectcar = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("stages.jpg")) {
                    this.trackbg = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("youlost.gif")) {
                    this.oyoulost = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("youwon.gif")) {
                    this.oyouwon = this.loadimage(array, mediaTracker, toolkit);
                }
            }
            dataInputStream.close();
            zipInputStream.close();
            ...
            System.out.println("Error Reading Images Pak 3: " + ex);
        }
        System.gc();
    }
    ...
    private Image loadopsnap(final Image image, final int n) {
        final int height = image.getHeight(this.ob);
        final int width = image.getWidth(this.ob);
        final int[] array = new int[width * height];
        final PixelGrabber pixelGrabber = new PixelGrabber(image, 0, 0, width, height, array, 0, width);
        ...
        for (int i = 0; i < width * height; ++i) {
            if (array[i] != array[76]) {
                ...
                int n3;
                if (this.hipno[n - 1] != 0) {
                    n2 = color.getRed() - color.getRed() * (this.m.snap[0] / (50 * this.hipno[n - 1]));
                    if (n2 > 255) {
                        n2 = 255;
                    }
                    if (n2 < 0) {
                    ...
                    green = color.getGreen() - color.getGreen() * (this.m.snap[1] / (50 * this.hipno[n - 1]));
                    if (green > 255) {
                        green = 255;
                    }
                    if (green < 0) {
                    ...
                    n3 = color.getBlue() - color.getBlue() * (this.m.snap[2] / (50 * this.hipno[n - 1]));
                    if (n3 > 255) {
                        n3 = 255;
                    }
                    if (n3 < 0) {
                    ...
                    n2 = (int)(color.getRed() + color.getRed() * 0.25f);
                    if (n2 > 255) {
                        n2 = 255;
                    }
                    if (n2 < 0) {
                    ...
                    n3 = (int)(color.getBlue() - color.getBlue() * 0.25);
                    if (n3 > 255) {
                        n3 = 255;
                    }
                    if (n3 < 0) {
                ...
                array[i] = new Color(n2, green, n3).getRGB();
            }
        }
        return this.createImage(new MemoryImageSource(width, height, array, 0, width));
    }
    
    public void loadingfailed(final int n, final Control control, final Graphics graphics) {
        graphics.drawImage(this.trackbg, 0, 0, null);
        graphics.drawImage(this.select, 201, 45, null);
        graphics.setFont(new Font("SansSerif", 1, 13));
        this.ftm = graphics.getFontMetrics();
        this.drawcs(graphics, 140, "Error Loading Stage " + n, 200, 0, 70, 3);
    ...
    public void loadpak4(final MediaTracker mediaTracker, final Toolkit toolkit) {
        try {
            final DataInputStream dataInputStream = new DataInputStream(new URL(this.app.getCodeBase(), "graphics/images4.zipo").openStream());
            final ZipInputStream zipInputStream = new ZipInputStream(dataInputStream);
            for (ZipEntry zipEntry = zipInputStream.getNextEntry(); zipEntry != null; zipEntry = zipInputStream.getNextEntry()) {
                int i = (int)zipEntry.getSize();
                final String name = zipEntry.getName();
                ...
                if (name.equals("0c.gif")) {
                    this.ocntdn[0] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("damage.gif")) {
                    this.odmg = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("power.gif")) {
                    this.opwr = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("position.gif")) {
                    this.opos = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("wasted.gif")) {
                    this.owas = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("bl.gif")) {
                    this.bl = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("bt.gif")) {
                    this.bt = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("bb.gif")) {
                    this.bb = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("start1.gif")) {
                    this.ostar[0] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("start2.gif")) {
                    this.ostar[1] = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("congrad.gif")) {
                    this.congrd = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("statb.gif")) {
                    this.statb = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("madness.gif")) {
                    this.omdness = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("options.gif")) {
                    this.opti = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("inst1.gif")) {
                    this.inst1 = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("inst2.gif")) {
                    this.inst2 = this.loadimage(array, mediaTracker, toolkit);
                }
                if (name.equals("nfmcom.gif")) {
                    this.nfmcom = this.loadimage(array, mediaTracker, toolkit);
                }
            }
            dataInputStream.close();
            zipInputStream.close();
            ...
            System.out.println("Error Reading Images Pak 4: " + ex);
        }
        System.gc();
    }
}
