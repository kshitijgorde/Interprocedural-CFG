...
public class ImageMath
{
    ...
    public static float spline(final float x, final int numKnots, final int[] xknots, final int[] yknots) {
        ...
        final float k0 = yknots[span];
        final float k2 = yknots[span + 1];
        final float k3 = yknots[span + 2];
        final float k4 = yknots[span + 3];
        final float c3 = -0.5f * k0 + 1.5f * k2 + -1.5f * k3 + 0.5f * k4;
        final float c4 = 1.0f * k0 + -2.5f * k2 + 2.0f * k3 + -0.5f * k4;
        final float c5 = -0.5f * k0 + 0.0f * k2 + 0.5f * k3 + 0.0f * k4;
        final float c6 = 0.0f * k0 + 1.0f * k2 + 0.0f * k3 + 0.0f * k4;
    ...
    public static int colorSpline(float x, final int numKnots, final int[] knots) {
        ...
        for (int i = 0; i < 4; ++i) {
            final int shift = i * 8;
            final float k0 = knots[span] >> shift & 0xFF;
            final float k2 = knots[span + 1] >> shift & 0xFF;
            final float k3 = knots[span + 2] >> shift & 0xFF;
            final float k4 = knots[span + 3] >> shift & 0xFF;
            final float c3 = -0.5f * k0 + 1.5f * k2 + -1.5f * k3 + 0.5f * k4;
            final float c4 = 1.0f * k0 + -2.5f * k2 + 2.0f * k3 + -0.5f * k4;
            final float c5 = -0.5f * k0 + 0.0f * k2 + 0.5f * k3 + 0.0f * k4;
            final float c6 = 0.0f * k0 + 1.0f * k2 + 0.0f * k3 + 0.0f * k4;
    ...
    public static int colorSpline(final int x, final int numKnots, final int[] xknots, final int[] yknots) {
        ...
        for (int i = 0; i < 4; ++i) {
            final int shift = i * 8;
            final float k0 = yknots[span] >> shift & 0xFF;
            final float k2 = yknots[span + 1] >> shift & 0xFF;
            final float k3 = yknots[span + 2] >> shift & 0xFF;
            final float k4 = yknots[span + 3] >> shift & 0xFF;
            final float c3 = -0.5f * k0 + 1.5f * k2 + -1.5f * k3 + 0.5f * k4;
            final float c4 = 1.0f * k0 + -2.5f * k2 + 2.0f * k3 + -0.5f * k4;
            final float c5 = -0.5f * k0 + 0.0f * k2 + 0.5f * k3 + 0.0f * k4;
            final float c6 = 0.0f * k0 + 1.0f * k2 + 0.0f * k3 + 0.0f * k4;
