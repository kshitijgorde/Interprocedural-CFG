...
public class XMLMessages
{
    ...
    protected static String BAD_CODE;
    protected static String FORMAT_FAILED;
    ...
    public static final String createMsg(final ListResourceBundle fResourceBundle, final String msgKey, final Object[] args) {
        ...
        if (msg == null) {
            msg = fResourceBundle.getString(XMLMessages.BAD_CODE);
            throwex = true;
        }
        if (args != null) {
            try {
                ...
                fmsg = fResourceBundle.getString(XMLMessages.FORMAT_FAILED);
                fmsg = fmsg + " " + msg;
            }
        }
        else {
    ...
    static {
        ...
        XMLMessages.BAD_CODE = "BAD_CODE";
        XMLMessages.FORMAT_FAILED = "FORMAT_FAILED";
    }
}
