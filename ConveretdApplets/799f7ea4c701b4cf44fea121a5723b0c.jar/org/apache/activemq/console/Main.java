...
public class Main
{
    ...
    private Set<File> activeMQClassPath;
    
    public Main() {
        this.extensions = new HashSet<File>(5);
        this.activeMQClassPath = new HashSet<File>(5);
    }
    ...
    public static void main(final String[] args) {
        ...
        final File confDir = new File(app.getActiveMQBase(), "conf");
