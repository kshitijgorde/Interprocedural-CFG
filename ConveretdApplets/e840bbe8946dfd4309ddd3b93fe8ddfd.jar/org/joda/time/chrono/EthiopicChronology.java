...
public final class EthiopicChronology extends BasicFixedMonthChronology
{
    ...
    public static EthiopicChronology getInstance(DateTimeZone default1, final int n) {
        if (default1 == null) {
            default1 = DateTimeZone.getDefault();
        }
        EthiopicChronology instance;
        synchronized (EthiopicChronology.cCache) {
            EthiopicChronology[] array = EthiopicChronology.cCache.get(default1);
            if (array == null) {
                array = new EthiopicChronology[7];
                EthiopicChronology.cCache.put(default1, array);
            }
            try {
                instance = array[n - 1];
            }
            ...
            if (instance == null) {
                if (default1 == DateTimeZone.UTC) {
                    instance = new EthiopicChronology(null, null, n);
                    instance = new EthiopicChronology(LimitChronology.getInstance(instance, new DateTime(1, 1, 1, 0, 0, 0, 0, instance), null), null, n);
                }
                else {
                    instance = getInstance(DateTimeZone.UTC, n);
                    instance = new EthiopicChronology(ZonedChronology.getInstance(instance, default1), null, n);
                }
                array[n - 1] = instance;
            }
        }
