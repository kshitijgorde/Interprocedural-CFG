...
public final class dN
{
    ...
    private static byte[] q(final byte[] array, final int n, final int n2, final byte[] array2, final int n3, int n4) {
        final byte[] array3 = (((n4 = n4) & 0x10) == 0x10) ? dN.e : (((n4 & 0x20) == 0x20) ? dN.t : dN.q);
    ...
    private static byte[] q(byte[] array, final int n, final int n2, final int n3) {
        ...
        if ((n3 & 0x2) != 0x0) {
            ...
            try {
                ...
                do1 = new dO(byteArrayOutputStream, 0x1 | n3);
                ((GZIPOutputStream)(deflaterOutputStream = new GZIPOutputStream(do1))).write(array, n, n2);
