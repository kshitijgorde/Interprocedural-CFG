...
public class SIRtext extends Applet implements Runnable
{
    int i;
    int j;
    int k;
    ...
    public void init() {
        ...
        this.TXTHEIGHT = this.HEIGHT - 2 * this.BORDERWIDTH - this.fontMetrics.getHeight();
    }
    ...
    public void paint(final Graphics graphics) {
        ...
        this.CreateText();
        this.pad.drawImage(this.buffer3, this.BORDERWIDTH, this.HEIGHT - this.TXTHEIGHT - this.BORDERWIDTH, this);
