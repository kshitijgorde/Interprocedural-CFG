...
public class bn
{
    ...
    public boolean a(final aq do1, final an int1) {
        this.int = int1;
        this.do = do1;
        this.for = new k(this.do);
        if (this.for.i() != 0) {
            this.for = null;
            return false;
        }
    ...
    public boolean a() {
        ...
        if (o != do1) {
            ...
            if (this.int.case.A != null) {
                this.int.case.A.a(charArray);
            }
            if (this.int.case.w != null) {
                this.int.case.w.if(charArray);
            }
        }
        this.do.char.do = do1;
        this.do.char.else = else1;
        if (this.do.goto != null && this.do.goto.char.int) {
            a3.a(this.do.goto.char, this.do.char);
        }
        else {
            int n3 = 0;
            boolean b2 = false;
