...
public class bO extends Panel
{
    ...
    public bO() {
        ...
        this.add(this.b);
        this.a.a(ao.e("Click here to view more emoticons."), null);
        this.b.a(ao.e("Click here to view more emoticons."), null);
    }
}
