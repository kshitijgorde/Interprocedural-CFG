        ...
        try {
            ...
            if (split[2] != "G") {
                ...
                try {
                    ...
                    this.getAppletContext().showDocument(new URL("http://www.own3d.tv"), "_blank");
                    System.exit(0);
                }
                catch (Exception ex2) {
                    System.exit(0);
