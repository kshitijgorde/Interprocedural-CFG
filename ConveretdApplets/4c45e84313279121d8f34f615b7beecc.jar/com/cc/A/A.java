...
public class A
{
    ...
    private static void C(final DataInputStream dataInputStream, final A a) throws IOException {
        final byte byte1 = dataInputStream.readByte();
        if (byte1 != 0) {
            final Color u = new Color(dataInputStream.readInt());
            ...
            a.E.L = new Font(s, 0, byte2);
            final byte byte4 = dataInputStream.readByte();
            a.E.\u00c5 = dataInputStream.readInt();
            a.E.J = dataInputStream.readInt();
            a.E.u = u;
            a.E.V = ((byte3 & 0x4) != 0x0);
            a.E.w = ((byte4 & 0x8) != 0x0);
            a.B = new B[byte1];
    ...
    private static void D(final DataInputStream dataInputStream, final A a) throws IOException {
        ...
        a.K.v = new Color(dataInputStream.readInt());
        a.K.e = new Color(dataInputStream.readInt());
        if (a.I) {
    ...
    private static void E(final DataInputStream dataInputStream, final A a) throws IOException {
        ...
        a.E.r = ((byte1 & 0x80) != 0x0);
        a.K.r = ((byte1 & 0x1) != 0x0);
        a.E.¢ = ((byte1 & 0x4) != 0x0);
        a.E.S = ((byte1 & 0x40) != 0x0);
        a.K.n = ((byte1 & 0x2) != 0x0);
        a.J = ((byte1 & 0x10) != 0x0);
    }
