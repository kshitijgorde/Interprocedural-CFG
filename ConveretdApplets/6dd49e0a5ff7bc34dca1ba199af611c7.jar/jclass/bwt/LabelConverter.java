...
class LabelConverter
{
    ...
    static void getParams(final JCLabel jcLabel) {
        ...
        jcLabel.shadow_type = conv.toEnum(jcLabel.getParam("shadowType"), "shadowType", LabelConverter.shadowtype_strings, LabelConverter.shadowtype_values, jcLabel.shadow_type);
    }
    ...
    static {
        ...
        shadowtype_strings = new String[] { "SHADOW_NONE", "SHADOW_ETCHED_IN", "SHADOW_ETCHED_OUT", "SHADOW_IN", "SHADOW_OUT", "SHADOW_PLAIN", "SHADOW_FRAME_IN", "SHADOW_FRAME_OUT" };
        shadowtype_values = new int[] { 0, 1, 2, 3, 4, 5, 6, 7 };
    }
}
