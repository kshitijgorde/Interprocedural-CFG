...
public class RubyTempfile$s$0$1$open extends JavaMethodNBlock
{
    public RubyTempfile$s$0$1$open(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyTempfile.open(context, recv, array, block);
    }
}
