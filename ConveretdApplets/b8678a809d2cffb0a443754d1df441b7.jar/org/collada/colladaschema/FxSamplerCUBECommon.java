...
@XmlType(name = "fx_samplerCUBE_common", propOrder = { "source", "wrapS", "wrapT", "wrapP", "minfilter", "magfilter", "mipfilter", "borderColor", "mipmapMaxlevel", "mipmapBias", "extras" })
public class FxSamplerCUBECommon
{
    ...
    public void setWrapP(final FxSamplerWrapCommon value) {
        this.wrapP = value;
    }
