...
public class GatePanel321 extends GatePanel
{
    public GatePanel321(final int x, final int y, final int width, final int height) {
        super(x, y, width, height, true);
    }
    
    protected void initComponents() {
        this._bitRadioInputs = new BitRadioButton[3];
        ...
        this.add(line, 0);
        this.add(this._gateComponents[1] = new GateComponent(207, this._gateComponents[0].getInput0().getTerminal().y + 25));
        line = new BitLine(this._gateComponents[0].getOutput(), this._gateComponents[1].getInput0(), false, false);
        this.add(line, 0);
        (this._bitRadioInputs[2] = new BitRadioButton(true)).setBounds(this._gateComponents[1].getInput1().getTerminal().x - this._bitRadioInputs[1].getWidth() * 3, this._gateComponents[1].getInput1().getTerminal().y + this._bitRadioInputs[1].getHeight() / 2, this._bitRadioInputs[2].getWidth(), this._bitRadioInputs[2].getHeight());
        this.add(this._bitRadioInputs[2]);
        line = new BitLine(this._bitRadioInputs[2], this._gateComponents[1].getInput1(), true, false);
        this.add(line, 0);
        ...
        line = new BitLine(this._gateComponents[1].getOutput(), this._bitRadioOutputs[0], false, true);
        this.add(line, 0);
        if (this.hasTable()) {
