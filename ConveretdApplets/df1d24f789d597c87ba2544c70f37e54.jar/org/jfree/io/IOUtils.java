...
public class IOUtils
{
    ...
    public void copyStreams(final InputStream inputStream, final OutputStream outputStream) throws IOException {
        this.copyStreams(inputStream, outputStream, 4096);
    }
    
    public void copyStreams(final InputStream inputStream, final OutputStream outputStream, final int n) throws IOException {
    ...
    public void copyWriter(final Reader reader, final Writer writer) throws IOException {
        this.copyWriter(reader, writer, 4096);
    }
    
    public void copyWriter(final Reader reader, final Writer writer, final int n) throws IOException {
    ...
    public boolean isSubDirectory(File canonicalFile, File file) throws IOException {
