...
class e extends Dialog implements ActionListener
{
    ...
    public void paint(final Graphics graphics) {
        ...
        graphics.drawString(e.z[2], 25, 80);
        graphics.drawString(e.z[0], 25, 100);
        graphics.drawString(e.z[4], 25, 120);
        graphics.setColor(Color.blue);
        graphics.drawString(e.z[3], 45, 160);
        graphics.setColor(Color.lightGray);
        graphics.setFont(new Font("", 2, 12));
        graphics.drawString(e.z[1], 35, 190);
        graphics.drawString(e.z[5], 30, 203);
    }
    
    static {
        final String[] z = new String[7];
        final int n = 0;
        final char[] charArray = "\u0012f@'/-/Gº3¢/\u0013fa~5\u0013\u0002 9fG/,".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "\u0011!q'2?}\u0013\u00037,j]f5?}R (0kR(a.}\\!3?b_'/3f@2(,!".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "\u0012f@'/-/['*2nA/ad/V? -d\u001d($*".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "\nz^f)?d_'37/v03;a@)'*/@/35jG//;/R/5*fAh".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "\u0012f@'/-/@')7mZfad/V? -d\u001d($*".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "\u0012f@'/-/@'57|\u0013-.0{R-ad/\u0013+20OV03;a@)'*!P),".toCharArray();
        ...
        final int n19 = 6;
        final char[] charArray7 = ";|p. */['*5f]\" p!\u001d".toCharArray();
