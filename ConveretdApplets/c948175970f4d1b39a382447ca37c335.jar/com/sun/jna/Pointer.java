...
public class Pointer
{
    ...
    Object getValue(final long offset, final Class type, final Object currentValue) {
        Object result = null;
        if (((Pointer.class$com$sun$jna$Structure == null) ? (Pointer.class$com$sun$jna$Structure = class$("com.sun.jna.Structure")) : Pointer.class$com$sun$jna$Structure).isAssignableFrom(type)) {
            Structure s = (Structure)currentValue;
            if (((Pointer.class$com$sun$jna$Structure$ByReference == null) ? (Pointer.class$com$sun$jna$Structure$ByReference = class$("com.sun.jna.Structure$ByReference")) : Pointer.class$com$sun$jna$Structure$ByReference).isAssignableFrom(type)) {
        ...
        else if (type == Boolean.TYPE || type == ((Pointer.class$java$lang$Boolean == null) ? (Pointer.class$java$lang$Boolean = class$("java.lang.Boolean")) : Pointer.class$java$lang$Boolean)) {
            result = Function.valueOf(this.getInt(offset) != 0);
        }
        else if (type == Byte.TYPE || type == ((Pointer.class$java$lang$Byte == null) ? (Pointer.class$java$lang$Byte = class$("java.lang.Byte")) : Pointer.class$java$lang$Byte)) {
            result = new Byte(this.getByte(offset));
        }
        else if (type == Short.TYPE || type == ((Pointer.class$java$lang$Short == null) ? (Pointer.class$java$lang$Short = class$("java.lang.Short")) : Pointer.class$java$lang$Short)) {
            result = new Short(this.getShort(offset));
        }
        else if (type == Character.TYPE || type == ((Pointer.class$java$lang$Character == null) ? (Pointer.class$java$lang$Character = class$("java.lang.Character")) : Pointer.class$java$lang$Character)) {
            result = new Character(this.getChar(offset));
        }
        else if (type == Integer.TYPE || type == ((Pointer.class$java$lang$Integer == null) ? (Pointer.class$java$lang$Integer = class$("java.lang.Integer")) : Pointer.class$java$lang$Integer)) {
            result = new Integer(this.getInt(offset));
        }
        else if (type == Long.TYPE || type == ((Pointer.class$java$lang$Long == null) ? (Pointer.class$java$lang$Long = class$("java.lang.Long")) : Pointer.class$java$lang$Long)) {
            result = new Long(this.getLong(offset));
        }
        else if (type == Float.TYPE || type == ((Pointer.class$java$lang$Float == null) ? (Pointer.class$java$lang$Float = class$("java.lang.Float")) : Pointer.class$java$lang$Float)) {
            result = new Float(this.getFloat(offset));
        }
        else if (type == Double.TYPE || type == ((Pointer.class$java$lang$Double == null) ? (Pointer.class$java$lang$Double = class$("java.lang.Double")) : Pointer.class$java$lang$Double)) {
            result = new Double(this.getDouble(offset));
        }
        else if (((Pointer.class$com$sun$jna$Pointer == null) ? (Pointer.class$com$sun$jna$Pointer = class$("com.sun.jna.Pointer")) : Pointer.class$com$sun$jna$Pointer).isAssignableFrom(type)) {
        ...
        else if (type == ((Pointer.class$java$lang$String == null) ? (Pointer.class$java$lang$String = class$("java.lang.String")) : Pointer.class$java$lang$String)) {
            final Pointer p = this.getPointer(offset);
            result = ((p != null) ? p.getString(0L) : null);
        }
        else if (type == ((Pointer.class$com$sun$jna$WString == null) ? (Pointer.class$com$sun$jna$WString = class$("com.sun.jna.WString")) : Pointer.class$com$sun$jna$WString)) {
            final Pointer p = this.getPointer(offset);
            result = ((p != null) ? new WString(p.getString(0L, true)) : null);
        }
        else if (((Pointer.class$com$sun$jna$Callback == null) ? (Pointer.class$com$sun$jna$Callback = class$("com.sun.jna.Callback")) : Pointer.class$com$sun$jna$Callback).isAssignableFrom(type)) {
        ...
        else if (((Pointer.class$java$nio$Buffer == null) ? (Pointer.class$java$nio$Buffer = class$("java.nio.Buffer")) : Pointer.class$java$nio$Buffer).isAssignableFrom(type)) {
        ...
        else if (((Pointer.class$com$sun$jna$NativeMapped == null) ? (Pointer.class$com$sun$jna$NativeMapped = class$("com.sun.jna.NativeMapped")) : Pointer.class$com$sun$jna$NativeMapped).isAssignableFrom(type)) {
    ...
    private void getArrayValue(final long offset, final Object o, final Class cls) {
        ...
        if (cls == Byte.TYPE) {
            this.read(offset, (byte[])o, 0, length);
        }
        else if (cls == Short.TYPE) {
            this.read(offset, (short[])o, 0, length);
        }
        else if (cls == Character.TYPE) {
            this.read(offset, (char[])o, 0, length);
        }
        else if (cls == Integer.TYPE) {
            this.read(offset, (int[])o, 0, length);
        }
        else if (cls == Long.TYPE) {
            this.read(offset, (long[])o, 0, length);
        }
        else if (cls == Float.TYPE) {
            this.read(offset, (float[])o, 0, length);
        }
        else if (cls == Double.TYPE) {
            this.read(offset, (double[])o, 0, length);
        }
        else if (((Pointer.class$com$sun$jna$Pointer == null) ? (Pointer.class$com$sun$jna$Pointer = class$("com.sun.jna.Pointer")) : Pointer.class$com$sun$jna$Pointer).isAssignableFrom(cls)) {
            this.read(offset, (Pointer[])o, 0, length);
        }
        else if (((Pointer.class$com$sun$jna$Structure == null) ? (Pointer.class$com$sun$jna$Structure = class$("com.sun.jna.Structure")) : Pointer.class$com$sun$jna$Structure).isAssignableFrom(cls)) {
            final Structure[] sarray = (Structure[])o;
            if (((Pointer.class$com$sun$jna$Structure$ByReference == null) ? (Pointer.class$com$sun$jna$Structure$ByReference = class$("com.sun.jna.Structure$ByReference")) : Pointer.class$com$sun$jna$Structure$ByReference).isAssignableFrom(cls)) {
            ...
            if (!((Pointer.class$com$sun$jna$NativeMapped == null) ? (Pointer.class$com$sun$jna$NativeMapped = class$("com.sun.jna.NativeMapped")) : Pointer.class$com$sun$jna$NativeMapped).isAssignableFrom(cls)) {
                throw new IllegalArgumentException("Reading array of " + cls + " from memory not supported");
            }
            final NativeMapped[] array = (NativeMapped[])o;
            final NativeMappedConverter tc = NativeMappedConverter.getInstance(cls);
            final int size = Native.getNativeSize(o.getClass(), o) / array.length;
    ...
    void setValue(final long offset, final Object value, final Class type) {
        if (type == Boolean.TYPE || type == ((Pointer.class$java$lang$Boolean == null) ? (Pointer.class$java$lang$Boolean = class$("java.lang.Boolean")) : Pointer.class$java$lang$Boolean)) {
        ...
        else if (type == ((Pointer.class$com$sun$jna$Pointer == null) ? (Pointer.class$com$sun$jna$Pointer = class$("com.sun.jna.Pointer")) : Pointer.class$com$sun$jna$Pointer)) {
        ...
        else if (((Pointer.class$com$sun$jna$Structure == null) ? (Pointer.class$com$sun$jna$Structure = class$("com.sun.jna.Structure")) : Pointer.class$com$sun$jna$Structure).isAssignableFrom(type)) {
