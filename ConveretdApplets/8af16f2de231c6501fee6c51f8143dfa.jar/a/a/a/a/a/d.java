...
public abstract class d extends b
{
    ...
    protected boolean if(final boolean b) {
        ...
        final URL url = (URL)super.W.byte("param/documentbase");
    ...
    public void r() {
        this.bc = (float)super.W.byte("param/pano.autospin");
        this.bh = (this.bc == 0.0f);
        float[] array = (float[])super.W.byte("param/pano.initialView");
        if (array == null) {
            array = new float[] { 0.0f, (this.aS == this.a6) ? 3.1415927f : ((this.a6 - this.aS) * 0.5f), 1.2217306f };
        }
        this.a(array[0], array[1], 0.0f, array[2]);
        this.a((float)super.W.byte("param/minZoomAngle"), false);
        this.a(array[2]);
    ...
    public void a(final URL url) {
        ...
        try {
            ...
            a.a.a.a.a.b.aq = i.a(dataInputStream, true);
            Label_0162: {
                if (!b) {
                    break Label_0162;
                }
    ...
    public void q() {
        ...
        this.bv = 0.08726647f;
        try {
            this.a(new URL((URL)super.W.byte("param/documentbase"), (String)super.W.byte("param/file")));
        }
        catch (Exception ex) {
            ex.printStackTrace();
            this.A();
            ...
            if (mouseEvent.isPopupTrigger()) {
                ...
                switch (mouseEvent.getID()) {
                    case 501: {
                        ...
                        switch (super.aw.if()) {
                            case 2: {
                                this.setCursor((Cursor)super.W.byte("cursor/zoomin"));
                                break Label_0266;
                            }
                            case 3: {
                                this.setCursor((Cursor)super.W.byte("cursor/zoomout"));
                                break Label_0266;
                            }
                            case 5: {
                                this.setCursor((Cursor)super.W.byte("cursor/rotate"));
                                break Label_0266;
                            }
                        }
                        break;
