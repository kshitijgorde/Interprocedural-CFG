...
public class m extends bl
{
    ...
    public boolean do(final long n) {
        ...
        if (super.k) {
            ...
            this.if(super.d);
            a2 a2 = super.d.if;
            this.W = new f(this, super.j, this.V);
            this.byte();
        ...
        try {
            ...
            if (a2.a.toLowerCase().compareTo("panocylinder") == 0) {
                ...
                try {
                    ...
                    (this.aa[this.U] = (ao)Class.forName(s2).getConstructor((Class<?>[])new Class[0]).newInstance((Object[])null)).a(super.j, this.V, super.void, this.W, this);
            ...
            if (clazz != null) {
                (this.aa[this.U] = (ao)clazz.getConstructor((Class<?>[])new Class[0]).newInstance((Object[])null)).a(super.j, this.V, super.void, this.W, this);
                this.aa[this.U].goto = b;
                this.aa[this.U].int(a2);
                this.a(this.aa[this.U]);
                ++this.U;
