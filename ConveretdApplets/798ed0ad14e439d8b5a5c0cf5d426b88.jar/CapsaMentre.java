...
public class CapsaMentre extends AbstractBox implements CommandsOwner
{
    public CapsaMentre() {
        super.color = 3;
        super.dibs = new NeuterBox[] { NeuterBox.crea("while"), NeuterBox.crea("do"), NeuterBox.crea("end") };
    ...
    public final void onScript(final BoxScripting boxScripting) {
        if (boxScripting.scriptMode == 1) {
            ...
            XMLBoxUtils.csymbol(boxScripting, "while");
