...
@XmlType(name = "glsl_newparam", propOrder = { "annotates", "semantic", "modifier", "surface", "float4X4", "_float", "_int", "bool", "bool4", "sampler2D", "float2", "float3", "samplerCUBE", "bool2", "samplerRECT", "float4", "int2", "float2X2", "_enum", "samplerDEPTH", "int4", "bool3", "sampler1D", "array", "float3X3", "int3", "sampler3D" })
public class GlslNewparam
{
    ...
    public void setArray(final GlslNewarrayType value) {
        this.array = value;
    }
