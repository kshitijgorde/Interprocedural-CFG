...
public class RubyFileTest$s$1$0$pipe_p extends JavaMethodOne
{
    public RubyFileTest$s$1$0$pipe_p(final RubyModule implementationClass, final Visibility visibility) {
