...
public class a
{
    ...
    public void a() {
        ...
        if (this.do != null) {
            ...
            while (keys2.hasMoreElements()) {
                this.int("images/button/" + keys2.nextElement());
            }
            this.do.clear();
            this.do = null;
        }
        if (this.if != null) {
            ...
            while (keys3.hasMoreElements()) {
                this.int("cursor/" + keys3.nextElement());
            }
            this.if.clear();
            this.if = null;
        }
    ...
    protected Object else(final String s) {
        final Applet applet = (Applet)this.case("applet");
        if (applet == null) {
            return null;
        }
        String s2 = s;
        ...
        if (s.equals("toolbar")) {
            ...
            if (!s.equals("leftMargin") && !s.equals("topMargin") && !s.equals("displayWidth")) {
                if (!s.equals("displayHeight")) {
                    ...
                    if (s.equals("backgroundColor")) {
                    ...
                    else if (s.equals("loadingBarColor")) {
                        final int[] array5 = { 255, 255, 255 };
                        ...
                        try {
                            for (n = 0; n < 3; ++n) {
                                ...
                                array5[n] = Integer.parseInt(stringTokenizer5.nextToken().trim());
                            }
                        }
                        ...
                        value = new Color(array5[0], array5[1], array5[2]);
                        return value;
                    }
                    else if (s.equals("loadingBkgdColor")) {
                        final int[] array6 = { 255, 255, 255 };
                        ...
                        try {
                            for (n2 = 0; n2 < 3; ++n2) {
                                ...
                                array6[n2] = Integer.parseInt(stringTokenizer6.nextToken().trim());
                            }
                        }
                        ...
                        value = new Color(array6[0], array6[1], array6[2]);
                        return value;
                    }
                    else {
                        ...
                        if (s.equals("enableZoomPastMin")) {
                            boolean b2 = false;
                            if (trim.trim().equalsIgnoreCase("on")) {
                                b2 = true;
                            }
                            value = new Boolean(b2);
                            return value;
                        }
                        if (s.equals("enableMagAllLevel")) {
                            boolean b3 = false;
                            if (trim.trim().equalsIgnoreCase("on")) {
                                b3 = true;
                            }
                            value = new Boolean(b3);
                            return value;
                        }
                        if (s.equals("d2.initialView")) {
                            final float[] array7 = { 0.0f, 0.0f, 1.0f, 1.0f };
                            final StringTokenizer stringTokenizer7 = new StringTokenizer(trim, ",");
                            try {
                                for (int n3 = 0; n3 < 4; ++n3) {
                                    if (!stringTokenizer7.hasMoreTokens()) {
                                        break;
                                    }
                                    array7[n3] = new Float(stringTokenizer7.nextToken().trim());
                                }
                            }
                        ...
                        if (s.equals("pano.initialView")) {
                            final float[] array8 = new float[3];
                            final StringTokenizer stringTokenizer8 = new StringTokenizer(trim, ",");
                            try {
                                for (int n4 = 0; n4 < 3; ++n4) {
                                    if (!stringTokenizer8.hasMoreTokens()) {
                                        break;
                                    }
                                    array8[n4] = Float.valueOf(stringTokenizer8.nextToken().trim()) * 3.1415927f / 180.0f;
                                }
                            }
                        ...
                        if (s.equals("url") || s.equals("file") || s.equals("verifi") || s.equals("backgroundImage") || s.equals("altsplash")) {
                            value = trim;
                            return value;
                        }
                        ...
                        if (s.equals("minZoomAngle")) {
                            float n5;
                            try {
                                n5 = Float.valueOf(trim) * 3.1415927f / 180.0f;
                            }
    ...
    public Object case(final String s) {
        ...
        if (s.startsWith("resource/")) {
            if (s.startsWith("resource/image.toolbar")) {
            ...
            if (s.startsWith("images/toolbar")) {
                return this.for("resource/image.toolbar");
            }
            if (s.startsWith("images/button/")) {
                return this.if().get(s.substring(14));
            }
            ...
            if (s.startsWith("param/")) {
                return this.goto(s.substring(6));
            }
            return this.a.get(s);
        }
    }
    
    protected c try(final String s) {
        c c = this.a.get(s);
        if (c == null) {
    ...
    protected Hashtable if() {
        if (this.do == null) {
            this.do = new Hashtable();
            final Image image = (Image)this.case("images/toolbar");
            if (image != null) {
                this.a(image);
                this.int("images/toolbar");
            }
        }
        return this.do;
    }
    ...
    public Image for(final String s) {
        return (Image)this.case(s);
    }
    
    public int char(final String s) {
        return Integer.parseInt(this.a(s));
    }
    
    public int do(final String s) {
        return (int)this.case(s);
    }
    
    protected Object goto(final String s) {
        Object o = this.a.get("param/" + s);
        if (o == null) {
            o = this.else(s);
            if (o == null) {
                if (s.equals("toolbar") || s.equals("foregroundFrame") || s.equals("showHotspots") || s.equals("enableZoomPastMax") || s.equals("enableZoomPastMin") || s.equals("enableMagAllLevel")) {
                    o = new Boolean(false);
                }
                else if (s.equals("rotationcontrol")) {
                    o = new Boolean(true);
                ...
                else if (s.equals("displayWidth")) {
                    o = new Integer(0);
                }
                else if (s.equals("displayHeight")) {
                    o = new Integer(0);
                }
                    ...
                    else if (s.equals("reverseDirection")) {
                        o = new Boolean(false);
                    }
                }
            }
    ...
    protected ResourceBundle for() {
        ...
        if (bundle == null) {
            ...
            Locale locale = applet.getLocale();
    ...
    protected j byte(final String s) {
        j j = this.a.get(s);
        if (j == null) {
    ...
    public String a(final String s) {
        final String s2 = (String)this.case(s);
        if (s2 != null) {
            return s2.trim();
        }
        return null;
    ...
    protected void a(final Image image) {
        final ResourceBundle resourceBundle = (ResourceBundle)this.case("resource.bundle");
    ...
    protected void new() {
        final StringTokenizer stringTokenizer = new StringTokenizer(((ResourceBundle)this.case("resource.bundle")).getString("cursors"), ":");
        while (stringTokenizer.hasMoreTokens()) {
