...
class y extends Panel implements ActionListener, ComponentListener
{
    ...
    y(final esChat a, final String s) {
        ...
        panel2.add(this.f, y.z[1]);
        panel.add(panel2, y.z[1]);
        this.add(panel, y.z[0]);
        ...
        Label_0233: {
            ...
            Label_0232: {
                if (!r) {
                    if (index > 0) {
                        this.i = true;
                        final boolean equalsIgnoreCase = this.a.X.equalsIgnoreCase(y.z[3]);
                        y y = null;
                        Label_0210: {
                            if (!r) {
                                if (equalsIgnoreCase) {
                                    this.a.a(String.valueOf(this.a.ob) + " " + this.c + y.z[5] + this.a.L + " ", 1);
                                }
                                y = this;
                                if (r) {
                                    break Label_0210;
                                }
                                this.a.Y.equalsIgnoreCase(y.z[3]);
                            }
                            if (equalsIgnoreCase) {
                                y = this;
                                if (r) {
                                ...
                                if (this.a.zb.length() > 0) {
                                    this.a.a(String.valueOf(this.a.ob) + " " + this.c + y.z[4] + this.a.zb + " ", 1);
                                }
                            }
                            y = this;
                        }
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "\u0007\"o!c".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "\u0017(t!n&".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "twº\u0014X\u0018m".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "twº\u001cF\u0013m".toCharArray();
