...
class $GGC extends $YNB implements $I7B, $W5B
{
    $YAC $ZAC;
    Component $PEC;
    ...
    void $QEC(final Container container) {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent actionEvent) {
                $GGC.this.setVisible(false);
                try {
                    if ($GGC.this.$ZAC.$CBC.$EFC == null) {
                        $GGC.this.$ZAC.$VEC();
                    }
                    else {
                        $GGC.this.$ZAC.$IGC();
        ...
        final Button button2 = new Button(this.$ZAC.$TEC.getString("No, quit now!"));
