...
public class RubyStringIO$i$0$1$seek extends JavaMethodN
{
    public RubyStringIO$i$0$1$seek(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyStringIO)rubyObject).seek(array);
    }
}
