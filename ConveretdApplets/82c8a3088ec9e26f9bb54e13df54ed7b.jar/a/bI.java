...
public final class bI extends bH
{
    protected final void q() {
        ...
        this.add(super.w);
        (super.q = new bQ()).setForeground(new Color(0, 0, 128));
        ...
        try {
            ...
            while (n < long1 && super.q != 2) {
                ...
                if (System.currentTimeMillis() > currentTimeMillis + 1000L) {
                    ...
                    super.r.setText("Transferring file " + bH.q(currentTimeMillis2, currentTimeMillis, n));
                }
            }
    ...
    public bI(final co co, final bW bw) {
        super(co, bw.q, bw.q, bw.w, false);
        super.w = bw.q;
        super.e = bw.q;
    }
    
    public bI(final co co, final l l) {
        super(co, l, null, null, true);
    }
}
