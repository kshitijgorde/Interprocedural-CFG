...
public class Border extends Panel
{
    ...
    protected String paramString() {
        return String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(super.paramString()))).append(",border=").append(this.border().toString()).append(",thickness=").append(this.thickness).append(",gap=").append(this.gap)));
    }
