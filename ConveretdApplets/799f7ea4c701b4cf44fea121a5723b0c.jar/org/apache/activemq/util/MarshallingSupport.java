...
public final class MarshallingSupport
{
    ...
    public static void marshalPrimitiveMap(final Map map, final DataOutputStream out) throws IOException {
        if (map == null) {
            out.writeInt(-1);
        }
        else {
    ...
    public static void marshalPrimitiveList(final List list, final DataOutputStream out) throws IOException {
