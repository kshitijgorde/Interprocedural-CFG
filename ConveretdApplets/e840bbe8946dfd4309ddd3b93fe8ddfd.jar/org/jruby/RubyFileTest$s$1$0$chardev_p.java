...
public class RubyFileTest$s$1$0$chardev_p extends JavaMethodOne
{
    public RubyFileTest$s$1$0$chardev_p(final RubyModule implementationClass, final Visibility visibility) {
