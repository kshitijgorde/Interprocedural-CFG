...
public class OrthoETMDataset extends Sensor
{
    ...
    OrthoETMDataset(final imgViewer imgViewer, final String s, final String s2, final String s3, final boolean isDownloadable) {
        super(imgViewer, s, "ortho/etm", s2, "showOrthoBrowse.cgi", "showOrthoMetadata.cgi", "USGS_logo.gif", "http://www.usgs.gov", s3, null, "Enter a 21 character scene ID", OrthoETMDataset.resolutions, OrthoETMDataset.borderX, OrthoETMDataset.borderY, Color.YELLOW);
    ...
    public int getNumCellsAtResolution(final int n) {
        if (n == OrthoETMDataset.resolutions[0]) {
    ...
    static {
        OrthoETMDataset.resolutions = new int[] { 1000, 240 };
