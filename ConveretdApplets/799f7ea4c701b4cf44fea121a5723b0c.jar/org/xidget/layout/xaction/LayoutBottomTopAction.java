...
public class LayoutBottomTopAction extends AbstractLayoutAction
{
    ...
    protected void layout(final IContext context, final IXidget xidget, final List<IXidget> list, final int n) {
        ...
        layoutFeature.attachContainer(list.get(n2), ILayoutFeature.Side.bottom, 0);
        for (int i = 0; i < n2; ++i) {
            layoutFeature.attachPeer(list.get(i), ILayoutFeature.Side.bottom, list.get(i + 1), ILayoutFeature.Side.top, -n);
        }
    }
}
