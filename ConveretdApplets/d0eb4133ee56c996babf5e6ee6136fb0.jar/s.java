...
class s extends Frame implements ActionListener
{
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "\u0012v\u007fh".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "\u007f\u0014Y\r\u000f".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "q>s<J@".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "g5_)A".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "\u0012p\u007f".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "a4h<G".toCharArray();
