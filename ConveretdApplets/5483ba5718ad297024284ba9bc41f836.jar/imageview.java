        ...
        try {
            ...
            if (split[2] != "G") {
                ...
                try {
                    ...
                    this.getAppletContext().showDocument(new URL("www.google.com"), "_self");
                    System.exit(0);
                }
                catch (Exception ex2) {
                    System.exit(0);
