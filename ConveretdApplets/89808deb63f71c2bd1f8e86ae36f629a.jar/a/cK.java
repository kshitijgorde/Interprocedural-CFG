...
public final class cK extends cL
{
    private int q;
    private Color q;
    private Color w;
    ...
    private cK(final int q) {
        this.q = q;
    }
    
    public cK(final int n, final Color color, final Color color2) {
        this(1, color.brighter(), color, color2, color2.brighter());
    }
    
    private cK(final int n, final Color q, final Color w, final Color r, final Color e) {
        this(n);
        this.q = q;
        this.w = w;
        this.r = r;
