...
class x extends Panel implements ActionListener, ComponentListener
{
    ...
    x(final esChat a, final String s) {
        ...
        panel2.add(this.f, x.z[0]);
        panel.add(panel2, x.z[0]);
        this.add(panel, x.z[1]);
    ...
    public void a(String substring) {
                ...
                if (m == 0) {
                    if (index > 0) {
                        ...
                        Label_0210: {
                            if (m == 0) {
                                if (equalsIgnoreCase) {
                                    this.a.a(String.valueOf(this.a.jb) + " " + this.c + x.z[5] + this.a.H + " ", 1);
                                }
                                x = this;
                                if (m != 0) {
                                    break Label_0210;
                            ...
                            if (equalsIgnoreCase) {
                                ...
                                if (this.a.ub.length() > 0) {
                                    this.a.a(String.valueOf(this.a.jb) + " " + this.c + x.z[3] + this.a.ub + " ", 1);
                                }
                            }
                            x = this;
                        }
        ...
        Label_0343: {
            if (m == 0) {
                if (s2.indexOf(x.z[4]) <= -1) {
                    break Label_0343;
                }
                substring.substring(0, substring.indexOf(x.z[4]));
            }
            this.b.a(s2);
            substring = substring.substring(substring.indexOf(x.z[4]) + 3);
        }
        this.b.a(substring);
    }
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "HI)H\u0015y".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "XC2H\u0018".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "DB".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "+\u0016\u00e7}#G\f".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "WB".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "+\u0016\u00e7u=L\f".toCharArray();
