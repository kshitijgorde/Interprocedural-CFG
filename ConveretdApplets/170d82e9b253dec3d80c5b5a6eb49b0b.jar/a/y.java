...
public class y implements ImageObserver
{
    private boolean q;
    private boolean w;
    private boolean e;
    ...
    public void q(final Graphics graphics, int n, int n2, final int n3, final boolean b, final boolean b2) {
        if (this.q instanceof Image) {
            ...
            a.w.q(graphics, this.q.toString(), n + 7, 0, n2 - 12, n3, 0, false);
        }
    }
    
    public boolean q(final Event event, final aF af) {
        return false;
    }
    
    final boolean q(Graphics graphics, final A a, final Object o, int int1, int n, int n2, int n3, final boolean b) {
        if (o == null && a.q instanceof cz) {
            return false;
        }
        if (o instanceof Boolean) {
            ...
            if (height == 0 || height == 0) {
                ...
                if (this.q.q != null && a.q()) {
                    int1 = 0;
                    if (this.q.q.q().containsKey("" + ((cz)a.q).q())) {
                        int1 = Integer.parseInt(this.q.q.q().get("" + ((cz)a.q).q()));
                    }
                    if (int1 > 0) {
            ...
            n = n19 + (n - 15) / 2;
            n3 = int1 + (n2 - 15) / 2 - 1;
            j.q(graphics, 15, 15, color2, n, n3);
        }
        else if (o != null) {
            ...
            graphics8.setFont(new Font(graphics8.getFont().getFamily(), ((bZ)a.q).u(), graphics8.getFont().getSize()));
            Color color3 = null;
            Label_0816: {
                Color q;
                if (b) {
                    if ((cf.w.Q.getRGB() & 0xFF) == 0x0) {
                        color3 = (a.q ? a.w : Color.lightGray);
                        break Label_0816;
                    }
                    q = cf.w.Q;
                }
                else {
                    q = ((a.q instanceof bZ && (((bZ)a.q).y() & 0xFF) != 0x0) ? new Color(((bZ)a.q).y()) : (a.q ? a.q : Color.gray));
                }
                color3 = q;
            }
            graphics8.setColor(color3);
            a.w.q(graphics8, s, n + 5, n2, n3 - 8, n23, this.e, a.w, a);
        }
        return true;
    }
    ...
    public y(final Object q, final String q2) {
        this.q = Color.red;
        this.q = false;
        this.w = false;
        this.q = 50;
