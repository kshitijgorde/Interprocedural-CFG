...
public class ColorBarPropertyEditPanel extends NumberAxisPropertyEditPanel
{
    ...
    public ColorBarPropertyEditPanel(final ColorBar colorBar) {
        ...
        (this.invertPaletteCheckBox = new JCheckBox(ColorBarPropertyEditPanel.localizationResources.getString("Invert_Palette"), this.invertPalette)).setActionCommand("invertPalette");
        this.invertPaletteCheckBox.addActionListener(this);
        palettePanel.add(this.invertPaletteCheckBox);
        palettePanel.add(new JPanel());
        palettePanel.add(new JPanel());
        (this.stepPaletteCheckBox = new JCheckBox(ColorBarPropertyEditPanel.localizationResources.getString("Step_Palette"), this.stepPalette)).setActionCommand("stepPalette");
        this.stepPaletteCheckBox.addActionListener(this);
        palettePanel.add(this.stepPaletteCheckBox);
        palettePanel.add(new JPanel());
        palettePanel.add(new JLabel(ColorBarPropertyEditPanel.localizationResources.getString("Palette")));
        final JButton button = new JButton(ColorBarPropertyEditPanel.localizationResources.getString("Set_palette..."));
        button.setActionCommand("PaletteChoice");
        button.addActionListener(this);
        palettePanel.add(this.currentPalette);
        palettePanel.add(button);
        other.add(ColorBarPropertyEditPanel.localizationResources.getString("Palette"), palettePanel);
    }
    ...
    private void attemptPaletteSelection() {
        ...
        final int result = JOptionPane.showConfirmDialog(this, panel, ColorBarPropertyEditPanel.localizationResources.getString("Palette_Selection"), 2, -1);
        if (result == 0) {
    ...
    public static ColorBarPropertyEditPanel getInstance(final ColorBar colorBar) {
        if (colorBar != null) {
    ...
    static {
        ColorBarPropertyEditPanel.localizationResources = ResourceBundle.getBundle("org.jfree.chart.ui.LocalizationBundle");
    }
}
