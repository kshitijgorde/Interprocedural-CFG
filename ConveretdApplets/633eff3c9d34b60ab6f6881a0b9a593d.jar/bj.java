...
class bj
{
    ...
    static final float[] a(final float[] array, final float[] array2, final int n) {
        if (n == 2) {
    ...
    public static final boolean d(final float[] array, final float[] array2) {
        for (int i = 0; i < array.length; ++i) {
            if (Math.abs(array[i] - array2[i]) > 1.0E-4f) {
                return false;
            }
        }
        return true;
    ...
    public static final boolean b(final float[] array, final float[] array2, final float[] array3) {
        for (int i = 0; i < array.length; ++i) {
            if (Math.abs(array[i] - array2[i]) > array3[i]) {
                return false;
            }
        }
        return true;
