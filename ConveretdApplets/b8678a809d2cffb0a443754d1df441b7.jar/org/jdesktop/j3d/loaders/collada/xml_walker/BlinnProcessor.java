...
public class BlinnProcessor extends Processor
{
    ...
    private ProfileCOMMON.Technique.Blinn blinn;
    
    public BlinnProcessor(final ProfileCOMMON.Technique.Blinn phong, final Processor parent) {
        super(phong, parent);
        this.app = null;
        this.blinn = phong;
    }
    ...
    public void create(final Node parent) {
        ...
        if (this.blinn != null) {
            ...
            final CommonFloatOrParamType shininess = this.blinn.getShininess();
            if (shininess != null) {
