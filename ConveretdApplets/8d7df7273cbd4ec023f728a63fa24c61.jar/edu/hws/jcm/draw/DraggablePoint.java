...
public class DraggablePoint extends Drawable implements InputObject, Draggable
{
    ...
    static /* synthetic */ void access$2(final DraggablePoint draggablePoint, final double xLoc) {
        draggablePoint.xLoc = xLoc;
    }
    
    static /* synthetic */ void access$5(final DraggablePoint draggablePoint, final double yLoc) {
        draggablePoint.yLoc = yLoc;
    }
            ...
            if (this.needsClamp) {
                if (this.isXVar) {
                    if (DraggablePoint.this.clampX != null) {
                        DraggablePoint.access$2(DraggablePoint.this, DraggablePoint.this.clampX.getVal());
                        this.setVariableValue(DraggablePoint.this.xLoc);
                    }
                }
                else if (DraggablePoint.this.clampY != null) {
                    DraggablePoint.access$5(DraggablePoint.this, DraggablePoint.this.clampY.getVal());
