...
public class default extends o
{
    public default(final int[] array, final a a) {
        super("FastD - %D Fast", 1, array, new double[] { 20.0, 80.0 }, a);
        this.C();
    }
    
    protected void C() {
        super.qIb[0] = super.DDb[0] - 1 + super.DDb[1] - 1;
    }
