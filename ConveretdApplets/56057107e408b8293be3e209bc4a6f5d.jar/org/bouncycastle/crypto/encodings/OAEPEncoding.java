...
public class OAEPEncoding implements AsymmetricBlockCipher
{
    ...
    public byte[] decodeBlock(final byte[] array, final int n, final int n2) throws InvalidCipherTextException {
        ...
        int n5;
        for (n5 = 2 * this.defHash.length; n5 != array2.length && array2[n5] != 1 && array2[n5] == 0; ++n5) {}
        if (n5 >= array2.length - 1 || array2[n5] != 1) {
            throw new InvalidCipherTextException("data start wrong " + n5);
        }
        ++n5;
        final byte[] array5 = new byte[array2.length - n5];
        System.arraycopy(array2, n5, array5, 0, array5.length);
        return array5;
    }
