...
public final class bE extends Panel implements MouseListener, WindowListener
{
    private ac q;
    private Window q;
    ...
    public bE(final Component component, final Component w, final Color q) {
        this(component);
        this.w = w;
        this.q = q;
    }
