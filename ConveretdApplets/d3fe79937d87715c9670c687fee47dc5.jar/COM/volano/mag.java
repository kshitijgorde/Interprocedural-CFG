...
public class mag extends Panel implements AppletStub, Runnable
{
    ...
    private static Properties a(final URL url) {
        ...
        if (url != null) {
            synchronized (mag.a) {
                final Properties properties2 = mag.b.get(url.toString());
                if (properties2 != null) {
                    ...
                    try {
                        ...
                        openStream.close();
                        mag.b.put(url.toString(), properties);
                    }
    ...
    public mag(final Applet c, final String d, final String e, final URL f, final int g, final int h) {
        this.i = new Object();
        this.c = c;
        this.d = d;
        this.e = e;
