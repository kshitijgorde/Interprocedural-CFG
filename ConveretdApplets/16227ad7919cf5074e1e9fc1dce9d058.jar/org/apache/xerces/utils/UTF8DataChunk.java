...
public class UTF8DataChunk implements StringProducer
{
    ...
    private static char[] fTempBuffer;
    ...
    public String toString(int i, final int n) {
        ...
        while (i < n3) {
            ...
            if (n6 < 128) {
                ...
                try {
                    UTF8DataChunk.fTempBuffer[n2] = (char)n6;
                    ++n2;
                }
                catch (NullPointerException ex) {
                    (UTF8DataChunk.fTempBuffer = new char[16384])[n2++] = (char)n6;
                }
                catch (ArrayIndexOutOfBoundsException ex2) {
                    final char[] fTempBuffer = new char[n2 * 2];
                    System.arraycopy(UTF8DataChunk.fTempBuffer, 0, fTempBuffer, 0, n2);
                    (UTF8DataChunk.fTempBuffer = fTempBuffer)[n2++] = (char)n6;
                }
            }
            else {
                ...
                if ((0xE0 & n6) == 0xC0) {
                    ...
                    try {
                        UTF8DataChunk.fTempBuffer[n2] = (char)n8;
                        ++n2;
                    }
                    catch (NullPointerException ex3) {
                        (UTF8DataChunk.fTempBuffer = new char[16384])[n2++] = (char)n8;
                    }
                    catch (ArrayIndexOutOfBoundsException ex4) {
                        final char[] fTempBuffer2 = new char[n2 * 2];
                        System.arraycopy(UTF8DataChunk.fTempBuffer, 0, fTempBuffer2, 0, n2);
                        (UTF8DataChunk.fTempBuffer = fTempBuffer2)[n2++] = (char)n8;
                    }
                }
                else {
                    ...
                    if ((0xF0 & n6) == 0xE0) {
                        ...
                        try {
                            UTF8DataChunk.fTempBuffer[n2] = (char)n10;
                            ++n2;
                        }
                        catch (NullPointerException ex5) {
                            (UTF8DataChunk.fTempBuffer = new char[16384])[n2++] = (char)n10;
                        }
                        catch (ArrayIndexOutOfBoundsException ex6) {
                            final char[] fTempBuffer3 = new char[n2 * 2];
                            System.arraycopy(UTF8DataChunk.fTempBuffer, 0, fTempBuffer3, 0, n2);
                            (UTF8DataChunk.fTempBuffer = fTempBuffer3)[n2++] = (char)n10;
                        }
                    }
                    else {
                        ...
                        if (n12 < 65536) {
                            try {
                                UTF8DataChunk.fTempBuffer[n2] = (char)n12;
                                ++n2;
                            }
                            catch (NullPointerException ex7) {
                                (UTF8DataChunk.fTempBuffer = new char[16384])[n2++] = (char)n12;
                            }
                            catch (ArrayIndexOutOfBoundsException ex8) {
                                final char[] fTempBuffer4 = new char[n2 * 2];
                                System.arraycopy(UTF8DataChunk.fTempBuffer, 0, fTempBuffer4, 0, n2);
                                (UTF8DataChunk.fTempBuffer = fTempBuffer4)[n2++] = (char)n12;
                            }
                        }
                        else {
                            ...
                            try {
                                UTF8DataChunk.fTempBuffer[n2] = c;
                                ++n2;
                            }
                            catch (NullPointerException ex9) {
                                (UTF8DataChunk.fTempBuffer = new char[16384])[n2++] = c;
                            }
                            catch (ArrayIndexOutOfBoundsException ex10) {
                                final char[] fTempBuffer5 = new char[n2 * 2];
                                System.arraycopy(UTF8DataChunk.fTempBuffer, 0, fTempBuffer5, 0, n2);
                                (UTF8DataChunk.fTempBuffer = fTempBuffer5)[n2++] = c;
                            }
                            try {
                                UTF8DataChunk.fTempBuffer[n2] = c2;
                                ++n2;
                            }
                            catch (NullPointerException ex11) {
                                (UTF8DataChunk.fTempBuffer = new char[16384])[n2++] = c2;
                            }
                            catch (ArrayIndexOutOfBoundsException ex12) {
                                final char[] fTempBuffer6 = new char[n2 * 2];
                                System.arraycopy(UTF8DataChunk.fTempBuffer, 0, fTempBuffer6, 0, n2);
                                (UTF8DataChunk.fTempBuffer = fTempBuffer6)[n2++] = c2;
                            }
                        }
                    }
                }
        ...
        return new String(UTF8DataChunk.fTempBuffer, 0, n2);
    }
    ...
    public int addSymbol(final int n, final int n2, int hashcode) {
        ...
        if (n3 != this.fChunk) {
            ...
            if (n3 == n4) {
                ...
                int n6 = this.fStringPool.lookupSymbol((StringPool.StringProducer)this, n5, n2, hashcode);
                if (n6 == -1) {
    ...
    private final void removeRef() {
        ...
        if (this.fRefCount == 0) {
            ...
            this.fChunk = -1;
            this.fPreviousChunk = null;
            this.fNextChunk = UTF8DataChunk.fgFreeChunks;
    ...
    static {
        ...
        UTF8DataChunk.fTempBuffer = null;
    }
}
