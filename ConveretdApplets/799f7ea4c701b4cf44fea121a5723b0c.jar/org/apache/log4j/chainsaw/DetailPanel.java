...
class DetailPanel extends JPanel implements ListSelectionListener
{
    ...
    static {
        LOG = Logger.getLogger((DetailPanel.class$org$apache$log4j$chainsaw$DetailPanel == null) ? (DetailPanel.class$org$apache$log4j$chainsaw$DetailPanel = class$("org.apache.log4j.chainsaw.DetailPanel")) : DetailPanel.class$org$apache$log4j$chainsaw$DetailPanel);
