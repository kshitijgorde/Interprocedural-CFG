...
public class RubyFileTest$s$1$0$size_p extends JavaMethodOne
{
    public RubyFileTest$s$1$0$size_p(final RubyModule implementationClass, final Visibility visibility) {
