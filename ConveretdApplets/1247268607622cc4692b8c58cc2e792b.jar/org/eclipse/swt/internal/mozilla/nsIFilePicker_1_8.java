...
public class nsIFilePicker_1_8 extends nsISupports
{
    ...
    static {
        ...
        NS_IFILEPICKER_IID = new nsID("80faf095-c807-4558-a2cc-185ed70754ea");
    }
    
    public nsIFilePicker_1_8(final int n) {
        super(n);
    }
    
    public int Init(final int n, final int n2, final int n3) {
