...
class ab extends Panel implements ActionListener, MouseListener
{
    ...
    public void mousePressed(final MouseEvent mouseEvent) {
        try {
            this.a.getAppletContext().showDocument(new URL(ab.z[2]), ab.z[3]);
        }
        catch (Exception ex) {
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "\u0012E\u000f|7\u0002V\u001f9|\u0015R\u0018".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "3V\u00183".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "\u0013C\u0018\"hT\u0018\u001b%%UR\u001a 7\u0015D\u00034&UT\u0003?".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "$U\u00003<\u0010".toCharArray();
