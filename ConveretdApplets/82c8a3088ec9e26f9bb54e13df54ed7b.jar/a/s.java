...
public class s implements ba
{
    ...
    public void q(final cp cp) {
        ...
        switch (q3) {
            case 1: {
                final bR br;
                (br = new bR(this.q.q, ak.q("Info"), new String[] { ak.q("Yes"), ak.q("No") }, new String[] { ak.q(q) }, null, this.q)).setVisible(true);
                this.q(q2, this.q.s, ak.q("Yes").equals(br.q));
            }
            case 3: {
                ...
                bm.q("AV conference with " + l.o, q, h.q().getCodeBase() + "Resources/" + co.p + "/" + ((av)this.q.w.w(l.e)).o);
            ...
            case 2: {
                ...
                (this.q = new bR(this.q.q, ak.q("Info"), new String[] { ak.q("Close") }, new String[] { ak.q(q) }, null, this.q)).setModal(false);
