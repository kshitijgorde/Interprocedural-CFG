...
public class RubyIO$i$0$1$each extends JavaMethodNBlock
{
    public RubyIO$i$0$1$each(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return ((RubyIO)rubyObject).each(context, array, block);
    }
}
