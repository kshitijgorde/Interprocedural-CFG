...
class ChartPanel extends Panel implements Runnable
{
    ...
    protected AverageOrderComboChartImage chartProducer;
    ...
    public ChartPanel(final int width, final int priceHeight, final int historyHeight, final int msgHeight) {
    ...
    protected void updateData() {
        ...
        if (this.started) {
            ...
            synchronized (this.socketLock) {
                list = this.dataController.getOrderChartData(this.symbol, this.shares);
    ...
    public void reset() {
        ...
        try {
            ...
            synchronized (this.socketLock) {
                ...
                this.dataController = new AverageOrderComboChartDataDecoder(this.streamer, this.shares);
                this.showMessage("Starting chart ...");
            }
            // monitorexit(this.socketLock)
            synchronized (this.chartLock) {
                (this.chartProducer = new AverageOrderComboChartImage(this.symbol)).setIslandChartMessage("http://www.island.com");
