...
public final class aK extends Panel implements Runnable
{
    private aH q;
    private Color q;
    private Color w;
    ...
    public aK(final aW aw, final aH q, final boolean e, final aS q2) {
        this.q = q2;
        this.e = true;
        this.q = false;
        this.r = true;
        ...
        for (int i = 0; i < aw.q.size(); ++i) {
            final Object q3;
            if ((q3 = aw.q()) instanceof aX) {
                final aX ax = (aX)q3;
                final aS q4 = new aS(ax, q, this);
                ax.q = q4;
                this.q.addElement(q4);
                if (q4.q() > this.r - 40) {
                    this.r = q4.q() + 40;
                }
                ++this.q;
            }
            else if (q3 instanceof aY) {
                this.q.addElement(new aT(q));
                ++this.w;
            }
        }
        if (!q.q()) {
    ...
    private void q(final boolean b) {
        ...
        for (int i = 0; i < this.q.size(); ++i) {
            final Panel panel;
            if ((panel = this.q.elementAt(i)) instanceof aS) {
                if (b) {
                    panel.setBounds(2, 2 + n * r + n2 * 3, this.r, r);
                }
                ++n;
            }
            else if (panel instanceof aT) {
    ...
    public final void w() {
        if (this.q != null) {
            ...
            for (int i = 0; i < q.q.size(); ++i) {
                final Panel panel;
                if ((panel = q.q.elementAt(i)) instanceof aS) {
                    ((aS)panel).q = false;
                }
            }
        }
