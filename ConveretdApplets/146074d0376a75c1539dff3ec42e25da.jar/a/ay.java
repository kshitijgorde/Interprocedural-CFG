...
final class ay extends Panel
{
    aA q;
    private static Image q;
    private ax q;
    
    public ay(final ax q) {
        this.q = q;
    }
    ...
    public final synchronized void update(final Graphics graphics) {
        if (ay.q == null) {
            ay.q = dU.q(this, this.getSize().width, this.getSize().height, "cpp.u");
        }
        final Graphics graphics2;
        (graphics2 = ay.q.getGraphics()).drawImage(this.q.q(ay.q), 0, 0, this);
        graphics2.setColor(Color.white);
        graphics2.drawOval(this.q.q.x - 4, this.q.q.y - 4, 8, 8);
        graphics2.dispose();
        graphics.drawImage(ay.q, 0, 0, this);
    }
}
