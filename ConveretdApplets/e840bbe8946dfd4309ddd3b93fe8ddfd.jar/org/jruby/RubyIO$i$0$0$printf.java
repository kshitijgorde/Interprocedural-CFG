...
public class RubyIO$i$0$0$printf extends JavaMethodN
{
    public RubyIO$i$0$0$printf(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyIO)rubyObject).printf(context, array);
    }
}
