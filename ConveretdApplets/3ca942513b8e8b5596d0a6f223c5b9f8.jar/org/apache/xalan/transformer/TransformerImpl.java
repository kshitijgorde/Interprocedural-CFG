...
public class TransformerImpl extends Transformer implements Runnable, DTMWSFilter, ExtensionsProvider2, SerializerTrace
{
    ...
    public TransformerImpl(final StylesheetRoot stylesheet) {
        ...
        final XPathContext xPath = new XPathContext(this);
    ...
    public void setExtensionsTable(final StylesheetRoot sroot) throws TransformerException {
        try {
    ...
    public Object extFunction(final XPathContext xcntx, final String ns, final String funcName, final Vector argVec, final Object methodKey) throws TransformerException {
        return this.getExtensionsTable().extFunction(ns, funcName, argVec, methodKey, this.getXPathContext().getExpressionContext());
    }
    
    public Object extFunction(final XPathContext xcntx, final FuncExtFunction extFunction, final Vector argVec) throws TransformerException {
        return this.getExtensionsTable().extFunction(extFunction, argVec, this.getXPathContext().getExpressionContext());
    }
    ...
    public SerializationHandler createSerializationHandler(final Result outputTarget, final OutputProperties format) throws TransformerException {
        ...
        if (outputTarget instanceof DOMResult) {
            ...
            if (null != outputNode) {
                ...
                final boolean isSecureProcessing = this.m_stylesheetRoot.isSecureProcessing();
                doc = (Document)(outputNode = DOMHelper.createDocument(isSecureProcessing));
                type = outputNode.getNodeType();
                ((DOMResult)outputTarget).setNode(outputNode);
            }
            final DOMBuilder handler = (11 == type) ? new DOMBuilder(doc, (DocumentFragment)outputNode) : new DOMBuilder(doc, outputNode);
            try {
                final Node nextSibling = ((DOMResult)outputTarget).getNextSibling();
                if (nextSibling != null) {
