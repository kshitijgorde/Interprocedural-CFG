...
public class j extends Canvas
{
    ...
    public j(final Image f, final Image g, final Image h, final Container o, final c q, final int l, final int m) {
        this.a = false;
        this.b = false;
        this.i = true;
        this.l = 4;
    ...
    public void a(final int n, final int r, final String i) {
        if (!this.a) {
            this.r = r;
            this.e = n * this.m / r;
            if (this.q != null) {
    ...
    private void c() {
        if (this.a) {
            ...
            this.paint(graphics);
            graphics.dispose();
            final String string = b.c((int)(this.a() * this.r)) + "/" + b.c(this.r);
            if (this.q != null) {
                this.q.i = string;
            }
        }
