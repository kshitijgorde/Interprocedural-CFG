...
public final class be extends Panel implements aA
{
    ...
    public final void q(final cC q) {
        this.q = q;
    }
    
    public final void q(final au e) {
        if (this.y && e != this.e) {
            this.e = e;
            this.repaint();
            this.w();
    ...
    private int q(final aW aw, final aW aw2) {
        int q = 0;
        au au;
        for (int index = this.w.indexOf(this.e), size = this.w.size(), n = 0; n < size && (!(au = this.w.elementAt((n + index) % size)).q() || (q = aw.q(aw2, au.q())) == 0); ++n) {}
        if (this.t) {
            return q;
        }
        return -q;
    ...
    private synchronized void q(final Vector vector, final int n, final int n2, final au au) {
        if (n2 > n) {
            final int n3 = (n + n2) / 2;
            int n4 = n2;
            int i = n;
            final aW q = vector.elementAt(n3).q;
            while (i <= n4) {
                ...
                if (i < n4) {
                    final bO element = vector.elementAt(i);
                    final bO element2 = vector.elementAt(n4);
            ...
            if (n < n4) {
                this.q(vector, n, n4, au);
            }
            if (i < n2) {
                this.q(vector, i, n2, au);
            }
        }
        this.q = false;
    }
    ...
    private au w(final int n) {
        ...
        for (int i = 0; i < size2 - 1; ++i) {
            final au au;
            final int w = (au = this.w.elementAt(i)).w();
            final int q = au.q();
            int n6 = n3 + w;
            if (n4 == 0) {
                n6 += n5;
        ...
        return (au)this.w.elementAt(size2 - 1);
    }
    ...
    protected final synchronized void q(final int n, final Graphics graphics) {
        if (graphics != null && this.isShowing()) {
            ...
            final bO bo = this.q.elementAt(n);
            ...
            else if (this.u && this.q.q((Object)bo.q)) {
                graphics.setColor(this.q);
            }
            else if (bo.q instanceof aJ && ((aJ)bo.q).g != 0) {
                graphics.setColor(new Color(((aJ)bo.q).g));
            }
            else {
            ...
            for (int i = 0; i < size; ++i) {
                final au au = this.w.elementAt(i);
                int q;
                if (i == size - 1 && !au.w()) {
                    q = size2.width + 5 - n3;
                }
                ...
                if (!au.w()) {
                    if (au.q(graphics, bo, bo.q.q(au.q()), n3, e, q, this.q, n == this.e)) {
                        n3 += q;
                    }
                }
                else if (au.q(graphics, bo, bo.q.q(au.q()), width - q - n4, e, q, this.q, n == this.e)) {
                    n4 += q;
                }
    ...
    public final synchronized int q(final aW aw) {
        for (int i = 0; i < this.q.size(); ++i) {
            if (((bO)this.q.elementAt(i)).q.equals(aw)) {
                return i;
            }
        }
        return -1;
    ...
    public final synchronized aW q(final int n) {
    ...
    private synchronized void w(final aW aw, int n) {
        if (this.e != null) {
            int i = 0;
            ...
            Label_0161: {
                if (n2 == -1) {
                    ...
                    int n5;
                    if ((n5 = this.q(aw, this.q.elementAt(n2).q)) > 0) {
                        n4 = n2 + 1;
                    }
                    else {
                        while (true) {
                            while (i <= n2) {
                                n3 = i + (n2 - i) / 2;
                                if ((n5 = this.q(aw, this.q.elementAt(n3).q)) == 0) {
                                    n4 = n3;
                                    break Label_0161;
                                }
                                if (n5 < 0) {
        ...
        this.q.insertElementAt(new bO(this, this, aw), n);
        if (this.e >= n) {
            ++this.e;
        }
        final int e = this.e(n);
    ...
    private au q(final Event event) {
        if (event.y < this.r) {
            int n = 0;
            for (int i = 0; i < this.w.size() - 1; ++i) {
    ...
    public final void w(final au au) {
        this.w.insertElementAt(au, this.w.size());
        au.q = this;
    }
    
    public final void q(final aW aw) {
        this.w(aw, this.q.size());
    }
    
    public final synchronized void q(final aW aw, final int n) {
        this.q.setElementAt(new bO(this, this, aw), n);
        if (this.e != null) {
            this.q(200L);
            return;
        }
    ...
    public final boolean q(final aW aw) {
        final int q;
        if ((q = this.q(aw)) != -1) {
            this.e(q);
            return true;
    ...
    public final void e(final au au) {
        final int index;
        if ((index = this.w.indexOf(au)) >= 0) {
            final int n = index;
            int n2 = 0;
            for (int i = 0; i < n; ++i) {
                n2 += ((au)this.w.elementAt(i)).q();
            }
            final int n3 = n2;
    ...
    protected static void q(final Graphics graphics, String string, final int n, final int n2, final int n3, final int n4, final int n5, final boolean b, final bO bo) {
        ...
        if (bo != null && bo.q() != null) {
            graphics.drawImage(bo.q(), n9 - 2, n6 - 17, null);
        }
        else {
    ...
    private void q(final Graphics graphics, final au au, final boolean b, final boolean b2) {
        final Dimension size = this.size();
        ...
        if (au == this.r) {
            ...
            final int index;
            final int n3 = index = this.w.indexOf(au);
            int n4 = 1;
            for (int i = 0; i < index; ++i) {
                int w = this.w.elementAt(i).w();
                final au au2;
                if (i > 0 && (au2 = this.w.elementAt(i - 1)).w() == 0) {
                    w += au2.q();
                }
                n4 += w;
            }
            ...
            if (n3 == this.w.size() - 1) {
                ...
                q = au.q();
                final au au3;
                if (n3 > 0 && (au3 = this.w.elementAt(n3 - 1)).w() == 0) {
                    q += au3.q();
                }
            }
        }
        this.q(graphics, au, n2, q, this.r, b, b2);
    }
    
    private void q(final Graphics graphics, final au au, final int n, final int n2, final int n3, final boolean b, final boolean b2) {
        final Color color;
    ...
    public final void paint(final Graphics graphics) {
        ...
        if (this.r > 0) {
            ...
            au au;
            int w2;
            for (int n4 = 0; n4 < size2 && n2 < size.width - 1; n2 += w2, q = au.q(), n3 = w2, ++n4) {
                au = this.w.elementAt(n4);
                if (n4 == size2 - 1) {
                ...
                if (w2 != 0) {
                    this.q(graphics, au, n2, w2, this.r, false, au == this.e);
                }
            }
            if (this.y) {
    ...
    public final synchronized void q(final aW aw, final boolean b) {
        final int q;
        if ((q = this.q(aw)) >= 0) {
            this.q(q, b);
        }
    ...
    private synchronized void q(final int n, final Color q, final Color w) {
        final bO bo;
        (bo = this.q.elementAt(n)).q = q;
        bo.w = w;
        this.q(0L, n);
    }
    
    public final synchronized void q(final aW aw, final Color color, final Color color2) {
        final int q;
        if ((q = this.q(aw)) >= 0) {
    ...
    private be(final int n) {
        ...
        this.y = false;
        this.q = false;
        (this.r = new au(null, null)).q(true);
        this.r.q(ak.q("Click here to reverse the sort order of items in this list."), null);
        if (!be.e) {
            be.e = true;
            try {
                this.setCursor(Cursor.getDefaultCursor());
    ...
    public be(final boolean u) {
        this();
        this.u = u;
    }
    
    public be(final co q) {
        this();
        this.q = q;
    }
    ...
    static boolean q(final be be) {
        return be.u;
    }
    
    static Vector w(final be be) {
        return be.q;
    }
    
    static A q(final be be) {
        return be.q;
    }
