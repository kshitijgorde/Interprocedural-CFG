...
public class bq extends Dialog
{
    ...
    private final String else = "copyright © ImmerVision 2002-2005";
    ...
    public bq(final Frame frame, final String s, final l new1, final String s2) {
        ...
        if (s2.length() != 0) {
            ...
            s3 = "Move :\n  - left mouse button drag\n  - arrow keys\n\nZoom in :\n  - right mouse button drag up\n  - ctrl or shift key with mouse drag up\n  - Mouse wheel up\n\nZoom out :\n  - right mouse button down up\n  - ctrl or shift key with mouse drag down\n  - Mouse wheel down\n\nExit fullscreen:  press escape key\n";
        }
