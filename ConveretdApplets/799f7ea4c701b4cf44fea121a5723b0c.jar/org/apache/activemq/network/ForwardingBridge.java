...
public class ForwardingBridge implements Service
{
    ...
    public void start() throws Exception {
        ForwardingBridge.LOG.info("Starting a network connection between " + this.localBroker + " and " + this.remoteBroker + " has been established.");
        ...
        final Thread thead = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    ForwardingBridge.LOG.error("Failed to start network bridge: " + e, e);
                }
            }
        };
        thead.start();
    ...
    final void startBridge() throws IOException {
        ...
        ForwardingBridge.LOG.info("Network connection between " + this.localBroker + " and " + this.remoteBroker + " has been established.");
    }
    ...
    public void serviceRemoteException(final Throwable error) {
        ForwardingBridge.LOG.info("Unexpected remote exception: " + error);
    ...
    public void serviceLocalException(final Throwable error) {
        ForwardingBridge.LOG.info("Unexpected local exception: " + error);
        ForwardingBridge.LOG.debug("Exception trace: ", error);
