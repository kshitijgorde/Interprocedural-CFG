...
public class ptviewer extends Applet implements Runnable
{
    ...
    void ReadParameters(final String s) {
        ...
        if (this.autopan != 0.0 && (myGetParameter39 = this.myGetParameter(s, "autoTime")) != null) {
        ...
        if ((myGetParameter40 = this.myGetParameter(s, "mousehs")) != null) {
            this.MouseOverHS = myGetParameter40;
        }
        final String myGetParameter41;
        if ((myGetParameter41 = this.myGetParameter(s, "getview")) != null) {
            this.GetView = myGetParameter41;
        }
        final String myGetParameter42;
        if ((myGetParameter42 = this.myGetParameter(s, "frame")) != null) {
            this.frame = null;
            this.frame = this.loadImage(myGetParameter42);
        }
        final String myGetParameter43;
        if ((myGetParameter43 = this.myGetParameter(s, "waittime")) != null) {
            this.waittime = Integer.parseInt(myGetParameter43);
        }
        final String myGetParameter44;
        if ((myGetParameter44 = this.myGetParameter(s, "hsimage")) != null) {
            this.hs_image = myGetParameter44;
        }
        final String myGetParameter45;
        if ((myGetParameter45 = this.myGetParameter(s, "pwidth")) != null) {
            this.pwidth = Integer.parseInt(myGetParameter45);
        }
        final String myGetParameter46;
        if ((myGetParameter46 = this.myGetParameter(s, "pheight")) != null) {
            this.pheight = Integer.parseInt(myGetParameter46);
        }
        final String myGetParameter47;
        if ((myGetParameter47 = this.myGetParameter(s, "loadAllRoi")) != null && myGetParameter47.equalsIgnoreCase("false")) {
            this.loadAllRoi = false;
        }
        final String myGetParameter48;
        if ((myGetParameter48 = this.myGetParameter(s, "file")) != null) {
            this.filename = myGetParameter48;
        }
        final String myGetParameter49;
        if ((myGetParameter49 = this.myGetParameter(s, "order")) != null) {
            this.order = myGetParameter49;
        }
        final String myGetParameter50;
        if ((myGetParameter50 = this.myGetParameter(s, "oversampling")) != null) {
            this.max_oversampling = Double.valueOf(myGetParameter50);
        }
        for (int i = 0; i <= this.hotspots.size(); ++i) {
            final String myGetParameter51;
            if ((myGetParameter51 = this.myGetParameter(s, "hotspot" + i)) != null) {
                if (i < this.hotspots.size()) {
                    this.hotspots.setSize(i);
                }
                this.hotspots.addElement(myGetParameter51);
            }
        }
        this.numroi = 0;
        int n;
        ...
        if (n > 0) {
            ...
            for (int j = 0; j < this.numroi; ++j) {
                ...
                if ((myGetParameter52 = this.myGetParameter(s, "roi" + j)) != null) {
                    this.ParseROILine(myGetParameter52, j);
                }
            }
        }
        for (int k = 0; k <= this.shotspots.size(); ++k) {
            final String myGetParameter53;
            if ((myGetParameter53 = this.myGetParameter(s, "shotspot" + k)) != null) {
                if (k < this.shotspots.size()) {
                    this.shotspots.setSize(k);
                }
                this.shotspots.addElement(myGetParameter53);
            }
        }
        for (int l = 0; l <= this.sounds.size(); ++l) {
            final String myGetParameter54;
            if ((myGetParameter54 = this.myGetParameter(s, "sound" + l)) != null) {
                if (l < this.sounds.size()) {
                    this.sounds.setSize(l);
                }
                this.sounds.addElement(myGetParameter54);
            }
        }
        for (int size = 0; size <= this.app_properties.size(); ++size) {
            final String myGetParameter55;
            if ((myGetParameter55 = this.myGetParameter(s, "applet" + size)) != null) {
                if (size < this.app_properties.size()) {
                    this.stopApplets(size);
                    this.app_properties.setSize(size);
                }
                this.app_properties.addElement(myGetParameter55);
            }
        }
        final String myGetParameter56;
        if ((myGetParameter56 = this.myGetParameter(s, "dynLoadROIs")) != null && myGetParameter56.equalsIgnoreCase("true")) {
            this.dynLoadROIs = true;
        }
        final String myGetParameter57;
        if ((myGetParameter57 = this.myGetParameter(s, "hsEnableVisibleOnly")) != null && myGetParameter57.equalsIgnoreCase("true")) {
            this.hsEnableVisibleOnly = true;
        }
        final String myGetParameter58;
        if ((myGetParameter58 = this.myGetParameter(s, "shsEnableVisibleOnly")) != null && myGetParameter58.equalsIgnoreCase("true")) {
            this.shsEnableVisibleOnly = true;
        }
        final String myGetParameter59;
        if ((myGetParameter59 = this.myGetParameter(s, "popup_panning")) != null && myGetParameter59.equalsIgnoreCase("true")) {
            this.popupPanning = true;
        }
        final String myGetParameter60;
        if ((myGetParameter60 = this.myGetParameter(s, "imgLoadFeedback")) != null && myGetParameter60.equalsIgnoreCase("false")) {
            this.imgLoadFeedback = false;
        }
        final String myGetParameter61;
        if ((myGetParameter61 = this.myGetParameter(s, "outOfMemoryURL")) != null) {
            this.outOfMemoryURL = myGetParameter61;
        }
    }
