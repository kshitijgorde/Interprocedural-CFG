...
public class NFChart extends Applet
{
    ...
    public NFChart(final Applet app) {
        this();
        this.app = app;
    }
    ...
    public static NFChart getChart(final NFCdf nfCdf) {
    ...
    public static NFChart getChart(final NFCdf nfCdf, final Applet applet) {
        if (applet == null) {
            return getChart(nfCdf, (NFContext)null);
        }
    ...
    public static NFChart getChart(final NFCdf nfCdf, final NFContext nfContext) {
        return getChart(nfCdf, nfContext, true);
    }
    
    public static NFChart getChart(final NFCdf cdf, final NFContext nfContext, final boolean loadAppletParamsOnInit) {
        if (cdf.name.equals("BREAK") || cdf.type == -2) {
            final NFChart nfChart = new NFChart();
            nfChart.cdf = cdf;
            return nfChart;
        }
        try {
            final NFChart applet = (NFChart)NFGlobal.getChart(cdf.type);
            if (nfContext != null) {
                try {
