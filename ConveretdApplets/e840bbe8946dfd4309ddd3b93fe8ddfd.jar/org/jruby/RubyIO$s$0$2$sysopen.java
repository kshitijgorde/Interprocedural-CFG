...
public class RubyIO$s$0$2$sysopen extends JavaMethodNBlock
{
    public RubyIO$s$0$2$sysopen(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyIO.sysopen(recv, array, block);
    }
}
