...
public class AverageOrderDetailChartPApplet extends Applet implements ActionListener, KeyListener
{
    protected int width;
    ...
    protected PDetailChartPanel cp;
    protected ToggleButton goButton;
    protected String symbol;
    
    public AverageOrderDetailChartPApplet() {
        this.symbol = "QQQ";
    }
    
    public AverageOrderDetailChartPApplet(final int width, final int height, final String serverURL) {
        this.symbol = "QQQ";
        this.width = width;
        this.height = height;
        ...
        (this.cp = new PDetailChartPanel(width, height - 50)).setVisible(true);
    ...
    public void init() {
        ...
        this.ctrPanel.add(this.tDeltaPrice);
        this.ctrPanel.add(this.goButton);
        (this.cp = new PDetailChartPanel(this.width, this.height - 40)).setCodeBase(this.getCodeBase());
    ...
    public static void main(final String[] argvs) {
        final AverageOrderDetailChartPApplet applet = new AverageOrderDetailChartPApplet(500, 300, argvs[0]);
