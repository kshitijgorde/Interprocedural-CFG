    ...
    public Object callFunction(final String funcName, final Vector args, final Object methodKey, final ExpressionContext exprContext) throws TransformerException {
        try {
            if (funcName.equals("new")) {
                ...
                if (4 == resolveType) {
                    if (TransformerImpl.S_DEBUG) {
                        final TransformerImpl trans2 = (TransformerImpl)exprContext.getXPathContext().getOwnerObject();
                        trans2.getTraceManager().fireExtensionEvent(m, targetObject, convertedArgs[0]);
                        Object result2;
                        try {
                            ...
                            trans2.getTraceManager().fireExtensionEndEvent(m, targetObject, convertedArgs[0]);
                        }
                        return result2;
                    }
                    return m.invoke(targetObject, convertedArgs[0]);
                    ...
                    if (TransformerImpl.S_DEBUG) {
                        final TransformerImpl trans2 = (TransformerImpl)exprContext.getXPathContext().getOwnerObject();
                        trans2.getTraceManager().fireExtensionEvent(m, null, convertedArgs[0]);
                        Object result2;
                        try {
                            ...
                            trans2.getTraceManager().fireExtensionEndEvent(m, null, convertedArgs[0]);
                        }
                        return result2;
                    }
                    return m.invoke(null, convertedArgs[0]);
                    ...
                    if (null == this.m_defaultInstance) {
                        if (TransformerImpl.S_DEBUG) {
                            final TransformerImpl trans2 = (TransformerImpl)exprContext.getXPathContext().getOwnerObject();
                            trans2.getTraceManager().fireExtensionEvent(new ExtensionEvent(trans2, this.m_classObj));
                            try {
                                ...
                                trans2.getTraceManager().fireExtensionEndEvent(new ExtensionEvent(trans2, this.m_classObj));
                            }
                        }
                        else {
                            this.m_defaultInstance = this.m_classObj.newInstance();
                    ...
                    if (TransformerImpl.S_DEBUG) {
                        final TransformerImpl trans2 = (TransformerImpl)exprContext.getXPathContext().getOwnerObject();
                        trans2.getTraceManager().fireExtensionEvent(m, this.m_defaultInstance, convertedArgs[0]);
                        Object result2;
                        try {
                            ...
                            trans2.getTraceManager().fireExtensionEndEvent(m, this.m_defaultInstance, convertedArgs[0]);
                        }
                        return result2;
                    }
                    return m.invoke(this.m_defaultInstance, convertedArgs[0]);
