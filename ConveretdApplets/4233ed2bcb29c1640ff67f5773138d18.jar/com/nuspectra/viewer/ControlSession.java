...
class ControlSession extends Thread
{
    String idStr;
    String urlBaseStr;
    NuApplet applet;
    ...
    protected static final int WATCHING = 1;
    protected static final int IN_QUEUE = 2;
    protected static final int IN_CONTROL = 3;
    protected static final int CAMERA_OFFLINE = 4;
    protected static final int CAMERA_BUSY = 5;
    protected static final int NO_CONTROLS = 6;
    protected static final int DISCONNECT = 7;
    protected static final int UNINITIALIZED = 8;
    ...
    protected synchronized Reply openSession(final String sessionKind) throws Exception {
    ...
    private void setState(final int v) {
        if (!this.isRunnable && v != 7) {
            Debug.println("setState when disconnected:" + v);
        }
    ...
    private Reply executeCommand(final URL url) throws Exception {
        try {
            ...
            final URLConnection u = this.applet.getConnection(url);
            if (u == null) {
                this.querying = null;
                throw new Exception("UNAUTHORIZED");
            }
            final Reply reply = new Reply(u.getInputStream());
            ...
            this.querying = null;
            Debug.report(e, "executeCommand terminated: " + url.toString());
            throw e;
        }
        finally {
            this.querying = null;
    ...
    protected void addListener(final SessionListener inListener) {
