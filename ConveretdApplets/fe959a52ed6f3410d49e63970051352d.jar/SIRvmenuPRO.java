...
public class SIRvmenuPRO extends Applet implements MouseMotionListener, MouseListener
{
    boolean started;
    boolean NOBUTTONS;
    boolean OFF;
    ...
    public void init() {
        SIRvmenuPRO.APPLETCONTEXT = this.getAppletContext();
        new Evaluation();
    ...
    public void startUp(final Graphics graphics) {
        ...
        if (this.BA.equals("l") || this.BA.equals("L")) {
            this.BALIGN = 0;
        }
        if (this.BA.equals("r") || this.BA.equals("R")) {
            this.BALIGN = 2;
        }
        ...
        if (!this.NOBUTTONS) {
            ...
            while (this.i < this.NO_BUTTONS) {
                ...
                this.BtnImg[this.i][0] = this.createImage(new FilteredImageSource(this.Btnimage.getSource(), new CropImageFilter(0, this.y, this.BTNSIZE[this.i][0], this.BTNSIZE[this.i][1])));
                this.BtnImg[this.i][1] = this.createImage(new FilteredImageSource(this.Btnimage.getSource(), new CropImageFilter(this.BTNSIZE[this.i][0], this.y, this.BTNSIZE[this.i][0], this.BTNSIZE[this.i][1])));
                this.BtnImg[this.i][2] = this.createImage(new FilteredImageSource(this.Btnimage.getSource(), new CropImageFilter(2 * this.BTNSIZE[this.i][0], this.y, this.BTNSIZE[this.i][0], this.BTNSIZE[this.i][1])));
                if (this.BALIGN == 0) {
                    this.BTNSIZE[this.i][2] = this.BORDER;
                }
                if (this.BALIGN == 1) {
                    this.BTNSIZE[this.i][2] = this.WIDTH / 2 - this.BtnImg[this.i][0].getWidth(this) / 2;
                }
                if (this.BALIGN == 2) {
                    this.BTNSIZE[this.i][2] = this.WIDTH - this.BORDER - this.BtnImg[this.i][this.STATE[this.i]].getWidth(this);
                }
                this.BTNSIZE[this.i][3] = this.y + this.BORDER + this.TITLEHEIGHT;
                this.BTNSIZE[this.i][4] = this.BTNSIZE[this.i][2] + this.BTNSIZE[this.i][0];
                this.BTNSIZE[this.i][5] = this.y + this.BORDER + this.TITLEHEIGHT + this.BTNSIZE[this.i][1];
                if (this.st.hasMoreTokens()) {
                ...
                if (!this.BTNINFO[this.i][2].equals(" ")) {
                    ...
                    if (this.TEMPSTR != null) {
                        do {
                            ...
                            this.SL_COORDS[this.i][this.SL_NITEMS[this.i][0]][0] = this.BTNSIZE[this.i][2] + 10;
    ...
    public void paint(final Graphics graphics) {
        ...
        if (this.NOBUTTONS) {
            ...
            this.pad.drawString("ERROR", 0, 30);
            this.pad.drawString("Button Images not Found", 0, 50);
            this.pad.drawString("Menu Cannot Start.", 0, 70);
        }
        else {
            this.pad.setColor(this.BGCOLOR);
            this.pad.fillRect(0, 0, this.WIDTH, this.HEIGHT);
            ...
            this.y = this.BORDER + this.TITLEHEIGHT;
            this.i = 0;
            while (this.i < this.NO_BUTTONS) {
                this.pad.drawImage(this.BtnImg[this.i][this.STATE[this.i]], this.BTNSIZE[this.i][2], this.y, this);
                this.y += this.BTNSIZE[this.i][1];
                ++this.i;
            }
            this.i = 0;
            ...
            if (this.SL_NITEMS[this.k2][1] == 1) {
                ...
                while (this.i < this.SL_NITEMS[this.k2][0]) {
                    if (x > this.SL_COORDS[this.k2][this.i][0] && x < this.SL_COORDS[this.k2][this.i][2] + this.SL_COORDS[this.k2][this.i][0] && y >= this.SL_COORDS[this.k2][this.i][1] && y <= this.SL_COORDS[this.k2][this.i][3] + this.SL_COORDS[this.k2][this.i][1]) {
                        ...
                        this.SL_COORDS[this.k2][this.i][4] = 0;
                    }
                    ++this.i;
                }
            }
            ++this.k2;
        } while (this.k2 < this.NO_BUTTONS);
        this.k2 = 0;
        do {
            if (x > this.BTNSIZE[this.k2][2] && x < this.BTNSIZE[this.k2][4] && y > this.BTNSIZE[this.k2][3] && y < this.BTNSIZE[this.k2][5] && !this.SUBMENU2) {
                b = true;
    ...
    public void mouseMoved(final MouseEvent mouseEvent) {
        ...
        do {
            ...
            if (x > this.BTNSIZE[this.k][2] && x < this.BTNSIZE[this.k][4] && y >= this.BTNSIZE[this.k][3] && y <= this.BTNSIZE[this.k][5] && !this.SUBMENU) {
