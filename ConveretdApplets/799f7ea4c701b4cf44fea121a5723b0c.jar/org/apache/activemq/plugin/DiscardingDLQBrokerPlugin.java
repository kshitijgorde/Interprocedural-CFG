...
public class DiscardingDLQBrokerPlugin implements BrokerPlugin
{
    ...
    public Broker installPlugin(final Broker broker) throws Exception {
        DiscardingDLQBrokerPlugin.log.info("Installing Discarding Dead Letter Queue broker plugin[dropAll=" + this.isDropAll() + "; dropTemporaryTopics=" + this.isDropTemporaryTopics() + "; dropTemporaryQueues=" + this.isDropTemporaryQueues() + "; dropOnly=" + this.getDropOnly() + "; reportInterval=" + this.getReportInterval() + "]");
