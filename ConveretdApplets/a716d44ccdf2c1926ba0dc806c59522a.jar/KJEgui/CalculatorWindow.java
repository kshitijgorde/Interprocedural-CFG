...
public class CalculatorWindow extends JFrame implements ActionListener
{
    ...
    public CalculatorWindow(final String sTitle, String s, final JPanel panel, final CalculatorApplet ca, final int n, final int n2) {
        ...
        (this.bButton = new JButton(this.CA.getParameter("MSG_OK_BUTTON", "   OK   "))).setForeground(this.CA.getForeground());
        this.bButton.setBackground(this.CA.getBackground());
    ...
    public void setTitle() {
        this.tfTitle.setForeground(this.CA.getForeground());
