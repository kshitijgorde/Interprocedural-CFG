...
public abstract class at extends as
{
    ...
    public void a(final String s, final String s2, final r r, final URL c, final int n, final String s3) {
        ...
        try {
            ...
            if (bi.T != null) {
                for (int k = 0; k < super.d.length; ++k) {
                    if (bi.T == super.d[k]) {
                        final String s5 = super.d[0];
                        super.d[0] = super.d[k];
                        super.d[k] = s5;
                        break;
                    }
            ...
            if (bi.au != 0) {
                for (int l = 0; l < doook.L.a.length; ++l) {
                    if (bi.au == doook.L.a(l)) {
                        doook.L.l(l);
                        break;
                    }
                }
            ...
            if (this.j()) {
                ...
                aj.a(0, 0, s);
                aj.a(0, 2, bi.R);
                aj.a(0, 1, doook.F.a(new Object[] { "window.location.href" }).toString());
                aj.a(0, 3, s2);
                aj.a(0, 4, s6);
                aj.a(0, 0, r);
    ...
    private boolean j() {
        boolean b = false;
        bi.au = 8396;
        for (int z = 0; !b && z < super.d.length; ++z) {
            super.Z = z;
            try {
                b = this.b(super.d[z], bi.au);
            }
            catch (Exception ex2) {
                if (z != super.d.length - 1) {
                    try {
                        Thread.sleep(200L);
                    }
        ...
        for (int z2 = 0; !b && z2 < super.d.length; ++z2) {
            super.Z = z2;
            this.c(super.d[z2]);
            for (int n = 0; !b && n < doook.L.a.length; ++n) {
                ...
                if (a != doook.L.g) {
                    bi.au = a;
                    try {
                        b = this.b(super.d[z2], a);
                    }
                    catch (Exception ex) {
                        if (z2 == super.d.length - 1 && n == doook.L.a.length - 1) {
                            throw ex;
                        }
                        try {
                            Thread.sleep(200L);
    ...
    public void a(final String s, final F f, final int n, final int n2, final boolean b, final boolean b2, final long n3, final int n4, final byte[] a, final int ac, final int d, final boolean ap, final boolean aq, final boolean ar) {
        if (super.a != null) {
            int e = f.e();
            if (e == this.e()) {
                e = n;
    ...
    protected void s(final aJ aj) {
        ...
        if (!"Admin".equals(super.r)) {
            if (super.b.k()) {
                super.b.r = this.a(super.b.e() + "background.gif", true);
            }
            if (super.b.l()) {
                super.b.s = this.a(super.b.e() + "chatbackground.gif", true);
            }
            if (bi.ae) {
    ...
    protected void D(final aJ aj) {
        ...
        if (super.a != null) {
            ((e)super.a).a(super.B);
            ((e)super.a).a().b((super.U <= 0) ? 7 : super.U);
        }
        ...
        as.Q = aj.a(0, 37);
        as.R = aj.a(0, 38);
        aX.n = super.a("Doooknet.gif", false);
        aX.e.clear();
