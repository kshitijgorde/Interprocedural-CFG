...
public class Graph extends JPanel implements MouseMotionListener
{
    ...
    public Graph(final GraphType gtGraphType, final Image imageBackground) {
        ...
        this._cGridBackground = Color.gray;
    ...
    public synchronized Image getImage(final int n, final int n2, final Color cBack) {
        this._iOWidth = -1;
        this._iOHeight = -1;
        this.dataChanged();
        final Image image = this.createImage(n, n2);
        final Graphics graphics = image.getGraphics();
        final Color cBackground = this._cBackground;
        this._titleGraph.b = true;
        this._titleXAxis.b = true;
        this._titleYAxis.b = true;
        graphics.setColor(this._gtGraphType.cBack = cBack);
        graphics.fillRect(0, 0, n, n2);
        this._gtGraphType.paint(graphics, this, new Dimension(n, n2), true);
        this._gtGraphType.cBack = cBackground;
        this._titleGraph.b = true;
        this._titleXAxis.b = true;
        this._titleYAxis.b = true;
        this._iOWidth = -1;
