...
public class InterestRateApplet extends Applet implements Runnable, MouseListener
{
    ...
    public void mouseClicked(final MouseEvent mouseEvent) {
        try {
            this.getAppletContext().showDocument(new URL(this.getCodeBase(), "https://ibank.hncb.com.tw/netbank/servlet/TrxDispatcher?trx=com.lb.wibc.trx.T_RateQuerym&state=prompt"), "_blank");
        }
        catch (Exception ex) {
            ex.printStackTrace();
        }
