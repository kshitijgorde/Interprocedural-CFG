...
public class A extends Canvas implements Runnable, MouseListener
{
    ...
    public A(final Image x) {
        ...
        this.B = "";
        this.X = x;
        (this.G = new MediaTracker(this)).addImage(x, 0);
        this.addMouseListener(this);
    }
    
    public void A() {
        if (this.P == null) {
            this.F = new Date().getTime() - this.Y;
    ...
    public void paint(final Graphics graphics) {
        ...
        if (this.X != null) {
            ...
            if (this.U != null) {
                ...
                graphics.drawString(this.U, this.X.getWidth(this) + 3, this.X.getHeight(this) / 2 + graphics.getFontMetrics().getHeight() / 4);
                if (this.R) {
