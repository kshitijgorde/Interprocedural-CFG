...
public class HeadLiner2 extends Applet implements Runnable
{
                ...
                for (int j = 0; j < string.length(); ++j) {
                    if (string.charAt(j) == '<' && string.charAt(j + 1) != '<') {
                        ...
                        if (substring.equalsIgnoreCase("<b>")) {
                            ...
                            final String substring3 = substring.substring(12, substring.length() - 1);
                            int intValue2 = 0;
                            try {
                                intValue2 = Integer.valueOf(substring3, 10);
                                if (intValue2 == 10) {
                                ...
                                this.showStatus("Invalid image argument: " + ex2.toString());
                            }
                            ...
                            try {
                                this.nCurrentFontSize = Integer.valueOf(substring4, 10);
                                ...
                                this.showStatus("Invalid Font Size: " + ex3.toString());
                            }
                        }
                        else if (substring.toLowerCase().indexOf("<bgcolor=") != -1) {
                            final String substring5 = substring.substring(9, substring.length() - 1);
                            try {
                                this.bgColor = new Color(Integer.valueOf(substring5, 16));
                            }
                            catch (NumberFormatException ex4) {
                                this.showStatus("Invalid Color: " + ex4.toString());
                            }
                        }
                        else if (substring.toLowerCase().indexOf("<color=") != -1) {
                            final String substring6 = substring.substring(7, substring.length() - 1);
                            try {
                                this.fgColor = new Color(Integer.valueOf(substring6, 16));
                                this.og.setColor(this.fgColor);
                            }
                            catch (NumberFormatException ex5) {
                                this.showStatus("Invalid Color: " + ex5.toString());
                            }
                        }
                        j = index;
                    }
