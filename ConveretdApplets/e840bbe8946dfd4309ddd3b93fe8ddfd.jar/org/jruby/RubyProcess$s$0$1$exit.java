...
public class RubyProcess$s$0$1$exit extends JavaMethodN
{
    public RubyProcess$s$0$1$exit(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyProcess.exit(recv, array);
    }
}
