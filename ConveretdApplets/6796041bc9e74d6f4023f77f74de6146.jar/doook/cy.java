...
public final class cy extends FilterOutputStream implements DataOutput
{
    private byte[] b;
    private int aL;
    private byte[] c;
    
    public cy(final OutputStream outputStream) {
        super(outputStream);
        this.aL = 0;
        this.c = new byte[8];
    }
    ...
    private int f() {
        return this.aL = (this.aL + 1) % this.b.length;
    }
