...
public final class H extends Canvas implements bf
{
    private Image q;
    private Image w;
    private Image e;
    ...
    public static H q(final Image image, final Image image2, final Image image3) {
        return new H(image, image2, image3, true);
    }
    ...
    private H(final Image q, final Image w, final Image e, final boolean b) {
        this.q = false;
        this.w = true;
        this.e = true;
        this.r = false;
