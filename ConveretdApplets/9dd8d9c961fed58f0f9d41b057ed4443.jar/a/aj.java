...
public final class aj extends V implements aA
{
    public final String q(final Object o) {
        ...
        final by by = (by)super.q.q();
        if (super.q.q()) {
            return s.q(ak.q("Click here to enter %1: %2."), new String[] { by.o, by.q });
        }
        if (by == null) {
            return ak.q("This button is disabled because no room is selected.");
        }
        return s.q(ak.q("This button is disabled because you are already in %1."), new String[] { by.o });
    }
    
    public aj(final cq q) {
        ((bg)(super.q = q)).resize(141, 140);
        ...
        final au au2 = new au(cu.w, "lock");
        final au au3 = new au(q.q("usersIcon.gif", false), "users");
        final au au4 = new au(cu.e, "default");
        au2.w(0);
        au2.e(12);
        au4.w(0);
        au4.e(12);
