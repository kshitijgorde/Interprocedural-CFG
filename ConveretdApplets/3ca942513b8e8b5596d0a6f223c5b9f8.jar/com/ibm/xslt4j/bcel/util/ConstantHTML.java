    ...
    private void writeConstant(final int index) {
        ...
        switch (tag) {
            ...
            case 11: {
                ...
                short_method_class = Utility.compactClassName(short_method_class, String.valueOf(this.class_package) + ".", true);
                ...
                if (method_class.equals(this.class_name)) {
                    ref = "<A HREF=\"" + this.class_name + "_code.html#method" + this.getMethodNumber(String.valueOf(method_name) + signature) + "\" TARGET=Code>" + html_method_name + "</A>";
                }
                else {
                    ref = "<A HREF=\"" + method_class + ".html" + "\" TARGET=_top>" + short_method_class + "</A>." + html_method_name;
                }
                this.constant_ref[index] = String.valueOf(ret_type) + "&nbsp;<A HREF=\"" + this.class_name + "_cp.html#cp" + class_index + "\" TARGET=Constants>" + short_method_class + "</A>.<A HREF=\"" + this.class_name + "_cp.html#cp" + index + "\" TARGET=ConstantPool>" + html_method_name + "</A>&nbsp;" + arg_types;
            ...
            case 9: {
                ...
                short_field_class = Utility.compactClassName(short_field_class, String.valueOf(this.class_package) + ".", true);
            ...
            case 7: {
                ...
                short_class_name = Utility.compactClassName(short_class_name, String.valueOf(this.class_package) + ".", true);
