...
public final class ch
{
    ...
    private static byte[] q(final byte[] array, final int n, final int n2, final byte[] array2, final int n3, int n4) {
        final byte[] array3 = (((n4 = n4) & 0x10) == 0x10) ? ch.e : (((n4 & 0x20) == 0x20) ? ch.t : ch.q);
    ...
    private static byte[] q(byte[] array, final int n, final int n2, final int n3) {
        ...
        if ((n3 & 0x2) != 0x0) {
            ...
            try {
                ...
                ci = new ci(byteArrayOutputStream, 0x1 | n3);
                ((GZIPOutputStream)(deflaterOutputStream = new GZIPOutputStream(ci))).write(array, n, n2);
