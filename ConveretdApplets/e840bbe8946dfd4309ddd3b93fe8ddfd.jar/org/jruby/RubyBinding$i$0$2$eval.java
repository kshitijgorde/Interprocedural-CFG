...
public class RubyBinding$i$0$2$eval extends JavaMethodN
{
    public RubyBinding$i$0$2$eval(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyBinding)rubyObject).eval(context, array);
    }
}
