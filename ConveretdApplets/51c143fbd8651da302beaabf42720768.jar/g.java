...
class g extends Dialog implements ActionListener
{
    ...
    g(final esChat a, final String s) {
        ...
        panel2.add(c);
        panel2.add(c2);
        this.add(new Label(), g.z[1]);
        this.add(panel, g.z[0]);
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "N}Qn\u0012\u007f".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "CwMn\u001f".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "^wJn\u001f".toCharArray();
