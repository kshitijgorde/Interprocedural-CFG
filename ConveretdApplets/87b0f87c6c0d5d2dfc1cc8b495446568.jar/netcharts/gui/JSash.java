...
public class JSash extends JComponent implements NFSashIntf
{
    ...
    public JSash(final Component component, final Component component2) {
        this(2, component, component2, 10, true);
    }
    
    public JSash(final int n, final Component component, final Component component2) {
        this(n, component, component2, 10, true);
    }
    
    public JSash(final int style, final Component left, final Component right, final int n, final boolean enabled) {
        this.mouse_down_x = 0;
        this.mouse_down_y = 0;
    ...
    public boolean mouseExit(final Event event, final int n, final int n2) {
        ...
        try {
            if (!this.mouse_down) {
                this.setCursor(new Cursor(this.a));
            }
        }
        catch (Exception ex) {
            if (this.frame != null && !this.mouse_down) {
