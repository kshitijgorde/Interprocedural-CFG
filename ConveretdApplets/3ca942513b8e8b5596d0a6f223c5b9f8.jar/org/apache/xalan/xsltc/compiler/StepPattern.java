...
class StepPattern extends RelativePathPattern
{
    ...
    private void translateSimpleContext(final ClassGenerator classGen, final MethodGenerator methodGen) {
        ...
        final LocalVariableGen stepIteratorTemp = methodGen.addLocalVariable("step_pattern_tmp2", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), il.getEnd(), null);
