...
public class J4Star extends Applet implements MouseListener, ItemListener, KeyListener, Runnable
{
    Thread JuliaTrace;
    Image imgMan;
    Image imgJulia;
    ...
    public void init() {
        ...
        this.BTracing(this.Rmid, this.Imid, this.stMan, this.wMan, this.wMan, array10, new ManZ4A(this.MaxIt, this.maxColor, this.maxIZI2));
    ...
    public void mouseReleased(final MouseEvent mouseEvent) {
        ...
        if (x > this.wMan) {
            ...
            this.BTracing(this.Xmid, this.Ymid, this.stJulia, this.wJulia, this.wJulia, this.pArr, new JuliaZ4A(this.trCr, this.trCi, this.MaxIt, this.maxColor, this.maxIZI2));
            ...
            this.BTracing(this.Rmid, this.Imid, this.stMan, this.wMan, this.wMan, this.pArr, new ManZ4A(this.MaxIt, this.maxColor, this.maxIZI2));
            if (this.bDrawGrid) {
                int n2;
    ...
    public void Orbits() {
        ...
        for (int i = 0; i < 3 * this.MaxIt; ++i) {
            ...
            final double n4 = rstar * istar;
            final double n5 = 4.0 * n4;
            istar = n3 * n5 + this.trCi;
            rstar = n3 * n3 - n5 * n4 + this.trCr;
            n2 = rstar * rstar;
            n = istar * istar;
            final int n6 = (int)(rstar / this.stJulia) + this.wJulia / 2;
            final int n7 = -(int)(istar / this.stJulia) + this.wJulia / 2;
            try {
                this.pArr[n6 + this.wJulia * (n7 + 1)] = this.ColorWhite;
            }
        ...
        final double n8 = istar;
        final double n9 = rstar;
        for (int j = 1; j < this.MaxIt; ++j) {
            final double n10 = n2 - n;
            final double n11 = rstar * istar;
            final double n12 = 4.0 * n11;
            istar = n10 * n12 + this.trCi;
            rstar = n10 * n10 - n12 * n11 + this.trCr;
            n2 = rstar * rstar;
            n = istar * istar;
            final double n13 = istar - n8;
            final double n14 = rstar - n9;
            if (n13 * n13 + n14 * n14 < this.PeriodPrecision2) {
                this.Rstar = rstar;
                this.Istar = istar;
                this.Nstar = j;
    ...
    public void paint(final Graphics graphics) {
        if (this.animate) {
            this.BTracing(0.0, this.stJulia * this.wJulia / 4.0, this.stJulia, this.wJulia, this.wJulia / 2 + 1, this.pArr, new JuliaZ4A(this.trCr, this.trCi, this.MaxIt, this.maxColor, this.maxIZI2));
        ...
        if (this.Nstar > 1 && this.stJulia * this.wJulia > 0.1) {
            double istar = this.Istar;
            double rstar = this.Rstar;
            double n3 = istar * istar;
            double n4 = rstar * rstar;
            int n5 = (int)((rstar - this.Xmid) / this.stJulia) + this.wJulia / 2 + this.wMan;
            int n6 = -(int)((istar - this.Ymid) / this.stJulia) + this.wJulia / 2 + this.lbSize;
            for (int j = 0; j < this.Nstar; ++j) {
                final double n7 = n4 - n3;
                final double n8 = rstar * istar;
                final double n9 = 4.0 * n8;
                istar = n7 * n9 + this.trCi;
                rstar = n7 * n7 - n9 * n8 + this.trCr;
                n4 = rstar * rstar;
                n3 = istar * istar;
                final int n10 = (int)((rstar - this.Xmid) / this.stJulia) + this.wJulia / 2 + this.wMan;
                final int n11 = -(int)((istar - this.Ymid) / this.stJulia) + this.wJulia / 2 + this.lbSize;
                graphics.drawLine(n5, n6, n10, n11);
                n5 = n10;
                n6 = n11;
            }
        }
    ...
    public void BTracing(final double n, final double n2, final double n3, final int n4, final int n5, final int[] array, final FormulaA formulaA) {
        for (int i = 0; i < n4; ++i) {
        ...
        for (double n7 = n2 + n3 * n5 / 2.0; l < n5; ++l, n7 -= n3, n6 += 2) {
            ...
            for (double n9 = n - n3 * (n4 / 2 - 1); n8 < n4 - 1; ++n8, n9 += n3, ++n6) {
                if (array[n6] == -1) {
                    ...
                    int n14 = 0;
                    final int n15 = n6;
                    final int iterate = formulaA.iterate(n9, n7);
                    array[n15] = iterate;
                    int n16;
                    ...
                    do {
                        for (int n17 = n14 + 3; n17 < n14 + 7; ++n17) {
                            ...
                            if ((n22 = array[n19]) == -1) {
                                final int n23 = n19;
                                final int iterate2 = formulaA.iterate(n20, n21);
                                array[n23] = iterate2;
                                n22 = iterate2;
                            }
                            if (n22 == n16) {
