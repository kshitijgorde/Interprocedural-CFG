...
public abstract class GraphType
{
    ...
    public void paint(final Graphics graphics, final Graph graph) {
        final Dimension size = graph.getSize();
        boolean b = false;
        ...
        if (size.width != this._iOW || size.height != this._iOH || b) {
            this.setBdr(graphics, 0, 0, size.width, size.height, graph);
        ...
        this._iOW = size.width;
        this._iOH = size.height;
        ...
        this.paintBorder(graphics, 0, 0, size.width, size.height, graph);
    ...
    protected void setAxisTitleINF(final Graphics graphics, final Graph graph) {
        this._titleXAxis.setTitle(graphics, graph);
        this._titleYAxis.setTitle(graphics, graph);
    }
    ...
    protected void setTitleINF(final Graphics graphics, final Graph graph) {
        this._titleGraph.setTitle(graphics, graph);
    }
