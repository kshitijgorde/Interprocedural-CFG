...
public class cg extends Panel implements aA, ai
{
    public TextArea q;
    private Canvas q;
    private Canvas w;
    ...
    public cg(final W q) {
        ...
        this.q.setFont(aS.w.w());
        final bb bb = new bb(this.q);
        this.q.setBackground((!bD.e || bD.w == 4) ? aS.w.y : aS.w.y.darker());
        ...
        if (b) {
            ...
            final E e3;
            final E e2 = e3 = new E(25, 25, this.q, aS.w.w);
        ...
        switch (event.id) {
            ...
            case 1001: {
                ...
                if (event.target == this.r) {
                    if (!bE.q) {
                        final bE be;
                        (be = new bE(this.q, this.r, null)).q(this.q.getForeground());
                        be.w();
                    }
                    return true;
                }
    ...
    private void e() {
        if (cs.e && !cm.q) {
            ...
            q.add(cw);
            if (cm.q == null) {
                (cm.q = new Checkbox(ak.q("Close after selection"))).setForeground(aS.w.u);
                cm.q.setState(true);
            }
    ...
    private void r() {
        if (cs.r && !B.q) {
            ...
            final Point point2 = locationOnScreen;
            point2.x += 400;
            (this.q = new B(this.q.q.q(), this, locationOnScreen)).setVisible(true);
        }
    }
