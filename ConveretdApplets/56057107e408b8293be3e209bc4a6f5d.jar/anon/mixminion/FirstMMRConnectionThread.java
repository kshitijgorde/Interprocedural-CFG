...
public class FirstMMRConnectionThread implements Runnable
{
    ...
    public FirstMMRConnectionThread(final String name, final int port, final long timeout, final ImmutableProxyInterface proxyInterface) {
        this.m_thread = null;
    ...
    public TinyTLS getConnection() throws IOException {
        (this.m_thread = new Thread(this, "FirstMMRConnectionThread")).setDaemon(true);
        this.m_thread.start();
