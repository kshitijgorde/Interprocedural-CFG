...
public class ah
{
    ...
    boolean char() throws ar {
        if (Character.isLetter(this.do[this.p]) || this.do[this.p] == '_') {
            ...
            a.a.a.a.g.for(this.d.do, array);
            if (a.a.a.a.g.if(array, ah.D) == 0) {
                this.d.for = 8;
                array[0] = '\0';
            }
            else if (a.a.a.a.g.if(array, ah.z) == 0) {
                this.d.for = 5;
                this.d.if = 1L;
            }
            else if (a.a.a.a.g.if(array, ah.F) == 0) {
                this.d.for = 5;
                this.d.if = 0L;
            }
            else if (a.a.a.a.g.if(array, ah.w) == 0) {
                this.d.for = 2;
                this.d.if = 0L;
            }
            else if (a.a.a.a.g.if(array, ah.G) == 0) {
                this.d.for = 2;
                this.d.if = 1L;
            }
            else if (a.a.a.a.g.if(array, ah.y) == 0) {
                this.d.for = 2;
                this.d.if = 2L;
            }
            else if (a.a.a.a.g.if(array, ah.x) == 0) {
                this.d.for = 2;
                this.d.if = 4L;
            }
            else if (a.a.a.a.g.if(array, ah.b) == 0) {
                this.d.for = 2;
                this.d.if = 5L;
            }
            else if (a.a.a.a.g.if(array, ah.new) == 0) {
                this.d.for = 2;
                this.d.if = 6L;
            }
            else if (a.a.a.a.g.if(array, ah.long) == 0) {
                this.d.for = 2;
                this.d.if = 7L;
            }
            else {
