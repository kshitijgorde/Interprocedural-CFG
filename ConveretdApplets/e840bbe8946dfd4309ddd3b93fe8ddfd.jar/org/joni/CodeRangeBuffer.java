...
public final class CodeRangeBuffer
{
    ...
    public CodeRangeBuffer(final int[] ranges) {
        this.p = ranges;
        this.used = ranges[0] + 1;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.p[0]; ++i) {
            buf.append("[" + rangeNumToString(this.p[i * 2 + 1]) + ".." + rangeNumToString(this.p[i * 2 + 2]) + "]");
            if (i > 0 && i % 6 == 0) {
                buf.append("\n          ");
            }
        }
    ...
    protected static CodeRangeBuffer setAllMultiByteRange(final Encoding enc, final CodeRangeBuffer pbuf) {
        return addCodeRangeToBuff(pbuf, enc.mbcodeStartPosition(), Integer.MAX_VALUE);
    }
    
    public static CodeRangeBuffer addAllMultiByteRange(final Encoding enc, final CodeRangeBuffer pbuf) {
        if (!enc.isSingleByte()) {
    ...
    public static CodeRangeBuffer notCodeRangeBuff(final Encoding enc, final CodeRangeBuffer bbuf) {
    ...
    public static CodeRangeBuffer orCodeRangeBuff(final Encoding enc, CodeRangeBuffer bbuf1, boolean not1, CodeRangeBuffer bbuf2, boolean not2) {
        CodeRangeBuffer pbuf = null;
