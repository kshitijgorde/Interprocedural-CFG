...
public class PrecisionBindingRule implements IBindingRule
{
    ...
    private static final class Listener extends ExpressionListener
    {
        ...
        public void notifyAdd(final IExpression expression, final IContext context, final List<IModelObject> list) {
            ...
            this.xidget.getFeature(ISliderWidgetFeature.class).setPrecision(Xlate.get(this.node, 1));
        }
        ...
        public void notifyChange(final IExpression expression, final IContext context, final String s, final String s2) {
            try {
                this.xidget.getFeature(ISliderWidgetFeature.class).setPrecision(Integer.parseInt(s));
            }
            catch (Exception ex) {}
        }
        ...
        public void notifyChange(final IExpression expression, final IContext context, final double n, final double n2) {
            this.xidget.getFeature(ISliderWidgetFeature.class).setPrecision((int)n);
        }
        ...
        public void notifyValue(final IExpression expression, final IContext[] array, final IModelObject modelObject, final Object o, final Object o2) {
            if (modelObject == this.node) {
                this.xidget.getFeature(ISliderWidgetFeature.class).setPrecision(Xlate.get(modelObject, 1));
            }
        }
