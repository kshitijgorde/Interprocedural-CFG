...
public class bj extends z implements aO, e
{
            ...
            case 1001: {
                ...
                if (event.target == this.p) {
                    ...
                    if (s.length() > 0) {
                        ...
                        this.d(s);
                        this.g.a(s, this.c.ax, this.d.getFont().isBold(), this.d.getFont().isItalic());
                        this.a.l();
                    }
                    if (bs.h) {
                        this.d.requestFocus();
    ...
    public void paint(final Graphics graphics) {
        ...
        if (this.t != null) {
            ...
            this.ao = this.t.getWidth(this);
            this.ap = this.t.getHeight(this);
            this.u = this.createImage(this.r, this.s);
            final Graphics graphics2 = this.u.getGraphics();
            graphics2.drawImage(this.t, 0, 0, null);
            for (int i = 0; i <= this.r / this.ao; ++i) {
                for (int j = 0; j <= this.s / this.ap; ++j) {
                    if (i + j > 0) {
                        graphics2.copyArea(0, 0, this.ao, this.ap, i * this.ao, j * this.ap);
                    }
                }
            }
            graphics2.dispose();
    ...
    private final void d(final String s) {
        ...
        if (this.g.Y != 0 && this.g.Z != 0) {
            final Object[] array = this.h.get(new Integer(this.y - this.g.Y + 1));
            if (array != null && System.currentTimeMillis() - (long)array[0] < this.g.Z * 1000) {
                this.g.o();
            }
        }
        if (this.g.X != 0) {
            int n = 1;
            for (int i = this.y - 1; i > this.y - this.g.X; --i) {
    ...
    public bj(final at at, final ba a) {
        ...
        as.i = at.a("arrowIcon.gif", false, 20);
        at.b.o = at.a(at.b.e() + "helpLogo.gif", true, 80);
        at.b.p = at.a(at.b.e() + "chatLogo.gif", true, 10);
        final GridBagLayout layout = new GridBagLayout();
        final GridBagConstraints gridBagConstraints = new GridBagConstraints();
        final aC ac = new aC(at.b.aq);
        ...
        gridBagConstraints.fill = 2;
        gridBagConstraints.gridwidth = 0;
        final Component a8 = this.a(at.b.aq);
        ...
        dimension.height = bi.as;
        this.resize(dimension.width = bi.at, dimension.height);
        if (a != null) {
            at.a(a);
        }
        this.t = at.b.a();
