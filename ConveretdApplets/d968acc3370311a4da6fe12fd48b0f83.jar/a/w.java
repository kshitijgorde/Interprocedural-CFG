...
public final class w extends Panel implements dT
{
    ...
    private int q(final aF af, final aF af2) {
        int q = 0;
        y y;
        for (int index = this.w.indexOf(this.e), size = this.w.size(), n = 0; n < size && (!(y = this.w.elementAt((n + index) % size)).w() || (q = af.q(af2, y.q())) == 0); ++n) {}
        if (this.t) {
            return q;
        }
        return -q;
    ...
    private synchronized void q(final Vector vector, final int n, final int n2, final y y) {
        if (n2 > n) {
            final int n3 = (n + n2) / 2;
            int n4 = n2;
            int i = n;
            final aF q = vector.elementAt(n3).q;
            while (i <= n4) {
                ...
                if (i < n4) {
                    final A element = vector.elementAt(i);
                    final A element2 = vector.elementAt(n4);
            ...
            if (n < n4) {
                this.q(vector, n, n4, y);
            }
            if (i < n2) {
                this.q(vector, i, n2, y);
            }
        }
        this.q = false;
    }
    ...
    private synchronized y w(final int n) {
        ...
        for (int i = 0; i < size2 - 1; ++i) {
            final y y;
            final int w = (y = this.w.elementAt(i)).w();
            final int q = y.q();
            int n6 = n3 + w;
            if (n4 == 0) {
                n6 += n5;
        ...
        return (y)this.w.elementAt(size2 - 1);
    }
    ...
    public final void q(final aF af) {
        this.q(0L, this.q(af));
    }
    ...
    protected final synchronized void q(final int n, final Graphics graphics) {
        if (graphics != null && this.isShowing()) {
            ...
            else if (this.u && this.q.q((Object)a.q)) {
                graphics.setColor(this.q);
            }
            else if (a.q instanceof bZ && ((bZ)a.q).t() != 0) {
                graphics.setColor(new Color(((bZ)a.q).t()));
            }
            else {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (!y.e()) {
                    if (y.q(graphics, a, a.q.q(y.q()), n3, e, q, this.q, n == this.e)) {
                        n3 += q;
                    }
                }
                else if (y.q(graphics, a, a.q.q(y.q()), width - q - n4, e, q, this.q, n == this.e)) {
                    n4 += q;
                }
    ...
    public final synchronized int q(final aF af) {
        for (int i = 0; i < this.q.size(); ++i) {
            if (((A)this.q.elementAt(i)).q.equals(af)) {
                return i;
            }
        }
        return -1;
    ...
    public final synchronized void w(final aF af) {
        final int q;
        if ((q = this.q(af)) >= 0) {
            this.q(q);
        }
    ...
    public final synchronized aF q(final int n) {
    ...
    private synchronized void w(final aF af, int n) {
        if (this.e != null) {
            int i = 0;
            ...
            Label_0161: {
                if (n2 == -1) {
                    ...
                    int n5;
                    if ((n5 = this.q(af, this.q.elementAt(n2).q)) > 0) {
                        n4 = n2 + 1;
                    }
                    else {
                        while (true) {
                            while (i <= n2) {
                                n3 = i + (n2 - i) / 2;
                                if ((n5 = this.q(af, this.q.elementAt(n3).q)) == 0) {
                                    n4 = n3;
                                    break Label_0161;
                                }
                                if (n5 < 0) {
        ...
        this.q.insertElementAt(new A(this, this, af), n);
        if (this.e >= n) {
            ++this.e;
        }
        final int e = this.e(n);
    ...
    private y q(final Event event) {
        if (event.y < this.r) {
            int n = 0;
            for (int i = 0; i < this.w.size() - 1; ++i) {
                final y y = this.w.elementAt(i);
                final int n2 = n + y.q();
                if (event.x > n2 - 4 && event.x < n2 + 4 && y.q()) {
                    return y;
                }
                if (event.x < n2) {
                    return null;
    ...
    public final void w(final y y) {
        this.q(y, this.w.size());
    }
    
    public final void q(final y y, final int n) {
        this.w.insertElementAt(y, n);
        y.q = this;
    }
    
    public final void e(final aF af) {
        this.w(af, this.q.size());
    }
    
    public final synchronized void q(final aF af, final int n) {
        this.q.setElementAt(new A(this, this, af), n);
        if (this.e != null) {
            this.q(200L);
            return;
        }
    ...
    public final boolean q(final aF af) {
        final int q;
        if ((q = this.q(af)) != -1) {
            this.e(q);
            return true;
    ...
    public final void e(final y y) {
        final int index;
        if ((index = this.w.indexOf(y)) >= 0) {
            final int n = index;
            int n2 = 0;
            for (int i = 0; i < n; ++i) {
                n2 += ((y)this.w.elementAt(i)).q();
            }
            final int n3 = n2;
    ...
    protected static void q(final Graphics graphics, String string, final int n, final int n2, final int n3, final int n4, final int n5, final boolean b, final A a) {
        ...
        int n10 = 0;
        if (a != null) {
            n10 = ((a.q instanceof cz) ? (((cz)a.q).a - 1) : 0);
        }
        if (n10 > 0) {
        ...
        if (a != null && a.q() != null) {
            graphics.drawImage(a.q(), n9 - 2, n6 - 17, null);
        }
        else {
    ...
    private void q(final Graphics graphics, final y y, final boolean b, final boolean b2) {
        final Dimension size = this.size();
        ...
        if (y == this.r) {
            ...
            final int index;
            final int n3 = index = this.w.indexOf(y);
            int n4 = 1;
            for (int i = 0; i < index; ++i) {
                int w = this.w.elementAt(i).w();
                final y y2;
                if (i > 0 && (y2 = this.w.elementAt(i - 1)).w() == 0) {
                    w += y2.q();
                }
                n4 += w;
            }
            ...
            if (n3 == this.w.size() - 1) {
                ...
                q = y.q();
                final y y3;
                if (n3 > 0 && (y3 = this.w.elementAt(n3 - 1)).w() == 0) {
                    q += y3.q();
                }
            }
        }
        this.q(graphics, y, n2, q, this.r, b, b2);
    }
    
    private void q(final Graphics graphics, final y y, final int n, final int n2, final int n3, final boolean b, final boolean b2) {
        final Color color;
    ...
    public final void paint(final Graphics graphics) {
        ...
        if (this.r > 0) {
            ...
            y y;
            int w2;
            for (int n4 = 0; n4 < size2 && n2 < size.width - 1; n2 += w2, q = y.q(), n3 = w2, ++n4) {
                y = this.w.elementAt(n4);
                if (n4 == size2 - 1) {
                ...
                if (w2 != 0) {
                    this.q(graphics, y, n2, w2, this.r, false, y == this.e);
                }
            }
            if (this.y) {
    ...
    public final synchronized boolean w(final aF af) {
        return this.q(this.q(af));
    }
    ...
    public final synchronized void q(final aF af, final boolean b) {
        final int q;
        if ((q = this.q(af)) >= 0) {
            this.q(q, b);
        }
    ...
    public final synchronized void w(final aF af, final boolean b) {
        final int q;
        if ((q = this.q(af)) >= 0) {
            this.w(q, b);
        }
    ...
    public final synchronized void q(final aF af, final Color color, final Color color2) {
        final int q;
        if ((q = this.q(af)) >= 0) {
    ...
    private w(final int n) {
        ...
        this.y = false;
        this.q = false;
        (this.r = new y(null, null)).w(true);
        this.r.q(eb.q("Click here to reverse the sort order of items in this list."), null);
        if (!a.w.e) {
            a.w.e = true;
            try {
                this.setCursor(Cursor.getDefaultCursor());
    ...
    static boolean q(final w w) {
        return w.u;
    }
    
    static Vector w(final w w) {
        return w.q;
    }
    
    static dW q(final w w) {
        return w.q;
    }
