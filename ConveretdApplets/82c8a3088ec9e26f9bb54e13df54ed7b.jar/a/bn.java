...
public final class bn extends Canvas
{
    private final X q;
    private long q;
            ...
            for (int i = this.q.w; i < n; ++i) {
                ...
                if ((graphics2 = this.getGraphics()) != null) {
                    ...
                    if (!(b = (n3 < 0 || n3 >= this.q.q.q))) {
                        Image image = null;
                        if (this.q.q.q(n3) instanceof av) {
                            image = ((av)this.q.q.q(n3)).q;
                        }
                        if (this.q.q.q(n3) instanceof Q) {
                            image = ((Q)this.q.q.q(n3)).q;
                        }
                        if (this.q.q.q(n3) instanceof bt) {
                            image = ((bt)this.q.q.q(n3)).q;
                        }
