    ...
    public void translatePredicates(final ClassGenerator classGen, final MethodGenerator methodGen) {
        ...
        if (this._predicates.size() == 0) {
            ...
            if (predicate.isNodeValueTest()) {
                ...
                this.translatePredicates(classGen, methodGen);
                final LocalVariableGen iteratorTemp = methodGen.addLocalVariable("step_tmp1", Util.getJCRefType("Lorg/apache/xml/dtm/DTMAxisIterator;"), il.getEnd(), null);
                il.append(new ASTORE(iteratorTemp.getIndex()));
                predicate.translate(classGen, methodGen);
                final LocalVariableGen predicateValueTemp = methodGen.addLocalVariable("step_tmp2", Util.getJCRefType("I"), il.getEnd(), null);
                ...
                final LocalVariableGen filterTemp = methodGen.addLocalVariable("step_tmp2", Util.getJCRefType("Lorg/apache/xalan/xsltc/dom/CurrentNodeListFilter;"), il.getEnd(), null);
