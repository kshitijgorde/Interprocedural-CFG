...
public class ManagedTempTopicRegion extends TempTopicRegion
{
    ...
    public ManagedTempTopicRegion(final ManagedRegionBroker regionBroker, final DestinationStatistics destinationStatistics, final SystemUsage memoryManager, final TaskRunnerFactory taskRunnerFactory, final DestinationFactory destinationFactory) {
