...
public class RubyFileTest$s$1$0$writable_p extends JavaMethodOne
{
    public RubyFileTest$s$1$0$writable_p(final RubyModule implementationClass, final Visibility visibility) {
