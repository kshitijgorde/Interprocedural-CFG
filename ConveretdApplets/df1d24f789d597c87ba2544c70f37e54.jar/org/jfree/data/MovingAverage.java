...
public class MovingAverage
{
    public static TimeSeriesCollection createMovingAverage(final TimeSeriesCollection source, final String suffix, final int periodCount, final int skip) {
        ...
        for (int i = 0; i < source.getSeriesCount(); ++i) {
            ...
            final TimeSeries maSeries = createMovingAverage(sourceSeries, sourceSeries.getName() + suffix, periodCount, skip);
    ...
    public static XYSeries createMovingAverage(final XYDataset source, final int series, final String name, final long period, final long skip) {
        return createMovingAverage(source, series, name, period, (double)skip);
    }
