...
public final class ax extends cN implements aA
{
    private Canvas w;
    private Canvas e;
    private Canvas r;
    ...
    public ax(final W w) {
        ...
        gridBagConstraints.insets = new Insets(0, 0, 0, 0);
        gridBagConstraints.gridwidth = 0;
        ax.q.setForeground(aU.w.t);
        if ((aU.w.m.getRGB() & 0xFF) != 0x0) {
            ax.q.setBackground(aU.w.m);
        }
        else {
            ax.q.setBackground(aU.w.r);
        }
    ...
    public final void w() {
        ...
        final Image r = this.q.r(aU.w.e() + "settings_button_up.gif", true);
        final Image r2 = this.q.r(aU.w.e() + "logout_button_up.gif", true);
