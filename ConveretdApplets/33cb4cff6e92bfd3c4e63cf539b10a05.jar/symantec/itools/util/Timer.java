...
public class Timer implements Runnable, Serializable
{
    ...
    public Timer(final int d, final boolean r) {
        ...
        this.execute = false;
        this.live = false;
        if (!(this.isDesignTime = Beans.isDesignTime())) {
    ...
    public synchronized void start(final int d) throws PropertyVetoException {
        this.setDelay(d);
        this.start();
    }
    
    public synchronized void start(final boolean r) throws PropertyVetoException {
        this.setRepeat(r);
        this.start();
    }
    
    public synchronized void start(final int d, final boolean r) throws PropertyVetoException {
        this.setDelay(d);
        this.setRepeat(r);
        this.start();
    }
