...
public class DS_Wobble extends Applet implements Runnable
{
    Thread _fld0;
    int _fld1;
    Font _fld2;
    ...
    void _mth0b() {
        ...
        this._fld3e = ((this._fld3e >= 10) ? ((this._fld3e <= 60) ? this._fld3e : 60) : 10);
        String parameter2 = this.getParameter("frequency");
        if (parameter2 == null) {
            parameter2 = "10";
        }
        this._fld4e = Integer.valueOf(parameter2);
        this._fld4e = ((this._fld4e >= 1) ? ((this._fld4e <= 30) ? this._fld4e : 30) : 1);
        String parameter3 = this.getParameter("pause");
        if (parameter3 == null) {
            parameter3 = "10";
        }
        this._fld7e = Integer.valueOf(parameter3);
        this._fld7e = ((this._fld7e >= 0) ? ((this._fld7e <= 60) ? this._fld7e : 60) : 0);
        ...
        if (parameter5 != null) {
            this._fld0f = parameter5;
            final String parameter6 = this.getParameter("reglink");
            if (parameter6 != null) {
                try {
                    this._fld1f = new URL("http://" + parameter6);
                }
                catch (MalformedURLException ex) {
                    this._fld1f = null;
                }
                ...
                if (parameter7 != null) {
                    this._fld2f = parameter7;
                }
            }
            final String parameter8 = this.getParameter("regstatusmsg");
            if (parameter8 != null) {
                this._fld3f = parameter8;
            }
        }
    }
    
    void _mth1b() {
        this._fld1e = new int[this._fld3 * this._fld4];
        this._fld2e = new int[this._fld4];
        this._fld5e = 0;
        for (int i = 0; i < this._fld4; ++i) {
            for (int j = 0; j < this._fld3; ++j) {
                this._fld1e[i * this._fld3 + j] = (int)Math.sqrt(j * j + i * i);
            }
        }
        this._fld8e = (this._fld7e << 1) + (this._fld3e << 1);
        this._fld9e = this._fld8e >> 1;
        this._fld6e = new int[this._fld8e];
        for (int k = 0; k < this._fld7e; ++k) {
            this._fld6e[k] = 0;
        }
        for (int l = this._fld7e; l < this._fld3e + this._fld7e; ++l) {
            this._fld6e[l] = l - this._fld7e;
        }
        for (int n = 0; n < this._fld3e; ++n) {
            this._fld6e[this._fld7e + this._fld3e + n] = this._fld3e - n;
        }
        for (int n2 = 0; n2 < this._fld7e; ++n2) {
            this._fld6e[this._fld7e + this._fld3e + this._fld3e + n2] = 0;
        }
    }
    
    void _mth2b() {
        if (this._fld5e > 0) {
            if (this._fld5e < this._fld9e) {
                --this._fld5e;
                return;
            }
            ++this._fld5e;
    ...
    void _mth3b() {
        ...
        final int n = this._fld6e[this._fld5e];
        for (int i = 0; i < this._fld4; ++i) {
            this._fld2e[i] = (int)(n * Math.sin(this._fld4e * (i - this._fld5e) * 3.141592653589793 / 180.0));
        }
        this._mth4b();
    ...
    void _mth4b() {
        int n = 0;
        for (int i = 0; i < this._fld4; ++i) {
            final int n2 = this._fld2e[i] + this._fld3;
            for (int j = 0; j < this._fld3; ++j) {
                this._fld6[n++] = this._fld5[i * this._fld3 + (j + n2) % this._fld3];
            }
        }
    }
    ...
    void _mth6b() {
        ...
        if (--fld8c > 0) {
            ...
            for (int i = 0; i < this._fld8c; ++i) {
                ...
                this._fld9f[i] = this._mth9("overtextcol" + String.valueOf(i + 1), new Color(16777215));
                this._fld0g[i] = this._mth9("overtextcols" + String.valueOf(i + 1), new Color(0));
