...
public class e
{
    ...
    public static void _(final double[] array, double[] array2, final int n, int n2) {
        double n3 = 0.0;
        boolean b = false;
        if (n2 < 1) {
            n2 = 1;
    ...
    public static void a(final double[] array, final int n, final double n2) {
    ...
    public static Vector b(final double[] array, final double n, final int n2) {
    ...
    public static Vector b(final double[] array, final double[] array2, final int n) {
        if (array == null || array2 == null || array.length == 0 || array2.length == 0 || array.length != array2.length || n >= array.length) {
            return new Vector();
        }
        final Vector<Integer> vector = new Vector<Integer>(Math.max(20, array.length / 10));
