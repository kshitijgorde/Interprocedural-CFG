...
public class ptzoom extends Applet implements Runnable
{
    ...
    boolean SetView(final int[][] array, final byte[][] array2, final boolean b) {
        ...
        if (b) {
                    ...
                    if (this.pv.vdata[n28] == 0) {
                        ...
                        if ((n32 = n29 + n27 * n9 >> 8) <= 0) {
                            ...
                            if ((n38 = n34 >> 8) == n22 && n36 >= 0 && n36 < n21) {
                                final int n39;
                                if (((n39 = array5[n36]) & 0xFF000000) != 0x0) {
                                    this.pv.hs_vdata[n28] = array7[n36];
                                    this.pv.vdata[n28] = ptviewer.bil(n39, array5[n36], array6[n36++], array6[n36], n35, n37);
                                }
                                else {
                                    b2 = false;
                                }
                                ...
                                array6 = array[n38];
                                final int n40;
                                if (((n40 = array5[n36]) & 0xFF000000) != 0x0) {
                                    this.pv.hs_vdata[n28] = array7[n36];
                                    this.pv.vdata[n28] = ptviewer.bil(n40, array5[n36], array6[n36++], array6[n36], n35, n37);
                                }
                                else {
                                    b2 = false;
                                }
                                ...
                                final int n41;
                                if (n36 >= 0 && n36 < length && n38 >= 0 && n38 < length2 && ((n41 = array[n38][n36]) & 0xFF000000) != 0x0) {
                                    this.pv.vdata[n28] = n41;
            ...
            final int n42 = n18 + 128;
            final int n43 = n19 + 128;
            for (int n44 = 0, n45 = -n17 * n12 + n15 + 128, n46 = -n17 * n10 + n13, n47 = -n17 * n11 + n14; n44 < this.pv.vheight; ++n44, n45 += n12, n46 += n10, n47 += n11) {
                final int n48 = this.pv.vwidth * n44;
                int n49 = 0;
                int n50 = n48;
                final int n51 = -n16 * n9 + n45;
                final int n52 = -n16 * n7 + n46;
                final int n53 = -n16 * n8 + n47;
                while (n49 < this.pv.vwidth) {
                    if (this.pv.vdata[n50] == 0) {
                        final int n54;
                        if ((n54 = n51 + n49 * n9 >> 8) <= 0) {
                            b2 = false;
                        }
                        else {
                            int n55 = (n52 + n49 * n7) / n54 + n42 >> 8;
                            int n56 = (n53 + n49 * n8) / n54 + n43 >> 8;
                            final int n57;
                            if (n55 >= 0 && n55 < length && n56 >= 0 && n56 < length2 && ((n57 = array[n56][n55]) & 0xFF000000) != 0x0) {
                                this.pv.vdata[n50] = n57;
                            }
                            else {
                                if (n55 == -1) {
                                    n55 = 0;
                                ...
                                final int n58;
                                if (n55 >= 0 && n55 < length && n56 >= 0 && n56 < length2 && ((n58 = array[n56][n55]) & 0xFF000000) != 0x0) {
                                    this.pv.vdata[n50] = n58;
                                }
                                else {
                                    b2 = false;
                                }
