...
public abstract class a extends Applet implements c
{
    ...
    public void CenterZoomIn() {
        final a.a.a.a.b.a a = (a.a.a.a.b.a)this.z.byte("command/action/zoomin");
        if (a != null) {
            a.a();
        }
    }
    ...
    public void CenterZoomOut() {
        final a.a.a.a.b.a a = (a.a.a.a.b.a)this.z.byte("command/action/zoomout");
        if (a != null) {
            a.a();
        }
    }
    ...
    public void Reset() {
        final a.a.a.a.b.a a = (a.a.a.a.b.a)this.z.byte("command/action/reset");
        if (a != null) {
            a.a();
        }
    }
    ...
    public void ShowInfo() {
        final a.a.a.a.b.a a = (a.a.a.a.b.a)this.z.byte("command/action/info");
        if (a != null) {
            a.a();
        }
    }
    ...
    protected void else() {
        ...
        this.add(this.B = this.goto());
        this.z.a("player", this.B);
    }
    
    private void null() {
        this.D = (Image)this.z.byte(new StringBuffer("images/button/fill").toString());
        ...
        this.C = new f(this.z, "toolbar", this.z.case("resource/button.toolbar.width"), this.z.case("resource/button.height"), 0, 0, (a.a.a.a.b.a)this.z.byte("command/state/toolbar"));
        if (this.n) {
            this.B.add(this.C);
        }
        else {
        ...
        this.w = 0;
        this.F = new d();
        boolean booleanValue = (boolean)this.z.byte("param/rotationcontrol");
        if (this.long().equals("d3") || this.long().equals("pano")) {
            if ((float)this.z.byte("param/" + this.long() + ".autospin") == 0.0) {
                booleanValue = false;
            }
        }
        else {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (!trim.equals("separator")) {
                ...
                a.a.a.a.b.a a;
                if (b) {
                    a = (a.a.a.a.b.a)this.z.byte("command/action/" + trim2);
                }
                else {
                    a = (a.a.a.a.b.a)this.z.byte("command/state/" + trim2);
                }
                final f f = new f(this.z, trim2, this.z.case("resource/button.width"), this.z.case("resource/button.height"), b ? 1 : 0, n, a);
                this.F.a(f);
                if (this.n) {
                    this.B.add(f);
                }
        ...
        if (this.n) {
            Point point = (Point)this.z.byte("param/logopos");
            if (point == null) {
                point = new Point(0, size.height - this.m);
            }
            this.C.setBounds(point.x, point.y, this.v, this.m);
            Rectangle rectangle = (Rectangle)this.z.byte("param/toolbarbounds");
            if (rectangle == null) {
    ...
    protected abstract String long();
    ...
    public void a(final String s) {
        final a.a.a.a.b.a a = (a.a.a.a.b.a)this.z.byte("command/action/" + s);
        if (a != null) {
            a.a();
        }
    }
    ...
    public void pressStateButton(final String s) {
        final a.a.a.a.b.a a = (a.a.a.a.b.a)this.z.byte("command/state/" + s);
        if (a != null) {
            a.a();
        }
    }
    ...
    private void case() {
        ...
        this.setBackground((Color)this.z.byte("param/backgroundColor"));
        final String char1 = this.char();
        if (char1 != null) {
            this.q = String.valueOf(char1) + "." + this.long();
        }
        else {
            this.q = this.long();
        }
        ...
        if (parameter == null) {
            if (this.z.byte("param/logopos") != null || this.z.byte("param/toolbarbounds") != null) {
                this.n = true;
            }
        }
        ...
        this.v = this.z.case("resource/button.toolbar.width");
        this.A = this.z.case("resource/button.width");
        this.m = this.z.case("resource/button.height");
        if (this.n) {
        ...
        (this.r = (a.a.a.a.c.a.a)this.z.byte("statemachine")).if(this);
