...
class Parser
{
    ...
    static String name_FontSubstitutions;
    static String name_ScriptSizeMultipliers;
    static String name_ScriptMinSize;
    static String name_ScriptBaselineShifts;
    static String name_HoldForm;
    static String name_SequenceForm;
    static String name_StringForm;
    static String name_Subscript;
    static String name_Superscript;
    static String name_Subsuperscript;
    static String name_Underscript;
    static String name_Overscript;
    static String name_Underoverscript;
    static String name_UnderBar;
    static String name_OverBar;
    static String name_OverVector;
    static String name_OverDot;
    static String name_OverTilde;
    static String name_OverHat;
        ...
        for (int frame_index = 0; frame_index < scanned_frames.size(); ++frame_index) {
            ...
            if (this.is_scanned_AxesLabel && null != this.graphics.option_AxesLabel) {
                ...
                for (int index = 0; index < 3; ++index) {
                    if (null != this.graphics.option_AxesLabel[index]) {
                        frame.option_AxesLabel[index] = new Primitive3D(this.graphics.option_AxesLabel[index]);
                    }
                    else {
                        frame.option_AxesLabel[index] = null;
                    }
                }
            }
    ...
    public boolean scan_text(final Primitive3D primitive, final boolean salt_follows) {
        ...
        if (22 == this.scanned_token_type) {
            ...
            final String first_identifier = this.scanned_identifier;
    ...
    TextElement scan_text_element(final TextElement parent, final Primitive3D primitive) {
        final TextElement text_element = new TextElement();
        if (null == parent) {
        ...
        if (this.scanned_identifier.equals(Parser.name_StyleForm)) {
            ...
            (text_element.children = new Vector()).addElement(child);
            this.scan_token();
            if (4 == this.scanned_token_type) {
                return text_element;
            }
        ...
        else if (this.scanned_identifier.equals(Parser.name_HoldForm)) {
            TextElement child = null;
        ...
        else if (this.scanned_identifier.equals(Parser.name_SequenceForm)) {
            TextElement child = null;
        ...
        else if (this.scanned_identifier.equals(Parser.name_StringForm)) {
            TextElement child = null;
            ...
            int child_index = 0;
            final StringBuffer current_string = new StringBuffer();
            int argument_index = 0;
            int next_argument_index = 1;
            do {
                argument_index = 0;
                final char control_char = control_string.charAt(control_char_index);
                if (control_char == '`') {
                    argument_index = -1;
                    ++control_char_index;
                    if (control_char_index >= control_string.length()) {
                        break;
                    }
                    if (control_string.charAt(control_char_index) == '.') {
                        current_string.append('`');
                        for (++control_char_index; control_char_index < control_string.length() && control_string.charAt(control_char_index) != '`'; ++control_char_index) {}
                        if (control_char_index >= control_string.length()) {
                            break;
                        }
                        ++control_char_index;
                        ...
                        argument_index = 0;
                        while (control_char_index < control_string.length() && 0 <= Parser.digit_characters.indexOf(control_string.charAt(control_char_index))) {
                            argument_index = 10 * argument_index + Parser.digit_characters.indexOf(control_string.charAt(control_char_index));
                            ++control_char_index;
                        }
                        if (control_char_index >= control_string.length()) {
                            break;
                    ...
                    if (current_string.length() > 0) {
                        final TextElement new_child = new TextElement();
                    ...
                    final TextElement placeholder = new TextElement();
            ...
            while (0 == this.scanned_token_type) {
                ...
                for (other_child_index = 0; other_child_index < text_element.children.size(); ++other_child_index) {
                    final TextElement placeholder2 = text_element.children.elementAt(other_child_index);
                    if (null != placeholder2 && -2 == placeholder2.node_type && argument_index2 == placeholder2.variable_index) {
                        break;
                    }
                }
        ...
        else if (this.scanned_identifier.equals(Parser.name_Subscript) || this.scanned_identifier.equals(Parser.name_Superscript) || this.scanned_identifier.equals(Parser.name_Underscript) || this.scanned_identifier.equals(Parser.name_Overscript)) {
            TextElement child = null;
            if (this.scanned_identifier.equals(Parser.name_Subscript)) {
                text_element.node_type = 4;
            }
            else if (this.scanned_identifier.equals(Parser.name_Superscript)) {
                text_element.node_type = 5;
            }
            if (this.scanned_identifier.equals(Parser.name_Underscript)) {
                text_element.node_type = 8;
            }
            if (this.scanned_identifier.equals(Parser.name_Overscript)) {
        ...
        else if (this.scanned_identifier.equals(Parser.name_UnderBar)) {
            TextElement child = null;
            text_element.node_type = 8;
            this.scan_token();
            if (3 != this.scanned_token_type) {
            ...
            child.node_type = 0;
            child.text = Parser.named_character_Dash;
            text_element.script_baseline_shift3 = -201.0;
            text_element.children.addElement(child);
            return text_element;
        }
        else if (this.scanned_identifier.equals(Parser.name_OverBar) || this.scanned_identifier.equals(Parser.name_OverVector) || this.scanned_identifier.equals(Parser.name_OverHat) || this.scanned_identifier.equals(Parser.name_OverDot) || this.scanned_identifier.equals(Parser.name_OverTilde)) {
            TextElement child = null;
            String overscript;
            if (this.scanned_identifier.equals(Parser.name_OverBar)) {
                overscript = Parser.named_character_Dash;
            }
            else if (this.scanned_identifier.equals(Parser.name_OverVector)) {
                overscript = Parser.named_character_RightArrow;
            }
            else if (this.scanned_identifier.equals(Parser.name_OverDot)) {
                overscript = Parser.named_character_CenterDot;
            }
            else if (this.scanned_identifier.equals(Parser.name_OverTilde)) {
                overscript = Parser.named_character_RawTilde;
            }
            else if (this.scanned_identifier.equals(Parser.name_OverHat)) {
                overscript = Parser.named_character_RawWedge;
            }
            else {
                overscript = Parser.name_Questionmark;
            }
            text_element.node_type = 7;
            this.scan_token();
            if (3 != this.scanned_token_type) {
            ...
            if (!this.scanned_identifier.equals(Parser.name_Subsuperscript) && !this.scanned_identifier.equals(Parser.name_Underoverscript)) {
                text_element.node_type = 0;
            ...
            TextElement child = null;
            if (this.scanned_identifier.equals(Parser.name_Subsuperscript)) {
                text_element.node_type = 6;
            }
            else if (this.scanned_identifier.equals(Parser.name_Underoverscript)) {
    ...
    boolean scan_font_options() {
        ...
        while (21 == this.scanned_token_type) {
            ...
            else if (this.scanned_identifier.equals(Parser.name_FontSubstitutions)) {
                this.scan_token();
                if (20 != this.scanned_token_type) {
                    return false;
                }
            ...
            else if (this.scanned_identifier.equals(Parser.name_ScriptSizeMultipliers)) {
                this.scan_token();
                if (20 != this.scanned_token_type) {
                    return false;
                }
            ...
            else if (this.scanned_identifier.equals(Parser.name_ScriptMinSize)) {
                this.scan_token();
                if (20 != this.scanned_token_type) {
                    return false;
                }
            ...
            else if (this.scanned_identifier.equals(Parser.name_ScriptBaselineShifts)) {
                this.scan_token();
                if (20 != this.scanned_token_type) {
                    return false;
                }
    ...
    static {
        ...
        Parser.name_URL = "URL";
        Parser.name_FontSubstitutions = "FontSubstitutions";
        Parser.name_ScriptSizeMultipliers = "ScriptSizeMultipliers";
        Parser.name_ScriptMinSize = "ScriptMinSize";
        Parser.name_ScriptBaselineShifts = "ScriptBaselineShifts";
        Parser.name_HoldForm = "HoldForm";
        Parser.name_SequenceForm = "SequenceForm";
        Parser.name_StringForm = "StringForm";
        Parser.name_Subscript = "Subscript";
        Parser.name_Superscript = "Superscript";
        Parser.name_Subsuperscript = "Subsuperscript";
        Parser.name_Underscript = "Underscript";
        Parser.name_Overscript = "Overscript";
        Parser.name_Underoverscript = "Underoverscript";
        Parser.name_UnderBar = "UnderBar";
        Parser.name_OverBar = "OverBar";
        Parser.name_OverVector = "OverVector";
        Parser.name_OverDot = "OverDot";
        Parser.name_OverTilde = "OverTilde";
        Parser.name_OverHat = "OverHat";
        Parser.named_character_Dash = "\u2013";
        Parser.named_character_RightArrow = "\u2192";
        Parser.named_character_CenterDot = "·";
        Parser.named_character_RawTilde = "~";
        Parser.named_character_RawWedge = "^";
