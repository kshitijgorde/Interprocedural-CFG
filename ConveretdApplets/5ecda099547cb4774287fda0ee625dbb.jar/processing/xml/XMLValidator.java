...
public class XMLValidator
{
    ...
    protected void processAttList(final StdXMLReader stdXMLReader, final XMLEntityResolver xmlEntityResolver) throws Exception {
        ...
        while (c2 != '>') {
            ...
            ((Hashtable<String, String>)properties).put(scanIdentifier2, XMLUtil.scanString(stdXMLReader, '%', this.parameterEntityResolver));
            XMLUtil.skipWhitespace(stdXMLReader, null);
            String s7;
    ...
    public void elementStarted(final String s, final String s2, final int n) {
        final Properties properties = this.attributeDefaultValues.get(s);
        ...
        this.currentElements.push(properties2);
    }
    ...
    public void elementAttributesProcessed(final String s, final Properties properties, final String s2, final int n) {
        ...
        final Enumeration<String> keys = ((Hashtable<String, Object>)properties2).keys();
        while (keys.hasMoreElements()) {
            final String s3 = keys.nextElement();
            ((Hashtable<String, Object>)properties).put(s3, ((Hashtable<String, Object>)properties2).get(s3));
        }
    }
