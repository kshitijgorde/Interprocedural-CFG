...
public final class ai extends Panel implements Runnable
{
    cw q;
    private Color q;
    private Color w;
    ...
    public ai(final bI bi, final cw q, final boolean e, final dq q2) {
        this.q = q2;
        this.e = true;
        this.q = false;
        this.r = true;
        ...
        this.q = new Vector(bi.q.size());
        this.e = 0;
        for (int i = 0; i < bi.q.size(); ++i) {
            final Object q3;
            if ((q3 = bi.q()) instanceof at) {
                final at at = (at)q3;
                final dq q4 = new dq(at, q, this);
                at.q = q4;
    ...
    private void q(final boolean b) {
        ...
        for (int i = 0; i < this.q.size(); ++i) {
            final Panel panel;
            if ((panel = this.q.elementAt(i)) instanceof dq) {
                if (b) {
                    panel.setBounds(2, 2 + n * e + n2 * 3, this.e, e);
                }
                ++n;
            }
            else if (panel instanceof U) {
