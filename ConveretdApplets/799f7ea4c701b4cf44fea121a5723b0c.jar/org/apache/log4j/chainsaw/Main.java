...
public class Main extends JFrame
{
    ...
    static {
        LOG = Logger.getLogger((Main.class$org$apache$log4j$chainsaw$Main == null) ? (Main.class$org$apache$log4j$chainsaw$Main = class$("org.apache.log4j.chainsaw.Main")) : Main.class$org$apache$log4j$chainsaw$Main);
    }
}
