...
public final class ca extends aH implements aB, Runnable
{
    private Thread q;
    ...
    public final String q(final Object o) {
        final int e = this.e;
        final u u;
        if ((u = ((e >= 0 && e < this.q.q) ? ((u)this.q.q(e)) : null)) != null) {
            return t.q(al.q("Click here to visit %1 (%2)."), new String[] { u.o, u.w });
        }
        return null;
    }
        ...
        while (!this.q) {
            ...
            try {
                if (this.r > 24) {
                    ...
                    if (this.r == 0) {
                        this.q.waitForID(((u)this.q.q(this.e)).a);
                    }
                    Thread.sleep(20L);
    ...
    public final synchronized void q(final u u) {
        if (u.q == null) {
            return;
        }
        if (this.q.q == 0) {
        ...
        this.q.q(u);
        this.q.addImage(u.q, u.a);
        this.q(u.q.getWidth(this), u.q.getHeight(this));
    }
