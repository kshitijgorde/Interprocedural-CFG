...
public class RubyKernel$s$0$1$sleep extends JavaMethodN
{
    public RubyKernel$s$0$1$sleep(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyKernel.sleep(context, recv, array);
    }
}
