...
public class RubyEtc$s$0$1$getgrgid extends JavaMethodN
{
    public RubyEtc$s$0$1$getgrgid(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyEtc.getgrgid(recv, array);
    }
}
