...
public class IMAPProtocol extends Protocol
{
    ...
    protected void parseCapabilities(final Response r) {
        ...
        while ((s = r.readAtom(']')) != null) {
            if (s.length() == 0) {
                ...
                this.out.println("DEBUG IMAP: AUTH: " + s.substring(5));
            }
        }
    }
    ...
    public synchronized void authntlm(final String authzid, final String u, final String p) throws ProtocolException {
        ...
        final Ntlm ntlm = new Ntlm(domain, this.getLocalHost(), u, p, this.debug ? this.out : null);
        try {
    ...
    public void startTLS() throws ProtocolException {
        try {
            ...
            if (this.debug) {
                this.out.println("DEBUG IMAP: STARTTLS ProtocolException: " + pex);
            }
            throw pex;
        }
        catch (Exception ex) {
            if (this.debug) {
                this.out.println("DEBUG IMAP: STARTTLS Exception: " + ex);
            }
