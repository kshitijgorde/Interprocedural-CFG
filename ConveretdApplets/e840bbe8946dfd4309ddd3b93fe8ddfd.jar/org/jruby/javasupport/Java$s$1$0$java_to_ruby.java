...
public class Java$s$1$0$java_to_ruby extends JavaMethodOneBlock
{
    public Java$s$1$0$java_to_ruby(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String name, final IRubyObject object, final Block block) {
        ...
        try {
            final IRubyObject java_to_ruby = Java.java_to_ruby(rubyObject, object, block);
