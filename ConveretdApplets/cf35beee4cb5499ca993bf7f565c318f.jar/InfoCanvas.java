...
public class InfoCanvas extends Canvas
{
    ...
    public void paint(final Graphics graphics) {
        try {
            ...
            this.gicIm.drawImage(this.sg1.getGradient("Level " + this.fi2f.lvl.getLevel(), new Font("Arial", 1, 18), this.bgcolor, Color.yellow, "green", 15), 5, 0, this);
            this.gicIm.drawImage(this.sg2.getGradient("Score: " + this.fi2f.getScore(), new Font("Arial", 1, 18), this.bgcolor, Color.yellow, "green", 15), 5, 25, this);
            for (int i = 0; i < 5; ++i) {
