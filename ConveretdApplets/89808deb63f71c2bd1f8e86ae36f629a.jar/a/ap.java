...
public final class ap extends W
{
    ...
    public final void q(final String s, final String s2, final cm cm, final int n) {
        if ("".equals("")) {
            this.q.getDocumentBase().getHost();
        }
        final URL codeBase = this.q.getCodeBase();
        System.out.println("Client.login()");
        this.q(s, s2, cm, codeBase, n, null);
    }
    
    protected final void w(final cr cr) {
        if (this.d != null) {
            try {
                synchronized (super.y) {
                    for (int i = 0; i < super.y.q; ++i) {
                        final by by;
                        if ((by = (by)super.y.q(i)).o.equals(this.d)) {
                            super.k = by.s;
                            break;
                        }
                    }
    ...
    public final void q(final URL url, final String s) {
        ...
        if (bF.w && bF.w == 1 && bF.e < 65792 && url.getProtocol().equalsIgnoreCase("http")) {
            appletContext.showDocument(url, s);
        }
    }
    
    public final boolean q(final cl cl) {
        return false;
    }
