...
public final class cg
{
    ...
    public static String q(final A a, String substring, int i) {
    ...
    private static int q(final A a, final String s) {
        for (int i = 0; i < a.q; ++i) {
            final aO ao = (aO)a.q(i);
            final String string = " " + ao.r().trim();
            if ((" " + s).equalsIgnoreCase(" " + ao.o)) {
