...
class ExternalFactory
{
    ...
    void createCOMInterfaces() {
        this.supports = new XPCOMObject(new int[] { 2, 0, 0 }) {
            public int method0(final int[] array) {
                return ExternalFactory.this.QueryInterface(array[0], array[1]);
            }
            
            public int method1(final int[] array) {
                return ExternalFactory.this.AddRef();
            }
            
            public int method2(final int[] array) {
                return ExternalFactory.this.Release();
            }
        };
        this.factory = new XPCOMObject(new int[] { 2, 0, 0, 3, 1 }) {
            ...
            public int method3(final int[] array) {
                return ExternalFactory.this.CreateInstance(array[0], array[1], array[2]);
            }
            
            public int method4(final int[] array) {
                return ExternalFactory.this.LockFactory(array[0]);
            }
        };
    }
    ...
    int CreateInstance(final int n, final int n2, final int n3) {
        ...
        external.AddRef();
        C.memmove(n3, new int[] { external.getAddress() }, C.PTR_SIZEOF);
        return 0;
    }
