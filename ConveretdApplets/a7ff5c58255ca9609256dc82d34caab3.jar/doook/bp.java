...
public class bp extends Panel implements MouseListener, WindowListener
{
    ...
    public void resize(final int ar, final int p2) {
        super.resize(ar, p2);
        this.ar = ar;
        this.p = p2;
    }
        ...
        try {
            if (at != null) {
                ...
                for (int i = 0; i < at.b(); ++i) {
                    if (this.ay == -1 || ((aS)at.a(i)).a(this.ay)) {
                        ++n;
                    }
                }
                if (n == 0) {
                ...
                try {
                    ...
                    int n2 = 0;
                    while (j < at.b()) {
                        if (this.ay == -1 || ((aS)at.a(j)).a(this.ay)) {
    ...
    public Dimension minimumSize() {
        return new Dimension(this.ar, this.p);
    }
