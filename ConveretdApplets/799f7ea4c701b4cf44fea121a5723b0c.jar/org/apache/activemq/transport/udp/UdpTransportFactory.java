...
public class UdpTransportFactory extends TransportFactory
{
    ...
    public TransportServer doBind(final URI location) throws IOException {
        try {
            ...
            final UdpTransport transport = (UdpTransport)this.createTransport(location, wf);
    ...
    public Transport compositeConfigure(Transport transport, final WireFormat format, final Map options) {
        ...
        if (udpTransport.isTrace()) {
            try {
                ...
                UdpTransportFactory.log.error("Could not create TransportLogger object for: " + TransportLoggerFactory.defaultLogWriterName + ", reason: " + e, e);
            }
        }
