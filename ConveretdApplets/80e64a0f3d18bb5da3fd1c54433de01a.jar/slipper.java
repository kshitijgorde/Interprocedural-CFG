...
public class slipper extends Applet implements Runnable
{
    Thread T;
    boolean pf;
    boolean pfK;
    ...
    public void init() {
        ...
        final String parameter5 = this.getParameter("HorizontalMode");
        if (parameter5 != null) {
            this.h_Mode = Integer.parseInt(parameter5);
        }
    ...
    public void run() {
        ...
        while (true) {
            if (this.waiting == 1) {
                ...
                ++this.offset;
                if (this.offset == this.i_Array[this.i_count].getHeight(this)) {
                    if (this.i_total > 1) {
                        ++this.i_count;
                ...
                if (this.m_Good) {
                    ...
                    while (b) {
                        if (this.theDirection == 0) {
                            b = false;
                            if (aHigh - this.offset < this.aHigh) {
                                b = true;
                            }
                            if (this.m_y < aHigh - this.offset + this.i_Array[i_count].getHeight(this)) {
                                break;
                            }
                        }
                        if (this.theDirection == 1) {
                            b = false;
                            if (aHigh + this.offset > 0) {
                                b = true;
                            }
                            if (this.m_y > aHigh + this.offset - this.i_Array[i_count].getHeight(this)) {
                                break;
                        ...
                        if (this.theDirection == 0) {
                            aHigh += this.i_Array[i_count].getHeight(this);
                        }
                        if (this.theDirection == 1) {
                            aHigh -= this.i_Array[i_count].getHeight(this);
                        }
    ...
    public void paint(final Graphics graphics) {
        if (this.FreeVersion && !this.fromDisk && this.FirstPass) {
            ...
            graphics.drawString("Slipper Slideshow Applet", 5, 14);
        ...
        if (this.pf || !this.pf) {
            ...
            if (this.waiting == 0) {
                ...
                while (b) {
                    ...
                    if (this.h_Mode == 1) {
                        n = (this.aWide - this.i_Array[i_count].getWidth(this)) / 2;
                    }
                    if (this.h_Mode == 2) {
                        n = this.aWide - this.i_Array[i_count].getWidth(this);
                    }
                    if (this.theDirection == 1) {
                        aHigh -= this.i_Array[i_count].getHeight(this);
                    }
                    if (this.theDirection == 0) {
                        graphics.drawImage(this.i_Array[i_count], n, aHigh - this.offset, null);
                    }
                    if (this.theDirection == 1) {
                        graphics.drawImage(this.i_Array[i_count], n, aHigh + this.offset, null);
                    }
                    ...
                    for (int i = 0; i <= this.f_Thick; ++i) {
                        if (this.theDirection == 0) {
                            graphics.drawRect(n2, n3 - this.offset, width - 1, height - 1);
                        }
                        if (this.theDirection == 1) {
                            graphics.drawRect(n2, n3 + this.offset, width - 1, height - 1);
                        }
    ...
    private void DoK() {
        ...
        this.pfN = false;
        this.pfK = false;
        final int int1 = Integer.parseInt("265724".substring(0, 1));
        final int int2 = Integer.parseInt("265724".substring(1, 2));
        final int int3 = Integer.parseInt("265724".substring(2, 3));
        final int int4 = Integer.parseInt("265724".substring(3, 4));
        final int int5 = Integer.parseInt("265724".substring(4, 5));
        final int int6 = Integer.parseInt("265724".substring(5, 6));
