...
public class W32FileMonitor extends FileMonitor
{
    ...
    private void handleChanges(final FileInfo finfo) throws IOException {
        ...
        do {
            ...
            switch (fni.Action) {
                ...
                case 3: {
                    event = new FileEvent(this, file, 4);
                    break;
                }
                case 1: {
                    event = new FileEvent(this, file, 1);
                    break;
                }
                case 2: {
                    event = new FileEvent(this, file, 2);
                    break;
                }
                case 4: {
                    event = new FileEvent(this, file, 16);
                    break;
                }
                case 5: {
                    event = new FileEvent(this, file, 32);
                    break;
                }
                default: {
    ...
    private FileInfo waitForChange() {
        ...
        final WinNT.HANDLEByReference rkey = new WinNT.HANDLEByReference();
