...
public class RubyBigDecimal$i$0$1$ceil extends JavaMethodN
{
    public RubyBigDecimal$i$0$1$ceil(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyBigDecimal)rubyObject).ceil(array);
    }
}
