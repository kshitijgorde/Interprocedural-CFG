...
{
    private static final char[] initialNameCharRanges;
    private static final char[] nameCharRanges;
    private static final int E_InitialNameCharFlag = 1;
    private static final int E_NameCharFlag = 2;
    private static byte[] fgCharFlags;
    
    public static boolean validChar(final int n) {
        if (n < 55296) {
            return n >= 32 || n == 10 || n == 9 || n == 13;
        }
        return (n >= 57344 && n <= 65533) || (n >= 65536 && n <= 1114111);
    }
    
    public static boolean initialNameChar(final int n) {
        return n < 65536 && (XMLCharacterProperties.fgCharFlags[n] & 0x1) != 0x0;
    }
    
    public static boolean nameChar(final int n) {
        return n < 65536 && (XMLCharacterProperties.fgCharFlags[n] & 0x2) != 0x0;
    }
