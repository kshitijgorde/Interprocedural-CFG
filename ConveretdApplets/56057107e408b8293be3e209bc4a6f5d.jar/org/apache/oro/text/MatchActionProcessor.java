...
public final class MatchActionProcessor
{
    ...
    public void addAction(final String s, final int n, final MatchAction matchAction) throws MalformedPatternException {
        if (s != null) {
    ...
    public void processMatches(final InputStream inputStream, final OutputStream outputStream, final String s) throws IOException {
        this.processMatches(new InputStreamReader(inputStream, s), new OutputStreamWriter(outputStream));
    }
    
    public void processMatches(final InputStream inputStream, final OutputStream outputStream) throws IOException {
        this.processMatches(new InputStreamReader(inputStream), new OutputStreamWriter(outputStream));
    }
    
    public void processMatches(final Reader reader, final Writer writer) throws IOException {
