...
public final class bd extends Canvas
{
    private final bc a;
        ...
        if (this.isShowing()) {
            ...
            for (int i = this.a.b; i < n; ++i) {
                ...
                if ((graphics2 = this.getGraphics()) != null) {
                    ...
                    final Image a3 = ((b)this.a.a.a(n3)).a;
                    final Rectangle a4 = this.a(n3 - this.a.b);
                    graphics4.drawImage(a3, 1 + a4.x + (a4.width - 24) / 2, 1 + a4.y + (a4.height - 24) / 2, this);
                    graphics2.dispose();
                }
            }
        }
