...
public class A extends Observable
{
    ...
    public B A(final E e) {
        final B b = new B();
        for (int i = 0; i < this.¥.A(); ++i) {
            if (!((D)this.¥.A(i)).A() && !((D)this.¥.A(i)).E() && ((D)this.¥.A(i)).A(e)) {
                b.A(this.¥.A(i));
            }
        }
        return b;
    ...
    public void A(final B b, final boolean b2) {
        if (b.A() == 0) {
            ...
            if (b3 > -1) {
                ...
                final int n = (a != null) ? a.E() : -1;
                final int n2 = (a2 != null) ? a2.E() : -1;
                if ((n == n2 && b2) || (n != n2 && !b2)) {
                    this.A((D)b.A(0));
                }
                else {
    ...
    private String A(final int n, final boolean b) {
        ...
        for (int i = 0; i < this.¥.A(); ++i) {
            if (!((D)this.¥.A(i)).E()) {
                ...
                String s = string + '+';
                final Point c = this.C(((D)this.¥.A(i)).H());
                final Point c2 = this.C(((D)this.¥.A(i)).D());
                if (n != 0) {
                    s += this.A(((D)this.¥.A(i)).L(), b);
                }
    ...
    private String A(final boolean b, final boolean b2) {
        ...
        String string2 = "";
        for (int i = 0; i < this.¥.A(); ++i) {
            string = string + '+' + this.A(((D)this.¥.A(i)).L(), b2);
            string2 += (char)(((D)this.¥.A(i)).G() ? 49 : 48);
        }
    ...
    public String A(final com.cc.C.A a, final String s, final int n, final boolean b) {
        ...
        if (index6 != -1 && this.K() != null) {
            s2 = s2.substring(0, index6) + this.K().L() + s2.substring(index6 + "%KEYWORD%".length());
        }
        return s2;
    }
}
