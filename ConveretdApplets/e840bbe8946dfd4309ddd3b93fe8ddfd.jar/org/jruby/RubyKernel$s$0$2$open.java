...
public class RubyKernel$s$0$2$open extends JavaMethodNBlock
{
    public RubyKernel$s$0$2$open(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array, final Block block) {
        ...
        return RubyKernel.open(context, recv, array, block);
    }
}
