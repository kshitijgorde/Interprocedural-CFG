...
public class ptcompass extends Applet
{
    ...
    void SetTheCompass() {
        ...
        final int n6 = height * 128;
        final int n7 = width * 128;
        for (int i = 0; i < height; ++i) {
            final int n8 = i * width;
            final int n9 = i - n4;
            for (int j = 0; j < width; ++j) {
                final int n10 = j - n5;
                final int n11 = n10 * n2 - n9 * n3 + n7 >> 8;
                final int n12 = n10 * n3 + n9 * n2 + n6 >> 8;
                if (n11 >= 0 && n11 < width && n12 >= 0 && n12 < height) {
                    this.cd_data[n8 + j] = this.cs_data[n12 * width + n11];
                }
                else {
                    this.cd_data[n8 + j] = 0;
                }
