...
public class ptmviewer extends Applet
{
    ...
    Image[] get_jpeg_images(final byte[] array) {
        ...
        for (int l = 0; l < vector.size(); ++l) {
            ...
            final int n4;
            final byte[] abyte0 = new byte[n4 = vector2.elementAt(l) - intValue];
            System.arraycopy(array, intValue, abyte0, 0, n4);
            vector3.addElement(this.pv.bufferToImage(abyte0));
        }
        int n5 = 0;
        ...
        final Image[] array3 = new Image[vector3.size()];
