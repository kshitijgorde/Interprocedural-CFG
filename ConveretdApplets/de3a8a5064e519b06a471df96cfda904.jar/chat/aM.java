...
public class aM extends Panel
{
    ...
    public aM(final int n, final int n2, final int n3, final int n4, final int a) {
        this(n, n2, n3, n4, (byte)0);
        this.a = a;
    }
    
    public aM(final int n, final int n2, final int n3, final int n4, final byte b) {
        this(n, n2, n3, n4);
    }
    
    private aM(final int n, final int n2, final int n3, final int n4) {
        this.a = 0;
