...
public final class cp
{
    ...
    public final ck q(final int n, final int n2) {
        if (n < 0 || n >= this.t) {
            throw new ArrayIndexOutOfBoundsException("itemNumber is out-of-bounds: " + n);
        }
        if (0 >= this.t()) {
    ...
    public final void q(final int n, final int n2, final ck ck) {
        if (this.t <= 0) {
            ...
            if (this.q != null) {
                for (int l = 0; l < this.q.length; ++l) {
                    if (this.q[l] == null) {
                        ...
                        final ck ck;
                        if ((ck = this.q[l]).q == null) {
                            dataOutput.writeInt(0);
                        }
                        else {
                            dataOutput.writeInt(ck.q.length);
                            dataOutput.write(ck.q);
                        }
                    }
                }
            }
    ...
    public cp(final int n, final int n2) {
        this(n, cq.q(n), 1);
    }
    
    public cp(final DataInput dataInput) {
        this();
                ...
                if (this.q != null) {
                    for (int n8 = 0; n8 < this.t; ++n8) {
                        for (int n9 = 0; n9 < n3; ++n9) {
                            if (n9 < n6) {
                                this.q[n8 * n6 + n9] = new ck(dataInput);
    ...
    private cp(final int r, final int y, final int t) {
        this();
        if (t < 0) {
