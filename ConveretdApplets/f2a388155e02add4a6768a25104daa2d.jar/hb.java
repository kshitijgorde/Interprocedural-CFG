...
class hb extends Panel
{
    ...
    hb(final esChat a) {
        ...
        this.b = new db(a);
        a.getClass();
        a.Rb = new cb(a, hb.z[1]);
        this.b.a(hb.z[1], a.Rb, true);
        a.getClass();
        this.c = new gb(a);
        a.getClass();
        this.d = new fb(a);
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "xX^1\u0014".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "eCM1\tE".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "eXY1\u0014".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "uRB1\u0019D".toCharArray();
