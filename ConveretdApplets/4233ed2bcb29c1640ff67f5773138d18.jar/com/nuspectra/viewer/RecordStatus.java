...
public class RecordStatus extends NuApplet implements Runnable, ActionListener
{
    ...
    public void actionPerformed(final ActionEvent ae) {
        ...
        if (o instanceof ImageButtonCanvas) {
            ...
            this.println("ae.getActionCommand()=" + ae.getActionCommand() + " cmd=" + b.getCommand());
            if ("mouseReleased".equals(ae.getActionCommand())) {
