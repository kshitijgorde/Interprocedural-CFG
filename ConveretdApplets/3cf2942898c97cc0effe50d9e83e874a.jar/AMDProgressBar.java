...
public class AMDProgressBar extends Canvas
{
    ...
    public void reshape(final int n, final int n2, final int width_, final int height_) {
        super.reshape(n, n2, width_, height_);
        this.width_ = width_;
    ...
    public void paint(final Graphics graphics) {
        if (this.graphics_ == null) {
            this.image_ = this.createImage(this.width_, this.height_);
        ...
        graphics.drawImage(this.image_, 0, 0, null);
    }
    ...
    void updateLocations() {
        ...
        final FontMetrics fontMetrics = this.getFontMetrics(this.font_);
        String text_;
        if (this.text_ == null) {
