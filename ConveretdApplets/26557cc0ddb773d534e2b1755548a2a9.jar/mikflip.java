...
public class mikflip extends Applet implements Runnable, ImageObserver
{
    Frame a;
    boolean b;
    int c;
    ...
    public mikflip() {
        this.d = c("^B u0k\u00122`uYS2p:?q9l6|[p1\"hE~x;y");
        this.x = false;
        this.n = false;
        this.be = 1;
        this.bh = 1;
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    switch (n2) {
                        ...
                        case 3: {
                            final char[] array4 = charArray;
                            final int n6 = n;
                            array4[n6] ^= '\u0019';
                            continue;
                        }
                        case 4: {
                            final char[] array5 = charArray;
                            final int n7 = n;
                            array5[n7] ^= 'U';
                            continue;
                        }
    ...
    void e() {
        ...
        if (!this.x) {
            this.Z = null;
            this.Y = new mikMIS(this.by, this.p, new DirectColorModel(24, 16711680, 65280, 255), this.k, 0, this.by);
    ...
    public void init() {
        ...
        this.L = 1;
        while (this.getParameter(String.valueOf(c("v_1~0")) + String.valueOf(this.L)) != null) {
            ++this.L;
        }
        --this.L;
        ...
        for (int n14 = 0; n14 < this.L; ++n14) {
            this.U[n14] = this.getParameter(String.valueOf(c("v_1~0")) + String.valueOf(n14 + 1));
        }
        for (int n15 = 0; n15 < this.L; ++n15) {
            this.bx[n15] = this.getParameter(String.valueOf(c("s[>r")) + String.valueOf(n15 + 1));
            this.bt[n15] = this.getParameter(String.valueOf(c("lF1m l_#~")) + String.valueOf(n15 + 1));
            array8[n15] = Integer.valueOf(this.getParameter(String.valueOf(c("y^9i")) + String.valueOf(n15 + 1)));
        }
