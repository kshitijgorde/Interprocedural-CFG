...
class bb extends Panel implements ActionListener, MouseListener
{
    ...
    public void actionPerformed(final ActionEvent actionEvent) {
        ...
        Label_0210: {
            if (!r) {
                if (b) {
                    new u(this.a, this.a.a(29, "", "", ""), bb.z[2]);
                    return;
                }
                final bb bb = this;
                if (r) {
            ...
            if (n != -1) {
                new u(this.a, this.a.a(30, "", "", ""), bb.z[2]);
                return;
            }
            this.a.n = this.c.b();
            this.a.o = this.b.b();
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "\u0012lb\f(U7a\u000beT}`\u000ew\u0014ky\u001afT{y\u0011".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "%zz\u001d|\u0011".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "2yb\u001d".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "\u0013juRa\u001b|s\u001fw\t}xR|\u001fl".toCharArray();
