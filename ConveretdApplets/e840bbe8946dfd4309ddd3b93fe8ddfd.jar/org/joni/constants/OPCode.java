...
public interface OPCode
{
    ...
    public static final int ANYCHAR_SB = 88;
    public static final int ANYCHAR_ML_SB = 89;
    public static final int ANYCHAR_STAR_SB = 90;
    public static final int ANYCHAR_ML_STAR_SB = 91;
    public static final int ANYCHAR_STAR_PEEK_NEXT_SB = 92;
    public static final int ANYCHAR_ML_STAR_PEEK_NEXT_SB = 93;
    public static final int STATE_CHECK_ANYCHAR_STAR_SB = 94;
    public static final int STATE_CHECK_ANYCHAR_ML_STAR_SB = 95;
    public static final int CCLASS_SB = 96;
    public static final int CCLASS_NOT_SB = 97;
    public static final int WORD_SB = 98;
    public static final int NOT_WORD_SB = 99;
    public static final int WORD_BOUND_SB = 100;
    public static final int NOT_WORD_BOUND_SB = 101;
    public static final int WORD_BEGIN_SB = 102;
    public static final int WORD_END_SB = 103;
    public static final int LOOK_BEHIND_SB = 104;
    public static final int EXACT1_IC_SB = 105;
    public static final int EXACTN_IC_SB = 106;
    public static final String[] OpCodeNames = null;
    public static final int[] OpCodeArgTypes = null;
}
