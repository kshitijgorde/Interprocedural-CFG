...
public class gb extends Panel implements ActionListener, MouseMotionListener, MouseListener
{
    ...
    public void a() {
        this.i = this.a.c(String.valueOf(this.a.N) + "/" + this.a.y + gb.z[8], gb.z[9]);
        this.j = this.a.c(String.valueOf(this.a.N) + "/" + this.a.y + gb.z[8], gb.z[9]);
        this.k = this.a.c(String.valueOf(this.a.N) + "/" + this.a.y + gb.z[8], gb.z[7]);
        this.l = this.a.c(String.valueOf(this.a.N) + "/" + this.a.y + gb.z[8], gb.z[5]);
        this.i[this.a.a(this.i)] = gb.z[6];
        this.j[this.a.a(this.j)] = gb.z[6];
        this.k[this.a.a(this.k)] = gb.z[6];
        this.l[this.a.a(this.l)] = gb.z[6];
    }
    ...
    public void b() {
        ...
        this.a.Ib.removeAll();
        this.a.Jb.removeAll();
        this.a.a(this.a.Fb, gb.z[1], this);
        this.a.a(this.a.Gb, gb.z[2], this);
        this.a.a(this.a.Hb, gb.z[4], this);
        this.a.a(this.a.Ib, gb.z[3], this);
        this.a.a(this.a.Jb, gb.z[0], this);
    }
    ...
    static {
        ...
        final int n = 0;
        final char[] charArray = "]\u0019D-/N".toCharArray();
        ...
        final int n4 = 1;
        final char[] charArray2 = "\\\u0019D-/N".toCharArray();
        ...
        final int n7 = 2;
        final char[] charArray3 = "S\u0019D-/N".toCharArray();
        ...
        final int n10 = 3;
        final char[] charArray4 = "R\u0019D-/N".toCharArray();
        ...
        final int n13 = 4;
        final char[] charArray5 = "O\u0019D-/N".toCharArray();
        ...
        final int n16 = 5;
        final char[] charArray6 = "n\u001bB+;J\f".toCharArray();
        ...
        final int n19 = 6;
        final char[] charArray7 = "PTN.\u0019V\b_gu_\u000bD(.".toCharArray();
        ...
        final int n22 = 7;
        final char[] charArray8 = "}\u0001J34[\u0005".toCharArray();
        ...
        final int n25 = 8;
        final char[] charArray9 = "\u0011\u001a@44\u0010\u001dS)".toCharArray();
        ...
        final int n28 = 9;
        final char[] charArray10 = "m\u001dJ)/M".toCharArray();
