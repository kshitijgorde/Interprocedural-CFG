...
public final class dq extends Panel
{
    private cw q;
    private String q;
    private Color q;
    ...
    public dq(final at q, final cw q2, final ai w) {
        this.q = true;
        this.q = 20;
        this.w = w;
        this.q = q;
        ...
        if (q.q) {
            this.r = true;
            this.q = new ai(q.q, this.q, false, this);
        }
    }
            ...
            case 502: {
                ...
                if ((w = this.w).q != null) {
                    ...
                    for (int i = 0; i < q2.q.size(); ++i) {
                        final Panel panel;
                        if ((panel = q2.q.elementAt(i)) instanceof dq) {
                            ((dq)panel).w = false;
                        }
                    }
                }
