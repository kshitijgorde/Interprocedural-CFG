...
{
    private static boolean q(String lowerCase, final String s) {
    ...
    public static String q(final M m, String substring, int i) {
    ...
    private static int q(final M m, final String s) {
        for (int i = 0; i < m.q; ++i) {
            final bw bw = (bw)m.q(i);
            final String string = " " + bw.r().trim();
            if ((" " + s).equalsIgnoreCase(" " + bw.a)) {
