...
public final class HTMLdtd
{
    ...
    public static boolean isBoolean(final String s, final String s2) {
        final String[] array = HTMLdtd._boolAttrs.get(s.toUpperCase());
        if (array == null) {
            return false;
        }
    ...
    public static int charFromName(final String s) {
        initialize();
        final Character value = HTMLdtd._byName.get(s);
    ...
    public static String fromChar(final int n) {
        ...
        initialize();
        final String s = HTMLdtd._byChar.get(String.valueOf(n));
        if (s == null) {
            return null;
        }
        return s;
    ...
    private static void initialize() {
        ...
        try {
            ...
            final ClassLoader classLoader = ((HTMLdtd.class$org$apache$xml$serialize$HTMLdtd == null) ? (HTMLdtd.class$org$apache$xml$serialize$HTMLdtd = class$("org.apache.xml.serialize.HTMLdtd")) : HTMLdtd.class$org$apache$xml$serialize$HTMLdtd).getClassLoader();
            if (classLoader == null) {
                inputStream = ClassLoader.getSystemResourceAsStream("org/apache/xml/serialize/HTMLEntities.res");
            }
            else {
                inputStream = classLoader.getResourceAsStream("org/apache/xml/serialize/HTMLEntities.res");
            }
            if (inputStream == null) {
                throw new RuntimeException("SER003 The resource [org/apache/xml/serialize/HTMLEntities.res] could not be found.\norg/apache/xml/serialize/HTMLEntities.res");
            }
            ...
            throw new RuntimeException("SER003 The resource [org/apache/xml/serialize/HTMLEntities.res] could not load: " + ex.toString() + "\n" + "org/apache/xml/serialize/HTMLEntities.res" + "\t" + ex.toString());
        }
        finally {
            if (inputStream != null) {
                try {
    ...
    private static void defineEntity(final String s, final char c) {
        if (HTMLdtd._byName.get(s) == null) {
            HTMLdtd._byName.put(s, new Character(c));
            HTMLdtd._byChar.put(String.valueOf(c), s);
        }
    }
    ...
    private static boolean isElement(final String s, final int n) {
        final Integer n2 = HTMLdtd._elemDefs.get(s.toUpperCase());
