...
public class g
{
    ...
    public static final int do(final char[] array, final char[] array2) {
    ...
    public static final char[] a(final char[] array, char[] array2) {
        if (array2 == null || array2.length <= a(array)) {
            array2 = new char[a(array) + 1];
        }
        for(array, array2);
        return array2;
    }
    
    public static final void for(final char[] array, final char[] array2) {
        if (array.length > 0) {
            final int a = a(array);
            for (int i = 0; i < a; ++i) {
                array2[i] = array[i];
