...
public class c extends a
{
    ...
    private void a(final int n, final float[] array, final float[] array2) {
        ...
        final int[] do1 = this.F.do;
        for (int i = n14; i < n15; ++i) {
            final int n16 = n9 >> 16;
            final int n17 = (n10 >> 16) * this.aF;
            if (n16 < this.aF - 1 && n10 >> 16 < this.aF - 1) {
                switch ((n9 >> 13 & 0x7) | (n10 >> 13 & 0x7) << 3) {
                    case 0: {
                        do1[i] = (this.C[n16 + n17] | 0xFF000000);
                        break;
                    }
                    case 1: {
                        do1[i] = (3 * (this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 2: {
                        do1[i] = (3 * (this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 3: {
                        do1[i] = ((this.C[n16 + n17] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + 1] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                        break;
                    }
                    case 4: {
                        do1[i] = ((this.C[n16 + n17] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + 1] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                    ...
                    case 5: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + 3 * (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 6: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + 3 * (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 7: {
                        do1[i] = (this.C[n16 + n17 + 1] | 0xFF000000);
                        break;
                    }
                    case 8: {
                        do1[i] = (3 * (this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 9: {
                        do1[i] = ((this.C[n16 + n17] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 10: {
                        do1[i] = ((this.C[n16 + n17] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 13: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + 1] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 14: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + 1] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 15: {
                        do1[i] = (3 * (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 16: {
                        do1[i] = (3 * (this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 24: {
                        do1[i] = ((this.C[n16 + n17] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                        break;
                    }
                    case 25: {
                        do1[i] = ((this.C[n16 + n17] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                    ...
                    case 27: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 28: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 29: {
                        do1[i] = ((this.C[n16 + n17 + 1] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF + 1] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                        break;
                    }
                    case 30: {
                        do1[i] = ((this.C[n16 + n17 + 1] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF + 1] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                    ...
                    case 40: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + 3 * (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 41: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 42: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 43: {
                        do1[i] = ((this.C[n16 + n17 + this.aF] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF + 1] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                        break;
                    }
                    case 44: {
                        do1[i] = ((this.C[n16 + n17 + this.aF] >> 1 & 0x7F7F7F7F) + (this.C[n16 + n17 + this.aF + 1] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                    ...
                    case 45: {
                        do1[i] = ((this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF + 1] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                        break;
                    }
                    case 46: {
                        do1[i] = ((this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF + 1] >> 1 & 0x7F7F7F7F) | 0xFF000000);
                    ...
                    case 47: {
                        do1[i] = ((this.C[n16 + n17 + 1] >> 2 & 0x3F3F3F3F) + 3 * (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 48: {
                        do1[i] = ((this.C[n16 + n17] >> 2 & 0x3F3F3F3F) + 3 * (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 56: {
                        do1[i] = (this.C[n16 + n17 + this.aF] | 0xFF000000);
                        break;
                    }
                    case 57: {
                        do1[i] = (3 * (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 58: {
                        do1[i] = (3 * (this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) + (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 61: {
                        do1[i] = ((this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) + 3 * (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                        break;
                    }
                    case 62: {
                        do1[i] = ((this.C[n16 + n17 + this.aF] >> 2 & 0x3F3F3F3F) + 3 * (this.C[n16 + n17 + this.aF + 1] >> 2 & 0x3F3F3F3F) | 0xFF000000);
                    ...
                    case 63: {
                        do1[i] = (this.C[n16 + n17 + this.aF + 1] | 0xFF000000);
                        break;
                    }
                }
            }
            else {
                do1[i] = this.C[(n10 >> 16) * this.aF + (n9 >> 16)];
            }
            n9 += n11;
            n10 += n12;
        }
