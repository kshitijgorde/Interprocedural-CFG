...
public class FreeTransForm extends Applet implements ActionListener, MouseListener
{
    String urlHost;
    String urlPort;
    String textHost;
    ...
    public void init() {
        ...
        this.topImage = this.getImage(this.getCodeBase(), "horizontal-top.gif");
        this.initComponents();
    }
    ...
    protected void initComponents() {
        ...
        final Canvas canvas = new Canvas() {
            public void paint(final Graphics graphics) {
                graphics.drawImage(FreeTransForm.this.topImage, 0, 0, this);
            }
        };
        canvas.setBackground(Color.lightGray);
        canvas.setCursor(new Cursor(12));
        canvas.addMouseListener(this);
        canvas.setBounds(0, 0, 540, 21);
        this.add(canvas);
        final Label label = new Label("Enter text or url to translate:");
        label.setBackground(Color.lightGray);
        label.setForeground(Color.black);
        label.setFont(new Font("Dialog", 0, 11));
        label.setBounds(5, 23, 150, 12);
        this.add(label);
        final Panel panel = new Panel();
        panel.setLayout(new FlowLayout(0, 0, 0));
        panel.setBackground(Color.lightGray);
        panel.setBounds(5, 37, 210, 35);
        (this.sourceArea = new TextArea("", 1, 30, 1)).setBackground(Color.white);
        ...
        label2.setBounds(220, 23, 150, 12);
        this.add(label2);
        final Panel panel2 = new Panel();
        panel2.setLayout(new FlowLayout(0, 0, 0));
        panel2.setBackground(Color.lightGray);
        panel2.setBounds(220, 37, 150, 20);
        ...
        panel3.setBounds(380, 37, 150, 30);
        final Button button = new Button();
