...
public final class r
{
    ...
    public final void a(final int n, final int n2, final String s) {
        ...
        this.a[n * this.a() + n2] = s;
    }
    
    public final aV a(final int n) {
        if (n < 0 || n >= this.b) {
            throw new ArrayIndexOutOfBoundsException("itemNumber is out-of-bounds: " + n);
        }
        if (0 >= this.b()) {
    ...
    public final void a(final int n, final int n2, final aV av) {
        if (n < 0 || n >= this.b) {
            throw new ArrayIndexOutOfBoundsException("itemNumber is out-of-bounds: " + n);
        }
        if (n2 < 0 || n2 >= this.b()) {
    ...
    public final boolean a(final int n) {
        ...
        return ((new long[] { this.a[(n << 1) + 2], this.a[(n << 1) + 3] })[0] & 1L << 63) != 0x0L;
    }
                ...
                if (this.a != null) {
                    for (int n10 = 0; n10 < this.b; ++n10) {
                        for (int n11 = 0; n11 < n3; ++n11) {
                            if (n11 < n6) {
                                this.a[n10 * n6 + n11] = new aV(dataInputStream);
                                if (this.a[n10 * n6 + n11].a()) {
                                    this.a[n10 * n6 + n11] = null;
                                }
                            }
                            else {
                                new aV(dataInputStream);
                            }
                        }
                    }
                }
    ...
    private r(final int a, final int c, final int b) {
        this.d = -999;
        this.e = -999;
        this.f = -999;
        if (b < 0) {
