        ...
        switch (n) {
            ...
            case 22: {
                if (n2 == 1 && array[0].char == 4) {
                    this.h.i.for(new String(array[0].int, 0, a.a.a.a.i.a(array[0].int)));
                }
                else {
                    this.h.i.for("");
                }
            ...
            case 37: {
                ...
                bi.char = 1;
                bi.long = this.h.i.if(new String(array[0].int, 0, a.a.a.a.i.a(array[0].int)));
                break;
            }
            case 26: {
                if (n2 != 1) {
                ...
                bi.long = this.h.i.new(new String(array[0].int, 0, a.a.a.a.i.a(array[0].int)));
                bi.char = 1;
                break;
            }
            case 29: {
