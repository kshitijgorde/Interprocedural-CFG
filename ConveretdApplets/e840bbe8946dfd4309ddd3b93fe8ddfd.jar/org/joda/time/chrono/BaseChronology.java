    ...
    public void validate(final ReadablePartial readablePartial, final int[] array) {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (n < field.getMinimumValue()) {
                throw new IllegalFieldValueException(field.getType(), new Integer(n), new Integer(field.getMinimumValue()), null);
            }
            if (n > field.getMaximumValue()) {
                throw new IllegalFieldValueException(field.getType(), new Integer(n), null, new Integer(field.getMaximumValue()));
            }
        }
        for (int j = 0; j < size; ++j) {
            ...
            if (n2 < field2.getMinimumValue(readablePartial, array)) {
                throw new IllegalFieldValueException(field2.getType(), new Integer(n2), new Integer(field2.getMinimumValue(readablePartial, array)), null);
            }
            if (n2 > field2.getMaximumValue(readablePartial, array)) {
                throw new IllegalFieldValueException(field2.getType(), new Integer(n2), null, new Integer(field2.getMaximumValue(readablePartial, array)));
            }
        }
    }
