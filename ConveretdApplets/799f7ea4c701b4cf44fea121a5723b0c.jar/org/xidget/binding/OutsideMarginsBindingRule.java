...
public class OutsideMarginsBindingRule implements IBindingRule
{
    ...
    private static final class Listener extends ExpressionListener
    {
        ...
        public void notifyChange(final IExpression expression, final IContext context, final double n, final double n2) {
            this.xidget.getFeature(IWidgetFeature.class).setOutsideMargins(new Margins((int)n));
        }
        ...
        private void setMargins(final String s) {
            this.xidget.getFeature(IWidgetFeature.class).setOutsideMargins(new Margins(s));
        }
    }
}
