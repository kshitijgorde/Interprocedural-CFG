...
public class XMLNSDocumentScannerImpl extends XMLDocumentScannerImpl
{
    ...
    protected boolean scanStartElement() throws IOException, XNIException {
        ...
        while (true) {
            ...
            if (!this.isValidNameStartChar(peekChar) || !skipSpaces) {
                this.reportFatalError("ElementUnterminated", new Object[] { rawname });
            }
    ...
    protected boolean scanStartElementAfterName() throws IOException, XNIException {
        ...
        while (true) {
            ...
            if (!this.isValidNameStartChar(peekChar) || !this.fSawSpace) {
                this.reportFatalError("ElementUnterminated", new Object[] { rawname });
            }
            this.scanAttribute(super.fAttributes);
            this.fSawSpace = super.fEntityScanner.skipSpaces();
    ...
    protected void scanAttribute(final XMLAttributesImpl xmlAttributesImpl) throws IOException, XNIException {
        ...
        if (this.fBindNamespaces) {
            ...
            if (s == XMLSymbols.PREFIX_XMLNS || (s == XMLSymbols.EMPTY_STRING && localpart == XMLSymbols.PREFIX_XMLNS)) {
                ...
                final String s2 = (localpart != XMLSymbols.PREFIX_XMLNS) ? localpart : XMLSymbols.EMPTY_STRING;
                if (addSymbol == XMLSymbols.EMPTY_STRING && localpart != XMLSymbols.PREFIX_XMLNS) {
                ...
                super.fNamespaceContext.declarePrefix(s2, (addSymbol.length() != 0) ? addSymbol : null);
    ...
    protected final class NSContentDispatcher extends ContentDispatcher
    {
        ...
        private void reconfigurePipeline() {
            if (XMLNSDocumentScannerImpl.this.fDTDValidator == null) {
                ...
                final XMLDocumentSource documentSource = XMLNSDocumentScannerImpl.this.fDTDValidator.getDocumentSource();
                final XMLDocumentHandler documentHandler = XMLNSDocumentScannerImpl.this.fDTDValidator.getDocumentHandler();
