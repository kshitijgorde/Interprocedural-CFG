...
class Z extends Canvas
{
    ...
    void a(final Graphics graphics, final int n) {
        final Image b = ((U)G.a(this.b).a(n)).b;
        final Rectangle a = this.a(n - this.b.g);
        graphics.drawImage(b, 1 + a.x + (a.width - 24) / 2, 1 + a.y + (a.height - 24) / 2, this);
    }
    
    public void paint(final Graphics graphics) {
        if (this.isShowing()) {
            final int b = G.a(this.b).b();
            int f = this.b.f();
            if (b <= f) {
                this.b.g = 0;
                f = b;
            ...
            if (this.b.t >= this.b.g && this.b.t < n) {
                this.m(this.b.t - this.b.g);
            }
            for (int i = this.b.g; i < n; ++i) {
                this.a(i);
            }
        }
    }
    ...
    public boolean handleEvent(final Event event) {
        switch (event.id) {
            ...
            case 506: {
                ...
                final int n4 = n2 * width + n3 + this.b.g;
                if (n4 < b && n4 != this.b.t) {
                    this.b.b(n4);
                }
                return true;
