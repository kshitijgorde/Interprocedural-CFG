...
public final class B extends Panel
{
    ...
    public final Dimension preferredSize() {
        ...
        final FontMetrics fontMetrics = this.getFontMetrics(B.q);
        ...
        final Dimension dimension = new Dimension(Math.max(preferredSize.width, cf.w.a), preferredSize.height);
    ...
    public B(final int t, final int y, final int i, final int u, final int e, final cM q, final boolean q2) {
        this.q = 12;
    ...
    public B(final int n, final int n2, final int n3, final int n4, final int n5, final cM cm) {
        this(2, 10, 2, 10, n5, cm, false);
    }
    
    public B(final cM cm, final boolean b) {
        this(4, 4, 4, 4, 1, cm, b);
    }
