...
public class RubyKernel$s$split extends JavaMethodZeroOrOneOrTwo
{
    public RubyKernel$s$split(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject arg0, final IRubyObject arg2) {
        return RubyKernel.split(context, recv, arg0, arg2);
    }
