...
class LoadXMLAction extends AbstractAction
{
    ...
    static {
        LOG = Logger.getLogger((LoadXMLAction.class$org$apache$log4j$chainsaw$LoadXMLAction == null) ? (LoadXMLAction.class$org$apache$log4j$chainsaw$LoadXMLAction = class$("org.apache.log4j.chainsaw.LoadXMLAction")) : LoadXMLAction.class$org$apache$log4j$chainsaw$LoadXMLAction);
    }
}
