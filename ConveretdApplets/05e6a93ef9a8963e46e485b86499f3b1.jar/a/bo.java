            ...
            for (int i = this.q.w; i < n; ++i) {
                ...
                if ((graphics2 = this.getGraphics()) != null) {
                    ...
                    if (!(b = (n3 < 0 || n3 >= this.q.q.q))) {
                        Image image = null;
                        if (this.q.q.q(n3) instanceof aw) {
                            image = ((aw)this.q.q.q(n3)).q;
                        }
                        if (this.q.q.q(n3) instanceof R) {
                            image = ((R)this.q.q.q(n3)).q;
                        }
                        if (this.q.q.q(n3) instanceof bu) {
                            image = ((bu)this.q.q.q(n3)).q;
                        }
