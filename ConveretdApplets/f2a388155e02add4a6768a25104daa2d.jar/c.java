...
class c extends Canvas
{
    ...
    public Dimension getMinimumSize() {
        final FontMetrics fontMetrics = this.getFontMetrics(new Font(this.a.bb, 0, this.a.eb));
    ...
    public void paint(final Graphics graphics) {
        ...
        Label_0222: {
            if (m == 0) {
                if (c) {
                    graphics.drawImage(this.a.y, 0, 0, 10, height, 30, 41, 40, 61, null);
                    graphics.drawImage(this.a.y, 10, 0, width - 10, height, 40, 41, 50, 61, null);
                    graphics.drawImage(this.a.y, width - 10, 0, width, height, 50, 41, 60, 61, null);
                    if (m == 0) {
                        break Label_0222;
                    }
                }
                graphics.drawImage(this.a.y, 0, 0, 10, height, 0, 41, 10, 61, null);
                graphics.drawImage(this.a.y, 10, 0, width - 10, height, 10, 41, 20, 61, null);
                graphics.drawImage(this.a.y, width - 10, 0, width, height, 20, 41, 30, 61, null);
            }
        }
