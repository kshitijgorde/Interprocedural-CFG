...
public final class ce
{
    ...
    public static String q(final B b, String substring, int i) {
    ...
    private static int q(final B b, final String s) {
        for (int i = 0; i < b.q; ++i) {
            final aN an = (aN)b.q(i);
            final String string = " " + an.r().trim();
            if ((" " + s).equalsIgnoreCase(" " + an.o)) {
