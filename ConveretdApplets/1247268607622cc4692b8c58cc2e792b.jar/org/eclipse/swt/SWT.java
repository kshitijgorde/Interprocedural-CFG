...
public class SWT
{
    ...
    static String findErrorText(final int n) {
        switch (n) {
            case 1: {
    ...
    public static String getMessage(final String s) {
        return Compatibility.getMessage(s);
    }
    ...
    public static void error(final int n, final Throwable t) {
        error(n, t, null);
    }
    
    public static void error(final int n, final Throwable throwable, final String s) {
        if (n != 46) {
        ...
        switch (n) {
            ...
            case 50:
            case 51: {
                final SWTException ex = new SWTException(n, s2);
            ...
            case 36:
            case 47: {
                final SWTError swtError = new SWTError(n, s2);
                swtError.throwable = throwable;
                throw swtError;
            }
            default: {
                final SWTError swtError2 = new SWTError(n, s2);
                swtError2.throwable = throwable;
                throw swtError2;
            }
        }
    }
