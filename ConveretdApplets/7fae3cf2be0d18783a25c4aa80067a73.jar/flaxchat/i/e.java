...
public class e extends Panel implements MouseListener, FocusListener, KeyListener
{
    ...
    public e(final String e, final String a, final Image b) {
        ...
        this.a = a;
        this.b = b;
        this.setFont(flaxchat.d.b.d(flaxchat.i.e.z));
        this.a();
    ...
    public void setFocusable(final boolean j) {
        this.j = j;
    }
    ...
    protected void a() {
        ...
        if (this.b != null) {
            final int n = (this.a == null) ? 0 : (this.f() + 13);
    ...
    public void paint(final Graphics graphics) {
        ...
        Label_0107: {
            if (this.g) {
                this.a(graphics, size, this.d(), this.h ? Color.gray : this.getBackground());
                if (!j) {
                    break Label_0107;
                }
            }
            if (this.h) {
                this.a(graphics, size, this.c(), Color.gray);
                if (!j) {
                    break Label_0107;
                }
            }
            this.a(graphics, size, this.e(), this.getBackground());
        }
        int n = 0;
        int width = 0;
        int f = 0;
        ...
        this.a(graphics, b);
        this.a(graphics, b + width + 2, f);
        if (!this.i) {
            return;
        }
        final int n2 = 3;
        flaxchat.a.c.b(Color.black, graphics, n2, n2, size.width - n2 * 2, size.height - n2 * 2);
    }
