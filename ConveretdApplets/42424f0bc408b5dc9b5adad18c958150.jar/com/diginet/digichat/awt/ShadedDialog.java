...
public class ShadedDialog extends Dialog
{
    ...
    public ShadedDialog(final Frame frame, final String title, final boolean b) {
        this(frame, b);
        this.setTitle(title);
    }
    
    public ShadedDialog(final Frame frame, final boolean b) {
