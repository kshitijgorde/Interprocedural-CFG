...
public class RubyKernel$s$0$1$exit_bang extends JavaMethodN
{
    public RubyKernel$s$0$1$exit_bang(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyKernel.exit_bang(recv, array);
    }
}
