...
public class RubyStringIO$i$0$1$gets extends JavaMethodN
{
    public RubyStringIO$i$0$1$gets(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyStringIO)rubyObject).gets(context, array);
    }
}
