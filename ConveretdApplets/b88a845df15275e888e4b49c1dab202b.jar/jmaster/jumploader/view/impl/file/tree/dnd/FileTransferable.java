...
public class FileTransferable implements Transferable, ClipboardOwner
{
    ...
    private File[] A;
    static /* synthetic */ Class class$jmaster$jumploader$view$impl$file$tree$dnd$FileTransferable;
    
    public FileTransferable(final File[] a) {
        this.A = a;
    ...
    static {
        MIME_TYPE = "application/x-java-jvm-local-objectref;class=" + ((FileTransferable.class$jmaster$jumploader$view$impl$file$tree$dnd$FileTransferable == null) ? (FileTransferable.class$jmaster$jumploader$view$impl$file$tree$dnd$FileTransferable = class$("jmaster.jumploader.view.impl.file.tree.dnd.FileTransferable")) : FileTransferable.class$jmaster$jumploader$view$impl$file$tree$dnd$FileTransferable).getName();
        try {
