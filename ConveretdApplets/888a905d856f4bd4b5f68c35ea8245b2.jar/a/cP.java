...
public class cP extends bE implements dB, Runnable
{
    protected boolean q;
    protected int q;
    ...
    protected void q() {
        ...
        this.add(this.w);
        (this.q = new cZ()).setForeground(new Color(0, 0, 128));
    ...
    public cP(final dH dh, final di di) {
        this(dh, di.q, di.q, di.w, false);
        this.w = di.q;
        this.e = di.q;
    }
    
    public cP(final dH dh, final p p2) {
        this(dh, p2, null, null, true);
    }
    
    protected cP(final dH q, final p q2, final String q3, final String w, final boolean q4) {
        super(false);
        this.q = 6;
        this.w = -1;
        this.q = q2;
