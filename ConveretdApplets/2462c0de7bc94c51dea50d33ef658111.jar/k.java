...
public class k extends Canvas
{
    ...
    public k(final Image f, final Image g, final Image h, final Container o, final d q, final int l, final int m) {
        this.a = false;
        this.b = false;
        this.i = true;
        this.l = 4;
    ...
    private void c() {
        if (this.a) {
            ...
            this.paint(graphics);
            graphics.dispose();
            final String string = c.c((int)(this.a() * this.r)) + "/" + c.c(this.r);
            if (this.q != null) {
                this.q.i = string;
            }
        }
