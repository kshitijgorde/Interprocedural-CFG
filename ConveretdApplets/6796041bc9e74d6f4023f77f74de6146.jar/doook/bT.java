...
public class bT extends Canvas
{
    private final bV a;
    ...
    void a(final Graphics graphics, final int n) {
        final Image q = ((as)bV.a(this.a).a(n)).q;
        final Rectangle a = this.a(n - this.a.i);
        graphics.drawImage(q, 1 + a.x + (a.width - 24) / 2, 1 + a.y + (a.height - 24) / 2, this);
    }
    
    public void paint(final Graphics graphics) {
        if (this.isShowing()) {
            final int b = bV.a(this.a).b();
            int c = this.a.c();
            if (b <= c) {
                this.a.i = 0;
                c = b;
            ...
            if (this.a.h >= this.a.i && this.a.h < n) {
                this.d(this.a.h - this.a.i);
            }
            for (int i = this.a.i; i < n; ++i) {
                this.a(i);
            }
        }
    }
    ...
    public boolean handleEvent(final Event event) {
        switch (event.id) {
            ...
            case 506: {
                ...
                final int n4 = n2 * width + n3 + this.a.i;
                if (n4 < b && n4 != this.a.h) {
                    this.a.b(n4);
                }
                return true;
