...
public class RubyBigDecimal$i$truncate extends JavaMethodZeroOrOne
{
    public RubyBigDecimal$i$truncate(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s) {
        return ((RubyBigDecimal)rubyObject).truncate();
    }
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject arg) {
        return ((RubyBigDecimal)rubyObject).truncate(arg);
    }
}
