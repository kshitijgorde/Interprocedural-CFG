...
final class cF extends Canvas
{
    ...
    public final synchronized void update(final Graphics graphics) {
        this.getSize();
        if (cF.q == null) {
            cF.q = cu.q(this, this.getSize().width, this.getSize().height, "vcr.u");
        }
        final Graphics graphics2 = cF.q.getGraphics();
        this.q = new Rectangle(8, 0, 8, 150);
        graphics2.setColor(Color.black);
        graphics2.drawImage(this.q.q(cF.q), 0, 0, this);
        ...
        graphics2.dispose();
        graphics.drawImage(cF.q, 0, 0, this);
    }
