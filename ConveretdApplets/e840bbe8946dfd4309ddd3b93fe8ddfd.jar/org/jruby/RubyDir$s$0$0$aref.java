...
public class RubyDir$s$0$0$aref extends JavaMethodN
{
    public RubyDir$s$0$0$aref(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyDir.aref(context, recv, array);
    }
}
