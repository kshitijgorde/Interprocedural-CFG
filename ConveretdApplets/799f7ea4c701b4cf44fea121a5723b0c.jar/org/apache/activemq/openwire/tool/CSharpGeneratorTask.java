...
public class CSharpGeneratorTask extends Task
{
    ...
    public static void main(final String[] args) {
        ...
        project.init();
        final CSharpGeneratorTask generator = new CSharpGeneratorTask();
    ...
    public void execute() throws BuildException {
        try {
            ...
            final CSharpClassesGenerator script = new CSharpClassesGenerator();
            script.setJam(jam);
            script.setTargetDir(this.target + "/src/main/csharp");
            script.setOpenwireVersion(this.version);
            script.run();
            final CSharpMarshallingGenerator script2 = new CSharpMarshallingGenerator();
            script2.setJam(jam);
            script2.setTargetDir(this.target + "/src/main/csharp");
