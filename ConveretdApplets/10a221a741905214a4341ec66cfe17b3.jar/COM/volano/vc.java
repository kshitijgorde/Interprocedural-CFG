...
public class vc extends Observable implements Runnable
{
    ...
    public static void a(final vk c) {
        vc.c = c;
    }
    ...
    public void a(final vn vn) throws IOException {
        if (this.w.a(vn) == 0) {
            throw new IOException("connection is closed");
        }
    }
    
    public void b(final vn vn) throws IOException {
        this.u.writeShort(vn.c());
        vn.a(this.u);
        this.u.flush();
        if (vc.m) {
            f();
    ...
    public Object c() throws ClassNotFoundException, IOException, InterruptedException {
        try {
            this.t.mark(0);
            final vm a = vc.c.a(this.t.readUnsignedShort());
            a.a(this.t);
            this.ae = 0;
            if (vc.m) {
                g();
