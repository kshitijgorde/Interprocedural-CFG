...
public final class dI
{
    ...
    public final dD q(final int n, final int n2) {
        if (n < 0 || n >= this.t) {
            throw new ArrayIndexOutOfBoundsException("itemNumber is out-of-bounds: " + n);
        }
        if (0 >= this.t()) {
    ...
    public final void q(final int n, final int n2, final dD dd) {
        if (n < 0 || n >= this.t) {
            throw new ArrayIndexOutOfBoundsException("itemNumber is out-of-bounds: " + n);
        }
        if (n2 < 0 || n2 >= this.t()) {
    ...
    public static final long q(long n, final int n2, final boolean b) {
        if (n2 < 0 || n2 > 63) {
            throw new ArrayIndexOutOfBoundsException("flag index must be between 0 and 63, inclusive: " + n2);
        }
        final long n3 = 1L << n2;
            ...
            if (this.q != null) {
                for (int l = 0; l < this.q.length; ++l) {
                    if (this.q[l] == null) {
                        ...
                        final dD dd;
                        if ((dd = this.q[l]).q == null) {
                            dataOutput.writeInt(0);
                        }
                        else {
                            dataOutput.writeInt(dd.q.length);
                            dataOutput.write(dd.q);
                        }
                    }
                }
            }
    ...
    public dI(final int n, final int n2) {
        this(n, dL.q(n), n2);
    }
    
    public dI(final DataInput dataInput) {
        this();
                ...
                if (this.q != null) {
                    for (int n8 = 0; n8 < this.t; ++n8) {
                        for (int n9 = 0; n9 < n3; ++n9) {
                            if (n9 < n6) {
                                this.q[n8 * n6 + n9] = new dD(dataInput);
    ...
    private dI(final int r, final int y, final int t) {
        this();
        if (t < 0) {
