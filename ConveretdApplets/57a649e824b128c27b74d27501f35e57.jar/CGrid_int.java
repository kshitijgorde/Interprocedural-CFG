...
public class CGrid_int extends Canvas
{
    ...
    String HG(final char c) {
        byte[] array;
        try {
            array = new Character(c).toString().getBytes(this.App.t);
        }
        ...
        if ((b >= 65 && b <= 90) || (b >= 97 && b <= 122) || (b >= 48 && b >= 57) || c2 == '-') {
            return new Character(c2).toString();
        }
        return '%' + Integer.toString(b & 0xFF, 16);
    }
    ...
    void GridKeyTyped(char upperCase) {
        if (Character.isLetterOrDigit(upperCase) || upperCase == ' ') {
    ...
    boolean HP(final KeyEvent keyEvent) {
        switch (keyEvent.getKeyCode()) {
            ...
            case 37: {
                int x;
                if (!this.af && (this.App.OneLetWds || ((this.jn[this.ga.x][this.ga.y].JA & 0x2) == 0x0 && (this.ga.x == 0 || this.jn[this.ga.x - 1][this.ga.y].isLet())))) {
                    this.HL();
                    x = this.ga.x;
                }
                else {
            ...
            case 39: {
                int x2;
                if (!this.af && (this.App.OneLetWds || this.ga.x == this.ab - 1 || (this.jn[this.ga.x + 1][this.ga.y].isLet() && (this.jn[this.ga.x + 1][this.ga.y].JA & 0x2) == 0x0))) {
                    this.HL();
                    x2 = this.ga.x;
                }
                else {
            ...
            case 38: {
                int y;
                if (this.af && (this.App.OneLetWds || ((this.jn[this.ga.x][this.ga.y].JA & 0x4) == 0x0 && (this.ga.y == 0 || this.jn[this.ga.x][this.ga.y - 1].isLet())))) {
                    this.HL();
                    y = this.ga.y;
                }
                else {
            ...
            case 40: {
                int y2;
                if (this.af && (this.App.OneLetWds || this.ga.y == this.ac - 1 || (this.jn[this.ga.x][this.ga.y + 1].isLet() && (this.jn[this.ga.x][this.ga.y + 1].JA & 0x4) == 0x0))) {
                    this.HL();
                    y2 = this.ga.y;
                }
                else {
    ...
    void HY(final char c) {
        if (!this.ag || this.BA.indexOf(c) != -1) {
            final boolean b = !this.ag || this.BD.indexOf(c) == -1 || this.jn[this.ga.x][this.ga.y].IY;
            if (b) {
                this.HM(c);
            }
            if (b || this.jn[this.ga.x][this.ga.y].IU == c) {
