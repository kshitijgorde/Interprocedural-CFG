...
public final class LimitChronology extends AssembledChronology
{
    ...
    private DurationField convertField(final DurationField durationField, final HashMap hashMap) {
        ...
        final LimitDurationField limitDurationField = new LimitDurationField(durationField);
    ...
    private DateTimeField convertField(final DateTimeField dateTimeField, final HashMap hashMap) {
        ...
        final LimitDateTimeField limitDateTimeField = new LimitDateTimeField(dateTimeField, this.convertField(dateTimeField.getDurationField(), hashMap), this.convertField(dateTimeField.getRangeDurationField(), hashMap), this.convertField(dateTimeField.getLeapDurationField(), hashMap));
