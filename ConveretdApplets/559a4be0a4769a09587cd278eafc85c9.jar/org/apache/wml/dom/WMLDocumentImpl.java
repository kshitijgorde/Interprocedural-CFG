...
public class WMLDocumentImpl extends DocumentImpl implements WMLDocument
{
    ...
    public Element createElement(final String tagName) throws DOMException {
        final Class elemClass = WMLDocumentImpl._elementTypesWML.get(tagName);
        if (elemClass != null) {
            try {
                final Constructor cnst = elemClass.getConstructor((Class[])WMLDocumentImpl._elemClassSigWML);
    ...
    public WMLDocumentImpl(final DocumentType doctype) {
        super(doctype, false);
    }
