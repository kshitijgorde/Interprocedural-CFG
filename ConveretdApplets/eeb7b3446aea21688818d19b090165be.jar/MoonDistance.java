...
class MoonDistance
{
    ...
    double computeR() {
        ...
        final double T2 = Math.pow(T, 3.0);
        final double T3 = Math.pow(T, 4.0);
        final double D = 0.017453292519943295 * (297.8502042 + 445267.1115168 * T - 0.00163 * T * T + T2 / 545868.0 - T3 / 1.13065E8);
        final double M = 0.017453292519943295 * (357.5291092 + 35999.0502909 * T - 1.536E-4 * T * T + T2 / 2.449E7);
        final double MS = 0.017453292519943295 * (134.9634114 + 477198.8676313 * T + 0.008997 * T * T + T2 / 69699.0 - T3 / 1.4712E7);
        final double F = 0.017453292519943295 * (93.2720993 + 483202.0175273 * T - 0.0034029 * T * T - T2 / 3526000.0 + T3 / 8.6331E8);
