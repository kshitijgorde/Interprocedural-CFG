...
public class RubyIO$i$0$1$sysseek extends JavaMethodN
{
    public RubyIO$i$0$1$sysseek(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject rubyObject, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return ((RubyIO)rubyObject).sysseek(context, array);
    }
}
