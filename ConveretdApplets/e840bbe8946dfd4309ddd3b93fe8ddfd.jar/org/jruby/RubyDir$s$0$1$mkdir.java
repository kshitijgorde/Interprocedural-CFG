...
public class RubyDir$s$0$1$mkdir extends JavaMethodN
{
    public RubyDir$s$0$1$mkdir(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext threadContext, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyDir.mkdir(recv, array);
    }
}
