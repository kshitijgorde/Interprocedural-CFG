...
public class Graph extends JPanel implements MouseMotionListener
{
    ...
    public static String getFloatList(final float[] array) {
        ...
        String s = number(array[0], 5);
        for (int i = 1; i < array.length; ++i) {
            s = String.valueOf(s) + "," + number(array[i], 5);
        }
        return s;
    }
    ...
    public static String number(final float n, final int n2) {
        return Fmt.number(n, n2, false, true, "", "", "", ".", 0, false, true, ' ');
    }
