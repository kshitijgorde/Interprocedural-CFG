...
public class IncrementalSAXSource_Xerces implements IncrementalSAXSource
{
    ...
    public void setContentHandler(final ContentHandler handler) {
        ((XMLReader)this.fIncrementalParser).setContentHandler(handler);
    }
    
    public void setLexicalHandler(final LexicalHandler handler) {
        try {
            ((XMLReader)this.fIncrementalParser).setProperty("http://xml.org/sax/properties/lexical-handler", handler);
        }
    ...
    public void setDTDHandler(final DTDHandler handler) {
        ((XMLReader)this.fIncrementalParser).setDTDHandler(handler);
    }
    ...
    public static void main(final String[] args) {
        ...
        final XMLSerializer trace = new XMLSerializer((OutputStream)System.out, (OutputFormat)null);
