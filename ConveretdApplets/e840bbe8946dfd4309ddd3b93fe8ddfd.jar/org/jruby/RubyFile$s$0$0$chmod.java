...
public class RubyFile$s$0$0$chmod extends JavaMethodN
{
    public RubyFile$s$0$0$chmod(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyFile.chmod(context, recv, array);
    }
}
