...
public final class P extends Panel implements Runnable
{
    bu q;
    private Color q;
    private Color w;
    ...
    public P(final aX ax, final bu q, final boolean e, final ce q2) {
        this.q = q2;
        this.e = true;
        this.q = false;
        this.r = true;
        ...
        this.q = new Vector(ax.q.size());
        this.e = 0;
        for (int i = 0; i < ax.q.size(); ++i) {
            final Object q3;
            if ((q3 = ax.q()) instanceof aa) {
                final ce ce = new ce((aa)q3, q, this);
                this.q.addElement(ce);
                if (ce.q() > this.e - 40) {
                    this.e = ce.q() + 40;
                }
                ++this.q;
    ...
    private void q(final boolean b) {
        ...
        for (int i = 0; i < this.q.size(); ++i) {
            final Panel panel;
            if ((panel = this.q.elementAt(i)) instanceof ce) {
                if (b) {
                    panel.setBounds(2, 2 + n * e + n2 * 3, this.e, e);
                }
                ++n;
            }
            else if (panel instanceof G) {
