...
class Rise_Set
{
    ...
    public Rise_Set(final Date myDat, final double myLat, final double myLong, final int myWhat) {
        this.civilRiseStr = "?";
        this.dat = myDat;
        ...
        for (int i = -this.locOffset; i < -this.locOffset + 24; ++i) {
            this.riseset(this.date, this.month + 1, this.year + 1900, i, this.what);
        ...
        if (this.RISE || this.SETT) {
            ...
            if (this.RISE) {
                this.riseStr = this.makeTimeString("Rise     ", this.hRise);
            }
            else if (this.ABOVE) {
            ...
            if (this.SETT) {
                this.setStr = this.makeTimeString("Set      ", this.hSet);
            }
            else if (this.ABOVE) {
                this.riseStr = "Visible all day";
                this.setStr = "Visible all day";
    ...
    String civilRise() {
        if (this.riseStr.equals("Visible all day") || this.riseStr.equals("Invisible all day")) {
            return "   Civil Tl.   --:--";
        }
        return this.makeTimeString("   Civil Tl.", this.hRise);
    }
    
    String civilSet() {
        if (this.setStr.equals("Visible all day") || this.setStr.equals("Invisible all day")) {
            return "   Civil Tl.   --:--";
        }
        return this.makeTimeString("   Civil Tl.", this.hSet);
    }
