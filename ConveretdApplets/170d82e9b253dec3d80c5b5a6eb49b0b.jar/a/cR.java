...
final class cR extends D
{
    ...
    public final boolean handleEvent(final Event event) {
        switch (event.id) {
            ...
            case 506: {
                ((r)(this.q.q = null)).setValue(this.q.w - (event.y - this.q));
                final int n;
            ...
            case 1001: {
                final cS cs;
                if (event.arg instanceof cS && (cs = (cS)event.arg).u != -1) {
                    this.q.q.s(cs.u);
                    break;
                }
                break;
    ...
    public final int q(final Graphics graphics, int n, final int n2) {
        ...
        if (this.q == null || (this.getSize().height != 0 && this.getSize().height != this.w) || (this.getSize().width != 0 && this.getSize().width != this.e)) {
            ...
            this.q = dU.q(this, this.e, this.w, "mpe.a");
        }
