...
public final class dt
{
    ...
    public static boolean g(final String s) {
        ...
        try {
            equalsIgnoreCase = s.equalsIgnoreCase(m("JG\u0003+"));
        }
        catch (Exception ex) {}
        ...
        if (substring != null) {
            try {
                ...
                if (index2 > 0) {
                    ...
                    if (trim.equalsIgnoreCase(m("wa7\u00028}"))) {
                        n = 2;
                    }
                    else if (trim.equalsIgnoreCase(m("|z:\n"))) {
                        n = 1;
                    }
                    else if (trim.equalsIgnoreCase(m("|z:\n8jt:\u00072"))) {
                        n = 3;
    ...
    public static ea k(String substring) {
        int intValue = 0;
        int intValue2 = 0;
        int intValue3 = 0;
        if (substring != null) {
        ...
        return new ea(intValue, intValue2, intValue3);
    }
