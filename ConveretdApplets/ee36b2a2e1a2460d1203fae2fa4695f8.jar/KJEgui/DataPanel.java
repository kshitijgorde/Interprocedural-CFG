...
public class DataPanel extends JPanel
{
    ...
    public void addRow(final Nbr nbr, final Slider slider, final Font font, final int n) {
        final JLabel jOutputLabel = this.JOutputLabel(String.valueOf(nbr.getName()) + " ", this.iAlign);
        this.c.gridx = 0;
        this.c.gridy = n;
        this.c.weightx = 1.0;
        this.c.gridwidth = 3;
    ...
    public void addRow(final JComponent component, final Nbr nbr, final Nbr nbr2, final Font font, final int n) {
        this.addRow(component, nbr, this.JOutputLabel(nbr2.getLabel(), this.iAlign), nbr2, font, n);
    }
