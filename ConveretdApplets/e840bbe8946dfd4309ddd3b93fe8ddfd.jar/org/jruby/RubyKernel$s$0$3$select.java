...
public class RubyKernel$s$0$3$select extends JavaMethodN
{
    public RubyKernel$s$0$3$select(final RubyModule implementationClass, final Visibility visibility) {
    ...
    public IRubyObject call(final ThreadContext context, final IRubyObject recv, final RubyModule rubyModule, final String s, final IRubyObject[] array) {
        ...
        return RubyKernel.select(context, recv, array);
    }
}
